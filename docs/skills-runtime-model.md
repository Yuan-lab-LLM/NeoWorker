...
- `architecture-design` can add artifact expectations and project-scaffolding context for a local design workspace, but it still does not replace the user's original design request.
