...
This feature is for analyzing a user-provided attachment through representative still frames. It is part of the attachment pipeline, not a selectable skill.
