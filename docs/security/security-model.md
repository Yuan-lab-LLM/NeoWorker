...
- cancellation propagates into NeoWorker agent tasks, Google requests/uploads, and signed webhooks. Arbitrary MCP servers may not support mid-call abort, so remote completion must still be verified;
