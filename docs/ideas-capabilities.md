...
The Ideas panel shows use case prompts that NeoWorker can execute. Each idea uses **built-in capabilities** that are available by default or via standard integrations.
