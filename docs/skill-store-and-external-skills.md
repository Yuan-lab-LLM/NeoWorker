...
Bundled skills such as [`architecture-design`](skills/architecture-design.md), [`kami`](skills/kami.md), and [`unbroker`](skills/unbroker.md) do not need installation from the Skill Store. They ship with the app and are available immediately.
