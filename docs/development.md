...
If a globally installed `neoworker` command is linked to this source checkout, its runtime dependency repair preserves the checkout's development dependencies. Packaged npm installs continue to omit development-only packages.
