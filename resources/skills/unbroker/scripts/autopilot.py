...
FANOUT_THRESHOLD = 8          # above this many unscanned brokers, use NeoWorker subagent fan-out
    ...
    if unscanned:
        ...
        if len(ids) > FANOUT_THRESHOLD:
            actions.append({
                ...
                "how": "spawn ONE NeoWorker subagent per batch IN PARALLEL with each batch's brief; "
