# NeoWorker Multi-Agent Research — Full Guidance
...
- Source: neoworker-multi-agent-research skill
```
...
## 2. NeoWorker Applicability

- **Agent Teams**: [How does this apply to NeoWorker agent teams?]
...
- **Other**: [Any other NeoWorker features]
...
- **NeoWorker applicability**: Be specific. Reference NeoWorker features: agent teams, sub-agents, collaborative mode, mention tools, etc.
...
## NeoWorker Context (for Applicability)
...
- Check NeoWorker docs: `docs/competitive-landscape-research.md`, `docs/architecture.md`, `docs/features.md` for alignment.
