...
if (electronStatus.installed && electronStatus.ready) {
  ...
  if (runningElectronPid) {
    process.stderr.write(
      `[dev-start] Existing NeoWorker development instance detected (PID ${runningElectronPid}). ` +
...
electron.once("exit", (code) => {
  ...
  if (code === ELECTRON_SINGLE_INSTANCE_EXIT_CODE) {
    process.stderr.write(
      "[dev-start] Electron startup was blocked by an existing NeoWorker instance. " +
