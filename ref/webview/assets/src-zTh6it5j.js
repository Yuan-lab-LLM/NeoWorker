...
function f(e, t, r, i) {
  ...
  function o(e, i, a, o, s, c) {
    if (e !== a || i !== o) {
      ...
      c.push({ i: l - 4, x: n(e, a) }, { i: l - 2, x: n(i, o) });
    } else (a || o) && s.push(`translate(` + a + t + o + r);
  }
  function s(e, t, r, o) {
    e === t
      ? t && r.push(a(r) + `rotate(` + t + i)
      : (e - t > 180 ? (t += 360) : t - e > 180 && (e += 360),
        o.push({ i: r.push(a(r) + `rotate(`, null, i) - 2, x: n(e, t) }));
  }
  function c(e, t, r, o) {
    e === t
      ? t && r.push(a(r) + `skewX(` + t + i)
      : o.push({ i: r.push(a(r) + `skewX(`, null, i) - 2, x: n(e, t) });
  }
  function l(e, t, r, i, o, s) {
    if (e !== r || t !== i) {
      var c = o.push(a(o) + `scale(`, null, `,`, null, `)`);
      s.push({ i: c - 4, x: n(e, r) }, { i: c - 2, x: n(t, i) });
...
//# sourceMappingURL=src-zTh6it5j.js.map
