...
import { n as pe, t as me } from "./star-BG4IWvX6.js";
import {
  c as he,
  i as ge,
  l as _e,
...
import { n as Ce, t as we } from "./use-git-recent-branches-C-3Xty1U.js";
import {
  n as K,
  t as Te,
...
function Ee(e) {
  let t = (0, Ne.c)(55),
    ...
    b = ce(),
    S;
  t[0] === h ? (S = t[1]) : ((S = { enabled: h }), (t[0] = h), (t[1] = S));
  let E = x(S),
    k = c ?? E,
    A = U(b),
    ae = A?.default_branch ?? `main`,
    M = A?.id ?? null,
    N = l === `worktree`,
    F = N || !!c,
    L = re(P),
  ...
  let V = se,
    H = !F && !!M && p && !!R,
    W;
  t[3] === H ? (W = t[4]) : ((W = { enabled: H }), (t[3] = H), (t[4] = W));
  let {
      data: G,
      isFetching: le,
      error: ue,
      hasNextPage: fe,
      isFetchingNextPage: pe,
      fetchNextPage: me,
      refetch: ge,
    } = j(M, R, W),
    ve = F && h,
    ye;
  t[5] !== L || t[6] !== ve
    ? ((ye = { enabled: ve, retainRepoWatch: L }),
      (t[5] = L),
      (t[6] = ve),
      (t[7] = ye))
    : (ye = t[7]);
  let {
      ...
      isLoading: xe,
      refetch: Se,
    } = O(k, i, `async_task_starting_state_dropdown`, ye),
    Ce = F && h && !!k,
    we;
  t[8] !== L || t[9] !== Ce
    ? ((we = { enabled: Ce, retainRepoWatch: L }),
      (t[8] = L),
      (t[9] = Ce),
      (t[10] = we))
    : (we = t[10]);
  let { data: K } = he(k, i, `async_task_starting_state_dropdown`, we),
    {
      branches: Te,
      defaultBranch: Ee,
      fetching: je,
      ...
      gitRoot: k,
      hostConfig: i,
      currentBranch: be ?? `main`,
      remoteDefaultBranch: ae,
      enabled: F && h,
    }),
    Fe = R.trim().toLowerCase(),
    Y = Fe.length > 0,
    Ie = F && p && Y,
    Le;
  t[11] !== R || t[12] !== k || t[13] !== i || t[14] !== N || t[15] !== Ie
    ? ((Le = {
        cwd: k,
        hostConfig: i,
        operationSource: `async_task_starting_state_dropdown`,
        preserveRemoteRefs: N,
        query: R,
        enabled: Ie,
      }),
      (t[11] = R),
      ...
      (t[16] = Le))
    : (Le = t[16]);
  let { data: X, isFetching: Re, error: ze, refetch: Be } = f(_e, Le),
    Ve = X?.branches,
    He = n.type === `branch` ? (n.remoteRef ?? n.branchName) : void 0,
    Z = F ? Ee : ae,
    Q = F
      ? Y
        ? Ve
        : Te
      : Y
        ? G?.filter((e) => e.toLowerCase().includes(Fe))
        : void 0,
    Ue = !Y || Z.toLowerCase().includes(Fe),
    We = Q?.filter((e) => e !== Z),
    Ge;
  t[17] !== Y || t[18] !== N || t[19] !== X?.remoteBranchRefs
    ? ((Ge = N && Y ? (X?.remoteBranchRefs ?? []) : []),
      (t[17] = Y),
      (t[18] = N),
      (t[19] = X?.remoteBranchRefs),
      (t[20] = Ge))
    : (Ge = t[20]);
  let Ke = Ge,
    qe = N && Ke.length > 0,
    ...
    Ze = !F && fe,
    Qe = be ?? Z,
    $e = n.type === `branch` ? n.branchName : Qe,
    et =
      K?.type === `success`
        ? K.stagedCount + K.unstagedCount + (K.untrackedCount ?? 0) > 0
        : !1,
    tt = F && et,
    nt = n.type === `working-tree` && et,
    rt =
      n.type === `working-tree`
        ? (0, q.jsx)(w, {
  ...
  t[21] === rt
    ? (it = t[22])
    : ((it = (0, q.jsx)(C, { electron: !0, children: rt })),
      (t[21] = rt),
      (t[22] = it));
  let at;
  t[23] === $e
    ? (at = t[24])
    : ((at = (0, q.jsx)(C, { browser: !0, children: $e })),
      (t[23] = $e),
      (t[24] = at));
  let ot = (0, q.jsxs)(q.Fragment, {
      children: [
        it,
        (0, q.jsx)(C, {
          extension: !0,
  ...
  t[32] === a
    ? (ut = t[33])
    : ((ut = oe(`whitespace-nowrap`, a)), (t[32] = a), (t[33] = ut));
  let dt = n.type === `working-tree` && et,
    ft;
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ft = (0, q.jsx)(_, { className: `icon-xs` })), (t[34] = ft))
    : (ft = t[34]);
  let pt;
  t[35] === dt
    ? (pt = t[36])
  ...
  let _t = tt
      ? (0, q.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, q.jsx)(T.Item, {
              LeftIcon: De,
              RightIcon: n.type === `working-tree` ? B : void 0,
              SubText: et
                ? (0, q.jsx)(`span`, {
                ...
                : void 0,
              onClick: () => {
                (r({ type: `working-tree` }), V(!1));
              },
              children: xe
                ? null
                : (0, q.jsx)(q.Fragment, { children: be ?? Z }),
            }),
          ],
        })
      : null,
  ...
  let yt =
      R && Je
        ? (0, q.jsx)(`div`, {
            ...
            children: (0, q.jsx)(ie, { className: `icon-xxs` }),
          })
        : R && Ye
          ? (0, q.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, q.jsx)(z, {
                  ...
                  children: (0, q.jsx)(o, { className: `icon-xxs` }),
                }),
              ],
            })
          : (0, q.jsxs)(`div`, {
              ...
              children: [
                Ue &&
                  (0, q.jsx)(T.Item, {
                    LeftIcon: _,
                    RightIcon: He === Z ? B : void 0,
                    onClick: () => {
                      (r({ type: `branch`, branchName: Z }), V(!1));
                    },
                    children: Z,
                  }),
                We?.map((e) =>
                  (0, q.jsx)(
                    ...
                    {
                      LeftIcon: _,
                      RightIcon: e === He ? B : void 0,
                      onClick: () => {
                        (r({ type: `branch`, branchName: e }), V(!1));
                      },
                      children: e,
                    },
                    e,
...
function De(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, q.jsx)(de, {
          borderColor: `border-token-side-bar-background`,
          children: (0, q.jsx)(_, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function ke(e) {
  let t = (0, Ne.c)(20),
    ...
    ee;
  t[0] !== o || t[1] !== s
    ? ((ee = { enabled: o, retainRepoWatch: s }),
      (t[0] = o),
      (t[1] = s),
      (t[2] = ee))
    : (ee = t[2]);
  let {
      ...
      error: l,
      refetch: u,
    } = ue(n, r, `async_task_starting_state_dropdown`, ee),
    d;
  t[3] !== o || t[4] !== s
    ? ((d = { enabled: o, retainRepoWatch: s }),
      (t[3] = o),
      (t[4] = s),
      (t[5] = d))
    : (d = t[5]);
  let {
      ...
      error: h,
      refetch: g,
    } = Ce(n, r, `async_task_starting_state_dropdown`, d),
    _;
  if (t[6] !== i || t[7] !== c || t[8] !== f || t[9] !== a) {
    let e = [
        c,
        i,
        je({
  ...
  let S = x,
    C;
  return (
    t[14] !== _ || t[15] !== v || t[16] !== b || t[17] !== y || t[18] !== S
      ? ((C = {
          branches: _,
          defaultBranch: v,
          fetching: y,
...
function Ae(e) {
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((a = (0, q.jsx)(`div`, { className: i, children: r })),
        (t[2] = r),
        (t[3] = i),
        (t[4] = a))
      : (a = t[4]),
...
function Me({ branch: e, list: t, seen: n }) {
  ...
  return t == null
    ...
    : (0, X.jsx)(ne, {
        ...
        children: (0, X.jsx)(te, {
          ...
          collapse: `sm`,
          disabled: n,
          icon: (0, X.jsx)(_, { className: `icon-xs` }),
...
function ze(e) {
  let t = (0, He.c)(74),
    {
      ...
      align: l,
      showIcon: u,
      selectedConfigPath: d,
      repairConfigPath: f,
      onSelectConfigPath: p,
      onOpenSettings: m,
      showDefaultOption: h,
    } = e,
    g = s === void 0 ? `top` : s,
  ...
  if (
    ...
    t[25] === d
      ? (c = t[26])
      : ((c = d ? E(d) : null), (t[25] = d), (t[26] = c));
    let l = c,
      u;
    t[27] !== l || t[28] !== f
      ? ((u = f ? E(f) : l), (t[27] = l), (t[28] = f), (t[29] = u))
      : (u = t[29]);
    let m = u,
      h = i.find((e) => E(e.configPath) === m) ?? null,
      I = !a && !o,
      L = s && v ? e.filter((e) => E(e.configPath) !== E(s.configPath)) : e,
      R = Ve({ isLoading: a, environmentResult: h });
    ((x = ee), (C = y), (D = b), (O = g), (k = re));
    let z;
    ...
    t[31] === n
      ? (V = t[32])
      : ((V = oe(`whitespace-nowrap`, n)), (t[31] = n), (t[32] = V));
    let H = r == null ? `secondary` : `sm`,
      U;
    t[33] === _
      ? (U = t[34])
      : ((U = _ ? (0, Q.jsx)(ae, { className: `icon-xs` }) : null),
        (t[33] = _),
        (t[34] = U));
    let W = a ? `pending` : `collapsible-chevron`,
      G;
    (t[35] === r
      ? (G = t[36])
      : ((G = oe(`max-w-40`, r)), (t[35] = r), (t[36] = G)),
      t[37] !== R ||
      t[38] !== V ||
      t[39] !== H ||
      t[40] !== U ||
      ...
      t[42] !== G
        ? ((A = (0, Q.jsx)(ne, {
          ...
          (t[43] = A))
        : (A = t[43]),
      (F = `flex w-64 flex-col overflow-hidden`),
      t[44] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((S = (0, Q.jsx)(T.Title, {
          ...
          (t[44] = S))
        : (S = t[44]),
      (j = `vertical-scroll-fade-mask flex max-h-[220px] flex-col overflow-y-auto`),
      t[45] !== p || t[46] !== f || t[47] !== d || t[48] !== I
        ? ((M = I
            ? (0, Q.jsx)(T.Item, {
                RightIcon: d == null && f == null ? B : void 0,
                onClick: () => {
                  (p(null), b(!1));
                },
                children: (0, Q.jsx)(w, {
      ...
      (N =
        v && s
          ? (0, Q.jsx)(T.Item, {
              RightIcon: l != null && E(s.configPath) === l ? B : void 0,
              onClick: () => {
                (p(s.configPath), b(!1));
              },
        ...
        : o
          ...
          : L.length > 0
            ? (0, Q.jsx)(`div`, {
                className: `flex flex-col`,
                children: L.map((e) => {
                  let t = d != null && E(e.configPath) === l;
                  return (0, Q.jsx)(
                    T.Item,
                    {
                      RightIcon: t ? B : void 0,
                      onClick: () => {
                        (p(e.configPath), b(!1));
                      },
            ...
            : i.length > 0 && e.length === 0
              ? (0, Q.jsx)(T.Message, {
                  compact: !0,
                  tone: `error`,
                  children: (0, Q.jsx)(w, { ...K.needsAttention }),
                })
              : i.length === 0
                ? (0, Q.jsx)(T.Message, {
                    compact: !0,
  ...
  t[54] === I
    ? (R = t[55])
    : ((R = (0, Q.jsx)(T.Item, { LeftIcon: c, onClick: I, children: L })),
      (t[54] = I),
      (t[55] = R));
  let z;
  t[56] !== R || t[57] !== j || t[58] !== M || t[59] !== N || t[60] !== P
    ? ((z = (0, Q.jsxs)(`div`, { className: j, children: [M, N, P, R] })),
      (t[56] = R),
      (t[57] = j),
      (t[58] = M),
      (t[59] = N),
    ...
    : (z = t[61]);
  let V;
  t[62] !== S || t[63] !== z || t[64] !== F
    ? ((V = (0, Q.jsxs)(`div`, { className: F, children: [S, z] })),
      (t[62] = S),
      (t[63] = z),
      (t[64] = F),
      (t[65] = V))
...
function Ve({ isLoading: e, environmentResult: t }) {
  return e
    ? (0, Q.jsx)(w, {
    ...
    : t?.type === `error`
      ? (0, Q.jsx)(w, { ...K.needsAttention })
      : t?.type === `success`
        ? (0, Q.jsx)(Q.Fragment, { children: t.environment.name })
        : (0, Q.jsx)(w, {
...
export { Ee as a, Re as i, Ue as n, J as o, Fe as r, ze as t };
//# sourceMappingURL=worktree-environment-dropdown-CVYFSALu.js.map
