...
import {
  ...
  r as N,
  t as te,
} from "./cloud-preferences-CBs_FcMz.js";
function P() {
  let e = (0, I.c)(1),
    t;
  return (
...
function F() {
  ...
  let u = r.data,
    p = i.data,
    m = c?.baseline === u.branch_format ? c.value : u.branch_format,
    _,
    v,
    b,
    x,
  ...
  if (
    ...
    e[11] !== t ||
    e[12] !== u.git_diff_mode ||
    e[13] !== n ||
    e[14] !== a
  ) {
    C = j(m, p.branch_format_max_length, p.branch_format_special_values);
    let r;
    ...
    e[33] === a.isPending
      ? (f = e[34])
      : ((f = { id: `unified`, label: l, disabled: a.isPending }),
        (e[33] = a.isPending),
        (e[34] = f));
    let y;
    ...
    e[36] === a.isPending
      ? (S = e[37])
      : ((S = { id: `split`, label: y, disabled: a.isPending }),
        (e[36] = a.isPending),
        (e[37] = S));
    let w;
    e[38] !== S || e[39] !== f
      ? ((w = [f, S]), (e[38] = S), (e[39] = f), (e[40] = w))
      : (w = e[40]);
    let k;
    (e[41] !== t || e[42] !== T
      ? ((k = (e) => {
        ...
        (e[43] = k))
      : (k = e[43]),
      e[44] !== u.git_diff_mode || e[45] !== w || e[46] !== k || e[47] !== c
        ? ((N = (0, R.jsx)(h, {
            label: i,
            description: o,
            control: (0, R.jsx)(ee, {
              ariaLabel: c,
              options: w,
              selectedId: u.git_diff_mode,
              onSelect: k,
            }),
          })),
          (e[44] = u.git_diff_mode),
          (e[45] = w),
          (e[46] = k),
          (e[47] = c),
          (e[48] = N))
      ...
      (O =
        C == null
          ? (0, R.jsx)(d, {
              ...
              values: { branchName: te(m, p.branch_format_special_values) },
            })
          : re(C)),
      (e[8] = m),
      (e[9] = p.branch_format_max_length),
  ...
  e[52] === t
    ...
    : ((z = t.formatMessage(
      ...
      (e[53] = z));
  let B;
  e[54] === u.branch_format
    ? (B = e[55])
    : ((B = (e) => {
        l({ baseline: u.branch_format, value: e.target.value });
      }),
      (e[54] = u.branch_format),
      (e[55] = B));
  let V;
  ...
  e[60] !== a.isPending
    ...
    : (V = e[61]);
  let H;
  e[62] !== _ || e[63] !== E || e[64] !== O || e[65] !== V
    ? ((H = (0, R.jsx)(_, { label: E, description: O, control: V })),
      (e[62] = _),
      (e[63] = E),
      (e[64] = O),
      (e[65] = V),
  ...
  e[70] === W
    ...
    : ((G = (0, R.jsx)(`span`, { className: `[text-wrap:wrap]`, children: W })),
      (e[70] = W),
      (e[71] = G));
  let K = m === u.branch_format || C != null,
    q;
  e[72] !== m || e[73] !== t || e[74] !== T
    ? ((q = () => {
        T(
          { branch_format: m },
          t.formatMessage({
  ...
  e[76] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (J = e[76]);
  let Y;
  e[77] !== K || e[78] !== q || e[79] !== a.isPending
    ? ((Y = (0, R.jsx)(y, {
        color: `primary`,
        disabled: K,
        loading: a.isPending,
...
//# sourceMappingURL=cloud-preferences-settings-4LQIAZv2.js.map
