import { a as e, i as t, n, r } from "./src-DbaHYgEA.js";
const i = {
...
function Je() {
  ...
  let Et = function (e) {
      let n = null;
      if (($(C.beforeSanitizeElements, e, null), Z(e))) return (J(e), !0);
      let r = K(e.nodeName);
      if (
    ...
    Dt = function (e, t, r) {
      if (He[t] || (B && (t === `id` || t === `name`) && (r in n || r in yt)))
        return !1;
      if (
        !(Xe && !He[t] && D(ce, t)) &&
        !(Ye && D(le, t)) &&
  ...
  return (
    (t.sanitize = function (e) {
      ...
      if (
        (et || xt(n), (t.removed = []), typeof e == `string` && (rt = !1), rt)
      ) {
        if (e.nodeName) {
          let t = K(e.nodeName);
          if (!j[t] || Be[t])
...
`,
  ...
  yt = {
    ...
    themeCSS: void 0,
    themeVariables: K.default.getThemeVariables(),
    sequence: {
      ...q.sequence,
    ...
    gantt: { ...q.gantt, tickInterval: void 0, useWidth: void 0 },
    c4: {
      ...q.c4,
      useWidth: void 0,
      ...
      flowchart: { ...q.flowchart, inheritDir: !1 },
    ...
    pie: { ...q.pie, useWidth: 984 },
    xyChart: { ...q.xyChart, useWidth: void 0 },
    requirement: { ...q.requirement, useWidth: void 0 },
    packet: { ...q.packet },
    treeView: { ...q.treeView, useWidth: void 0 },
    radar: { ...q.radar },
    ishikawa: { ...q.ishikawa },
    treemap: {
      useMaxWidth: !0,
    ...
    if (
      ...
      for (let n of Object.keys(e)) {
        ...
        for (let r of [`themeCSS`, `fontFamily`, `altFontFamily`])
          n.includes(r) &&
            (t.debug(`sanitizing css option`, n), (e[n] = wt(e[n])));
      }
      if (e.themeVariables)
  ...
  $ = r((e, t) => {
    let n = R({}, e),
      r = {};
    for (let e of t) (Mt(e), (r = R(r, e)));
    if (((n = R(n, r)), r.theme && r.theme in K)) {
      let e = R(R({}, Tt).themeVariables || {}, r.themeVariables);
      n.theme &&
        n.theme in K &&
        (n.themeVariables = K[n.theme].getThemeVariables(e));
    }
    return ((Q = n), Rt(Q), Q);
  }, `updateCurrentConfig`),
  Et = r(
    (e) => (
      ...
      e.theme &&
        K[e.theme] &&
        (X.themeVariables = K[e.theme].getThemeVariables(e.themeVariables)),
      $(X, Z),
      X
    ),
    `setSiteConfig`,
  ...
  Ot = r((e) => ((X = R(X, e)), $(X, Z), X), `updateSiteConfig`),
  kt = r(() => R({}, X), `getSiteConfig`),
  At = r((e) => (Rt(e), R(Q, e), jt()), `setConfig`),
  jt = r(() => R({}, Q), `getConfig`),
  Mt = r((e) => {
    e &&
      ([`secure`, ...(X.secure ?? [])].forEach((n) => {
        Object.hasOwn(e, n) &&
  ...
  It = {},
  Lt = r((e) => {
    It[e] || (t.warn(Ft[e]), (It[e] = !0));
  }, `issueWarning`),
  Rt = r((e) => {
    e &&
      (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) &&
      Lt(`LAZY_LOAD_DEPRECATED`);
  }, `checkConfig`),
  zt = r(() => {
    let e = {};
    Tt && (e = R(e, Tt));
    for (let t of Z) e = R(e, t);
    return e;
  }, `getUserDefinedConfig`),
  Bt = r(
    (e) => (
      e.flowchart?.htmlLabels != null && Lt(`FLOWCHART_HTML_LABELS_DEPRECATED`),
      Y(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)
    ),
...
r(Wt, `setupDompurifyHooks`);
var Gt = r((e) => (Ut(), P.sanitize(e)), `removeScript`),
  Kt = r((e, t) => {
    if (Bt(t)) {
  ...
  qt = r(
    (e, t) =>
      e &&
      ((e = t.dompurifyConfig
        ? P.sanitize(Kt(e, t), t.dompurifyConfig).toString()
        : P.sanitize(Kt(e, t), { FORBID_TAGS: [`style`] }).toString()),
      e),
    `sanitizeText`,
  ),
  Jt = r(
    (e, t) => (typeof e == `string` ? qt(e, t) : e.flat().map((e) => qt(e, t))),
    `sanitizeTextOrArray`,
  ),
  Yt = r((e) => Vt.test(e), `hasBreaks`),
  Xt = r((e) => e.split(Vt), `splitBreaks`),
  Zt = r((e) => e.replace(/#br#/g, `<br/>`), `placeholderToBreak`),
  Qt = r((e) => e.replace(Vt, `#br#`), `breakToPlaceholder`),
  $t = r((e) => {
    let t = ``;
    return (
      e &&
  ...
  nn = r(function (e) {
    ...
    for (let e = 0; e < t.length; e++) {
      ...
      if (r === `,` && e > 0 && e + 1 < t.length) {
        let i = t[e - 1],
          a = t[e + 1];
        an(i, a) && ((r = i + `,` + a), e++, n.pop());
      }
      n.push(on(r));
    }
    return n.join(``);
  }, `parseGenericTypes`),
  rn = r((e, t) => Math.max(0, e.split(t).length - 1), `countOccurrence`),
  an = r((e, t) => {
    let n = rn(e, `~`),
      r = rn(t, `~`);
    return n === 1 && r === 1;
  ...
  sn = r(() => window.MathMLElement !== void 0, `isMathMLSupported`),
  cn = /\$\$(.*)\$\$/g,
  ln = r((e) => (e.match(cn)?.length ?? 0) > 0, `hasKatex`),
  un = r(async (e, t) => {
    let n = document.createElement(`div`);
    ((n.innerHTML = await fn(e, t)),
      (n.id = `katex-temp`),
  ...
  dn = r(async (e, t) => {
    if (!ln(e)) return e;
    if (!(sn() || t.legacyMathML || t.forceLegacyMathML))
      return e.replace(cn, `MathML is unsupported in this environment.`);
    {
      let { default: n } = await import(`./katex-DFAkUG_D.js`),
        r =
          t.forceLegacyMathML || (!sn() && t.legacyMathML)
            ? `htmlAndMathml`
            : `mathml`;
      return e
        .split(Vt)
  ...
  fn = r(async (e, t) => qt(await dn(e, t), t), `renderKatexSanitized`),
  pn = {
    getRows: Ht,
    sanitizeText: qt,
    sanitizeTextOrArray: Jt,
    hasBreaks: Yt,
    splitBreaks: Xt,
    lineBreakRegex: Vt,
    removeScript: Gt,
  ...
  gn = r(function (e, t, n, r) {
    mn(e, hn(t, n, r));
  }, `configureSvgSize`),
  _n = r(function (e, n, r, i) {
...
`,
  ...
  jn = r(() => Tn, `getAccDescription`),
  Mn = r((e) => {
    wn = En(e);
  }, `setDiagramTitle`),
  Nn = r(() => wn, `getDiagramTitle`),
  Pn = t,
  Fn = e,
  In = jt,
  Ln = At,
  Rn = J,
  zn = r((e) => qt(e, In()), `sanitizeText`),
  Bn = _n,
  Vn = r(() => Sn, `getCommonDb`),
  Hn = {},
  Un = r((e, t, n) => {
    (Hn[e] && Pn.warn(`Diagram with id ${e} already registered. Overwriting.`),
      (Hn[e] = t),
      n && et(e, n),
      bn(e, t.styles),
      t.injectUtils?.(Pn, Fn, In, zn, Bn, Vn(), () => {}));
  }, `registerDiagram`),
  Wn = r((e) => {
...
//# sourceMappingURL=chunk-ICPOFSXX-CC2k9yFo.js.map
