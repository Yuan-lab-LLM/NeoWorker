...
function R(e) {
  ...
  t[0] === r
    ? (o = t[1])
    : ((o = { conversationId: r, enablePullRequestComments: !1 }),
      (t[0] = r),
      (t[1] = o));
  let { commentProps: l } = oe(o),
    u;
  t[2] === n ? (u = t[3]) : ((u = ne(n)), (t[2] = n), (t[3] = u));
  let d = u,
    p;
  t[4] === d ? (p = t[5]) : ((p = i(d)), (t[4] = d), (t[5] = p));
  let m = p,
    g = h(w),
    _ = h(P),
    v = h(ae),
    ...
    { fileCount: T, linesAdded: E, linesDeleted: D } = m,
    O = T <= U && E + D <= W,
    k;
  t[6] === T
    ? (k = t[7])
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = { id: `left`, label: (0, H.jsx)(ue, { className: `icon-xs` }) }),
      (t[14] = M))
    : (M = t[14]);
  let N;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = [
      ...
      (t[15] = N))
    : (N = t[15]);
  let F = g === `unified` ? `left` : `right`,
    L;
  t[16] === a
    ? (L = t[17])
    : ((L = (e) => a.set(w, e === `left` ? `unified` : `split`)),
      (t[16] = a),
      (t[17] = L));
  let R;
  t[18] !== L || t[19] !== F
  ...
  let G = _ ? `ghostActive` : `ghost`,
    K;
  t[24] !== _ || t[25] !== a
    ? ((K = () => a.set(P, !_)), (t[24] = _), (t[25] = a), (t[26] = K))
    : (K = t[26]);
  let q;
  t[27] === _
    ? (q = t[28])
...
function le(e) {
  ...
  return (
    t[3] !== i || t[4] !== r
      ? ((o = (0, H.jsx)(l, { ...r, open: i, onOpenChange: a })),
        (t[3] = i),
        (t[4] = r),
        (t[5] = o))
      : (o = t[5]),
...
function ue(e) {
  ...
  return (
    t[1] === n
      ...
      : ((i = (0, H.jsx)(c, {
          tooltipContent: r,
          children: (0, H.jsx)(A, { className: n }),
        })),
        (t[1] = n),
        (t[2] = i)),
    i
...
//# sourceMappingURL=editor-diff-page-CfNPiG3j.js.map
