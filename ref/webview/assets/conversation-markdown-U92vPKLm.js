...
function T(e, t, n, r) {
  let i = [],
            ...
            }),
    {
      ...
      personalityChangedItems: g,
      forkedFromConversationItems: te,
      modelChangedItems: ne,
      ...
      o == null
        ...
        : e.items.map((e) =>
            e.type === `assistant-message`
              ? { ...e, content: u(e.content, o) }
              : e,
          ),
      e.status,
    );
  for (let e of ne) F(i, E(e, a));
  for (let e of s) F(i, ae(e, a));
  for (let e of _) F(i, E(e, a));
  let D = [];
  for (let e of C(l)) F(D, A(e, a));
  for (let e of d) F(D, E(e, a));
  m != null && F(D, E(m, a));
  for (let e of f) F(D, E(e, a));
  for (let e of C(p)) F(D, A(e, a));
  (v != null && F(D, E(v, a)),
    y != null && F(D, E(y, a)),
    b != null && F(D, E(b, a)));
  for (let e of x) F(D, E(e, a));
...
function H(e) {
  let t = $.exec(e);
  return t?.[1] == null || t[2] == null || !h(t[1])
    ? { lineSuffix: ``, path: e }
...
//# sourceMappingURL=conversation-markdown-U92vPKLm.js.map
