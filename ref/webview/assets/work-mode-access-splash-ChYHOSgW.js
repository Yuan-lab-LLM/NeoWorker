...
import { n as l, t as u } from "./access-splash-Bm3vFTCF.js";
function d(e) {
  let t = (0, f.c)(8),
    { modeToggle: n } = e,
    r;
  t[0] === n
    ...
    : ((r = (0, p.jsx)(a, {
        browser: !0,
        electron: !0,
        children: (0, p.jsx)(c.HeaderAction, {
  ...
  return (
    t[6] === r
      ? (m = t[7])
      : ((m = (0, p.jsxs)(p.Fragment, { children: [r, d] })),
        (t[6] = r),
        (t[7] = m)),
    m
  );
...
//# sourceMappingURL=work-mode-access-splash-ChYHOSgW.js.map
