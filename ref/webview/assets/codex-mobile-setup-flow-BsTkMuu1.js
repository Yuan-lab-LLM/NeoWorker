...
var Se,
  ...
  De = e(() => {
    (b(),
      ...
      (Se = 3e4),
      (Ce = S(F, ({ get: e }) => {
        let t = x(e, `local_remote_control_environment_id`) ?? null,
          n = !e(A, `2055603567`);
        return {
      ...
      (Te = D(F, (e, { get: t }) => {
        let n = x(t, `local_remote_control_environment_id`) ?? null,
          r = !t(A, `2055603567`);
        return {
          enabled: e,
      ...
      (Ee = D(
        ...
        (
          ...
          let o = null,
            ...
            c = !i(A, `2055603567`);
          if (r && t == null)
            o = x(i, `local_remote_control_environment_id`) ?? null;
          else if (r) {
            let e = i(H, t);
...
async function ke(e, t, n) {
  return t === `local`
    ? (await B(`set-local-remote-control-enabled`, { params: { enabled: n } }),
      G(e, n, { force: !0 }))
    : w(e, t, n);
}
var Ae = e(() => {
...
function Pe(e) {
  return e.some((e) => e instanceof T);
}
function Fe(e) {
  switch (e) {
    case `disabled`:
...
function Le(e) {
  let t = (0, Be.c)(76),
    ...
    [d] = fe(_e),
    f = ne(te),
    [p, _] = (0, Q.useState)(n ?? null),
    [v, y] = (0, Q.useState)(null),
    [b] = i(`local_remote_control_client_id`),
    x;
  t[0] !== l || t[1] !== p || t[2] !== f.data
    ? ((x =
        p ??
        Ne({
  ...
  let S = x,
    ...
    w = ne(he),
    oe =
      S === `waiting` && (v == null ? ae?.length : ye(ae, v)) ? `connected` : S,
    se = ne(ie),
    T =
      d === `auto` ? (S === `mfa-required` && se.data ? `allow-host` : oe) : d,
    E;
  t[4] !== T || t[5] !== o || t[6] !== a
    ? ((E = (e) => {
        ce(o, de, { action: e, step: T, surface: a });
      }),
      (t[4] = T),
      (t[5] = o),
      (t[6] = a),
  ...
  (t[8] !== T || t[9] !== o || t[10] !== a
    ? ((O = () => {
        let e = `${a}:${T}`;
        c.current !== e &&
          ((c.current = e), ce(o, ue, { step: T, surface: a }));
      }),
      (k = [T, o, a]),
      (t[8] = T),
      (t[9] = o),
    ...
    (0, Q.useEffect)(O, k));
  let A;
  t[13] === o ? (A = t[14]) : ((A = () => h(o)), (t[13] = o), (t[14] = A));
  let j;
  ...
  t[20] === b
    ? (I = t[21])
    : ((I = (e) => {
        (y(new Set(ve(e, b)?.map(Re))), _(`waiting`));
      }),
      (t[20] = b),
      (t[21] = I));
  let L;
  ...
  t[34] !== C.error ||
  t[35] !== f.error
    ? ((H = Pe([f.error, C.error, w.error, N.error, z.error])),
      (t[31] = z.error),
      (t[32] = N.error),
      (t[33] = w.error),
      (t[34] = C.error),
  ...
  (t[37] !== s || t[38] !== U
    ...
    : ((W = t[39]), (G = t[40])),
    (0, Q.useEffect)(W, G));
  let K = N.isPending || z.isPending || (w.data === `required` && se.isLoading),
    q;
  t[41] !== z.error || t[42] !== z.isError
    ? ((q = z.isError && !u(z.error)),
      (t[41] = z.error),
      (t[42] = z.isError),
      (t[43] = q))
    : (q = t[43]);
  let J = q;
  if ((d === `auto` && p == null && l && f.isLoading) || U) return null;
  if (a === `dialog`) {
    let e;
    t[44] === r
      ? (e = t[45])
...
function ze(e) {
  ...
  t[0] !== u || t[1] !== l
    ? ((f = (e) => {
        ce(u, de, { action: e, step: l, surface: `page` });
      }),
      (t[0] = u),
      (t[1] = l),
      (t[2] = f))
  ...
  t[3] === l
    ? (m = t[4])
    : ((m =
        l === `allow-host` || l === `mfa-required` || l === `waiting`
          ? (0, $.jsx)(V.Header, {
              children: (0, $.jsx)(k, {
                start: (0, $.jsx)(se, {
  ...
  t[10] !== d || t[11] !== p
    ? ((_ = () => {
        (p(`manage_connections`), d(`/settings/connections`));
      }),
      (t[10] = d),
      (t[11] = p),
      (t[12] = _))
  ...
  t[22] !== _
    ? ((v = (0, $.jsx)(Y, {
        onAllowHost: n,
        onContinueOnChatGPT: h,
        onFinishSetup: g,
        onManageConnections: _,
        onSkip: i,
        onStartSetup: a,
        setupInProgress: o,
        showAllowHostError: s,
  ...
  return (
    t[24] !== m || t[25] !== v
      ? ((y = (0, $.jsxs)($.Fragment, { children: [m, v] })),
        (t[24] = m),
        (t[25] = v),
        (t[26] = y))
      : (y = t[26]),
...
//# sourceMappingURL=codex-mobile-setup-flow-BsTkMuu1.js.map
