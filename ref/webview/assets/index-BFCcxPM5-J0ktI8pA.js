...
import {
  ...
  s as a,
  t as o,
} from "./register-BqqwIOLc-BmdQpaTx.js";
function s(e, t) {
  ...
  return function (e, r) {
    i(e, `element`, function (e, i) {
      ...
      let f = C(d, { whitespace: `pre` }),
        p;
      try {
        p = no.renderToString(f, { ...t, displayMode: l, throwOnError: !0 });
      } catch (n) {
        let a = n,
  ...
  ((Pn = [
    ...
    (Rr = function (e, t) {
      function n() {
        ...
        if (A.contains([`widehat`, `widecheck`, `widetilde`, `utilde`], r)) {
          ...
          return { span: q.makeSvgSpan([], [u], t), minWidth: 0, height: s };
        } else {
          var d = [],
            f = Ir[r],
            [p, m, h] = f,
          ...
          for (var x = 0; x < _; x++) {
            var S = new ln(p[x]),
              ...
              ee = q.makeSvgSpan([v[x]], [C], t);
            if (_ === 1) return { span: ee, minWidth: m, height: g };
            ((ee.style.height = N(g)), d.push(ee));
          }
          return {
            span: q.makeSpan([`stretchy`], d, t),
            minWidth: m,
            height: g,
          };
        }
    ...
    (ui = function (e, t, n) {
      var r = Bt[`Size4-Regular`][e.charCodeAt(0)]
        ...
        i = new ln(`inner`, It(e, Math.round(1e3 * t))),
        a = new cn([i], {
          width: N(r),
          height: N(t),
          style: `width:` + N(r),
    ...
    (vi = function (e, t, n, r, i) {
      ...
      return q.makeSvgSpan([`hide-tail`], [s], i);
    }),
    (yi = function (e, t) {
    ...
    (Fi = (e, t) => {
      ...
      if (r === `sout`)
        ...
        var f = Math.floor(1e3 * d * i),
          p = Nt(f),
          m = new cn([new ln(`phase`, p)], {
            width: `400em`,
            height: N(f / 1e3),
            viewBox: `0 0 400000 ` + f,
            preserveAspectRatio: `xMinYMin slice`,
          });
        ((a = q.makeSvgSpan([`hide-tail`], [m], t)),
          (a.style.height = N(d)),
          (o = n.depth + c + l));
      } else {
        /cancel/.test(r)
        ...
        (/box/.test(r)
          ? ((_ = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness)),
            (h = t.fontMetrics().fboxsep + (r === `colorbox` ? 0 : _)),
            (g = h))
          : r === `angl`
            ? ((_ = Math.max(
            ...
            : ((h = s ? 0.2 : 0), (g = h)),
          (a = Br.encloseSpan(n, r, h, g, t)),
          /fbox|boxed|fcolorbox/.test(r)
            ? ((a.style.borderStyle = `solid`), (a.style.borderWidth = N(_)))
            : r === `angl` &&
              _ !== 0.049 &&
              ((a.style.borderTopWidth = N(_)),
              (a.style.borderRightWidth = N(_))),
          (o = n.depth + g),
          e.backgroundColor &&
        ...
        v = q.makeVList(
          {
            ...
            children: [
              { type: `elem`, elem: n, shift: 0 },
              { type: `elem`, elem: a, shift: o, wrapperClasses: y },
            ],
          },
          t,
        );
      ...
      return (
        /cancel/.test(r) && ((v.height = n.height), (v.depth = n.depth)),
        /cancel/.test(r) && !s
          ? q.makeSpan([`mord`, `cancel-lap`], [v], t)
          : q.makeSpan([`mord`], [v], t)
      );
    }),
    (Ii = (e, t) => {
    ...
    (Ua = class {
      ...
      _getExpansion(e) {
        ...
        if (typeof r == `string`) {
          var i = 0;
          if (r.indexOf(`#`) !== -1)
            for (var a = r.replace(/##/g, ``); a.indexOf(`#` + (i + 1)) !== -1;)
              ++i;
          for (
...
//# sourceMappingURL=index-BFCcxPM5-J0ktI8pA.js.map
