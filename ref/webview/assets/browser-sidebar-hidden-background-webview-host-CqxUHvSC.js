...
function k(e) {
  ...
  t[0] === u
    ...
    : ((d = (e) => u.on(`change`, e)),
      ...
      (t[1] = d),
      (t[2] = f));
  let m = (0, R.useSyncExternalStore)(d, f, M),
    h = s(T.tabs$),
    g = s(E),
    _ = s(x),
    v,
  ...
  t[3] === _
    ...
    : ((v = (e) => _.on(`change`, e)),
      ...
      (t[4] = v),
      (t[5] = b));
  let S = (0, R.useSyncExternalStore)(v, b, j),
    C = c(
      r,
      { bottom: i, right: a },
      { bottom: l || m > 0, right: g || S > 0 },
    ),
    D;
  (t[6] === r
    ? (D = t[7])
...
//# sourceMappingURL=browser-sidebar-hidden-background-webview-host-CqxUHvSC.js.map
