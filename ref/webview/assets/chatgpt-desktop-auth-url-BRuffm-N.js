...
function m({
  ...
  loginHint: a,
  sourceSurfaceStableId: o = _.StableID.get(i),
  includeCodexOriginStableId: s = !1,
  useDesktopAuth: c,
  ...
  try {
    let i = new URL(t);
    if (i.pathname === v) {
      let t = i.searchParams.get(`authorize_url`);
      if (u && t) {
        let c = new URL(t);
        (g(c, e, n, r, a, o, s),
          i.searchParams.set(`authorize_url`, c.toString()));
      }
      return (l && i.searchParams.set(S, `true`), i.toString());
    }
    if ((u && g(i, e, n, r, a, o, s), l && i.searchParams.set(S, `true`), !c))
      return i.toString();
    let d = new URL(y);
    return (
      d.searchParams.set(`authorize_url`, i.toString()),
...
//# sourceMappingURL=chatgpt-desktop-auth-url-BRuffm-N.js.map
