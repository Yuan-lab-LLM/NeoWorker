...
function P() {
  ...
  return (
    e[0] === t
      ? (n = e[1])
      : ((n = ce(t) == null ? (0, V.jsx)(d, { to: `/`, replace: !0 }) : null),
        (e[0] = t),
        (e[1] = n)),
    n
  );
...
function F() {
  let e = (0, z.c)(71),
    t = g(ne),
    { authMethod: r, isLoading: i, userId: a } = b(),
    { data: o, isLoading: s } = n(),
    c = u(),
    l;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = { disableExposureLog: !0 }), (e[0] = l))
    : (l = e[0]);
  let p = (0, le.useLayer)(ue, l),
    m = ie(),
    h = ae(),
    _;
  e[1] === h
  ...
  e[6] !== c.pathname || e[7] !== c.search
    ? ((C =
        c.pathname === `/workspace-settings/web`
          ? (ce(new URLSearchParams(c.search))?.accountId ?? null)
          : null),
      (e[6] = c.pathname),
      (e[7] = c.search),
      (e[8] = C))
  ...
  let j = A,
    M = f(Y, S),
    N =
      k != null && M.accountId === k && M.userId === a
        ? M.generation
        : M.generation + 1,
    P = (0, B.useRef)(null),
    F,
  ...
  e[32] !== a
    ? ((R = () => {
      ...
      (e[34] = R))
    : ((L = e[33]), (R = e[34])),
    (0, B.useLayoutEffect)(R, L));
  let H, U;
  (e[35] !== S || e[36] !== O || e[37] !== t || e[38] !== a
    ? ((H = () => {
        let e = O != null && P.current !== O;
        if (((P.current = O), !e)) return;
        let n = t.get(Y, S);
        if (
          n.accountId !== O ||
          n.userId !== a ||
          n.loadState !== `failed` ||
          n.failedAttemptCount < q
        )
          return;
        let r = {
          ...n,
      ...
      (e[40] = U))
    : ((H = e[39]), (U = e[40])),
    (0, B.useLayoutEffect)(H, U));
  let W;
  e[41] !== k || e[42] !== N || e[43] !== S || e[44] !== t || e[45] !== a
    ? ((W = (e) => {
        let n = t.get(Y, S);
        n.accountId !== k ||
          n.generation !== N ||
  ...
  if (
    ...
    e[54] !== t
      ? ((K = () => {
          if (
            M.accountId == null ||
            (O != null && M.loadState !== `failed`) ||
            (M.loadState === `failed` && M.failedAttemptCount >= q)
          )
            return;
          let e = window.setTimeout(
            ...
            M.loadState === `failed`
              ? Math.min(fe * 2 ** Math.max(0, M.failedAttemptCount - 1), pe)
              : de,
          );
          return () => {
    ...
    return (
      e[57] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, V.jsx)(d, { to: `/`, replace: !0 })), (e[57] = t))
        : (t = e[57]),
      t
    );
  }
  ...
  let X = O != null,
    me = !X,
    he = !X,
    ge = !X && `pointer-events-none invisible`,
    Z;
  e[58] === ge
    ? (Z = e[59])
    : ((Z = ee(`fixed inset-0 z-30`, ge)), (e[58] = ge), (e[59] = Z));
  let _e = `${a ?? ``}|${k}|${j ?? ``}|${N}`,
    Q;
  e[60] !== k || e[61] !== G || e[62] !== S || e[63] !== _e || e[64] !== j
    ? ((Q = (0, V.jsx)(
        oe,
        {
          accountId: k,
  ...
  (t[1] !== r || t[2] !== u
    ? ((m = () => {
        ...
        let e = !1,
          ...
          o = (t) => {
            t.isMainFrame !== !1 && (i(), r(`loading`), e || l(!0));
          },
          s = (t) => {
            let n = t;
            if (n.isMainFrame !== !1) {
...
function se({ accountId: e, userId: t }) {
  let n = JSON.stringify([t, e]),
    r = J.get(n);
  return (r ?? ((r = `${S}${crypto.randomUUID()}`), J.set(n, r)), r);
}
function ce(e) {
  let t = H.safeParse(Object.fromEntries(e.entries()));
...
function L(e) {
  return e.origin === U && (e.pathname === G || e.pathname.startsWith(`${G}/`));
}
function R(e) {
  return (
    e != null &&
...
var z, le, B, V, H, U, W, G, ue, de, K, fe, pe, q, J, Y;
e(() => {
  ((z = m()),
    (le = k()),
    M(),
...
export { F as WorkspaceSettingsWebviewHost, P as WorkspaceSettingsWebviewPage };
//# sourceMappingURL=workspace-settings-webview-page-DJrDw-d3.js.map
