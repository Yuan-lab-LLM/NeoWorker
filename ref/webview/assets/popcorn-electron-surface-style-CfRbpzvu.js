...
import { At as j, kt as se } from "./workbook-Bcziiv_P.js";
import {
  $ as ce,
  B as le,
  F as ue,
...
function be(e) {
  let { children: t, id: n, items: r, strategy: a = Ee, disabled: s = !1 } = e,
    {
      active: c,
      dragOverlay: l,
      droppableRects: u,
  ...
  let w = (0, I.useMemo)(
    ...
    [v, m, C.draggable, C.droppable, S, g, y, u, h, a],
  );
  ...
  return (
    o(() => {
      if (!t && n !== c.current && r.current) {
        let e = i.current;
        if (e) {
          let t = x(r.current, { ignoreTransform: !0 }),
            n = {
              x: e.left - t.left,
              y: e.top - t.top,
...
function Se(e) {
  let {
    ...
    S = f.indexOf(o),
    C = (0, I.useMemo)(
      () => ({ sortable: { containerId: p, index: S, items: f }, ...i }),
      [p, i, S, f],
    ),
    w = (0, I.useMemo)(() => f.slice(f.indexOf(o)), [f, o]),
    {
      rect: T,
      node: E,
      isOver: D,
      ...
      resizeObserverConfig: { updateMeasurementsFor: w, ...c },
    }),
    {
      active: O,
      activatorEvent: te,
    ...
    pe = de
      ...
      : null,
    N =
      ge(m) && ge(v) ? a({ id: o, items: f, activeIndex: m, overIndex: v }) : S,
    P = O?.id,
    F = (0, I.useRef)({ activeId: P, items: f, newIndex: N, containerId: p }),
    me = f !== F.current.items,
    he = t({
      active: O,
      containerId: p,
      isDragging: j,
    ...
    _e = xe({ disabled: !he, index: S, node: E, rect: T });
  return (
    (0, I.useEffect)(() => {
      (M && F.current.newIndex !== N && (F.current.newIndex = N),
        p !== F.current.containerId && (F.current.containerId = p),
        f !== F.current.items && (F.current.items = f));
    }, [M, N, p, f]),
    (0, I.useEffect)(() => {
  ...
  function ve() {
    if (_e || (me && F.current.newIndex === S)) return Ne;
    if (!((fe && !ae(te)) || !l) && (M || he))
      return u.Transition.toString({ ...l, property: Me });
  }
}
function Ce(e, t) {
...
function st({
  ...
  return (0, L.jsx)(`div`, {
    "data-testid": s,
    className: m(`pointer-events-none absolute box-border`),
    style: {
      left: e.left,
      top: e.top,
      width: e.width,
...
`),
      ...
      (gn = (0, V.forwardRef)(function (
        ...
        let d = (0, V.useRef)(null),
          ...
          j = _ ? Jt : Yt,
          se = ae == null ? void 0 : ae + (Jt - j) / 2 + qt,
          le = (0, V.useCallback)(
            (e) => {
              if (((d.current = e), k.setFloating(e), typeof u == `function`)) {
                u(e);
                return;
              }
              u && (u.current = e);
        ...
        if (
          ...
          (0, V.useEffect)(() => {
            e && oe?.();
          }, [e?.height, e?.left, e?.top, e?.width, r, _, oe]),
          !e)
        )
          return null;
        let M = (0, H.jsx)(`div`, {
          ...
          style: { position: A, left: ie ?? 0, top: se ?? 0, width: Gt },
          onMouseDown: (e) => {
            e.stopPropagation();
          },
          children: (0, H.jsx)(`form`, {
            ...
            style: $t,
            onSubmit: (e) => {
              (e.preventDefault(), C && o(S ? `saved` : `direct`, `button`));
            },
                      ...
                      children: (0, H.jsx)(`textarea`, {
                        ...
                        onKeyDown: (e) => {
                          ...
                          e.key === `Enter` &&
                            ...
                            e.stopPropagation(),
                            o(
                              S || e.metaKey || e.ctrlKey ? `saved` : `direct`,
                              `keyboard`,
                            ));
                        },
                        ...
                        className: m(
                          Qt,
                          !_ && `!overflow-hidden whitespace-nowrap`,
                        ),
                        style: {
                          fontSize: `var(--codex-chat-font-size, 13px)`,
                          lineHeight: `${Xt}px`,
...
function yn(e) {
  let t = Math.min(wn, Math.max(1, e.containerWidth - U * 2)),
    n = Math.min(e.previewWidth && e.previewWidth > 0 ? e.previewWidth : t, t),
    r = vn(
      e.markerPoint.left - n / 2,
      U,
      Math.max(U, e.containerWidth - n - U),
    ),
    i = e.markerPoint.top - 25 - Cn;
  if (i >= U) return { left: r, top: i, maxWidth: t };
  let a = e.markerPoint.top + 25;
  return a + Cn <= e.containerHeight - U
    ? { left: r, top: a, maxWidth: t }
    : {
        left: r,
        top: vn(i, U, Math.max(U, e.containerHeight - Cn - U)),
        maxWidth: t,
      };
}
function bn({
...
var xn,
  ...
  On = e(() => {
    ((xn = t(l())),
      ...
      (wn = 294),
      (U = 16),
      (Tn = `var(--color-token-dropdown-background, var(--color-token-main-surface-primary, white))`),
      (En = `var(--color-token-foreground, var(--color-token-text-primary, rgb(38, 38, 38)))`),
      (Dn = `var(--color-token-border-default, var(--color-token-border-light, rgba(13, 13, 13, 0.08)))`));
  }),
  kn = e(() => {
    a();
  }),
...
function Hn({ trigger: e, actions: t }) {
  return (0, K.jsxs)(O, {
    children: [
      (0, K.jsx)(p, { asChild: !0, children: e }),
      (0, K.jsx)(E, {
        children: (0, K.jsx)(_, {
...
var K,
  ...
  Kn = e(() => {
    ((Wn = t(l())),
      (Gn = typeof window > `u` ? Wn.useEffect : Wn.useLayoutEffect));
  });
function qn(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function er(e) {
  ...
  return {
    centerX: (n.x + r.x) / 2,
    centerY: (n.y + r.y) / 2,
    distance: Math.max(tr, Math.hypot(i, a)),
  };
}
var tr,
  nr = e(() => {
...
function ar({ open: e, onOpenChange: t, trigger: r, children: i }) {
  return (0, X.jsxs)(C, {
    open: e,
    onOpenChange: t,
    children: [
      (0, X.jsx)(s, { asChild: !0, children: r }),
      (0, X.jsx)(n, {
        children: (0, X.jsx)(w, {
          side: `bottom`,
          align: `end`,
...
function J({ onClick: e, children: t, destructive: n = !1 }) {
...
function lr({
  ...
  let g = o && s != null,
    _ = g && n !== `resolved` && c != null,
    [v, y] = (0, Y.useState)(``),
    [b, x] = (0, Y.useState)(!1),
    [S, C] = (0, Y.useState)(null),
    [w, T] = (0, Y.useState)(``);
  (0, Y.useEffect)(() => {
    S != null && !a.some((e) => e.id === S) && (C(null), T(``));
  }, [a, S]);
  let E = n === `resolved` ? [r, rr(i)].filter(Boolean).join(` · `) : null;
  return (0, X.jsxs)(`div`, {
        ...
        children: [
          (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              E
                ? (0, X.jsx)(`div`, {
                    className: m(`text-token-description-foreground mt-1`, pr),
                    children: E,
                  })
                : null,
            ],
...
function ur({ open: e, onOpenChange: t, trigger: r, content: i }) {
  return (0, X.jsxs)(C, {
    open: e,
    onOpenChange: t,
    children: [
    ...
    (nr(),
      ...
      (Wr = class {
        ...
        zoomTo(e, t) {
          ...
          this.setCamera(
            Yn(this.#p, r, i, e, this.#i.minZoom, this.#i.maxZoom),
            { settled: t?.settled },
          );
        }
        panByScroll(e, t) {
        ...
        #y(e) {
          return this.#i.clampCamera
            ? this.#i.clampCamera({
                ...e,
                k: qn(e.k, this.#i.minZoom, this.#i.maxZoom),
              })
            : Xn(
                { ...e, k: qn(e.k, this.#i.minZoom, this.#i.maxZoom) },
...
//# sourceMappingURL=popcorn-electron-surface-style-CfRbpzvu.js.map
