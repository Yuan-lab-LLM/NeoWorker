...
import { n as De, t as Oe } from "./play-outline-CTUUwJeL.js";
import { n as ke, t as Ae } from "./flask-BQjQDhOP.js";
import { n as je, t as Me } from "./star-BG4IWvX6.js";
var Ne,
  Pe,
  Fe = e(() => {
    ((Ne = [`codex-micro-input-monitoring-permission`]), (Pe = 1e3));
  }),
  U,
  Ie,
  Le = e(() => {
  ...
  Ze = e(() => {
    ((Y = m()),
      ...
      (Xe = {
        ...
        "pointer-outline": Te,
        "pull-request": ve,
        "pull-request-draft": se,
        "pull-request-merged": ae,
        settings: B,
        star: Me,
        terminal: be,
        trash: n,
...
function Qe(e) {
          ...
          ? d.formatMessage(
              {
                ...
                defaultMessage: `No chat or action assigned to agent key {position}`,
  ...
  t[5] === f
    ? (h = t[6])
    : ((h = fe(f).toString(16).padStart(6, `0`)), (t[5] = f), (t[6] = h));
  let g = `#${h}`,
    _ = f === `off`,
    v = c?.selected ? `opacity-40` : `opacity-25`,
    y = c?.selected ? `opacity-55` : `opacity-40`;
  (_ && ((v = `opacity-0`), (y = `opacity-0`)),
    r && ((v = `opacity-45`), (y = `opacity-65`)));
  let b = a == null ? m : void 0,
    x = r && `translate-y-px scale-[0.985]`,
    S;
  t[7] === x
    ? (S = t[8])
    : ((S = V(
      ...
      (t[7] = x),
      (t[8] = S));
  let C = a == null ? `img` : void 0,
    w;
  t[9] !== g || t[10] !== v || t[11] !== r || t[12] !== i || t[13] !== y
    ? ((w =
        i == null
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
          ...
          : (0, Z.jsx)(Je, {
              className: `size-full`,
              children: (0, Z.jsx)(Ye, { keycap: i, className: `size-5` }),
            })),
      (t[9] = g),
      (t[10] = v),
      (t[11] = r),
              ...
              "aria-label": d.formatMessage(
                {
                  ...
                  defaultMessage: `Assign a chat, shortcut, keycap, or skill to agent key {position}`,
  ...
  let L;
  t[34] !== F || t[35] !== I
    ? ((L = (0, Z.jsx)(`span`, { "aria-hidden": !0, className: F, style: I })),
      (t[34] = F),
      (t[35] = I),
      (t[36] = L))
    : (L = t[36]);
  ...
  return (
    t[43] !== O || t[44] !== z
      ? ((B = (0, Z.jsx)(u, { delayOpen: !0, tooltipContent: z, children: O })),
        (t[43] = O),
        (t[44] = z),
        (t[45] = B))
      : (B = t[45]),
...
function nt(e) {
  ...
  return (
    t[3] !== n || t[4] !== i
      ? ((o = (0, $.jsxs)(`div`, { className: i, children: [a, n] })),
        (t[3] = n),
        (t[4] = i),
        (t[5] = o))
      : (o = t[5]),
...
function rt(e) {
  ...
  t[2] === c
    ? (l = t[3])
    : ((l = (0, $.jsx)(`div`, { className: c })), (t[2] = c), (t[3] = l));
  let u =
      i === `counterclockwise` &&
  ...
  t[6] === d
    ? (f = t[7])
    : ((f = (0, $.jsx)(`div`, { className: d })), (t[6] = d), (t[7] = f));
  let p =
      i === `clockwise` &&
      `bg-[#7da8ff]/90 opacity-100 shadow-[0_0_9px_rgba(125,168,255,0.92)]`,
    m;
  ...
  t[10] === m
    ? (h = t[11])
    : ((h = (0, $.jsx)(`div`, { className: m })), (t[10] = m), (t[11] = h));
  let g;
...
function it(e) {
  ...
  return (
    t[4] !== o || t[5] !== c
      ? ((l = (0, $.jsx)(`div`, { className: o, style: c })),
        (t[4] = o),
        (t[5] = c),
        (t[6] = l))
      : (l = t[6]),
...
function at(e) {
  ...
  t[2] === r
    ? (a = t[3])
    : ((a = (0, $.jsx)(it, { className: `size-[72%]`, joystick: r })),
      (t[2] = r),
      (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, $.jsx)(`div`, { className: i, children: a })),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
//# sourceMappingURL=codex-micro-keyboard-surface-Bf8ox4bP.js.map
