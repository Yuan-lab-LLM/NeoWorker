...
function I({ onClose: e, startLogin: t = N, workspaceId: n }) {
  let i = p(O),
    c = _(),
    u = s(),
    d = C(),
  ...
  let y = () => {
    ...
    T = async () => {
      ...
      h(r);
      try {
        let { authUrl: o, completion: s } = await t({
          signal: r.signal,
...
//# sourceMappingURL=business-checkout-switch-workspace-dialog-BLpNplo9.js.map
