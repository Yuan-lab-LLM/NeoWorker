const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./auto-track-CtD7BRzV.js",
      "./rolldown-runtime-BG2f4sTM.js",
      "./esm-Dg7vifPm.js",
      "./app-initial-BHB6SClA.js",
      "./app-initial-Czet5G9g.css",
      "./middleware-Doa7co0W.js",
      "./middleware-D4PmVk-p.js",
      "./query-string-COLLE6Tc.js",
      "./gracefulDecodeURIComponent-DUAwlHZu.js",
      "./routing-middleware-B8BjNZUQ.js",
      "./ajs-destination-Dtfh1U4P.js",
      "./load-script-Cltl04TI.js",
      "./metric-helpers-DPhSwte_.js",
      "./is-plan-event-enabled-BUDpDO9_.js",
      "./legacy-video-plugins-DEhg1jA7.js",
      "./schema-filter-jBXNBlZX.js",
      "./remote-middleware-DRFWEjf6.js",
    ]),
) => i.map((i) => d[i]);
...
import {
  ...
  t as _e,
  u as k,
} from "./metric-helpers-DPhSwte_.js";
import {
  _ as ve,
  a as ye,
  b as be,
  ...
  function d(n) {
    if (n.length !== 0) {
      var r = n[0]?.writeKey,
        a = n.map(function (e) {
          var t = e;
          return (t.sentAt, c(t, [`sentAt`]));
        });
      return ve(`https://${e}/b`, {
        credentials: t?.credentials,
        keepalive: t?.keepalive || i,
        ...
        if (e.status === 429) {
          var t = e.headers?.get(`x-ratelimit-reset`),
            n = typeof t == `string` ? parseInt(t) * 1e3 : s;
  ...
  function h(e, s) {
    return r(this, void 0, void 0, function () {
      ...
      return o(this, function (r) {
        return (
          n.push(s),
          (e = n.length >= a || Jt(n) || (t?.keepalive && Yt(n))),
          [2, e || i ? f() : m()]
        );
      });
    });
...
function ln(e, t, n) {
  ...
  var i = t?.apiKey ?? ``,
    a = e.options.disableClientPersistence
      ...
      : new ge(e.queue.queue.maxAttempts, `${i}:dest-Segment.io`),
    s = new Set(),
    c = !1,
    l = t?.apiHost ?? xe,
    u = t?.protocol ?? `https`,
              ...
              return o(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return (
                      (t = a.sent()),
                      [2, (r = t.link).call.apply(r, i([this], e, !1))]
                    );
                }
              });
            });
              ...
              return o(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return (
                      (t = a.sent()),
                      [2, (r = t.form).call.apply(r, i([this], e, !1))]
                    );
                }
              });
            });
                  ...
                  case 0:
                    return this.options.useQueryString === !1
                      ...
                      : [
                          4,
                          n(
                            () => import(`./query-string-COLLE6Tc.js`),
      ...
      switch (o.label) {
        case 0:
          ...
          ((i = e.url.split(`/`)),
            ...
            (o.label = 1));
        case 1:
          return (o.trys.push([1, 3, , 5]), [4, oe(s.replace(n, r))]);
        case 2:
          return (o.sent(), [3, 5]);
        case 3:
          return (o.sent(), [4, oe(e.url.replace(n, r))]);
        case 4:
          return (o.sent(), [3, 5]);
        case 5:
          return [3, 8];
                  ...
                  switch (o.label) {
                    ...
                    case 3:
                      return (
                        (r = d),
                        r
                          ? ((f = n[e.name]), [4, r(l(l({}, e.settings), f))])
                          : [3, 5]
                      );
                    case 4:
                      ((p = o.sent()),
        ...
        switch (w.label) {
            ...
            return (
              ...
              Vn(t) || l.length > 0
                ? [
                    ...
                    n(
                      () =>
                        import(`./ajs-destination-Dtfh1U4P.js`).then(
                          function (n) {
                      ...
                      __vite__mapDeps([10, 1, 3, 4, 2, 11, 12, 6, 13]),
                      import.meta.url,
                    ),
                  ]
                : [3, 5]
            ...
            return (
              ...
              t.legacyVideoPluginsEnabled
                ? [
                    ...
                    n(
                      () =>
                        import(`./legacy-video-plugins-DEhg1jA7.js`).then(
                          function (e) {
                            return e.loadLegacyVideoPlugins(a);
                          },
                        ),
                      __vite__mapDeps([14, 1, 3, 4]),
                      import.meta.url,
                    ),
                  ]
                : [3, 8]
          ...
          case 8:
            return s.plan?.track
              ? [
                  ...
                  n(
                    () =>
                      import(`./schema-filter-jBXNBlZX.js`).then(function (e) {
                        return e.schemaFilter(s.plan?.track, t);
                      }),
                    __vite__mapDeps([15, 1, 3, 4, 13]),
                    import.meta.url,
                  ),
                ]
              : [3, 10];
          ...
          case 11:
            return (
              ...
              [
                4,
                Nn(t, a.integrations, y, s, p, f).catch(function (e) {
                  return (
          ...
          case 12:
            return (
              ...
              _ && b.push(_),
              (x =
                (s.integrations?.All === !1 && !s.integrations[`Segment.io`]) ||
                (s.integrations && s.integrations[`Segment.io`] === !1)),
              x
                ? [3, 14]
                : ((te = (S = b).push),
                  [4, ln(a, y[`Segment.io`], t.integrations)])
            );
          case 13:
            (te.apply(S, [w.sent()]), (w.label = 14));
          case 14:
            return [4, a.register.apply(a, i(i([], b, !1), d, !1))];
          case 15:
            return ((C = w.sent()), [4, Nt(a, u)]);
          case 16:
            return (
              w.sent(),
              Object.entries(t.enabledMiddleware ?? {}).some(function (e) {
                ...
                ? [
                    ...
                    n(
                      () =>
                        import(`./remote-middleware-DRFWEjf6.js`).then(
                          function (e) {
                            var n = e.remoteMiddlewares;
                            return r(ne, void 0, void 0, function () {
                              var e, r;
                              return o(this, function (i) {
                                switch (i.label) {
                                  case 0:
                                    return [4, n(C, t, s.obfuscate)];
                                  case 1:
                                    return (
                                      (e = i.sent()),
                                      (r = e.map(function (e) {
        ...
        switch (o.label) {
          ...
          case 5:
            return (
              ...
              (t = l({ retryQueue: d }, t)),
              (f = new Z(l(l({}, e), { cdnSettings: s, cdnURL: a }), t)),
              Rn(f),
              (p = e.plugins ?? []),
...
//# sourceMappingURL=pkg-BMKWsTI0.js.map
