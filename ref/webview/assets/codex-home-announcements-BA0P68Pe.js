...
import { n as K, t as q } from "./onboarding-banner-x8BEylhu.js";
import {
  i as Ct,
  n as wt,
  r as Tt,
...
import { n as Dt, t as Ot } from "./app-Cu4w-wb3.js";
import { n as kt, t as At } from "./team-DMlIBqXy.js";
...
async function zt(e, t, n) {
  if (!Ct(e.beacon_id))
    try {
      await _.safePost(`/beacons/event`, {
        requestBody:
          n == null
...
function Ut() {
  let e = (0, Wt.c)(31),
    t = P(W),
    { accountId: r, authMethod: i, isLoading: a, userId: o } = he(),
    { data: s } = n(),
    c = ft(),
    l = L(Yt),
    u = L(wt),
  ...
  if (
    ...
    ((m = r ?? s?.id ?? t ?? o ?? null),
      (h = Lt({ accountId: m, authMethod: i, isAuthLoading: a })),
      (e[0] = r),
      (e[1] = i),
      (e[2] = s?.id),
      (e[3] = a),
  ...
  e[8] === a
    ? (_ = e[9])
    : ((_ = Rt({ isAuthLoading: a })), (e[8] = a), (e[9] = _));
  let v = _,
    y,
    b;
  (e[10] !== m || e[11] !== t || e[12] !== g
    ? ((y = () => {
        (t.set(Kt, m), t.set(qt, g));
      }),
      (b = [m, t, g]),
      (e[10] = m),
      (e[11] = t),
      ...
      (e[14] = b))
    : ((y = e[13]), (b = e[14])),
    (0, Gt.useLayoutEffect)(y, b));
  let x, S;
  (e[15] !== d.data || e[16] !== t
    ? ((x = () => {
        d.data?.accountId != null &&
          d.data.beacon != null &&
          t.set(Xt, { accountId: d.data.accountId, beacon: d.data.beacon });
      }),
      (S = [d.data, t]),
      (e[15] = d.data),
      (e[16] = t),
  ...
  let C =
      d.data?.accountId === m
        ...
        : null,
    w;
  if (e[19] !== l || e[20] !== u || e[21] !== C || e[22] !== m || e[23] !== g) {
    let t = C != null && m != null ? Bt(m, C.beacon_id) : null;
    ((w = null),
      u ? (w = Zt) : g && C != null && t != null && !l.has(t) && (w = C),
      (e[19] = l),
      (e[20] = u),
      (e[21] = C),
      (e[22] = m),
  ...
  $t = e(() => {
    ((Wt = N()),
      ...
      (Qt = ve(W, ({ get: e }) => {
        let t = e(Kt);
        return {
          queryKey: [`codex-app-home-beacon`, t, e(d).locale],
          enabled: e(qt),
          refetchOnMount: !1,
          ...
          queryFn: async () => ({
            accountId: t,
            response: await _.safeGet(`/beacons/home`, {
...
function tn(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    let e = n.action_items.find(rn),
      i = n.action_items.find(nn),
      a = (e) => {
        if (e == null || e.text == null) return;
        let t = r?.[jt({ actionId: e.id, beaconId: n.beacon_id })],
          i = Pt(e);
        if (!(i == null && t == null))
          return {
            label: e.text,
  ...
  let h;
  t[14] !== i || t[15] !== m
    ? ((h = { ariaLabel: m, icon: z, onClick: i }),
      (t[14] = i),
      (t[15] = m),
      (t[16] = h))
    : (h = t[16]);
  ...
  return (
    t[25] !== p || t[26] !== g
      ? ((_ = (0, J.jsx)(`div`, { className: p, children: g })),
        (t[25] = p),
        (t[26] = g),
        (t[27] = _))
      : (_ = t[27]),
...
function cn(e) {
  ...
  let d;
  t[9] !== l || t[10] !== u
    ? ((d = { ariaLabel: l, icon: z, onClick: u }),
      (t[9] = l),
      (t[10] = u),
      (t[11] = d))
    : (d = t[11]);
...
function dn(e) {
  let t = (0, pn.c)(6),
    { platform: n, isLoading: r } = te(),
    { authMethod: i, planAtLogin: a, isLoading: o } = he(),
    s = i === `chatgpt`,
    c = i === `apikey`,
    l = s || c,
    u;
  t[0] === l ? (u = t[1]) : ((u = { enabled: l }), (t[0] = l), (t[1] = u));
  let { data: d, isLoading: f } = Me(u),
    p = i === `copilot`,
    m = n === `macOS`,
    h = d?.plan ?? a,
    g = h === x.FREE || h === x.GO,
...
var pn,
  ...
  gn = e(() => {
    ((pn = N()),
      ...
      ne(),
      (mn = m()),
      (hn = pt(`has-seen-app-upsell-banner`, !1)));
  });
function _n(e) {
  let t = (0, vn.c)(25),
    {
  ...
  let d, f;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, yn.jsx)(Re, { className: `icon-sm text-token-charts-yellow` })),
      (f = (0, yn.jsx)(B, {
  ...
  t[3] !== r || t[4] !== l || t[5] !== o || t[6] !== s || t[7] !== c
    ? ((p = () => {
        r != null &&
          (s(!0),
          V(l, We, {}),
          c(st(r)?.id ?? `priority`, `home_banner`).finally(() => {
            (o(!0), s(!1));
          }));
      }),
      (t[3] = r),
  ...
  t[17] !== a || t[18] !== h || t[19] !== g
    ? ((_ = { ariaLabel: h, icon: z, onClick: g, disabled: a }),
      (t[17] = a),
      (t[18] = h),
      (t[19] = g),
      (t[20] = _))
...
var vn,
  yn,
  bn = e(() => {
    ((vn = N()), St(), I(), R(), K(), tt(), h(), T(), M(), Le(), (yn = m()));
  });
function xn() {
  let e = (0, Sn.c)(19),
    t = P(W),
    n = H(),
    { isServiceTierAllowed: r } = l(),
    { data: i } = Fe(),
    [a, o] = G(Tn),
    { modelSettings: s } = Te(),
    { serviceTierSettings: c, setServiceTier: u } = Je(),
    [d, f] = (0, Cn.useState)(!1),
    p = (0, Cn.useRef)(!1),
    m = i?.models,
    h;
  e[0] !== s.model || e[1] !== m
    ? ((h = Ke(m, s.model, $e)), (e[0] = s.model), (e[1] = m), (e[2] = h))
    : (h = e[2]);
  let g = h,
    _ = r && g != null && !a && c.selectedServiceTier == null && !c.isLoading,
    { estimate: v, estimateStatus: y } = Ge(_),
  ...
  (e[3] !== x || e[4] !== t
    ? ((S = () => {
        !x || p.current || ((p.current = !0), V(t, Qe, {}));
      }),
      (C = [t, x]),
      (e[3] = x),
      (e[4] = t),
    ...
    ? ((w =
        !x || v == null
          ...
          : (0, wn.jsx)(B, {
              ...
              values: {
                savedHours: v.savedHours,
                savedMinutes: v.savedMinutes,
...
var Sn,
  ...
  En = e(() => {
    ((Sn = N()),
      ...
      Ve(),
      (wn = m()),
      (Tn = pt(`has-seen-fast-mode-home-banner`, !1)));
  });
function Dn() {
  let e = (0, kn.c)(5),
    { hostId: t } = S(ot()),
    n = Ce(),
    [r] = G(jn),
    { data: i, isLoading: a } = se(y, t),
    o;
  e[0] === i ? (o = e[1]) : ((o = i?.some(On) ?? !1), (e[0] = i), (e[1] = o));
  let s = o,
    c = n && !r && a,
    l = n && !r && !s,
    u;
...
var kn,
  ...
  Mn = e(() => {
    ((kn = N()),
      ...
      f(),
      (An = `multi_agent`),
      (jn = pt(`has-seen-multi-agent-composer-banner`, !1)));
  });
function Nn(e) {
  let t = (0, Pn.c)(31),
    { onTryNow: n } = e,
  ...
  if (
    (t[1] !== m || t[2] !== r
      ? ((h = () => {
          !m || f.current || ((f.current = !0), V(r, we, {}));
        }),
        (g = [r, m]),
        (t[1] = m),
        (t[2] = r),
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, X.jsx)(B, {
      ...
      (y = (0, X.jsx)(At, { className: `icon-sm` })),
      (b = (0, X.jsx)(B, {
  ...
  t[14] !== l
    ? ((x = () => {
        ...
        (V(r, ze, { action: `try_now` }),
          o.mutateAsync({ featureName: In, enabled: !0 }).finally(() => {
  ...
  let S;
  t[16] !== u || t[17] !== x
    ? ((S = { label: b, onClick: x, disabled: u }),
      (t[16] = u),
      (t[17] = x),
      (t[18] = S))
    : (S = t[18]);
  ...
  t[21] !== r || t[22] !== l
    ...
    : (w = t[23]);
  let T;
  t[24] !== u || t[25] !== C || t[26] !== w
    ? ((T = { ariaLabel: C, icon: z, onClick: w, disabled: u }),
      (t[24] = u),
      (t[25] = C),
      (t[26] = w),
      (t[27] = T))
...
function Rn() {
  ...
  e[0] === n
    ? (i = e[1])
    : ((i = n.get(`desktop_beacon_enabled`, !1)), (e[0] = n), (e[1] = i));
  let a = i,
    [o, s] = G(pe),
    [, c] = G(le),
    l = L(Un),
    [u, d] = (0, Vn.useState)(!1),
    [f] = (0, Vn.useState)(zn),
    [p, m] = (0, Vn.useState)(`loading`);
  if (l != null && p === `loading`) {
    let e = Hn[l.shownCount - 1] ?? 30;
    l.lastShownAtMs == null || f - l.lastShownAtMs >= e * 864e5
      ? m(`eligible`)
      : m(`cooldown`);
  }
  let h = o && l?.lastShownAtMs == null,
    g;
  e[2] !== o || e[3] !== c || e[4] !== s
    ? ((g = () => {
        (d(!0), s(!0), o || c(!0));
  ...
  let x;
  return (
    e[8] !== g || e[9] !== _ || e[10] !== y || e[11] !== b
      ? ((x = { dismiss: g, isEligible: _, isLoading: y, openGiftCredits: b }),
        (e[8] = g),
        (e[9] = _),
        (e[10] = y),
        (e[11] = b),
...
var Bn,
  ...
  Wn = e(() => {
    ((Bn = N()),
      ...
      _e(),
      (Hn = [7, 14, 30]),
      (Un = i(`gift-credits-home-beacon-state`, { shownCount: 0 })));
  });
function Gn(e) {
  let t = (0, qn.c)(19),
  ...
  t[0] === i
    ? (s = t[1])
    : ((s = () => {
        o.current || ((o.current = !0), i.set(Un, Kn));
      }),
      (t[0] = i),
      (t[1] = s));
  let l = (0, Jn.useEffectEvent)(s),
    u;
  t[2] === l
    ? (u = t[3])
    : ((u = () => {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Z.jsx)(B, {
      ...
      (m = (0, Z.jsx)(c, { "aria-hidden": !0, className: `icon-sm` })),
      (h = (0, Z.jsx)(B, {
  ...
  let v;
  t[13] !== n || t[14] !== _
    ? ((v = { ariaLabel: _, icon: z, onClick: n }),
      (t[13] = n),
      (t[14] = _),
      (t[15] = v))
    : (v = t[15]);
...
function Zn({ entries: e }) {
  ...
  return r == null || r.isLoading || !r.isEligible || r.content == null
    ? null
    : (0, tr.jsx)(Qn, { children: r.content });
}
function Qn(e) {
  let t = (0, $n.c)(5),
    { children: n } = e,
  ...
  (t[0] === r
    ...
    : ((i = () => (
      ...
      (t[1] = i),
      (t[2] = a)),
    (0, er.useLayoutEffect)(i, a));
  let o;
  return (
    t[3] === n
      ? (o = t[4])
      : ((o = (0, tr.jsx)(tr.Fragment, { children: n })),
        (t[3] = n),
        (t[4] = o)),
    o
  );
...
function rr(e) {
  ...
  return (
    t[3] !== r || t[4] !== a
      ? ((o = (0, Q.jsx)(ar, { onDismiss: r, onSeeResets: a })),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o))
      : (o = t[5]),
...
function ar(e) {
  ...
  let d;
  t[8] !== n || t[9] !== u
    ? ((d = { ariaLabel: u, icon: z, onClick: n }),
      (t[8] = n),
      (t[9] = u),
      (t[10] = d))
    : (d = t[10]);
...
var or,
  Q,
  sr = e(() => {
    ((or = N()), I(), R(), j(), K(), qe(), h(), me(), M(), (Q = m()));
  });
function cr() {
  let e = (0, lr.c)(13),
    t = P(W),
    { accountId: r, isLoading: i } = he(),
    { data: a, isLoading: o } = n(),
    s = ft(),
    c = L(dr),
    { data: l, isLoading: u } = L(nt),
  ...
  let m = p,
    h;
  e[2] !== a || e[3] !== s
    ? ((h = be(s, { currentAccount: a, disableExposureLog: !0 })),
      (e[2] = a),
      (e[3] = s),
      (e[4] = h))
    : (h = e[4]);
  ...
  e[5] !== r || e[6] !== t
    ? ((y = () => {
        r != null &&
          t.set(dr, (e) => ({ ...e, [r]: { dismissedAtMs: Date.now() } }));
      }),
      (e[5] = r),
      (e[6] = t),
      (e[7] = y))
  ...
  let b =
      ...
      (_ == null || v - _.dismissedAtMs >= ur),
    x = i || o || (l == null && u),
    S;
  return (
    e[8] !== d || e[9] !== y || e[10] !== b || e[11] !== x
      ? ((S = { availableCount: d, dismiss: y, isEligible: b, isLoading: x }),
        (e[8] = d),
        (e[9] = y),
        (e[10] = b),
        (e[11] = x),
...
function pr(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = Be(`empty:hidden`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === n
    ? (a = t[3])
...
function mr(e) {
  ...
  t[7] === l
    ...
    : ((d = (0, $.jsx)(De, {
        extension: !0,
        children: (0, $.jsx)(gr, { shouldHideOnboardingPromos: l }),
      })),
      (t[7] = l),
      (t[8] = d));
  let f;
...
function hr(e) {
  ...
  t[15] !== s.accountId || t[16] !== s.beacon
    ? ((y =
        s.beacon != null && s.accountId != null
          ? (0, $.jsx)(en, { accountId: s.accountId, beacon: s.beacon })
          : null),
      (t[15] = s.accountId),
      (t[16] = s.beacon),
      (t[17] = y))
  ...
  t[26] === l
    ? (D = t[27])
    : ((D = l.content == null ? null : (0, $.jsx)(_n, { ...l })),
      (t[26] = l),
      (t[27] = D));
  let O;
...
function gr(e) {
  ...
  t[11] === a
    ? (g = t[12])
    : ((g = a.content == null ? null : (0, $.jsx)(_n, { ...a })),
      (t[11] = a),
      (t[12] = g));
  let _;
...
export { pr as n, yr as r, mr as t };
//# sourceMappingURL=codex-home-announcements-BA0P68Pe.js.map
