...
async function jt({
  ...
  let { instructions: s } = await _t(`developer-instructions`, {
...
async function Pt(
  ...
  try {
    let o = await jt({
      ...
      hostId: i,
      collaborationMode: a,
      instructionOverrides: ke(
        e.get(ht),
        e.get(je, n) ?? a?.settings.model ?? null,
      ),
    ...
    return (
      ...
      await u?.(o),
      p.openTab(e, t, {
        activate: p.panelId === `bottom` ? e.get(Ze) : e.get(et),
        icon: (0, Z.jsx)(G, { className: `icon-sm` }),
        onClose: () => {
          (l?.(), I(e, n, o), Ft(o).then((e) => c?.(e)));
        },
        onMove: (e, t) => ({
          props: {
            conversationId: o,
...
async function Ft(e) {
  try {
    ...
    return (
      J.warning(`Failed to discard side chat`, {
...
function Ut({
  ...
  pendingWorktree: r,
  onRenamePendingWorktree: i,
  onTogglePendingWorktreePin: o,
  sideChatTab: c,
  cwd: l,
  title: d,
  canPin: p = !0,
  ...
  triggerButtonColor: se = `ghost`,
  triggerIconClassName: ce,
}) {
  let v = ve(gt),
    ue = ge() === ft,
    y = Re(),
    ...
    [De, D] = (0, Q.useState)(null),
    [ke, je] = (0, Q.useState)(null),
    [O, Ie] = (0, Q.useState)(!1),
    A = b(kt, e),
    Ue = b(Ne, Dt(e ?? mt(`missing-conversation`))),
    Ge = we(wt),
    Je = b(bt, e),
    { isPinned: Ye, togglePin: Xe } = Ve(e, { canPin: p }),
    F = r?.isPinned ?? Ye,
    I = () => {
      if (p) {
        if (r != null) {
    ...
    Ze = b(M, `toggleThreadPin`),
    $e = p ? Ze : null,
    et = b(M, `renameThread`),
    L = b(M, `archiveThread`),
    nt = b(M, `copyWorkingDirectory`),
    rt = b(M, `copySessionId`),
    it = b(M, `copyDeeplink`),
    at = b(M, `copyConversationMarkdown`),
    st = b(M, `openSideChat`),
    { canOpenThreadInNewWindow: R, openThreadInNewWindow: ct } = f({
      conversationId: e,
    }),
    z = b(oe, e),
    ut = z.isEligible;
  b(he, e);
  let B = e != null && c != null && !dt(),
    V = b(Tt, e),
    H = yt(Qe),
    U = (t) => {
      if (e == null) return;
      let n =
          Ue ??
          (Je === `projectless` || Ge?.includes(e) === !0 ? null : void 0),
        r =
          ee === `home`
            ? () => {
                (Me(v, `work`),
    ...
    W = (t) => {
      e != null &&
        (async () => {
          ...
          try {
            n = s({
              automations: (await _t(`list-automations`)).items,
              conversationId: e,
              includePausedAutomations: !0,
            });
          } catch (e) {
            J.error(`Error checking heartbeat automation before archive`, {
              safe: {},
              sensitive: { error: e },
            });
          }
    ...
    ht = (t) => {
      if (t != null) {
        We({ scope: v, automationId: t.id, title: t.name });
        return;
      }
      He({
        scope: v,
    ...
    K = () => {
      e == null ||
        ...
        Pt(v, c, {
          ...
          (J.error(`Error opening side chat`, {
            safe: {},
            sensitive: { error: e },
          }),
            v.get(ye).danger(
  ...
  if (
    ...
    ae(`openSideChat`, K, { enabled: e != null && B }),
    P(
      `rename-thread`,
      () => {
        (e == null && r == null) || D(d ?? ``);
    ...
    return null;
  let q = l != null && (_ || Ue?.repositoryData != null),
    vt = async () => {
      if (e == null) return;
      Le(v, Te, {
        destination: _
          ? S.CODEX_THREAD_FORK_DESTINATION_SAME_WORKTREE
          : S.CODEX_THREAD_FORK_DESTINATION_LOCAL,
        source: h.CODEX_THREAD_FORK_SOURCE_THREAD_OVERFLOW_MENU,
      });
      let t = await Pe(v, { sourceConversationId: e, sourceWorkspaceRoot: l });
      t != null && T(`/local/${t}`);
    },
    St = async () => {
      if (e == null) return;
      Le(v, Te, {
        destination: S.CODEX_THREAD_FORK_DESTINATION_NEW_WORKTREE,
        source: h.CODEX_THREAD_FORK_SOURCE_THREAD_OVERFLOW_MENU,
      });
      let t = await ze(v, {
        localEnvironmentSelectionsByWorkspace: H,
        sourceConversationId: e,
        sourceWorkspaceRoot: l,
      });
      t != null && l != null && T(`/local/${t.clientThreadId}`);
    },
    Y = () => {
      Se != null && (E(!1), U(Se));
    },
    Ct = F ? u : Ae,
    Et = y.formatMessage(N.moreActions),
    Ot = (0, $.jsx)(k, { ...Ct }),
    At = ce ?? `icon-sm`,
    jt = e != null && !m && !0,
    Mt = R,
    X = z.reason === `turn_in_progress`;
  return (0, $.jsxs)($.Fragment, {
    children: [
      e == null ? null : (0, $.jsx)(Bt, { enabled: p, onToggle: I }),
      (0, $.jsxs)(re, {
        open: O,
        onOpenChange: Ie,
        triggerButton: (0, $.jsx)(ot, {
          size: `icon`,
          color: se,
          className: ie ?? `no-drag`,
          "aria-label": Et,
          children: (0, $.jsx)(le, { className: At }),
        }),
        align: ne,
        contentWidth: `menu`,
        children: [
          ...
          (0, $.jsx)(j.Item, {
            ...
            LeftIcon: g,
            keyboardShortcut: et,
            children: (0, $.jsx)(k, { ...N.renameThread }),
          }),
          e == null
            ? null
            : (0, $.jsx)(j.Item, {
                ...
                LeftIcon: de,
                keyboardShortcut: L,
                children: (0, $.jsx)(k, { ...N.archiveThread }),
              }),
          (0, $.jsx)(j.Separator, {}),
          null,
          B
          ...
          (0, $.jsxs)(j.FlyoutSubmenuItem, {
            ...
            children: [
              (0, $.jsx)(j.Item, {
                ...
                keyboardShortcut: nt,
                disabled: !l,
                children: (0, $.jsx)(k, { ...N.copyWorkingDirectory }),
              }),
              e == null
                ? null
                : (0, $.jsxs)($.Fragment, {
                    children: [
                      (0, $.jsx)(j.Item, {
                        ...
                        LeftIcon: a,
                        keyboardShortcut: rt,
                        children: (0, $.jsx)(k, { ...N.copySessionId }),
                      }),
                      (0, $.jsx)(j.Item, {
                        onSelect: () => me(e),
                        LeftIcon: a,
                        keyboardShortcut: it,
                        children: (0, $.jsx)(k, { ...N.copyAppLink }),
                      }),
                    ],
                  }),
              e != null && t != null
                ? (0, $.jsx)(j.Item, {
                    ...
                    LeftIcon: a,
                    keyboardShortcut: at,
                    children: (0, $.jsx)(k, { ...N.copyConversationMarkdown }),
                  })
                : null,
            ],
          }),
                ...
                children: [
                  ...
                  !ue && q
                    ? (0, $.jsx)(j.Item, {
                        ...
                        LeftIcon: _e,
                        children: (0, $.jsx)(k, { ...N.forkIntoWorktree }),
                      })
                    : null,
                ],
              })
          ...
          Mt ? (0, $.jsx)(j.Separator, {}) : null,
          R
            ? (0, $.jsx)(j.Item, {
                onSelect: ct,
                LeftIcon: tt,
                children: (0, $.jsx)(k, { ...N.openInNewWindow }),
              })
            : null,
        ],
      }),
      De == null
        ...
        : (0, $.jsx)(Be, {
            ...
            onSave: (t) => {
              ...
              e != null && pe({ conversationId: e, title: t });
            },
          }),
      be &&
        (0, $.jsx)(xe, {
...
function Wt(e) {
  ...
  let l = c,
    u = l != null;
  if (!(u || n || a)) return null;
  let d;
  t[3] !== l || t[4] !== i
    ? ((d = () => i(l)), (t[3] = l), (t[4] = i), (t[5] = d))
    : (d = t[5]);
  let f = !u && !n,
    p = u ? N.editAutomation : N.addAutomation,
    m;
  t[6] === p
    ? (m = t[7])
    : ((m = (0, $.jsx)(k, { ...p })), (t[6] = p), (t[7] = m));
  let h;
  return (
    t[8] !== d || t[9] !== f || t[10] !== m
      ? ((h = (0, $.jsx)(j.Item, {
...
//# sourceMappingURL=thread-overflow-menu-CHu-muVE.js.map
