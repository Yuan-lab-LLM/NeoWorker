...
import { r as _, t as v } from "./codex-micro-joystick-feedback-CRZ9dV-Q.js";
import { n as y, t as ne } from "./codex-micro-analog-action-title-D3332W-9.js";
function b() {
  let e = (0, S.c)(4),
    t = c(v),
    n = c(l),
...
function x(e) {
  let n = (0, S.c)(72),
    ...
    o = te(),
    s = r.visible && !i,
    c = r.event.angle * Math.PI * 2,
    l = Math.min(r.event.distance, 1) * 13,
    u = r.status === `game-gesture`,
    d = u
      ? (r.gameActivationProgress ?? 0)
      : Math.min(r.event.distance / 0.5, 1),
    m;
  n[0] !== r.action || n[1] !== o || n[2] !== u || n[3] !== a
    ? ((m = u
        ? (0, C.jsx)(f, { ...w.miniGameTitle })
        : r.action == null
          ? (0, C.jsx)(f, {
  ...
  let h = m,
    g = w[r.status];
  r.status === `tracking` && r.action == null && (g = w.unassignedTracking);
  let _ = r.status === `triggered`,
    v = r.status === `unavailable`,
    y = _ || u,
    b = !s,
    x = s ? `translate-y-0 opacity-100` : `-translate-y-1 opacity-0`,
    T;
  n[5] === x
    ? (T = n[6])
    : ((T = p(
  ...
  let ae = r.status,
    ...
    se = v && `border-token-editor-warning-foreground/35`,
    ce = !y && !v && `border-token-border`,
    E;
  n[7] !== oe || n[8] !== se || n[9] !== ce
    ? ((E = p(
  ...
  n[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, C.jsx)(`div`, {
      ...
      (n[14] = k),
      (n[15] = A))
    : ((O = n[13]), (k = n[14]), (A = n[15]));
  let j =
      y &&
      `bg-token-text-link-foreground shadow-[0_0_9px_rgba(91,141,235,0.72)]`,
    M = v && `bg-token-editor-warning-foreground`,
    N = !y && !v && `bg-token-foreground`,
    P;
  n[16] !== j || n[17] !== M || n[18] !== N
    ? ((P = p(
      ...
      (n[19] = P))
    : (P = n[19]);
  let F = `translate(${Math.cos(c) * l}px, ${Math.sin(c) * l}px)`,
    I;
  n[20] === F
    ? (I = n[21])
    : ((I = { transform: F }), (n[20] = F), (n[21] = I));
  let L;
  n[22] !== P || n[23] !== I
    ? ((L = (0, C.jsx)(`div`, { className: P, style: I })),
      (n[22] = P),
      (n[23] = I),
      (n[24] = L))
    : (L = n[24]);
  let R;
  n[25] !== D || n[26] !== L
    ? ((R = (0, C.jsxs)(`div`, { className: D, children: [O, k, A, L] })),
      (n[25] = D),
      (n[26] = L),
      (n[27] = R))
    : (R = n[27]);
  let z;
  n[28] !== r.direction || n[29] !== u
    ? ((z = (0, C.jsx)(`div`, {
        className: `flex items-center gap-1.5 text-[11px] font-medium text-token-text-tertiary`,
        children: u
          ? (0, C.jsx)(f, { ...w.gameGesture })
          : (0, C.jsxs)(C.Fragment, {
              children: [
                (0, C.jsx)(t, {
                  className: p(`size-3 shrink-0`, re[r.direction]),
                }),
                (0, C.jsx)(`span`, {
                  children: (0, C.jsx)(f, { ...w[r.direction] }),
                }),
              ],
            }),
      })),
  ...
  n[33] === V
    ? (H = n[34])
    : ((H = p(`flex min-h-4 items-center gap-1.5 text-xs`, V)),
      (n[33] = V),
      (n[34] = H));
  let U;
  n[35] === _
    ? (U = n[36])
    : ((U = _
        ? (0, C.jsx)(ee, { className: `size-3 shrink-0` })
        : (0, C.jsx)(`span`, {
      ...
      (n[36] = U));
  let W;
  n[37] !== o || n[38] !== u || n[39] !== d
    ? ((W = u ? { progress: o.formatNumber(d, { style: `percent` }) } : void 0),
      (n[37] = o),
      (n[38] = u),
      (n[39] = d),
      (n[40] = W))
  ...
  let G;
  n[41] !== g || n[42] !== W
    ? ((G = (0, C.jsx)(f, { ...g, values: W })),
      (n[41] = g),
      (n[42] = W),
      (n[43] = G))
    : (G = n[43]);
  let K;
  n[44] !== H || n[45] !== U || n[46] !== G
    ? ((K = (0, C.jsxs)(`div`, {
        "aria-atomic": `true`,
        "aria-live": `polite`,
        className: H,
      ...
      (n[47] = K))
    : (K = n[47]);
  let q = y && `bg-token-text-link-foreground`,
    ue = v && `bg-token-editor-warning-foreground`,
    de = !y && !v && `bg-token-text-tertiary/55`,
    J;
  n[48] !== q || n[49] !== ue || n[50] !== de
    ? ((J = p(
  ...
  n[57] !== z || n[58] !== B || n[59] !== K || n[60] !== X
    ...
    : (Z = n[61]);
  let Q;
  n[62] !== R || n[63] !== Z || n[64] !== E
    ? ((Q = (0, C.jsxs)(`div`, { className: E, children: [R, Z] })),
      (n[62] = R),
      (n[63] = Z),
      (n[64] = E),
      (n[65] = Q))
...
export { b as CodexMicroJoystickHud };
//# sourceMappingURL=codex-micro-joystick-hud-D4b-r5jK.js.map
