...
function V() {
  let e = (0, U.c)(48),
    ...
    c = d(h),
    u = i(),
    p = a == null || k(`${r.pathname}${r.search}`, a.originPath, S(s, c));
  if (
    a == null ||
    !p ||
    (a.request.source === `composer_button_existing_thread` &&
      a.phase !== `failed`)
  )
    return null;
  if (a.phase === `failed`) {
    ...
    e[3] === r
      ...
      : ((i = (0, W.jsxs)(`div`, {
        ...
        (e[4] = i));
    let o;
    e[5] !== a.originPath || e[6] !== a.request || e[7] !== n
      ? ((o = () => {
          y(n, a.request, a.originPath).catch(H);
        }),
        (e[5] = a.originPath),
        (e[6] = a.request),
        (e[7] = n),
  ...
  let m =
      s.phase === `active` && s.preferredPresentationSurface === `main-thread`,
    _ = a.phase === `connected` && a.handoffComplete,
    b = +!_,
    C;
  e[23] === b ? (C = e[24]) : ((C = { opacity: b }), (e[23] = b), (e[24] = C));
  let w;
  e[25] !== _ || e[26] !== a.request || e[27] !== n
    ? ((w = () => {
        _ && t(n, a.request);
      }),
      (e[25] = _),
  ...
  let V = !m,
    G;
  e[32] !== a.request || e[33] !== n
    ? ((G = () => f(n, a.request)),
      (e[32] = a.request),
      (e[33] = n),
      (e[34] = G))
    : (G = e[34]);
  let K = s.phase === `inactive` ? `starting` : s.phase,
    q = s.phase === `inactive` ? `idle` : s.activity,
    J;
  e[35] !== q || e[36] !== K
    ? ((J = (0, W.jsx)(A, {
...
//# sourceMappingURL=realtime-voice-launch-surface-D0L5DoPz.js.map
