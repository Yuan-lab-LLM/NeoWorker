...
import { n as We, t as Ge } from "./settings-row-disclosure-NtnSBbIg.js";
function Ke(e) {
  let t = (0, Xe.c)(27),
    {
      isImportContextLoading: r,
      latestSuccessfulImportAtMs: i,
      workspaceRoots: o,
    } = e,
    s = T(xe),
    l = ie(),
    ...
    p = n(de),
    m;
  t[0] === p ? (m = t[1]) : ((m = te(p)), (t[0] = p), (t[1] = m));
  let h = m,
    g = Be(),
    _;
  t[2] !== h || t[3] !== g || t[4] !== o
  ...
  let {
      ...
      unsupportedProjects: w,
    } = he(_),
    E = v.length === 0 ? null : we(l, v),
    D = Oe(y),
    O = d?.hostId === J,
    k =
      O && d != null
        ? me({ detectedItems: d.items, intl: l, providerIds: Oe(d.items) })
        : null,
    A = b || r,
    j;
  t[6] === l ? (j = t[7]) : ((j = (e) => C(l, e)), (t[6] = l), (t[7] = j));
  let N = (0, Y.jsx)(ee, { type: `conjunction`, value: D.map(j) }),
    P = () => {
      E != null &&
        (re(s, c, { source: `settings`, action: `shown`, ...fe(E, Ae(E), D) }),
        pe(s, {
          hostId: J,
          items: y,
          restoreFocus: () => u.current?.focus(),
          sessionLimits: g,
          source: `settings`,
        }));
    },
      ...
      ? (0, Y.jsx)(B, {
          ...
          description:
            k == null
              ...
              : (0, Y.jsx)(ee, {
                  type: `unit`,
                  value: k.customizeItems.map(Ye),
                }),
          control: (0, Y.jsx)(ue, { className: `icon-xs` }),
        })
      : A
        ? (0, Y.jsx)(B, {
            label: (0, Y.jsx)(L, {
                      ...
                      : (0, Y.jsx)(L, {
                          ...
                          values: {
                            relativeTime: (0, Y.jsx)(
                              le,
                              { dateString: new Date(i).toISOString() },
                              `last-imported-at`,
                            ),
                          },
                        }),
  ...
  t[11] !== A || t[12] !== x || t[13] !== w
          ...
          ? (0, Y.jsx)(B, {
              ...
              description: (0, Y.jsx)(L, {
                ...
                values: {
                  ...
                  projects: (0, Y.jsx)(
                    ee,
                    { type: `conjunction`, value: w.map(qe) },
    ...
    : (z = t[14]);
  let V;
  t[15] !== se || t[16] !== z || t[17] !== ce
    ? ((V = (0, Y.jsxs)(se, { children: [ce, z] })),
      (t[15] = se),
      (t[16] = z),
      (t[17] = ce),
      (t[18] = V))
    : (V = t[18]);
  let U;
  t[19] !== V || t[20] !== oe.Content
    ? ((U = (0, Y.jsx)(oe.Content, { children: V })),
      (t[19] = V),
      (t[20] = oe.Content),
      (t[21] = U))
    : (U = t[21]);
  let W;
  return (
    t[22] !== I || t[23] !== U || t[24] !== ae || t[25] !== R
      ? ((W = (0, Y.jsxs)(I, { id: ae, children: [R, U] })),
        (t[22] = I),
        (t[23] = U),
        (t[24] = ae),
        (t[25] = R),
...
function $e(e) {
  ...
  if (t[0] !== n.itemType || t[1] !== r.failures || t[2] !== r.successes) {
    ...
    t[7] === n.itemType
      ? (o = t[8])
      : ((o = (e) => e.itemType === n.itemType),
        (t[7] = n.itemType),
        (t[8] = o));
    let c = r.failures.filter(o),
      l;
    (t[9] === n.itemType
      ? (l = t[10])
      : ((l = (e, t) =>
  ...
  let l;
  return (
    t[16] !== a || t[17] !== s || t[18] !== c
      ? ((l = (0, X.jsxs)(X.Fragment, { children: [a, s, c] })),
        (t[16] = a),
        (t[17] = s),
        (t[18] = c),
        (t[19] = l))
                ...
                r(o, {
                  state:
                    e.itemType === `SKILLS` || e.itemType === `COMMANDS`
                      ? { initialHostId: J, initialTab: `skills` }
                      : void 0,
                });
              },
              children:
...
function tt(e, t, n) {
  return e === `SKILLS` || e === `COMMANDS` || e === `MCP_SERVER_CONFIG`
    ? `${e === `MCP_SERVER_CONFIG` ? `/settings/mcp-settings` : `/skills`}?search=${encodeURIComponent(n ?? t)}`
    : e === `SESSIONS` && n != null
      ? se(Te(n))
      : e === `PLUGINS`
        ? R({ hostId: J, pluginId: n ?? t })
        : null;
}
var nt,
  X,
  rt = e(() => {
    ((nt = w()), Ee(), P(), i(), ge(), W(), F(), je(), ze(), (X = d()));
  });
function it(e) {
  let t = (0, Z.c)(6),
  ...
  if (t[0] !== r || t[1] !== n.items) {
    ...
    (t[4] === r
      ...
      : ((o = (e) =>
        ...
        (t[4] = r),
        (t[5] = o)),
      (i = (0, Q.jsxs)(H, { children: [a, e.map(o)] })),
      (t[0] = r),
      (t[1] = n.items),
      (t[2] = i));
  } else i = t[2];
...
function ot(e) {
  let t = (0, Z.c)(33),
    ...
    c;
  t[0] !== r || t[1] !== i
    ? ((c = A({ histories: [r], mcpServerStatuses: i })),
      (t[0] = r),
      (t[1] = i),
      (t[2] = c))
    : (c = t[2]);
  ...
  t[13] === w
    ? (T = t[14])
    : ((T = (0, Q.jsx)(Me, { "aria-hidden": !0, className: w })),
      (t[13] = w),
      (t[14] = T));
  let D;
  t[15] === p
  ...
  t[22] !== S
    ...
    : (O = t[23]);
  let k;
  t[24] !== v || t[25] !== g || t[26] !== f || t[27] !== O || t[28] !== y
    ? ((k = (0, Q.jsx)(v, {
        contentId: g,
        expanded: f,
        content: y,
...
function dt(e) {
  ...
  t[0] !== n.itemType || t[1] !== a || t[2] !== o
    ? ((l =
        n.itemType === `MCP_SERVER_CONFIG`
          ? A({ histories: [a], mcpServerStatuses: o }).length
          : 0),
      (t[0] = n.itemType),
      (t[1] = a),
      (t[2] = o),
  ...
  t[4] !== n.itemType || t[5] !== c
    ? ((d = Se(c, n.itemType)), (t[4] = n.itemType), (t[5] = c), (t[6] = d))
    : (d = t[6]);
  let f;
  ...
  t[19] === _
    ? (v = t[20])
    : ((v = (0, Q.jsx)(h, { className: _ })), (t[19] = _), (t[20] = v));
  let y;
...
function ht() {
  let e = (0, yt.c)(41),
    t = N(),
    { data: n, isLoading: r } = M(ke),
    i = M(y),
    o = M(m),
    [s, c] = (0, bt.useState)(!1),
    l = M(a),
    { data: u, error: d, isLoading: f, refetch: h } = x(Fe, J),
    { data: g, error: _, isLoading: b, refetch: S } = x(v, J),
    C;
  if (
    e[0] !== o ||
    e[1] !== i ||
    ...
    let a = p({
        histories: (u == null || s ? u : u.slice(0, xt)) ?? [],
        runningImport: l?.hostId === `local` ? l : null,
      }),
      m = u != null && u.length > xt && !s,
      v;
    e[16] === u ? (v = e[17]) : ((v = u?.find(vt)), (e[16] = u), (e[17] = v));
    let y = v,
      x,
      w,
      T,
    ...
    if (
      ...
      let a = A({ histories: u ?? [], mcpServerStatuses: g?.data ?? [] }),
        s = (u?.some(gt) ?? !1) && (b || _ != null);
      ((x = ye),
        e[35] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((w = (0, $.jsx)(oe, { slug: `import` })), (e[35] = w))
          : (w = e[35]),
        e[36] === Symbol.for(`react.memo_cache_sentinel`)
          ...
          : (T = e[36]));
      let c = r || o || f,
        l = y == null ? null : Number(y.completedAtMs),
        d = n == null ? void 0 : i;
      (e[37] !== c || e[38] !== l || e[39] !== d
        ? ((E = (0, $.jsx)(Ke, {
        ...
        (e[33] = E),
        (e[34] = D));
    } else ((x = e[30]), (w = e[31]), (T = e[32]), (E = e[33]), (D = e[34]));
    ((C = (0, $.jsxs)(x, {
      title: w,
      subtitle: T,
      children: [
                    ...
                    a.map((e) =>
                      (0, $.jsx)(
                        it,
                        {
                          defaultExpanded:
                            e.kind === `completed` &&
                            e.history.importId === u?.[0]?.importId,
                          entry: e,
                          mcpServerStatuses: g?.data ?? [],
                        },
                        e.kind === `running`
...
//# sourceMappingURL=import-settings-B8R-6DPp.js.map
