...
import {
  ...
  r as jt,
  t as Mt,
} from "./worktree-environment-dropdown-CVYFSALu.js";
import {
  a as Nt,
  i as Pt,
  n as Ft,
...
function zt(e) {
  let t = (0, Bt.c)(40),
    ...
    u = F(Ve),
    d;
  t[0] !== l.cwd || t[1] !== l.hostConfig
    ? ((d = l.cwd == null ? null : { cwd: l.cwd, hostConfig: l.hostConfig }),
      (t[0] = l.cwd),
      (t[1] = l.hostConfig),
      (t[2] = d))
    : (d = t[2]);
  ...
  t[3] === u
    ? (f = t[4])
    : ((f = { retainRepoWatch: u }), (t[3] = u), (t[4] = f));
  let { data: p, isLoading: m } = Qe(
      d,
      `cloud_follow_up_local_remote_dropdown`,
      f,
    ),
    h = p?.root != null,
    g = a?.type === `cloud` && a.hasAppliedCodeLocally,
    _,
    v;
  (t[5] !== g || t[6] !== i
    ? ((_ = () => {
  ...
  t[17] === n
    ...
    : ((T =
        n === `cloud`
          ? (0, K.jsx)(He, { className: `icon-xs` })
          : (0, K.jsx)(et, { className: `icon-xs` })),
      (t[17] = n),
      (t[18] = T));
  let E;
  t[19] !== C || t[20] !== T
  ...
  t[26] !== D || t[27] !== O
    ...
    : (A = t[28]);
  let j;
  t[29] !== n || t[30] !== h || t[31] !== r
    ? ((j = h
        ? (0, K.jsx)(V.Item, {
            LeftIcon: He,
            RightIcon: n === `cloud` ? ft : void 0,
            onClick: () => {
              (r(`cloud`), c(!1));
            },
            children: (0, K.jsx)(B, { ...q.cloud }),
          })
        : null),
      (t[29] = n),
      (t[30] = h),
...
function Ut(e) {
  ...
  t[0] === n
    ...
    : ((o =
        n === `working-tree`
          ? (0, Y.jsx)(B, { ...X.workingTree })
          : (0, Y.jsx)(B, { ...X.directFollowUp })),
      (t[0] = n),
      (t[1] = o));
  let s = o,
    c;
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Y.jsx)(me, { className: `icon-xs` })), (t[4] = d))
    : (d = t[4]);
  let f;
  t[5] === u
    ? (f = t[6])
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, Y.jsx)(B, {
      ...
      (t[10] = m))
    : (m = t[10]);
  let ee = n === `working-tree` ? ft : void 0,
    h;
  t[11] === r
    ? (h = t[12])
    : ((h = () => {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Y.jsx)(B, { ...X.workingTree })), (t[13] = g))
    : (g = t[13]);
  let _;
  t[14] !== h || t[15] !== ee
    ? ((_ = (0, Y.jsx)(b, {
        tooltipContent: m,
        children: (0, Y.jsx)(V.Item, {
          LeftIcon: Wt,
          RightIcon: ee,
          onClick: h,
          children: g,
      ...
      (t[16] = _))
    : (_ = t[16]);
  let v = n === `direct-follow-up` ? ft : void 0,
    y;
  t[17] === r
    ? (y = t[18])
    : ((y = () => {
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Y.jsx)(B, { ...X.directFollowUp })), (t[19] = x))
    : (x = t[19]);
  let S;
  t[20] !== v || t[21] !== y
    ? ((S = (0, Y.jsx)(V.Item, {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, Y.jsx)(wt, {
          ...
          children: (0, Y.jsx)(me, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
var Jt,
  ...
  Xt = e(() => {
    ((Jt = M()),
      ...
      Me(),
      (Z = f()),
      (Yt = De(rt, `has-custom-cli-executable`, {
        staleTime: ze.FIVE_SECONDS,
      })));
  });
function Zt({
  variant: e,
  ...
  worktreeEnvironmentHostId: a,
  worktreeEnvironmentWorkspaceRoot: o,
  codexHome: c,
  homeAuxiliaryControl: l,
  showRuntimeControls: f,
  hideRunLocationDropdown: m,
  showWorkspaceDropdown: _,
  gitRootForStartingState: te,
  showUtilityBarBranchWhen: ne,
  freeUpsellButton: x,
  remoteConfig: S,
  activeProjectIdOverride: T,
  ...
  let L = A(Be, I),
    ...
    we = A(en, I),
    De = P != null || we,
    ke = S.currentHostId ?? `local`,
    Ae = d({
      composerMode: t,
      draftRemoteHostId: ke,
      followUpType: P?.type,
      hasStartedBranchConversation: we,
    }),
    H = Ae ? ke : Se,
    Me = !Ae && H !== `local`,
    Ne = A(_t, I),
    { data: Ie } = g(v.THREAD_PROJECT_ASSIGNMENTS),
    Le = Fe({ cwd: Ne, assignment: I == null ? void 0 : Ie?.[I] }),
    Re = nt(z.hostId) ?? c,
    U = u(Le, Re),
    ze = u(D?.workspaceRoot, Re),
    He = e === `home`,
    We = i(`1115442235`),
    qe = U,
    Xe = A(he, I),
    Ze = xe(),
    $e = Ze.find((e) => e.hostId === H) ?? null,
    tt = H === `local` ? null : Me ? z.cwd : S.getProjectPathForHostId(H),
    rt = Ze.find((e) => e.hostId === S.currentHostId) ?? null,
    ot = S.getProjectPathForHostId(S.currentHostId),
    st = (0, Q.useMemo)(
      () => ({
        isAttachedToStartedTask: De,
        existingRemoteThreadState: {
          hostId: H,
          connectionDisplayName:
            H === `local` ? null : ($e?.displayName ?? null),
          projectPath: tt,
        },
        draftNewThreadRemoteSelectionState: {
          hostId: S.currentHostId,
          connectionDisplayName: rt?.displayName ?? null,
          projectPath: ot,
        },
      }),
      [$e?.displayName, tt, De, S.currentHostId, H, rt?.displayName, ot],
    ),
    W = z.hostConfig,
    ct =
      A(gt, { hostConfig: W, operationSource: `composer_content` }).data
        ?.available === !0 &&
      ge &&
      !R
        ? z.cwd
        : null,
    { data: lt, isLoading: ut } = Qe(
      ct == null ? null : { cwd: ct, hostConfig: W },
      `composer_content`,
      { enabled: !0, retainRepoWatch: F(Ve), watchForGitInit: !1 },
    ),
    {
      canCreateGitRepository: dt,
      createGitRepository: ft,
      isCreatingGitRepository: pt,
    } = mt({ cwd: ct, hostConfig: W, showErrorToast: !0 }),
    ht = ct != null && lt != null,
    G = ge && ht && lt?.root == null,
    yt = !dt || pt || !ht || ut,
    bt = G ? null : x,
    xt = t === `worktree`,
    {
      ...
      repairConfigPath: At,
      updateSelection: Nt,
    } = Ue({ hostId: a, workspaceRoot: xt ? o : null }),
    Pt =
      !P && xt
        ? (0, $.jsx)(Mt, {
            environments: wt,
            ...
            onOpenSettings: (e) => {
              if ((St(k, a), e == null)) {
                let e = new URLSearchParams({ workspaceRoot: o });
                oe(`/settings/local-environments?${e.toString()}`);
                return;
              }
              oe(Ke({ configPath: e, workspaceRoot: o }), {
                state: {
                  hostId: a,
      ...
      !P && (t === `cloud` || t === `worktree`)
        ? (0, $.jsx)(Ce, {
            ...
            children: (0, $.jsx)(Dt, {
              startingState: se,
              setStartingState: (e) => {
                vt(k, `asyncThreadStartingState`, e);
              },
              hostConfig: W,
              gitRootOverride: te,
    ...
    Bt = (0, Q.useMemo)(
      () =>
        We && be({ isCompactWindow: fe }) && I != null && z.cwd != null
          ? { conversationTitle: Xe, cwd: O(z.cwd), isWorktreeConversation: U }
          : null,
      [I, Xe, z.cwd, fe, U, We],
    ),
    Vt = I != null && H !== `local` && V?.role === `follower`,
    K = (ne === `always` || t === `local`) && !Vt && !R && !ut,
    q = (0, Q.useMemo)(
      () =>
        K && !G
          ? (0, $.jsx)(jt, {
              gitRoot: lt?.root ?? null,
              hostConfig: W,
    ...
    D != null && t === `local`
      ? (0, $.jsx)(b, {
          tooltipContent: (0, $.jsxs)(`div`, {
            ...
            children: [
              D.sourceConversationTitle == null
                ? null
                : (0, $.jsx)(B, {
                    ...
                    values: { taskTitle: D.sourceConversationTitle },
                  }),
              (0, $.jsx)(`span`, {
      ...
      : P?.type === `cloud`
        ? (0, $.jsx)(zt, { composerMode: t, setComposerMode: n })
        : (0, $.jsx)(Rt, {
            composerMode: t,
            setComposerMode: n,
            conversationId: I,
            executionTargetOverride: E,
            remoteSelectionState: st,
            disabled: qe,
            hideModeDropdown: m,
            allowWorktree: !P && !r,
            threadHandoff: Bt,
  ...
  let Wt = _ && It(t) && !P,
    [J, Gt] = (0, Q.useState)(!1),
    Y = A(Te, `composer.openProjectPicker`);
  p(
  ...
  let X = Wt
    ...
    Kt = P ? (0, $.jsx)(qt, {}) : null,
    Jt =
      t === `cloud` && P?.type === `cloud` && P.hasAppliedCodeLocally
        ? (0, $.jsx)(Ut, {
            startingState: ce,
            setStartingState: (e) => {
              vt(k, `followUpCloudStartingState`, e);
            },
          })
        : null,
    Z = Ae
      ? st.draftNewThreadRemoteSelectionState
      : st.existingRemoteThreadState,
    Yt =
      K && G
        ? (0, $.jsxs)(Ye, {
            className: `px-0`,
    ...
    on = (0, $.jsxs)($.Fragment, {
      children: [X, l, $t ? Ht : null, $t ? nn : null],
    }),
    sn =
      Zt && (Xt || Yt || bt || Kt)
        ? (0, $.jsxs)(`div`, {
        ...
        : null;
  return e === `home`
    ? (0, $.jsx)(Pe, { trailingControls: sn, children: He ? on : an })
    : (0, $.jsxs)(Je, {
...
function Qt(e) {
  ...
  t[2] === n
    ? (c = t[3])
    : ((c = (0, $.jsx)(oe, { hostId: n })), (t[2] = n), (t[3] = c));
  let l;
  t[4] !== s || t[5] !== c
    ? ((l = (0, $.jsxs)(Ge, {
        collapse: `sm`,
...
//# sourceMappingURL=composer-utility-bar-Bj52tH4x.js.map
