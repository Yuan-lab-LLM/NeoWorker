...
import { n as Ve, t as He } from "./chronicle-config-queries-Dqaq04vs.js";
function Ue(e) {
  let t = (0, Ge.c)(2),
    { children: n } = e,
    r;
...
function We(e) {
  return ue({ event: e, href: qe, initiator: `open_in_browser_bridge` });
}
var Ge,
  Ke,
  qe,
...
function _t(e) {
  ...
  if (
    ...
    let e = a.formatMessage(f.assistant),
      r = yt(e, a.locale);
    ((S = `flex flex-col`),
      (h = be),
    ...
    (t[34] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      t[35] === f.user
        ...
        : ((g = (0, X.jsx)(`p`, {
            className: u,
            children: (0, X.jsx)(W, { ...f.user }),
          })),
          (t[35] = f.user),
          (t[36] = g)),
      (T = `mt-4`),
      (E = (0, X.jsx)(`span`, { className: `sr-only`, children: e })),
      (C = `true`));
    let d;
    (t[37] === f.key
      ? (d = t[38])
  ...
  let k;
  t[39] !== C || t[40] !== w
    ? ((k = (0, X.jsx)(`span`, { "aria-hidden": C, children: w })),
      (t[39] = C),
      (t[40] = w),
      (t[41] = k))
    : (k = t[41]);
  let A;
  t[42] !== k || t[43] !== T || t[44] !== E
    ? ((A = (0, X.jsxs)(`p`, { className: T, children: [E, k] })),
      (t[42] = k),
      (t[43] = T),
      (t[44] = E),
      (t[45] = A))
    : (A = t[45]);
  let j;
  t[46] !== g || t[47] !== A || t[48] !== D || t[49] !== O
    ? ((j = (0, X.jsxs)(`div`, { className: O, children: [g, A] }, D)),
      (t[46] = g),
      (t[47] = A),
      (t[48] = D),
      (t[49] = O),
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = () => m(-1)),
      (P = (0, X.jsx)(r, { className: `!size-[15px]` })),
      (t[53] = N),
      (t[54] = P))
    : ((N = t[53]), (P = t[54]));
  let F;
  ...
  t[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = () => m(1)),
      (R = (0, X.jsx)(r, { className: `!size-[15px] -scale-x-100 transform` })),
      (t[59] = L),
      (t[60] = R))
    : ((L = t[59]), (R = t[60]));
  let z;
  ...
  t[63] !== F || t[64] !== z
    ...
    : (B = t[65]);
  let ee;
  t[66] !== _ || t[67] !== j || t[68] !== B
    ? ((ee = (0, X.jsxs)(`div`, { className: _, children: [j, B] })),
      (t[66] = _),
      (t[67] = j),
      (t[68] = B),
      (t[69] = ee))
  ...
  t[75] !== V || t[76] !== H
    ...
    : (U = t[77]);
  let te;
  t[78] !== v || t[79] !== y || t[80] !== ee || t[81] !== U
    ? ((te = (0, X.jsxs)(`div`, { className: v, children: [y, ee, U] })),
      (t[78] = v),
      (t[79] = y),
      (t[80] = ee),
      (t[81] = U),
    ...
    : (te = t[82]);
  let ne;
  t[83] !== h || t[84] !== b || t[85] !== x || t[86] !== te
    ? ((ne = (0, X.jsxs)(h, { className: b, children: [x, te] })),
      (t[83] = h),
      (t[84] = b),
      (t[85] = x),
      (t[86] = te),
  ...
  return (
    t[89] !== S || t[90] !== ne
      ? ((ie = (0, X.jsxs)(`div`, { className: S, children: [ne, re] })),
        (t[89] = S),
        (t[90] = ne),
        (t[91] = ie))
      : (ie = t[91]),
...
var Rt,
  ...
  Yt = e(() => {
    (N(),
      ...
      (Ht = fe(J, (e) => ({
        enabled: B.chronicle != null && e.length > 0,
      ...
      (Ut = ce(J, ({ scope: e }) => ({
        ...
        onSuccess: (t, { hostId: r }) => {
          (e.query.setData(Rt, t),
            e.query.setData(U, r, (e) =>
...
function sn(e) {
  let t = (0, vn.c)(39),
    ...
    o = k(J),
    { data: s, isError: c, isLoading: l, refetch: u } = F(Bt),
    d = F(Kt),
    f = F(qt),
    [p, m] = (0, yn.useState)(null),
    [h, g] = (0, yn.useState)(null),
    [_] = (0, yn.useState)(Date.now),
    v = (0, yn.useRef)(null),
    y,
    b;
  ...
  if (
    ...
    (t[23] !== s?.length || t[24] !== r || t[25] !== i
      ...
      t[27] === v
        ? (D = t[28])
        : ((D = (0, Z.jsx)(je.Header, { title: m, actions: v })),
          (t[27] = v),
          (t[28] = D)),
      (w = je.Content),
      (C = be),
                ...
                children: e.map((e) =>
                  (0, Z.jsx)(
                    cn,
                    {
                      group: e,
                      settings: a,
                      highlightedApplication: p,
                      confirmingDeleteId: h,
                      isUpdatingApplication: d.isPending,
                      isDeletingItem: f.isPending,
                      onHighlightApplication: S,
      ...
      (t[20] = E),
      (t[21] = D));
  } else ((C = t[17]), (w = t[18]), (T = t[19]), (E = t[20]), (D = t[21]));
  let O;
  t[29] !== C || t[30] !== E
    ? ((O = (0, Z.jsx)(C, { children: E })),
      (t[29] = C),
      (t[30] = E),
      (t[31] = O))
    : (O = t[31]);
  ...
  let M;
  return (
    t[35] !== T || t[36] !== D || t[37] !== A
      ? ((M = (0, Z.jsxs)(T, { children: [D, A] })),
        (t[35] = T),
        (t[36] = D),
        (t[37] = A),
        (t[38] = M))
...
function cn(e) {
  ...
  t[3] === g
    ? (_ = t[4])
    : ((_ = _e(`transition-opacity`, g)), (t[3] = g), (t[4] = _));
  let v;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = () => m(ln)), (t[5] = v))
    : (v = t[5]);
  ...
  t[6] === n.label
    ? (y = t[7])
    : ((y = (0, Z.jsx)(hn, { label: n.label })), (t[6] = n.label), (t[7] = y));
  let b = p && `rotate-90`,
    x;
  t[8] === b
    ? (x = t[9])
    : ((x = _e(`icon-xs text-token-text-tertiary transition-transform`, b)),
      (t[8] = b),
      (t[9] = x));
  let S;
  t[10] === x
    ? (S = t[11])
    : ((S = (0, Z.jsx)(u, { className: x })), (t[10] = x), (t[11] = S));
  let C;
  t[12] !== p || t[13] !== y || t[14] !== S
    ? ((C = (0, Z.jsxs)(`button`, {
        "aria-expanded": p,
  ...
  let w;
  t[16] !== _ || t[17] !== C
    ? ((w = (0, Z.jsx)(`h2`, { className: _, children: C })),
      (t[16] = _),
      (t[17] = C),
      (t[18] = w))
    : (w = t[18]);
...
function un(e) {
  let t = (0, vn.c)(69),
    {
      hasGapAfter: n,
      hasGapBefore: r,
      highlightedApplication: a,
      isConfirmingDelete: o,
      isDeletingItem: s,
      isUpdatingApplication: c,
      item: l,
      onApplicationObservedChange: u,
      onDelete: d,
      onConfirmingDeleteChange: f,
      onHighlightApplication: p,
      settings: m,
    } = e,
    h = ae(),
    g;
  t[0] !== a || t[1] !== l.applications
    ? ((g = a != null && !l.applications.some((e) => e.bundleIdentifier === a)),
      (t[0] = a),
      (t[1] = l.applications),
      (t[2] = g))
    : (g = t[2]);
  ...
  t[3] === v
    ...
    : ((y = _e(
      ...
      (t[3] = v),
      (t[4] = y));
  let b = l.summaryLevel !== `six_hour`,
    x;
  t[5] !== h || t[6] !== l
    ? ((x = mn(l, h)), (t[5] = h), (t[6] = l), (t[7] = x))
    : (x = t[7]);
  let S;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (S = t[8]);
  let C;
  t[9] === l.interval.startMs
    ? (C = t[10])
    : ((C = new Date(l.interval.startMs).toISOString()),
      (t[9] = l.interval.startMs),
      (t[10] = C));
  let w;
  t[11] === l
    ? (w = t[12])
    : ((w = (0, Z.jsx)(pn, { item: l })), (t[11] = l), (t[12] = w));
  let T;
  t[13] !== C || t[14] !== w
    ? ((T = (0, Z.jsx)(`time`, { className: S, dateTime: C, children: w })),
      (t[13] = C),
      (t[14] = w),
      (t[15] = T))
    : (T = t[15]);
  let E;
  t[16] !== b || t[17] !== x || t[18] !== T
    ? ((E = (0, Z.jsx)(_, { disabled: b, tooltipContent: x, children: T })),
      (t[16] = b),
      (t[17] = x),
      (t[18] = T),
      (t[19] = E))
    : (E = t[19]);
  let D = r && an.timelineRailGapBefore,
    O = n && an.timelineRailGapAfter,
    k;
  t[20] !== D || t[21] !== O
    ? ((k = _e(an.timelineRail, `relative min-h-full`, D, O)),
      (t[20] = D),
      (t[21] = O),
      (t[22] = k))
    : (k = t[22]);
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = _e(an.timelineContent, `min-w-0`)), (t[26] = M))
    : (M = t[26]);
  let N;
  t[27] === l.title
    ? (N = t[28])
  ...
  t[46] !== z
    ? ((B = (0, Z.jsx)(K, {
        ...
        size: `iconSm`,
        className: F,
        "data-chronicle-delete-confirming": I,
        disabled: s,
        "aria-label": L,
        onClick: R,
        children: z,
  ...
  t[58] !== m
    ...
    : (H = t[59]);
  let U;
  t[60] !== ee || t[61] !== V || t[62] !== H
    ? ((U = (0, Z.jsxs)(`div`, { className: M, children: [ee, V, H] })),
      (t[60] = ee),
      (t[61] = V),
      (t[62] = H),
      (t[63] = U))
  ...
  let te;
  return (
    t[64] !== E || t[65] !== j || t[66] !== U || t[67] !== y
      ? ((te = (0, Z.jsxs)(`article`, { className: y, children: [E, j, U] })),
        (t[64] = E),
        (t[65] = j),
        (t[66] = U),
        (t[67] = y),
...
function dn(e) {
  ...
  let f = d,
    p = s == null || i,
    h;
  t[3] !== n.bundleIdentifier || t[4] !== p || t[5] !== o
    ? ((h = (e) => {
        if (p) {
          (u(!1), o(null));
          return;
  ...
  t[10] !== _ || t[11] !== v
    ...
    : (y = t[12]);
  let b;
  t[13] !== n.bundleIdentifier || t[14] !== p || t[15] !== o
    ? ((b = () => {
        p || o(n.bundleIdentifier);
      }),
  ...
  t[29] !== n || t[30] !== f || t[31] !== a
    ? ((w = () => a(n, !f)), (t[29] = n), (t[30] = f), (t[31] = a), (t[32] = w))
    : (w = t[32]);
  let T;
  t[33] !== n.displayName || t[34] !== f
    ...
    : (T = t[35]);
  let E;
  t[36] !== i || t[37] !== w || t[38] !== T
    ? ((E = (0, Z.jsx)(G.Item, { disabled: i, onSelect: w, children: T })),
      (t[36] = i),
      (t[37] = w),
      (t[38] = T),
      (t[39] = E))
  ...
  let D;
  return (
    t[40] !== p || t[41] !== l || t[42] !== C || t[43] !== E || t[44] !== h
      ? ((D = (0, Z.jsx)(m, {
          align: `start`,
...
function fn(e) {
  ...
  t[2] === n
    ? (s = t[3])
    : ((s = (0, Z.jsx)(b, { disabled: n, children: o })),
      (t[2] = n),
      (t[3] = s));
  let c;
  t[4] === r
...
function xn(e) {
  ...
  let { data: p, isError: g, isLoading: _ } = F(Vt, d),
    [v, y] = (0, Nn.useState)(null),
    [b, x] = (0, Nn.useState)(``),
    [S, T] = (0, Nn.useState)(!1),
    [E, D] = (0, Nn.useState)(null),
    O;
  t[2] === r
    ? (O = t[3])
    : ((O = () => {
        (y(null), l(!1), D(null), x(``), T(!1), r(!1));
      }),
      (t[2] = r),
      (t[3] = O));
  let A = O,
  ...
  let N = M,
    P;
  t[7] === i ? (P = t[8]) : ((P = { enabled: i }), (t[7] = i), (t[8] = P));
  let { data: I, isError: L, isLoading: R, refetch: z } = F(zt, P),
    B = v ?? (I == null ? null : kt(I)),
    ee = B?.applicationBundleIdentifiers ?? [],
    V;
  t[9] === i ? (V = t[10]) : ((V = { enabled: i }), (t[9] = i), (t[10] = V));
  let { data: H } = w(Ht, ee, V),
    U = F(Jt),
    te = new Map([...(H ?? []), ...(p ?? [])].map(Cn)),
    ne =
      B == null
        ? []
        : B.applicationBundleIdentifiers.map(
            (e) =>
              te.get(e) ?? {
                bundleIdentifier: e,
    ...
    re = () => {
      ...
      let e = An(b);
      e != null &&
        (B.urlDomains.includes(e) ||
          y({ ...B, urlDomains: [...B.urlDomains, e] }),
        x(``),
        T(!1));
    },
    G = f,
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = {
        ...
        onOpenAutoFocus: (e) => {
          e.currentTarget instanceof HTMLElement && D(e.currentTarget);
        },
      }),
      (t[11] = se))
    : (se = t[11]);
      ...
      : B == null || R
        ...
        : (0, Q.jsxs)(`div`, {
            ...
            children: [
              (0, Q.jsxs)(Tn, {
                kind: `apps`,
                behavior: B.defaultApplicationBehavior,
                onBehaviorChange: (e) =>
                  y({ ...B, defaultApplicationBehavior: e }),
                children: [
                  (0, Q.jsx)(m, {
                    ...
                    children: (0, Q.jsx)(wn, {
                      ...
                      isError: g,
                      isLoading: _,
                      selectedBundleIdentifiers: B.applicationBundleIdentifiers,
                      onSelect: (e) =>
                        y({
                          ...B,
                          applicationBundleIdentifiers: [
                            ...B.applicationBundleIdentifiers,
                            e.bundleIdentifier,
                          ],
                        }),
                    }),
                    ...
                    children: ne.map((e) =>
                      (0, Q.jsx)(
                        On,
                        {
                          ...
                          subtitle:
                            e.isWebBrowser &&
                            B.defaultApplicationBehavior === `do_not_observe`
                              ? kn(B.defaultURLBehavior, B.urlDomains.length)
                              : null,
                          onRemove: () =>
                            y({
                              ...B,
                              applicationBundleIdentifiers:
                                B.applicationBundleIdentifiers.filter(
              ...
              (0, Q.jsxs)(Tn, {
                kind: `websites`,
                behavior: B.defaultURLBehavior,
                onBehaviorChange: (e) => y({ ...B, defaultURLBehavior: e }),
                children: [
                  S
                    ? (0, Q.jsxs)(`div`, {
                      ...
                      (0, Q.jsx)(
                        En,
                        {
                          ...
                          onRemove: () =>
                            y({
                              ...B,
                              urlDomains: B.urlDomains.filter((t) => t !== e),
                            }),
                        },
                        e,
                      ),
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (pe = t[13]);
  let me;
  t[14] !== ue || t[15] !== de || t[16] !== fe
    ? ((me = (0, Q.jsxs)(ue, { children: [de, fe, pe] })),
      (t[14] = ue),
      (t[15] = de),
      (t[16] = fe),
      (t[17] = me))
  ...
  t[25] !== ge || t[26] !== be
    ? ((xe = (0, Q.jsx)(ze, {
        children: (0, Q.jsxs)(C, { className: `gap-3`, children: [ge, be] }),
      })),
      (t[25] = ge),
      (t[26] = be),
      (t[27] = xe))
    : (xe = t[27]);
  let Se;
  t[28] !== ce || t[29] !== le || t[30] !== me || t[31] !== xe
    ? ((Se = (0, Q.jsxs)(ce, {
        as: `form`,
  ...
  let q;
  return (
    t[33] !== G || t[34] !== N || t[35] !== i || t[36] !== se || t[37] !== Se
      ? ((q = (0, Q.jsx)(G, {
          open: i,
          onOpenChange: N,
          showDialogClose: !1,
...
function wn(e) {
  ...
  if (
    ...
    t[10] === f
      ? (p = t[11])
      : ((p = (e) => !f.has(e.bundleIdentifier)), (t[10] = f), (t[11] = p));
    let m = (0, Mn.default)(n, `bundleIdentifier`).filter(p),
      h = m.filter(
        (t) =>
          e === `` ||
    ...
    t[16] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((v = (e) => l(e.currentTarget.value)), (t[16] = v))
      : (v = t[16]);
    let y;
    (t[17] !== c || t[18] !== g || t[19] !== _
      ? ((y = (0, Q.jsx)(G.SearchInput, {
          autoFocus: !0,
          "aria-label": g,
          placeholder: _,
          value: c,
...
function Tn(e) {
  ...
  let s;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(Pe, { className: `icon-2xs text-token-text-tertiary` })),
      (t[3] = s))
    : (s = t[3]);
  let c;
  t[4] === o
  ...
  t[10] !== l || t[11] !== u || t[12] !== d
    ? ((f = (0, Q.jsx)(G.Item, { RightIcon: l, onSelect: u, children: d })),
      (t[10] = l),
      (t[11] = u),
      (t[12] = d),
      (t[13] = f))
    : (f = t[13]);
  let p = n === `do_not_observe` ? ke : void 0,
    h;
  t[14] === a
    ? (h = t[15])
    : ((h = () => a(`do_not_observe`)), (t[14] = a), (t[15] = h));
  let g;
  t[16] === i
    ? (g = t[17])
    : ((g = (0, Q.jsx)(ct, { behavior: `do_not_observe`, kind: i })),
      (t[16] = i),
      (t[17] = g));
  let _;
  t[18] !== g || t[19] !== p || t[20] !== h
    ? ((_ = (0, Q.jsx)(G.Item, { RightIcon: p, onSelect: h, children: g })),
      (t[18] = g),
      (t[19] = p),
      (t[20] = h),
      (t[21] = _))
...
function Fn() {
  let e = (0, Vn.c)(42),
    t = k(J),
    { selectedHostId: r } = ee(),
    { data: i, isLoading: a } = w(U, r),
    [o, s] = (0, Hn.useState)(!1),
    [c, u] = (0, Hn.useState)(null),
    d = B.chronicle,
    f = i?.config,
    p;
  e[0] === f ? (p = e[1]) : ((p = l(f, `memories`)), (e[0] = f), (e[1] = p));
  let m = p === !0,
    h = i?.config,
    g;
  e[2] === h ? (g = e[3]) : ((g = l(h, `chronicle`)), (e[2] = h), (e[3] = g));
  let _ = g === !0,
    v;
  e[4] === _ ? (v = e[5]) : ((v = { enabled: _ }), (e[4] = _), (e[5] = v));
  let { data: y, dataUpdatedAt: b, errorUpdatedAt: x, isError: S } = F(Rt, v),
    C = F(Ut),
    T = F(Wt),
    E = C.isPending && C.variables?.enabled === !0,
    D = y ?? T.data ?? C.data,
    O = E || T.isPending || D?.activationState === `starting`,
    A = E || (D?.enabled ?? _),
    M = S || x > b,
    N = d == null || a || C.isPending || T.isPending,
    P;
  e[6] !== _ || e[7] !== t || e[8] !== y?.enabled
    ? ((P = () => {
        y?.enabled !== !1 ||
          !_ ||
          (q(t.queryClient, n), q(t.queryClient, [`user-saved-config`]));
      }),
      (e[6] = _),
      (e[7] = t),
      (e[8] = y?.enabled),
  ...
  let I = y?.enabled,
    L;
  (e[10] !== _ || e[11] !== t || e[12] !== I
    ? ((L = [_, t, I]), (e[10] = _), (e[11] = t), (e[12] = I), (e[13] = L))
    : (L = e[13]),
    (0, Hn.useEffect)(P, L));
  let R;
  e[14] !== t || e[15] !== r || e[16] !== C
    ? ((R = (e) => {
        C.mutate(
          { enabled: e, hostId: r },
          {
  ...
  e[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = (0, $.jsx)(le, { slug: `chronicle` })), (e[21] = te))
    : (te = e[21]);
  let ne;
  e[22] !== O ||
  e[23] !== N ||
  ...
  e[31] !== z
    ? ((ne =
        !m && !a
          ...
          : A
            ? (0, $.jsx)(Ln, {
                activationInProgress: O,
                currentState: D,
                isServiceUnavailable: M,
                onClearRequest: u,
                onOpenPermissions: () => {
                  (t.query.invalidate(zt), s(!0));
                },
                onRetryActivation: H,
                onToggle: z,
                toggleDisabled: N,
              })
            : (0, $.jsx)(_t, { disabled: N, onTurnOn: () => z(!0) })),
      (e[22] = O),
      (e[23] = N),
      (e[24] = D),
      (e[25] = A),
  ...
  e[33] === o
    ? (re = e[34])
    : ((re = (0, $.jsx)(xn, { open: o, onOpenChange: s })),
      (e[33] = o),
      (e[34] = re));
  let ie;
  ...
  e[36] === c
    ? (G = e[37])
    : ((G = (0, $.jsx)(zn, { request: c, onOpenChange: ie })),
      (e[36] = c),
      (e[37] = G));
  let ae;
  return (
    e[38] !== ne || e[39] !== re || e[40] !== G
      ? ((ae = (0, $.jsxs)(Ce, { title: te, children: [ne, re, G] })),
        (e[38] = ne),
        (e[39] = re),
        (e[40] = G),
        (e[41] = ae))
...
function In() {
  let e = (0, Vn.c)(3),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(p, { className: `icon-lg text-token-text-tertiary` })),
      (e[0] = t))
    : (t = e[0]);
  let n;
...
function Ln(e) {
  ...
  t[0] === f
    ? (p = t[1])
    : ((p = f == null ? null : kt(f)), (t[0] = f), (t[1] = p));
  let m = p,
    h =
      (m?.applicationBundleIdentifiers.length ?? 0) +
      (m?.urlDomains.length ?? 0),
    g = F(Gt),
    _ =
      r?.activationState === `waiting_for_permissions` ||
      (r?.recorderState === `stopped` && r.activationState === `idle`),
    v = i || r?.activationState === `failed`,
    y = n || _ || v,
    b = l || g.isPending,
    x;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let D;
  t[24] !== S || t[25] !== E
    ? ((D = (0, $.jsx)(me, { label: x, description: S, control: E })),
      (t[24] = S),
      (t[25] = E),
      (t[26] = D))
    : (D = t[26]);
  ...
  t[35] !== N || t[36] !== D
    ? ((P = (0, $.jsx)(je, {
        children: (0, $.jsx)(je.Content, {
          children: (0, $.jsxs)(be, { children: [D, N] }),
        }),
      })),
      (t[35] = N),
      (t[36] = D),
...
function zn(e) {
  ...
  t[6] === l
    ? (u = t[7])
    : ((u = (0, $.jsx)(Bn, { scope: l })), (t[6] = l), (t[7] = u));
  let d;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(W, {
  ...
  t[9] === u
    ? (p = t[10])
    : ((p = (0, $.jsxs)(ze, {
        children: [c, (0, $.jsx)(L, { title: u, subtitle: d })],
      })),
      (t[9] = u),
      (t[10] = p));
  let m;
  t[11] === n ? (m = t[12]) : ((m = () => n(!1)), (t[11] = n), (t[12] = m));
  let g;
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $.jsx)(W, {
  ...
  let b;
  t[21] !== _ || t[22] !== y
    ? ((b = (0, $.jsx)(ze, { children: (0, $.jsxs)(C, { children: [_, y] }) })),
      (t[21] = _),
      (t[22] = y),
      (t[23] = b))
    : (b = t[23]);
  let x;
  t[24] !== b || t[25] !== s || t[26] !== p
    ? ((x = (0, $.jsxs)(h, { as: `form`, onSubmit: s, children: [p, b] })),
      (t[24] = b),
      (t[25] = s),
      (t[26] = p),
      (t[27] = x))
...
//# sourceMappingURL=chronicle-settings-page-BhEOcSST.js.map
