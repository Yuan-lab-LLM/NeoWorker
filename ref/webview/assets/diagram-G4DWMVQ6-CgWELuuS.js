...
import { r } from "./chunk-5PVQY5BW-Dg9V_wGW.js";
import { R as i, tt as a, yt as o, z as s } from "./runtime.worker-_LqsnMiG.js";
import { t as c } from "./mermaid-parser.core-Bs_kKzLq.js";
import {
  B as l,
  C as u,
  E as d,
...
import { t as x } from "./chunk-4BX2VUAB-FBE5WLZr.js";
import { t as S } from "./chunk-EDXVE4YY-Dd6nfaAc.js";
import { i as C, n as w } from "./chunk-X2U36JSP-CoOl3j8b.js";
var T = class {
  constructor() {
    ((this.nodes = []),
      (this.levels = new Map()),
...
var D = t((e, n) => {
  ...
  N = {
    draw: t((r, c, l, u) => {
      ...
      try {
        let e = f.valueFormat || `,`;
        if (e === `$0,0`) O = t((e) => `$` + o(`,`)(e), `valueFormat`);
        else if (e.startsWith(`$`) && e.includes(`,`)) {
          let n = /\.\d+/.exec(e),
            r = n ? n[0] : ``;
          O = t((e) => `$` + o(`,` + r)(e), `valueFormat`);
        } else if (e.startsWith(`$`)) {
          let n = e.substring(1);
          O = t((e) => `$` + o(n || ``)(e), `valueFormat`);
        } else O = o(e);
      } catch (t) {
        (e.error(`Error creating format function:`, t), (O = o(`,`)));
      }
      let k = a().range([
          `transparent`,
          _.cScale0,
...
export { F as diagram };
//# sourceMappingURL=diagram-G4DWMVQ6-CgWELuuS.js.map
