import {
  ...
  xt as m,
  y as h,
} from "./runtime.worker-_LqsnMiG.js";
function g(e, t) {
  return r(f(e, t), 1);
}
function _(e, t) {
  return e && e.length ? u(e, c(t, 2)) : [];
}
function v(e) {
...
function T(e) {
  return C(e) && typeof e.fullText == `string`;
}
var te = class e {
  constructor(e, t) {
...
const L = new zt();
function Bt(e) {
  return new re(e, (e) => (C(e) ? e.content : []), { includeRoot: !0 });
}
function Vt(e, t) {
...
function Yt(e, t) {
  return w(e) && t.includes(e.tokenType.name);
}
function Xt(e, t = !0) {
  for (; e.container;) {
    let n = e.container,
      ...
      if (u !== -1) {
        if (
          ...
          d !== void 0 &&
            ...
            (f = A.tokenTypeIdx),
            (p = this.createTokenInstance(s, y, f, A.tokenType, C, w, u)),
          ...
          while (n === !0);
          t === 0
            ? (w = this.computeNewColumn(w, u))
            : ((C += t),
              (w = u - r),
              this.updateTokenEndLineColumnLocation(p, d, r, t, C, w, u));
        ...
        if (
          ...
          ee.push({ offset: t, line: n, column: i, length: m, message: h }),
          j === !1)
        )
          break;
      }
  ...
  ua = class extends la {
    ...
    walkTerminal(e, t, n) {
      if (
        ...
        let e = new cr({ definition: t.concat(n) });
        ((this.possibleTokTypes = Cr(e)), (this.found = !0));
      }
    }
  },
  da = class extends xr {
	...
	For Further details.`);
      ...
      if (Array.isArray(e))
        ...
        let t = Object.values(e.modes).flat(),
          n = [...new Set(t)];
        this.tokensMap = n.reduce((e, t) => ((e[t.name] = t), e), {});
      ...
      ((this.tokenMatcher = n ? Ei : Ti), ki(Object.values(this.tokensMap)));
    }
    defineRule(e, t, n) {
        ...
        this.definitionErrors.length === 0 &&
          (this.recoveryEnabled &&
            this.TRACE_INIT(`computeAllProdsFollows`, () => {
              let e = kr(Object.values(this.gastProductionsCache));
...
function ys(e, t, n) {
  ...
  return (Ts(e, r), Es(e, t, r, n, ...f(n.definition, (n) => ms(e, t, n))));
}
function bs(e, t, n) {
  let r = G(e, t, n, { type: 1 });
...
function xs(e, t, r) {
  let i = n(
    f(r.definition, (n) => ms(e, t, n)),
    (e) => e !== void 0,
  );
  return i.length === 1 ? i[0] : i.length === 0 ? void 0 : Os(e, i);
}
...
var Bs = class extends Co {
  ...
  buildLookaheadForAlternation(e) {
    ...
    if (Vs(u, !1) && !a) {
      ...
      return function (e) {
        ...
        let r = Us.call(this, o, l, t, s);
        return typeof r == `number` ? r : void 0;
      };
    else
      return function () {
        let e = Us.call(this, o, l, zs, s);
  ...
  buildLookaheadForOptional(e) {
    let {
      ...
      p = f(ba({ maxLookahead: 1, occurrence: n, prodType: a, rule: r }), (e) =>
        f(e, (e) => e[0]),
      );
    if (Vs(p) && p[0][0] && !o) {
      let e = p[0],
        n = i(e);
      if (n.length === 1 && h(n[0].categoryMatches)) {
        let e = n[0].tokenTypeIdx;
        return function () {
          return this.LA_FAST(1).tokenTypeIdx === e;
        };
      } else {
...
function qs(e) {
  let t = f(e.prefixPath, (e) => Ui(e)).join(`, `),
  ...
  Vd = s((e) => {
    ...
    (function (e) {
      function t(e) {
        ...
        return (
          t &&
          (ee.is(t.cancellationStrategy) ||
            v.is(t.connectionStrategy) ||
            C.is(t.messageStrategy))
        );
      }
      e.is = t;
    })(w || (e.ConnectionOptions = w = {}));
    var T;
    (function (e) {
      ((e[(e.New = 1)] = `New`),
    ...
    function te(f, v, b, x) {
      let S = b === void 0 ? e.NullLogger : b,
        ...
        de = new a.Emitter(),
        F = new a.Emitter(),
        fe = x && x.cancellationStrategy ? x.cancellationStrategy : ee.Message;
      function pe(e) {
        if (e === null)
          throw Error(
      ...
      function Ee() {
        ...
        try {
          ...
          C.is(t) ? t.handleMessage(e, Te) : Te(e);
        } finally {
          we();
        }
      }
...
`)),
  ...
  hf = s((e) => {
    ...
    Object.defineProperty(e, "InlineCompletionRequest", {
      enumerable: !0,
      get: function () {
        return w.InlineCompletionRequest;
      },
    });
    var T;
    (function (e) {
...
var bf = class {
    ...
    awaitDocumentState(e, t, n) {
      ...
      return r
        ? r.state >= e
          ...
          : n.isCancellationRequested
            ...
            : this.currentState >= e && e > r.state
              ? Promise.reject(
                  new vf.ResponseError(
                    vf.LSPErrorCodes.RequestFailed,
        ...
        : Promise.reject(
            new vf.ResponseError(
              vf.LSPErrorCodes.ServerCancelled,
...
var Tf = class {
  constructor(e) {
    ...
    let n = Of(t) ? Object.values(t) : t,
      r = e.LanguageMetaData.mode === `production`;
    this.chevrotainLexer = new Hi(n, {
      positionTracking: `full`,
      skipValidations: r,
  ...
  toTokenTypeDictionary(e) {
    if (Of(e)) return e;
    let t = Df(e) ? Object.values(e.modes).flat() : e,
      n = {};
...
function kf(e, t, n) {
  ...
  return Bf({
    index: 0,
    tokens: Pf({ lines: a, position: i, options: o }),
    position: i,
  });
}
function Af(e, t) {
...
function Pf(e) {
  ...
  for (let i = 0; i < e.lines.length; i++) {
    ...
    if (((s = s.substring(0, zf(s))), Rf(s, c) >= s.length)) {
      if (t.length > 0) {
        let e = K.create(n, r);
...
function Bf(e) {
  ...
  if (e.tokens.length === 0) return new Yf([], q.create(t, t));
  let n = [];
  for (; e.index < e.tokens.length;) {
    let t = Vf(e, n[n.length - 1]);
    t && n.push(t);
  }
  let r = n[0]?.range.start ?? t,
    i = n[n.length - 1]?.range.end ?? t;
  return new Yf(n, q.create(r, i));
}
function Vf(e, t) {
  let n = e.tokens[e.index];
  if (n.type === `tag`) return Gf(e, !1);
  if (n.type === `text` || n.type === `inline-tag`) return Uf(e);
  (Hf(n, t), e.index++);
}
function Hf(e, t) {
  if (t) {
    let n = new ep(``, e.range);
...
function Uf(e) {
  ...
  for (; t && t.type !== `break` && t.type !== `tag`;)
    (i.push(Wf(e)), (r = t), (t = e.tokens[e.index]));
  return new $f(i, q.create(n.range.start, r.range.end));
}
function Wf(e) {
  return e.tokens[e.index].type === `inline-tag` ? Gf(e, !0) : Kf(e);
}
function Gf(e, t) {
  let n = e.tokens[e.index++],
  ...
  if (e.tokens[e.index]?.type === `text`)
    if (t) {
      ...
      let i = Uf(e);
      return new Xf(r, i, t, q.create(n.range.start, i.range.end));
    }
  else {
    let e = n.range;
    return new Xf(r, new $f([], e), t, e);
  }
}
function Kf(e) {
  let t = e.tokens[e.index++];
  return new ep(t.content, t.range);
}
function qf(e) {
  if (!e) return qf({ start: `/**`, end: `*/`, line: `*` });
  let { start: t, end: n, line: r } = e;
  return { start: Jf(t, !0), end: Jf(n, !1), line: Jf(r, !0) };
}
function Jf(e, t) {
...
function sp(e) {
  return {
    documentation: {
      CommentProvider: (e) => new rp(e),
      DocumentationProvider: (e) => new np(e),
    },
    parser: {
      AsyncParser: (e) => new ip(e),
      ...
      LexerErrorMessageProvider: () => new Cf(),
    },
    workspace: {
...
function cp(e) {
  return {
    ...
    workspace: {
      ...
      DocumentBuilder: (e) => new bf(e),
      IndexManager: (e) => new xf(e),
      WorkspaceManager: (e) => new Sf(e),
      FileSystemProvider: (t) => e.fileSystemProvider(t),
      WorkspaceLock: () => new ap(),
...
var lp;
(function (e) {
  e.merge = (e, t) => hp(hp({}, e), t);
})((lp ||= {}));
function up(e, t, n, r, i, a, o, s, c) {
  return fp([e, t, n, r, i, a, o, s, c].reduce(hp, {}));
}
const dp = Symbol(`isProxy`);
function fp(e, t) {
  let n = new Proxy(
    {},
    {
...
function mp(e, t, n, r) {
  if (t in e) {
    ...
    e[t] = pp;
    try {
      e[t] = typeof i == `function` ? i(r) : fp(i, r);
    } catch (n) {
  ...
  if (t) {
    for (let [n, r] of Object.entries(t))
      if (r != null)
        if (typeof r == `object`) {
          let t = e[n];
          typeof t == `object` && t ? (e[n] = hp(t, r)) : (e[n] = hp({}, r));
        } else e[n] = r;
  }
  return e;
}
...
const _p = { fileSystemProvider: () => new gp() },
  vp = {
    Grammar: () => void 0,
    LanguageMetaData: () => ({
      caseInsensitive: !1,
...
var Sp = Object.defineProperty,
  Q = (e, t) => Sp(e, `name`, { value: t, configurable: !0 }),
  Cp;
((e) => {
  e.Terminals = {
...
var Mp = { $type: `Accelerator`, name: `name`, x: `x`, y: `y` },
  Np = {
    $type: `Anchor`,
    evolution: `evolution`,
    name: `name`,
  ...
  Pp = { $type: `Annotation`, number: `number`, text: `text`, x: `x`, y: `y` },
  Fp = { $type: `Annotations`, x: `x`, y: `y` },
  Ip = {
    $type: `Architecture`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
...
function Lp(e) {
  return Rm.isInstance(e, Ip.$type);
}
Q(Lp, `isArchitecture`);
var Rp = { $type: `Axis`, label: `label`, name: `name` },
  zp = { $type: `Branch`, name: `name`, order: `order` };
function Bp(e) {
  return Rm.isInstance(e, zp.$type);
}
Q(Bp, `isBranch`);
var Vp = { $type: `Checkout`, branch: `branch` },
  Hp = { $type: `CherryPicking`, id: `id`, parent: `parent`, tags: `tags` },
  Up = {
...
function Gp(e) {
  return Rm.isInstance(e, Wp.$type);
}
Q(Gp, `isCommit`);
var Kp = {
    $type: `Component`,
  ...
  qp = { $type: `Curve`, entries: `entries`, label: `label`, name: `name` },
  Jp = { $type: `Deaccelerator`, name: `name`, x: `x`, y: `y` },
  Yp = { $type: `Decorator`, strategy: `strategy` },
  Xp = {
    $type: `Direction`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
  ...
  Qp = { $type: `Entry`, axis: `axis`, value: `value` },
  $p = { $type: `Evolution`, stages: `stages` },
  em = {
    $type: `EvolutionStage`,
    boundary: `boundary`,
    name: `name`,
  ...
  tm = { $type: `Evolve`, component: `component`, target: `target` },
  nm = {
    $type: `GitGraph`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
...
function rm(e) {
  return Rm.isInstance(e, nm.$type);
}
Q(rm, `isGitGraph`);
var im = { $type: `Group`, icon: `icon`, id: `id`, in: `in`, title: `title` },
  am = {
    $type: `Info`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
...
function om(e) {
  return Rm.isInstance(e, am.$type);
}
Q(om, `isInfo`);
var sm = { $type: `Item`, classSelector: `classSelector`, name: `name` },
  cm = { $type: `Junction`, id: `id`, in: `in` },
  lm = {
    $type: `Label`,
    negX: `negX`,
    negY: `negY`,
...
function pm(e) {
  return Rm.isInstance(e, fm.$type);
}
Q(pm, `isMerge`);
var mm = {
    $type: `Note`,
  ...
  hm = { $type: `Option`, name: `name`, value: `value` },
  gm = {
    $type: `Packet`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
...
function _m(e) {
  return Rm.isInstance(e, gm.$type);
}
Q(_m, `isPacket`);
var vm = {
  $type: `PacketBlock`,
...
function ym(e) {
  return Rm.isInstance(e, vm.$type);
}
Q(ym, `isPacketBlock`);
var bm = {
  $type: `Pie`,
...
function xm(e) {
  return Rm.isInstance(e, bm.$type);
}
Q(xm, `isPie`);
var Sm = { $type: `PieSection`, label: `label`, value: `value` };
function Cm(e) {
  return Rm.isInstance(e, Sm.$type);
}
Q(Cm, `isPieSection`);
var wm = { $type: `Pipeline`, components: `components`, parent: `parent` },
  Tm = {
  ...
  Dm = { $type: `Section`, classSelector: `classSelector`, name: `name` },
  Om = {
    $type: `Service`,
    icon: `icon`,
    iconText: `iconText`,
  ...
  km = { $type: `Size`, height: `height`, width: `width` },
  Am = { $type: `Statement` },
  jm = {
    $type: `Treemap`,
    accDescr: `accDescr`,
...
function Mm(e) {
  return Rm.isInstance(e, jm.$type);
}
Q(Mm, `isTreemap`);
var Nm = { $type: `TreemapRow`, indent: `indent`, item: `item` },
  Pm = { $type: `TreeNode`, indent: `indent`, name: `name` },
  Fm = {
    $type: `TreeView`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
...
function Im(e) {
  return Rm.isInstance(e, $.$type);
}
Q(Im, `isWardley`);
var Lm = class extends ee {
    constructor() {
      (super(...arguments),
        (this.types = {
          Accelerator: {
          ...
          Anchor: {
            name: Np.$type,
            properties: {
              evolution: { name: Np.evolution },
              name: { name: Np.name },
              visibility: { name: Np.visibility },
            },
            superTypes: [],
          },
          Annotation: {
          ...
          Annotations: {
            name: Fp.$type,
            properties: { x: { name: Fp.x }, y: { name: Fp.y } },
            superTypes: [],
          },
          Architecture: {
            name: Ip.$type,
            properties: {
              accDescr: { name: Ip.accDescr },
              accTitle: { name: Ip.accTitle },
              edges: { name: Ip.edges, defaultValue: [] },
              groups: { name: Ip.groups, defaultValue: [] },
              junctions: { name: Ip.junctions, defaultValue: [] },
              services: { name: Ip.services, defaultValue: [] },
              title: { name: Ip.title },
            },
            superTypes: [],
          },
          Axis: {
            name: Rp.$type,
            properties: { label: { name: Rp.label }, name: { name: Rp.name } },
            superTypes: [],
          },
          Branch: {
            name: zp.$type,
            properties: { name: { name: zp.name }, order: { name: zp.order } },
            superTypes: [Am.$type],
          },
          Checkout: {
            name: Vp.$type,
            properties: { branch: { name: Vp.branch } },
            superTypes: [Am.$type],
          },
          CherryPicking: {
            name: Hp.$type,
            properties: {
              id: { name: Hp.id },
              parent: { name: Hp.parent },
              tags: { name: Hp.tags, defaultValue: [] },
            },
            superTypes: [Am.$type],
          },
          ClassDefStatement: {
            name: Up.$type,
            properties: {
              className: { name: Up.className },
              styleText: { name: Up.styleText },
            },
            superTypes: [],
          },
          Commit: {
            ...
            properties: {
              id: { name: Wp.id },
              message: { name: Wp.message },
              tags: { name: Wp.tags, defaultValue: [] },
              type: { name: Wp.type },
            },
            superTypes: [Am.$type],
          },
          Component: {
            name: Kp.$type,
            properties: {
              decorator: { name: Kp.decorator },
              evolution: { name: Kp.evolution },
              inertia: { name: Kp.inertia, defaultValue: !1 },
              label: { name: Kp.label },
              name: { name: Kp.name },
              visibility: { name: Kp.visibility },
            },
            superTypes: [],
          },
          Curve: {
            name: qp.$type,
            properties: {
              entries: { name: qp.entries, defaultValue: [] },
              label: { name: qp.label },
              name: { name: qp.name },
            },
            superTypes: [],
          ...
          Decorator: {
            name: Yp.$type,
            properties: { strategy: { name: Yp.strategy } },
            superTypes: [],
          },
          Direction: {
            name: Xp.$type,
            properties: {
              accDescr: { name: Xp.accDescr },
              accTitle: { name: Xp.accTitle },
              dir: { name: Xp.dir },
              statements: { name: Xp.statements, defaultValue: [] },
              title: { name: Xp.title },
            },
            superTypes: [nm.$type],
          },
          Edge: {
            name: Zp.$type,
            properties: {
              lhsDir: { name: Zp.lhsDir },
              lhsGroup: { name: Zp.lhsGroup, defaultValue: !1 },
              lhsId: { name: Zp.lhsId },
              lhsInto: { name: Zp.lhsInto, defaultValue: !1 },
              rhsDir: { name: Zp.rhsDir },
              rhsGroup: { name: Zp.rhsGroup, defaultValue: !1 },
              rhsId: { name: Zp.rhsId },
              rhsInto: { name: Zp.rhsInto, defaultValue: !1 },
              title: { name: Zp.title },
            },
            superTypes: [],
          },
          Entry: {
            name: Qp.$type,
            properties: {
              axis: { name: Qp.axis, referenceType: Rp.$type },
              value: { name: Qp.value },
            },
            superTypes: [],
          },
          Evolution: {
            name: $p.$type,
            properties: { stages: { name: $p.stages, defaultValue: [] } },
            superTypes: [],
          },
          EvolutionStage: {
            name: em.$type,
            properties: {
              boundary: { name: em.boundary },
              name: { name: em.name },
              secondName: { name: em.secondName },
            },
            superTypes: [],
          },
          Evolve: {
            name: tm.$type,
            properties: {
              component: { name: tm.component },
              target: { name: tm.target },
            },
            superTypes: [],
          },
          GitGraph: {
            name: nm.$type,
            properties: {
              accDescr: { name: nm.accDescr },
              accTitle: { name: nm.accTitle },
              statements: { name: nm.statements, defaultValue: [] },
              title: { name: nm.title },
            },
            superTypes: [],
          },
          ...
          Info: {
            name: am.$type,
            properties: {
              accDescr: { name: am.accDescr },
              accTitle: { name: am.accTitle },
              title: { name: am.title },
            },
            superTypes: [],
          },
          Item: {
            name: sm.$type,
            properties: {
              classSelector: { name: sm.classSelector },
              name: { name: sm.name },
            },
            superTypes: [],
          },
          Junction: {
            name: cm.$type,
            properties: { id: { name: cm.id }, in: { name: cm.in } },
            superTypes: [],
          },
          Label: {
            name: lm.$type,
            properties: {
              negX: { name: lm.negX, defaultValue: !1 },
              negY: { name: lm.negY, defaultValue: !1 },
              offsetX: { name: lm.offsetX },
              offsetY: { name: lm.offsetY },
            },
            superTypes: [],
          },
          Leaf: {
            name: um.$type,
            properties: {
              classSelector: { name: um.classSelector },
              name: { name: um.name },
              value: { name: um.value },
            },
            superTypes: [sm.$type],
          ...
          Link: {
            ...
            properties: {
              arrow: { name: dm.arrow },
              from: { name: dm.from },
              fromPort: { name: dm.fromPort },
              linkLabel: { name: dm.linkLabel },
              to: { name: dm.to },
              toPort: { name: dm.toPort },
            },
            superTypes: [],
          },
          Merge: {
            name: fm.$type,
            properties: {
              branch: { name: fm.branch },
              id: { name: fm.id },
              tags: { name: fm.tags, defaultValue: [] },
              type: { name: fm.type },
            },
            superTypes: [Am.$type],
          },
          Note: {
            name: mm.$type,
            properties: {
              evolution: { name: mm.evolution },
              text: { name: mm.text },
              visibility: { name: mm.visibility },
            },
            superTypes: [],
          },
          Option: {
            ...
            properties: {
              name: { name: hm.name },
              value: { name: hm.value, defaultValue: !1 },
            },
            superTypes: [],
          },
          Packet: {
            name: gm.$type,
            properties: {
              accDescr: { name: gm.accDescr },
              accTitle: { name: gm.accTitle },
              blocks: { name: gm.blocks, defaultValue: [] },
              title: { name: gm.title },
            },
            superTypes: [],
          },
          ...
          Pie: {
            name: bm.$type,
            properties: {
              accDescr: { name: bm.accDescr },
              accTitle: { name: bm.accTitle },
              sections: { name: bm.sections, defaultValue: [] },
              showData: { name: bm.showData, defaultValue: !1 },
              title: { name: bm.title },
            },
            superTypes: [],
          },
          ...
          Pipeline: {
            name: wm.$type,
            properties: {
              components: { name: wm.components, defaultValue: [] },
              parent: { name: wm.parent },
            },
            superTypes: [],
          },
          PipelineComponent: {
          ...
          Radar: {
            name: Em.$type,
            properties: {
              accDescr: { name: Em.accDescr },
              accTitle: { name: Em.accTitle },
              axes: { name: Em.axes, defaultValue: [] },
              curves: { name: Em.curves, defaultValue: [] },
              options: { name: Em.options, defaultValue: [] },
              title: { name: Em.title },
            },
            superTypes: [],
          },
          ...
          Size: {
            name: km.$type,
            properties: {
              height: { name: km.height },
              width: { name: km.width },
            },
            superTypes: [],
          },
          Statement: { name: Am.$type, properties: {}, superTypes: [] },
          TreeNode: {
            name: Pm.$type,
            properties: {
          ...
          TreeView: {
            name: Fm.$type,
            properties: {
              accDescr: { name: Fm.accDescr },
              accTitle: { name: Fm.accTitle },
              nodes: { name: Fm.nodes, defaultValue: [] },
              title: { name: Fm.title },
            },
            superTypes: [],
          },
          Treemap: {
            name: jm.$type,
            properties: {
              accDescr: { name: jm.accDescr },
              accTitle: { name: jm.accTitle },
              title: { name: jm.title },
              TreemapRows: { name: jm.TreemapRows, defaultValue: [] },
            },
            superTypes: [],
          },
          TreemapRow: {
  ...
  fh = { AstReflection: Q(() => new Lm(), `AstReflection`) },
  ph = {
    Grammar: Q(() => Bm(), `Grammar`),
    LanguageMetaData: Q(() => rh, `LanguageMetaData`),
    parser: {},
  },
  mh = {
    Grammar: Q(() => Hm(), `Grammar`),
    LanguageMetaData: Q(() => ih, `LanguageMetaData`),
    parser: {},
  },
  hh = {
    Grammar: Q(() => Wm(), `Grammar`),
    LanguageMetaData: Q(() => ah, `LanguageMetaData`),
    parser: {},
  },
  gh = {
    Grammar: Q(() => Km(), `Grammar`),
    LanguageMetaData: Q(() => oh, `LanguageMetaData`),
    parser: {},
  },
  _h = {
    Grammar: Q(() => Jm(), `Grammar`),
    LanguageMetaData: Q(() => sh, `LanguageMetaData`),
    parser: {},
  },
  vh = {
    Grammar: Q(() => Xm(), `Grammar`),
  ...
  bh = {
    Grammar: Q(() => eh(), `Grammar`),
    LanguageMetaData: Q(() => uh, `LanguageMetaData`),
    parser: {},
  },
  xh = {
    Grammar: Q(() => nh(), `Grammar`),
...
//# sourceMappingURL=chunk-K5T4RW27-CF76IhR4.js.map
