...
function W(e) {
  ...
  t[0] !== i || t[1] !== u
    ...
    : (d = t[2]);
  let p;
  t[3] === c ? (p = t[4]) : ((p = { enabled: c }), (t[3] = c), (t[4] = p));
  let m;
  t[5] !== d || t[6] !== p
    ? ((m = { params: d, queryConfig: p }), (t[5] = d), (t[6] = p), (t[7] = m))
    : (m = t[7]);
  let { data: h, isError: g, isLoading: _ } = f(`read-file`, m);
  if (!c) return r;
  if (_) {
    let e;
    t[8] === n
...
function G({ className: e, contents: r, filePath: i }) {
  let o = _(),
    s = (0, Z.useMemo)(() => A(r), [r]),
    [c, u] = (0, Z.useState)(0),
    ...
    z = T?.modelIndex === c ? T : null,
    B = (0, Z.useMemo)(() => ae(R, z), [R, z]),
    V = (0, Z.useMemo)(() => oe(B), [B]),
    H = (0, Z.useMemo)(() => ae(R, k?.modelIndex === c ? k : null), [c, R, k]),
  ...
  function J(e) {
    R != null &&
      (O(e),
      W({ chainId: R.chainId, endIndex: e, modelIndex: c, startIndex: e }));
  }
  function Y(e) {
    D == null ||
      R == null ||
  ...
  function de() {
    let e = N.current;
    (O(null), e != null && e.modelIndex === c && j(e));
  }
  function X(e) {
    if (R == null) return;
    let t = { chainId: R.chainId, endIndex: e, modelIndex: c, startIndex: e };
    (O(null), W(t), j(t));
  }
  function $() {
      ...
      return (
        ...
        (async () => {
          try {
            ...
            if (!e) return;
            let i = r(d, { backgroundColor: `white`, disableFog: !0 });
            ((M.current = i),
              i.addModel(I, `pdb`),
              ie(i, null),
              i.zoomTo(),
            ...
            e && (q(d, M.current), (M.current = null), h(`error`));
          }
        })(),
        () => {
                  ...
                  ? (0, Q.jsx)(a, {
                      ...
                      triggerButton: (0, Q.jsxs)(x, {
                        ...
                        children: [
                          ...
                          (0, Q.jsx)(te, { className: `icon-2xs opacity-65` }),
                        ],
                      }),
                      children: P.map((e, t) =>
                        (0, Q.jsx)(
...
function ne(e) {
  ...
  t[0] === r
    ? (a = t[1])
    : ((a = y(`flex h-full min-h-0 flex-col bg-token-main-surface-primary`, r)),
      (t[0] = r),
      (t[1] = a));
  let o;
  t[2] === i
...
function re(e) {
  ...
  let w = C,
    T;
  t[3] !== n || t[4] !== f || t[5] !== r || t[6] !== l.chainId
    ? ((T =
        n.length > 1
          ? (0, Q.jsx)(a, {
              align: `start`,
              ...
              children: n.map((e) =>
                (0, Q.jsx)(
                  g.Item,
                  {
                    RightIcon: e.chainId === l.chainId ? ee : void 0,
  ...
  t[20] === o
    ? (j = t[21])
    : ((j = (e) => {
        if (h.current !== e.pointerId) return;
      ...
      (t[21] = j));
  let M;
  if (t[22] !== f || t[23] !== s || t[24] !== l.residues || t[25] !== v) {
    let e;
    (t[27] !== f || t[28] !== s || t[29] !== v
      ? ((e = (e, t) => {
          let n = v != null && t >= v.startIndex && t <= v.endIndex,
            r = n && t === v?.startIndex,
            i = n && t === v?.endIndex;
          return (0, Q.jsx)(
            `button`,
...
function K(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = y(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === i
    ? (a = t[3])
...
//# sourceMappingURL=preview-DkI0lhwY.js.map
