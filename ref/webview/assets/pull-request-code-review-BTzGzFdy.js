...
function Ie(e) {
  let t = (0, $e.c)(173),
    ...
    ne = A.getItem(j, NaN),
    re = Number.isFinite(ne) && ne <= 1,
    M;
  t[0] === u ? (M = t[1]) : ((M = We(u)), (t[0] = u), (t[1] = M));
  let N = re ? Ue(ne) : M,
    [P, F] = (0, X.useState)(0),
    [I, L] = (0, X.useState)(!1),
    R = (0, X.useRef)(null),
  ...
  (t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    (0, X.useEffect)(me, he));
  let ge, _e;
  (t[8] !== P || t[9] !== D || t[10] !== T || t[11] !== E || t[12] !== v
    ? ((ge = () => {
        !P || !D || (!T && !E && v?.(!0));
      }),
      (_e = [P, D, T, E, v]),
  ...
  t[30] !== j
    ? ((ve = () => {
        ...
        oe.current
          ? i && Re([le, V, H], B)
          : (Re([le, V, H], B), (oe.current = !0));
        let a = () => {
          ((se.current = t), (ce.current = k));
        };
        if (C > 0 && D && t <= C && !de) {
          (Xe({
            containerWidth: t,
        ...
        if (!O) {
          let n = o * Ue(U.current),
            { rightWidth: r, boundedLeftRatio: i } = Ye({
              containerWidth: t,
              minLeftWidth: b,
              minRightWidth: x,
              leftWidth: n,
          ...
          U.current = i;
          let s = Je(W.current > 0 ? W.current : r, o);
          ((W.current = s),
            Qe({
              containerWidth: t,
              handleWidth: 0,
  ...
  t[48] !== A ||
  t[49] !== j
    ? ((ye = [P, k, O, K, C, h, w, de, D, G, T, E, I, b, x, te, A, j]),
      (t[32] = P),
      (t[33] = C),
      (t[34] = h),
      (t[35] = w),
  ...
  t[57] !== L
    ? ((be = (e) => {
        ...
        ((ie.current = r.left), T || v?.(!0), E || y?.(!0), L(!0));
      }),
      (t[51] = P),
      (t[52] = G),
      (t[53] = T),
  ...
  t[93] !== y
    ? ((we = (e) => {
        ...
        let r = Ve(n),
          i = r * Ue(U.current),
          { rightWidth: a, boundedLeftRatio: o } = Ye({
            containerWidth: n,
            minLeftWidth: b,
            minRightWidth: x,
            leftWidth: i,
        ...
        U.current = o;
        let s = Je(W.current > 0 ? W.current : a, r);
        ((W.current = s),
          Qe({
            containerWidth: n,
            handleWidth: 0,
  ...
  let J = Te,
    Ee;
  t[111] !== q || t[112] !== J || t[113] !== T || t[114] !== E
    ? ((Ee = (e) => {
        if (e === `left`) {
          if (T) {
            q(`left`);
  ...
  let Oe = De,
    ke = D && !G && k && O,
    Ae = `min(calc(100% - ${S}px), max(0px, ${k && O ? `calc(var(--split-left-width, 100%) - (${S}px / 2))` : `calc(100% - (${S}px / 2))`}))`,
    je = I && `cursor-col-resize`,
    Me;
  t[123] !== a || t[124] !== je
    ? ((Me = ae(
  ...
  t[129] === Fe
    ...
    : ((Ie = {
        ...
        contain: `strict`,
        transitionProperty: Fe,
      }),
      (t[129] = Fe),
      (t[130] = Ie));
  let Ge = k ? `visible` : `hidden`,
    Ke = `${n}-left`,
    qe;
  t[131] !== r || t[132] !== Ge || t[133] !== Ke
    ? ((qe = (0, Z.jsx)(`div`, {
        className: `h-full min-w-0`,
        children: (0, Z.jsx)(X.Activity, { mode: Ge, name: Ke, children: r }),
      })),
      (t[131] = r),
      (t[132] = Ge),
      (t[133] = Ke),
  ...
  let st = G
    ...
    ut;
  t[149] !== c || t[150] !== st || t[151] !== ct || t[152] !== lt
    ? ((ut = ae(
      ...
      (t[153] = ut))
    : (ut = t[153]);
  let dt = I ? `none` : `width, transform, opacity`,
    ft;
  t[154] === dt
    ? (ft = t[155])
    : ((ft = {
        ...
        ? (0, Z.jsx)(`div`, {
            ...
            children: (0, Z.jsx)(X.Activity, {
              ...
              children: (0, Z.jsx)(`div`, {
                ...
                style: { transitionDelay: O ? `${it}ms` : `0ms` },
                children: i,
              }),
            }),
          })
  ...
  t[161] !== ut || t[162] !== ft || t[163] !== pt
    ...
    : (mt = t[164]);
  let ht;
  t[165] !== Me || t[166] !== nt || t[167] !== at || t[168] !== mt
    ? ((ht = (0, Z.jsxs)(`div`, {
        ref: R,
        className: Me,
        children: [nt, at, mt],
  ...
  return (
    t[170] !== Oe || t[171] !== ht
      ? ((Q = (0, Z.jsx)(ot.Provider, { value: Oe, children: ht })),
        (t[170] = Oe),
        (t[171] = ht),
        (t[172] = Q))
      : (Q = t[172]),
...
function Ye({
  ...
  let i = Ve(e),
    a = qe(r, e, t, n),
    o = Je(Math.max(0, i - a), i);
  return {
    openAvailableWidth: i,
    boundedLeftWidth: a,
    boundedLeftRatio: Ge(i, a),
    rightWidth: o,
  };
}
function Xe({
  ...
  let s = Ne({ containerWidth: e, maxWidth: t, minWidth: r, visibleInset: n });
  Qe({
    containerWidth: e,
    handleWidth: 0,
    nextLeftWidth: e,
...
var $e,
  ...
  st = e(() => {
    (($e = v()),
      ...
      (rt = 720),
      (it = 150),
      (at = { version: 0, listeners: new Set() }),
      (ot = (0, X.createContext)(null)));
  });
function ct() {
  let e = (0, lt.c)(30),
    t = b(ue),
  ...
  e[9] === t
    ? (p = e[10])
    : ((p = (e) => {
        t.set(ie, e === `left` ? `unified` : `split`);
      }),
      (e[9] = t),
      (e[10] = p));
  let h;
  e[11] !== r || e[12] !== p
    ? ((h = (0, dt.jsx)(D, { diffMode: r, onSelectDiffMode: p })),
      (e[11] = r),
      (e[12] = p),
      (e[13] = h))
    : (h = e[13]);
  let g = i ? `secondary` : `ghost`,
    _;
  e[14] !== i || e[15] !== t
    ? ((_ = () => {
        _e(t, !i);
  ...
  e[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, dt.jsx)(ee, { className: `icon-xs` })), (e[17] = v))
    : (v = e[17]);
  let y;
  e[18] !== l || e[19] !== i || e[20] !== g || e[21] !== _
    ? ((y = (0, dt.jsx)(ce, {
        "aria-label": l,
        "aria-pressed": i,
        color: g,
  ...
  let x;
  e[23] !== l || e[24] !== y
    ? ((x = (0, dt.jsx)(m, { tooltipContent: l, delayOpen: !0, children: y })),
      (e[23] = l),
      (e[24] = y),
      (e[25] = x))
    : (x = e[25]);
...
function pt(e) {
  let t = (0, mt.c)(59),
    {
      ...
      path: l,
      reviewDiffMetrics: u,
      renderReadonlyCommentActions: d,
      renderReadonlyCommentBody: f,
      onRequestChanges: p,
    } = e,
    m = b(ue),
    g = re(),
    ee;
  t[0] !== l || t[1] !== n
    ? ((ee = { path: l, request: n }), (t[0] = l), (t[1] = n), (t[2] = ee))
    : (ee = t[2]);
  let v = _(J, ee),
    y;
  t[3] !== l || t[4] !== n
    ? ((y = { path: l, request: n }), (t[3] = l), (t[4] = n), (t[5] = y))
    : (y = t[5]);
  let x = _(ke, y),
    S;
  t[6] !== l || t[7] !== n
    ? ((S = { path: l, request: n }), (t[6] = l), (t[7] = n), (t[8] = S))
    : (S = t[8]);
  let C = _(q, S),
    T;
  t[9] !== l || t[10] !== n
    ? ((T = { path: l, request: n }), (t[9] = l), (t[10] = n), (t[11] = T))
    : (T = t[11]);
  let E = _(Ee, T),
    te = w(G),
    D = w(H),
    [O, k] = (0, ht.useState)(s.metadata.type !== `deleted`),
    A;
  if (t[12] !== g || t[13] !== l || t[14] !== n || t[15] !== m || t[16] !== E) {
    let e;
    (t[18] !== g || t[19] !== l || t[20] !== n || t[21] !== m
      ? ((e = (e) => {
  ...
  t[27] !== v || t[28] !== l || t[29] !== n || t[30] !== m
    ? ((M = (e) => {
      ...
      (t[31] = M))
    : (M = t[31]);
  let N = s.metadata.additionLines ? `line-info` : `metadata`,
    P;
  t[32] !== m || t[33] !== D
    ? ((P = () => {
        m.set(H, !D);
  ...
  return (
    t[56] !== F || t[57] !== A
      ? ((I = (0, Q.jsxs)(Q.Fragment, { children: [A, F] })),
        (t[56] = F),
        (t[57] = A),
        (t[58] = I))
      : (I = t[58]),
...
function _t(e) {
  let t = (0, St.c)(88),
    ...
    C = n.account,
    T = _(P, C.hostId),
    E = x(f.codeFontSize) ?? 12,
    te;
  t[0] === E ? (te = t[1]) : ((te = i(E)), (t[0] = E), (t[1] = te));
  let D = te,
    [O] = (0, Ct.useState)(bt),
    k = (0, Ct.useRef)(null),
    A;
  t[2] !== u || t[3] !== O
    ? ((A = (e) => {
        if (e == null) {
          (k.current != null && he(u, k.current.scrollTop),
            (k.current = null),
            O.cleanUp());
          return;
        }
        ((k.current = e), O.setup(e), (e.scrollTop = u.get(be)));
      }),
      (t[2] = u),
      (t[3] = O),
      (t[4] = A))
  ...
  if (m?.data?.status !== `success` || m.data.headRevision !== a) {
    let e;
    t[7] === m
      ? (e = t[8])
      : ((e = () => {
    ...
    t[10] === e
      ? (r = t[11])
      : ((r = (0, $.jsx)(ce, { color: `secondary`, onClick: e, children: n })),
        (t[10] = e),
        (t[11] = r));
    let i;
    t[12] === m
  ...
  t[19] === s
    ? (M = t[20])
    : ((M = s?.trim() || null), (t[19] = s), (t[20] = M));
  let N = M,
    F;
  t[21] === r
    ? (F = t[22])
    : ((F = r?.trim() || null), (t[21] = r), (t[22] = F));
  let I = F,
    L;
  t[23] === h ? (L = t[24]) : ((L = h ?? []), (t[23] = h), (t[24] = L));
  let R;
  if (
    t[25] !== C ||
    t[26] !== d ||
  ...
  t[50] !== n || t[51] !== u
    ...
    : (U = t[52]);
  let W;
  t[53] !== S || t[54] !== H || t[55] !== U || t[56] !== g
    ? ((W = (0, $.jsx)(`div`, {
        className: `min-h-0 flex-1`,
        children: (0, $.jsx)(de, {
          activePath: H,
          commentCountByPath: S,
          cwd: null,
          entries: g,
          onSelectPath: U,
        }),
  ...
  return (
    t[85] !== ke || t[86] !== O
      ? ((je = (0, $.jsx)(o.Provider, { value: O, children: ke })),
        (t[85] = ke),
        (t[86] = O),
        (t[87] = je))
      : (je = t[87]),
...
//# sourceMappingURL=pull-request-code-review-BTzGzFdy.js.map
