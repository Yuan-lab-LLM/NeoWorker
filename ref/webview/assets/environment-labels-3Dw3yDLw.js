      ...
      (ze = G(
        ...
        (
          ...
          return z(
            ...
            L(n),
            n,
            { enabled: t, staleTime: q.FIVE_SECONDS },
          );
        },
        { key: Le },
      )));
...
function Ye(e, t) {
  ...
  n[0] === i
    ? (a = n[1])
    : ((a = { retainRepoWatch: i }), (n[0] = i), (n[1] = a));
  let { data: o } = he(e, t, a),
    s = e?.cwd ?? null,
    c = e?.hostId ?? null,
    u;
  n[2] !== s || n[3] !== c
    ? ((u = [`vscode`, `git-checkout-branch`, s, c]),
      (n[2] = s),
      (n[3] = c),
      (n[4] = u))
    : (u = n[4]);
    ...
    ? ((p = (t) => {
        e != null &&
          ...
          l(
            ...
            { changeType: `head`, hostKey: L(e.hostConfig) },
          );
      }),
      (n[8] = o),
      (n[9] = r),
...
function Qe(e, t) {
  ...
  let { data: o } = he(e, t, a),
    ...
    u;
  n[2] !== s || n[3] !== c
    ? ((u = [`vscode`, `git-create-branch`, s, c]),
      (n[2] = s),
      (n[3] = c),
      (n[4] = u))
    : (u = n[4]);
  ...
  n[8] !== o || n[9] !== r || n[10] !== e
    ? ((p = (t, n, i) => {
        if (e != null && o != null) {
          ...
          l(r, o, { changeType: t, hostKey: L(e.hostConfig) });
        }
      }),
      (n[8] = o),
      (n[9] = r),
...
function it(e) {
  ...
  let [N, P] = (0, Z.useState)(M),
    [F, I] = (0, Z.useState)(`idle`),
    ae;
  t[1] !== n || t[2] !== i
    ? ((ae = n == null ? null : Ce({ hostConfig: i, root: n })),
      (t[1] = n),
      (t[2] = i),
      (t[3] = ae))
    : (ae = t[3]);
  let L = ae,
    R;
  t[4] !== i || t[5] !== L
    ? ((R = L == null ? null : { cwd: L.cwd, hostConfig: i }),
      (t[4] = i),
      (t[5] = L),
      (t[6] = R))
    : (R = t[6]);
  let oe;
  t[7] !== s || t[8] !== R
    ? ((oe = { enabled: s, operationSource: $, lookup: R }),
      (t[7] = s),
      (t[8] = R),
      (t[9] = oe))
    : (oe = t[9]);
  ...
  t[30] !== L || t[31] !== g
    ? ((Ee = () => {
        L != null && (g.set(S, ge(L), ``), I(`idle`), ie(at), b(!1), E(!0));
      }),
      (t[30] = L),
      (t[31] = g),
      (t[32] = Ee))
  ...
  let De = Ee,
    Oe;
  t[33] !== ve || t[34] !== be || t[35] !== Se || t[36] !== A
    ? ((Oe = (e) => {
        if (e === `success` && A != null) {
          let e = A;
  ...
  let ke = Oe;
  if (!V)
    return s && z.isSuccess
      ? d({
          currentBranch: null,
          disabled: !1,
          isPending: !1,
          switchTooltipText: ue,
        })
      : null;
  if (n == null || p) return u?.({ currentBranch: B }) ?? null;
  let je = _,
    Me;
  t[38] === f
    ? (Me = t[39])
  ...
  let Re;
  return (
    t[80] !== X || t[81] !== Fe || t[82] !== Ie || t[83] !== Le
      ? ((Re = (0, Q.jsxs)(Q.Fragment, { children: [X, Fe, Ie, Le] })),
        (t[80] = X),
        (t[81] = Fe),
        (t[82] = Ie),
        (t[83] = Le),
...
function ot(e) {
  let t = (0, pt.c)(55),
    ...
    p = fe(d, 200),
    m;
  t[0] === a ? (m = t[1]) : ((m = { enabled: a }), (t[0] = a), (t[1] = m));
  let { data: h } = Ve(r, i, $, m),
    g;
  t[2] === a ? (g = t[3]) : ((g = { enabled: a }), (t[2] = a), (t[3] = g));
  let {
      data: _,
      isLoading: v,
      isFetching: ee,
    ...
    ne = _ === void 0 ? [] : _,
    re;
  t[4] === a ? (re = t[5]) : ((re = { enabled: a }), (t[4] = a), (t[5] = re));
  let { data: b } = Pe(r, i, $, re),
    x;
  t[6] === d ? (x = t[7]) : ((x = d.trim()), (t[6] = d), (t[7] = x));
  let S = x,
    w;
  t[8] === p ? (w = t[9]) : ((w = p.trim()), (t[8] = p), (t[9] = w));
  let T = w,
    E = S !== T,
    O = T.length > 0,
    k;
  t[10] !== r || t[11] !== i || t[12] !== T || t[13] !== O
    ? ((k = {
        cwd: r,
        hostConfig: i,
        operationSource: $,
      ...
      (t[14] = k))
    : (k = t[14]);
  let { data: ie, isFetching: A, isError: j, refetch: M } = C(ze, k),
    N = ie?.branches,
    P = dt({ branches: ne, currentBranch: n, defaultBranch: b }),
    F = !v && !ee && !te && ne.length === 0,
    I;
  t[15] !== o || t[16] !== F || t[17] !== h
    ? ((I = tt({ disabled: o, hasNoCommits: F, statusSummary: h })),
      (t[15] = o),
      (t[16] = F),
      (t[17] = h),
      (t[18] = I))
    : (I = t[18]);
  let {
      branchSelectionDisabled: ae,
      createAndCheckoutDisabled: L,
      uncommittedFileCount: R,
    } = I,
    oe;
  t[19] !== F || t[20] !== u
    ? ((oe = F
  ...
  t[44] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = (0, Q.jsx)(se.Separator, {})), (t[44] = le))
    : (le = t[44]);
  let q;
  t[45] === l
    ? (q = t[46])
  ...
  return (
    t[52] !== K || t[53] !== Y
      ? ((de = (0, Q.jsxs)(Q.Fragment, { children: [K, le, Y] })),
        (t[52] = K),
        (t[53] = Y),
        (t[54] = de))
      : (de = t[54]),
...
function st(e) {
  let t = (0, pt.c)(57),
    ...
    l = ce(),
    u = ie(Ne.branchPrefix),
    d;
  t[0] !== u || t[1] !== i
    ? ((d = oe({ branchPrefix: u, conversationTitle: i })),
      (t[0] = u),
      (t[1] = i),
      (t[2] = d))
    : (d = t[2]);
  ...
  let { data: _, isLoading: te, isFetching: y, isError: b } = We(a, o, $, h),
    x,
    S,
    C,
    w;
  if (t[5] !== f || t[6] !== _) {
    x = _ === void 0 ? [] : _;
    let e = dt({ branches: x, currentBranch: ``, defaultBranch: null });
    ((w = f.trim()),
      (S = w.endsWith(`/`)),
      ...
      (t[9] = C),
      (t[10] = w));
  } else ((x = t[7]), (S = t[8]), (C = t[9]), (w = t[10]));
  let T = C,
    E = !te && !y && !b && x.length === 0,
    D = !s && !te && !y && !E && w.length > 0 && !S && !T && a != null,
    O;
  ...
  t[37] === L
    ? (z = t[38])
    : ((z = (0, Q.jsx)(me, { color: `secondary`, onClick: L, children: R })),
      (t[37] = L),
      (t[38] = z));
  let B = !D,
    V;
  ...
  let W;
  t[47] !== z || t[48] !== U
    ? ((W = (0, Q.jsx)(X, { children: (0, Q.jsxs)(re, { children: [z, U] }) })),
      (t[47] = z),
      (t[48] = U),
      (t[49] = W))
    : (W = t[49]);
...
function ct(e) {
  ...
  t[4] === n
    ? (f = t[5])
    : ((f = { enabled: n, liveQuery: ut, staleTime: 1 / 0 }),
      (t[4] = n),
      (t[5] = f));
  let { data: p } = ve(a, o, `review-summary`, d, $, f),
    h;
  t[6] === a ? (h = t[7]) : ((h = x(a)), (t[6] = a), (t[7] = h));
  let _;
  t[8] === h
    ? (_ = t[9])
    : ((_ = { cwd: h, operationSource: $, source: `unstaged` }),
      (t[8] = h),
      (t[9] = _));
  let v;
  t[10] === n
    ? (v = t[11])
    : ((v = { enabled: n, liveQuery: lt, staleTime: 1 / 0 }),
      (t[10] = n),
      (t[11] = v));
  let { data: y } = ve(a, o, `review-summary`, _, $, v),
    ne,
    b,
    S,
    C,
  ...
  if (
    ...
    let e = [p, y],
      ...
      d = i.length > 0,
      f;
    t[28] === l ? (f = t[29]) : ((f = nt(l)), (t[28] = l), (t[29] = f));
    let h = f;
    ((S = g),
      (C = `feature`),
      (w = n),
        ...
        : u
          ...
          : s == null
            ...
            : (0, Q.jsx)(H, {
                ...
                values: { fileCount: h, branchName: s },
              })),
      (t[12] = i),
      (t[13] = r),
      (t[14] = n),
  ...
  t[38] === ie
    ? (j = t[39])
    : ((j = (0, Q.jsx)(me, { color: `secondary`, onClick: ie, children: A })),
      (t[38] = ie),
      (t[39] = j));
  let M;
  ...
  t[41] === c
    ? (N = t[42])
    : ((N = (0, Q.jsx)(me, { color: `primary`, onClick: c, children: M })),
      (t[41] = c),
      (t[42] = N));
  let P;
  t[43] !== j || t[44] !== N
    ? ((P = (0, Q.jsx)(X, { children: (0, Q.jsxs)(re, { children: [j, N] }) })),
      (t[43] = j),
      (t[44] = N),
      (t[45] = P))
    : (P = t[45]);
  let F;
  t[46] !== b || t[47] !== k || t[48] !== P || t[49] !== O
    ? ((F = (0, Q.jsxs)(b, { children: [O, k, P] })),
      (t[46] = b),
      (t[47] = k),
      (t[48] = P),
      (t[49] = O),
  ...
  let L;
  return (
    t[51] !== S || t[52] !== C || t[53] !== w || t[54] !== T || t[55] !== F
      ? ((L = (0, Q.jsx)(S, {
          size: C,
          open: w,
          onOpenChange: T,
...
//# sourceMappingURL=environment-labels-3Dw3yDLw.js.map
