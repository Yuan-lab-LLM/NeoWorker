...
function v(e) {
  ...
  t[20] === F
    ? (I = t[21])
    : ((I = m(S, `col-start-1 row-start-1`, F)), (t[20] = F), (t[21] = I));
  let L = o === `chat`,
    R = p && o === `chat` ? c : void 0,
    z;
  t[22] !== s || t[23] !== o
  ...
  let H;
  t[33] !== g || t[34] !== V
    ? ((H = (0, x.jsx)(i, { disabled: g, tooltipContent: N, children: V })),
      (t[33] = g),
      (t[34] = V),
      (t[35] = H))
    : (H = t[35]);
  ...
  t[37] === G
    ? (K = t[38])
    : ((K = m(S, `col-start-2 row-start-1`, G)), (t[37] = G), (t[38] = K));
  let q = o === `work`,
    J = p && o === `work` ? c : void 0,
    Y;
  t[39] !== s || t[40] !== o
  ...
  let Q;
  t[50] !== g || t[51] !== Z
    ? ((Q = (0, x.jsx)(i, { disabled: g, tooltipContent: U, children: Z })),
      (t[50] = g),
      (t[51] = Z),
      (t[52] = Q))
    : (Q = t[52]);
...
e(() => {
  ((y = a()),
    ...
    (C = { duration: 300 / 1e3, ease: _ }));
})();
export { v as HomeComposerModeToggle };
//# sourceMappingURL=home-composer-mode-toggle-CgZSTsCs.js.map
