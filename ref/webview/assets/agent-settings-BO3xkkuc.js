...
import {
  ...
  n as nn,
  r as rn,
} from "./settings-route-state-DB76KYn2.js";
import { n as an, t as on } from "./settings-loading-row-BdxyJgCw.js";
function sn(e) {
  if (e == null) return 0;
  switch (e.phase) {
    case `checking`:
...
async function pn({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await Ft(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
  ...
  if (r !== n)
    try {
      await Ft(`local-environment-config-save`, {
...
function Sn(e) {
  let t = (0, En.c)(26),
    ...
    i = Ae(),
    [a, o] = (0, Dn.useState)(!1),
    [s] = h(`statsig_default_enable_features`),
    c = yt(_e(Qe)),
    { data: l, isLoading: u } = oe(C, n),
    d = l === void 0 ? [] : l,
    f;
  ...
  t[7] === T
    ? (E = t[8])
    : ((E = (0, Z.jsx)(Y.Header, { title: w, subtitle: T })),
      (t[7] = T),
      (t[8] = E));
  let D = Y,
    O = tt,
  ...
  let j = b.map((e) =>
    ...
    M;
  t[14] !== O || t[15] !== j || t[16] !== k || t[17] !== A
    ? ((M = (0, Z.jsxs)(O, { children: [k, A, j] })),
      (t[14] = O),
      (t[15] = j),
      (t[16] = k),
      (t[17] = A),
    ...
    : (M = t[18]);
  let N;
  t[19] !== M || t[20] !== D.Content
    ? ((N = (0, Z.jsx)(D.Content, { children: M })),
      (t[19] = M),
      (t[20] = D.Content),
      (t[21] = N))
    : (N = t[21]);
  let P;
  return (
    t[22] !== S || t[23] !== N || t[24] !== E
      ? ((P = (0, Z.jsxs)(S, { children: [E, N] })),
        (t[22] = S),
        (t[23] = N),
        (t[24] = E),
        (t[25] = P))
...
function kn(e) {
  ...
  let { data: u } = Be(l),
    ...
    w,
    T;
  if (t[2] !== o || t[3] !== n || t[4] !== u || t[5] !== i) {
    g = Symbol.for(`react.early_return_sentinel`);
    bb0: {
      let e;
      t[20] !== u?.hasModelSupportingMaxReasoningEffort ||
      t[21] !== u?.hasModelSupportingUltraReasoningEffort
        ? ((e = (e) =>
            e === `max`
              ? u?.hasModelSupportingMaxReasoningEffort === !0
              : u?.hasModelSupportingUltraReasoningEffort === !0),
          (t[20] = u?.hasModelSupportingMaxReasoningEffort),
          (t[21] = u?.hasModelSupportingUltraReasoningEffort),
          (t[22] = e))
        : (e = t[22]);
      let a = Mn.filter(e);
      if (u == null || a.length === 0) {
        g = null;
        break bb0;
      }
      let s;
      t[23] === o
        ? (s = t[24])
        : ((s = (e) => o.has(e)), (t[23] = o), (t[24] = s));
      let c = Fe.length + a.filter(s).length;
      ((h = Y),
  ...
  t[36] !== S
    ...
    : (E = t[37]);
  let O;
  t[38] !== f || t[39] !== E || t[40] !== C || t[41] !== w
    ? ((O = (0, Q.jsx)(f, { label: C, description: w, control: E })),
      (t[38] = f),
      (t[39] = E),
      (t[40] = C),
      (t[41] = w),
  ...
  let k;
  t[43] !== a ||
  t[44] !== u.hasModelSupportingUltraReasoningEffort ||
  t[45] !== c ||
  t[46] !== s
    ? ((k = u.hasModelSupportingUltraReasoningEffort
        ? (0, Q.jsx)(J, {
            label: (0, Q.jsx)(G, {
            ...
            control: (0, Q.jsx)(Yt, {
              "aria-busy": c.isPending || void 0,
              checked: s?.ultraEffortEnabled === !0,
              disabled: s == null || c.isPending,
              onChange: (e) => {
                c.mutate(e);
              },
    ...
    : (k = t[47]);
  let A;
  t[48] !== p || t[49] !== O || t[50] !== k
    ? ((A = (0, Q.jsxs)(p, { children: [O, k] })),
      (t[48] = p),
      (t[49] = O),
      (t[50] = k),
      (t[51] = A))
  ...
  let M;
  return (
    t[55] !== h || t[56] !== j || t[57] !== T
      ? ((M = (0, Q.jsxs)(h, { children: [T, j] })),
        (t[55] = h),
        (t[56] = j),
        (t[57] = T),
        (t[58] = M))
...
function An(e) {
  return (0, Q.jsx)(
    K.CheckboxItem,
    { checked: !0, disabled: !0, children: (0, Q.jsx)(At, { effort: e }) },
    e,
  );
}
var jn,
    ...
    children: (0, $.jsxs)(ft, {
      ...
      children: [
        ...
        (0, $.jsx)(H, {
          electron: !0,
          children:
            a && t.kind === `local` ? (0, $.jsx)(Fn, { hostId: e }) : null,
        }),
      ],
    }),
  });
...
function In(e) {
  let t = (0, Xn.c)(98),
    ...
    a = Ae(),
    o = Vt(),
    { data: s, isLoading: c } = oe(C, n),
    l;
  t[0] === n ? (l = t[1]) : ((l = { hostId: n }), (t[0] = n), (t[1] = l));
  let u = Mt(l),
    d;
  t[2] === s ? (d = t[3]) : ((d = s?.find(Ln)), (t[2] = s), (t[3] = d));
  let f = d,
    p = f?.enabled === !0,
    m;
  t[4] !== n || t[5] !== r
    ? ((m = () => r.diagnoseDependencies({ hostId: n })),
      (t[4] = n),
      (t[5] = r),
      (t[6] = m))
    : (m = t[6]);
  let h;
  t[7] === n ? (h = t[8]) : ((h = Me(n)), (t[7] = n), (t[8] = h));
  let g;
  t[9] !== m || t[10] !== h
    ? ((g = { queryFn: m, queryKey: h, staleTime: et.FIVE_SECONDS }),
      (t[9] = m),
      (t[10] = h),
      (t[11] = g))
    : (g = t[11]);
  let _ = Jt(g),
    v;
  t[12] !== n || t[13] !== r
    ? ((v = { mutationFn: () => r.diagnoseDependencies({ hostId: n }) }),
      (t[12] = n),
      (t[13] = r),
      (t[14] = v))
    : (v = t[14]);
  ...
  t[15] !== r || t[16] !== o
    ? ((b = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Je(o), r.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = r),
      (t[16] = o),
  ...
  t[18] !== n || t[19] !== r || t[20] !== o
    ? ((S = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Je(o), r.resetDependencies({ hostId: n, release: t }));
        },
      }),
      (t[18] = n),
      (t[19] = r),
  ...
  t[22] === n
    ? (T = t[23])
    : ((T = { mutationFn: () => ye({ hostId: n }) }), (t[22] = n), (t[23] = T));
  let E = jt(T),
    D = _e(Ve),
    O = _e(ee),
    A = D?.hostId === n ? D : null,
    j;
  t[24] === i ? (j = t[25]) : ((j = i.get(de)), (t[24] = i), (t[25] = j));
  let M = j,
    N =
      c ||
      u.isPending ||
      ...
      E.isPending,
    P;
  t[26] === A ? (P = t[27]) : ((P = Pt(A)), (t[26] = A), (t[27] = P));
  let F = P,
    te =
      _.data?.bundleVersion == null || _.data.bundleVersion.length === 0
        ? null
        : _.data.bundleVersion,
    I;
  t[28] !== y || t[29] !== _ || t[30] !== a || t[31] !== i || t[32] !== M
    ? ((I = () => {
        let e = Date.now();
        y.mutateAsync()
          .then((t) => {
            if (
              (ke(i, k, it({ diagnostics: t, durationMs: Date.now() - e })),
              _.refetch(),
              t.installed)
            ) {
              M.success(
          ...
          .catch(() => {
            (ke(i, k, Ht({ durationMs: Date.now() - e })),
              M.danger(
                a.formatMessage({
  ...
  let re = L,
    ie;
  t[41] !== E || t[42] !== _ || t[43] !== a || t[44] !== i || t[45] !== M
    ? ((ie = () => {
        E.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((i.set(Ve, null), _.refetch(), !t)) {
              M.info(
                a.formatMessage({
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, $.jsx)(Y.Header, {
        title: (0, $.jsx)(G, { ...X.workspaceDependencies }),
      })),
      (t[47] = R))
    : (R = t[47]);
  let se, ce;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, $.jsx)(G, { ...X.codexDependencies })),
      (ce = (0, $.jsx)(G, {
      ...
      (t[49] = ce))
    : ((se = t[48]), (ce = t[49]));
  let le = c || u.isPending || f == null,
    z;
  t[50] !== O || t[51] !== x || t[52] !== u
    ? ((z = (e) => {
        u.mutate(
          { enabled: e, featureName: je },
          {
            onSuccess: () => {
              e && x.mutate({ release: O });
            },
          },
        );
      }),
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (0, $.jsx)(G, { ...X.diagnoseWorkspaceDependencies })),
      (me = (0, $.jsx)(G, {
  ...
  t[63] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = (0, $.jsx)(ze, { className: `icon-2xs` })),
      (ge = (0, $.jsx)(G, {
    ...
    : ((he = t[63]), (ge = t[64]));
  let ve;
  t[65] !== y.isPending || t[66] !== ne || t[67] !== w.isPending
    ? ((ve = (0, $.jsx)(J, {
        label: pe,
        description: me,
        control: (0, $.jsxs)(ut, {
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((be = (0, $.jsx)(G, { ...X.resetWorkspaceDependencies })),
      (V = (0, $.jsx)(G, {
      ...
      (t[70] = V))
    : ((be = t[69]), (V = t[70]));
  let xe = F ? E.isPending : w.isPending,
    Se = !p || (F ? E.isPending : N),
    Ce = F ? ae : re,
    H;
  t[71] === F
    ? (H = t[72])
    : ((H = F
      ...
      (t[72] = H));
  let U;
  t[73] !== xe || t[74] !== Se || t[75] !== Ce || t[76] !== H
    ? ((U = (0, $.jsx)(J, {
        label: be,
        description: V,
        control: (0, $.jsx)(ut, {
    ...
    : (U = t[77]);
  let W;
  t[78] !== fe || t[79] !== ve || t[80] !== U
    ? ((W = (0, $.jsx)(Y.Content, {
        children: (0, $.jsxs)(tt, { children: [fe, ve, U] }),
      })),
      (t[78] = fe),
      (t[79] = ve),
      (t[80] = U),
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = (0, $.jsx)(G, { ...X.currentDependencyVersion })), (t[82] = De))
    : (De = t[82]);
  let Oe;
  t[83] !== te || t[84] !== _.isLoading || t[85] !== F || t[86] !== A
    ? ((Oe = F
        ? cn(A, sn(A))
        : _.isLoading
          ? (0, $.jsx)(G, {
  ...
  t[88] === Oe
    ...
    : ((K = (0, $.jsxs)(`span`, {
        ...
        children: [De, (0, $.jsx)(`span`, { children: Oe })],
      })),
      (t[88] = Oe),
      (t[89] = K));
  let q;
  t[90] === _.data?.problems.length
    ? (q = t[91])
    : ((q = _.data?.problems.length
        ? (0, $.jsx)(`span`, {
            children: (0, $.jsx)(G, {
  ...
  let t = ue(vt),
    ...
    m = p.hasValue
      ...
      : e === `local`
        ...
        : null,
    h = _t(e),
    { data: g, isPending: _ } = Zt(m, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: v, isPending: y } = oe(gt, { hostId: e }),
    b = g?.config ?? null,
    S = g?.layers ?? null,
    C = g?.origins ?? null,
    w = v?.requirements ?? null,
    T = Vn(S, n),
    E = S?.find((e) => e.name.type === `user`) ?? null,
    O = S?.find((e) => x(e.name)) ?? null,
    k = h == null ? null : `${h}/config.toml`,
    A = E == null ? k : z(E.name),
    M = {
      key: `user`,
      kind: `user`,
      label: n.formatMessage(X.userConfig),
      tooltipText: A ?? `~/.codex/config.toml`,
      filePath: A,
      expectedVersion: E?.version ?? null,
      workspaceRoot: null,
      layer: E,
    },
    N =
    ...
    P = [...T, M, ...(N == null ? [] : [N])],
    F = T.length > 0,
    ee = m == null ? (P[0]?.key ?? null) : `project:${m}`,
    I =
      P.find((e) => e.key === i) ?? P.find((e) => e.key === ee) ?? P[0] ?? null,
    { data: ne } = oe(qt, {
      cwd:
        I?.workspaceRoot == null
          ? m == null
            ? null
            : ie(m)
          : ie(I.workspaceRoot),
    ...
    L = Wn(I?.layer?.config ?? null),
    re = Yn(b?.approval_policy ?? null) ?? `on-request`,
    R = b?.sandbox_mode == null ? `read-only` : b.sandbox_mode,
    se = L.sandboxMode == null && R === `workspace-write`,
    ce = L.sandboxMode === `workspace-write` || se,
    le = L.approvalPolicy ?? re,
    de = L.sandboxMode ?? R,
    B = qn(le),
    pe = Jn(de),
    me = L.networkAccess ?? b?.sandbox_workspace_write?.network_access ?? !1,
    he = C == null ? null : be(C, `approval_policy`, [`approvalPolicy`]),
    ge = C == null ? null : be(C, `sandbox_mode`),
    ve =
      C == null ? null : be(C, `sandbox_workspace_write`, [`network_access`]),
    ye = I?.kind === `project` ? (I.layer?.disabledReason ?? null) : null,
    V = Gn(I, n),
    xe = Qn.filter((e) =>
      w?.allowedApprovalPolicies == null ||
      w.allowedApprovalPolicies.length === 0
        ? !0
        : w.allowedApprovalPolicies.includes(e.value),
    ),
    Se = er.filter((e) =>
      w?.allowedSandboxModes == null || w.allowedSandboxModes.length === 0
        ? !0
        : w.allowedSandboxModes.includes(e.value),
    );
  async function Ce(n, r, i) {
    if (!(I == null || I.filePath == null) && o == null) {
      (c(n), u((e) => ({ ...e, [n]: void 0 })));
      try {
        if (I.kind === `project`)
          await fn({ filePath: I.filePath, keyPath: r, value: i });
        else {
          let n = I.kind === `user` ? await ae(t.queryClient, e) : null;
          await rt(`write-config-value`, {
            hostId: e,
            keyPath: r,
            value: i,
            mergeStrategy: `upsert`,
            filePath: n ? n.filePath : I.filePath,
            expectedVersion: n == null ? I.expectedVersion : n.expectedVersion,
          });
        }
        (await t.queryClient.invalidateQueries({ queryKey: [...fe, e] }),
          await Promise.all([
            t.queryClient.invalidateQueries({ queryKey: [...f, e] }),
            t.queryClient.invalidateQueries({ queryKey: [...s, e] }),
          ]));
      } catch (e) {
        u((t) => ({
          ...t,
    ...
    children: [
      (0, $.jsx)(Y.Header, {
        title: (0, $.jsxs)(D, {
          ...
          children: [
                    ...
                    (0, $.jsxs)(K.Section, {
                      children: [
                        (0, $.jsx)(K.SectionLabel, {
                          children: (0, $.jsx)(G, { ...X.projectConfig }),
                        }),
                        T.map((e) =>
                          (0, $.jsx)(
                            zn,
            ...
            (0, $.jsxs)(K.Section, {
              children: [
                (0, $.jsx)(K.SectionLabel, {
                  children: (0, $.jsx)(G, { ...X.globalConfig }),
                }),
                (0, $.jsx)(zn, {
                  scopeOption: M,
                  selected: I?.key === M.key,
                  onSelect: () => {
                    W(M.key);
                  },
                }),
        ...
        actions: (0, $.jsxs)(ut, {
          color: `ghost`,
          size: `toolbar`,
          disabled: I?.filePath == null,
          onClick: () => {
            I?.filePath != null &&
              $e({
                path: I.filePath,
                cwd: I.workspaceRoot == null ? null : ie(I.workspaceRoot),
                hostId: e,
                target: ne?.preferredTarget,
              });
          },
          children: [
            (0, $.jsx)(G, {
      ...
      (0, $.jsxs)(Y.Content, {
        children: [
          ye == null
            ? null
            : (0, $.jsx)(Wt, { content: ye, Icon: lt, type: `warning` }),
          (0, $.jsxs)(tt, {
            children: [
              (0, $.jsx)(J, {
                label: (0, $.jsx)(G, { ...X.approvalPolicy }),
                ...
                control: (0, $.jsx)(D, {
                  ...
                  triggerButton: (0, $.jsx)(te, {
                    disabled: U || Te != null,
                    contentClassName: `truncate`,
                    children: B == null ? le : n.formatMessage(B.label),
                  }),
                  children: xe.map((e) =>
                    (0, $.jsx)(
                      K.Item,
                      {
                        RightIcon: e.value === le ? Nt : void 0,
                        subTextAllowWrap: !0,
                        onSelect: () => {
                          Ce(`approval`, `approval_policy`, e.value);
                        },
                        SubText: (0, $.jsx)(`div`, {
              ...
              (0, $.jsx)(J, {
                label: (0, $.jsx)(G, { ...X.sandboxSettings }),
                description: (0, $.jsx)(Bn, {
                  error: l.sandbox,
                  lockReason: Ee,
                  children: (0, $.jsx)(G, {
                ...
                control: (0, $.jsx)(D, {
                  ...
                  triggerButton: (0, $.jsx)(te, {
                    disabled: U || Ee != null,
                    contentClassName: `truncate`,
                    children: pe == null ? de : n.formatMessage(pe.label),
                  }),
                  children: Se.map((e) =>
                    (0, $.jsx)(
                      K.Item,
                      {
                        RightIcon: e.value === de ? Nt : void 0,
                        subTextAllowWrap: !0,
                        onSelect: () => {
                          Ce(`sandbox`, `sandbox_mode`, e.value);
                        },
                        SubText: (0, $.jsx)(`div`, {
                          className: `pt-1 text-sm text-token-text-secondary`,
                          children: e.description,
...
function Vn(e, t) {
  ...
  for (let r of e) {
    ...
    n.push({
      ...
      tooltipText: z(r.name) ?? r.name.dotCodexFolder,
      filePath: z(r.name),
...
function Kn({
  ...
  return (
    t ??
    (i
      ? r?.kind !== `managed` && n != null && x(n.name)
        ? e.formatMessage({
...
//# sourceMappingURL=agent-settings-BO3xkkuc.js.map
