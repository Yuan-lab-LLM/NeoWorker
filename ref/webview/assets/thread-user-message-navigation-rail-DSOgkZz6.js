...
var J,
  ...
  Ae,
  je = e(() => {
    ((ke = `_preview_1njv6_1`), (Ae = { preview: ke }));
  });
function Me(e) {
  let t = (0, X.c)(13),
    { item: n } = e,
  ...
  if (t[0] !== n) {
    ...
    if (e.length === 0) {
      ...
      (t[4] === e
        ? (n = t[5])
        : ((n = (0, Z.jsx)(He, { label: e })), (t[4] = e), (t[5] = n)),
        (o = n));
    }
    let s;
    t[6] === n.isHeartbeat
    ...
    (t[10] !== s || t[11] !== c
      ...
      (r = (0, Z.jsxs)(`div`, {
        ...
        children: [
          ...
          a.length > 0
            ? (0, Z.jsx)(V, {
                className: _e(Ae.preview, `mt-1 line-clamp-3`),
                components: Ge,
                  ...
                  i.outputs.length > We
                    ? (0, Z.jsx)(`span`, {
                        ...
                        children: (0, Z.jsx)(E, {
                          ...
                          values: { count: i.outputs.length - We },
                        }),
                      })
                    : null,
                ],
...
function Ne(e, t) {
  return (0, Z.jsx)(ze, { output: e }, `${e.type}:${e.label ?? t}`);
}
function Pe(e) {
  let t = (0, X.c)(2),
    { children: n } = e,
...
function Re(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Z.jsx)(`td`, { className: `truncate`, children: n })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function ze(e) {
  let t = (0, X.c)(9),
    { output: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = Be(n)), (t[0] = n), (t[1] = r));
  let i;
  t[2] === n ? (i = t[3]) : ((i = Ve(n)), (t[2] = n), (t[3] = i));
  let a;
  t[4] === i
    ? (a = t[5])
    : ((a = (0, Z.jsx)(`span`, {
...
function Be(e) {
  switch (e.type) {
    ...
    case `file`:
      return (0, Ue.createElement)(I(e.label ?? void 0), {
        className: `icon-sm shrink-0`,
      });
    case `google-drive`:
      return (0, Z.jsx)(r, { className: `icon-sm shrink-0` });
    case `image`:
      return (0, Z.jsx)(P, { className: `icon-sm shrink-0` });
    case `pull-request`:
      return (0, Z.jsx)(B, { className: `icon-sm shrink-0` });
    case `review`:
...
function He(e) {
  ...
  if (t[0] !== n) {
    ...
    for (; a < n.length;) {
      ...
      if (t == null) break;
      a = t.end;
      let r = W(t.label).trim(),
        s = C(t.path),
        l,
        d = r,
        f;
      if (de(s) || u(s)) ((l = c(r) ?? v), (d = be(r)));
      else if (r.startsWith(`$`)) {
        let e = i(r);
        ((l = xe(e.icon)), (d = e.displayLabel ?? O(e.name)));
      } else {
        let e = Se(s);
        if (e == null) continue;
        ((l = (0, Z.jsx)(te, { href: e })), (f = e));
      }
      (e.push(n.slice(o, t.start)),
        e.push(
          (0, Z.jsx)(
            w,
            { className: `first:pl-0`, icon: l, title: f, children: d },
            t.start,
          ),
        ),
        (o = t.end));
...
var X,
  ...
  Ke = e(() => {
    ((X = ae()),
      ...
      (Z = a()),
      (We = 2),
      (Ge = { a: Pe, code: Pe, img: Fe, table: Ie, td: Re, th: Le }));
  }),
  qe,
  Je,
  Ye,
  ...
  Ze = e(() => {
    ((qe = `_marker_fmcrx_1`),
      (Je = `_row_fmcrx_22`),
      (Ye = `_railList_fmcrx_47`),
      (Xe = { marker: qe, row: Je, railList: Ye }));
  });
function Qe(e) {
  let t = (0, ct.c)(3),
    { items: n, onRevealItem: r } = e;
  if (n.length < dt) return null;
  let i;
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, $.jsx)($e, { items: n, onRevealItem: r })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function $e(e) {
  ...
  let [u, d] = (0, Q.useState)(l),
    [f, ee] = (0, Q.useState)(!1),
    [p, te] = (0, Q.useState)(null),
  ...
  t[2] === n
    ? (le = t[3])
    : ((le = n.map(et).join(`\0`)), (t[2] = n), (t[3] = le));
  let w = le,
    ue;
  t[4] !== u || t[5] !== n || t[6] !== c
    ? ((ue = n.find((e) => u.has(e.id))?.id ?? c),
      (t[4] = u),
      (t[5] = n),
      (t[6] = c),
      (t[7] = ue))
  ...
  t[8] === T
    ? (E = t[9])
    : ((E = () => {
        y.current ?? nt(se.current, T);
      }),
      (t[8] = T),
      (t[9] = E));
  let de = (0, Q.useEffectEvent)(E),
    fe;
  t[10] !== i || t[11] !== r || t[12] !== C
    ? ((fe = async (e, t) => {
        let n = i();
        if (n == null) return;
        let a = tt(n, e.id);
        if (a == null && r != null) {
          (await r(e), (a = tt(n, e.id)), at(a, C));
          return;
        }
        (a?.scrollIntoView({ behavior: t, block: `start` }), at(a, C));
      }),
      (t[10] = i),
      (t[11] = r),
      (t[12] = C),
  ...
  let D = me(fe),
    he;
  t[14] !== D || t[15] !== o
    ? ((he = (e) => (o.logProductEvent(ye, {}), D(e, `smooth`))),
      (t[14] = D),
      (t[15] = o),
      (t[16] = he))
    : (he = t[16]);
  ...
  (t[24] !== i || t[25] !== w
    ? ((M = () => {
        ...
        let t = new Set(),
          n = new Map(),
          r = new Set(),
          a = w.length === 0 ? [] : w.split(`\0`),
          o = new Set(a),
          s = () => {
            let e = a.findIndex((e) => t.has(e));
            if (e === -1) return;
            let n = (0, lt.default)(a, (e) => t.has(e)),
          ...
          c = new IntersectionObserver(
            ...
            { root: e, rootMargin: `-${ft}px 0px 0px 0px` },
          ),
          l = () => {
            let i = new Set();
  ...
  let F;
  if (
    (t[31] !== T || t[32] !== ie || t[33] !== p
      ? ((F = [T, ie, p]), (t[31] = T), (t[32] = ie), (t[33] = p), (t[34] = F))
      : (F = t[34]),
    (0, Q.useLayoutEffect)(P, F),
    !ie || v == null || typeof document > `u`)
  )
    return null;
  let I;
  t[35] === S
  ...
  t[39] === C
    ? (z = t[40])
    : ((z = C ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[39] = C),
      (t[40] = z));
  let B;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (e) => {
        (!e && y.current != null) || (_(e), e || h(null));
      }),
      (t[41] = B))
    : (B = t[41]);
  let be = m?.button,
  ...
  t[42] === xe
    ? (V = t[43])
    : ((V = (0, $.jsx)(Me, { item: xe })), (t[42] = xe), (t[43] = V));
  let Se = p == null ? void 0 : !0,
    we;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = () => {
      ...
      (Ee = () => {
        (ee(!1), y.current ?? h(null));
      }),
      (t[47] = Te),
      (t[48] = Ee))
    : ((Te = t[47]), (Ee = t[48]));
  let U;
  t[49] !== k || t[50] !== D || t[51] !== n
    ? ((U = (e) => {
        let t = y.current;
        if (t == null) {
          let t = it(
          ...
          t != null && h((e) => (e?.item.id === t.item.id ? e : t));
          return;
        }
    ...
    ? ((W = n.map((e, t) =>
        (0, $.jsx)(
          `button`,
          {
            ...
            "data-scrub-target": p === e.id ? !0 : void 0,
            "aria-current": u.has(e.id) ? `true` : void 0,
            "aria-describedby": g && m?.item.id === e.id ? x : void 0,
            ...
            onClick: (t) => {
              ...
              (h({ button: t.currentTarget, item: e }), _(!0), ge(e));
            },
            onFocus: (t) => {
              (h({ button: t.currentTarget, item: e }), _(!0));
            },
            children: (0, $.jsx)(`span`, {
              ...
              children: (0, $.jsx)(`span`, {
                className: _e(
                  ...
                  u.has(e.id) && p !== e.id && `bg-token-foreground opacity-60`,
                  p === e.id && `bg-token-foreground opacity-100`,
                ),
              }),
            }),
          },
  ...
  t[62] === W
    ? (G = t[63])
    : ((G = (0, $.jsx)(`div`, { className: `flex flex-col`, children: W })),
      (t[62] = W),
      (t[63] = G));
  let K;
  t[64] !== k || t[65] !== Se || t[66] !== H || t[67] !== U || t[68] !== G
    ? ((K = (0, $.jsx)(`div`, {
        ref: se,
...
function tt(e, t) {
  return e.querySelector(`[data-content-search-unit-key="${st(t)}"]`);
}
function nt(e, t) {
  if (e == null) return;
  let n = rt(e, t);
...
function rt(e, t) {
  return t == null || e == null
    ? null
    : e.querySelector(
        `[data-thread-user-message-navigation-item-id="${st(t)}"]`,
      );
}
function it(e, t, n) {
...
function at(e, t) {
  (
    ...
    [
      { backgroundColor: mt },
      { backgroundColor: mt, offset: 0.35 },
      { backgroundColor: ht },
    ],
  ...
  return e.some((e) =>
    [...e.addedNodes, ...e.removedNodes].some(
      (e) =>
        ...
        (e.matches(pt) || e.querySelector(pt) != null),
    ),
  );
}
function st(e) {
...
e(() => {
  ((ct = ae()),
    ...
    (dt = 4),
    (ft = 16),
    (pt = `[data-turn-key], [data-content-search-turn-key]`),
    (mt = `color-mix(in srgb, var(--color-token-foreground) 14%, transparent)`),
    (ht = `color-mix(in srgb, var(--color-token-foreground) 5%, transparent)`));
})();
export { Qe as ThreadUserMessageNavigationRail };
//# sourceMappingURL=thread-user-message-navigation-rail-DSOgkZz6.js.map
