...
function U() {
  ...
  e[0] !== l || e[1] !== n || e[2] !== t
    ? ((d = async () => {
        (await c(t, u.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await c(t, u.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await c(t, u.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          l(`/`));
      }),
      (e[0] = l),
      (e[1] = n),
...
function W(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = {
      ...
      (t[0] = l))
    : (l = t[0]);
  let { columns: u, rows: d, lines: p } = ce(l),
    [m, ee] = Y.useState(!1),
    h;
  ...
  t[26] === P
    ...
    : ((F = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(`div`, {
          ...
          children: (0, X.jsx)(oe, { initial: !1, mode: `wait`, children: P }),
        }),
      })),
      (t[26] = P),
      (t[27] = F));
  ...
  t[31] === I
    ...
    : ((L = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(`h1`, {
          ...
          children: (0, X.jsx)(oe, { initial: !1, mode: `wait`, children: I }),
        }),
      })),
      (t[31] = I),
      (t[32] = L));
...
function pe(e) {
        ...
        return n === `intro`
          ...
          : n === `cloud`
            ? (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(C, { className: `size-8` }),
                  (0, X.jsxs)(`div`, {
                    className: `flex w-full items-center justify-between gap-4`,
                    children: [
                      (0, X.jsx)(k, { className: `size-4` }),
                      (0, X.jsxs)(`div`, {
  ...
  let c = s,
    l;
  t[2] !== o || t[3] !== a
    ? ((l = { width: a, height: o }), (t[2] = o), (t[3] = a), (t[4] = l))
    : (l = t[4]);
  let u;
  ...
  return (
    t[7] !== l || t[8] !== u
      ? ((d = (0, X.jsx)(`div`, { style: l, "aria-hidden": !0, children: u })),
        (t[7] = l),
        (t[8] = u),
        (t[9] = d))
      : (d = t[9]),
...
//# sourceMappingURL=first-run-C_Q7zIhO.js.map
