import {
  ...
  x as m,
  xt as h,
} from "./runtime.worker-B8x81tEL.js";
function g(e, t) {
  return n(m(e, t), 1);
}
function _(e, t) {
...
function ys(e, t, n) {
  ...
  return (Ts(e, r), Es(e, t, r, n, ...m(n.definition, (n) => ms(e, t, n))));
}
function bs(e, t, n) {
  let r = G(e, t, n, { type: 1 });
...
function xs(t, n, r) {
  let i = e(
    m(r.definition, (e) => ms(t, n, e)),
    (e) => e !== void 0,
  );
  return i.length === 1 ? i[0] : i.length === 0 ? void 0 : Os(t, i);
}
...
var Bs = class extends Co {
  ...
  buildLookaheadForAlternation(e) {
    ...
    if (Vs(l, !1) && !i) {
      ...
      return function (e) {
        ...
        let r = Us.call(this, a, c, t, o);
        return typeof r == `number` ? r : void 0;
      };
    else
      return function () {
        let e = Us.call(this, a, c, zs, o);
  ...
  buildLookaheadForOptional(e) {
    let {
      ...
      p = m(ba({ maxLookahead: 1, occurrence: t, prodType: r, rule: n }), (e) =>
        m(e, (e) => e[0]),
      );
    if (Vs(p) && p[0][0] && !i) {
      let e = p[0],
        t = u(e);
      if (t.length === 1 && c(t[0].categoryMatches)) {
        let e = t[0].tokenTypeIdx;
        return function () {
          return this.LA_FAST(1).tokenTypeIdx === e;
        };
...
function Gs(e, t, n, r, i, a) {
  ...
  if (l !== void 0)
    ...
    ((c.isAcceptState = !0),
      (c.prediction = t),
      (c.configs.uniqueAlt = t),
      Ks.apply(this, [e, r, o.alts, a]));
  }
  return ((c = tc(e, t, n, c)), c);
}
function Ks(e, t, n, r) {
  let i = [];
...
function qs(e) {
  let t = m(e.prefixPath, (e) => Ui(e)).join(`, `),
...
//# sourceMappingURL=chunk-K5T4RW27-Cn1uC8WN.js.map
