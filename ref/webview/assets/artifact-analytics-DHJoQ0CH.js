...
function f(e, t, { annotationModeEnabled: n, startSource: a }) {
  i(e, r, { ...g(t), annotationModeEnabled: n, startSource: v(a) });
}
function p(e, t) {
  i(e, l, { ...g(t) });
}
...
function v(e) {
  switch (e) {
    case `annotation_mode_pointer`:
      return o.CODEX_ARTIFACT_ANNOTATION_START_SOURCE_ANNOTATION_MODE_POINTER;
    case `ask_codex_button`:
      return o.CODEX_ARTIFACT_ANNOTATION_START_SOURCE_ASK_CODEX_BUTTON;
    case `ask_codex_shortcut`:
      return o.CODEX_ARTIFACT_ANNOTATION_START_SOURCE_ASK_CODEX_SHORTCUT;
  }
}
function y(e) {
  switch (e) {
...
//# sourceMappingURL=artifact-analytics-DHJoQ0CH.js.map
