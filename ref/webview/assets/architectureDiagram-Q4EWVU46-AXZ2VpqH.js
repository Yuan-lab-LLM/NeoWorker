...
import { r, s as i } from "./chunk-5PVQY5BW-Dg9V_wGW.js";
import { Tt as a, bt as o } from "./runtime.worker-_LqsnMiG.js";
import { t as s } from "./mermaid-parser.core-Bs_kKzLq.js";
import {
  B as c,
  C as l,
  K as u,
...
import { t as b } from "./chunk-426QAEUC-CfQ_NmTR.js";
import { a as x, i as S, n as C, r as w } from "./chunk-U2HBQHQK-CM1HhHWn.js";
import { t as T } from "./chunk-4BX2VUAB-FBE5WLZr.js";
import { t as E } from "./cytoscape.esm-DAe24LXI.js";
var D = o((e, t) => {
    (function (n, r) {
      ...
      return (function (e) {
        ...
        function (e, t, n) {
          ...
          ((r.svd = function (e) {
            ...
            for (var te = E - 1, H = 0, ne = 2 ** -52, re = 2 ** -966; E > 0;) {
              var U = void 0,
                W = void 0;
              for (U = E - 2; U >= -1 && U !== -1; U--)
                if (
...
`,
      ...
      t.nodes().map(async (t) => {
        ...
        if (s.type === `group`) {
          ...
          if (s.icon) {
            let e = p.append(`g`);
            (e.html(
              `<g>${await w(s.icon, { height: i, width: i, fallbackPrefix: Y.prefix })}</g>`,
            ),
              e.attr(
                `transform`,
  ...
  oe = t(async function (e, t, n, r) {
    ...
    for (let a of n) {
      ...
      if (a.icon)
        s.html(
          `<g>${await w(a.icon, { height: o, width: o, fallbackPrefix: Y.prefix })}</g>`,
        );
      else if (a.iconText) {
        s.html(
          `<g>${await w(`blank`, { height: o, width: o, fallbackPrefix: Y.prefix })}</g>`,
        );
        let e = s
            .append(`g`)
...
(S([{ name: Y.prefix, icons: Y }]), E.use(k.default));
function se(e, t, n) {
  e.forEach((e) => {
    t.add({
      group: `nodes`,
...
//# sourceMappingURL=architectureDiagram-Q4EWVU46-AXZ2VpqH.js.map
