...
import { n as ze, t as Be } from "./artifact-preview-status-0ScAQLgS.js";
function Ve(e) {
  let t = (0, Ge.c)(19),
...
var Ge,
  ...
  Je,
  Ye = e(() => {
    ((Ge = E()), (Ke = t(O(), 1)), (qe = [0, 0.25, 0.5, 0.75, 1]), (Je = 100));
  });
function Xe(e) {
  let t = (0, $e.c)(10),
    { fileDataUrl: n } = e,
...
function Vt({
  ...
  let m = D(_e),
    ...
    [b, x] = (0, Y.useState)(null),
    [C, w] = (0, Y.useState)(``),
    [T, E] = (0, Y.useState)(null),
    [O, k] = (0, Y.useState)(null),
    [ee, A] = (0, Y.useState)(null),
    [j, N] = (0, Y.useState)(null),
    [te, P] = (0, Y.useState)(null),
    [ne, F] = (0, Y.useState)(!1),
    [re, I] = (0, Y.useState)(!1),
    ie = h.formatMessage({
    ...
    R = te == null ? null : (L.find((e) => on(e) === te) ?? null),
    z = j == null ? null : (L.find((e) => on(e) === j) ?? null),
    B = z == null ? null : Zt(z),
    V = b ?? B,
    H = (0, Y.useMemo)(
      () =>
        b == null
          ? B == null || z == null || j == null
            ? null
            : Jt({
                anchor: B,
                body: Qt(z),
    ...
    U = V == null ? null : $t({ anchor: V, layer: v, pageSize: l }),
    ue = V != null,
    de = (0, Y.useCallback)(() => {
      (b != null && i?.(c, !1),
        x(null),
    ...
    he = (0, Y.useCallback)(
      () =>
        H == null
          ? !1
          : H.target.mode === `create` && C.trim().length > 0
            ? ne
              ? (de(), !0)
              : (F(!0), me(), !1)
            : (de(), !0),
    ...
    ve = (0, Y.useEffectEvent)(() => {
      if (V == null) return;
      let e = $t({ anchor: V, layer: v, pageSize: l });
      e != null && G(g.current, e);
    });
  (0, Y.useEffect)(() => {
    if (!ue || v == null) return;
    let e = v.ownerDocument,
      t = e.defaultView,
      n = () => {
        ve();
      };
  ...
  let xe = (0, Y.useEffectEvent)((e) => {
    let t = e.target;
    (t instanceof Node && g.current?.contains(t)) ||
      (e.preventDefault(),
      e.stopPropagation(),
      he() &&
        (t instanceof Node ? t.ownerDocument : v?.ownerDocument)
          ?.getSelection()
          ?.removeAllRanges());
  });
  (0, Y.useEffect)(() => {
    if (t || H?.target.mode !== `create` || v == null) return;
    let e = v.ownerDocument,
      n = (e) => {
        xe(e);
      };
  ...
  let Se = (0, Y.useEffectEvent)(() => {
    if (t || v == null) return;
    let e = v.parentElement;
    if (e == null) return;
    let n = mt({ pageElement: e, pageSize: l });
    if (n == null) {
      k(null);
      return;
    }
    ((b != null || j != null) && !he()) ||
      (k(n), x(null), w(``), N(null), P(null), A(null), F(!1));
  });
  (0, Y.useEffect)(() => {
    if (v == null || t) return;
    let e = v.parentElement;
  ...
  let we = (e, n, r) => {
    ...
    Te = (0, Y.useEffectEvent)((e, t) => {
      if (b != null || j != null || !Ae(e)) return;
      let n =
        mt({ pageElement: t, pageSize: l }) ??
        (O?.selectionKind === `text` ? null : O);
      n != null &&
        (e.preventDefault(), e.stopPropagation(), K(n, `ask_codex_shortcut`));
    });
  (0, Y.useEffect)(() => {
    if (v == null || t) return;
    let e = v.parentElement;
  ...
  let Ee = (e) => {
      ((b != null || j != null) && !he()) || K(e, `annotation_mode_pointer`);
    },
    Oe = (e) => {
    ...
    je = (e) => {
      ...
      if (b != null && i.kind === `point`) {
        (he(), E(null));
        return;
      }
      (K(i, `annotation_mode_pointer`), E(null));
    },
    Me = async (e, { submitDirectly: i = !1 } = {}) => {
      let h = e.body.trim();
      if (j != null) {
        if (h.length === 0 || re) return;
        (r((e) =>
          e.map((e) =>
            on(e) === j
              ? { ...e, content: [{ content_type: `text`, text: h }] }
              : e,
          ),
        ),
          de());
      ...
      if (!(b == null || h.length === 0 || re))
        try {
          I(!0);
          let g = Yt({ anchor: b, pageSize: l }),
            _ = crypto.randomUUID(),
            v;
          try {
            v = await en({
  ...
  return (0, X.jsxs)(`div`, {
    ref: y,
    className: le(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: be } : void 0,
    onPointerDown: Oe,
    onPointerMove: ke,
    onPointerUp: je,
    onPointerCancel: () => {
    ...
    children: [
      ...
      R == null || j != null ? null : (0, X.jsx)(Ut, { comment: R, layer: v }),
      ee != null && b == null && j == null
        ? (0, X.jsx)(ye, {
            paddingPx: 4,
            pageSize: l,
            rect: ee.rect,
      ...
      O != null && b == null
        ? (0, X.jsx)(q, {
            ...
            onClick: () => K(O, `ask_codex_button`),
          })
        : null,
      T == null
        ? null
        : (0, X.jsx)(Kt, { rect: vt(T.start, T.current), pageSize: l }),
      b == null ? null : (0, X.jsx)(Wt, { anchor: b, label: n, pageSize: l }),
      V == null || U == null || H == null
        ? null
        : (0, X.jsx)(`div`, {
            ref: g,
            className: Ce,
            style: { left: U.x, top: U.y, height: pe, width: 294 },
            ...
            children: (0, X.jsx)(
              M,
              {
                ...
                onCancel: de,
                onDelete: (e) => {
                  (r((t) => t.filter((t) => on(t) !== e)), de());
                },
                onDirectSubmit: (e) => {
                  Me(e, { submitDirectly: !0 });
                },
                onEscape: de,
                onBodyChange: H.target.mode === `create` ? fe : void 0,
...
function $t({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? L({ layer: t, pageSize: n, rect: e.rect })
    : Oe({
        layer: t,
    ...
    ((Nn = E()),
      ...
      (In = (0, Pn.memo)(function (e) {
        let t = (0, Nn.c)(73),
          ...
          ee;
        t[0] !== c || t[1] !== u || t[2] !== k
          ? ((ee = yn({ pageViewportSize: k, pageWidth: c, resize: u })),
            (t[0] = c),
            (t[1] = u),
            (t[2] = k),
            (t[3] = ee))
          : (ee = t[3]);
        let A = ee,
          j = O != null && O.width > 0 ? A.width / O.width : 1,
          M = Math.abs(r - a),
          N = w || M <= 2,
          te = w || M <= 2,
          P = w ? 50 : 50 + M * 40,
        ...
        let re;
        (t[7] !== a || t[8] !== l || t[9] !== d
          ? ((re = [a, l, d]), (t[7] = a), (t[8] = l), (t[9] = d), (t[10] = re))
          : (re = t[10]),
          (0, Pn.useEffect)(F, re));
        let I, ie;
        (t[11] !== r ||
        ...
        t[43] !== N ||
        t[44] !== _
          ? ((le = [A.height, A.width, w, p, m, h, D, d, N, _]),
            (t[35] = A.height),
            (t[36] = A.width),
            (t[37] = w),
            (t[38] = p),
        ...
        let R = O == null ? void 0 : ``,
          z = D?.userUnit ?? 1,
          B;
        t[46] !== A.height || t[47] !== A.width || t[48] !== j || t[49] !== z
          ? ((B = {
              "--scale-factor": j,
              "--user-unit": z,
              height: A.height,
...
function Rn(e) {
  let t = (0, Vn.c)(70),
    ...
    d;
  t[0] !== n || t[1] !== r
    ? ((d = Bn(n, r)), (t[0] = n), (t[1] = r), (t[2] = d))
    : (d = t[2]);
  let [f, m] = (0, Hn.useState)(d),
  ...
  let S = x,
    C;
  t[8] !== S || t[9] !== a
    ? ((C = { onExternalLink: a, onPageChange: S }),
      (t[8] = S),
      (t[9] = a),
      (t[10] = C))
    : (C = t[10]);
  ...
  let M = j,
    N;
  t[21] !== M || t[22] !== S || t[23] !== A || t[24] !== r || t[25] !== i
    ? ((N = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
        ...
        e.key === `End` && (e.preventDefault(), S(r));
      }),
      (t[21] = M),
      (t[22] = S),
      (t[23] = A),
  ...
  let F = P,
    re;
  t[30] !== o || t[31] !== h
    ? ((re = zn({ pageViewportSize: o, presentationSize: h })),
      (t[30] = o),
      (t[31] = h),
      (t[32] = re))
    : (re = t[32]);
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ie = t[33]);
  let ae;
  t[34] !== k || t[35] !== w || t[36] !== o || t[37] !== s || t[38] !== re
    ? ((ae = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (0, Z.jsx)(p, { className: `icon-2xs rotate-180` })), (t[40] = ce))
    : (ce = t[40]);
  let L;
  t[41] !== A || t[42] !== E || t[43] !== se
    ? ((L = (0, Z.jsx)(he, {
        "aria-label": E,
        color: `ghost`,
        disabled: se,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, Z.jsx)(p, { className: `icon-2xs` })), (t[48] = z))
    : (z = t[48]);
  let B;
  t[49] !== M || t[50] !== O || t[51] !== R
    ? ((B = (0, Z.jsx)(he, {
        "aria-label": O,
        color: `ghost`,
        disabled: R,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, Z.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })),
      (t[53] = V))
    : (V = t[53]);
  let H, U;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, Z.jsx)(ne, { className: `icon-2xs` })),
      (U = (0, Z.jsx)(I, {
...
var Vn,
  ...
  Z,
  Un = e(() => {
    ((Vn = E()), (Hn = t(O(), 1)), te(), de(), x(), c(), o(), Ln(), (Z = s()));
  });
...
function $n(e) {
  ...
  t[1] === b.value
    ? (B = t[2])
    : ((B = fe(b.value)), (t[1] = b.value), (t[2] = B));
  let V = B,
    U;
  t[3] === V
    ? (U = t[4])
    : ((U = V ?? ee({ entrypoint: `home` })), (t[3] = V), (t[4] = U));
  let W = U,
    G = w(xe, W),
    de;
  t[5] !== W || t[6] !== b
  ...
  if (t[8] !== G || t[9] !== p) {
    ...
    (t[11] === p
      ? (e = t[12])
      : ((e = (e) => H(e) && e.localPdfContext?.path === p),
        (t[11] = p),
        (t[12] = e)),
      (me = G.filter(e)),
      (t[8] = G),
  ...
  t[13] === he
    ? (ge = t[14])
    : ((ge = Math.max(0, ...he.map(rr))), (t[13] = he), (t[14] = ge));
  let _e = ge + 1,
    ye,
    be;
  (t[15] !== p || t[16] !== pe
    ? ((ye = () => () => {
        pe((e) => {
          let t = e.filter((e) => !(H(e) && e.localPdfContext?.path === p));
  ...
  t[19] === r
    ? (Se = t[20])
    : ((Se = { fileDataUrl: r }), (t[19] = r), (t[20] = Se));
  let {
      loadedFileDataUrl: Ce,
      loadState: K,
      loadStateFileDataUrl: Te,
      numPages: q,
      pageViewportSize: Ee,
      pdfDocument: De,
    } = Xe(Se),
  ...
  t[21] === q
    ...
    : ((Oe = {
      ...
      (t[21] = q),
      (t[22] = Oe));
  let { currentPage: ke, goToNextPage: Ae, goToPreviousPage: je } = Ve(Oe),
    Me;
  ...
  let Ne = Me,
    Pe;
  t[24] !== Ee || t[25] !== R
    ? ((Pe = { onBeforeZoom: Ne, pageViewportSize: Ee, pageWidth: R }),
      (t[24] = Ee),
      (t[25] = R),
      (t[26] = Pe))
    : (Pe = t[26]);
  let {
    ...
    Ke;
  t[27] !== ke || t[28] !== Le || t[29] !== He
    ? ((Ke = () => {
        let e =
          He.kind === `page-width`
            ? null
            : T.current?.querySelector(
                `[data-artifact-pdf-page][data-page-number="${ke}"]`,
              );
        (Le(),
          e != null &&
  ...
  t[31] === Fe
    ...
    : ((Je = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = P.current;
        n !== t &&
          (n != null && (Ne({ kind: `center` }), Fe()), (P.current = t), z(t));
      }),
      (t[31] = Fe),
      (t[32] = Je));
  let Ye = ve(Je),
  ...
  t[36] === Qe
    ...
    : (($e = () => {
      ...
      (t[37] = $e));
  let et;
  (t[38] !== Ee || t[39] !== R || t[40] !== He || t[41] !== Qe
    ? ((et = [Ee, R, He, Qe]),
      (t[38] = Ee),
      (t[39] = R),
      (t[40] = He),
  ...
  (t[43] === r
    ? ((tt = t[44]), (nt = t[45]))
    : ((tt = () => {
        te.current !== r && ((te.current = r), Ne({ kind: `center` }));
      }),
      (nt = [Ne, r]),
      (t[43] = r),
      (t[44] = tt),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((rt = () => {
        ((E.current = !1), ie(!1), le(!1));
      }),
      (t[46] = rt))
    : (rt = t[46]);
  let it;
  (t[47] === r ? (it = t[48]) : ((it = [r]), (t[47] = r), (t[48] = it)),
    (0, Q.useEffect)(rt, it));
  let at;
  ...
  (t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        let e = () => {
          document.fullscreenElement !== S.current && ie(!1);
        };
        return (
  ...
  t[55] === Re
    ...
    : ((lt = (e) => {
      ...
      (t[56] = lt));
  let ut = lt,
    J = K === `ready` && De != null && Ce === r,
    dt = J,
    ft = J ? De : null,
    pt;
  t[57] !== q || t[58] !== b
    ? ((pt = () => {
        ((E.current = !0), ae(b, f, { pageCount: q }));
      }),
      (t[57] = q),
      (t[58] = b),
      (t[59] = pt))
  ...
  t[72] !== J || t[73] !== vt
    ...
    : (Ct = t[74]);
  let wt;
  (t[75] !== J || t[76] !== m || t[77] !== vt
    ? ((wt = [J, m, vt]), (t[75] = J), (t[76] = m), (t[77] = vt), (t[78] = wt))
    : (wt = t[78]),
    (0, Q.useEffect)(Ct, wt));
  let Tt;
  t[79] !== r || t[80] !== K || t[81] !== Te || t[82] !== bt
    ? ((Tt = () => {
        K !== `error` || Te !== r || k.current || bt();
      }),
      (t[79] = r),
      (t[80] = K),
      (t[81] = Te),
    ...
    : (Tt = t[83]);
  let Et;
  (t[84] !== r || t[85] !== K || t[86] !== Te || t[87] !== m || t[88] !== bt
    ? ((Et = [r, K, Te, m, bt]),
      (t[84] = r),
      (t[85] = K),
      (t[86] = Te),
  ...
  t[90] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Dt = () => {
        (ie(!1),
          document.fullscreenElement === S.current &&
    ...
    ? ((Nt = () => {
        ...
        let e = (e) => {
          e.defaultPrevented ||
            e.key !== `Escape` ||
            F.current.size > 0 ||
            (e.preventDefault(), e.stopPropagation(), le(!1));
        };
        return (
  ...
  let Rt = Lt,
    ...
    Vt;
  t[101] !== L || t[102] !== b || t[103] !== _ || t[104] !== V
    ? ((Vt = () => {
        (Bt(!1),
          L ||
            Ie(b, {
    ...
    : (Vt = t[105]);
  let Ht;
  t[106] !== It || t[107] !== Rt || t[108] !== L || t[109] !== Vt
    ? ((Ht = (0, $.jsx)(j, {
        active: L,
        activeLabel: Rt,
        label: It,
...
//# sourceMappingURL=pdf-preview-panel-YIevlW21.js.map
