...
function U(e) {
  ...
  t[4] === a
    ? (f = t[5])
    : ((f = (0, G.jsx)(F.Item, { LeftIcon: te, onSelect: a, children: d })),
      (t[4] = a),
      (t[5] = f));
  let m;
  return (
...
function Je() {
  let e = (0, X.c)(100),
    ...
    [i, a] = ke(Ee),
    o = Se(xe),
    { data: s, isFetching: c } = d(),
    l = s === void 0 ? [] : s,
    u = le(),
    f;
  e[0] === u ? (f = e[1]) : ((f = (e) => !h(e, u)), (e[0] = u), (e[1] = f));
  let p = l.filter(f).map(rt),
    { data: m, isFetching: g } = re(Oe),
    { data: ee, isFetching: x } = y(me, {
      params: { dirs: (0, Z.default)(st(p), nt).sort(tt) },
      source: `onboarding_workspace_select`,
    }),
    { data: S, isFetching: te } = v(),
    {
      autoLaunchAction: w,
      isRemoteHost: T,
      setWorkspaceOnboardingAutoLaunchApplied: E,
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = []), (e[2] = ae))
    : (ae = e[2]);
  let [se, O] = (0, Q.useState)(ae),
    ce;
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = {}), (e[3] = ce))
    : (ce = e[3]);
  let [k, A] = (0, Q.useState)(ce),
    [j, M] = (0, Q.useState)(!1),
    [N, F] = (0, Q.useState)(null),
    fe = (0, Q.useRef)(!1),
    pe;
  e[4] === r
    ? (pe = e[5])
  ...
  let he = pe,
    ge = (0, Q.useRef)(0),
    I = m?.roots,
    ye = I != null && I.length > 0,
    be = ct({ tasks: p, gitOrigins: ee?.origins, codexHome: S?.codexHome }),
    Ce = (0, Z.default)([...(I ?? []), ...be, ...se], et).sort($e),
    L;
  e[6] === m?.labels
    ? (L = e[7])
    : ((L = (e) => {
        let t = m?.labels?.[e]?.trim();
  ...
  let R = Ce.map(L),
    z = R.map(Qe),
    De;
  e[8] === k ? (De = e[9]) : ((De = (e) => !!k[e]), (e[8] = k), (e[9] = De));
  let B = z.filter(De),
    Ae =
      z.length > 0 && B.length === z.length
        ? !0
        : B.length > 0 && B.length < z.length
          ? `indeterminate`
          : !1,
    je;
  (e[10] !== z ||
  ...
  e[15] !== D
    ? ((je = (e) => {
        O((t) => (0, Z.default)([...t, e.root], Ze));
        let n = { ...k, [e.root]: !0 };
        A(n);
        let r = z.includes(e.root),
          i = ot(n, z) + +!r,
          a = r ? z.length : z.length + 1;
        P(t, ie, {
          action: `toggle_root`,
      ...
      (e[16] = je))
    : (je = e[16]),
    ve(`workspace-root-option-picked`, je));
  let Me;
  (e[17] !== z.length ||
  e[18] !== t ||
  e[19] !== M ||
  ...
  e[24] !== D
    ? ((Me = (e) => {
      ...
      (e[25] = Me))
    : (Me = e[25]),
    ve(`electron-onboarding-skip-workspace-result`, Me));
  let Ne;
  e[26] !== ye || e[27] !== t || e[28] !== F || e[29] !== D
    ? ((Ne = () => {
        (F(null),
          P(t, b, {
            hasExistingWorkspaces: ye,
            source: `onboarding_modal`,
            experimentArm: D,
          }),
          we.dispatchMessage(`electron-pick-workspace-root-option`, {
            allowMultiple: !1,
          }));
      }),
      (e[26] = ye),
  ...
  e[44] !== D
    ? ((Be = (e, n) => {
        (F(null), O((t) => (0, Z.default)([...t, e], Xe)));
        let r = { ...k, [e]: n };
        (A(r),
          P(t, ie, {
            action: `toggle_root`,
            checked: n,
            selectedWorkspacesCount: ot(r, z),
            totalWorkspacesCount: z.length,
            experimentArm: D,
          }));
      }),
  ...
  e[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((We = { queryKey: [_, `paths-exist`] }), (e[53] = We))
    : (We = e[53]);
  let Ge = _e(We),
    U = c || g || x || te || Ge > 0,
    W = R.length > 0,
  ...
  e[54] !== ze || e[55] !== U || e[56] !== w || e[57] !== E
    ...
    : (K = e[58]);
  let q;
  (e[59] !== U || e[60] !== w || e[61] !== E
    ? ((q = [U, w, E]), (e[59] = U), (e[60] = w), (e[61] = E), (e[62] = q))
    : (q = e[62]),
    (0, Q.useEffect)(K, q));
  let J;
  e[63] !== n ||
  ...
  e[70] !== D
    ? ((J = (e, r) => {
        ...
        (o(Math.floor(Date.now() / 1e3)),
          i === `workspace` &&
            I != null &&
            (s = (0, Z.default)([...I, ...e], Ye)),
          we.dispatchMessage(`electron-update-workspace-root-options`, {
            roots: s,
          }),
          a(`auto`),
          (ge.current += 1),
          ue(t, `work`),
          n(`/`, { replace: !0, state: { focusComposerNonce: ge.current } }));
      }),
      (e[63] = n),
      (e[64] = i),
      (e[65] = z.length),
  ...
  let Y = J,
    ut,
    dt;
  (e[72] !== Y || e[73] !== G || e[74] !== U || e[75] !== B
    ? ((ut = () => {
        G ||
          Je.current ||
          U ||
          (B.length !== 0 && ((Je.current = !0), Y(B, !0)));
      }),
      (dt = [Y, G, U, B]),
      (e[72] = Y),
      (e[73] = G),
      ...
      ? ((mt = (0, $.jsx)(Re, {
          children: qe
            ...
            : (0, $.jsx)(at, {
                ...
                availableOptions: R,
                selectedRoots: B,
                selectAllState: Ae === `indeterminate` ? !1 : Ae,
                handleToggleSelectAll: Ue,
                handleToggleWorkspace: Ve,
                intl: r,
                handleOpenFolder: V,
                hasSelectedRoots: Ke,
                isRemoteHost: T,
...
function rt(e) {
  return { kind: `local`, key: Be(e.id), at: e.createdAt, conversation: e };
}
function K(e) {
  let t = (0, X.c)(7),
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = r
        ? (0, $.jsx)(V, { className: `h-10 w-10`, "aria-hidden": `true` })
        : null),
      (t[0] = r),
      (t[1] = i));
  let a, o;
...
function at(e) {
  let t = (0, X.c)(40),
    {
      ...
      isSkipPending: h,
      skipErrorMessage: g,
      workspaceOnboardingExperimentArm: ee,
    } = e,
    _;
  t[0] === a ? (_ = t[1]) : ((_ = new Set(a)), (t[0] = a), (t[1] = _));
  let v = _,
    y;
  t[2] === n
    ? (y = t[3])
    : ((y = n
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(ge, { className: `h-4 w-4 text-token-foreground` }),
              (0, $.jsx)(`span`, {
  ...
  t[12] !== v
    ? ((b = r
        ? (0, $.jsxs)(Me, {
            className: I(n && `pointer-events-none opacity-50`),
  ...
  t[25] !== S || t[26] !== C
    ...
    : (w = t[27]);
  let T;
  t[28] !== m || t[29] !== p || t[30] !== h || t[31] !== g || t[32] !== ee
    ? ((T = p
        ? null
        : (0, $.jsx)(J, {
            handleSkip: m,
...
function Y(e) {
  let t = (0, X.c)(21),
    ...
    c = o.root,
    l;
  t[0] === c ? (l = t[1]) : ((l = ee(c)), (t[0] = c), (t[1] = l));
  let u = l,
    d = M(c).replace(/\/+$/, ``),
    f,
    p;
  ...
  t[7] !== f || t[8] !== p || t[9] !== h
    ? ((g = { params: f, placeholderData: p, queryConfig: h }),
      ...
      (t[10] = g))
    : (g = t[10]);
  let { data: _ } = ae(`paths-exist`, g);
  if (!(
    a || (_?.existingPaths ?? []).some((e) => M(e).replace(/\/+$/, ``) === d)
  ))
    return null;
...
function ct({ tasks: e, gitOrigins: t, codexHome: n }) {
  ...
  return (0, Z.default)(
    r
      .map((e) => {
        let t = ce(e, i);
        return !t?.root || !o(t.root, n)
          ? e
          : (i.reduce(
              (e, r) =>
                !t.originUrl || r.originUrl !== t.originUrl || o(r.root, n)
                  ? e
                  : e
...
//# sourceMappingURL=select-workspace-page-D66sJfwT.js.map
