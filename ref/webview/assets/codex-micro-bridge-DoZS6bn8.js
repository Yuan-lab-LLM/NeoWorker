...
import { n as Pe, r as W } from "./codex-micro-commands-CwKGl2NY.js";
import {
  a as G,
  i as Fe,
  o as K,
...
import {
  ...
  o as $e,
  r as et,
} from "./codex-micro-joystick-feedback-CRZ9dV-Q.js";
import {
  a as tt,
  c as nt,
  i as rt,
  ...
  t as ct,
  u as lt,
} from "./codex-micro-mini-games-ImTY22iQ.js";
import { n as ut, r as dt } from "./codex-micro-onboarding-state-B88rYlQN.js";
function ft() {
  let e = (0, pt.c)(1),
    t;
  return (
...
function gt(e) {
  ...
  t[0] !== r || t[1] !== i
    ? ((s = (e) => {
        ...
        (!t &&
          e === `short-press` &&
          (t = h(`composer.startVoiceMode`, `codex_micro_hid`)),
          !(t || e === `long-press` || r) &&
            i.get(re).warning((0, yt.jsx)(ft, {}), {
              duration: 3,
              hasCloseButton: !1,
        ...
        if (n) {
          ...
          a.current != null ||
            ...
            (a.current = globalThis.setTimeout(() => {
              ((a.current = null), (o.current = !0), c(`long-press`));
            }, bt));
        }
      }),
      (t[4] = c),
  ...
  return (
    t[11] === f
      ? (g = t[12])
      : ((g = { handleGesture: f }), (t[11] = f), (t[12] = g)),
    g
  );
}
var _t,
...
function Et(e) {
  ...
  let t = Pe(e.commandId);
  return t == null ? null : { type: `command`, command: t.id };
}
var Dt,
  Y,
  Ot = e(() => {
    (W(), K(), p(), (Dt = 350), (Y = { type: `idle` }));
  }),
  kt = e(() => {});
function At(e) {
  return e.map(({ id: e }) => ({
...
function qt(e) {
  ...
  (t[0] === r
    ...
    : ((l = (e) => {
        ...
        ((a.current = !0),
          t === `device-lifecycle` && (s.current = { value: r.get(v) }),
          Yt(r, n));
      }),
      (u = [r]),
      (t[0] = r),
      (t[1] = l),
      (t[2] = u)),
    he(`codex-micro-device-state-changed`, l, u));
  let d, p;
  (t[3] === r
    ? ((d = t[4]), (p = t[5]))
    : ((d = (e) => {
      ...
      (t[4] = d),
      (t[5] = p)),
    he(`codex-micro-window-ownership-changed`, d, p));
  let m, h;
  (t[6] === r
    ? ((m = t[7]), (h = t[8]))
    : ((m = (e) => {
      ...
      (t[7] = m),
      (t[8] = h)),
    he(`codex-micro-device-lifecycle`, m, h));
  let g, _;
  (t[9] !== n || t[10] !== r
    ? ((g = () => {
        let e = !0;
        ...
        let t = null,
          ...
          u = r.watch((e) => {
            ...
            let a = r(Je),
              o = a.slots.map(Jt),
              u = Te(r, we.agentSource) === `custom` ? (r(Ye) ?? We) : null,
              d =
                u == null
                  ? []
                  : a.slots.flatMap((e) => {
  ...
  return (
    t[13] === i
      ...
      : ((b =
          i === `connected`
            ? (0, _n.jsx)(Xt, { miniGameRearmRequiredRef: c })
            : null),
        (t[13] = i),
        (t[14] = b)),
    b
...
function Xt(e) {
  ...
  t[0] === a.pathname
    ? (o = t[1])
    : ((o = a.pathname.startsWith(`/settings/codex-micro`)),
      (t[0] = a.pathname),
      (t[1] = o));
  let s = o,
    l = le(),
    ...
    _ = se(Ye),
    v;
  t[2] === p ? (v = t[3]) : ((v = Fe(p)), (t[2] = p), (t[3] = v));
  let y = v,
    b =
      n(`2380644311`) && y.voiceButtonMode === `realtime`
        ? `realtime`
        : `push-to-talk`,
    ee = g && b === `realtime`,
    x;
  t[4] !== s || t[5] !== ee
    ? ((x = { enabled: ee, isCodexMicroSettings: s }),
      (t[4] = s),
      (t[5] = ee),
      (t[6] = x))
    : (x = t[6]);
  let { handleGesture: S } = gt(x),
    oe;
  t[7] !== f || t[8] !== _ || t[9] !== y.analogStick || t[10] !== y.slots
    ? ((oe =
        Object.values(y.slots).some(tn) ||
        Object.values(y.analogStick).some(en) ||
        (f === `custom` && Object.values(_ ?? We).some($t))),
      (t[7] = f),
      (t[8] = _),
      (t[9] = y.analogStick),
      (t[10] = y.slots),
  ...
  let { skills: T } = de(void 0, void 0, w),
    E = (0, Z.useRef)(null),
    D = (0, Z.useRef)(nt),
    O;
  ...
  t[15] === i
    ? (Se = t[16])
    : ((Se = function () {
        return ((L.current ??= new Wt((e) => i.set(Ut, e), Qt)), L.current);
      }),
      (t[15] = i),
      (t[16] = Se));
  let z = Se,
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Oe = function () {
        I.current != null &&
          (globalThis.clearTimeout(I.current), (I.current = null));
      }),
      (t[17] = Oe))
    : (Oe = t[17]);
  let ke = Oe,
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = function () {
        (ke(),
          (I.current = globalThis.setTimeout(() => {
            I.current = null;
            let e = cn();
    ...
    ? ((V = function (e) {
        ...
        r != null &&
          (j.current = globalThis.setTimeout(
            () => {
              j.current = null;
              let e = wt(A.current, `timeout`, r);
              ((A.current = e.state), nn(e.action));
            },
            Math.max(0, r - t),
          ));
      }),
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = function () {
        for (let e of k.current) globalThis.clearTimeout(e);
        k.current.clear();
      }),
      (t[20] = H))
    : (H = t[20]);
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = function (e, t, n) {
        ...
        let r = globalThis.setTimeout(() => {
          (k.current.delete(r), n(e() ? `triggered` : `unavailable`));
        }, yn);
        return (k.current.add(r), null);
      }),
      (t[21] = U))
    : (U = t[21]);
  let Pe = U,
  ...
  t[24] === i
    ? (K = t[25])
    : ((K = function (e, t) {
        (N.current != null && globalThis.clearTimeout(N.current),
          $e(i, e, t),
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ie = () => {
        (j.current != null &&
          (globalThis.clearTimeout(j.current), (j.current = null)),
          A.current.type !== `idle` &&
            A.current.type !== `suppressing-presses` &&
            nn(`stop`),
          (A.current = Y));
      }),
      (t[26] = Ie))
    ...
    ? ((ze = () => {
        let e = () => {
            (M.current != null &&
              ...
              P.current != null &&
                (globalThis.clearTimeout(P.current), (P.current = null)),
              (F.current = !1),
              ke(),
              L.current?.dispose(),
              (L.current = null),
  ...
  t[46] !== b
    ? ((He = (e) => {
        ...
        let n = t.slot == null ? null : Be(t.slot),
          r =
            n != null && Te(i.get, we.agentSource) === `custom`
              ? (i.get(Ye) ?? We)[n]
              : null,
        ...
        if (o != null) {
          if (y.encoderMode === `reasoning`) {
            ...
            if (
              e == null ||
              z().getActivationTarget(e.root, e.composerId, `reasoning`) == null
            )
              return;
            (h(
              o === `ArrowUp`
        ...
        let f = St(t, y, r);
        if (f?.type === `encoder-press`) {
          if (P.current != null || F.current) return;
          P.current = globalThis.setTimeout(() => {
            ((P.current = null),
              (F.current = !0),
              L.current?.clearHighlight(),
              l(`/settings/codex-micro`));
          }, xn);
          return;
        }
        if (f?.type === `encoder-release`) {
          if (F.current) {
            F.current = !1;
            return;
          }
          ...
          if (
            (globalThis.clearTimeout(P.current),
            (P.current = null),
          ...
          if (e != null) {
            ...
            (X(`Enter`, e),
              ...
              y.encoderMode === `reasoning` && t != null && un(t) && Ae());
            return;
          }
          let t = hn();
          if (t != null) {
        ...
        if (f?.type === `command`) {
          !h(f.command, `codex_micro_hid`) &&
            !s &&
            i.get(re).warning((0, _n.jsx)(ft, {}), {
              duration: 3,
              hasCloseButton: !1,
              id: `codex-micro-command-unavailable`,
            });
        ...
        if (f?.type === `external-url`) {
          me({ href: f.url, initiator: `open_in_browser_bridge` });
          return;
        }
        if (f?.type === `composer-text`) {
          be.dispatchHostMessage({
        ...
        if (
          f?.type === `push-to-talk-press` ||
          f?.type === `push-to-talk-release`
        ) {
          let e = f.type === `push-to-talk-press` ? `press` : `release`;
          b === `realtime` ? S(e) : Me(e);
          return;
        }
        if (t.act !== 1 || t.slot == null) return;
        let p = je(t.threadKey);
        if (p == null) {
          t.threadKey == null &&
            Te(i.get, we.agentSource) === `custom` &&
            n != null &&
            r == null &&
            qe(i, n, i.get(c, Sn)) &&
            d();
  ...
  t[56] !== b
    ? ((Ue = [S, s, y, l, u, i, T, d, b]),
      ...
      (t[57] = Ue))
    : (Ue = t[57]),
    he(`codex-micro-hid-event`, He, Ue));
  let Ke;
  t[58] !== G ||
  t[59] !== y.analogStick ||
  t[60] !== r ||
  ...
  t[62] !== q
    ? ((Ke = (e) => {
        ...
        let n = E.current,
          ...
          o = ot();
        if (i.get(it) != null) {
          ((r.current = !0), (D.current = nt), (E.current = null));
          return;
        }
        if (r.current) {
          ((E.current = null), t.distance <= 0.1 && (r.current = !1));
          return;
        }
        if (o != null && !a) {
          let e = rt(D.current, t, globalThis.performance.now());
          if (((D.current = e.state), e.activated)) {
            (Ne(),
              (r.current = !0),
              (E.current = null),
              ct(i),
          ...
          if (e.captured) {
            (Ne(), (E.current = null), q(t, e.progress));
            return;
          }
        } else D.current = nt;
        let s = Tt(t, n, y.analogStick, a);
        E.current = s.activeDirection;
        let c = function (e) {
            (N.current != null &&
              (globalThis.clearTimeout(N.current), (N.current = null)),
              Xe(i, {
                ...
                (N.current = globalThis.setTimeout(() => {
                  ((N.current = null), (E.current = null), Qe(i));
                }, 600)));
          },
          l = !1,
          u = null;
        if (s.action?.type === `command`) {
          ...
          ((u = Pe(() => h(e, `codex_micro_joystick`), o != null, c)),
            (l = u == null));
        } else if (s.action?.type === `skill`) {
          let e = s.action;
          ((u = Pe(() => G(e), o != null, c)), (l = u == null));
        }
        l || c(u);
      }),
      (t[58] = G),
  ...
  return (
    t[64] !== y.analogStick || t[65] !== i || t[66] !== T
      ? ((Je = [y.analogStick, i, T]),
        ...
        (t[67] = Je))
      : (Je = t[67]),
    he(`codex-micro-joystick-event`, Ke, Je),
    null
  );
}
function Zt(e) {
...
//# sourceMappingURL=codex-micro-bridge-DoZS6bn8.js.map
