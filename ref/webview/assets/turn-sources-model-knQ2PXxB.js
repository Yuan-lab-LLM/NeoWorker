...
var j,
    ...
    (i(),
      ...
      (M = {
        "google-drive": {
          ...
          getTitle(e, t) {
            return A(e, t) ?? y(t.structuredContent)?.title ?? null;
          },
        },
      }));
  }),
  ...
  R = e(() => {
    (c(),
      ...
      N(),
      (P = 1440 * 60 * 1e3),
      (F = t(`conversation-sources:connector-asset-title-cache`, {})),
      (I = a(x, ({ get: e }) => e(F) != null)),
      (L = d(
        x,
            ...
            queryFn: async () => {
              ...
              try {
                let t = w({
                    ...
                    toolResult: await b(r, e, i.server, i.tool, i.arguments),
                  }),
                  n = k(i, t);
                return (
                  n != null &&
...
function z(e) {
  ...
  return (
    t[5] === o
      ? (s = t[6])
      : ((s = (0, V.jsx)(v, { initial: !1, children: o })),
        (t[5] = o),
        (t[6] = s)),
    s
  );
...
//# sourceMappingURL=turn-sources-model-knQ2PXxB.js.map
