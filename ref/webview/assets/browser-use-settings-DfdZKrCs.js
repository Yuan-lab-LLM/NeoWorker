...
import { n as Wn, t as Gn } from "./toolbar-breadcrumb-COhCwKVT.js";
import { n as Kn, t as qn } from "./use-home-directory-Ca_CpGeT.js";
import { n as Jn, t as Yn } from "./settings-loading-row-BdxyJgCw.js";
import { n as Xn, t as Zn } from "./settings-row-disclosure-NtnSBbIg.js";
function Qn(e) {
  let t = (0, $n.c)(6),
    { service: r } = e,
    i = z(G);
  if (!n(`1834314516`)) return null;
  let a = r ?? Pe.browserProfileImport;
  if (a == null) return null;
  let o;
  t[0] !== a || t[1] !== i
    ? ((o = () => {
        En(i, a, `browser-settings-page`);
      }),
      (t[0] = a),
      (t[1] = i),
      (t[2] = o))
...
function lr(e) {
  let t = (0, Lr.c)(71),
    ...
    [p, m] = (0, Rr.useState)(null),
    h = zr[n],
    g;
  t[0] !== r || t[1] !== h.webviewLabel
    ? ((g = r.formatMessage(h.webviewLabel)),
      (t[0] = r),
      (t[1] = h.webviewLabel),
      (t[2] = g))
    : (g = t[2]);
  ...
  t[3] !== n || t[4] !== i.search || t[5] !== o?.params
    ...
    : ((v = t[6]), (y = t[7]));
  let b = y,
    x = d?.initialUrl === v ? d : null,
    S = x?.url ?? v,
    C = p?.url === S ? p.title : null,
    w;
  t[8] !== S || t[9] !== n
    ? ((w = Mr(n, S)), (t[8] = S), (t[9] = n), (t[10] = w))
    : (w = t[10]);
  let T = w,
    E = Pt($t()),
    te;
  ...
  t[22] !== b
    ? ((j = () => {
          ...
          p = () => {
            !i ||
              ...
              t({
                ...
                gn.warning(`Failed to unmount browser settings webview`, {
                  safe: { kind: n },
                  sensitive: { error: e },
                });
              }));
          };
        ((l.current = Or(n, v)), (u.current = null));
        let g = (e) => {
            let t = o;
            t != null &&
              wr(t).then((n) => {
                a ||
                  o !== t ||
                  Cr(t, v) !== e ||
                  m(n == null ? null : { title: n, url: e });
              });
          },
          y = () => {
            if (o == null || a) return;
            let e = br(o, v),
              t = d != null && e.url === b ? { ...e, url: d } : e,
              r = u.current,
              i = kr(l.current ?? Or(n, v), t.url, r);
            (r != null &&
              i.index === r &&
              i.entries[r] === t.url &&
              (u.current = null),
          ...
          x = [`did-navigate`, `did-navigate-in-page`, `did-stop-loading`],
          S = () => {
            if ((y(), o == null || d == null)) return;
            let e = d;
            ((d = null),
              Ar({ sourceUrl: b, targetUrl: e, webview: o }).catch((t) => {
                gn.warning(`Failed to open initial browser settings URL`, {
                  safe: { kind: n },
        ...
        return (
          (async () => {
            try {
              ...
              ((o = document.createElement(`webview`)),
                ...
                o.setAttribute(`aria-label`, _),
                o.setAttribute(`partition`, h.partition),
                o.setAttribute(`src`, b),
                o.addEventListener(`dom-ready`, S));
              for (let e of x) o.addEventListener(e, y);
              ((c.current = o), e.append(o), y());
            } catch (e) {
              let t = e;
              gn.error(`Failed to mount browser settings webview`, {
                safe: { kind: n },
                sensitive: { error: t },
              });
            }
          ...
          () => {
            ((a = !0),
              c.current === o &&
                ((c.current = null), (l.current = null), (u.current = null)),
              o?.removeEventListener(`dom-ready`, S));
            for (let e of x) o?.removeEventListener(e, y);
            (o?.remove(), o != null && hr(o), p());
          }
        );
      }),
      (t[17] = v),
    ...
    : (j = t[23]);
  let M;
  (t[24] !== v || t[25] !== n || t[26] !== h || t[27] !== _ || t[28] !== b
    ? ((M = [v, n, h, _, b]),
      (t[24] = v),
      (t[25] = n),
      (t[26] = h),
  ...
  (t[30] !== n || t[31] !== E
    ? ((ie = () => {
        ...
        e?.({
          ...
          gn.warning(`Failed to sync browser settings webview theme`, {
            safe: { kind: n },
            sensitive: { error: e },
          });
        });
      ...
      (t[33] = ie))
    : ((re = t[32]), (ie = t[33])),
    (0, Rr.useLayoutEffect)(ie, re));
  let N, F;
  t[34] !== v || t[35] !== n
    ? ((N = (e) => {
        let t = l.current;
        return t == null ? !1 : F(t.index + e);
      }),
      (F = (e) => {
        let t = c.current,
          r = l.current;
        ...
        return (
          (l.current = o),
          (u.current = e),
          f(Dr({ history: o, initialUrl: v, url: i, webview: t })),
          Ar({ sourceUrl: a, targetUrl: i, webview: t }).catch((e) => {
            gn.warning(`Failed to navigate browser settings webview`, {
              safe: { kind: n },
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, q.jsx)(`div`, {
      ...
      (t[46] = se))
    : (se = t[46]);
  let ce = x?.canGoBack === !0 || T != null,
    le = x?.canGoForward ?? !1,
    ue;
  t[47] !== T || t[48] !== a || t[49] !== N
    ? ((ue = () => {
        let e = c.current;
        if (!(l.current?.preferHistoryControls === !0 && N(-1))) {
          if (e != null && xr(e)) {
            e.goBack?.();
            return;
          }
  ...
  t[51] === N
    ...
    : ((de = () => {
        ...
        (l.current?.preferHistoryControls === !0 && N(1)) || N(1);
      }),
      (t[51] = N),
      (t[52] = de));
  let I;
  ...
  t[58] !== de
    ...
    : (I = t[59]);
  let L;
  t[60] !== C || t[61] !== S || t[62] !== oe || t[63] !== n
    ? ((L = (0, q.jsx)(ur, {
        currentPageTitle: C,
        currentUrl: S,
        kind: n,
        onCurrentSectionClick: oe,
      })),
      (t[60] = C),
      (t[61] = S),
      (t[62] = oe),
...
function mr(e, t) {
  ...
  if (t != null) return t;
  let r = Pr(n);
  return r == null ? Fr(n) : (0, q.jsx)(B, { ...r });
}
function hr(e) {
  gr(e) && e.destroy();
}
...
function _r({ kind: e, search: t, siteSettingsRoutePath: n }) {
  ...
  return e === `siteSettings`
    ? (Le(new URLSearchParams(t).get(`site`)) ?? vr(n) ?? r.url)
    : r.url;
}
function vr(e) {
...
function yr(e, t) {
  return e === `siteSettings` && Nr(t) === `siteDetails` ? Ln : t;
}
function br(e, t) {
  return {
    canGoBack: xr(e),
...
function Or(e, t) {
  return e !== `siteSettings` || Nr(t) == null
    ...
    : { entries: [Ln, t], index: 1, preferHistoryControls: !0 };
}
function kr(e, t, n) {
...
function Vr() {
  let e = (0, Ur.c)(3),
    { selectedHostId: t } = Ie();
  if (vt(t).kind !== `local`) return null;
  let n;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = (0, J.jsx)(K.Header, {
        title: (0, J.jsx)(B, {
...
function Hr(e) {
  let t = (0, Ur.c)(25),
    { hostId: n } = e,
    r = Xe(),
    { data: i, isLoading: a } = Te(_e),
    o;
  t[0] === n ? (o = t[1]) : ((o = { hostId: n }), (t[0] = n), (t[1] = o));
  let { data: s, isPending: c } = ce(Bt, o),
    l;
  t[2] === n ? (l = t[3]) : ((l = { hostId: n }), (t[2] = n), (t[3] = l));
  let u = fe(l),
    d = s?.requirements?.featureRequirements?.[st],
    f;
  t[4] === d ? (f = t[5]) : ((f = hn(d)), (t[4] = d), (t[5] = f));
  let p = f,
    m = a || c,
    ...
    ? ((g = (0, J.jsxs)(`div`, {
        ...
        children: [
          (0, J.jsxs)(`span`, {
            ...
            children: [
              (0, J.jsx)(cn, { className: `icon-xs shrink-0` }),
              (0, J.jsx)(B, {
  ...
  return (
    t[22] !== C || t[23] !== y
      ? ((w = (0, J.jsx)(H, { label: g, description: y, control: C })),
        (t[22] = C),
        (t[23] = y),
        (t[24] = w))
      : (w = t[24]),
...
function Qr() {
  let e = (0, fi.c)(12),
    { selectedHostId: t } = Ie(),
    { data: n, isError: r, isLoading: i } = Te(_e),
    a;
  e[0] === t ? (a = e[1]) : ((a = { hostId: t }), (e[0] = t), (e[1] = a));
  let { data: o, isError: s, isPending: c } = ce(Bt, a),
  ...
  e[5] !== l
    ? ((f =
        ...
        !s &&
        !c &&
        !hn(o?.requirements?.featureRequirements?.browser_use_full_cdp_access)),
      (e[2] = o?.requirements?.featureRequirements),
      (e[3] = s),
      (e[4] = c),
      (e[5] = l),
...
function $r(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = () => {
      ...
      (h = (0, X.jsx)(_t, { className: `icon-xs` })),
      (g = (0, X.jsx)(B, {
  ...
  t[11] === _
    ? (b = t[12])
    : ((b = (0, X.jsx)(K.Header, { actions: _, title: v, subtitle: y })),
      (t[11] = _),
      (t[12] = b));
  let x;
  ...
  return (
    t[28] !== x || t[29] !== S || t[30] !== C || t[31] !== w || t[32] !== b
      ? ((T = (0, X.jsxs)(K, { children: [b, x, S, C, w] })),
        (t[28] = x),
        (t[29] = S),
        (t[30] = C),
        (t[31] = w),
...
function ti(e) {
  ...
  t[19] === r
    ? (f = t[20])
    : ((f = (0, X.jsx)(ai, { row: r })), (t[19] = r), (t[20] = f));
  let p;
  return (
    t[21] !== u || t[22] !== d || t[23] !== f
      ? ((p = (0, X.jsxs)(`div`, {
...
function ri(e) {
  let t = (0, fi.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((o = ht(`size-2 shrink-0 rounded-full`, r, i, a)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
...
function si({ onOpenChange: e, open: t, visibleResources: n }) {
  let r = z(G),
    i = Xe(),
    [a, o] = (0, Y.useState)(``),
    [s, c] = (0, Y.useState)(`allowed`),
    [l, u] = (0, Y.useState)(gi),
    [d, f] = (0, Y.useState)(!1),
    [p, m] = (0, Y.useState)(!1),
    h = v(),
    g = `browser-use-add-browsing-label`,
    _ = `browser-use-add-browsing-value`,
    y = () => {
      (o(``), c(`allowed`), u(gi), f(!1));
    },
    x = async () => {
      let t = a.trim();
      if (!(t.length === 0 || p)) {
...
function yi(e) {
  ...
  let l = c,
    u = ke(),
    { installPlugin: d, status: f } = re(),
    p;
  t[2] === o ? (p = t[3]) : ((p = { hostId: o }), (t[2] = o), (t[3] = p));
  let { pendingPluginId: m, setPluginEnabled: h } = bt(p),
    g;
  t[4] === o ? (g = t[5]) : ((g = { hostId: o }), (t[4] = o), (t[5] = g));
  let { pendingUninstallPluginId: _, uninstallPlugin: v } = yn(g),
    y = f?.hostId === o ? f.pluginId : null,
    b = m ?? y ?? _,
    x = i.length + l.length;
  if (a.isLoading && x === 0) {
    let e;
  ...
  if (x === 0) {
    ...
    return (
      t[9] === n
        ? (e = t[10])
        : ((e = (0, Z.jsx)(U, {
            children: (0, Z.jsx)(lt, { layout: `settings-row`, children: n }),
          })),
          (t[9] = n),
          (t[10] = e)),
      e
      ...
      ? ((e = (e) =>
          e.kind === `app`
            ...
            : (0, Z.jsx)(
                ...
                {
                  installButtonLabel: r,
                  isPending: b === e.plugin.plugin.id,
                  item: e,
                  onInstallPlugin: (e) => {
                    d(e, { hostId: o, onSuccess: a.forceReload });
                  },
                  onOpenPluginDetails: (e) => {
                    u(k(e, { hostId: o }));
                  },
                  onToggleInstalledPluginEnabled: (t, n) => {
                    h({
                      pluginId: t.plugin.id,
                      pluginDisplayName: e.displayName ?? tt(t),
                      enabled: n,
                    });
                  },
                  onUninstallPlugin: (e) => {
  ...
  let C;
  t[30] === l ? (C = t[31]) : ((C = l.map(bi)), (t[30] = l), (t[31] = C));
  let w;
  return (
    t[32] !== S || t[33] !== C
      ? ((w = (0, Z.jsx)(Z.Fragment, {
          children: (0, Z.jsxs)(U, { children: [S, C] }),
        })),
        (t[32] = S),
        (t[33] = C),
        (t[34] = w))
...
function xi(e) {
  ...
  t[0] === n.icon
    ...
    : ((i =
        n.icon ??
        (0, Z.jsx)(pe, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
...
function Ci(e) {
  ...
  if (
    ...
    let e = i.displayName ?? tt(i.plugin),
      _ = i.plugin.plugin.installed;
    h = `group flex min-h-[60px] items-center gap-3 px-4 py-3 text-sm hover:bg-token-foreground/5 max-sm:flex-wrap`;
    let v;
    ...
    let x =
        ...
        (0, Z.jsx)(Re, {
          ...
          logoDarkUrl: i.plugin.logoDarkPath,
      ...
      S;
    t[18] !== b || t[19] !== x
      ? ((S = (0, Z.jsx)(`span`, { className: b, children: x })),
        (t[18] = b),
        (t[19] = x),
        (t[20] = S))
      : (S = t[20]);
    ...
    (t[26] !== w || t[27] !== T
      ...
      t[29] !== S || t[30] !== E || t[31] !== v
        ? ((g = (0, Z.jsxs)(`button`, {
          ...
          (t[32] = g))
        : (g = t[32]),
      (f = `flex shrink-0 items-center gap-2`),
      (p = i.action),
      (m = _
        ? (0, Z.jsxs)(Z.Fragment, {
            children: [
      ...
      (t[11] = h),
      (t[12] = g));
  } else ((f = t[8]), (p = t[9]), (m = t[10]), (h = t[11]), (g = t[12]));
  let _;
  t[33] !== f || t[34] !== p || t[35] !== m
    ? ((_ = (0, Z.jsxs)(`div`, { className: f, children: [p, m] })),
      (t[33] = f),
      (t[34] = p),
      (t[35] = m),
      (t[36] = _))
...
function Oi() {
  let e = (0, Q.c)(15),
    ...
    { selectedHostId: a } = Ie(),
    o;
  e[0] === a ? (o = e[1]) : ((o = { hostId: a }), (e[0] = a), (e[1] = o));
  let s = p(o),
    c;
  e[2] === a ? (c = e[3]) : ((c = { hostId: a }), (e[2] = a), (e[3] = c));
  let l = Ae(c),
    u = n(`1834314516`);
  if (i != null) {
    if (i === `downloads` && !u) {
      ...
      return (
        e[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(ae, { to: `/settings/browser-use`, replace: !0 })),
            (e[4] = t))
          : (t = e[4]),
        t
      );
      ...
      if (n.isLoading) {
        ...
        return (
          e[5] === Symbol.for(`react.memo_cache_sentinel`)
            ? ((t = (0, $.jsx)(ie, { section: `browser-use` })), (e[5] = t))
            : (t = e[5]),
          t
        );
      }
    ...
    r !== i && t.set(oa, i);
    let o;
    return (e[7] === i ? (o = e[8]) : ((o = zi(i)), (e[7] = i), (e[8] = o)), o);
  }
  r != null && t.set(oa, null);
  let d;
  e[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)($e, { slug: `browser-use` })), (e[9] = d))
    : (d = e[9]);
  let f;
  e[10] === l.available
    ? (f = e[11])
  ...
  return (
    e[13] === f
      ? (h = e[14])
      : ((h = (0, $.jsx)(Rt, { title: d, subtitle: f, children: m })),
        (e[13] = f),
        (e[14] = h)),
    h
  );
...
function Ai() {
  ...
  let i = f(t, r),
    a = Kn(t),
    o;
  e[1] !== a || e[2] !== i.availablePlugins
    ? ((o = Ei(i.availablePlugins, ue, a)),
      (e[1] = a),
      (e[2] = i.availablePlugins),
      (e[3] = o))
    : (o = e[3]);
  let s = o,
    c;
  ...
  let d = w(u),
    m;
  e[8] === t ? (m = e[9]) : ((m = { hostId: t }), (e[8] = t), (e[9] = m));
  let h = p(m),
    g;
  e[10] === t ? (g = e[11]) : ((g = { hostId: t }), (e[10] = t), (e[11] = g));
  let _ = te(g),
    v;
  e[12] === t ? (v = e[13]) : ((v = { hostId: t }), (e[12] = t), (e[13] = v));
  let y = Ae(v),
    b = n(`1834314516`),
    x = d.enabled && !d.isLoading,
    S = h.passwordManager.enabled,
    C = h.contactInfo.enabled,
    T = S || C,
    E = h.siteSettings.enabled,
    ee = h.extensions.enabled,
    D = _.available || y.available,
    O = E || D,
    k;
  e[14] !== s || e[15] !== _
    ? ((k =
    ...
    ? ((A = (0, $.jsx)(K, {
        children: (0, $.jsx)(K.Content, {
          children: (0, $.jsx)($i, {
            ...
            pluginsQuery: i,
            selectedHostId: t,
            unavailableBrowserUsePlugins: ne,
          }),
        }),
      })),
      (e[17] = l),
                ...
                children: (0, $.jsxs)(U, {
                  children: [
                    b
                      ...
                      : null,
                    (0, $.jsx)(Ui, {}),
                    (0, $.jsx)(Gi, { includeHistory: h.history.enabled }),
                    h.history.enabled ? (0, $.jsx)(Fi, {}) : null,
                    (0, $.jsx)(Bi, {}),
                  ],
                }),
              }),
    ...
    : ((re = ee
        ? (0, $.jsxs)(K, {
            children: [
              ...
              (0, $.jsx)(K.Content, {
                children: (0, $.jsx)(U, { children: (0, $.jsx)(Pi, {}) }),
              }),
            ],
          })
        : null),
      ...
      (e[31] = re));
  let ie;
  e[32] !== b || e[33] !== h.downloads
    ? ((ie =
        !b || !h.downloads.enabled
          ? null
          : (0, $.jsx)(We, { electron: !0, children: (0, $.jsx)(ji, {}) })),
      (e[32] = b),
      (e[33] = h.downloads),
      (e[34] = ie))
    : (ie = e[34]);
  let N;
  e[35] !== O || e[36] !== D || e[37] !== E
    ? ((N = O
        ? (0, $.jsxs)(K, {
            children: [
              (0, $.jsx)(K.Header, {
  ...
  return (
    ...
    e[46] !== A ||
    e[47] !== j
      ? ((F = (0, $.jsxs)($.Fragment, { children: [A, j, M, re, ie, N, P] })),
        (e[41] = M),
        (e[42] = re),
        (e[43] = ie),
        (e[44] = N),
...
function ji() {
  let e = z(G),
    ...
    [r, i] = (0, ta.useState)(!1),
    a = Pe?.downloads,
    o = he(Kt.downloadDirectory),
    s = he(Kt.promptForDownloadLocation);
  if (a == null) return null;
  let c = async () => {
    i(!0);
    try {
      let t = await a.chooseDownloadDirectory();
      t != null && (await I(e, Kt.downloadDirectory, t));
    } catch {
      e.get(me).danger(
        t.formatMessage({
          ...
          children: [
            ...
            (0, $.jsx)(H, {
              ...
              control: (0, $.jsx)(Pn, {
                ...
                checked: s,
                onChange: (t) => {
                  I(e, Kt.promptForDownloadLocation, t);
                },
              }),
            }),
            (0, $.jsx)(H, {
              ...
              control: (0, $.jsx)(W, {
                ...
                onClick: () => {
                  (Ye(e, oe, {
                    action:
                      R.CODEX_BROWSER_SURFACE_ACTION_TYPE_DOWNLOADS_SELECTED,
                    surface: Ht.CODEX_BROWSER_SURFACE_BROWSER_SETTINGS_PAGE,
                  }),
                    n(mn));
                },
                children: (0, $.jsx)(B, {
...
function Mi() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(Li, {
          action: R.CODEX_BROWSER_SURFACE_ACTION_TYPE_PASSWORD_MANAGER_SELECTED,
          description: (0, $.jsx)(B, {
...
function Ni() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(Li, {
          action: R.CODEX_BROWSER_SURFACE_ACTION_TYPE_CONTACT_INFO_SELECTED,
          description: (0, $.jsx)(B, {
...
function Pi() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(Li, {
          action: R.CODEX_BROWSER_SURFACE_ACTION_TYPE_EXTENSIONS_SELECTED,
          description: (0, $.jsx)(B, {
...
function Fi() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(Li, {
          action: R.CODEX_BROWSER_SURFACE_ACTION_TYPE_HISTORY_SELECTED,
          description: (0, $.jsx)(B, {
...
function Ii() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(Li, {
          action: R.CODEX_BROWSER_SURFACE_ACTION_TYPE_SITE_SETTINGS_SELECTED,
          description: (0, $.jsx)(B, {
...
function Li(e) {
  ...
  return (
    t[8] !== r || t[9] !== i || t[10] !== u
      ? ((d = (0, $.jsx)(H, { label: i, description: r, control: u })),
        (t[8] = r),
        (t[9] = i),
        (t[10] = u),
        (t[11] = d))
...
function Bi() {
  let e = (0, Q.c)(14),
    t = z(G),
    n = he(Kt.annotationScreenshotsMode),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = {
        id: `always`,
    ...
    ? ((d = (0, $.jsx)(`div`, {
        ...
        children: a.map((e) => {
          ...
          return (0, $.jsx)(
            ...
            {
              allowWrap: !0,
              RightIcon: r ? fn : void 0,
              onSelect: () => {
                I(t, Kt.annotationScreenshotsMode, e.id);
              },
              children: (0, $.jsx)(`span`, {
                className: `truncate`,
                children: e.label,
...
function Vi() {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(j, { children: (0, $.jsx)(Hi, { target: n }) })),
      (e[2] = n),
      (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = aa.map((e) =>
        (0, $.jsx)(
          V.Item,
          {
            onSelect: () => {
              n !== e &&
                (I(t, ze.openLinkInTargetPreference, e),
                Ye(t, be, {
                  setting: `web_url`,
...
function Ui() {
  let e = (0, Q.c)(10),
    t = z(G),
    n = he(ze.openLocalUrlInTargetPreference),
    r,
    i;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(B, {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(j, { children: (0, $.jsx)(Wi, { target: n }) })),
      (e[2] = n),
      (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = aa.map((e) =>
        (0, $.jsx)(
          V.Item,
          {
            onSelect: () => {
              n !== e &&
                (I(t, ze.openLocalUrlInTargetPreference, e),
                Ye(t, be, {
                  setting: `local_url`,
                  previousDestination: n,
                  selectedDestination: e,
  ...
  let t = z(G),
    ...
    u = async (e, n) => {
      if (!c) {
        o(e);
        try {
          (await s.mutateAsync(n), t.get(me).success(Yi(e)));
        } catch {
          t.get(me).danger(Xi(e));
        } finally {
          o(null);
        }
      }
...
function Zi() {
  let e = (0, Q.c)(35),
    t = z(G),
    { data: n, isLoading: r } = Te(_e),
    i = n?.approvalMode,
    a = Ut(),
    { value: o } = De(ve),
    s;
  e[0] === o ? (s = e[1]) : ((s = Jt(o)), (e[0] = o), (e[1] = s));
  let c = s,
    l;
  e[2] === c
    ? (l = e[3])
    : ((l = (e) => {
        et({ event: e, href: c, initiator: `open_in_browser_bridge` });
      }),
      (e[2] = c),
      (e[3] = l));
  let u = l,
  ...
  e[19] === E
    ? (ee = e[20])
    : ((ee = (0, $.jsx)(`span`, { className: `truncate`, children: E })),
      (e[19] = E),
      (e[20] = ee));
  let te;
  e[21] !== T || e[22] !== ee
  ...
  return (
    e[32] !== O || e[33] !== S
      ? ((k = (0, $.jsx)(H, { label: x, description: S, control: O })),
        (e[32] = O),
        (e[33] = S),
        (e[34] = k))
      : (k = e[34]),
      ...
      (d = n.map((t) => ({
        ...
        onTryInChat: () => {
          o({
            activeProject: e,
            prefillPrompt: it({
              defaultPrompt: Cn(t.plugin.interface?.defaultPrompt),
              pluginDisplayName: tt(t),
              pluginId: t.plugin.id,
            }),
            startInSidebar: !0,
          });
...
//# sourceMappingURL=browser-use-settings-DfdZKrCs.js.map
