...
function v(e, t) {
  ...
  let n = e.location === S ? `Left` : e.location === C ? `Right` : null;
...
var x,
  ...
  T = e(() => {
    (ae(),
      (x = new Set([`Meta`, `Control`, `Alt`, `AltGraph`, `Shift`])),
      (S = 1),
      (C = 2),
      (w = new Map([
        [`Escape`, `Esc`],
...
function E(e) {
  let t = (0, ve.c)(116),
    ...
    M = (0, D.useRef)(null),
    N = (0, D.useRef)(null),
    [ye, be] = (0, D.useState)(!1),
    [xe, Se] = (0, D.useState)(null),
    P;
  ...
  t[1] === fe
    ? (F = t[2])
    : ((F = function (e) {
        ((A.current += 1), (j.current = null), Ce(), fe(e));
      }),
      (t[1] = fe),
      (t[2] = F));
  let I = F,
  ...
  t[3] === de
    ? (L = t[4])
    : ((L = function () {
        ((A.current += 1), (j.current = null), Ce(), de());
      }),
      (t[3] = de),
      (t[4] = L));
  let R = L,
  ...
  t[9] === I
    ...
    : ((Ee = async (e) => {
        try {
          let { hotkey: t } = await ue(`global-dictation-capture-fn-hotkey`);
          t != null && A.current === e && I(t);
        } catch {}
      }),
      (t[9] = I),
      (t[10] = Ee));
  let De = (0, D.useEffectEvent)(Ee),
    Oe;
  t[11] !== b || t[12] !== De || t[13] !== g || t[14] !== E
    ? ((Oe = () => (
        (A.current += 1),
        g && b && E === `macOS` && De(A.current),
        () => {
          ((A.current += 1),
            (j.current = null),
            (M.current = null),
  ...
  let ke;
  if (
    (t[16] !== b || t[17] !== g || t[18] !== E
      ? ((ke = [b, g, E]), (t[16] = b), (t[17] = g), (t[18] = E), (t[19] = ke))
      : (ke = t[19]),
    (0, D.useEffect)(Oe, ke),
    g)
  ) {
    ...
    t[20] === d
      ? (e = t[21])
      : ((e = ie(`flex w-full flex-col items-start gap-1`, d)),
        (t[20] = d),
        (t[21] = e));
    let n = C == null ? void 0 : k,
      r = C == null ? void 0 : !0,
      i;
    t[22] !== T || t[23] !== xe
      ? ((i =
    ...
    t[29] !== b || t[30] !== I
      ? ((o = (e) => {
          if ((e.preventDefault(), e.stopPropagation(), !b)) return;
          let t = ge(e.nativeEvent);
          t != null && j.current === t && I(t);
        }),
        (t[29] = b),
        (t[30] = I),
        (t[31] = o))
    ...
    let p;
    return (
      t[49] !== e || t[50] !== u || t[51] !== f
        ? ((p = (0, O.jsxs)(`div`, { className: e, children: [u, f] })),
          (t[49] = e),
          (t[50] = u),
          (t[51] = f),
          (t[52] = p))
  ...
  t[68] === d
    ? (V = t[69])
    : ((V = ie(`group flex min-h-8 items-center`, d)),
      (t[68] = d),
      (t[69] = V));
  let Pe = l == null ? void 0 : `group`,
    H;
  t[70] !== i || t[71] !== ae
    ? ((H =
        i == null
          ...
          : (0, O.jsx)(p, { className: `!px-2 !py-1 !text-sm`, keysLabel: i })),
      (t[70] = i),
      (t[71] = ae),
      (t[72] = H))
    : (H = t[72]);
  ...
  t[80] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Fe = t[80]);
  let K;
  t[81] !== S || t[82] !== z || t[83] !== y
    ? ((K = (e) => {
        z ? (S && e.shiftKey ? y(`append`) : y(`replace`)) : y(`set`);
      }),
      (t[81] = S),
      (t[82] = z),
      (t[83] = y),
  ...
  t[85] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ie = (0, O.jsx)(pe, { className: `icon-xs` })), (t[85] = Ie))
    : (Ie = t[85]);
  let q;
  t[86] !== w || t[87] !== B || t[88] !== W || t[89] !== G || t[90] !== K
    ? ((q = (0, O.jsx)(h, {
        "aria-label": B,
        color: `ghost`,
        disabled: w,
  ...
  let J;
  t[92] !== B || t[93] !== q
    ? ((J = (0, O.jsx)(o, { tooltipContent: B, children: q })),
      (t[92] = B),
      (t[93] = q),
      (t[94] = J))
    : (J = t[94]);
  ...
  t[95] !== U || t[96] !== J
    ...
    : (Y = t[97]);
  let X;
  t[98] !== je || t[99] !== w || t[100] !== z || t[101] !== _
    ? ((X = z
        ? (0, O.jsx)(o, {
            tooltipContent: je,
            children: (0, O.jsx)(h, {
              ...
              uniform: !0,
              onClick: _,
              children: (0, O.jsx)(n, { className: `icon-xs` }),
            }),
          })
        : null),
      (t[98] = je),
        ...
        v == null
          ...
          : (0, O.jsx)(o, {
              ...
              children: (0, O.jsx)(h, {
                ...
                uniform: !0,
                onClick: v,
                children: (0, O.jsx)(se, { className: `icon-xs` }),
              }),
            })),
      (t[103] = w),
      (t[104] = v),
...
export { T as i, k as n, me as r, E as t };
//# sourceMappingURL=hotkey-setter-S1Vpy1pX.js.map
