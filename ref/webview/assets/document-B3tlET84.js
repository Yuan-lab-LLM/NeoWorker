...
import { Bn as m, Vn as re } from "./spreadsheet-Ckzf8Np8.js";
function h() {
  return {
    id: void 0,
    charts: [],
  ...
  de = e(() => {
    (ee(),
      ...
      (N = {
        encode(e, t = new n()) {
          ...
          (e.settings !== void 0 &&
            ...
            e.theme !== void 0 &&
              a.encode(e.theme, t.uint32(154).fork()).join());
          for (let n of e.fonts) V.encode(n, t.uint32(162).fork()).join();
          return t;
        },
        decode(e, t) {
          let n = e instanceof r ? e : new r(e),
          ...
          for (; n.pos < i;) {
            ...
            switch (e >>> 3) {
              ...
              case 1:
                if (e !== 10) break;
                s.charts.push(c.decode(n, n.uint32()));
                continue;
              case 2:
                if (e !== 18) break;
                s.name = n.string();
              ...
              case 3:
                if (e !== 24) break;
                s.widthEmu = O(n.int64());
                continue;
              case 4:
                if (e !== 32) break;
                s.heightEmu = O(n.int64());
                continue;
              case 5:
                if (e !== 42) break;
                s.elements.push(o.decode(n, n.uint32()));
                continue;
              case 7:
                if (e !== 58) break;
                s.images.push(d.decode(n, n.uint32()));
                continue;
              case 8:
                if (e !== 66) break;
                s.footnotes.push(P.decode(n, n.uint32()));
                continue;
              case 9:
                if (e !== 74) break;
                s.comments.push(I.decode(n, n.uint32()));
                continue;
              case 10:
                if (e !== 82) break;
                s.commentReferences.push(L.decode(n, n.uint32()));
                continue;
              case 11:
                if (e !== 90) break;
                s.textStyles.push(p.decode(n, n.uint32()));
                continue;
              case 12:
                if (e !== 98) break;
                s.reviewMarks.push(f.decode(n, n.uint32()));
                continue;
              case 13:
                if (e !== 106) break;
                s.sections.push(X.decode(n, n.uint32()));
                continue;
              case 14:
                if (e !== 114) break;
                s.numberingDefinitions.push(J.decode(n, n.uint32()));
                continue;
              case 15:
                if (e !== 122) break;
                s.paragraphNumberings.push(Y.decode(n, n.uint32()));
                continue;
              case 16:
                if (e !== 130) break;
                s.tableStyleDefinitions.push(l.decode(n, n.uint32()));
                continue;
              case 17:
                if (e !== 138) break;
                s.endnotes.push(F.decode(n, n.uint32()));
                continue;
              case 18:
                if (e !== 146) break;
                s.settings = z.decode(n, n.uint32());
                continue;
              case 19:
                if (e !== 154) break;
                s.theme = a.decode(n, n.uint32());
                continue;
              case 20:
                if (e !== 162) break;
                s.fonts.push(V.decode(n, n.uint32()));
                continue;
            }
            if ((e & 7) == 4 || e === 0) break;
            n.skip(e & 7);
        ...
        decode(e, t) {
          ...
          for (; n.pos < a;) {
            ...
            switch (e >>> 3) {
              ...
              case 2:
                if (e !== 18) break;
                o.paragraphs.push(i.decode(n, n.uint32()));
                continue;
              case 3:
                if (e !== 26) break;
        ...
        decode(e, t) {
          ...
          for (; n.pos < i;) {
            ...
            switch (e >>> 3) {
              case 1:
                if (e !== 10) break;
                a.elements.push(o.decode(n, n.uint32()));
                continue;
            }
            if ((e & 7) == 4 || e === 0) break;
            n.skip(e & 7);
      ...
      (Q = {
        encode(e, r = new n()) {
          return (
            e.id !== void 0 && r.uint32(82).string(e.id),
            e.type !== 0 && r.uint32(8).int32(e.type),
            e.version !== `` && r.uint32(50).string(e.version),
            e.document !== void 0 &&
              N.encode(e.document, r.uint32(18).fork()).join(),
            e.presentation !== void 0 &&
              t.encode(e.presentation, r.uint32(26).fork()).join(),
            e.workbook !== void 0 &&
              m.encode(e.workbook, r.uint32(34).fork()).join(),
            e.playground !== void 0 &&
              Z.encode(e.playground, r.uint32(42).fork()).join(),
            r
          );
        },
        decode(e, n) {
          let i = e instanceof r ? e : new r(e),
            a = n === void 0 ? i.len : i.pos + n,
            o = D();
          for (; i.pos < a;) {
            let e = i.uint32();
            switch (e >>> 3) {
              ...
              case 2:
                if (e !== 18) break;
                o.document = N.decode(i, i.uint32());
                continue;
              case 3:
                if (e !== 26) break;
                o.presentation = t.decode(i, i.uint32());
                continue;
              case 4:
                if (e !== 34) break;
                o.workbook = m.decode(i, i.uint32());
                continue;
              case 5:
                if (e !== 42) break;
                o.playground = Z.decode(i, i.uint32());
                continue;
            }
            if ((e & 7) == 4 || e === 0) break;
            i.skip(e & 7);
...
//# sourceMappingURL=document-B3tlET84.js.map
