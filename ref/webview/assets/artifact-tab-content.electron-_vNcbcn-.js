const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./workbook-C19LNRn3.js",
      "./workbook-Bcziiv_P.js",
      ...
      "./PopcornElectronDocumentPanel-5Li1GjYe.js",
      "./remote-text-edit-session-DoJKJPVz.js",
      "./remote-text-edit-session-CW-aJKLZ.css",
      "./feature-catalog-BRPzcYeX.js",
      "./PopcornPageNumberNavigation-ub7O3ho1.js",
      "./PopcornElectronPresentationPanel-CWv1SPy0.js",
      "./modifiers.esm--SGMoLew.js",
      "./popcorn-electron-surface-style-CfRbpzvu.js",
      "./PopcornElectronPresentationPanel-pMDpowHW.css",
      "./PopcornElectronWorkbookPanel-Bxc50C6W.js",
      "./docx-preview-panel-bCo3qbro.js",
      "./artifact-analytics-DHJoQ0CH.js",
      "./artifact-annotation-comment-CYq-DIFd.js",
      "./artifact-preview-status-0ScAQLgS.js",
      "./notebook-preview-panel-Du9aIMqK.js",
      "./pdf-preview-panel-YIevlW21.js",
...
import {
  ...
  r as At,
  t as jt,
} from "./artifact-analytics-DHJoQ0CH.js";
import {
  a as Mt,
  i as Nt,
  n as Pt,
  ...
  r as It,
  t as Lt,
} from "./artifact-annotation-comment-CYq-DIFd.js";
import { n as Rt, t as zt } from "./artifact-preview-status-0ScAQLgS.js";
function Bt() {
  let e = (0, Vt.c)(3),
    [t, n] = (0, Ht.useState)(!1),
    r,
    ...
    t.map((e) =>
      (async function (e) {
        try {
          ...
          let n = await a(() => import(t), [], import.meta.url);
...
function U(e, n) {
  ...
  let o = i && typeof n.message == `string` ? n.message : `` + n;
  (((n = i
    ? n
    : K.ExitStatus
      ? (function (e, t) {
      ...
      : Error(`Exit with code ` + e + ` ` + o)).status = e),
    (n.message ||= o));
  let s = `` + (n.stack || Error().stack);
  try {
    Object.defineProperty(n, "stack", { get: () => s });
  } catch {}
  let c = !!n.silent;
  if (((n.silent = !0), qn()))
        ...
        try {
          await (async function () {
            try {
              ...
              (await Promise.race([Promise.all([i, r]), s]), clearTimeout(o));
            } catch (e) {
    ...
    (ni && ri) ||
      (typeof e.moduleExports == `object`
        ...
        : (q.diagnosticTracing &&
          ...
          (ni = a(() => import(e.resolvedUrl), [], import.meta.url))),
      typeof t.moduleExports == `object`
        ? (ri = t.moduleExports)
        : (q.diagnosticTracing &&
            B(`Attempting to import '${t.resolvedUrl}' for ${t.name}`),
          (ri = a(() => import(t.resolvedUrl), [], import.meta.url)))),
    [ni, ri]
  );
}
async function or(e) {
  let {
      ...
      configureWorkerStartup: o,
      setRuntimeGlobals: s,
      passEmscriptenInternals: c,
    } = e[0],
    { default: l } = e[1];
  if ((s($r), t($r), q.config.globalizationMode === `hybrid`)) {
    let { initHybrid: e } = await (async function () {
      ...
      return (
        typeof t.moduleExports == `object`
          ? (e = t.moduleExports)
          : (B(`Attempting to import '${t.resolvedUrl}' for ${t.name}`),
            (e = a(() => import(t.resolvedUrl), [], import.meta.url))),
        await e
      );
    })();
    e(Yr, K);
...
async function mi(e, t) {
  let { Workbook: n } = await a(
    async () => {
      let { Workbook: e } = await import(`./workbook-C19LNRn3.js`);
      return { Workbook: e };
    },
...
function xi(e) {
  let t = (0, wi.c)(13),
    ...
    a = Fe(),
    { skills: s } = ue(void 0, n),
    c;
  t[0] === s ? (c = t[1]) : ((c = s.find(Si)), (t[0] = s), (t[1] = c));
  let l = c,
    u;
  t[2] === r
    ? (u = t[3])
  ...
  let d = u,
    f = l == null,
    p;
  t[4] !== d || t[5] !== i || t[6] !== a || t[7] !== l
    ? ((p = () => {
        l != null &&
          a({
            activeProject: d,
            prefillPrompt: `${o(l)} Edit ${o(i)} `,
            startInSidebar: !0,
          });
      }),
      (t[4] = d),
...
function Ci(e) {
  let t = (0, wi.c)(40),
    ...
    [s, c] = (0, Ti.useState)(!1),
    l;
  t[0] === r ? (l = t[1]) : ((l = St(r)), (t[0] = r), (t[1] = l));
  let u = l,
    d;
  t[2] === r ? (d = t[3]) : ((d = L(r)), (t[2] = r), (t[3] = d));
  let f = d,
    p;
  t[4] === a
    ? (p = t[5])
  ...
  t[6] === p
    ? (m = t[7])
    : ((m = (0, X.jsx)(Oe, { label: p })), (t[6] = p), (t[7] = m));
  let h;
  ...
  let y;
  t[15] !== g || t[16] !== v
    ? ((y = (0, X.jsx)(he.Item, { onSelect: g, children: v })),
      (t[15] = g),
      (t[16] = v),
      (t[17] = y))
    : (y = t[17]);
  ...
  t[18] !== m || t[19] !== y
    ...
    : (b = t[20]);
  let x;
  t[21] === r ? (x = t[22]) : ((x = yt(r)), (t[21] = r), (t[22] = x));
  let S;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, X.jsx)(Ei, { className: `size-5 text-token-text-secondary` })),
      (t[23] = S))
    : (S = t[23]);
  let C;
  t[24] === u
    ? (C = t[25])
    : ((C = (0, X.jsx)(pt, { kind: `Skill`, title: u })),
      (t[24] = u),
      (t[25] = C));
  let w;
  t[26] !== s || t[27] !== u || t[28] !== n || t[29] !== r.path
    ...
    : (w = t[30]);
  let E;
  t[31] !== s || t[32] !== u || t[33] !== x || t[34] !== C || t[35] !== w
    ? ((E = (0, X.jsx)(Ce, {
        description: x,
        icon: S,
        iconShape: `rounded`,
  ...
  return (
    t[37] !== E || t[38] !== b
      ? ((D = (0, X.jsxs)(X.Fragment, { children: [b, E] })),
        (t[37] = E),
        (t[38] = b),
        (t[39] = D))
      : (D = t[39]),
...
function Oi({
  ...
  let l = ne(it),
    ...
    _ = g
      ? () => {
          if (l.value.routeKind === `local-thread`)
            return je(`ignore-open-file-change-events`, {
              conversationId: l.value.conversationId,
              hostId: i,
              path: o,
            });
        }
    ...
    S = _e((e) => {
      ((y.current = e), e != null && s != null && D(s));
    }),
    C = Li({ hostId: i, importKind: a, path: o }),
    T = (0, Q.useMemo)(() => [`manual-artifact-preview`, C], [C]),
    {
      data: E,
      dataUpdatedAt: ee,
      isError: O,
      isFetching: k,
      isLoading: te,
    } = ce(`read-file-metadata`, {
      params: { hostId: i, path: o },
      queryConfig: {
        enabled: f,
        ...(g
          ? {
    ...
    A =
      f &&
      E?.isFile === !0 &&
      (t === `pdf` || E.sizeBytes == null || E.sizeBytes <= Wi),
    j = a === `tex`,
    re = A && t !== `pdf` && t !== `notebook` && !v,
    {
      data: N,
      dataUpdatedAt: ie,
      isError: oe,
      isFetching: se,
      isLoading: P,
    } = ce(j ? `compile-latex-artifact` : `read-file-binary`, {
      params: { hostId: i, path: o },
      queryConfig: {
        enabled: A,
        ...(g
    ...
    }),
    {
      ...
      cacheKey: C,
      contentsBase64: N?.contentsBase64,
      hasBinaryResponse: N != null,
      importKind: a,
      shouldParseArtifactPreview: re,
    }),
    fe =
      t === `pdf` && N?.contentsBase64 != null
        ? `data:application/pdf;base64,${N.contentsBase64}`
        : null,
    L = (0, Q.useMemo)(
      () => (!v || N?.contentsBase64 == null ? null : Vi(N.contentsBase64)),
      [N?.contentsBase64, v],
    ),
    pe = (0, Q.useMemo)(() => (L == null ? null : Hi(L)), [L]);
  ((0, Q.useEffect)(() => {
    if (s == null) return;
    let e = `${s}\0${i}\0${o}\0${t}\0${a}`;
    return (
      d.current !== e &&
        ((d.current = e),
        Ve({ artifactType: t, importKind: a, requestKey: s })),
      Qe(s)
    );
  }, [t, i, a, o, s]),
    (0, Q.useEffect)(() => {
      if (!(s == null || !f) && !(k || se)) {
        if (O) {
          Je(s, `metadata_load_failed`);
          return;
        }
        if (E == null) {
          te || Je(s, `metadata_load_failed`);
          return;
        }
        if (!E.isFile) {
          Je(s, `metadata_load_failed`);
        ...
        if ((Ne(s), t !== `pdf` && E.sizeBytes != null && E.sizeBytes > Wi)) {
          Je(s, `size_limit_exceeded`);
          return;
        }
        if (oe) {
          Je(s, `binary_read_failed`);
          return;
        }
        if (N?.contentsBase64 != null) De(s);
        else if (!P && N != null) {
          Je(s, `binary_read_failed`);
          return;
        }
        if (t !== `pdf`) {
          ...
          ((v && L != null) || (de != null && F)) && (at(s), rt(s));
        }
      }
    }, [t, N, ie, E, ee, f, oe, se, P, F, O, k, te, L, ue, de, v, s]));
  let me = _e((e) => {
    if (e.artifactKind === `document`) {
      ...
      return v
        ...
        : de?.kind === `document`
          ? (x({ requestId: globalThis.crypto.randomUUID(), target: e }), !0)
          : !1;
    }
    return e.artifactKind === `presentation`
      ? de?.kind !== `presentation` || e.slideNumber == null
        ? !1
        : (x({ requestId: globalThis.crypto.randomUUID(), target: e }), !0)
      : de?.kind !== `spreadsheet` || !(`range` in e)
        ? !1
        : (x({ requestId: globalThis.crypto.randomUUID(), target: e }), !0);
  });
  (0, Q.useEffect)(() => {
    if (s != null) return w(s, me);
  }, [me, s]);
  let R = v ? L != null : de != null;
  (0, Q.useEffect)(() => {
    s == null || !R || D(s);
  }, [R, s]);
  let z = Ie(a)
      ? (0, $.jsx)(Fi, { hostId: i, path: o, tabId: s, title: c })
      : null,
    he =
      e == null
        ? null
        : (0, $.jsx)(yi, { hostId: i, part: `title`, skill: e, title: c }),
    ge =
      e == null
        ? null
        : (0, $.jsx)(yi, { hostId: i, part: `menu`, skill: e, title: c }),
    ve =
      e == null
        ? null
        : (0, $.jsx)(yi, {
            ...
            part: `edit`,
            projectContext:
              l.value.routeKind === `home` ||
              l.value.routeKind === `local-thread`
                ? l.value.projectContext
                : null,
            skill: e,
            title: c,
          }),
  ...
  return f
    ? E == null
      ? (0, $.jsx)(Z, { isError: O, isLoading: te })
      : E.isFile
        ? t !== `pdf` && E.sizeBytes != null && E.sizeBytes > Wi
          ? (0, $.jsx)(Ii, {
              chromeMode: r,
                            ...
                            children: (0, $.jsx)(Q.Suspense, {
                              ...
                              children: (0, $.jsx)(
                                Qi,
                                {
                                  ...
                                  headerRightContent: ve,
                                  headerTitleContent: he,
                                  headerZoomLeadingContent: ge,
                                  hostId: i,
                                  onBeforeOpen: _,
                                  path: o,
                                  tabId: s,
...
function Ai(e) {
  let t = (0, Ui.c)(50),
    ...
    f;
  t[0] !== r || t[1] !== a
    ? ((f = be({ hostId: r, path: a })), (t[0] = r), (t[1] = a), (t[2] = f))
    : (f = t[2]);
  let p = te(ut, f),
    m;
  t[3] !== r || t[4] !== a || t[5] !== o || t[6] !== l
    ? ((m = () =>
        nt({
          cacheKey: o,
          openFiles: [{ hostId: r, path: a }],
          queryClient: l,
          throwOnError: !0,
        })),
      (t[3] = r),
  ...
  t[8] !== r || t[9] !== a || t[10] !== c
    ? ((h = () => {
        Me(c, { hostId: r, path: a });
      }),
      (g = () => {
        mt(c, { hostId: r, path: a });
      }),
      (t[8] = r),
      (t[9] = a),
      (t[10] = c),
    ...
    : ((h = t[11]), (g = t[12]));
  let _;
  t[13] !== m || t[14] !== h || t[15] !== g
    ? ((_ = { mutationFn: m, onError: h, onSuccess: g }),
      (t[13] = m),
      (t[14] = h),
      (t[15] = g),
      (t[16] = _))
  ...
  t[17] === u
    ? (y = t[18])
    : ((y = u.formatMessage(qi.refreshForLatest)), (t[17] = u), (t[18] = y));
  let b = v.isPending,
    x;
  t[19] !== n || t[20] !== i || t[21] !== v || t[22] !== c || t[23] !== s
    ? ((x = () => {
        (Dt(c, {
          artifactTabId: s,
          artifactType: n,
          ...
          s != null && Ve({ artifactType: n, importKind: i, requestKey: s }),
          v.mutate());
      }),
      (t[19] = n),
      (t[20] = i),
      ...
      (t[24] = x))
    : (x = t[24]);
  let S = v.isPending ? `animate-spin` : null,
    w;
  t[25] === S
    ? (w = t[26])
    : ((w = we(`size-3.5`, S)), (t[25] = S), (t[26] = w));
  let T;
  t[27] === w
    ? (T = t[28])
    : ((T = (0, $.jsx)(C, { className: w })), (t[27] = w), (t[28] = T));
  let E;
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, $.jsx)(`span`, {
        children: (0, $.jsx)(R, { ...qi.refreshForLatest }),
      })),
      (t[29] = E))
    : (E = t[29]);
  let D;
  t[30] !== v.isPending || t[31] !== T || t[32] !== y || t[33] !== x
    ? ((D = (0, $.jsxs)(`button`, {
        type: `button`,
        "aria-label": y,
  ...
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, $.jsx)(`div`, { className: `h-full w-px bg-white/20` })),
      (t[35] = ee))
    : (ee = t[35]);
  let O;
  t[36] === u
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, $.jsx)(fe, { className: `size-3.5` })), (t[42] = A))
    : (A = t[42]);
  let j;
  t[43] !== v.isPending || t[44] !== O || t[45] !== k
    ? ((j = (0, $.jsx)(`button`, {
        type: `button`,
        "aria-label": O,
...
function ji(e) {
  ...
  t[0] === S.value
    ? (C = t[1])
    : ((C = Be(S.value)), (t[0] = S.value), (t[1] = C));
  let w = C,
    T;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(Z, { isError: !1, isLoading: !0 })), (t[2] = T))
    : (T = t[2]);
  let E = T,
    D;
  t[3] === s
  ...
  let A;
  t[12] !== a || t[13] !== k
    ? ((A = (0, $.jsxs)($.Fragment, { children: [k, a] })),
      (t[12] = a),
      (t[13] = k),
      (t[14] = A))
    : (A = t[14]);
  ...
  let re;
  t[22] !== a || t[23] !== M
    ? ((re = (0, $.jsxs)($.Fragment, { children: [M, a] })),
      (t[22] = a),
      (t[23] = M),
      (t[24] = re))
    : (re = t[24]);
  ...
  t[25] === w
    ? (P = t[26])
    : ((P = w ?? ie({ entrypoint: `home` })), (t[25] = w), (t[26] = P));
  let F = P,
    le = te(tt, F),
    ue;
  t[27] !== F || t[28] !== S
  ...
  let I = _e(ue),
    ...
    pe;
  t[30] !== le || t[31] !== f
    ? ((pe = Pt(le, f)), (t[30] = le), (t[31] = f), (t[32] = pe))
    : (pe = t[32]);
  let me = pe,
    R;
  t[33] === p ? (R = t[34]) : ((R = Ni(p)), (t[33] = p), (t[34] = R));
  let z = R,
    he;
  t[35] !== z || t[36] !== l || t[37] !== h || t[38] !== g
    ? ((he = { artifactTabId: h, artifactType: z, importKind: l, threadId: g }),
      (t[35] = z),
      (t[36] = l),
      (t[37] = h),
      (t[38] = g),
  ...
  let ge = he,
    ve;
  t[40] === me ? (ve = t[41]) : ((ve = It(me)), (t[40] = me), (t[41] = ve));
  let ye = ve,
    be,
    xe;
  (t[42] !== le || t[43] !== f
    ? ((be = () => {
        let e = L.current;
        if (((L.current = le), e != null))
          for (let t of Nt({
            previousComments: e,
            currentComments: le,
            path: f,
          }))
            fe.current?.dismissAnnotation(t);
      }),
      (xe = [le, f]),
      (t[42] = le),
      (t[43] = f),
  ...
  t[50] !== ge || t[51] !== S
    ? ((Te = (e, t) => {
        ...
        At(S, ge, { annotationModeEnabled: n, startSource: e });
      }),
      (Ee = () => {
        kt(S, ge);
      }),
      ...
      (t[53] = Ee),
      (t[54] = De))
    : ((Te = t[52]), (Ee = t[53]), (De = t[54]));
  let Oe;
  t[55] !== ye || t[56] !== f || t[57] !== I || t[58] !== _
    ? ((Oe = (e) => {
        let t = Lt({ line: ye, path: f, payload: e, title: _ });
        t != null && (I((e) => [...e, t]), _t());
      }),
      (t[55] = ye),
      (t[56] = f),
  ...
  t[60] !== F || t[61] !== ye || t[62] !== f || t[63] !== _
    ...
    : (ke = t[64]);
  let Ae;
  t[65] !== f || t[66] !== I || t[67] !== _
    ? ((Ae = (e) => {
        I((t) => {
          let n = !1,
            r = t.map((t) => {
              if (
                t.localArtifactAnnotationContext?.path !== f ||
  ...
  bb0: switch (p.kind) {
    case `document`: {
      let e = u?.target.artifactKind === `document` ? u.target : null,
        n = e == null ? void 0 : u?.requestId,
      ...
      t[87] !== i
        ? ((a = (0, $.jsx)(Q.Suspense, {
            ...
            children: (0, $.jsx)(
              Yi,
              {
                bottomScrollReservePx: ce,
                className: `h-full min-h-0`,
                enablePageNavigation: !1,
                headerRightContent: j,
                headerTitleContent: o,
                initialDocumentProto: p.proto,
                initialPageIndex: r,
    ...
    case `presentation`: {
      let e =
          u?.target.artifactKind === `presentation` &&
          u.target.slideNumber != null
            ? u.target.slideNumber - 1
            : void 0,
        n = e == null ? void 0 : u?.requestId,
        ...
        ? ((d = (0, $.jsx)(Q.Suspense, {
            ...
            children: (0, $.jsx)(
              Xi,
              {
                ...
                headerTitleContent: o,
                hideSpeakerNotes: se,
                initialPresentationProto: p.proto,
    ...
    case `spreadsheet`: {
      let e =
          u?.target.artifactKind === `workbook` && `range` in u.target
            ? u.target
            : null,
        n = e == null ? void 0 : u?.requestId,
        r;
  ...
  let Fe = p.kind === `spreadsheet` ? `top-[88px]` : `top-12`,
    Ie;
  return (
    t[118] !== Pe || t[119] !== m || t[120] !== Fe
      ? ((Ie = (0, $.jsx)(Mi, {
          refreshButton: m,
          topClassName: Fe,
          children: Pe,
...
function Fi(e) {
  ...
  t[2] !== n || t[3] !== r || t[4] !== o || t[5] !== i || t[6] !== a
    ? ((f = function (e) {
        (e.preventDefault(), M(o, r, { hostId: n, tabId: i, title: a }), l(!1));
      }),
      (t[2] = n),
      (t[3] = r),
      (t[4] = o),
  ...
  let p = f,
    m;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(S, { className: `icon-xs` })), (t[8] = m))
    : (m = t[8]);
  let h;
  t[9] === d
    ? (h = t[10])
  ...
  t[12] === p
    ? (v = t[13])
    : ((v = (0, $.jsx)(he.Item, { onSelect: p, LeftIcon: xt, children: g })),
      (t[12] = p),
      (t[13] = v));
  let y;
  return (
...
function Ii(e) {
  ...
  t[2] !== n || t[3] !== r || t[4] !== i || t[5] !== a
    ? ((c =
        n === "default" &&
        (0, $.jsx)(ae, { hostId: r, path: i, sizeBytes: a })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = a),
...
e(() => {
  ((Ui = j()),
    ...
    (Ji = new Map()),
    (Yi = (0, Q.lazy)(async () => {
      let { PopcornElectronDocumentPanel: e } = await a(
        async () => {
    ...
    (Xi = (0, Q.lazy)(async () => {
      let { PopcornElectronPresentationPanel: e } = await a(
        async () => {
    ...
    (Zi = (0, Q.lazy)(async () => {
      let { PopcornElectronWorkbookPanel: e } = await a(
        async () => {
    ...
    (Qi = (0, Q.lazy)(async () => {
      let { DocxPreviewPanel: e } = await a(
        async () => {
    ...
    ($i = (0, Q.lazy)(async () => {
      let { NotebookPreviewPanel: e } = await a(
        async () => {
...
//# sourceMappingURL=artifact-tab-content.electron-_vNcbcn-.js.map
