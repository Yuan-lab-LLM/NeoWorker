...
import { n as Ne, t as Pe } from "./codex-avatar-rFd6-NsG.js";
import {
  n as Fe,
  r as Ie,
  t as Le,
} from "./recommended-skill-statsig-overrides-Dg4KJvN0.js";
import { a as Re } from "./avatar-overlay-mascot-size-CydkQqgJ.js";
import { i as ze, r as Be, t as Ve } from "./custom-avatars-query-mkYIdPJ1.js";
import { n as He, t as Ue } from "./settings-loading-row-BdxyJgCw.js";
function We(e) {
  let t = (0, Ge.c)(12),
...
function Je(e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Y.jsx)(F, {
      ...
      (d = (0, Y.jsx)(Se, { className: `icon-2xs` })),
      (t[10] = u),
      (t[11] = d))
    : ((u = t[10]), (d = t[11]));
  let f;
  ...
  return (
    t[14] !== c || t[15] !== f
      ? ((p = (0, Y.jsx)(H, { label: s, description: c, control: f })),
        (t[14] = c),
        (t[15] = f),
        (t[16] = p))
      : (p = t[16]),
...
function Qe(e) {
  let t = (0, X.c)(89),
    {
      ...
      onRefreshCustomAvatars: d,
      onUpgradeCustomAvatar: f,
    } = e,
    h = I(),
    g = k(R),
    _ = n(`188145323`),
    ...
    S = x(de),
    C = w(Te.petSize),
    { selectedAvatar: T, setSelectedAvatarId: E } = r(a),
    D = ((C - 80) / 144) * 100,
    O,
    A,
    j,
  ...
  if (
      ...
      : ((y = (e, t) => {
          b.logProductEvent(
            ...
            ee({
              action: e,
              selectedAvatar: t,
              source: ge.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS,
            }),
          );
        }),
        (t[24] = b),
    ...
    t[26] !== E || t[27] !== x
      ? ((S = (e) => {
          (E(e.id), x(q.CODEX_AVATAR_OVERLAY_ACTION_PET_SELECTED, e));
        }),
        (t[26] = E),
        (t[27] = x),
        (t[28] = S))
    ...
    t[29] !== d || t[30] !== v
      ...
      : (w = t[31]);
    let D;
    t[32] !== i || t[33] !== o || t[34] !== u || t[35] !== T || t[36] !== x
      ? ((D = u
          ? (0, Z.jsx)(K, {
              "aria-label": i,
              color: `secondary`,
              loading: o,
              onClick: () => {
                (x(q.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED, T),
                  u());
              },
              size: `toolbar`,
              children: (0, Z.jsx)(F, {
      ...
      : (D = t[37]);
    let k;
    t[38] !== g || t[39] !== T || t[40] !== x
      ? ((k = () => {
          (x(
            g
              ? q.CODEX_AVATAR_OVERLAY_ACTION_CLOSE_REQUESTED
              : q.CODEX_AVATAR_OVERLAY_ACTION_OPEN_REQUESTED,
            T,
          ),
            oe.dispatchMessage(`avatar-overlay-open`, {}));
        }),
        (t[38] = g),
        (t[39] = T),
        (t[40] = x),
    ...
    t[44] !== k || t[45] !== I
      ...
      : (R = t[46]);
    let z;
    t[47] !== D || t[48] !== R || t[49] !== w
      ? ((z = (0, Z.jsxs)(Z.Fragment, { children: [w, D, R] })),
        (t[47] = D),
        (t[48] = R),
        (t[49] = w),
        (t[50] = z))
    ...
    (t[51] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      t[53] === z
        ? (L = t[54])
        : ((L = (0, Z.jsx)(J.Header, { actions: z, title: B, subtitle: V })),
          (t[53] = z),
          (t[54] = L)),
      (A = J.Content),
      (O = ne),
    ...
    (t[63] !== C || t[64] !== T
      ? ((W = (e) =>
          (0, Z.jsx)(
            tt,
            { avatar: e, isSelected: e.id === T.id, onSelectAvatar: C },
            e.id,
          )),
        (t[63] = C),
        (t[64] = T),
  ...
  t[66] === i
    ? (z = t[67])
    : ((z = i == null ? null : (0, Z.jsx)(Je, { avatarDirectory: i })),
      (t[66] = i),
      (t[67] = z));
  let B;
  t[68] !== O || t[69] !== M || t[70] !== N || t[71] !== P || t[72] !== z
    ? ((B = (0, Z.jsxs)(O, { children: [M, N, P, z] })),
      (t[68] = O),
      (t[69] = M),
      (t[70] = N),
      (t[71] = P),
  ...
  let V;
  t[74] !== A || t[75] !== B
    ? ((V = (0, Z.jsx)(A, { children: B })),
      (t[74] = A),
      (t[75] = B),
      (t[76] = V))
    : (V = t[76]);
  let U;
  t[77] !== j || t[78] !== L || t[79] !== V
    ? ((U = (0, Z.jsxs)(j, { children: [L, V] })),
      (t[77] = j),
      (t[78] = L),
      (t[79] = V),
      (t[80] = U))
                ...
                children: (0, Z.jsx)(ne, {
                  children: (0, Z.jsx)(H, {
                    ...
                    control: (0, Z.jsx)(`input`, {
                      ...
                      min: 80,
                      onInput: (e) => {
                        y(S, Te.petSize, Number(e.currentTarget.value));
                      },
                      style: {
                        background: `linear-gradient(to right, var(--color-token-primary) ${D}%, var(--color-token-border-light) ${D}%)`,
                      },
                      type: `range`,
                      value: C,
                    }),
...
function tt(e) {
  ...
  t[3] === n
    ? (u = t[4])
    : ((u = (0, Z.jsx)(We, { avatar: n })), (t[3] = n), (t[4] = u));
  let d;
  ...
  let m;
  t[14] !== d || t[15] !== f
    ? ((m = (0, Z.jsxs)(Z.Fragment, { children: [d, f] })),
      (t[14] = d),
      (t[15] = f),
      (t[16] = m))
    : (m = t[16]);
...
async function rt(e) {
  return `${await at(e)} create a pet based on what you know about me`;
}
async function it({
  forceReloadSkills: e,
  petDirectoryPath: t,
  ...
  return `${await at({ forceReloadSkills: e, skillStatsigOverride: r })} upgrade the existing pet at ${je(n.replaceAll(/[\r\n]+/g, ` `), t)} to the latest pet version with looking directions`;
}
async function at({ forceReloadSkills: e, skillStatsigOverride: t }) {
  let n = await ye(`install-recommended-skill`, {
    params: {
      forceReinstall: !0,
      hostId: Oe,
      installRoot: null,
  ...
  return (await e(), a({ name: ot, path: me(n.destination, `SKILL.md`) }));
}
var ot,
  st,
  ct = e(() => {
    (Ee(),
      ...
      V(),
      (ot = `hatch-pet`),
      (st = `skills/.curated/hatch-pet`));
  });
function lt() {
  let e = (0, ut.c)(8),
    { data: t, isError: n, isFetching: r, isLoading: i } = k(Be),
    a = t?.avatarDirectory ?? null,
    o = t?.avatars,
    s;
  e[0] === o ? (s = e[1]) : ((s = v(o)), (e[0] = o), (e[1] = s));
  let c;
  return (
...
function ft() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(P, { electron: !0, children: (0, Q.jsx)(pt, {}) })),
        (e[0] = t))
      : (t = e[0]),
    t
  );
...
function pt() {
  let e = x(de),
    [t, n] = (0, ht.useState)(!1),
    { avatarDirectory: r, avatarOptions: i, isError: a, isLoading: o } = lt(),
    s = U(),
    c = ie(),
    { forceReload: l } = N(void 0, Oe),
    u = Le(Ie(), `hatch-pet`),
    d = async () => {
      await l();
    },
    f = async () => {
      n(!0);
      try {
        let t = await rt({ forceReloadSkills: d, skillStatsigOverride: u });
        (await h(e, E),
          c({
            activeProject: null,
    ...
    p = async (t, n) => {
      try {
        c({
          prefillPrompt: await it({
            forceReloadSkills: d,
            petDirectoryPath: n,
            petName: t,
            skillStatsigOverride: u,
          }),
        });
      } catch {
        e.get(S).danger(
...
export { _t as PetsSettings };
//# sourceMappingURL=pets-settings-BTsRzspN.js.map
