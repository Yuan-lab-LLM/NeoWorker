...
import { o as ee, s as te } from "./workbook-Bcziiv_P.js";
import {
  $ as ne,
  A as h,
  C as re,
...
import { n as he, t as ge } from "./PopcornPageNumberNavigation-ub7O3ho1.js";
import { n as _e, t as P } from "./modifiers.esm--SGMoLew.js";
import {
  $ as ve,
  A as F,
  B as ye,
  ...
  y as pt,
  yt as mt,
} from "./popcorn-electron-surface-style-CfRbpzvu.js";
function ht() {
  return (
    (gt ??= Promise.all([
      j(),
...
function Lt() {
  return new Worker(
    new URL(
      `` + new URL(`runtime.worker-_LqsnMiG.js`, import.meta.url).href,
      `` + import.meta.url,
    ),
...
var qt,
  ...
  Yt = e(() => {
    (y(),
      ...
      (Jt = class {
        id = qt++;
        #e = le(`presentation-main-controller`);
        #t = Vt();
        #n = new Set();
        #r = new Set();
        #i = [];
        ...
        constructor(e = {}) {
          let t =
              e.presentationProto ??
              e.presentation?.toProto() ??
              Mt().toProto(),
            n = (e.workerFactory ?? Lt)();
          ((this.#a = new fe(
            n,
            (e) => this.#C(e),
            (e) => {
        ...
        #C(e) {
          switch (e.kind) {
            ...
            case `inspector`:
              ...
              return;
            case `debug-log`:
              le(e.namespace).debug(e.message, e.details);
              return;
            default:
              return e;
          }
...
function fn(e) {
  let t = on({
    ...
    n = I(e.camera, e.viewportX, e.viewportY);
...
var pn,
  ...
  hn,
  gn = e(() => {
    (xe(), (pn = 48), (mn = 0.1), (hn = 0.05));
  }),
  _n,
  vn,
  yn = e(() => {
    ((_n = t(i())), (vn = (0, _n.createContext)(null)));
  });
...
function Gn({
  ...
  let [d, f] = (0, Kn.useState)(null);
  return (
    (0, Kn.useEffect)(() => {
      d && (e.some((e) => e.threadId === d) || f(null));
    }, [d, e]),
        ...
        return (0, qn.jsx)(
          Re,
          {
            ...
            trigger: (0, qn.jsx)(`button`, {
              ...
              style: { left: t, top: p, transform: `translate(-50%, -50%)` },
              onMouseDown: (e) => {
                e.stopPropagation();
              },
              onClick: (e) => {
              ...
              children: (0, qn.jsx)(N, { className: `size-4` }),
            }),
            content: (0, qn.jsx)(pt, {
...
function yr({
  ...
  let ie = jn(e),
    ...
    E = (0, X.useRef)(null),
    se = (0, X.useRef)(null),
    [ce, le] = (0, X.useState)(0),
    [ue, D] = (0, X.useState)(!1),
    O = te && m?.annotation != null && m.annotation.enabled !== !1,
    k = ne && m?.drawing != null && m.drawing.enabled !== !1,
    [A, j] = (0, X.useState)(null),
    [fe, M] = (0, X.useState)(null),
    pe = (0, X.useRef)(A);
  pe.current = A;
  let me = (0, X.useRef)(null),
    ...
    _e = (0, X.useRef)(null),
    [P, F] = (0, X.useState)(null),
    [be, I] = (0, X.useState)(null),
    xe = (0, X.useRef)(null);
  xe.current = be;
  let [L, Ce] = (0, X.useState)([]),
    we = (0, X.useRef)([]);
  we.current = L;
  let Te = (0, X.useRef)(null),
    De = (0, X.useRef)(null),
    Oe = (0, X.useRef)(p),
    Ae = (0, X.useCallback)((e) => {
      (M((t) => (t === e ? null : t)),
    ...
    Le = (0, X.useCallback)(
      (e) => {
        (Ae(e), m?.annotation?.onDismiss?.(e));
      },
      [Ae, m?.annotation],
    ),
    Re = (0, X.useCallback)((e) => {
      I((t) => {
        let n = typeof e == `function` ? e(t) : e;
        return ((xe.current = n), n);
      });
    }, []),
    ...
    Be = (0, X.useSyncExternalStore)(
      (e) => t.subscribeToLayoutChanges(e),
      () => t.getLayoutSnapshot(),
      () => t.getLayoutSnapshot(),
    ),
    He = Be.viewportInsets,
    We = Tr(Be.width, Be.height, R, g.selectedSlideFrame, He) ?? g.slideRect,
    z = We === g.slideRect ? g : { ...g, slideRect: We },
    B = g.slideIds[g.selectedSlideIdx] ?? `slide-${g.selectedSlideIdx}`,
    Ke = g.slideLabels[g.selectedSlideIdx] ?? `Slide ${g.selectedSlideIdx + 1}`,
    qe = (0, X.useMemo)(() => Er(z), [z]),
    Ye = (0, X.useMemo)(() => $n({ snapshot: g }), [g]),
    Xe = (0, X.useMemo)(() => {
      let e = z.slideRect;
      return e
    ...
    Qe = (0, X.useMemo)(
      () => (A?.target ? ir(A.target, z.slideRect) : null),
      [A?.target, z.slideRect],
    ),
    et = (0, X.useMemo)(
      () => (A?.target ? ar(A.target, z.slideRect) : null),
      [A?.target, z.slideRect],
    ),
    tt = Qe ?? et,
    nt = (0, X.useMemo)(
      () => (!O || !P ? null : ur(P.start, P.current)),
      [O, P],
    ),
    V = (0, X.useMemo)(() => {
      if (!nt || !P) return null;
      let e = er({ snapshot: g, frame: nt, anchorPoint: P.current });
    ...
    lt = (0, X.useMemo)(
      () =>
        he && g.hoveredElementId
          ? (g.selectedSlideElementTargets.find(
              (e) => e.id === g.hoveredElementId,
            ) ?? null)
          : null,
      [he, g.hoveredElementId, g.selectedSlideElementTargets],
    ),
    ut = (0, X.useMemo)(
      () =>
        V ||
            ...
            ? ir(
                {
                  ...
                  slideLabel: Ke,
                  elementIds: [lt.id],
                  primaryElementId: lt.id,
                  frame: lt.frame,
                },
                z.slideRect,
              )
            : null),
      [Qe, O, lt, l, V, B, Ke, g.selectedSlideIdx, z.slideRect],
    ),
    {
      annotations: dt,
    ...
    } = ye(m?.annotation?.handleRef, {
      onDismissAnnotation: Le,
      onDismissAllAnnotations: je,
    }),
    gt = (0, X.useMemo)(
      () => dt.filter((e) => e.target.slideId === B),
      [B, dt],
    ),
    _t = (0, X.useMemo)(
      () =>
        gt.map((e) => ({ annotation: e, bounds: ir(e.target, z.slideRect) })),
      [gt, z.slideRect],
    ),
    vt = (0, X.useMemo)(
      () =>
        fe == null || A?.mode === `edit`
          ? null
          : (_t.find(({ annotation: e }) => e.annotationId === fe) ?? null),
      [A?.mode, fe, _t],
    ),
    yt = (0, X.useMemo)(() => (V ? at : ct), [ct, at, V]),
    { drawings: bt, addPendingDrawing: H } = ke(m?.drawing?.handleRef),
    xt = (0, X.useMemo)(
      () => bt.filter((e) => e.target.slideId === B),
      [B, bt],
    ),
    U = (0, X.useMemo)(
      () =>
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      g.selectedSlideFrame &&
        ...
        e.setViewportCamera(R);
    }, [R, e, t, g.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = v.current;
      !g.selectedSlideFrame ||
        !e ||
    ...
    }, [a, R, g.selectedSlideFrame, g.textEditState, g.textLayoutBlocks, U]),
    (0, X.useEffect)(() => {
  ...
  let W = (0, X.useCallback)(() => {
    ...
    G = (0, X.useCallback)(() => {
      (De.current?.(), (De.current = null), Re(null));
    }, [Re]),
    K = (0, X.useCallback)(() => {
      ((Te.current = null), (we.current = []), Ce([]));
    }, []),
    q = (0, X.useCallback)(() => {
      ((N.current = !1), j(null), F(null), W());
    }, [W]),
    St = (0, X.useCallback)(() => {
      let e = pe.current;
    ...
    Ct = (0, X.useCallback)(
      (e) => {
        e == null ||
          ...
          !k ||
          !d ||
          ((Te.current = B), (we.current = [...we.current, e]), Ce(we.current));
      },
      [B, k, d],
    ),
    wt = (0, X.useCallback)(
      (e) => {
        ...
        let t = rt(e),
          n = rt(e.map((e) => ({ ...e, points: e.points.map(J) }))),
          r = v.current,
          i = y.current;
        ...
        let a = { width: r.clientWidth, height: r.clientHeight },
          ...
          l = dr(g.selectedSlideElementTargets, c).flatMap((e) => {
            let t = g.selectedSlideElementTargets.find((t) => t.id === e);
            return t
              ? [
                  {
        ...
        Ve({
          ...
          viewportSize: a,
          baseCanvas: i,
          overlayCanvases: [ae.current, oe.current],
          strokes: e,
          projectPoint: J,
        })
          .then((t) => {
            let n = { ...t, commentId: d },
              r = {
                ...
                strokes: e,
                screenshot: n,
                browserCompatible: Ze({
                  drawingId: d,
                  screenshot: n,
                  markerViewportPoint: p,
                  viewportSize: a,
                }),
              };
    ...
    Et = (e = `saved`, t = `button`) => {
      ...
      (ft(r),
        ...
        m?.annotation?.onSubmitted?.(r, e, t, { annotationMode: l }),
        q());
    },
    Dt = () => {
      A?.mode === `edit` &&
        (ht(A.annotationId), M((e) => (e === A.annotationId ? null : e)), q());
    };
  ((0, X.useEffect)(() => {
    (O || (A?.mode !== `edit` && j(null)),
      (!O || !l) && (F(null), (_e.current = null)));
  }, [O, A?.mode, l]),
    (0, X.useEffect)(() => {
      if (k && d) {
        (j(null),
    ...
    (0, X.useEffect)(() => {
      if (!O || !l) {
        (ge(!1), e.setHoveredElementId(null));
        return;
      }
      (ge(!1), e.setHoveredElementId(null));
    }, [O, l, e]),
    (0, X.useEffect)(() => {
      A &&
        A.target.slideId !== B &&
        (M(null), F(null), (_e.current = null), j(null));
    }, [A, B]),
    (0, X.useEffect)(
      () => () => {
        G();
    ...
    (0, X.useEffect)(() => {
      Te.current == null || Te.current === B || K();
    }, [K, B]),
    (0, X.useEffect)(() => {
      let e = v.current,
        t = oe.current,
        n = k && d ? `crosshair` : O && l && !A ? $e : ``;
      return (
        e && (e.style.cursor = n),
        t && (t.style.cursor = n),
        () => {
  ...
  let Ot = (t) => {
      ((se.current = t ? { x: Math.round(t.x), y: Math.round(t.y) } : null),
    ...
    kt = (t) => {
      ...
      if ((Ot(n), k && d)) {
        ...
        (Dr(t, b),
          ...
          Re({ color: ve, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      if (O && !l && pe.current && !St()) {
      ...
      if (O && l) {
        ...
        if ((r != null && i === `replace` && j(null), !n)) {
          (r != null && i !== `replace` && St(), (_e.current = null), F(null));
          return;
        }
        let a = sr(g.selectedSlideElementTargets, n, R.k);
      ...
      if (!n) {
        if (U?.isActive()) {
          (U.clear(), (S.current = null));
          return;
        }
        (e.clearElementSelection(), (S.current = null));
        return;
      }
      if (!a) {
        ...
        let i = sr(g.selectedSlideElementTargets, n, R.k);
      ...
      let r = U.isActive(),
        i =
          ...
          g.selectedElementIds.length === 1 &&
          g.primarySelectedElementId &&
          S.current === g.primarySelectedElementId
            ? g.primarySelectedElementId
            : void 0;
      if (
        (r || i) &&
      ...
      let o = g.primarySelectedElementId
        ...
        c = g.selectedElementIds.length === 1 && o ? lr([o], n, R.k) : null,
        u = c ? null : fr(s, n, R.k),
        f = !c && !u && !!o?.canRotate && pr(s, n, R.k),
        p = c
          ? c.endpoint === `from`
            ? `connector-from`
            : `connector-to`
        ...
        m =
          c?.elementId ??
          (p === `move`
            ? sr(g.selectedSlideElementTargets, n, R.k)
            : g.primarySelectedElementId);
      if (!m) {
        if (((C.current = null), (w.current = null), (T.current = !1), r))
          return;
        (Dr(t, b),
          (x.current = `marquee`),
          (S.current = null),
      ...
      (e.beginElementInteraction({
        ...
        (w.current = n),
        (T.current = !1),
        S.current && S.current !== m && (S.current = null));
    },
    At = (t) => {
      let n = Cr(t, v.current, R, g, He);
      if ((Ot(n), k && d)) {
        if (b.current != null && b.current !== t.pointerId) return;
        (n &&
          xe.current &&
          Re((e) => {
            if (!e) return e;
      ...
      if (O && l) {
        let r = _e.current;
        if (r != null && b.current != null && b.current !== t.pointerId) return;
        if (r != null && n) {
          ge(!0);
          let e = Math.hypot(n.x - r.start.x, n.y - r.start.y) >= Mr;
          (e && pe.current && ((N.current = !1), j(null)),
        ...
        (e.setHoveredElementId(i),
          (t.currentTarget.style.cursor = pe.current ? `` : $e));
        return;
      }
      if (x.current === `text`) {
        n && U.pointerMove(n);
      ...
      if (x.current === `marquee`) {
        n && e.updateSelectionMarquee({ nextPoint: n });
        return;
      }
      if (x.current === `element` && n) {
        (w.current &&
          Math.hypot(n.x - w.current.x, n.y - w.current.y) > jr &&
          (T.current = !0),
      ...
      if (!a) {
        ...
        let r = n ? sr(g.selectedSlideElementTargets, n, R.k) : null;
      ...
      let r = g.primarySelectedElementId
        ...
        o = g.selectedElementIds.length === 1 && r ? lr([r], n, R.k) : null;
      if (o) {
      ...
      if (s) {
        (e.setHoveredElementId(g.primarySelectedElementId),
          (t.currentTarget.style.cursor = Ue(s) ?? ``));
        return;
      }
      if (i && r?.canRotate && pr(i, n, R.k)) {
        (e.setHoveredElementId(g.primarySelectedElementId),
          (t.currentTarget.style.cursor = Ie()));
        return;
      }
      ...
      let c = sr(g.selectedSlideElementTargets, n, R.k);
    ...
    jt = (t, n) => {
      if (k && d) {
        if (b.current != null && b.current !== t.pointerId) return;
        Ot(Cr(t, v.current, R, g, He));
        let e = xe.current;
        (Or(t, b), (De.current = null), Re(null), n && Ct(e));
        return;
      }
      if (O && l) {
        if (b.current != null && b.current !== t.pointerId) return;
        (Ot(Cr(t, v.current, R, g, He)), Or(t, b));
        let r = _e.current;
        if (((_e.current = null), F(null), !n || !r)) return;
        let i = Cr(t, v.current, R, g, He);
        if (!i) return;
        let a = ur(r.start, i),
        ...
        (m?.annotation?.onStart?.(`annotation_mode_pointer`, {
          ...
          (N.current = !1),
          j({ mode: `create`, target: s, body: `` }));
        return;
      }
      if (b.current != null && b.current !== t.pointerId) return;
      let r = x.current;
      if (!r) return;
      if ((Ot(Cr(t, v.current, R, g, He)), Or(t, b), r === `text`)) {
        ((x.current = null), U.pointerUp());
        return;
      }
      if (r === `marquee`) {
        ((x.current = null),
    ...
    Mt = (t) => {
      ...
      if (!a) return;
      let n = wr(t.clientX, t.clientY, v.current, R, g, He);
      n &&
    ...
    Pt = (t) => {
      if (!(
        ...
        if (
          ...
          U.activateBlockEnd(g.primarySelectedElementId) && t.preventDefault();
          return;
        }
    ...
    children: (0, Z.jsxs)(`div`, {
      ...
      children: [
        (0, Z.jsx)(`canvas`, {
          ...
          className: o(`absolute inset-0 h-full w-full select-none`),
        }),
        (0, Z.jsx)(`canvas`, {
          ref: ae,
        ...
        vt
          ? (0, Z.jsx)(Ne, {
              ...
              markerPosition: st(vt.bounds),
              containerElement: v.current,
        ...
        Y && qe && Ye
          ? (0, Z.jsx)(it, {
              bounds: qe,
              shortcutScopeElement: v.current,
              testId: `popcorn-presentation-ask-for-edit-button`,
              onClick: (e) => {
                (m?.annotation?.onStart?.(e, { annotationMode: l }),
                  (N.current = !1),
                  j({ mode: `create`, target: Ye, body: `` }));
              },
            })
          : null,
        et
...
function Kr({
  ...
  theme: g = `web`,
  isEditing: _ = !0,
  hideSpeakerNotes: v = !1,
  reviewTools: y,
  onHyperlinkClick: b,
  annotationsEnabled: x = !0,
  drawingAnnotationsEnabled: S = !0,
  commentThreadsEnabled: C = !0,
}) {
  let w = M(
    e,
    (0, Q.useCallback)(() => Kt(), []),
  ...
  if (!w) return null;
  let T = An(w),
    { panels: E, stageOverlays: se } = (0, Q.useMemo)(() => Zt(t), [t]),
    le = x && y?.annotation?.enabled !== !1,
    [ue, D] = (0, Q.useState)(!1),
    O = S && y?.drawing?.enabled !== !1,
    [k, A] = (0, Q.useState)(!1),
    [de, j] = (0, Q.useState)(0),
    fe = (0, Q.useMemo)(() => new Ir(), []);
  ((0, Q.useEffect)(() => {
    le || D(!1);
  }, [le]),
    (0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      !ue || !le || (w.clearElementSelection(), w.setHoveredElementId(null));
    }, [le, ue, w]),
    (0, Q.useEffect)(() => {
      !k || !O || (w.clearElementSelection(), w.setHoveredElementId(null));
    }, [w, O, k]),
    (0, Q.useEffect)(() => {
      if (!ue) return;
      let e = (e) => {
  ...
  let [pe, me] = (0, Q.useState)(() =>
      Object.fromEntries(E.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [N, he] = (0, Q.useState)(Zr),
    [P, ve] = (0, Q.useState)(() =>
      Object.fromEntries(T.slideIds.map((e) => [e, null])),
    ),
    [ye, be] = (0, Q.useState)(() =>
      Object.fromEntries(T.slideIds.map((e) => [e, null])),
    ),
    [I, xe] = (0, Q.useState)(() => T.slideIds),
    [L, Se] = (0, Q.useState)(null),
    [Ce, Te] = (0, Q.useState)(!1),
    [De, Oe] = (0, Q.useState)(!1),
    [ke, Ae] = (0, Q.useState)(!1),
    ...
    Re = (0, Q.useRef)([]),
    R = (0, Q.useRef)(null),
    ze = (0, Q.useRef)(new Set()),
    Be = (0, Q.useRef)(P),
    Ve = (0, Q.useRef)(ye),
    He = (0, Q.useRef)(I),
    Ue = m(s(d, { activationConstraint: { distance: 4 } })),
    We = (0, Q.useMemo)(() => [_e], []),
    z = n === `left`,
    Ge = n === `bottom`,
    B = g === `codex`,
    ...
    Je = re ?? B,
    Ye = De && (z || Ke || qe),
    Xe = !v && (_ || T.notesText.trim().length > 0),
    Ze = Xe && Ne && N > 0,
    Qe = (0, Q.useMemo)(
      () => ({
        left: Ye ? Qr : 0,
  ...
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      (xe(T.slideIds),
        ve((e) => {
          let t = {};
          for (let n of T.slideIds) t[n] = e[n] ?? null;
          return t;
        }),
        be((e) => {
          let t = {};
  ...
  let et = (0, Q.useMemo)(
      () =>
        Object.fromEntries(
          T.slideIds.map((e, t) => [e, T.slideLabels[t] ?? `Slide ${t + 1}`]),
        ),
      [T.slideIds, T.slideLabels],
    ),
    nt = (0, Q.useMemo)(
      () => Object.fromEntries(T.slideIds.map((e, t) => [e, t])),
      [T.slideIds],
    ),
    rt = T.slideIds[T.selectedSlideIdx] ?? null,
    V =
      T.fitScale ??
      (T.slideRect && T.zoom > 0 ? T.slideRect.scale / T.zoom : null),
    it = V ? rn(V) : null,
    at = T.slideRect?.scale ?? rn(V ? V * T.zoom : T.zoom),
    ot = it != null && Math.abs(T.zoom - 1) < ti,
    st = Ke && (!ke || je),
    ct = !st,
    lt = Je && !st,
    dt = (e) => {
    ...
    vt = (0, Q.useCallback)((e, t, n) => {
      ((Le.current[e] = t), t && R.current && n && R.current.observe(t));
    }, []),
    yt = (0, Q.useCallback)(() => {}, []),
    bt = (0, Q.useCallback)(() => {
      w.addSlide();
    ...
    H = (0, Q.useCallback)(
      async (e, t) => {
        if (e < 0 || e >= w.getSnapshot().slideCount) return;
        let n = w.getSnapshot().slideIds[e];
        if (!n) return;
        let r = t?.cacheKind === `stacked-page`,
          i = r ? Ve.current[n] : Be.current[n],
          a = `${r ? `stacked-page` : `rail`}:${n}`;
        if (!(
          (!t?.force && i != null) ||
          ze.current.has(a) ||
          e < 0 ||
          e >= w.getSnapshot().slideCount
        )) {
          ze.current.add(a);
          try {
            await ht();
            let t = await w.requestSlideThumbnail(
              e,
              r ? { cssMaxPx: ri } : void 0,
            );
            (r ? be : ve)((e) => (e[n] === t ? e : { ...e, [n]: t }));
          } finally {
            ze.current.delete(a);
          }
        }
  ...
  ((0, Q.useEffect)(() => {
    let e = T.slideIds[T.selectedSlideIdx];
    (e &&
      (ze.current.delete(`rail:${e}`), ze.current.delete(`stacked-page:${e}`)),
      H(T.selectedSlideIdx, { force: !0 }),
      e &&
        Ve.current[e] != null &&
        H(T.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [H, T.presentationVersion, T.selectedSlideIdx, T.slideIds]),
    (0, Q.useEffect)(() => {
            ...
            (e) => {
              for (let t of e) {
                ...
                (H(n, { cacheKind: r, force: i }),
                  ...
                  R.current?.unobserve(t.target));
              }
            },
            { root: Fe.current, rootMargin: `200px`, threshold: 0.05 },
          )));
        for (let e of [...Le.current, ...Re.current]) e && R.current.observe(e);
        return () => {
          R.current?.disconnect();
        };
      }
    }, [H, T.presentationVersion, T.slideCount]));
  let xt = (0, Q.useCallback)(
      (e) => {
        ...
        let n = T.selectedSlideIdx,
          r = T.slideIds.length - 1,
          i = t < 0 ? Math.max(0, n - 1) : Math.min(r, n + 1);
        if (i === n) return;
        w.setSelectedSlideIdx(i);
      ...
      [w, T.selectedSlideIdx, T.slideIds.length],
    ),
    U = (0, Q.useCallback)((e) => {
      Se(typeof e.active.id == `string` ? e.active.id : null);
    }, []),
    W = (0, Q.useCallback)(() => {
      (xe(T.slideIds), Se(null));
    }, [T.slideIds]),
    G = (0, Q.useCallback)(
      (e) => {
        Se(null);
        ...
        i < 0 ||
          a < 0 ||
          i === a ||
          (xe((e) => Gr(e, i, a)), w.moveSlide(i, a));
      },
      [w],
    ),
    K = (0, Q.useCallback)((e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.contains(t)) || Te(!1);
    }, []),
    q = (0, Q.useCallback)((e) => {
      let t = e.relatedTarget;
    ...
    St = (0, Q.useCallback)((e, t, n) => {
      ((Re.current[e] = n),
        n && R.current && Ve.current[t] == null && R.current.observe(n));
    }, []),
    J = (0, Q.useCallback)(
      (e, t = `default`, n) => {
        let r = Vr(e, t);
          ...
          ? (0, $.jsxs)(f, {
              ...
              children: [
                (0, $.jsx)(ft, {
                  ...
                  strategy: ut,
                  children: (0, $.jsxs)(`div`, {
                    className: o(`flex min-w-full justify-[safe_center]`, r),
                    children: [
                      I.map((r, i) => {
                        let a = P[r] ?? null,
                          o = nt[r] ?? -1;
      ...
      [L, bt, _t, I, We, W, G, U, yt, _, vt, ne, rt, gt, Ue, nt, et, P],
    );
  return (0, $.jsx)(`div`, {
    className: o(
    ...
    children: (0, $.jsxs)(bn, {
      ...
      children: [
        (0, $.jsx)(ie, {
          ...
          centeredContent: lt
            ? (0, $.jsx)(ge, {
                currentIndex: T.selectedSlideIdx,
                totalCount: T.slideCount,
                itemLabel: `slide`,
                onChangeIndex: (e) => w.setSelectedSlideIdx(e),
                testId: `popcorn-presentation-page-navigation`,
              })
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: o(`flex items-center`, B ? `gap-1` : `gap-2`),
            children: [
              y?.annotation && le
                ? (0, $.jsx)(we, {
                    active: ue,
                    onClick: () => {
                      let e = !ue;
                      (e && (y?.annotation?.onModeEnabled?.(), A(!1)), D(e));
                    },
          ...
          icon: (0, $.jsx)(ce, {
            kind: `presentation`,
            children: (0, $.jsx)(oe, { className: `size-4` }),
          }),
        }),
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            ...
            className: o(
              ...
              Ke && `popcorn-presentation-editor-shell--small-stacked`,
              Ge
                ? `flex-col`
                : z || qe
                  ? `flex-row`
              ...
              st
                ...
                : (0, $.jsxs)(`div`, {
                    className: o(
                      ...
                      qe && `popcorn-presentation-main-panel--codex-responsive`,
                    ),
                    children: [
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(yr, {
                          ...
                          viewportInsets: Qe,
                          annotationMode: ue,
                          onAnnotationModeChange: D,
                          drawingMode: k,
                          onDrawingModeChange: A,
                          drawingCommitToken: de,
                          reviewTools: y,
                          onHyperlinkClick: b,
                          annotationsEnabled: x,
                          drawingAnnotationsEnabled: S,
                          commentThreadsEnabled: C,
                          annotationPortalContainerElement: Fe.current,
                        }),
                      }),
                      Xe
                        ? (0, $.jsx)(Jr, {
    ...
    (l(),
      ...
      (pi = (0, Q.memo)(function ({
        ...
        let ee = zr(c, l),
          ...
          ne = Hr(l),
          h = Ur(l),
          re = l === `floating` ? ii : void 0,
          ie = { ...(l === `floating` ? ai : {}), ...(i ? { color: si } : {}) };
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              className: o(`text-token-text-primary`, h, te),
              style: ie,
              children: t + 1,
            }),
            (0, $.jsxs)(`div`, {
              ...
              children: [
                r
                  ? (0, $.jsx)(`img`, {
                      src: r,
                      alt: ``,
                      className: o(`block`, ne),
                      style: re,
                      draggable: !1,
                    })
                  : (0, $.jsx)(`div`, {
                      className: o(ne, `animate-pulse bg-gray-200`),
      ...
      (mi = (0, Q.memo)(function ({
        ...
        return (0, $.jsx)(B, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: h,
            style: {
              transform: a.Translate.toString(re),
      ...
      (hi = (0, Q.memo)(function ({
        ...
        let r = zr(t, n),
          ...
          a = Hr(n),
          s = Ur(n),
          c = n === `floating` ? ii : void 0,
          l = n === `floating` ? ai : void 0;
        return (0, $.jsxs)(`button`, {
          type: `button`,
          onClick: e,
          ...
          children: [
            (0, $.jsx)(`div`, {
              "aria-hidden": `true`,
              className: o(`text-token-text-primary invisible`, s, i),
              style: l,
              children: `00`,
            }),
            (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(`div`, {
                ...
                children: (0, $.jsx)(b, { className: `size-4` }),
              }),
            }),
          ],
        });
...
function _i({
  ...
  initialZoom: u,
  onCrdtUpdate: d,
  pendingImageGenerations: f = [],
  resolveImageHydrationAssets: p,
  ...
  enablePageNavigation: v,
  artifactSearchEnabled: y = !1,
  commentThreadsEnabled: ae = !1,
  workerFactory: oe,
}) {
  let b = Le({ initialCrdtState: s, externalCrdtUpdates: t }),
    x = (0, Si.useRef)(c),
    S = (0, Si.useRef)(null),
    C = M(
      void 0,
      () =>
        new Jt({
          initialCrdtState: b.initialCrdtState,
          initialSelectedSlideIdx: l,
          initialZoom: u,
    ...
    T = Qe({
      ...
      controller: C,
      externalCrdtUpdates: b.externalCrdtUpdates,
      onCrdtUpdate: d,
    }),
    E = (0, Si.useMemo)(() => bi(f), [f]),
    se = (0, Si.useMemo)(() => xi(E), [E]);
  return (
    (0, Si.useEffect)(() => {
      C &&
        x.current !== c &&
        ((x.current = c), C.replaceFromProto(c ?? vi().toProto()));
    }, [C, c]),
    (0, Si.useEffect)(() => {
      if (!C || h == null) return;
      let e = () => {
        if (h.requestId === S.current) return !0;
        let e = null;
        if (h.slideId != null) {
          let t = C.getSnapshot().slideIds.indexOf(h.slideId);
          t >= 0 && (e = t);
        }
        return (
          ...
          e == null
            ? h.slideId == null
            : ((S.current = h.requestId),
              C.setSelectedSlideIdx(e),
              C.setSelectedElementId(h.objectId ?? null),
              !0)
        );
      };
      if (e()) return;
    ...
    (0, Si.useEffect)(() => {
      if (C && p)
        return C.subscribeImageHydrationRequests((e) => {
          let t = w.current + 1;
          ((w.current = t),
            p(e)
              .then((e) => {
                if (!(w.current !== t || e.length === 0))
                  return C.hydrateImageAssets(e);
              })
              .catch(() => {}));
        });
    }, [C, p]),
      ...
      ? (0, Ci.jsxs)(`section`, {
          ...
          children: [
            (0, Ci.jsx)(Kr, {
              ...
              headerRightContent:
                E.length > 0
                  ? (0, Ci.jsxs)(Ci.Fragment, {
                      children: [(0, Ci.jsx)(yi, { count: E.length }), r],
                    })
                  : r,
              renderHeaderZoomControl: a,
              zoomToFitLabel: i,
              ...
              commentThreadsEnabled: ae,
            }),
            (0, Ci.jsx)(nt, { artifactLabel: `Presentation`, restoreState: T }),
          ],
        })
      : null
  );
...
var Si, Ci;
e(() => {
  (te(), p(), (Si = t(i())), gi(), Yt(), re(), z(), Xe(), (Ci = r()));
})();
export { _i as PopcornElectronPresentationPanel };
//# sourceMappingURL=PopcornElectronPresentationPanel-CWv1SPy0.js.map
