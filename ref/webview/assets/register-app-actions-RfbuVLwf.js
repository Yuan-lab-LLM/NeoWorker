...
var I,
  ...
  ot = e(() => {
    (k(),
      ...
      r(),
      _(),
      (I = b({ type: w(`app.appearance.get`) })),
      (L = p({
        schema: I,
        run: async () => {
          let [e, t, n, r, i] = await Promise.all([
            D(m.theme),
            D(m.lightCodeThemeId),
            D(m.darkCodeThemeId),
            D(m.lightChromeTheme),
            D(m.darkChromeTheme),
          ]);
          return {
            schemaVersion: 1,
  ...
  st = e(() => {
    (T(),
      n(),
      _(),
      (R = b({ type: w(`app.appearance.get_available_themes`) })),
      (z = p({
        schema: R,
        run: () => ({
          schemaVersion: 1,
...
async function B(e, t, n, r) {
  ...
  try {
    ...
    (await e.queryClient?.invalidateQueries({ queryKey: i }), h(i));
  }
}
var V = e(() => {
    (ee(), r(), ye());
  ...
  ct = e(() => {
    (k(),
      ...
      (U = p({
        schema: H,
        run: async ({ mode: e }, t) => (
          await B(t, m.theme, e, { optimistic: !1 }),
...
function ut(e) {
  return e === `light`
    ? {
        chromeThemeSetting: m.lightChromeTheme,
        codeThemeSetting: m.lightCodeThemeId,
      }
    : {
        chromeThemeSetting: m.darkChromeTheme,
        codeThemeSetting: m.darkCodeThemeId,
      };
}
var G,
  K,
  ...
  pt = e(() => {
    (k(),
      ...
      _(),
      V(),
      (G = P().regex(/^#[0-9a-fA-F]{6}$/)),
      (K = b({
        code: P().nullable().optional(),
        ui: P().nullable().optional(),
      })),
      (q = b({ diffAdded: G, diffRemoved: G, skill: G })),
      (J = b({
        accent: G.optional(),
        contrast: Pe().int().min(0).max(100).optional(),
        fonts: K.optional(),
        ink: G.optional(),
        opaqueWindows: N().optional(),
      ...
      (dt = b({
        ...
        theme: Ae(`kind`, [
          b({
            kind: w(`preset`),
            themeId: P().refine(Le, `Invalid code theme id`),
          }),
          b({ kind: w(`custom`), patch: J }),
        ]),
  ...
  switch (e.value.routeKind) {
    case `local-thread`:
      return {
        ...
        kind: `local`,
        hostId: e.get(qe, e.value.conversationId) ?? `local`,
...
function _t(e, t, n, r, a) {
  let s = t == null ? [] : o(e, t),
    c = t == null ? null : ae(t, e.get(i), { bottom: n, right: r }),
    l = c == null ? null : (s.find((e) => e.browserTabId === c) ?? null),
    u = t == null || c == null ? null : C.getSnapshot(t, c);
  return {
    canGoBack: u?.canGoBack ?? !1,
    canGoForward: u?.canGoForward ?? !1,
    fullscreen: l?.target === `right` && a,
    isLoading: u?.isLoading ?? !1,
    open: l != null,
    tabs: vt(
      t,
      s.map((e) => e.browserTabId),
      c,
    ),
    title: u?.title ?? null,
    url: u?.url ?? null,
...
function vt(e, t, n) {
  if (e == null) return [];
  let r = C.getBrowserUseBrowserTabIds(e),
    i = [...t, ...r],
    a = new Set(r),
    o = new Set();
  return i.flatMap((t) => {
    if (o.has(t)) return [];
    o.add(t);
    let r = C.getSnapshot(e, t);
    return [
      {
        active: t === n,
        browserTabId: t,
        isBrowserUseActive: C.isBrowserUseActive(e, t),
...
function yt() {
  return Array.from(document.querySelectorAll(ze)).map((e, t) => bt(e, t));
}
function bt(e, t) {
  let n = wt(e);
...
function xt(e) {
  let t = Ct(),
    n = new Set(e.get(at).map((e) => e.path));
  return [
    ...e.get(at).map((e) => ({
      path: e.path,
      ...
      (Et = p({
        ...
        run: (e, n) => {
          let r = Y(n),
            ...
            o = r.get(Xe),
            c = r.get(Ee),
            l = o && c ? r.get(Ye.activeTab$) : null,
            d = r.get(Ye.tabs$),
            f = r.get(we) ? r.get(t.activeTab$) : null,
            p = l?.tabId ?? null,
            m = null;
          p === x.DIFF ? (m = `right`) : f?.tabId === x.DIFF && (m = `bottom`);
          let h = m != null,
            g = r.get(y),
            _ = u(r.get(i), { bottom: r.get(Ke), right: r.get(Te) });
          return {
            schemaVersion: 1,
            window: {
              windowId: je,
              ...
              thread: ht(r),
              panels: {
                browser: _t(r, mt(r.value) ? Je(r) : null, f, l, g),
                sidebar: { open: a },
                review: {
                  open: h,
                  placement: m,
                  fullscreen: m === `right` && g,
                  fileTreeOpen: h && r.get(He),
                  view: r.get(s),
                },
                terminal: { open: _ != null, placement: _ },
                rightPanel: {
                  fullscreen: g,
                  kind: p,
                  open: o,
                  tabs: d.map((e) => ({
                    focused: e.tabId === l?.tabId,
                    type: Ie(e),
                  })),
                },
              },
              ...(a
                ? { sidebar: { viewport: Z(v.sidebarScroll), rows: yt() } }
                : {}),
              ...(h
                ? { review: { viewport: Z(v.reviewScroll), files: xt(r) } }
                : {}),
              ...(mt(r.value) ? { timeline: Z(v.timelineScroll) } : {}),
            },
          };
        },
      })));
...
function kt(e, t, n = jt) {
  return {
    ...
    actions: e
      ...
      .map((e) => ({
        type: e.type,
        jsonSchema: JSON.stringify(he(e.schema), null, 2),
      })),
  };
}
var At,
  ...
  Mt = e(() => {
    (T(),
      _(),
      (At = b({ type: w(`app.help`), action: P().optional() })),
...
Prefer the smallest action that directly satisfies the user request.`));
  ...
  Ft = e(() => {
    (T(),
      ...
      _(),
      F(),
      (Nt = b({ type: w(`windows.nav.back`), windowId: A })),
      (Pt = p({
        schema: Nt,
        run: () => {
  ...
  Rt = e(() => {
    (T(),
      ...
      _(),
      F(),
      (It = b({ type: w(`windows.nav.forward`), windowId: A })),
      (Lt = p({
        schema: It,
        run: () => {
  ...
  Vt = e(() => {
    (T(),
      _(),
      F(),
      (zt = b({ type: w(`windows.review.collapse_all`), windowId: A })),
      (Bt = p({
        schema: zt,
        run: () => {
  ...
  Wt = e(() => {
    (T(),
      _(),
      F(),
      (Ht = b({ type: w(`windows.review.expand_all`), windowId: A })),
      (Ut = p({
        schema: Ht,
        run: () => {
          window.dispatchEvent(
    ...
    (T(),
      ...
      (Kt = p({
        ...
        run: ({ path: e, expanded: t }) => {
          let n = Fe(e).querySelector(v.reviewFileToggle);
  ...
  Xt = e(() => {
    (T(),
      _(),
      F(),
      (Jt = b({ type: w(`windows.review.scroll`), windowId: A, scroll: d })),
      (Yt = p({
        schema: Jt,
        run: ({ scroll: e }) => {
          Ce(O(v.reviewScroll), e);
        },
      })));
  });
function Zt(e) {
...
var Qt,
  ...
  un = e(() => {
    (T(),
      ...
      _(),
      F(),
      (cn = b({ type: w(`windows.review.toggle`), windowId: A })),
      (ln = p({
        schema: cn,
        run: () => {
          E.dispatchHostMessage({ type: `toggle-diff-panel` });
        },
      })));
  }),
  dn,
  ...
  pn = e(() => {
    (T(),
      ...
      _(),
      F(),
      (dn = b({ type: w(`windows.show_home`), windowId: A })),
      (fn = p({
        schema: dn,
        run: () => {
          E.dispatchHostMessage({ type: `new-chat` });
        },
      })));
  });
function mn(e) {
  let t = $e(e);
  return t == null ? _e(We(e)) : fe(t.key);
}
var hn,
  gn,
  _n = e(() => {
    (k(),
      ...
      F(),
      (hn = b({
        type: w(`windows.show_thread`),
        windowId: A,
        threadId: P(),
        kind: M([`chatgpt`, `codex`]).optional(),
      })),
      (gn = p({
        schema: hn,
    ...
    (T(),
      ...
      (Sn = p({
        ...
        run: ({ project: e, showAll: t }) => {
          ...
          let a = i.querySelector(v.sidebarProjectShowAllToggle);
          if (a == null)
  ...
  En = e(() => {
    (T(),
      _(),
      F(),
      (wn = b({ type: w(`windows.sidebar.scroll`), windowId: A, scroll: d })),
      (Tn = p({
        schema: wn,
        run: ({ scroll: e }) => {
          Ce(O(v.sidebarScroll), e);
        },
      })));
  }),
  Dn,
  ...
  Mn = e(() => {
    (T(),
      ...
      (jn = p({
        schema: An,
        run: ({ project: e }) => {
          let t = S(e).querySelector(v.sidebarProjectSelect);
  ...
  Pn = e(() => {
    (T(),
      ...
      _(),
      F(),
      (Nn = b({ type: w(`windows.sidebar.toggle`), windowId: A })),
      (Q = p({
        schema: Nn,
        run: () => {
          E.dispatchHostMessage({ type: `toggle-sidebar` });
        },
      })));
  }),
  Fn,
  ...
  Ln = e(() => {
    (T(),
      ...
      _(),
      F(),
      (Fn = b({ type: w(`windows.terminal.toggle`), windowId: A })),
      (In = p({
        schema: Fn,
        run: (e, t) => {
          Ve(Y(t));
  ...
  Bn = e(() => {
    (T(),
      _(),
      F(),
      (Rn = b({ type: w(`windows.timeline.scroll`), windowId: A, scroll: d })),
      (zn = p({
        schema: Rn,
        run: ({ scroll: e }) => {
          nt(O(v.timelineScroll), e);
        },
      })));
  }),
  Vn,
...
//# sourceMappingURL=register-app-actions-RfbuVLwf.js.map
