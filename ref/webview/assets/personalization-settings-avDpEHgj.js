...
import { n as kt, r as At } from "./chronicle-config-queries-Dqaq04vs.js";
var jt,
  Mt = e(() => {
    (P(),
      tt(),
      U(),
      (jt = Te($e, `codex-agents-md`, (e) => ({
        params: { hostId: e },
...
function It(e, t) {
  let n = (0, Rt.c)(20),
    ...
    a = Ae(),
    s;
  n[0] === e ? (s = n[1]) : ((s = [...o, e]), (n[0] = e), (n[1] = s));
  let c = s,
    l;
  n[2] !== t || n[3] !== e || n[4] !== i?.configWriteTarget?.filePath
    ? ((l = (n) =>
        Ve(`batch-write-config-value`, {
          hostId: e,
          edits: t(n).map(Lt),
  ...
  n[6] !== t || n[7] !== r || n[8] !== c
    ? ((d = async (e) => {
        ...
        return (
          r.setQueryData(c, (e) =>
            e == null ? e : { ...e, config: gt(e.config, n) },
          ),
  ...
  n[10] !== r || n[11] !== c
    ? ((f = (e, t, n) => {
        (ht.error(`Failed to update memory config`, {
          safe: {},
          sensitive: { error: e },
        }),
  ...
  n[13] === a
    ? (p = n[14])
    : ((p = async () => {
        await Promise.all([a(o), a([`user-saved-config`])]);
      }),
      (n[13] = a),
      (n[14] = p));
  let m;
...
function Bt({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = ne($e),
    ...
    a = Ge(),
    o = At(),
    { data: s, isLoading: c } = v(S.CHRONICLE_CONSENT_ACCEPTED),
    { data: l, isLoading: d } = te(me, n),
    [f, p] = (0, rn.useState)(!1),
    [g, _] = (0, rn.useState)(!1),
    [y, b] = (0, rn.useState)(null),
    [x, C] = (0, rn.useState)(!1),
    w = se(`chronicle-permissions`, {
      queryConfig: {
        intervalMs: 1e3,
  ...
  (0, rn.useEffect)(() => {
    g && lt(ee.kind) && h(t, S.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [g, t, ee.kind]);
  let N = async ({ rememberConsentAccepted: n, showSetupDialog: r }) => {
      let a = O;
      (C(!0), b(null), p(!1), _(r));
      try {
        (n === !0 && (await h(t, S.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || h(t, S.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await o.mutateAsync({ enabled: !0 }),
          e?.(a, !0),
          await i.invalidateQueries({ queryKey: A(`chronicle-permissions`) }));
      } catch (e) {
        let n = nn(e);
        (h(t, S.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          b(n),
          ht.error(`Failed to enable Chronicle`, {
            safe: { errorMessage: n },
            sensitive: { error: e },
          }));
      } finally {
    ...
    P = async () => {
      let n = O;
      (C(!0), b(null), h(t, S.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
    ...
    : (0, Z.jsxs)(Z.Fragment, {
        children: [
          (0, Z.jsx)(Oe, {
            ...
            control: (0, Z.jsx)(T, {
              ...
              children: (0, Z.jsx)(`span`, {
                className: Ne(`inline-flex`, !D && `cursor-not-allowed`),
                tabIndex: D ? void 0 : 0,
                children: (0, Z.jsx)(Tt, {
                  checked: O,
          ...
          (0, Z.jsx)(Vt, {
            open: f,
            onOpenChange: p,
            chronicleDisplayName: M,
            isPending: k,
            onContinue: () => {
              N({ rememberConsentAccepted: !0, showSetupDialog: !0 });
            },
          }),
          (0, Z.jsx)(Ye, {
            open: g,
            setupState: ee,
            onOpenChange: (e) => {
              (e || h(t, S.CHRONICLE_SETUP_COMPLETION_PENDING, !1), _(e));
            },
            onAskCodex: () => {
              (h(t, S.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
                _(!1),
...
function Vt(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = (0, Z.jsx)(ce, { title: l })), (t[4] = l), (t[5] = u));
  let f;
  t[6] !== c || t[7] !== u
    ? ((f = (0, Z.jsxs)(Dt, { children: [c, u] })),
      (t[6] = c),
      (t[7] = u),
      (t[8] = f))
    : (f = t[8]);
  ...
  t[27] !== T || t[28] !== D
    ? ((O = (0, Z.jsx)(Dt, {
        children: (0, Z.jsxs)(M, { className: d, children: [T, D] }),
      })),
      (t[27] = T),
      (t[28] = D),
      (t[29] = O))
...
function Zt(e) {
  let t = (0, X.c)(12),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = Ne(`font-medium`, en({ isChecking: n, status: i }))),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
    : (a = t[2]);
...
function on({
  ...
  return {
    chronicleResearchPreviewEnabled: e,
    chronicleResearchPreviewVisible: t,
    ...he({ isMemoryFeatureEnabled: n, memoryConfig: r }),
...
function fn() {
  let e = (0, mn.c)(99),
    ...
    l = fe(),
    { data: u } = te(me, i),
    { data: d, isLoading: f } = te(p, i),
    h;
  e[0] === d
    ? (h = e[1])
    : ((h = d === void 0 ? [] : d), (e[0] = d), (e[1] = h));
  let g = h,
    v = c && !l.isLoading && !l.available,
    y;
  e[2] === v
    ? (y = e[3])
    : ((y = {
      ...
      (e[2] = v),
      (e[3] = y));
  let { data: b } = se(`chronicle-permissions`, y),
    x = Pt(i),
    S;
  e[4] === i ? (S = e[5]) : ((S = { hostId: i }), (e[4] = i), (e[5] = S));
  let w = dt(S),
    T = At(),
    D;
  e[6] === i
    ? (D = e[7])
    : ((D = () => Ve(`reset-memories-for-host`, { hostId: i })),
      (e[6] = i),
      (e[7] = D));
  let O, k;
  e[8] === t
    ...
    : ((O = () => {
      ...
      (e[10] = k));
  let A;
  e[11] !== D || e[12] !== O || e[13] !== k
    ? ((A = { mutationFn: D, onSuccess: O, onError: k }),
      (e[11] = D),
      (e[12] = O),
      (e[13] = k),
      (e[14] = A))
  ...
  let j = ut(A),
    N;
  e[15] === g ? (N = e[16]) : ((N = we(g)), (e[15] = g), (e[16] = N));
  let P = N;
  if (P == null) return null;
  let F = P.enabled,
    I = u?.config,
    L;
  e[17] === I ? (L = e[18]) : ((L = it(I)), (e[17] = I), (e[18] = L));
  let R = L,
    z = u?.config,
    ae;
  e[19] === z ? (ae = e[20]) : ((ae = m(z, wt)), (e[19] = z), (e[20] = ae));
  let le = ae === !0,
    ue = f || x.isPending || w.isPending || T.isPending || j.isPending,
    he = a.kind === `local`,
    ge = ue || (he && l.isLoading),
    _e = F && R.generateMemories && R.useMemories,
    B =
      he &&
      c &&
      !l.isLoading &&
      !l.available &&
      b?.chronicleSidecarPresent === !0,
    ve;
  e[21] !== le || e[22] !== F || e[23] !== R || e[24] !== B
    ? ((ve = {
        chronicleResearchPreviewEnabled: le,
        chronicleResearchPreviewVisible: B,
        isMemoryFeatureEnabled: F,
        memoryConfig: R,
      }),
      (e[21] = le),
      (e[22] = F),
  ...
  e[34] !== l
    ? ((Se = (e) => {
        un({
          ...
          previousState: H(),
          selectedEnabled: e,
          featureWrite: () => w.mutateAsync({ featureName: E, enabled: e }),
          configWrite: () =>
            x.mutateAsync({
              edits: [
          ...
          ...(!e && he
            ? {
                chronicleDisable: () =>
                  l.available && de.chronicle != null
                    ? de.chronicle.setEnabled(!1)
                    : T.mutateAsync({ enabled: !1 }),
              }
            : {}),
        });
      }),
  ...
  e[42] === n
    ...
    : ((je = n.formatMessage({
      ...
      (e[43] = je));
  let W;
  e[44] !== _e || e[45] !== ge || e[46] !== Ce || e[47] !== je
    ? ((W = (0, Q.jsx)(Oe, {
        label: ke,
        description: Ae,
        control: (0, Q.jsx)(Tt, {
  ...
  e[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Me = (0, Q.jsx)(V, {
      ...
      (e[54] = Ne))
    : ((Me = e[53]), (Ne = e[54]));
  let Fe = !R.disableOnExternalContext,
    Ie = ue || !F,
    Le;
  e[55] === n
    ? (Le = e[56])
  ...
  e[57] !== x ||
  e[58] !== H ||
  e[59] !== R.disableOnExternalContext ||
  e[60] !== r
    ? ((ze = (e) => {
        let t = !e;
        ln({
    ...
    : (ze = e[61]);
  let Be;
  e[62] !== Fe || e[63] !== Ie || e[64] !== Le || e[65] !== ze
    ? ((Be = (0, Q.jsx)(Oe, {
        label: Me,
        description: Ne,
        control: (0, Q.jsx)(Tt, {
  ...
  e[71] === j.isPending
    ...
    : ((Ke = (0, Q.jsx)(Oe, {
      ...
      (e[72] = Ke));
  let qe;
  e[73] !== W || e[74] !== G || e[75] !== Be || e[76] !== Ke
    ? ((qe = (0, Q.jsxs)(J, {
        children: [
          U,
          (0, Q.jsx)(J.Content, {
            children: (0, Q.jsxs)(Re, { children: [W, G, Be, Ke] }),
          }),
        ],
      })),
      (e[73] = W),
  ...
  e[83] !== Ee || e[84] !== r
    ? ((K = () => {
        (r.logProductEvent(ie, { resetScope: `all_memories` }), Ee());
      }),
      (e[83] = Ee),
      (e[84] = r),
      (e[85] = K))
  ...
  e[90] !== Qe || e[91] !== tt
    ? ((q = (0, Q.jsxs)(C, {
        children: [
          Je,
          (0, Q.jsx)(Dt, { children: (0, Q.jsxs)(M, { children: [Qe, tt] }) }),
        ],
      })),
      (e[90] = Qe),
      (e[91] = tt),
...
function _n() {
  let e = oe(ae);
  return (0, $.jsxs)(Qe, {
    title: (0, $.jsx)(Ce, { slug: `personalization` }),
    children: [
      e ? (0, $.jsx)(vn, {}) : null,
      (0, $.jsx)(B, {
        electron: !0,
...
function vn() {
  ...
  let { personality: o, setPersonality: s } = He(a),
    c;
  e[2] === t
    ? (c = e[3])
    : ((c = t.formatMessage(Y.friendly)), (e[2] = t), (e[3] = c));
  let l;
  e[4] === t
    ? (l = e[5])
    : ((l = t.formatMessage({
  ...
  let u;
  e[6] !== c || e[7] !== l
    ? ((u = { value: `friendly`, label: c, description: l }),
      (e[6] = c),
      (e[7] = l),
      (e[8] = u))
    : (u = e[8]);
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = t.formatMessage(Y.pragmatic)), (e[9] = t), (e[10] = d));
  let f;
  e[11] === t
    ? (f = e[12])
    : ((f = t.formatMessage({
  ...
  let p;
  e[13] !== d || e[14] !== f
    ? ((p = { value: `pragmatic`, label: d, description: f }),
      (e[13] = d),
      (e[14] = f),
      (e[15] = p))
    : (p = e[15]);
  let m;
  e[16] !== u || e[17] !== p
    ? ((m = [u, p]), (e[16] = u), (e[17] = p), (e[18] = m))
    : (m = e[18]);
  let h = m,
    g;
  e[19] !== o || e[20] !== h
    ? ((g = h.find((e) => e.value === o) ?? h[0]),
      (e[19] = o),
      (e[20] = h),
      (e[21] = g))
    : (g = e[21]);
  let _ = g,
    v;
  e[22] !== r || e[23] !== o || e[24] !== h || e[25] !== _ || e[26] !== s
    ? ((v = r
        ? (0, $.jsx)(J, {
  ...
  e[28] === i
    ? (y = e[29])
    : ((y = (0, $.jsx)(yn, { hostId: i }, i)), (e[28] = i), (e[29] = y));
  let b;
  return (
    e[30] !== y || e[31] !== v
...
function yn(e) {
  let t = (0, xn.c)(46),
    ...
    { data: l, error: d, isFetching: f, refetch: p } = te(jt, n),
    m;
  t[0] !== a || t[1] !== o || t[2] !== r
    ? ((m = (e, t) => {
        (o.setQueryData(A(`codex-agents-md`, { hostId: t.hostId }), {
          path: e.path,
          contents: t.contents,
        }),
          c(null),
  ...
  let g;
  t[7] !== m || t[8] !== h
    ? ((g = { onSuccess: m, onError: h }), (t[7] = m), (t[8] = h), (t[9] = g))
    : (g = t[9]);
  let _ = i(`codex-agents-md-save`, g),
    v = l?.contents ?? ``,
    y = s ?? v,
    b = s != null && s !== v,
    x = l != null,
  ...
  t[15] !== _
    ? ((T = () => {
        !x || !b || C || _.mutate({ hostId: n, contents: y });
      }),
      (t[10] = y),
      (t[11] = n),
      (t[12] = b),
  ...
  t[24] === a
    ? (M = t[25])
    : ((M = a.formatMessage(Y.customInstructions)), (t[24] = a), (t[25] = M));
  let N = M,
    P;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, $.jsx)(V, { ...Y.customInstructions })), (t[26] = P))
    : (P = t[26]);
  let F;
...
//# sourceMappingURL=personalization-settings-avDpEHgj.js.map
