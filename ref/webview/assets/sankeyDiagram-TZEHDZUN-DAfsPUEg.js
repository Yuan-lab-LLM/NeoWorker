...
import { hat as t } from "./app-initial-BHB6SClA.js";
import { d as n } from "./src-DWyvtO7a.js";
import { n as r, r as i } from "./chunk-AGHRB4JF-D33xM56t.js";
import {
  B as a,
  C as o,
  K as s,
...
` +
    ...
    (L = { left: x, right: T, center: S, justify: y }),
    (R = {
      draw: r(function (e, i, a, o) {
        ...
        let p = _(c === `sandbox` ? d.nodes()[0].contentDocument.body : `body`),
          ...
          x = l?.nodeAlignment ?? u.nodeAlignment,
          S = l?.prefix ?? u.prefix,
          w = l?.suffix ?? u.suffix,
...
export { H as diagram };
//# sourceMappingURL=sankeyDiagram-TZEHDZUN-DAfsPUEg.js.map
