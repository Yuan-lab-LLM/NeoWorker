...
import { r as T, t as E } from "./codex-home-announcements-BA0P68Pe.js";
function D() {
  let e = (0, k.c)(14),
    t = f(),
    n = c(l);
  {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, A.jsx)(a, { to: `/`, replace: !0 })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
  ...
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = S.isRecording() ? (0, A.jsx)(v, { onPaint: O }) : null), (e[1] = r))
    : (r = e[1]);
  let o;
  e[2] === t
    ? (o = e[3])
...
//# sourceMappingURL=new-thread-panel-page-Xl0DC1bk.js.map
