...
async function N(e, t, n, r) {
  ...
  try {
    ((W = e),
      await h.systemPermissions?.requestMicrophoneAccess().catch(() => {}),
      (i = await v({ channelCount: 1 })),
    ...
    throw (
      ...
      W === e && (W = null),
      G === e && (G = null),
      T.dispatchMessage(`global-dictation-failed`, {
        sessionId: e,
        stage: `recording`,
      }),
      n
...
function P(e) {
  ...
  t.isStopping ||
    ...
    T.dispatchMessage(`global-dictation-recording-stopped`, { sessionId: e }),
    F(t));
}
async function F(e) {
  let t = null;
  try {
    ...
    if (e.chunks.length === 0 || Date.now() - e.startedAtMs < V) {
      (e.streamingSession?.close(),
        T.dispatchMessage(`global-dictation-completed`, {
...
function ee(e) {
  ...
  (t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (e) => {
      ...
      (t[22] = H))
    : ((V = t[21]), (H = t[22])),
    C(`global-dictation-stop`, V, H));
  let U, W;
  (t[23] !== o || t[24] !== c || t[25] !== u
    ? ((U = () => {
        let e = !0;
        return (
          u &&
            queueMicrotask(() => {
              e &&
                T.dispatchMessage(`global-dictation-pet-renderer-ready`, {
                  ready: !0,
                });
            }),
          () => {
  ...
  let G = m === `error` && v,
    K;
  t[28] !== f || t[29] !== F || t[30] !== G || t[31] !== m
    ? ((K = (e) => {
        if ((e.stopPropagation(), m === `listening` && f != null)) {
          T.dispatchMessage(`global-dictation-stop-requested`, {
            sessionId: f,
          });
          return;
        }
        ...
        m === `error` &&
          f != null &&
          T.dispatchMessage(`global-dictation-dismiss`, { sessionId: f });
      }),
      (t[28] = f),
      (t[29] = F),
      (t[30] = G),
  ...
  let J;
  return (
    t[33] !== v || t[34] !== g || t[35] !== q || t[36] !== m || t[37] !== w
      ? ((J = (0, $.jsx)(te, {
          canRetryError: v,
          errorMessage: g,
          onClick: q,
...
function te(e) {
  ...
  t[10] === a
    ...
    : ((p = w(
        ...
        a === `listening`
          ? w(`cursor-interaction text-white`, Y.recordingOrb)
  ...
  t[15] === l
    ? (h = t[16])
    : ((h = l ? (0, $.jsx)(S, { className: `icon-sm` }) : null),
      (t[15] = l),
      (t[16] = h));
  let g;
  t[17] === u
    ? (g = t[18])
    : ((g = u ? (0, $.jsx)(o, { className: `icon-sm` }) : null),
      (t[17] = u),
      (t[18] = g));
  let v;
  t[19] !== n || t[20] !== a
    ? ((v =
        a === `error` && !n ? (0, $.jsx)(_, { className: `icon-sm` }) : null),
      (t[19] = n),
      (t[20] = a),
      (t[21] = v))
    : (v = t[21]);
  ...
  let T = a === `error` && r != null ? r : null,
    E;
  t[26] !== b || t[27] !== C || t[28] !== T
    ? ((E = (0, $.jsxs)(`span`, { className: `sr-only`, children: [b, C, T] })),
      (t[26] = b),
      (t[27] = C),
      (t[28] = T),
      (t[29] = E))
...
//# sourceMappingURL=global-dictation-orb-j6CQ75jj.js.map
