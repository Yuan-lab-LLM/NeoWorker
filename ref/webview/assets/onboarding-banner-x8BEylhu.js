...
function d(e) {
  ...
  t[0] === a
    ? (u = t[1])
    : ((u = a ? (0, m.jsx)(a, { className: `icon-xs` }) : null),
      (t[0] = a),
      (t[1] = u));
  let d;
  return (
...
function f(e) {
  ...
  if (
    ...
    let e = {
      ...
      n = (t) =>
        (0, m.jsxs)(`div`, {
          className: a(`flex items-center gap-2`, e, t),
          children: [
  ...
  return (
    t[30] !== M || t[31] !== j
      ? ((N = (0, m.jsx)(l, { stackOnNarrow: !0, content: j, customCtas: M })),
        (t[30] = M),
        (t[31] = j),
        (t[32] = N))
      : (N = t[32]),
...
//# sourceMappingURL=onboarding-banner-x8BEylhu.js.map
