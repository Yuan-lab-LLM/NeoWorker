...
function M({ conversationId: e, hostId: t }) {
  let n = u(T),
    i = y(),
    [o, c] = (0, N.useState)(!1),
    { agentMode: l, setAgentMode: f } = m({ conversationId: e, hostId: t }),
    { setPreferredNonFullAccessMode: p } = r({ conversationId: e, hostId: t }),
    h = async () => {
      if (!o) {
        c(!0);
        try {
          ...
          (j.error(`Failed to enable Auto-review`, {
          ...
          children: [
            ...
            (0, P.jsxs)(S, {
              ...
              children: [
                ...
                (0, P.jsx)(s, { variant: `primary`, children: `⏎` }),
              ],
            }),
          ],
        }),
...
//# sourceMappingURL=auto-review-approval-nudge-bOcekUG0.js.map
