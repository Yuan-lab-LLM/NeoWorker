...
import { n as hn, t as gn } from "./artifact-file-preview-icon-J_J1f2vx.js";
import { n as _n, t as vn } from "./thread-panel-toggle-button-CFhH1XBM.js";
import {
  L as yn,
  R as bn,
  a as xn,
...
import { o as Cn, s as wn } from "./thread-overflow-menu-CHu-muVE.js";
import { n as Tn, t as En } from "./use-media-query-_4fcOL58.js";
var Dn,
  On,
  kn = e(() => {
    (ue(),
...
function Pn({ onClose: e, target: t }) {
  let n = B(kt),
    a = G(),
    o = A(),
    s = H(Wt.tabs$),
    ...
    _ = H(At),
    v = zt(n),
    y = n.value.routeKind === `local-thread` ? n.value.conversationId : null,
    b = I(Gt, y);
  I(ne, y);
  let x = I(fn, y),
    S = I(nn, y),
    C = I(K, `searchFiles`),
    w = I(K, `openSideChat`),
    T = I(K, `openBrowserTab`),
    E = I(K, `openReviewTab`),
    ee = I(Ot, { conversationId: y, hostId: _.id }, { enabled: !1 }),
    O = b !== `projectless` && g != null,
    k = y != null && !1,
    j = y != null && !mt(),
    M = d && (f || !l.some((e) => Yt(e))),
    P = !p && (h.kind === `git` || !1) && !l.some((e) => e.tabId === Ze.DIFF),
    te = k && !l.some((e) => e.tabId === Ze.TIMELINE),
    L = (!p || t !== `right`) && qt(n),
    R = o.status === `allowed` || o.status === `loading`,
    z = R && h.kind !== `git` ? ee : null,
    ae = z != null && z.length > 0,
    oe = () => {
      y != null &&
        wn(n, Sn, {
          sourceConversationId: y,
          cwd: h.cwd,
          hostId: x,
          collaborationMode: S,
          intl: a,
          ...
          .catch((e) => {
            (Ht.error(`Error opening side chat`, {
              safe: {},
              sensitive: { error: e },
            }),
              n.get(le).danger(
    ...
    ue = () => {
      st(n, {
        browserConversationId: v ?? void 0,
        browserHostDisplayName: _.display_name,
        cwd: h.cwd,
    ...
    fe = () => {
      g != null &&
        (ie(n, null, { hostId: _.id, target: t, workspaceRoot: g }), e?.());
    },
    pe = () => {
      (Be(n, t), e?.());
    },
    V = (e, t, n) => {
      if (t == null) {
        Le({ href: e, initiator: `mcp_app_resource`, originHostId: n });
        return;
      }
      Pe({ event: t, href: e, initiator: `mcp_app_resource`, originHostId: n });
    },
    me = (e, t) => {
      switch (e.type) {
        case `file`:
    ...
    he = [
      ...
      ...(L
        ...
        : []),
    ].filter((e) => R || !e.requiresCodexAccess);
  return {
    actions:
      h.kind === `git`
        ? [...he].sort(
            (e, t) => (In[e.id] ?? he.length) - (In[t.id] ?? he.length),
          )
        : he,
    hasOutputArtifacts: ae,
    onOpenArtifact: me,
    outputArtifacts: z,
  };
}
var J,
  ...
  Ln = e(() => {
    (V(),
      ...
      (J = p()),
      (Fn = k(pt, ({ get: e }) =>
        e(Ue).filter((e) => e.entrypoint === `thread`),
      )),
      (In = { review: 0, terminal: 1, browser: 2, "open-file": 3 }));
  });
function Rn(e) {
  switch (e.type) {
    case `external-resource`:
...
function Un(e) {
  ...
  switch (n.type) {
    case `external-resource`: {
      let e;
      return (
        t[0] !== n.resource || t[1] !== r
          ? ((e = (0, Gn.jsx)(yn, { className: r, resource: n.resource })),
            (t[0] = n.resource),
            (t[1] = r),
            (t[2] = e))
          : (e = t[2]),
    ...
    case `appgen-app`: {
      ...
      return (
        t[10] === r
          ? (e = t[11])
          : ((e = (0, Gn.jsx)(xe, { className: r })), (t[10] = r), (t[11] = e)),
        e
      );
    }
    case `website`: {
      ...
      return (
        t[12] === r
          ? (e = t[13])
          : ((e = (0, Gn.jsx)(je, { className: r })), (t[12] = r), (t[13] = e)),
        e
      );
    }
  }
...
function qn(e) {
            ...
            W.Item,
            {
              ...
              children: [
                e.mcpServerIcon == null
                  ? null
                  : (0, Y.jsx)(W.ItemIcon, { children: nt(e.mcpServerIcon) }),
                e.title,
              ],
            },
            e.id,
  ...
  t[6] !== n.length || t[7] !== s || t[8] !== a || t[9] !== o
    ? ((l = s
        ? (0, Y.jsxs)(Y.Fragment, {
            children: [
              n.length > 0 ? (0, Y.jsx)(W.Separator, {}) : null,
              (0, Y.jsx)(W.SectionLabel, {
                children: (0, Y.jsx)(U, {
              ...
              o.map((e) =>
                (0, Y.jsxs)(
                  W.Item,
                  {
                    onClickCapture: (t) => {
                      Ie(t) &&
                        (t.preventDefault(), t.stopPropagation(), a(e, t));
                    },
                    onSelect: () => a(e),
                    children: [
                      (0, Y.jsx)(W.ItemIcon, {
  ...
  return (
    t[11] !== c || t[12] !== l
      ? ((u = (0, Y.jsxs)(Y.Fragment, { children: [c, l] })),
        (t[11] = c),
        (t[12] = l),
        (t[13] = u))
      : (u = t[13]),
...
var Jn,
  Y,
  Yn = e(() => {
    ((Jn = z()), Se(), E(), O(), Kt(), Hn(), Kn(), (Y = p()));
  });
function Xn(e) {
  let t = (0, rr.c)(61),
    { cwd: n, hostConfig: r } = e,
    i = G(),
    a = Tn(`(max-width: 920px)`),
    o = re() === ht,
    [s, c] = (0, ir.useState)(null),
    l = r?.id,
    u;
  t[0] !== n || t[1] !== l
    ? ((u = { cwd: n, deferEnrichment: !0, hostId: l }),
      (t[0] = n),
      (t[1] = l),
      (t[2] = u))
    : (u = t[2]);
  ...
  if (!n || !d) return null;
  let _, v, y, b, x, S, C, w, T, E, D, O, k, A, j, M, N;
  if (
    t[3] !== m ||
    t[4] !== h ||
    t[5] !== i ||
    ...
    bb0: {
      N = o ? p.filter(er) : p;
      let e;
      t[29] === m ? (e = t[30]) : ((e = new Set(m)), (t[29] = m), (t[30] = e));
      let n = e,
        r = o
          ? (N.find(
              (e) => e.target === `fileManager` && !e.hidden && n.has(e.target),
            ) ?? null)
          : null,
        c = te({
          preferredTarget: f,
      ...
      ((v = c?.target === `systemDefault` && r != null ? r : c),
        (y = a || (v != null && f === v.target)));
      let l = v
          ? i.formatMessage(
              {
      ...
      ((_ = Me),
        (E = `outline`),
        (D = `toolbar`),
        (O = `!border-token-border`),
        (k = `!border-token-border`),
        (A = v == null),
        (j = `end`),
        (M = `tall`),
        (b = `menuFixed`),
        (x = `pt-2`),
        (S = y ? ar.openPrimaryTarget : void 0),
        (C = y ? l : void 0),
        (w =
          d.length === 0
            ? (0, X.jsx)(tr, {})
  ...
  t[36] !== v || t[37] !== y
    ? ((I = (0, X.jsx)(`span`, {
        className: `icon-xs inline-flex shrink-0 items-center justify-center`,
        children:
          v == null
            ? (0, X.jsx)(`span`, {
                className: `size-4 rounded bg-token-bg-tertiary`,
              })
            : (0, X.jsx)(nr, {
                alt: y ? v.label : ``,
                src: v.icon,
  ...
  t[39] === y
    ...
    : ((L = y
        ...
        : (0, X.jsx)(`span`, {
            className: `truncate`,
            children: (0, X.jsx)(U, { ...ar.openPrimaryTarget }),
          })),
      (t[39] = y),
      (t[40] = L));
  let R;
  ...
  return (
    ...
    t[59] !== M
      ? ((z = (0, X.jsx)(_, {
          ...
          size: D,
          primaryClassName: O,
          dropdownButtonClassName: k,
          primaryDisabled: A,
          dropdownAlign: j,
          dropdownContentMaxHeight: M,
          dropdownContentWidth: b,
          dropdownContentClassName: x,
          primaryAriaLabel: S,
          tooltipContent: C,
          dropdownContent: w,
    ...
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, X.jsxs)(W.Item, {
          ...
          children: [
            ...
            (0, X.jsx)(`span`, {
              className: `h-3 w-24 rounded bg-token-bg-tertiary`,
            }),
          ],
        })),
        (e[0] = t))
...
function nr(e) {
  let t = (0, rr.c)(7),
    { alt: n, className: r, src: i } = e,
    [a, o] = (0, ir.useState)(null);
  if (i === a) return null;
  let s;
  t[0] === i ? (s = t[1]) : ((s = () => o(i)), (t[0] = i), (t[1] = s));
  let c;
  return (
    t[2] !== n || t[3] !== r || t[4] !== i || t[5] !== s
      ? ((c = (0, X.jsx)(`img`, { alt: n, className: r, onError: s, src: i })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = i),
        (t[5] = s),
...
function sr(e) {
  ...
  t[0] === i.cwd
    ? (o = t[1])
    : ((o = i.cwd == null ? null : N(i.cwd)), (t[0] = i.cwd), (t[1] = o));
  let s = o;
  ...
  return (
    t[2] !== s || t[3] !== r
      ? ((c = (0, lr.jsx)(q.HeaderAction, {
          actionId: `thread-local-project-actions`,
          align: `end`,
          order: 100,
          children: (0, lr.jsx)(Xn, { cwd: s, hostConfig: r }),
        })),
        (t[2] = s),
        (t[3] = r),
        (t[4] = c))
...
function dr(e) {
  ...
  t[2] === r
    ? (i = t[3])
    : ((i = { onClose: r, target: `right` }), (t[2] = r), (t[3] = i));
  let { actions: a, onOpenArtifact: o, outputArtifacts: s } = Pn(i),
    c;
  t[4] === a ? (c = t[5]) : ((c = a.find(fr)), (t[4] = a), (t[5] = c));
  let l = c,
    u;
  t[6] === l
    ? (u = t[7])
...
function pr(e) {
    ...
    ? ((_ =
        n.length > 0
          ? (0, Z.jsx)(et.ul, {
              ...
              variants: o ? void 0 : br,
              children: n.map((e) =>
                (0, Z.jsx)(
                  et.li,
                  {
                    className: `w-full`,
                    variants: o ? void 0 : xr,
                    children: (0, Z.jsxs)(`button`, {
                      type: `button`,
                      className: Ge(
                        `cursor-interaction flex min-h-10 w-full items-center gap-2 rounded-md bg-token-bg-fog px-2.5 py-2 text-left`,
  ...
  t[5] === a
    ...
    : ((v =
      ...
      (t[6] = v));
  let y;
  t[7] !== d || t[8] !== g || t[9] !== _ || t[10] !== v
    ? ((y = (0, Z.jsxs)(`div`, { ref: d, className: g, children: [_, v] })),
      (t[7] = d),
      (t[8] = g),
      (t[9] = _),
      (t[10] = v),
        ...
        a == null
          ...
          : (0, Z.jsxs)(Z.Fragment, {
              children: [
                ...
                (0, Z.jsx)(hr, { artifacts: a, onOpen: r }),
              ],
            })),
      (t[12] = f),
      (t[13] = r),
...
function mr(e) {
  ...
  return (
    t[4] !== a || t[5] !== o
      ? ((s = (0, Z.jsx)(
          `div`,
          { "aria-hidden": !0, className: `h-px`, ref: o },
          a,
        )),
        (t[4] = a),
        (t[5] = o),
...
function gr(e) {
  ...
  t[0] === o
    ...
    : ((s = Ge(
      ...
      (t[1] = s));
  let c;
  t[2] === n ? (c = t[3]) : ((c = Bn(n)), (t[2] = n), (t[3] = c));
  let l;
  ...
  t[13] === n
    ...
    : ((h = (0, Z.jsx)(`span`, {
      ...
      (t[14] = h));
  let g;
  t[15] === n ? (g = t[16]) : ((g = zn(n)), (t[15] = n), (t[16] = g));
  let _;
  t[17] === g
    ? (_ = t[18])
    : ((_ = (0, Z.jsx)(`span`, {
    ...
    ((_r = z()),
      ...
      (yr = {
        closed: {
          opacity: 0,
          y: -8,
          transition: { duration: 0.06, ease: Zt.ease, when: `afterChildren` },
        },
        open: {
          opacity: 1,
          y: 0,
          transition: { duration: 0.09, ease: Zt.ease, when: `beforeChildren` },
        },
      }),
      (br = {
        closed: {
      ...
      (xr = {
        closed: {
          opacity: 0,
          y: -6,
          transition: { duration: 0.045, ease: Zt.ease },
        },
        open: {
          opacity: 1,
          y: 0,
          transition: { duration: 0.075, ease: Zt.ease },
        },
      }));
  });
function Cr(e) {
  ...
  (t[0] !== o || t[1] !== c || t[2] !== n
    ? ((m = () => {
        ...
        p.current !== e && ((p.current = e), Ft(n, o));
      }),
      (g = [o, c, n]),
      (t[0] = o),
      (t[1] = c),
    ...
    (0, Mr.useEffect)(m, g));
  let _;
  t[5] === n ? (_ = t[6]) : ((_ = () => Qt(n)), (t[5] = n), (t[6] = _));
  let v;
  (t[7] === f ? (v = t[8]) : ((v = { enabled: f }), (t[7] = f), (t[8] = v)),
    b(`openReviewTab`, _, v));
  let y;
  t[9] === n ? (y = t[10]) : ((y = () => on(n)), (t[9] = n), (t[10] = y));
  let x;
  (t[11] === f ? (x = t[12]) : ((x = { enabled: f }), (t[11] = f), (t[12] = x)),
    b(`toggleReviewTab`, y, x));
  let S, C;
  (t[13] !== a.id ||
  t[14] !== l ||
  t[15] !== e.threadType ||
  ...
  t[17] !== i
    ? ((S = () => {
        !l ||
          e.threadType === `remote` ||
          i == null ||
          ge(n, null, { hostId: a.id, workspaceRoot: i });
      }),
      (C = [a.id, l, e.threadType, n, i]),
      (t[13] = a.id),
      (t[14] = l),
      (t[15] = e.threadType),
      (t[16] = n),
  ...
  return (
    ...
    t[22] !== l ||
    t[23] !== c ||
    t[24] !== e.conversationId ||
    t[25] !== e.showReviewTab ||
    t[26] !== e.threadType ||
    t[27] !== n ||
    t[28] !== u
      ? ((w = (0, $.jsx)($.Fragment, {
          children:
            e.threadType === `remote`
              ? (0, $.jsxs)($.Fragment, {
                  children: [
                    (0, $.jsx)(Tr, { actionIdPrefix: d }),
                    (0, $.jsx)(wr, {}),
                    (0, $.jsx)(q.HeaderAction, {
                      actionId: `${d}-panel-toggles`,
                      align: `end`,
                      order: 300,
                      slotPosition: `right`,
                      children: (0, $.jsx)(vn, {
                        label: s.formatMessage(Pr.toggleSidePanel),
                        disabled: !e.showReviewTab,
                        pressed: c,
                        shortcut: u,
                        onClick: () => we(n),
                        children: c
                          ? (0, $.jsx)(h, { className: `icon-xs rotate-180` })
                          : (0, $.jsx)(pe, { className: `icon-xs rotate-180` }),
                      }),
                    }),
                  ],
                })
              : (0, $.jsxs)($.Fragment, {
                  children: [
                    l && e.threadType === `local` && e.conversationId != null
                      ? (0, $.jsx)(sr, { conversationId: e.conversationId })
                      : null,
                    null,
                    (0, $.jsx)(Tr, { actionIdPrefix: d }),
                    (0, $.jsx)(Or, { conversationId: e.conversationId }),
                  ],
                }),
        })),
        (t[20] = d),
...
function wr() {
  let e = (0, Q.c)(7),
    t = B(kt),
    n;
  e[0] === t ? (n = e[1]) : ((n = zt(t)), (e[0] = t), (e[1] = n));
  let r = n,
    i;
  e[2] === r
    ? (i = e[3])
    : ((i = (0, $.jsx)(Ar, { browserConversationId: r })),
      (e[2] = r),
      (e[3] = i));
  let a;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(q.RightPanelOutlet, {
        children: (0, $.jsx)(q.RightPanelTabs, {}),
      })),
      (e[4] = a))
    : (a = e[4]);
  let o;
  ...
  let t = B(kt),
    ...
    p = () => {
      if (s) {
        ...
        j(t, `bottom`, { activateFallbackTab: !0, allowEmpty: !0 }) &&
          t.get(Et) &&
          jr();
      }
    };
  return (
    Ve(`toggle-bottom-panel`, p),
    Ve(`toggle-terminal`, () => {
      f && It(t, void 0, c);
    }),
    b(`toggleBottomPanel`, p),
    b(`toggleTerminal`, () => {
      f && yt(t, c);
    }),
    (0, $.jsxs)($.Fragment, {
      children: [
        (0, $.jsx)(Dr, {}),
        (0, $.jsx)(q.BottomPanelOutlet, {
          children: (0, $.jsx)(q.BottomPanelTabs, {}),
        }),
        d
          ? (0, $.jsx)(q.BottomPanelTabListAfterSticky, {
              children: (0, $.jsx)(Er, {
                target: `bottom`,
          ...
          : null,
        (0, $.jsx)(q.BottomPanelTabListAfter, {
          children: (0, $.jsx)(lt, {
            color: `ghost`,
            size: `toolbar`,
            uniform: !0,
        ...
        s
          ? (0, $.jsx)(q.HeaderAction, {
              actionId: `${e}-bottom-panel-toggle`,
              align: `end`,
              order: 200,
              slotPosition: `right`,
              children: (0, $.jsx)(vn, {
                ...
                onClick: p,
                children: a
                  ? (0, $.jsx)(jn, { className: `icon-xs` })
                  : (0, $.jsx)(On, { className: `icon-xs` }),
              }),
            })
          : null,
      ],
...
function Er(e) {
  ...
  let {
      actions: a,
      hasOutputArtifacts: s,
      onOpenArtifact: c,
      outputArtifacts: l,
    } = Pn(i),
    u;
  t[2] === n ? (u = t[3]) : ((u = _e(n)), (t[2] = n), (t[3] = u));
  let d = H(u.tabs$).length,
    f = (0, Mr.useRef)(null);
  if (n === `right` && d === 0) return null;
  let p;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (e) => {
        let t = f.current;
        t != null && ((f.current = null), e.preventDefault(), t());
      }),
      (t[4] = p))
    : (p = t[4]);
  let m;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(Ke, { className: `icon-xs` })), (t[5] = m))
    : (m = t[5]);
  let h;
  t[6] === r
    ? (h = t[7])
...
function Dr() {
  ...
  return (
    e[4] !== n || e[5] !== i
      ? ((a = (0, $.jsx)(q.HeaderContextMenuItem, {
          checked: n,
...
function Or(e) {
  ...
  t[2] === i
    ? (s = t[3])
    : ((s = (0, $.jsx)(Ar, { browserConversationId: i })),
      (t[2] = i),
      (t[3] = s));
  let c;
  t[4] === o ? (c = t[5]) : ((c = null), (t[4] = o), (t[5] = c));
  let l;
  ...
  t[8] !== a || t[9] !== o
    ? ((d = o
        ? (0, $.jsxs)($.Fragment, {
            children: [
              (0, $.jsx)(q.RightPanelTabsEmptyState, {
                children: (0, $.jsx)(dr, {}),
              }),
              (0, $.jsx)(q.RightPanelTabListAfterSticky, {
                children: (0, $.jsx)(Er, {
                  target: `right`,
  ...
  return (
    t[12] !== s || t[13] !== c || t[14] !== d
      ? ((p = (0, $.jsxs)($.Fragment, { children: [s, c, l, u, d, f] })),
        (t[12] = s),
        (t[13] = c),
        (t[14] = d),
        (t[15] = p))
...
function kr() {
  let e = (0, Q.c)(16),
    ...
    r = H(Jt),
    i = H(Wt.tabs$).length,
    a = I(K, `toggleSidePanel`),
    o;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { target: `right` }), (e[0] = o))
    : (o = e[0]);
  let { actions: s } = Pn(o),
    c;
  e[1] !== s || e[2] !== r || e[3] !== i || e[4] !== t
    ? ((c = () => {
        if (!r && i === 0 && s.length === 1) {
          s[0]?.onSelect();
          return;
  ...
  e[6] === n
    ? (u = e[7])
    : ((u = n.formatMessage(Pr.toggleSidePanel)), (e[6] = n), (e[7] = u));
  let d;
  e[8] === r
    ? (d = e[9])
    : ((d = r
  ...
  let f;
  return (
    e[10] !== l || e[11] !== r || e[12] !== u || e[13] !== d || e[14] !== a
      ? ((f = (0, $.jsx)(vn, {
          label: u,
          pressed: r,
          shortcut: a,
...
function Ar(e) {
  ...
  let l = c,
    u;
  if (t[2] !== i || t[3] !== n || t[4] !== l || t[5] !== o) {
    let e = { bottom: i, right: o };
    ((u = ft.flatMap((t) =>
      e[t].map((e) => {
        let r = Je(e, n);
        return r == null
  ...
  return (
    t[7] === u
      ? (d = t[8])
      : ((d = (0, $.jsx)($.Fragment, { children: u })), (t[7] = u), (t[8] = d)),
    d
  );
}
function jr() {
  requestAnimationFrame(() => {
    let e = document.querySelector(Nr);
    e != null && $e(e);
  });
}
var Q,
  ...
  Fr = e(() => {
    ((Q = z()),
      ...
      Qe(),
      ($ = p()),
      (Nr = `[role="tabpanel"][data-app-shell-tab-panel-controller="bottom"]`),
      (Pr = M({
        toggleSidePanel: {
...
export { Fr as n, Nn as r, Cr as t };
//# sourceMappingURL=thread-app-shell-chrome-DLtp8zjL.js.map
