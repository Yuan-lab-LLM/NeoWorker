...
function P() {
  let e = (0, I.c)(39),
    ...
    a = o(),
    l = w(),
    { clearPendingAppConnect: u, getPendingAppConnectForCallbackUrl: d } = S(),
    {
      closePluginInstallAppConnectBeforeInstall: m,
      markRequiredAppStatus: h,
      session: _,
    } = s(),
    C = (0, L.useRef)(null),
    k;
  ...
  e[4] !== _.status
    ? ((k = (e) => {
        _.kind !== `connectAppBeforeInstall` ||
          _.connectMode !== `automatic` ||
          _.status !== `waitingForCallback` ||
          _.app.id !== e ||
          h({ appId: e, status: `launching` });
      }),
      (e[0] = h),
      (e[1] = _.app),
      (e[2] = _.connectMode),
  ...
  e[10] !== _.kind
    ? ((M = (e) => {
        ...
        if (!(
          ...
          if (n === `pending` && _.connectMode === `automatic`) {
            m();
            return;
          }
          h({ appId: _.app.id, status: n });
        }
      }),
      (e[6] = m),
      (e[7] = h),
  ...
  e[12] === t
    ...
    : ((P = (e) => {
        ...
        y(t, D, {
          action: j.CODEX_PLUGIN_ACTION_TYPE_CONNECT_CONNECTOR,
          connectorId: n,
          errorType: r,
          pluginId: i.pluginId,
  ...
  e[28] !== V
    ? ((H = () => {
        if (C.current === a.key) return;
        C.current = a.key;
        let e = c(a.state),
          t = e?.fullRedirectUrl?.trim(),
          n = t != null && t.length > 0 ? d(t) : null,
          o = n?.returnTo ?? e?.returnTo ?? `/skills`,
          s = n?.resumeTarget.kind === `plugin-install`,
          l =
            s &&
            (_.kind === `preparingApp` ||
              (_.kind === `connectAppBeforeInstall` && _.app.id !== n?.appId));
        if (n != null && l) {
        ...
        if (
          (V({
            ...
            (t != null &&
              ...
              e.kind === `success`
                ? N({ appId: e.appId, status: `connected` })
                : (s || n == null) &&
                  N({ appId: n?.appId, status: `pending` }));
          }),
          i(x, o) != null)
        ) {
          r(o, { replace: !0 });
...
//# sourceMappingURL=app-connect-oauth-callback-page-B7-7kV8L.js.map
