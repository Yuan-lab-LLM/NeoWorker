      ...
      switch (i.label) {
        case 0:
          ((n = R(t)),
            (o = z(n, a)),
            (s = p()),
            (c = `${s}/integrations/${o ?? n}/${r}/${o ?? n}.dynamic.js.gz`),
            (i.label = 1));
        case 1:
  ...
  return n(this, void 0, void 0, function () {
    ...
    return i(this, function (i) {
      return (
        ...
        (a = R(e)),
        (o = z(e, r)),
        (s = `${n}/integrations/${o ?? a}/${t}/${o ?? a}.dynamic.js.gz`),
        [2, v(s)]
      );
    });
  });
...
function Z(e, t, n, i, o, s) {
  if ((n === void 0 && (n = {}), i === void 0 && (i = {}), h())) return [];
            ...
            return i(this, function (i) {
              switch (i.label) {
                ...
                case 4:
                  return (
                    (n = a),
                    (this.integration = H(n, this.settings, t)),
                    [3, 6]
                  );
                case 5:
                  throw (
...
//# sourceMappingURL=ajs-destination-Dtfh1U4P.js.map
