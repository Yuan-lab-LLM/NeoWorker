...
import { n as k, t as nt } from "./home-suggestion-staggered-item-ClJ45CI3.js";
var rt,
  it = e(() => {
    rt = `` + new URL(`budget-planner-B_xX3PJl.xlsx`, import.meta.url).href;
  }),
  A,
  at = e(() => {
    A = `` + new URL(`content-calendar-D2hO7r4o.xlsx`, import.meta.url).href;
  }),
  j,
  M = e(() => {
    j = `` + new URL(`design-review-DfDJVwWu.pptx`, import.meta.url).href;
  }),
  N,
  P = e(() => {
    N = `` + new URL(`meeting-notes-hfgk-Kdr.docx`, import.meta.url).href;
  }),
  F,
  ot = e(() => {
    F =
  ...
  I,
  st = e(() => {
    I = `` + new URL(`budget-planner-DdzCe8wU.png`, import.meta.url).href;
  }),
  L,
  R = e(() => {
    L = `` + new URL(`content-calendar-Ct37j4gK.png`, import.meta.url).href;
  }),
  z,
  ct = e(() => {
    z = `` + new URL(`design-review-D5ZTsvgZ.png`, import.meta.url).href;
  }),
  B,
  V = e(() => {
    B = `` + new URL(`meeting-notes-HtllKJ8V.png`, import.meta.url).href;
  }),
  H,
  U = e(() => {
    H =
  ...
  W,
  G = e(() => {
    W = `` + new URL(`project-brief-bL95n3Ke.png`, import.meta.url).href;
  }),
  K,
  q = e(() => {
    K = `` + new URL(`project-tracker-BsrXHgJI.png`, import.meta.url).href;
  }),
  J,
  Y = e(() => {
    J = `` + new URL(`report-outline-CQViP9Z5.png`, import.meta.url).href;
  }),
  X,
  lt = e(() => {
    X = `` + new URL(`sales-discovery-CFt_AKqR.png`, import.meta.url).href;
  }),
  ut,
  dt = e(() => {
    ut = `` + new URL(`project-brief-Dgi4V0mX.docx`, import.meta.url).href;
  }),
  ft,
  pt = e(() => {
  ...
  mt,
  ht = e(() => {
    mt = `` + new URL(`report-outline-DUfNp9Wv.docx`, import.meta.url).href;
  }),
  gt,
  _t = e(() => {
    gt = `` + new URL(`sales-discovery-DI8H6s1v.pptx`, import.meta.url).href;
  });
function vt(e) {
  return yt.filter((t) => t.kind === e);
}
var yt,
  bt = e(() => {
    (y(),
...
function xt({ createTemplateCard: e, kind: t, onAttachTemplate: r }) {
  let i = ue(Ve),
    a = n(),
    o = Ee(),
    [s, c] = (0, St.useState)(null),
    l = t === `document` || t === `google-docs`,
    u = vt(t).slice(0, !l && e != null ? 2 : void 0),
    d = async (e) => {
      c(e.id);
      try {
        if ((await r(e)) == null) return;
        a.focus();
      } catch {
        i.get(de).danger(
          o.formatMessage({
                ...
                (0, Z.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, Z.jsx)(`div`, {
                      ...
                      children: (0, Z.jsx)(Ge, { className: `icon-lg` }),
                    }),
                  ],
                }),
                (0, Z.jsx)(`div`, {
...
function wt(e) {
  ...
  t[3] === o
    ? (c = t[4])
    : ((c = (0, Et.jsx)(`div`, { className: o, children: s })),
      (t[3] = o),
      (t[4] = c));
  let l;
  t[5] === r
...
function Ot(e) {
  let t = (0, Ft.c)(93),
    ...
    [se, ce] = (0, Q.useState)(!1),
    le = _(Fe),
    de = _(We),
    fe = _(he),
    [me] = c(`skills_refresh_nonce`),
    g = _(ve),
    ge = _(o),
    v = Ee(),
    y = Ne(f, Mt),
  ...
  t[0] === ge
    ? (Se = t[1])
    : ((Se = (e) => Be(e.view.state.doc, ge)), (t[0] = ge), (t[1] = Se));
  let Ce = Ne(f, Se),
    b = g && !y ? Ce : null,
    Oe = b != null,
    x;
  t[2] === Oe ? (x = t[3]) : ((x = { enabled: Oe }), (t[2] = Oe), (t[3] = x));
  let { isLoading: S, skills: C } = ye(le ?? void 0, de, x),
    Ae;
  t[4] !== C || t[5] !== b
    ? ((Ae = b == null ? [] : C), (t[4] = C), (t[5] = b), (t[6] = Ae))
    : (Ae = t[6]);
  let { data: je, isLoading: T } = ke(Ae, de, me),
    Ie = b == null || je == null ? [] : Te(C, b, je),
    { data: Le } = ae(Bt, {
      hostId: de,
      paths: Ie.map(jt),
      skillsRefreshNonce: me,
    }),
    E = Le == null ? Ie : ne(Ie, Le),
    Ve = (0, Q.useRef)(!1),
    Je,
    Ye;
  (t[7] !== S ||
  ...
  t[12] !== E.length
    ...
    (0, Q.useEffect)(Je, Ye));
  let Qe;
  t[15] === C ? (Qe = t[16]) : ((Qe = C.find(At)), (t[15] = C), (t[16] = Qe));
  let D = Qe != null && u,
    et = (0, Q.useRef)(null),
    O,
    tt;
  (t[17] !== p || t[18] !== b
    ? ((O = () => {
        b != null && et.current !== b && ((et.current = b), Me(p, b));
      }),
      (tt = [p, b]),
      (t[17] = p),
      (t[18] = b),
  ...
  if (t[21] !== D || t[22] !== E) {
    ...
    (t[24] === D
      ? (e = t[25])
      : ((e = D ? [`create-template`] : []), (t[24] = D), (t[25] = e)),
      (k = [...E.map(kt), ...e]),
      (t[21] = D),
      (t[22] = E),
      (t[23] = k));
...
`),
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((it = (e) => {
        let t = Pt(e);
        (oe(e.scrollLeft > 1), ce(e.scrollLeft < t - 1));
      }),
      (t[26] = it))
    : (it = t[26]);
  let A = De(it),
  ...
  t[27] !== rt || t[28] !== A
    ? ((at = (e) => {
        if (
          ...
          (m.current = e),
          e == null || rt === `` || (A(e), typeof ResizeObserver > `u`))
        )
          return;
        let t = new ResizeObserver(() => A(e));
        (t.observe(e),
  ...
  t[30] !== f || t[31] !== p || t[32] !== v
    ? ((F = (e) => {
        ...
        if (o === -1) {
          (f.insertSkillMentionAtSelection(e),
            f.insertTextAtSelection(a),
            qe(p, e));
          return;
        }
        let s = a.slice(0, o),
          c = a
            .slice(o + 35)
            .replaceAll(`__CODEX_TEMPLATE_NAME_PLACEHOLDER__`, () => $e(e));
        (f.insertTextAtSelection(s), f.insertSkillMentionAtSelection(e));
        let { state: l, dispatch: u } = f.view,
          d = l.selection.from - 1,
          m = l.tr.insertText(c, d, l.selection.from);
        (m.setSelection(Ke.create(m.doc, d + c.length)), u(m), qe(p, e));
      }),
      (t[30] = f),
      (t[31] = p),
      (t[32] = v),
  ...
  let ot = F,
    I;
  t[34] !== f || t[35] !== p || t[36] !== v || t[37] !== b
    ? ((I = () => {
        (Pe(p, Lt),
          f.appendPromptText(v.formatMessage(Vt[b], { templateCreator: Rt })));
      }),
      (t[34] = f),
      (t[35] = p),
      (t[36] = v),
  ...
  let st = I,
    L;
  t[39] !== D || t[40] !== v || t[41] !== M || t[42] !== st
    ? ((L = D
        ? (0, $.jsx)(wt, {
            isDocumentTemplates: M,
  ...
  t[44] !== fe || t[45] !== A
    ? ((z = (e) => {
        ...
        if (t == null) return;
        let n = Pt(t),
          r = Number.parseFloat(getComputedStyle(t).scrollPaddingLeft),
          i = (0, It.default)(
            t.scrollLeft + e * (t.clientWidth - (Number.isNaN(r) ? 0 : r)),
            0,
            n,
          );
        if (
          (re.current?.stop(), t.style.removeProperty(`scroll-snap-type`), fe)
        ) {
          (t.scrollTo({ left: i }), A(t));
          return;
        }
        ((t.style.scrollSnapType = `none`),
          (re.current = _e(t.scrollLeft, i, {
            duration: 0.2,
          ...
          ? (0, $.jsxs)($.Fragment, {
              children: [
                ...
                (0, $.jsx)(Re, {
                  ...
                  size: `toolbar`,
                  uniform: !0,
                  children: (0, $.jsx)(ee, { className: `icon-xs` }),
                }),
              ],
            })
          : null),
  ...
  t[56] === p
    ? (U = t[57])
    : ((U = () => {
        (Ze(p, te.CODEX_ARTIFACT_TEMPLATE_CAROUSEL_DISMISS_REASON_CLOSE_BUTTON),
          ze(p));
      }),
      (t[56] = p),
      (t[57] = U));
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, $.jsx)(xe, { className: `icon-xs` })), (t[58] = W))
    : (W = t[58]);
  let G;
  t[59] !== H || t[60] !== U
    ? ((G = (0, $.jsx)(Re, {
  ...
  t[72] !== E.length
    ? ((q =
        E.length === 0 && !S && !T && u && a != null
          ? (0, $.jsx)(xt, {
              createTemplateCard: R,
              kind: b,
              onAttachTemplate: async (e) => {
                let t = p.get(Xe),
                  n = await a({ assetUrl: e.assetUrl, label: e.filename });
                return n == null
                  ? null
                  : (Ue(p, {
                      attachmentPath: n.path,
                      journey: t,
                      templateId: e.id,
                    }),
                    n);
                    ...
                    nt,
                    {
                      ...
                      children: (0, $.jsxs)(`button`, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(`div`, {
                            className: `min-w-0 -translate-y-0.5 truncate pr-2 pb-1 pl-0 text-xs leading-4 font-normal tracking-normal text-token-text-secondary group-hover:text-token-text-primary group-focus-visible:text-token-text-primary`,
                            children: n,
                          }),
                        ],
                      }),
...
function Mt(e) {
  return D(e.view.state);
}
function Nt(e) {
  let t = zt.get(e);
  if (t != null) return t;
  let n = Oe(e, { size: `large` });
  return (zt.set(e, n), n);
}
function Pt(e) {
  return Math.max(0, e.scrollWidth - e.clientWidth);
}
var Ft, It, Q, $, Lt, Rt, zt, Bt, Vt;
e(() => {
  ((Ft = ce()),
    Se(),
    O(),
    ...
    Dt(),
    ($ = u()),
    (Lt = `plugin://template-creator@openai-primary-runtime`),
    (Rt = `[@Template Creator](${Lt})`),
    (zt = new WeakMap()),
    (Bt = x(Ve, ({ hostId: e, paths: t, skillsRefreshNonce: n }) => ({
      queryKey: [`artifact-template-skill-updates`, e, n, ...t],
      queryFn: async ({ signal: n }) => {
        let r = await Promise.all(
          t.map(async (t) => {
            try {
              let { mtimeMs: r } = await Je(`read-file-metadata`, {
...
export { Ot as ArtifactTemplatePicker };
//# sourceMappingURL=home-artifact-templates-CFYRLcto.js.map
