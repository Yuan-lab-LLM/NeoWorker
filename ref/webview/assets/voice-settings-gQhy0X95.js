...
import { n as $e, t as et } from "./hotkey-setter-S1Vpy1pX.js";
function tt({
  initialVoice: e,
  onOpenChange: t,
  onSave: n,
  ...
  return (0, J.jsx)(g, {
    ...
    dialogCloseLabel: s.formatMessage({
...
function rt() {
  let e = (0, ot.c)(40),
    ...
    c;
  e[0] !== a || e[1] !== n
    ? ((c = { enabled: n, hostId: a }), (e[0] = a), (e[1] = n), (e[2] = c))
    : (c = e[2]);
  let { data: l, error: u, refetch: f } = R(Ne(se, c)),
    [p, m] = (0, st.useState)(!1),
    g;
  e[3] === l
    ? (g = e[4])
    : ((g = l?.voices.find((e) => e.slug === l.effectiveVoiceSlug)),
      (e[3] = l),
      (e[4] = g));
  let _ = g,
    v = u != null || l?.accountVoiceStatus === `unavailable`;
  if (!n) return null;
  let b;
  if (v) {
    let t;
  ...
  let E;
  e[29] !== T || e[30] !== b
    ? ((E = (0, Y.jsx)(H, { label: S, description: T, control: b })),
      (e[29] = T),
      (e[30] = b),
      (e[31] = E))
    : (E = e[31]);
    ...
    e[37] !== E || e[38] !== k
      ? ((j = (0, Y.jsxs)(K, {
          children: [
            x,
            (0, Y.jsx)(K.Content, {
              children: (0, Y.jsxs)(U, { children: [E, O, k] }),
            }),
          ],
        })),
        (e[37] = E),
...
function it() {
  ...
  e[2] === t
    ...
    : ((o = (e) => {
        if (!e) {
          M(t, ct.screenContextEnabled, !1);
          return;
        }
        ie(t, () => {
          M(t, ct.screenContextEnabled, !0);
        });
      }),
      (e[2] = t),
      (e[3] = o));
  ...
  return (
    e[6] !== r || e[7] !== o || e[8] !== s
      ? ((c = (0, Y.jsx)(H, {
          label: i,
          description: a,
          control: (0, Y.jsx)(Xe, { checked: r, onChange: o, ariaLabel: s }),
        })),
        (e[6] = r),
        (e[7] = o),
        (e[8] = s),
...
function at() {
  let e = (0, ot.c)(40),
    ...
    { data: o } = R(S),
    [s, c] = (0, st.useState)(!1),
    [l, u] = (0, st.useState)(null),
    d;
  e[0] !== a || e[1] !== r
    ? ((d = {
        onSuccess: (e) => {
          let t = E(`codex-command-keymap-state`);
          (r.setQueryData(t, e), a(t));
        },
      }),
      (e[0] = a),
      (e[1] = r),
      (e[2] = d))
    : (d = e[2]);
  let p = i(`set-codex-command-keybinding`, d),
    m;
  e[3] !== t || e[4] !== p
    ? ((m = async function (e) {
        u(null);
  ...
  let g, _;
  e[6] !== o || e[7] !== n
    ? ((g = pe(`realtimeVoice`, o, n)[0]?.accelerator ?? null),
      (_ = g == null ? null : we(g)),
      (e[6] = o),
      (e[7] = n),
      (e[8] = g),
  ...
  return (
    e[37] !== P || e[38] !== C
      ? ((F = (0, Y.jsx)(H, { label: y, description: C, control: P })),
        (e[37] = P),
        (e[38] = C),
        (e[39] = F))
      : (F = e[39]),
...
var dt,
  ...
  pt = e(() => {
    (j(),
      Pe(),
      ge(),
      (dt = fe(G, `global-dictation-history`, { staleTime: Ce.FIVE_SECONDS })),
      (ft = fe(G, `global-dictation-hotkey-state`, {
...
function mt() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsxs)(K, {
        children: [
          a,
          (0, Q.jsx)(K.Content, {
            children: (0, Q.jsx)(U, { children: (0, Q.jsx)(ht, {}) }),
          }),
        ],
      })),
      (s = (0, Q.jsx)(rt, {})),
  ...
  return (
    e[7] === c
      ...
      : ((l = (0, Q.jsx)(Ae, {
          title: i,
          children: (0, Q.jsxs)(oe, { electron: !0, children: [o, s, c] }),
        })),
        (e[7] = c),
        (e[8] = l)),
    l
...
function ht() {
  ...
  if (e[1] !== o.data || e[2] !== n || e[3] !== r) {
    ...
    ((e[1] = o.data),
      ...
      (e[5] = c),
      (e[6] = u));
  } else ((s = e[4]), (c = e[5]), (u = e[6]));
  let d;
  e[15] === o
    ? (d = e[16])
    : ((d = async function () {
        (await re.systemPermissions?.requestMicrophoneAccess(),
          await o.refetch());
      }),
      (e[15] = o),
      (e[16] = d));
  ...
  e[21] === c
    ...
    : ((g = (0, Q.jsx)(T, {
        disabled: !i,
        children: (0, Q.jsx)(`span`, { className: `truncate`, children: c }),
      })),
      (e[21] = c),
      (e[22] = g));
  let _ = r == null ? Ve : void 0,
    y;
  e[23] === t
    ? (y = e[24])
    : ((y = () => {
        M(t, l.microphoneInputDeviceId, null);
      }),
      (e[23] = t),
      (e[24] = y));
  let b;
  e[25] !== u || e[26] !== _ || e[27] !== y
    ? ((b = (0, Q.jsx)(B.Item, { RightIcon: _, onSelect: y, children: u })),
      (e[25] = u),
      (e[26] = _),
      (e[27] = y),
      (e[28] = b))
  ...
  e[29] === s.length
    ? (x = e[30])
    : ((x = s.length > 0 ? (0, Q.jsx)(B.Separator, {}) : null),
      (e[29] = s.length),
      (e[30] = x));
  let S;
    ...
    (e[36] !== n || e[37] !== t || e[38] !== r
      ? ((i = (e, i) => {
          ...
          return (0, Q.jsx)(
            B.Item,
            {
              RightIcon: e.deviceId === r ? Ve : void 0,
              onSelect: () => {
                M(t, l.microphoneInputDeviceId, e.deviceId);
              },
              children: a,
            },
            e.deviceId,
              ...
              children: r
                ? (0, Q.jsxs)(Q.Fragment, {
                    children: [
                      ...
                      (0, Q.jsx)(U, { children: (0, Q.jsx)(bt, {}) }),
                      (0, Q.jsx)(U, { children: (0, Q.jsx)(Et, {}) }),
                    ],
                  })
                : (0, Q.jsx)(U, {
                    children: (0, Q.jsx)(be, {
...
function yt(e) {
  ...
  t[0] !== o || t[1] !== a
    ? ((s = {
        onSuccess: (e) => {
          let t = E(`global-dictation-hotkey-state`);
      ...
      (t[2] = s))
    : (s = t[2]);
  let c = i(`global-dictation-set-keep-visible`, s),
    l,
    u;
...
function bt() {
  let e = (0, X.c)(17),
    t = P(G),
    n = V(),
    r = F(l.dictationDictionary),
    [i, a] = (0, Z.useState)(null),
    o = (0, Z.useRef)(!1),
    s = i ?? r,
    u = s != null && s.length > 0 ? s : At,
    d;
  e[0] === t
    ? (d = e[1])
    : ((d = async function (e) {
        let n = e.map(wt).filter(Ct);
        (await M(t, l.dictationDictionary, n), a(null));
      }),
      (e[0] = t),
      (e[1] = d));
  let f = d,
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Q.jsx)(Se, { className: `icon-2xs` })),
      (_ = (0, Q.jsx)(z, {
...
function Tt(e) {
    ...
    ? ((m = {
        onSuccess: (e) => {
          ...
          (s.setQueryData(t, e.state),
            Promise.all([c(t), c(E(`codex-command-keymap-state`))]));
        },
      }),
      (t[0] = c),
      (t[1] = s),
  ...
  t[7] === v
    ? (y = t[8])
    : ((y = v == null ? null : we(v)), (t[7] = v), (t[8] = y));
  let b = y,
    x;
  t[9] !== o || t[10] !== a
    ? ((x = a
  ...
  t[15] === a
    ? (T = t[16])
    : ((T = a
        ? (0, Q.jsx)(z, { ...$.toggleDictationHotkey })
        : (0, Q.jsx)(z, { ...$.holdToDictateHotkey })),
      (t[15] = a),
      (t[16] = T));
  let D;
  t[17] === a
  ...
  return (
    t[41] !== I || t[42] !== T || t[43] !== k
      ? ((L = (0, Q.jsx)(H, { label: T, description: k, control: I })),
        (t[41] = I),
        (t[42] = T),
        (t[43] = k),
        (t[44] = L))
...
function Et() {
  let e = (0, X.c)(12),
    t = V(),
    { data: n } = R(dt),
    r = i(`global-dictation-copy-history-item`),
    a,
    o;
  if (e[0] !== r || e[1] !== n?.items || e[2] !== t) {
    o = Symbol.for(`react.early_return_sentinel`);
    bb0: {
      let i = n?.items.filter(Dt).slice(0, 4);
    ...
    ((e[0] = r), (e[1] = n?.items), (e[2] = t), (e[3] = a), (e[4] = o));
  } else ((a = e[3]), (o = e[4]));
  ...
  return (
    e[10] === a
      ? (s = e[11])
      : ((s = (0, Q.jsx)(Q.Fragment, { children: a })),
        (e[10] = a),
        (e[11] = s)),
    s
  );
...
function Ot(e) {
  let t = (0, X.c)(21),
    { copyDisabled: n, item: r, onCopy: i, timestamp: o } = e,
    s = V(),
    c;
  t[0] === s
    ? (c = t[1])
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, Q.jsx)(a, { className: `icon-sm` })), (t[9] = p))
    : (p = t[9]);
  let m;
  ...
  let h;
  t[14] !== l || t[15] !== m
    ? ((h = (0, Q.jsx)(x, { tooltipContent: l, children: m })),
      (t[14] = l),
      (t[15] = m),
      (t[16] = h))
    : (h = t[16]);
...
//# sourceMappingURL=voice-settings-gQhy0X95.js.map
