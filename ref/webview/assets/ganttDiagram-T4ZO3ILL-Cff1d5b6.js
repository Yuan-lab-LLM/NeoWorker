...
import { a as S, i as C, r as w, t as T } from "./src-D1Kyl_w4.js";
import { t as E } from "./dist-BNkeg5V9.js";
import { i as D, n as O, o as k, r as A } from "./chunk-AGHRB4JF-COxpu2PX.js";
import {
  A as j,
  C as M,
  G as ee,
...
import { g as ce, u as le } from "./chunk-5PVQY5BW-DfdH3lpT.js";
var ue = n((e, t) => {
    (function (n, r) {
...
` +
    ...
    (Tt = {
      ...
      renderer: {
        setConf: St,
        draw: O(function (e, t, n, a) {
          let o = N().gantt;
          a.db.setDiagramId(t);
          let s = N().securityLevel,
            c;
          s === `sandbox` && (c = w(`#i` + t));
          let p = w(
              s === `sandbox` ? c.nodes()[0].contentDocument.body : `body`,
            ),
            m = s === `sandbox` ? c.nodes()[0].contentDocument : document,
            y = m.getElementById(t);
          ((Q = y.parentElement.offsetWidth),
            Q === void 0 && (Q = 1200),
            o.useWidth !== void 0 && (Q = o.useWidth));
          let T = a.db.getTasks(),
            E = [];
          ...
          let k = {},
            A = 2 * o.topPadding;
          if (
            a.db.getDisplayMode() === `compact` ||
            o.displayMode === `compact`
          ) {
            let e = {};
            for (let t of T)
              e[t.section] === void 0
            ...
            for (let n of Object.keys(e)) {
              let r = wt(e[n], t) + 1;
              ((t += r), (A += r * (o.barHeight + o.barGap)), (k[n] = r));
            }
          } else {
            A += T.length * (o.barHeight + o.barGap);
          ...
          let j = p.select(`[id="${t}"]`),
            M = d()
              ...
              .rangeRound([0, Q - o.leftPadding - o.rightPadding]);
          function ee(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
          ...
          (O(ee, `taskCompare`),
            T.sort(ee),
            te(T, Q, A),
            ae(j, A, Q, o.useMaxWidth),
            j
              .append(`text`)
              .text(a.db.getDiagramTitle())
              .attr(`x`, Q / 2)
              .attr(`y`, o.titleTopMargin)
          ...
          function te(e, t, n) {
            let r = o.barHeight,
              ...
              l = b()
                ...
                .range([`#00B9FA`, `#F95002`])
                .interpolate(u);
            (re(i, s, c, t, n, e, a.db.getExcludes(), a.db.getIncludes()),
              se(c, s, t, n),
              ne(e, i, s, c, r, l, t, n),
              ce(i, s, c, r, l),
              le(c, s, t, n));
          ...
          function ne(e, n, r, i, s, c, l) {
            ...
            j.append(`g`)
              ...
              .attr(`width`, function () {
                return l - o.rightPadding / 2;
              })
              .attr(`height`, n)
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e.type === n)
                    return `section section` + (t % o.numberSectionStyles);
            ...
            if (
              (d
                ...
                .attr(`y`, function (e, t) {
                  return (
                    (t = e.order),
                    e.vert ? o.gridLineStartPadding : t * n + r
                  );
                })
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? T.length * (o.barHeight + o.barGap) + o.barHeight * 2
                    : s;
                })
                ...
                .attr(`class`, function (e) {
                  ...
                  for (let [t, r] of E.entries())
                    e.type === r && (n = t % o.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (M(e.endTime) - M(e.startTime)) - 0.5 * s),
                      (n = t + s)),
                    e.vert)
                  )
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? o.gridLineStartPadding +
                        T.length * (o.barHeight + o.barGap) +
                        60
                    : ((t = e.order),
                      t * n + o.barHeight / 2 + (o.fontSize / 2 - 2) + r);
                })
                .attr(`text-height`, s)
                .attr(`class`, function (e) {
                  let t = M(e.startTime),
                  ...
                  let a = 0;
                  for (let [t, n] of E.entries())
                    e.type === n && (a = t % o.numberSectionStyles);
                  let c = ``;
                  return (
                    e.active &&
                      (c = e.crit ? `activeCritText` + a : `activeText` + a),
                    e.done
                      ? (c = e.crit
                          ? c + ` doneCritText` + a
                          : c + ` doneText` + a)
                      : e.crit && (c = c + ` critText` + a),
                    ...
                    r > n - t
                      ? n + r + 1.5 * o.leftPadding > l
                        ...
                        : i +
                          ...
                          ` width-` +
                          r
                      : i + ` taskText taskText` + a + ` ` + c + ` width-` + r
                  );
                }),
          ...
          function re(e, n, r, i, s, c, l, u) {
            ...
            let p = a.db.getDateFormat(),
              m = [],
              h = null,
              g = (0, F.default)(d);
            for (; g.valueOf() <= f;)
              (a.db.isInvalidDate(g, p, l, u)
                ? h
                  ? (h.end = g)
                  : (h = { start: g, end: g })
                : (h &&= (m.push(h), null)),
            ...
            j.append(`g`)
              ...
              .attr(`y`, o.gridLineStartPadding)
              .attr(
                `width`,
                (e) => M(e.end.endOf(`day`)) - M(e.start.startOf(`day`)),
              )
              .attr(`height`, s - n - o.gridLineStartPadding)
          ...
          function se(e, t, n, i) {
            let s = a.db.getDateFormat(),
              c = a.db.getAxisFormat(),
              u;
            u = c || (s === `D` ? `%d` : (o.axisFormat ?? `%Y-%m-%d`));
            let d = C(M)
                .tickSize(-i + t + o.gridLineStartPadding)
                .tickFormat(l(u)),
              p =
                /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
                  a.db.getTickInterval() || o.tickInterval,
                );
            if (p !== null) {
              let e = parseInt(p[1], 10);
              if (isNaN(e) || e <= 0)
                D.warn(
                  `Invalid tick interval value: "${p[1]}". Skipping custom tick interval.`,
                );
              else {
                let t = p[2],
                  n = a.db.getWeekday() || o.weekday,
                  i = M.domain(),
                  s = i[0],
                  c = i[1],
                  l = ie(s, c, e, t);
                if (l > $)
                  D.warn(
                    `The tick interval "${e}${t}" would generate ${l} ticks, which exceeds the maximum allowed (${$}). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                  );
                else
                  switch (t) {
                    case `millisecond`:
            ...
            if (
              (j
                .append(`g`)
                .attr(`class`, `grid`)
                .attr(`transform`, `translate(` + e + `, ` + (i - 50) + `)`)
                .call(d)
                .selectAll(`text`)
            ...
            j.append(`g`)
              ...
              .append(function (e) {
                let t = e[0].split(oe.lineBreakRegex),
                  n = -(t.length - 1) / 2,
                  r = m.createElementNS(`http://www.w3.org/2000/svg`, `text`);
                r.setAttribute(`dy`, n + `em`);
                for (let [e, n] of t.entries()) {
                  let t = m.createElementNS(
              ...
              .attr(`font-size`, o.sectionFontSize)
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e[0] === n)
                    return (
                      `sectionTitle sectionTitle` + (t % o.numberSectionStyles)
                    );
                return `sectionTitle`;
              });
          }
          O(ce, `vertLabels`);
          function le(e, t, n, r) {
            let i = a.db.getTodayMarker();
            if (i === `off`) return;
            let s = j.append(`g`).attr(`class`, `today`),
              c = new Date(),
              l = s.append(`line`);
            (l
              .attr(`x1`, M(c) + e)
              .attr(`x2`, M(c) + e)
              .attr(`y1`, o.titleTopMargin)
              .attr(`y2`, r - o.titleTopMargin)
              .attr(`class`, `today`),
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-Cff1d5b6.js.map
