...
import { n as dn, t as fn } from "./codex-avatar-rFd6-NsG.js";
import { i as pn, r as mn } from "./custom-avatars-query-mkYIdPJ1.js";
function hn() {
  let e = (0, _n.c)(20),
    t = fe(bt),
    r = Ve(),
    { accountId: i, authMethod: a, userId: o } = ve(),
    { data: s } = n(),
    c;
  e[0] !== i || e[1] !== s
    ? ((c = s?.id === i ? g(s.structure) : null),
      (e[0] = i),
      (e[1] = s),
      (e[2] = c))
    : (c = e[2]);
  let l = c,
    u;
  e[3] !== i || e[4] !== l || e[5] !== r.locale || e[6] !== o
    ? ((u = { accountId: i, context: l, locale: r.locale, userId: o }),
      (e[3] = i),
      (e[4] = l),
      (e[5] = r.locale),
      (e[6] = o),
  ...
  let f = u,
    p = a === `chatgpt`,
    h;
  e[8] === p ? (h = e[9]) : ((h = { enabled: p }), (e[8] = p), (e[9] = h));
  let { data: _ } = se(d, f, h),
    v = a === `chatgpt`,
    y;
  e[10] === v ? (y = e[11]) : ((y = { enabled: v }), (e[10] = v), (e[11] = y));
  let { data: b, isError: x } = se(St, f, y),
    S = b ?? _;
  if (a !== `chatgpt` || l == null || x || S?.should_show !== !0) return null;
  let C = b == null,
    w;
  e[12] !== l || e[13] !== S || e[14] !== t
    ? ((w = () => {
        It(t, m, { context: l, eligibility: S });
      }),
      (e[12] = l),
      (e[13] = S),
      (e[14] = t),
  ...
  let T;
  return (
    e[16] !== l || e[17] !== C || e[18] !== w
      ? ((T = (0, vn.jsx)(gn, { context: l, loading: C, onClick: w })),
        (e[16] = l),
        (e[17] = C),
        (e[18] = w),
        (e[19] = T))
...
function gn(e) {
  ...
  t[0] === r
    ? (o = t[1])
    : ((o = r
        ? (0, vn.jsx)(tt, { as: `span`, className: `icon-xs` })
...
function Sn(e) {
  ...
  t[2] === s
    ? (c = t[3])
    : ((c = rt(`shrink-0 tabular-nums`, s)), (t[2] = s), (t[3] = c));
  let l;
  t[4] === a
    ? (l = t[5])
    : ((l = (0, J.jsx)(`span`, {
  ...
  switch (n) {
    ...
    case `ultra`: {
      ...
      return (
        t[0] === n
          ? (e = t[1])
          : ((e = (0, J.jsx)(Ft, { effort: n })), (t[0] = n), (t[1] = e)),
        e
      );
    }
    default: {
...
function En(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o =
        a === `plugin`
          ? (0, jn.createElement)(ue, {
              "aria-hidden": !0,
              className: `icon-sm`,
            })
          : (0, jn.createElement)(Ye(null, { fallbackName: n }), {
              className: `icon-sm`,
            })),
      (t[0] = n),
      (t[1] = a),
  ...
  if (r == null) {
    ...
    if (t[7] !== n || t[8] !== i || t[9] !== a) {
      ...
      bb0: {
        let t = x(i?.split(`@`)[0] ?? (a === `skill` ? n.split(`:`)[0] : n));
        if (t != null) {
...
function Ln(e) {
  ...
  t[0] === o
    ? (m = t[1])
    : ((m = o == null ? 1 : zn(o.naturalWidth, o.naturalHeight)),
      (t[0] = o),
      (t[1] = m));
  let h = m,
    g = o == null ? 1 : o.zoom / h,
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Y.jsx)(Ce, { title: (0, Y.jsx)(K, { ...ir.title }) })),
      (t[17] = E))
    : (E = t[17]);
  let D;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = { maxWidth: Xn }), (t[18] = D))
    : (D = t[18]);
  let O;
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = (0, Y.jsx)(Fn, { className: `icon-sm` })), (t[48] = ie))
    : (ie = t[48]);
  let ae;
  t[49] !== R || t[50] !== ne || t[51] !== z
    ? ((ae = (0, Y.jsx)(q, {
        "aria-label": R,
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ue = (0, Y.jsx)(Et, { className: `icon-sm` })), (t[67] = ue))
    : (ue = t[67]);
  let de;
  t[68] !== ce || t[69] !== H || t[70] !== le
    ? ((de = (0, Y.jsx)(q, {
        "aria-label": ce,
        className: `!size-5 !p-0`,
        color: `ghost`,
  ...
  let ge;
  t[86] !== W || t[87] !== G
    ? ((ge = (0, Y.jsxs)(re, { children: [W, G] })),
      (t[86] = W),
      (t[87] = G),
      (t[88] = ge))
    : (ge = t[88]);
  let _e;
  t[89] !== L || t[90] !== fe || t[91] !== U || t[92] !== ge || t[93] !== C
    ? ((_e = (0, Y.jsxs)(A, {
        as: `form`,
        className: `gap-5`,
        onSubmit: C,
        children: [w, T, E, L, fe, U, ge],
      })),
      (t[89] = L),
      (t[90] = fe),
      (t[91] = U),
...
async function Rr(e) {
  if (!Br(e)) return null;
  try {
    let t = await Kt.getInstance().get(e),
      n = _i.parse(t.body);
    return await zr(
...
var Hr,
  ...
  vi = e(() => {
    (mt(),
      ...
      (_i = $e({ base64: an().min(1), contentType: an() })));
  }),
  yi,
  bi,
  xi = e(() => {
...
function Oi(e) {
  ...
  let A;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, X.jsx)(ke, { "aria-hidden": !0, className: `icon-sm` })),
      (t[14] = A))
    : (A = t[14]);
  let te;
  t[15] !== O || t[16] !== k
  ...
  t[19] === M
    ? (N = t[20])
    : ((N = rt(`flex flex-col items-center`, M)), (t[19] = M), (t[20] = N));
  let P;
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (P = t[21]);
  let F;
  t[22] !== T || t[23] !== _ || t[24] !== v
    ? ((F = { rotateX: _, rotateY: v, width: T }),
      (t[22] = T),
      (t[23] = _),
      (t[24] = v),
      (t[25] = F))
  ...
  let L;
  t[29] !== F || t[30] !== I
    ? ((L = (0, X.jsx)(ct.div, { className: P, style: F, children: I })),
      (t[29] = F),
      (t[30] = I),
      (t[31] = L))
    : (L = t[31]);
  ...
  t[41] === re
    ? (ie = t[42])
    : ((ie = rt(`flex items-start justify-center gap-2 sm:gap-5`, re)),
      (t[41] = re),
      (t[42] = ie));
  let ae;
  t[43] === m
  ...
  let ce;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (0, X.jsx)(Ei, { "aria-hidden": !0, className: `icon-sm` })),
      (t[48] = ce))
    : (ce = t[48]);
  let H;
  t[49] !== ae || t[50] !== oe || t[51] !== se || t[52] !== V
    ? ((H = (0, X.jsx)(ki, {
        ariaLabel: ae,
        active: oe,
        disabled: se,
  ...
  t[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (0, X.jsx)(bi, { "aria-hidden": !0, className: `icon-sm` })),
      (t[59] = pe))
    : (pe = t[59]);
  let W;
  t[60] !== le || t[61] !== ue || t[62] !== de || t[63] !== U
    ? ((W = (0, X.jsx)(ki, {
        ariaLabel: le,
        active: ue,
        disabled: de,
  ...
  t[70] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ve = (0, X.jsx)(Ci, { "aria-hidden": !0, className: `icon-sm` })),
      (t[70] = ve))
    : (ve = t[70]);
  let ye;
  t[71] !== me || t[72] !== he || t[73] !== G || t[74] !== _e
    ? ((ye = (0, X.jsx)(ki, {
        ariaLabel: me,
        active: he,
        disabled: G,
  ...
  let xe = r || n == null,
    Se;
  t[78] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, X.jsx)(je, { "aria-hidden": !0, className: `icon-sm` })),
      (t[78] = Se))
    : (Se = t[78]);
  let Ce;
  ...
  t[80] !== l || t[81] !== be || t[82] !== xe
    ...
    : (we = t[83]);
  let Te;
  t[84] !== ie || t[85] !== H || t[86] !== W || t[87] !== ye || t[88] !== we
    ? ((Te = (0, X.jsxs)(`div`, { className: ie, children: [H, W, ye, we] })),
      (t[84] = ie),
      (t[85] = H),
      (t[86] = W),
      (t[87] = ye),
  ...
  t[96] === Ee
    ? (De = t[97])
    : ((De = (0, X.jsx)(dt, { children: Ee })), (t[96] = Ee), (t[97] = De));
  let Oe;
  t[98] !== N || t[99] !== z || t[100] !== Te || t[101] !== De
    ? ((Oe = (0, X.jsxs)(`div`, {
        className: `flex min-h-fit flex-col items-center`,
        children: [
          j,
          (0, X.jsxs)(`div`, { className: N, children: [z, Te, De] }),
        ],
      })),
      (t[98] = N),
      (t[99] = z),
  ...
  let Ne;
  return (
    t[106] !== d || t[107] !== i || t[108] !== Me || t[109] !== te
      ? ((Ne = (0, X.jsxs)(ee, {
          open: i,
...
function Ai(e) {
  ...
  t[9] === g
    ? (_ = t[10])
    : ((_ = rt(`truncate text-xs leading-4 font-medium`, g)),
      (t[9] = g),
      (t[10] = _));
  let v;
  t[11] !== a || t[12] !== _
...
function ji(e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, X.jsx)(ke, { "aria-hidden": !0, className: `icon-xs` })),
      (t[10] = h))
    : (h = t[10]);
  let g;
  t[11] !== a || t[12] !== m
  ...
  let y, x;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, X.jsx)(c, { "aria-hidden": !0, className: `icon-xs` })),
      (y = (0, X.jsx)(K, {
  ...
  t[26] === f
    ? (T = t[27])
    : ((T = (0, X.jsx)(b, { href: f, className: `icon-xs` })),
      (t[26] = f),
      (t[27] = T));
  let E;
  t[28] === u
  ...
  return (
    t[38] !== O || t[39] !== _
      ? ((k = (0, X.jsxs)(X.Fragment, { children: [_, O] })),
        (t[38] = O),
        (t[39] = _),
        (t[40] = k))
      : (k = t[40]),
...
function Gi({
  ...
  let l = fe(bt),
    ...
    A = (e, t) => {
      ...
      ze(l, xe, { action: e, socialPlatform: Ji(t) });
    },
    te = () => {
      ...
      return {
        ...
        stats: [
          ...
          },
          {
            ...
            value: Se(u, o.currentStreakDays),
          },
          {
            label: u.formatMessage({
            ...
            value: Se(u, o.longestStreakDays),
          },
        ],
        theme: fr(),
        usernameLabel: r,
    ...
    j = async (e, t) => {
      let n = await Ki(e);
      T.current === t && g({ blob: e, imageUrl: n });
    },
    M = async (e, { clearPreview: t, showLoadingState: n, requestId: r }) => {
      (n && f(!0), t && g(null));
      try {
        await j(await pr({ ...te(), pet: e }), r);
      } catch {
        if (T.current !== r) return;
        (m(!1), w(null), l.get(U).danger(D));
      } finally {
        n && T.current === r && f(!1);
      }
    },
    N = async (
      ...
      try {
        ...
        (t ?? w(n), await j(await n.createImageBlob(e), i));
      } catch {
        if (T.current !== i) return;
        (m(!1), w(null), l.get(U).danger(D));
      } finally {
    ...
    P = () => {
      ...
      (m(!0), v(null), w(null), b(t === -1 ? null : t), S(t !== -1));
      let n = r[t];
      if (n == null) {
        M(null, { clearPreview: !0, requestId: e, showLoadingState: !0 });
        return;
      }
      N(n, null, { clearPreview: !0, requestId: e, showLoadingState: !0 });
    },
    F = (e) => {
      let t = r[e];
      if (t == null) return;
      ...
      (b(e),
        S(!0),
        N(t, C, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    I = (e) => {
      let t = y == null ? null : r[y];
      if (e && t == null) return;
      T.current += 1;
      let n = T.current;
      (S(e),
  ...
  return (0, Xi.jsxs)(Xi.Fragment, {
    children: [
      (0, Xi.jsxs)(q, {
        ...
        size: `toolbar`,
        onClick: () => {
          (A(Ze.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), P());
        },
        children: [
          (0, Xi.jsx)(Jt, { "aria-hidden": !0, className: `icon-xs` }),
          (0, Xi.jsx)(K, {
      ...
      (0, Xi.jsx)(Oi, {
        ...
        petSwitcher:
          y == null || r.length === 0
            ...
            : {
                ...
                isPetVisible: x,
                petCount: r.length,
                petName: r[y]?.displayName ?? ``,
                petPosition: y + 1,
                onNext: () => {
                  F((y + 1) % r.length);
                },
                onPrevious: () => {
                  F((y - 1 + r.length) % r.length);
                },
        ...
        getSocialDraftUrl: (e) => qi(e, k),
        onCopy: () => {
          h != null &&
            s({ "image/png": h.blob }).then((e) => {
              e && l.get(U).success(ee);
            });
        },
        onDownload: () => {
          h != null &&
            (A(Ze.CODEX_PROFILE_SHARE_ACTION_SAVE_BUTTON_CLICKED),
            hr(h.blob),
            l.get(U).success(O));
        },
        ...
        onOpenChange: (e) => {
          (e || ((T.current += 1), v(null), b(null), S(!1), f(!1), w(null)),
            m(e));
        },
        onOpenSocialDraft: (e, t) => {
          let n = qi(e, k);
          (A(Ze.CODEX_PROFILE_SHARE_ACTION_SOCIAL_COMPOSER_BUTTON_CLICKED, e),
            Ke({ event: t, href: n, initiator: `open_in_browser_bridge` }));
        },
        onSelectSocialPlatform: (e) => {
          (A(Ze.CODEX_PROFILE_SHARE_ACTION_SOCIAL_SHARE_BUTTON_CLICKED, e),
            v(e));
        },
      }),
    ],
...
function Ji(e) {
  switch (e) {
    case `linkedin`:
      return i.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_LINKEDIN;
    case `reddit`:
      return i.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_REDDIT;
    case `x`:
      return i.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_X;
  }
}
var Yi,
  Xi,
...
function ra({ today: e = new Date() }) {
  let t = fe(bt),
    ...
    p = r(`1991660486`),
    m = r(`2056428529`),
    { accountId: h, authMethod: g, planAtLogin: _, userId: v } = ve(),
    { data: y } = n(),
    { data: b } = D({ enabled: !0 }),
    { data: x } = ye(mn),
    C = Ht(e),
    E = Yt(C),
    ee = ja(C),
    O = h ?? b?.accountId ?? null,
    k = v ?? b?.userId ?? null,
    A = Ue({ accountId: O, enabled: g === `chatgpt`, userId: k }),
    te = A.data?.activityInsights,
    j = T({ accountId: O, userId: k }),
    F = Rt({ accountId: O, userId: k }),
    I = j.isPending || F.isPending,
    L = ne({ accountId: O, userId: k }),
    R = ce(x?.avatars),
    { selectedAvatar: z } = u(R),
    [re, ie] = (0, Q.useState)(null),
    [ae, se] = (0, Q.useState)(null),
    [B, V] = (0, Q.useState)(`daily`),
    [H, ue] = (0, Q.useState)(null),
    [de, U] = (0, Q.useState)(null),
    [pe, W] = (0, Q.useState)(null),
    [me, he] = (0, Q.useState)(!1),
    G = A.isLoading,
    ge = A.data == null && A.isError,
    _e = He.isInternal(Me()) && A.error != null ? Ra(A.error) : null,
    be = A.data?.hasStatsError === !0,
    xe = z.id.startsWith(`custom:`),
    Ce = f(
      G ? null : (ae ?? A.data?.imageUrl ?? y?.profile_picture_url ?? null),
    ),
    we = Ce != null && Ce !== re,
    Te = y?.plan_type ?? b?.plan ?? _,
    Ee = !N(Te) || m,
    De = A.data?.username?.trim() || null,
    Oe = Ee ? De : null,
    ke = A.data?.displayName ?? null,
    Ae = G ? null : zt({ accountName: y?.name, displayName: ke, username: Oe }),
    je = kt({
      accountStructure: y?.structure,
      plan: Te,
      workspaceName: y?.name,
    }),
    Ne = A.data?.summary,
    Pe = Ne?.longestTaskDurationMs,
    Fe = A.data?.dailyUsage,
    Ie = R.flatMap((e) =>
    ...
    Le =
      be || Fe == null
        ? null
        : {
            cells: wt({ dailyUsage: Fe, todayIso: C, view: B }),
            dailyValues: ut({ dailyUsage: Fe, todayIso: C }),
            weeklyTotals: Pt({ dailyUsage: Fe, todayIso: C }),
            cumulativeTotals: st({ dailyUsage: Fe, todayIso: C }),
          },
    Re = o.formatMessage({
  ...
  return (
    (0, Q.useEffect)(() => {
      i.current || ((i.current = !0), ze(t, We, { profileOwner: `self` }));
    }, [t]),
    ge
      ? (0, $.jsx)(gt, {
              ...
              (0, $.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, $.jsxs)(q, {
                    ...
                    onClick: () => {
                      (ze(t, w, {
                        action: Be.CODEX_PROFILE_EDIT_ACTION_OPENED,
                      }),
                        he(!0));
                    },
                    children: [
          ...
          children: [
                                ...
                                children: [
                                  ...
                                  (0, $.jsx)(`input`, {
                                    ...
                                    onClick: () => {
                                      ze(t, P, {
                                        action:
                                          Lt.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED,
                                      });
                                    },
                                    onChange: (e) => {
                                      ...
                                      ((e.currentTarget.value = ``),
                                        n != null &&
                                          (ze(t, P, {
                                            action:
                                              Lt.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED,
                                          }),
                                          pa(n).then(W, () => {
                                            (ze(t, P, {
                                              action:
                                                Lt.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                                            }),
                                              W(null));
                                          })));
                                    },
                      ...
                      : be
                        ...
                        : (0, $.jsxs)($.Fragment, {
                            children: [
                              ...
                              (0, $.jsx)(Oa, {
                                value: Se(o, Ne?.currentStreakDays),
                                label: (0, $.jsx)(K, {
                              ...
                              (0, $.jsx)(ka, {}),
                              (0, $.jsx)(Oa, {
                                value: Se(o, Ne?.longestStreakDays),
                                label: (0, $.jsx)(K, {
                              ...
                              (0, $.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, $.jsx)(`div`, {
                                    ...
                                    style: {
                                      gridTemplateColumns: `repeat(${E}, minmax(1px, 1fr))`,
                                    },
                                    children: Le.cells.map((e, t) => {
                                      let n = at(t, C);
                                      if (B === `daily` && n > C) return null;
                              ...
                              (0, $.jsx)(`div`, {
                                ...
                                children: ee.map((e) =>
                                  (0, $.jsx)(
                                    `span`,
                                    {
                                      children: o.formatDate(new Date(e), {
                                        month: `short`,
                                        timeZone: `UTC`,
                                      }),
                                    },
                    ...
                    (W(null),
                      ...
                      L.mutate(e.photo, {
                        ...
                        onSuccess: () => {
                          (ze(t, P, {
                            action:
                              Lt.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED,
                          }),
                            ie(null),
                            se(null));
                        },
            ...
            me
              ? (0, $.jsx)(ia, {
                  ...
                  onProfileImageError: ie,
                  onSaveError: (e) => {
                    ze(t, w, {
                      action: Be.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED,
                      ...e,
                    });
                  },
                  onPhotoChangeImageSelected: () => {
                    ze(t, w, {
                      action:
                        Be.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED,
                    });
                  },
                  onPhotoChangeStarted: () => {
                    ze(t, w, {
                      action:
                        Be.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED,
                    });
                  },
                  onSaveProfile: async (e) => {
                    (await j.mutateAsync(e), ie(null));
                  },
                  onSaveSuccess: () => {
                    ze(t, w, {
                      action: Be.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED,
                    });
                  },
                  onSaveUsername: (e) => F.mutateAsync(e),
                })
              : null,
          ],
        })
...
function ia({
  ...
  let h = Ve(),
    ...
    z = L || r || n,
    ie = Mt(S),
    ae = z || b.trim().length === 0 || (p && !ie.ok),
    oe = w?.previewUrl ?? f,
    se = oe != null && oe !== t,
    B = m?.trim() ?? ``,
    V = async () => {
      if (ae) return;
      (te(null), M(null), P(null), I(null));
      let t = b.trim(),
        n = lt(S),
        r = e?.trim() ?? ``;
      (x(t), C(n));
      ...
      if ((s && ((f.photo = w.photo), (m += 1)), g == null && m === 0)) {
        i();
        return;
      }
      ne(!0);
      let _ = R.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED,
        v = R.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED;
      try {
        (g != null &&
          ((_ = R.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
          await d(g),
          (_ = R.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          m > 0 &&
            ((v = R.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
            await l(f),
            (v = R.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          u(),
          i());
      } catch (e) {
        if (
                        ...
                        children: [
                          ...
                          (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, $.jsx)(`input`, {
                                id: y,
                                "aria-describedby": j == null ? void 0 : v,
                                "aria-invalid": j != null,
                                className: `min-w-0 flex-1 bg-transparent text-base leading-6 text-token-input-foreground outline-none`,
                                disabled: z,
                                maxLength: 20,
                                onChange: (e) => {
                                  let t = nt(e.target.value),
                                    n = Mt(t);
                                  (C(t),
                                    M(n.ok ? null : fa(n.reason, h)),
                                    I(null));
                                },
                                onFocus: (e) => {
                                  e.currentTarget.select();
...
function ha(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = rt(ta.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
//# sourceMappingURL=profile-BYkkAWYA.js.map
