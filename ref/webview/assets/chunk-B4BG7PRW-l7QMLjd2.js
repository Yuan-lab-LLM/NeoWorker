...
import { r as g, t as _ } from "./src-D1Kyl_w4.js";
import { g as v, s as y, u as b } from "./chunk-S3R3BYOJ-TWL1uuTy.js";
import { n as x, t as S } from "./chunk-FMBD7UC4-DXlVnBF9.js";
import { n as C, t as w } from "./chunk-55IACEB6-BdoixNZJ.js";
import { n as T, t as E } from "./chunk-QN33PNHL-BlcNM0Vu.js";
import { i as D, n as O, t as k } from "./chunk-N4CR4FBY-BW_tQoJ9.js";
var A,
  j,
  M,
  N,
        ...
        parseMember(e) {
          ...
          ((this.classifier = t),
            (this.id = this.id.startsWith(` `)
              ? ` ` + this.id.trim()
              : this.id.trim()));
          let n = `${this.visibility ? `\\` + this.visibility : ``}${f(this.id)}${this.memberType === `method` ? `(${f(this.parameters)})${this.returnType ? ` : ` + f(this.returnType) : ``}` : ``}`;
...
//# sourceMappingURL=chunk-B4BG7PRW-l7QMLjd2.js.map
