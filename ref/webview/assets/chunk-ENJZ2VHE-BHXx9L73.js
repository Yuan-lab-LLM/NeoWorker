...
import { r as m, t as h } from "./src-D1Kyl_w4.js";
import { n as g, t as _ } from "./rough.esm-CxIZKu28.js";
import { i as v, n as y, r as b } from "./chunk-AGHRB4JF-COxpu2PX.js";
import { A as x, b as S, w as C, y as w } from "./chunk-ICPOFSXX-CFvmAboO.js";
import { g as T, l as ee, u as E } from "./chunk-5PVQY5BW-DfdH3lpT.js";
import { i as D, n as O } from "./chunk-U2HBQHQK-D5slOmuq.js";
import {
  a as te,
  i as k,
  n as ne,
  r as A,
  t as j,
} from "./chunk-BSJP7CBP-DFvoyeko.js";
import { n as re, r as M } from "./chunk-ZZ45TVLE-3eqPbOqm.js";
import { a as N, n as P, r as ie } from "./chunk-X2U36JSP-DF5ovUWO.js";
import { i as ae, r as F } from "./chunk-5FUZZQ4R-DXh6s1If.js";
function I(e, t) {
  C(S()) &&
    e &&
  ...
  for (let a = 0; a < r; a++) {
    ...
    if (a === 0) n += `M${o.x},${o.y}`;
      ...
      let f = e / u,
        ...
        h = l / d,
        g = f * m + p * h,
        _ = Math.acos(Math.max(-1, Math.min(1, g)));
...
function B(e, t) {
  let n = e.map((e) => ({ ...e }));
  if (e.length >= 2 && k[t.arrowTypeStart]) {
    let r = k[t.arrowTypeStart],
      i = e[0],
      a = e[1],
      { angle: o } = z(i, a),
      s = r * Math.cos(o),
  ...
  let r = e.length;
  if (r >= 2 && k[t.arrowTypeEnd]) {
    let i = k[t.arrowTypeEnd],
      a = e[r - 1],
      o = e[r - 2],
      { angle: s } = z(o, a),
      c = i * Math.cos(s),
...
var V,
  ...
  me = e(() => {
    (A(),
      ...
      (W = y((e, t, n, r, i, a, o = !1, s) => {
        let c = H[n],
          l = c && U.includes(c.type);
        if (!c) {
          v.warn(`Unknown arrow type: ${n}`);
          return;
        }
      ...
      (oe = y(
        (e) => (typeof e == `string` ? e : S()?.flowchart?.curve),
      ...
      (Y = y(async (e, t) => {
        ...
        (o.node().appendChild(c), v.info(`abc82`, t, t.labelType));
        let l = c.getBBox(),
          u = l;
        if (r) {
          let e = c.children[0],
      ...
      y(I, `setTerminalWidth`),
      (X = y((e, t) => {
        v.debug(`Moving label abc88 `, e.id, e.label, G.get(e.id), t);
        let n = t.updatedPath ? t.updatedPath : t.originalPath,
          { subGraphTitleTotalMargin: r } = re(S());
        if (e.label) {
          let i = G.get(e.id),
            a = e.x,
            o = e.y;
          if (n) {
            let r = T.calcLabelPosition(n);
            (v.debug(
        ...
        if (e.startLabelLeft) {
          let t = K.get(e.id).startLeft,
            ...
            i = e.y;
          if (n) {
            let t = T.calcTerminalLabelPosition(
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
        ...
        if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * c) {
          ...
          return (
            ...
            u === 0 && (r.x = t.x),
            l === 0 && (r.y = t.y),
            v.debug(`abc89 top/bottom calc, Q ${l}, q ${e}, R ${u}, r ${s}`, r),
            r
          );
        } else {
          ...
          return (
            v.debug(`sides calc abc89, Q ${l}, q ${e}, R ${u}, r ${s}`, {
              _x: i,
              _y: a,
            }),
            s === 0 && ((i = t.x), (a = t.y)),
      ...
      (Q = y((e, t) => {
        v.warn(`abc88 cutPathAtIntersect`, e, t);
        let n = [],
          r = e[0],
          i = !1;
        return (
          e.forEach((e) => {
            if ((v.info(`abc88 checking point`, e, t), !Z(t, e) && !i)) {
              let a = se(t, r, e);
              (v.debug(`abc88 inside`, e, r, a),
                v.debug(`abc88 intersection`, a, t));
              let o = !1;
              (n.forEach((e) => {
                o ||= e.x === a.x && e.y === a.y;
              }),
                n.some((e) => e.x === a.x && e.y === a.y)
                  ? v.warn(`abc88 no intersect`, a, n)
                  : n.push(a),
                (i = !0));
            } else (v.warn(`abc88 outside`, e, r), (r = e), i || n.push(e));
          }),
          v.debug(`returning points`, n),
          n
        );
      }, `cutPathAtIntersect`)),
      y(L, `extractCornerPoints`),
      ($ = y(function (e, t, n) {
        let r = t.x - e.x,
          i = t.y - e.y,
      ...
      (ue = y(function (e, h, g, y, b, x, C, w = !1) {
        ...
        for (let e in h.cssCompiledStyles)
          ie(e) || j.push(h.cssCompiledStyles[e]);
        (v.debug(`UIO intersect check`, h.points, A.x, k.x),
          A.intersect &&
            k.intersect &&
            !w &&
        ...
        let re = btoa(JSON.stringify(D));
        (h.toCluster &&
          (v.info(`to cluster abc88`, g.get(h.toCluster)),
          ...
          h.fromCluster &&
            ...
            (O = !0)));
        let M = D.filter((e) => !Number.isNaN(e.y)),
          N = oe(h.curve);
        N !== `rounded` && (M = ce(M));
        let P = a;
        switch (N) {
        ...
        if (h.look === `handDrawn`) {
          let t = _.svg(e);
          Object.assign([], M);
          let n = t.path(H, { roughness: 0.3, seed: E });
          ((L += ` transition`),
            (z = m(n)
              .select(`path`)
              .attr(`id`, `${C}-${h.id}`)
          ...
          let i = z.node(),
            ...
            o = te[h.arrowTypeStart] || 0,
            s = te[h.arrowTypeEnd] || 0;
          if (h.look === `neo` && !K) {
        ...
        (z.attr(`data-edge`, !0),
          z.attr(`data-et`, `edge`),
          z.attr(`data-id`, h.id),
          z.attr(`data-points`, re),
          z.attr(`data-look`, ee(h.look)),
          h.showPoints &&
            M.forEach((t) => {
              e.append(`circle`)
                .style(`stroke`, `red`)
        ...
        let q = ``;
        ((S().flowchart.arrowMarkerAbsolute || S().state.arrowMarkerAbsolute) &&
          ((q =
          ...
          v.info(`arrowTypeStart`, h.arrowTypeStart),
          v.info(`arrowTypeEnd`, h.arrowTypeEnd));
        let J = !K && h?.look === `neo`;
        V(z, h, q, C, y, J, W);
        let Y = Math.floor(D.length / 2),
          X = D[Y];
        T.isLabelCoordinateInPath(X, z.attr(`d`)) || (O = !0);
        let Z = {};
        return (O && (Z.updatedPath = D), (Z.originalPath = h.points), Z);
      }, `insertEdge`)),
      y(R, `generateRoundedPath`),
      y(z, `calculateDeltaAndAngle`),
      y(B, `applyMarkerOffsetsToPoints`),
      (de = y((e, t, n, r) => {
        t.forEach((t) => {
          fe[t](e, n, r);
        });
      ...
      L0,20`,
        ...
        requirement_contains_neo: y((e, t, n) => {
          let { themeVariables: r } = w(),
            { strokeWidth: i } = r,
            a = e
              .append(`defs`)
...
//# sourceMappingURL=chunk-ENJZ2VHE-BHXx9L73.js.map
