...
function d() {
  return n.safeGet(`/wham/settings/user`);
}
function f() {
  let e = (0, y.c)(1),
    t;
...
function p() {
  return n.safeGet(`/wham/settings/configs/user-preferences`);
}
function m() {
  let e = (0, y.c)(2),
    n = t(),
...
function h(e) {
  return n.safePatch(`/wham/settings/user`, { requestBody: e });
}
function g(e, t, n) {
...
//# sourceMappingURL=cloud-preferences-CBs_FcMz.js.map
