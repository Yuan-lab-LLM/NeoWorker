...
function p(e) {
  ...
  let {
    ...
    se = j === `field` && `relative`,
    H;
  t[22] === se ? (H = t[23]) : ((H = l(se)), (t[22] = se), (t[23] = H));
  let U =
      j === `field`
  ...
  let q;
  t[33] !== oe || t[34] !== K
    ? ((q = oe({ onKeyDown: K })), (t[33] = oe), (t[34] = K), (t[35] = q))
    : (q = t[35]);
  let J = j === `menu` || k.length === 0 ? b : void 0,
    Y;
  t[36] === T
    ? (Y = t[37])
    : ((Y = (e) => {
  ...
  t[43] !== Y
    ...
    : (X = t[44]);
  let Z;
  t[45] !== u || t[46] !== W || t[47] !== G || t[48] !== X || t[49] !== w
    ? ((Z = (0, y.jsxs)(`div`, { className: W, children: [u, G, X, w] })),
      (t[45] = u),
      (t[46] = W),
      (t[47] = G),
      (t[48] = X),
              ...
              children:
                N == null
                  ? (0, y.jsx)(`div`, {
                      ...
                      role: d == null ? void 0 : `status`,
                      children: (0, y.jsx)(c, { className: `icon-xs` }),
                    })
                  : N.length === 0
                    ? (0, y.jsx)(`div`, {
  ...
  let $;
  return (
    t[64] !== H || t[65] !== Z || t[66] !== Q
      ? (($ = (0, y.jsxs)(`div`, { className: H, children: [Z, Q] })),
        (t[64] = H),
        (t[65] = Z),
        (t[66] = Q),
        (t[67] = $))
...
//# sourceMappingURL=share-invite-autocomplete-Bj1i12Dp.js.map
