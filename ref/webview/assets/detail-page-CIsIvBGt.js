...
function s(e) {
  let t = (0, c.c)(20),
    { action: n, as: i, count: a, showDivider: o, sticky: s, title: u } = e,
    d = i === void 0 ? `div` : i,
    f = o === void 0 ? !0 : o,
...
function d(e) {
  ...
  t[15] === T
    ? (E = t[16])
    : ((E = r(`flex flex-col gap-1`, T)), (t[15] = T), (t[16] = E));
  let D;
  t[17] !== a || t[18] !== E
    ? ((D = (0, p.jsx)(`div`, { className: E, children: a })),
      (t[17] = a),
      (t[18] = E),
      (t[19] = D))
    : (D = t[19]);
...
function h(e) {
  ...
  return (
    t[1] === n
      ? (a = t[2])
      : ((a = (0, _.jsx)(`div`, { className: i, children: n })),
        (t[1] = n),
        (t[2] = a)),
    a
  );
...
//# sourceMappingURL=detail-page-CIsIvBGt.js.map
