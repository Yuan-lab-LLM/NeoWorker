import { i as e, o as t, r as n, t as r } from "./src-zTh6it5j.js";
import { h as i } from "./chunk-5PVQY5BW-Dg9V_wGW.js";
import {
  $ as a,
  Q as o,
  Tt as s,
...
import {
  ...
  s as A,
  v as te,
} from "./chunk-ICPOFSXX-3NpaOJSf.js";
import { t as ne } from "./dist-Cy1PbdU6.js";
...
function qe(e, t, n, r, i, a) {
  ...
  function c(t, n, r) {
    let i = Math.abs(n - t) / r,
      a = y(([, , e]) => e).right(o, i);
    if (a === o.length) return e.every(d(t / Te, n / Te, r));
    if (a === 0) return P.every(Math.max(d(t, n, r), 1));
...
function Cn(e, t, n, r, i, s, l, u, d, f) {
  var p = o(),
    m = p.invert,
    h = p.domain,
    g = f(`.%L`),
  ...
  return (
    ...
    (p.domain = function (e) {
      return arguments.length ? h(Array.from(e, Sn)) : h().map(xn);
    }),
    (p.ticks = function (t) {
      var n = h();
    ...
    (p.copy = function () {
      return a(p, Cn(e, t, n, r, i, s, l, u, d, f));
    }),
    p
  );
}
  ...
  pi = {
    ...
    renderer: {
      ...
      draw: n(function (t, i, a, o) {
        let s = k().gantt;
        o.db.setDiagramId(i);
        let c = k().securityLevel,
          u;
        c === `sandbox` && (u = r(`#i` + i));
        let d = r(c === `sandbox` ? u.nodes()[0].contentDocument.body : `body`),
          f = c === `sandbox` ? u.nodes()[0].contentDocument : document,
          p = f.getElementById(i);
        (($ = p.parentElement.offsetWidth),
          $ === void 0 && ($ = 1200),
          s.useWidth !== void 0 && ($ = s.useWidth));
        let m = o.db.getTasks(),
          h = [];
        for (let e of m) h.push(e.type);
        h = ne(h);
        let g = {},
          v = 2 * s.topPadding;
        if (
          ...
          for (let n of Object.keys(e)) {
            let r = di(e[n], t) + 1;
            ((t += r), (v += r * (s.barHeight + s.barGap)), (g[n] = r));
          }
        } else {
          v += m.length * (s.barHeight + s.barGap);
          for (let e of h) g[e] = m.filter((t) => t.type === e).length;
        }
        p.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + v);
        let y = d.select(`[id="${i}"]`),
          b = wn()
            .domain([
              x(m, function (e) {
          ...
          if (
            (f
              ...
              .attr(`height`, function (e) {
                return e.vert
                  ? m.length * (s.barHeight + s.barGap) + s.barHeight * 2
                  : c;
              })
            ...
            f
              ...
              .attr(`x`, function (e) {
                ...
                if (
                  (e.milestone &&
                    ((t += 0.5 * (b(e.endTime) - b(e.startTime)) - 0.5 * c),
                    (n = t + c)),
                  e.vert)
                )
          ...
          y.append(`g`)
            ...
            .append(function (e) {
              let t = e[0].split(A.lineBreakRegex),
                n = -(t.length - 1) / 2,
                r = f.createElementNS(`http://www.w3.org/2000/svg`, `text`);
              r.setAttribute(`dy`, n + `em`);
              for (let [e, n] of t.entries()) {
                let t = f.createElementNS(
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-CD_QQLjZ.js.map
