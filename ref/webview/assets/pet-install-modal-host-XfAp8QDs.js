...
import { r as T, t as E } from "./avatar-mascot-button-lIOXDH5S.js";
import { i as D, t as O } from "./custom-avatars-query-mkYIdPJ1.js";
import {
  i as k,
  n as A,
  r as j,
  t as M,
} from "./pet-install-state-wUu7G9Ym.js";
function N(e) {
  let n = (0, P.c)(37),
    { session: r, onClose: s, onInstall: c } = e,
    { setSelectedAvatarId: l } = t(),
    u = r.status !== `installing`,
    d = r.status === `ready` || r.status === `installError`,
    f;
  n[0] !== u || n[1] !== s
    ? ((f = (e) => {
        !e && u && s();
  ...
  n[9] !== r.description || n[10] !== v
    ? ((y = (0, F.jsx)(w, {
        children: (0, F.jsx)(p, { title: v, subtitle: r.description }),
      })),
      (n[9] = r.description),
      (n[10] = v),
      (n[11] = y))
  ...
  n[24] !== l
    ...
    : (C = n[25]);
  let T;
  n[26] !== h || n[27] !== y || n[28] !== x || n[29] !== S || n[30] !== C
    ? ((T = (0, F.jsxs)(a, {
        as: `form`,
        onSubmit: h,
        children: [y, x, S, C],
...
function L(e) {
  ...
  let s;
  t[3] !== a || t[4] !== r
    ? ((s = () => j(r, () => a(O))), (t[3] = a), (t[4] = r), (t[5] = s))
    : (s = t[5]);
  let c;
  return (
    t[6] !== i || t[7] !== o || t[8] !== s
      ? ((c = (0, z.jsx)(N, { session: i, onClose: o, onInstall: s })),
        (t[6] = i),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
...
//# sourceMappingURL=pet-install-modal-host-XfAp8QDs.js.map
