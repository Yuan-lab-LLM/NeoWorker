...
import { n as Me, t as Ne } from "./use-element-in-view--7okH2PV.js";
import {
  F as Pe,
  G as O,
  H as Fe,
...
import {
  ...
  t as qe,
  u as Je,
} from "./plugins-page-BwYsCaTY.js";
import { n as Ye, t as Xe } from "./settings-host-dropdown-zO83iEBq.js";
function Ze() {
  let e = (0, R.c)(5),
    t = p(),
    n = F(),
...
function I(e) {
  let t = (0, R.c)(99),
    ...
    p;
  t[0] !== l || t[1] !== d
    ? ((p = le(d, l)), (t[0] = l), (t[1] = d), (t[2] = p))
    : (p = t[2]);
  let g = p,
    [_, v] = (0, z.useState)(null),
    [ee, ne] = (0, z.useState)(null),
    ie;
  t[3] !== ee || t[4] !== _
    ? ((ie = { container: _, target: ee }),
      (t[3] = ee),
      (t[4] = _),
      (t[5] = ie))
    : (ie = t[5]);
  let ae = Me(ie),
    ...
    ge = he(He),
    {
      forceReloadSkills: ve,
      installedSkillMatchKeys: C,
      isFetching: be,
      isLoading: w,
      markSkillsUpdated: T,
  ...
  let A;
  t[7] !== ve || t[8] !== g
    ? ((A = { forceReloadSkills: ve, hostId: g, onInstalled: k }),
      (t[7] = ve),
      (t[8] = g),
      (t[9] = A))
    : (A = t[9]);
  ...
  t[10] === o
    ? (j = t[11])
    : ((j = h({ scope: `repo`, intl: o })), (t[10] = o), (t[11] = j));
  let We = j,
    M = s?.name ?? void 0,
    N;
  t[12] !== o || t[13] !== M
    ? ((N = h({ scope: `admin`, intl: o, adminLabel: M })),
      (t[12] = o),
      (t[13] = M),
      (t[14] = N))
    : (N = t[14]);
  let Ke = N,
    P;
  t[15] !== o || t[16] !== Ke || t[17] !== We || t[18] !== Ee
    ? ((P = (e) => {
        let { scope: t, skillPath: n } = e;
        return h({
          scope: t,
          intl: o,
          repoLabel: ce({ skillPath: n, roots: Ee, fallbackLabel: We }),
          adminLabel: Ke,
        });
      }),
      (t[15] = o),
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ot = (0, B.jsx)(u, { className: `icon-xs` })), (t[34] = ot))
    : (ot = t[34]);
  let H;
  t[35] === b
    ? (H = t[36])
  ...
  t[46] !== y || t[47] !== W || t[48] !== G
    ...
    : (K = t[49]);
  let q;
  t[50] !== S || t[51] !== a || t[52] !== ge || t[53] !== D || t[54] !== c
    ? ((q = () => {
        if (!D) return;
        ue(a, Se, {});
        let e = Ge({ creatorPath: D, isFirstOpen: !S, kind: `skill` });
        (S || ge(!0), c({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (t[50] = S),
      (t[51] = a),
      (t[52] = ge),
  ...
  t[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ct = (0, B.jsx)(me, { className: `icon-xs` })),
      (lt = (0, B.jsx)(x, {
  ...
  let X;
  t[66] !== I || t[67] !== Y
    ? ((X = (0, B.jsx)(pe, { start: I, trailing: Y })),
      (t[66] = I),
      (t[67] = Y),
      (t[68] = X))
    : (X = t[68]);
    ...
    bb0: {
      ...
      if (i) {
        ...
        (t[17] === i
          ...
          : ((n = (0, B.jsx)(`div`, {
              className: `flex min-h-0 flex-1 items-center justify-center`,
              children: (0, B.jsx)(C, { title: e, description: i }),
            })),
            (t[17] = i),
            (t[18] = n)),
          (m = n));
...
//# sourceMappingURL=skills-page-S3iLnPKi.js.map
