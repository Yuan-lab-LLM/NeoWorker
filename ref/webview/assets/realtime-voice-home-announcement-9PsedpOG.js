...
import { n as b, t as x } from "./onboarding-banner-x8BEylhu.js";
function S(e) {
  let t = (0, w.c)(8),
    { entryPoint: n } = e,
    r = a(_),
    ...
    s = u(n),
    l = g();
  if (s == null || i || l !== !0) return null;
  let d;
  t[0] === r ? (d = t[1]) : ((d = () => v(r)), (t[0] = r), (t[1] = d));
  let f;
  t[2] === s ? (f = t[3]) : ((f = () => void s()), (t[2] = s), (t[3] = f));
  let p;
  return (
    t[4] !== n || t[5] !== d || t[6] !== f
      ? ((p = (0, T.jsx)(C, { entryPoint: n, onDismiss: d, onStart: f })),
        (t[4] = n),
        (t[5] = d),
        (t[6] = f),
        (t[7] = p))
...
function C(e) {
  let t = (0, w.c)(18),
    { entryPoint: n, onDismiss: r, onStart: i, orbSrc: a } = e,
    o = a === void 0 ? E : a,
    s = m(),
    c;
  ...
  t[3] === o
    ? (u = t[4])
    : ((u = (0, T.jsx)(`img`, { alt: ``, className: `size-full`, src: o })),
      (t[3] = o),
      (t[4] = u));
  let d;
  ...
  t[6] === i
    ? (h = t[7])
    : ((h = { label: d, onClick: i }), (t[6] = i), (t[7] = h));
  let g;
  t[8] === s
    ? (g = t[9])
    : ((g = s.formatMessage({
  ...
  let _;
  t[10] !== r || t[11] !== g
    ? ((_ = { ariaLabel: g, icon: f, onClick: r }),
      (t[10] = r),
      (t[11] = g),
      (t[12] = _))
    : (_ = t[12]);
...
//# sourceMappingURL=realtime-voice-home-announcement-9PsedpOG.js.map
