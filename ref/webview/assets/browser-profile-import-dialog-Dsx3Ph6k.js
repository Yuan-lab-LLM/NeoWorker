...
function Se(e) {
  ...
  t[29] !== _
    ...
    : (B = t[30]);
  let V;
  t[31] !== r || t[32] !== s || t[33] !== y || t[34] !== h
    ? ((V = h && (0, Q.jsx)(Ee, { checked: r, disabled: s, onChange: y })),
      (t[31] = r),
      (t[32] = s),
      (t[33] = y),
      (t[34] = h),
  ...
  t[53] !== re || t[54] !== G
    ? ((K = (0, Q.jsx)(q, {
        children: (0, Q.jsxs)(p, { className: a, children: [re, G] }),
      })),
      (t[53] = re),
      (t[54] = G),
      (t[55] = K))
...
function Ce(e) {
  let t = (0, Z.c)(27),
    ...
    u;
  t[0] === o ? (u = t[1]) : ((u = o ? Pe(o) : null), (t[0] = o), (t[1] = u));
  let d = u,
    p;
  t[2] === o ? (p = t[3]) : ((p = o ? Fe(o) : void 0), (t[2] = o), (t[3] = p));
  let m = p,
    h = a?.length === 1,
    g = h || void 0,
  ...
  t[4] === _
    ? (v = t[5])
    : ((v = I(`min-w-0 flex-1`, _)), (t[4] = _), (t[5] = v));
  let y = h ? `hidden` : void 0,
    b = h ? void 0 : n,
    x = h ? -1 : void 0,
    S;
  t[6] !== r || t[7] !== o
    ? ((S = (0, Q.jsx)(we, { isLoading: r, selectedProfile: o })),
      (t[6] = r),
      (t[7] = o),
      (t[8] = S))
    : (S = t[8]);
...
function Te(e) {
  ...
  let u;
  t[4] !== c || t[5] !== s
    ? ((u = (0, Q.jsx)(`span`, { id: s, children: c })),
      (t[4] = c),
      (t[5] = s),
      (t[6] = u))
    : (u = t[6]);
  ...
  return (
    t[12] !== l || t[13] !== u || t[14] !== f
      ? ((p = (0, Q.jsx)(M, { icon: l, label: u, control: f })),
        (t[12] = l),
        (t[13] = u),
        (t[14] = f),
        (t[15] = p))
...
function Ee(e) {
  ...
  let s;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((s = (0, Q.jsx)(k, { checked: n, disabled: r, onCheckedChange: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = s))
...
function De(e) {
  let t = (0, Z.c)(54),
    ...
    c = i.cookies?.status === `failed_to_copy`,
    u;
  t[0] === i.cookies
    ? (u = t[1])
    : ((u = Ie(i.cookies)), (t[0] = i.cookies), (t[1] = u));
  let d = u,
    f =
      d &&
  ...
  let v = _,
    ...
    b;
  t[7] !== v || t[8] !== g
    ? ((b = v && g.some(Oe)), (t[7] = v), (t[8] = g), (t[9] = b))
    : (b = t[9]);
  let x = b,
    C = d || v,
    w = s == null ? Le.complete : Le.failed,
    E;
  t[10] === w
    ? (E = t[11])
    : ((E = (0, Q.jsx)(ee, {
  ...
  let M;
  t[20] !== j || t[21] !== E
    ? ((M = (0, Q.jsxs)(q, { children: [E, j] })),
      (t[20] = j),
      (t[21] = E),
      (t[22] = M))
    : (M = t[22]);
  let N;
  t[23] !== y || t[24] !== v || t[25] !== x || t[26] !== i.passwords
    ? ((N =
        i.passwords != null &&
        (0, Q.jsx)(Ne, {
          failureMessage: v
            ? (0, Q.jsx)(je, { accessFailed: y, partiallyFailed: x })
            : void 0,
          kind: `passwords`,
        })),
      (t[23] = y),
  ...
  let F;
  t[36] !== N || t[37] !== P
    ? ((F = (0, Q.jsx)(q, { children: (0, Q.jsxs)(te, { children: [N, P] }) })),
      (t[36] = N),
      (t[37] = P),
      (t[38] = F))
    : (F = t[38]);
  ...
  t[39] !== o || t[40] !== s
    ...
    : (I = t[41]);
  let L = s ?? o,
    R = s == null ? Le.done : Le.retry,
    z;
  t[42] === R
    ? (z = t[43])
    : ((z = (0, Q.jsx)(D, { ...R })), (t[42] = R), (t[43] = z));
  let B;
  t[44] !== L || t[45] !== z
    ? ((B = (0, Q.jsx)(H, {
        color: `primary`,
...
function Me(e) {
  ...
  bb0: switch (n.source) {
    ...
    case `chrome`: {
      let e;
      (t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(G, { className: `size-4 shrink-0` })), (t[1] = e))
        : (e = t[1]),
        (r = e));
    }
  }
...
function Ne(e) {
  ...
  t[4] === n
    ...
    : ((o =
        n == null
          ? (0, Q.jsx)(ce, { className: `size-5 text-token-text-primary` })
          : (0, Q.jsx)(W, { className: `size-5 text-token-error-foreground` })),
      (s =
        n == null
          ? void 0
          : (0, Q.jsx)(`span`, {
  ...
  return (
    t[7] !== i || t[8] !== a || t[9] !== o || t[10] !== s
      ? ((c = (0, Q.jsx)(M, { control: o, description: s, icon: i, label: a })),
        (t[7] = i),
        (t[8] = a),
        (t[9] = o),
        (t[10] = s),
...
function ze(e) {
  let t = (0, He.c)(88),
    { entryPoint: i, flowId: a, onClose: o, service: c } = e,
    l = v(ne),
    u = n(`1834314516`),
    [d, f] = (0, $.useState)(``),
    [p, m] = (0, $.useState)(!0),
    ...
    T = (0, $.useRef)(null),
    E;
  t[0] === c ? (E = t[1]) : ((E = ie(c, !0)), (t[0] = c), (t[1] = E));
  let D = me(E),
    ee;
  t[2] === c
    ? (ee = t[3])
    : ((ee = (e) => {
        let { request: t } = e;
        return c.importBrowserProfile(t);
      }),
      (t[2] = c),
      (t[3] = ee));
  let O, k;
  t[4] !== i || t[5] !== l
    ? ((O = (e, t) => {
        let { context: n, request: r } = t;
        ((b.current = `after-request-error`), L(l, i, r, n));
      }),
      (k = (e, t) => {
        let { context: n, request: r } = t;
        ((b.current = `after-result`), L(l, i, r, n, e));
      }),
      (t[4] = i),
      (t[5] = l),
      (t[6] = O),
  ...
  let A;
  t[8] !== ee || t[9] !== O || t[10] !== k
    ? ((A = { mutationFn: ee, onError: O, onSuccess: k }),
      (t[8] = ee),
      (t[9] = O),
      (t[10] = k),
      (t[11] = A))
  ...
  let j = ae(A),
    ...
    N;
  t[12] !== M || t[13] !== d
    ? ((N = M?.find((e) => Ve(e) === d) ?? V(M ?? [])[0] ?? M?.[0] ?? null),
      (t[12] = M),
      (t[13] = d),
      (t[14] = N))
    : (N = t[14]);
  let P = N,
    ...
    z = te && P?.source === `chrome`,
    B;
  t[15] === P
    ? (B = t[16])
    : ((B = P ? Ve(P) : null), (t[15] = P), (t[16] = B));
  let H = B,
    U = H != null && _ === H,
    W;
  t[17] !== j.isError || t[18] !== j.variables
    ? ((W =
        j.isError && j.variables != null
          ? {
              source: j.variables.request.source,
              profilePath: j.variables.request.profilePath,
              cookies:
                j.variables.request.importCookies === !1
                  ? void 0
                  : { status: `failed` },
              passwords:
                j.variables.request.importPasswords === !1
                  ? void 0
                  : { status: `failed` },
            }
          : null),
  ...
  t[24] !== P?.source
    ? ((K = () => {
        x.current ||
          ...
          w(l, i, {
            flowId: a,
            attemptIndex: T.current?.context.attemptIndex,
            source:
              T.current?.request.source ?? (C.current ? `chrome` : P?.source),
            windowsChromeAdminApprovalNoticeRequired:
              T.current?.context.windowsChromeAdminApprovalNoticeRequired ??
              C.current,
            windowsChromeAdminApprovalNoticeAcknowledged:
              T.current?.context.windowsChromeAdminApprovalNoticeAcknowledged ??
              S.current,
            exitState: j.isPending ? void 0 : b.current,
          }));
      }),
      (t[20] = i),
      (t[21] = a),
  ...
  t[29] !== ce || t[30] !== u
    ...
    : (le = t[31]);
  let ue;
  (t[32] === u ? (ue = t[33]) : ((ue = [u]), (t[32] = u), (t[33] = ue)),
    (0, $.useEffect)(le, ue));
  let fe, he;
  (t[34] !== H ||
  t[35] !== u ||
  ...
  t[39] !== l
    ? ((fe = () => {
        !u || !z || H == null || C.current || ((C.current = !0), de(l, i, a));
      }),
      (he = [H, u, i, a, z, l]),
      (t[34] = H),
      (t[35] = u),
    ...
    (0, $.useEffect)(fe, he));
  let ge;
  t[42] !== j.isPending || t[43] !== oe || t[44] !== o
    ? ((ge = () => {
        j.isPending || (oe(), o());
      }),
      (t[42] = j.isPending),
  ...
  t[46] === q
    ...
    : ((J = (e) => {
      ...
      (t[46] = q),
      (t[47] = J));
  let _e = !j.isPending && G == null,
    ve;
  t[48] === j.data
    ? (ve = t[49])
    : ((ve = void 0), (t[48] = j.data), (t[49] = ve));
  let Y;
  t[50] !== H || t[51] !== i || t[52] !== a || t[53] !== l
    ? ((Y = (e) => {
        (e && !S.current && ((S.current = !0), r(l, i, a)), y(e ? H : null));
      }),
      (t[50] = H),
      (t[51] = i),
      (t[52] = a),
  ...
  t[63] !== P
    ? ((ye = () => {
        ...
        let e = Be(P, F, I, z),
          t = {
            flowId: a,
            attemptIndex: (T.current?.context.attemptIndex ?? 0) + 1,
            windowsChromeAdminApprovalNoticeRequired: z,
            windowsChromeAdminApprovalNoticeAcknowledged: U,
          };
        ((T.current = { context: t, request: e }),
          pe(l, i, e, t),
          j.mutate({ context: t, request: e }));
      }),
      (t[55] = i),
      (t[56] = a),
      (t[57] = U),
      ...
      (t[64] = ye))
    : (ye = t[64]);
  let be = re == null ? void 0 : j.reset,
    X;
  t[65] === j
    ? (X = t[66])
    : ((X = (e) => {
        (f(Ve(e)), y(null), j.reset());
      }),
      (t[65] = j),
      (t[66] = X));
  let xe;
  ...
  t[82] !== X
    ? ((xe = (0, Ue.jsx)(Se, {
        ...
        elevatedChromeConsent: U,
        importCookies: p,
        importPasswords: h,
        isImporting: j.isPending,
        isLoadingProfiles: D.isLoading,
        showCloseBrowserGuidance: R,
        profiles: M,
        profilesHaveError: D.isError,
        requiresElevatedChromeConsent: z,
        result: G,
        selectedProfile: P,
        onCancel: q,
        onElevatedChromeConsentChange: Y,
        onImport: ye,
        onImportCookiesChange: m,
        onImportPasswordsChange: g,
        onTryAgain: be,
        onSelectProfile: X,
      })),
      (t[67] = q),
...
//# sourceMappingURL=browser-profile-import-dialog-Dsx3Ph6k.js.map
