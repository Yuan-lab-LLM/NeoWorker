...
import {
  ...
  v as qe,
  y as Je,
} from "./avatar-overlay-pill-dismiss-button-CG9nT7GM.js";
import { n as Ye, r as Xe, t as Ze } from "./avatar-mascot-button-lIOXDH5S.js";
import { n as Qe, t as $e } from "./global-dictation-orb-j6CQ75jj.js";
import { n as et, t as tt } from "./sound-on-BQbSd609.js";
import { n as nt, t as rt } from "./realtime-voice-handoff-target-C5T0-pQL.js";
import { n as it, t as at } from "./create-resize-observer-iS4TFEPa.js";
function ot(e) {
  return e === `primary` ? `activity-primary` : `activity-secondary`;
}
var st,
  ct = e(() => {
    st = [`activity-primary`, `activity-secondary`, `activity-tertiary`];
  });
function lt(e) {
  let t = (0, ht.c)(27),
    {
  ...
  let _;
  t[6] !== r || t[7] !== i
    ? ((_ = mt(i, I(qe.activityPillMaterial, r))),
      (t[6] = r),
      (t[7] = i),
      (t[8] = _))
    : (_ = t[8]);
...
function dt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = Y({ height: 54, left: 0, top: 0, width: 345 }, i)), (t[0] = o))
    : (o = t[0]);
  let s = o,
    c;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = Y({ height: 54, left: 0, top: 0, width: 345 }, a)), (t[1] = c))
    : (c = t[1]);
  let l = c,
    u;
  t[2] === r ? (u = t[3]) : ((u = fe(r)), (t[2] = r), (t[3] = u));
  let d;
    ...
    ? ((f =
        r > 2
          ? (0, gt.jsx)(`div`, {
              className: mt(
                n,
                I(qe.activityPillMaterial, `absolute rounded-[27px]`),
              ),
  ...
  t[9] === n
    ? (p = t[10])
    : ((p = mt(n, I(qe.activityPillMaterial, `absolute rounded-[27px]`))),
      (t[9] = n),
      (t[10] = p));
  let m;
  t[11] === p
...
function mt(e, t) {
  return I(
    ...
    e ? `bg-transparent` : qe.cssMaterial,
    !e && qe.cssMaterialElevated,
  );
}
var ht,
  gt,
...
function yt(e) {
  let t = (0, bt.c)(14),
    ...
    p;
  t[0] !== n || t[1] !== f
    ? ((p = I(`no-drag pointer-events-none`, f, n)),
      (t[0] = n),
      (t[1] = f),
      (t[2] = p))
    : (p = t[2]);
...
function Et({ mascot: e, orbScale: t = 1 }) {
  return { left: e.left + e.width / 2, top: e.top + (e.height * (1 + t)) / 2 };
}
function Dt({ mascot: e, viewport: t }) {
  let n = e.left + e.width / 2;
  return Math.max(0, 2 * Math.min(n - Nt, t.width - n - Nt));
}
function Ot({ caption: e, status: t }) {
  return e == null || t == null
    ? 0
    : Math.max(0, t.top + t.height + Mt - e.top);
}
function kt({ mascot: e, showsNotificationBadge: t, surfaceId: n }) {
  let r = t ? 4 : 3,
    i;
  switch (n) {
    case `voice-output`:
...
function Bt(e) {
  let t = (0, Kt.c)(62),
    {
      ...
      onStop: m,
      onOpenThread: h,
      onToggleMicrophoneMute: g,
      onToggleMute: _,
      phase: v,
      placement: y,
      showsNotificationBadge: x,
      willResume: S,
    } = e,
    C = n === void 0 ? !1 : n,
    w = r === void 0 ? !0 : r,
  ...
  if (!L && !i && !ne) return null;
  let z = v === `active`,
    B = (z || ne) && g != null && _ != null,
    V = w
  ...
  t[21] !== U
    ? ((G =
        B && (f == null || f === `voice-output`)
          ? (0, X.jsx)(
              Ut,
              {
                ariaLabel: I.formatMessage(A ? Z.unmuteOutput : Z.muteOutput),
                disabled: !z,
                isAnimated: !M,
                isInert: j,
                isPressed: A,
                nativeMaterialAttached: M,
                nativeSurfaceId: `voice-output`,
                position:
                  d ??
                  kt({
                    mascot: l,
                    showsNotificationBadge: P,
                    surfaceId: `voice-output`,
                  }),
                tooltipContent: (0, X.jsx)(O, {
                  ...(A ? Z.unmuteOutput : Z.muteOutput),
                }),
                visibilityClassName: U,
                onClick: _,
                children: A
                  ? (0, X.jsx)(se, { className: `icon-xs` })
  ...
  t[34] !== U
    ? ((K =
        B && (f == null || f === `voice-microphone`)
          ? (0, X.jsx)(
              Ut,
              {
                ariaLabel: I.formatMessage(
                  D ? Z.unmuteMicrophone : Z.muteMicrophone,
                ),
                disabled: !z,
                isAnimated: !M,
                isInert: j,
                ...
                onClick: g,
                children: D
                  ? (0, X.jsx)(te, { className: `icon-xs` })
                  : (0, X.jsx)(b, { className: `icon-xs` }),
              },
              `voice-microphone`,
            )
          : null),
  ...
  t[36] !== G || t[37] !== K
    ? ((q = (0, X.jsx)(re, {
        reducedMotion: `never`,
        children: (0, X.jsxs)(ae, { initial: !1, children: [G, K] }),
      })),
      (t[36] = G),
      (t[37] = K),
      (t[38] = q))
          ...
          ? (0, X.jsx)(Ut, {
              ...
              children:
                B || ((E || h == null) && (z || ee))
                  ...
                  : R
                    ? (0, X.jsx)(N, { className: `icon-xs` })
                    : (0, X.jsx)(pe, { className: `icon-xs` }),
            })
          : null),
      (t[39] = ie),
      (t[40] = I),
  ...
  let J;
  return (
    t[58] !== W || t[59] !== q || t[60] !== ce
      ? ((J = (0, X.jsxs)(X.Fragment, { children: [W, q, ce] })),
        (t[58] = W),
        (t[59] = q),
        (t[60] = ce),
        (t[61] = J))
...
function Ut(e) {
  ...
  let S = o && `invisible`,
    C;
  t[14] !== S || t[15] !== m
    ? ((C = I(`group/voice-action no-drag size-6`, S, m)),
      (t[14] = S),
      (t[15] = m),
      (t[16] = C))
    : (C = t[16]);
  let w = i ? `cursor-default` : `cursor-interaction`,
    T = s && `text-token-foreground`,
    E;
  t[17] !== w || t[18] !== T
    ? ((E = I(
  ...
  t[29] !== O || t[30] !== p
    ...
    : (k = t[31]);
  let A;
  t[32] !== o || t[33] !== c || t[34] !== u || t[35] !== k || t[36] !== C
    ? ((A = (0, X.jsx)(It, {
        className: C,
        inert: o,
        nativeMaterialAttached: c,
...
function Wt(e) {
  let t = (0, Kt.c)(5),
    { mascot: n, showsNotificationBadge: r } = e,
    i;
  t[0] !== n || t[1] !== r
    ? ((i = j.filter(Gt).map((e) => {
        let t = kt({ mascot: n, showsNotificationBadge: r, surfaceId: e });
        return (0, X.jsx)(
          `div`,
          {
            "aria-hidden": `true`,
  ...
  return (
    t[3] === i
      ? (a = t[4])
      : ((a = (0, X.jsx)(X.Fragment, { children: i })), (t[3] = i), (t[4] = a)),
    a
  );
}
function Gt(e) {
...
var Kt,
  ...
  Jt = e(() => {
    ((Kt = m()),
      ...
      zt(),
      (X = a()),
      (qt = { damping: 22, mass: 0.72, stiffness: 360, type: `spring` }),
      (Z = d({
        start: {
...
function Yt({
  ...
  let i = ze(n),
    ...
    s = n.waitingRequest == null ? o : Pe(n.waitingRequest, e),
    c = s.replace(/[.?!]+$/, ``),
...
function Qt(e) {
  ...
  t[15] === i
    ...
    : ((D = I(
        ...
        i ? `bg-transparent` : I(qe.cssMaterial, qe.cssMaterialElevated),
      )),
      (t[15] = i),
      (t[16] = D));
  let O;
...
function mn({
  ...
  areActivityPillsVisible: r = !0,
  avatar: i,
  avatarMenuItems: a,
  debugWindowBorderVisible: o = !1,
  expandedNotificationIds: s = [],
  globalDictationOrbEnabled: c = !1,
  interactiveRegionRef: l,
  isNotificationTrayOpen: u = !0,
  layout: d,
  mascotDragState: f,
  mascotStyle: p,
  nativeMaterialAttached: m,
  notificationStackContentExpanded: h,
  notificationStackControlsVisible: g = !0,
  notifications: _,
  notificationStackItemCount: v = _.length,
  notificationFollowUp: y,
  pointerSurfaceId: b = null,
  quickChatDictation: S,
  onActivityStackScroll: C,
  onActivateNotification: w,
  onHideActivityPills: T,
  onMascotLostPointerCapture: E,
  onMascotPointerCancel: D,
  onMascotPointerDown: O,
  onMascotPointerMove: A,
  onMascotPointerUp: j,
  onNotificationExpansionChange: M,
  onDismissNotification: N,
  onOpenNotificationActions: F,
  onRunNotificationControl: L,
  onRunNotificationAction: R,
  onSubmitQuestionOption: ee,
  onQuickChatEditorActiveChange: te,
  onQuickChatDraftChange: z,
  onQuickChatVisibilityChange: V,
  onSubmitQuickChat: H,
  onTrayAnimationFrame: ie,
  onShowActivityPills: oe,
  quickChatDraft: U,
  quickChatEnabled: W = !0,
  quickChatVisible: G,
  realtimeVoiceSurface: K,
  renderMode: q,
}) {
  let se = k(),
    ce = be(),
    J = q?.type === `native-surface` ? q.id : void 0,
    le = q?.type === `native-surface` || (q?.type === `native-root` && m),
    ue = q != null,
    de = (0, Q.useRef)(!1),
    fe = (0, Q.useRef)(!1),
    pe = (0, Q.useRef)(null),
    ...
    ye = c && ge,
    Y = G ?? me,
    xe = q?.type === `native-root` && m && !ye,
    Se = ze(_[0]),
    [Ce, Te] = (0, Q.useState)(null);
  P(`avatar-overlay-computer-use-cursor-changed`, (e) => {
    Te(e.point);
  });
  let Ee = _.length > 0,
    De = Ee,
    Oe = K?.phase ?? `inactive`,
    ke = K?.canStart === !0 || Oe !== `inactive`,
    Ae = ke
      ? kt({
          mascot: d.mascot,
      ...
      : null,
    je = Ue(K?.isSessionActive ?? !1, Oe !== `inactive`, K?.petOpenIntent),
    Me = d.mascot,
    Ne = y?.caretPoint ?? Ce,
    Pe = K?.caption ?? null,
    Ie = K != null,
    Le = Ne == null || i == null ? null : Fe(Me, Ne, i.spriteVersionNumber),
    Re = r && Ee,
    Be = Re || ye || Y,
    Ve = v > 1 && u,
    He = v > 1 && !u,
    We = h ?? Ve,
    Ge =
      d.tray == null || q?.type === `native-root`
        ? void 0
        : Math.max(0, d.tray.height),
    Ke = () => {
      (pe.current != null &&
        (window.clearTimeout(pe.current), (pe.current = null)),
        G ?? he(!0),
        V?.(!0));
    },
    qe = () => {
    ...
    ? (Je = {
        ...
        content: (0, $.jsx)(we, {
          className: I(
            ...
            d.placement.startsWith(`bottom`) && `rotate-180`,
          ),
        }),
  ...
  let Xe =
    i == null
      ? null
      : (0, $.jsx)(Ze, {
          ariaLabel: se.formatMessage(Wn.mascotLabel, {
            petName: i.displayName,
          }),
          assetRef: i.assetRef,
          lookFrame: Le,
          notificationBadge: Ie ? void 0 : Je,
          spriteVersionNumber: i.spriteVersionNumber,
  ...
  return (0, $.jsx)(`main`, {
    className: I(
      ...
      q?.type === `native-surface` ? `overflow-visible` : `overflow-hidden`,
      o && `-outline-offset-2 outline-2 outline-[#ff0000]`,
    ),
    ...
    children: (0, $.jsxs)(`section`, {
      ...
      children: [
        J == null && Y && d.tray != null
          ...
          : null,
        Pe != null && (J == null || J === `realtime-caption`)
          ? (0, $.jsx)(Qt, {
              isNativeMeasurementPlaceholder: le && J == null,
              layout: d,
              nativeMaterialAttached: m,
              prefersReducedMotion: !!ce,
              presentationOffsetY: !m && K?.statusText != null ? Pt : 0,
              text: Pe,
            })
          : null,
        (0, $.jsx)(`div`, {
          "aria-hidden": xe || void 0,
          "data-avatar-overlay-hit-region": Be ? `notification-tray` : void 0,
          className: I(
            `absolute text-sm text-token-foreground`,
            Be && !xe ? `cursor-interaction` : `pointer-events-none`,
          ),
          inert: xe,
          style: {
          ...
          onPointerEnter: J == null ? Ke : void 0,
          onPointerLeave: J == null ? qe : void 0,
          children: (0, $.jsxs)(`div`, {
            className: I(`relative w-max`, m && J == null && `overflow-hidden`),
            ...
            children: [
              ...
              (0, $.jsx)(`div`, {
                children: (0, $.jsx)(hn, {
                  activityCopies: e,
                  activityStackPresentation: t,
                  areActivityPillsLaidOut: d.tray != null,
                  areActivityPillsVisible: r,
                  isQuickChatVisible: Y,
                  isNotificationStackCollapsed: He,
                  isNotificationTrayExpanded: We,
                  isNotificationTrayVisiblyExpanded: Ve,
                  isTrayAboveMascot: d.placement.startsWith(`top`),
                  isGlobalDictationEnabled: c,
                  isGlobalDictationVisible: ye,
                  compositionSurfaceId: J,
                  nativeMaterialAttached: m,
                  nativePresentationOwnsMotion: le,
                  usesStableBackingCanvases: ue,
                  notifications: _,
                  notificationFollowUp: y,
                  expandedNotificationIds: s,
                  pointerSurfaceId: b,
                  ...
                  onActivityStackScroll: C,
                  onActivateNotification: w,
                  onGlobalDictationVisibilityChange: _e,
                  trayMaxHeight: Ge,
                  onDismissNotification: v === 1 || u ? N : void 0,
                  onOpenNotificationActions: F,
                  onNotificationExpansionChange: M,
                  onRunNotificationControl: L,
                  onRunNotificationAction: R,
                  ...
                  onQuickChatEditorActiveChange: (e) => {
                    ((fe.current = e), te?.(e), e ? Ke() : qe());
                  },
                  onQuickChatDraftChange: z,
                  onTrayAnimationFrame: ie,
                  onQuickChatPointerEnter: Ke,
                  onQuickChatPointerLeave: qe,
                  onSubmitQuickChat: H,
                  quickChatDraft: U,
                  quickChatEnabled: W,
                }),
        ...
        J == null && je === `voice-orb` && K != null
          ? (0, $.jsx)(`div`, {
              "aria-hidden": K.statusText == null || void 0,
              className: I(
                `pointer-events-none absolute z-30 -translate-x-1/2 -translate-y-1/2`,
                K.statusText == null && `invisible`,
              ),
              style: Et({ mascot: Me, orbScale: Un }),
              children: (0, $.jsx)(yt, {
                isNativeMeasurementPlaceholder: m,
                nativeMaterialAttached: m,
                style: { maxWidth: Dt({ mascot: Me, viewport: d.viewport }) },
                text: K.statusText ?? `\xA0`,
              }),
            })
          : null,
        (J == null && i != null) || B(J)
                ...
                (0, $.jsx)(x, {
                  ...
                  children: (0, $.jsx)(`div`, {
                    "data-avatar-overlay-hit-region":
                      je === `hidden` ? void 0 : `mascot`,
                    className: `h-full w-full`,
                    onPointerEnter: Ke,
                    onPointerLeave: qe,
                    children: (0, $.jsxs)(rt, {
                      className: `relative size-full`,
                      handoff: K?.handoff ?? null,
                      ...
                      children: [
                            ...
                            J == null && Ie && Je != null
                              ? (0, $.jsx)(
                                  Ye,
                                  {
                                    ...
                                    notificationBadge: Je,
                                    presentationPosition:
                                      Ae == null
                                        ? void 0
                                        : {
                                            left: `calc(50% + ${Ae.x - 12}px)`,
                                            top: Ae.y,
                                          },
                                  },
                                  `mascot-badge`,
                        ...
                        je === `hidden`
                          ...
                          : (0, $.jsx)(re, {
                              reducedMotion: `never`,
                              children: (0, $.jsx)(Bt, {
                                areControlsVisible: je === `voice-orb` || B(b),
                                canStart: K?.canStart ?? !1,
                                isRealtimeVoiceSurfaceVisible:
                                  je === `voice-orb`,
                                isMicrophoneMuted: K?.microphoneMuted ?? !1,
                                isMuted: K?.muted ?? !1,
                                isInert: q?.type === `native-root` && m,
                                nativeMaterialAttached: m,
                                nativeSurfacePosition: K?.nativeSurfacePosition,
                                nativeSurfaceId: n(J) ? J : void 0,
                                phase: Oe,
                                placement: d.placement,
                                mascot: d.mascot,
                                showsNotificationBadge: De,
                                willResume: K?.willResume,
                                onStart: K?.onStart,
                                onStop: K?.onStop,
                                onToggleMicrophoneMute:
                                  K?.onToggleMicrophoneMute,
                                onToggleMute: K?.onToggleMute,
                              }),
                            }),
                      ],
                    }),
...
function hn(e) {
  ...
  let re = V,
    H;
  t[20] !== B || t[21] !== re
    ? ((H = (0, $.jsxs)($.Fragment, { children: [B, re] })),
      (t[20] = B),
      (t[21] = re),
      (t[22] = H))
    : (H = t[22]);
  ...
  let G;
  t[51] !== O || t[52] !== W
    ? ((G = (0, $.jsx)(ae, { initial: !1, onExitComplete: O, children: W })),
      (t[51] = O),
      (t[52] = W),
      (t[53] = G))
    : (G = t[53]);
...
function gn(e) {
  ...
  t[0] === d
    ? (E = t[1])
    : ((E = d ? { duration: 0 } : { duration: 0.3, ease: [0.16, 1, 0.3, 1] }),
      (t[0] = d),
      (t[1] = E));
  let D = E;
  if (r != null) {
  ...
  let O;
  t[27] !== n?.[0]?.notificationListAriaLabel || t[28] !== T
    ? ((O =
        n?.[0]?.notificationListAriaLabel ??
        T.formatMessage(Wn.notificationList)),
  ...
  t[30] === A
    ? (j = t[31])
    : ((j = I(`relative w-[345px] max-w-full shrink-0`, A)),
      (t[30] = A),
      (t[31] = j));
  let M;
      ...
      ? ((e = (e, t) => {
          ...
          return (
            c === `primary`
              ? (T = `relative z-20`)
              : l &&
                (T = `pointer-events-none absolute top-0 right-0 left-0 z-10`),
            (0, $.jsx)(
              ne.div,
              {
                layout: !d,
...
function _n(e) {
  ...
  if (
    ...
    t[39] === r.slots
      ? (k = t[40])
      : ((k = r.slots.some(bn)), (t[39] = r.slots), (t[40] = k));
    let z = k,
      B =
        f.length > 1 && (s || d)
    ...
    t[43] !== c ||
    t[44] !== f.length
      ? ((V = c ? B : fe(f.length, r.slots[0]?.presentationRect.height)),
        (t[41] = r.slots[0]?.presentationRect),
        (t[42] = B),
        (t[43] = c),
        (t[44] = f.length),
      ...
      : (V = t[45]);
    let re = V,
      H = s && !u && i == null && r.contentHeight > r.viewportRect.height,
      ie;
    t[46] !== r.slots || t[47] !== H
      ? ((ie = H && r.slots.some(yn)),
        (t[46] = r.slots),
        (t[47] = H),
        (t[48] = ie))
      : (ie = t[48]);
    let ae = ie,
      oe;
    t[49] !== r.slots || t[50] !== H
      ? ((oe = H && r.slots.some(vn)),
        (t[49] = r.slots),
        (t[50] = H),
        (t[51] = oe))
      : (oe = t[51]);
    let U = oe;
    t[52] !== n?.[0]?.notificationListAriaLabel || t[53] !== E
      ? ((R =
          n?.[0]?.notificationListAriaLabel ??
        ...
        (t[54] = R))
      : (R = t[54]);
    let W = i == null && d && `overflow-hidden`;
    (t[55] === W
      ? (ee = t[56])
      : ((ee = I(`relative w-[345px] max-w-full shrink-0`, W)),
        (t[55] = W),
        (t[56] = ee)),
      (te = `notification-stack-visible-layout`),
      (O = `list`),
      t[57] === re
        ? (A = t[58])
      ...
      t[59] !== s || t[60] !== g
        ? ((j =
          ...
          (t[61] = j))
        : (j = t[61]));
    let G = H ? `-inset-x-6 overflow-hidden` : `inset-0`,
      K = H && (ae ? `top-0` : `-top-6`),
      q = H && (U ? `bottom-0` : `-bottom-6`),
      se = ae && U && fn.activityStackFadeBoth,
      ce = ae && !U && fn.activityStackFadeTop,
      J = !ae && U && fn.activityStackFadeBottom;
    t[62] !== G ||
    t[63] !== K ||
    t[64] !== q ||
    t[65] !== se ||
    ...
    let le = H ? `inset-x-6` : `inset-x-0`,
      ue = l
        ...
        : H && !ae
          ...
          : `top-0`;
    (t[69] !== le || t[70] !== ue
      ? ((D = I(`absolute`, le, ue)), (t[69] = le), (t[70] = ue), (t[71] = D))
      : (D = t[71]),
      (M = `true`),
      (N = `notification-stack-backing-layout`),
      t[72] === B
        ? (P = t[73])
        : ((P = { height: B }), (t[72] = B), (t[73] = P)),
      (F = r.slots.map((t) => {
        let { itemId: c, presentationRect: l, slotId: g, zIndex: E } = t;
        ...
        let O = n?.[f.indexOf(D)],
          k =
            D === f[0] &&
            (!d ||
              (s ? g !== `activity-slot-8` : g === `activity-slot-8` || !z)),
          A = !s && !k;
        ...
        return (0, $.jsx)(
          ne.div,
          {
            ...
            children: (0, $.jsx)(wn, {
              ...
              notificationFollowUp: p,
              publishesFollowUpVisibility: h,
              isExpanded: x == null ? void 0 : a.includes(D.id),
              onAnimationFrame: v,
    ...
    ((D = t[27]),
      ...
      (te = t[38]));
  let z;
  t[74] !== D || t[75] !== M || t[76] !== N || t[77] !== P || t[78] !== F
    ? ((z = (0, $.jsx)(`div`, {
        className: D,
  ...
  let B;
  t[80] !== z || t[81] !== L
    ? ((B = (0, $.jsx)(`div`, { className: L, children: z })),
      (t[80] = z),
      (t[81] = L),
      (t[82] = B))
    : (B = t[82]);
...
function Sn({
  ...
  let f = h(G),
    ...
    D = e ? 160 : 85,
    O = C.length === 0 ? D : 344,
    A = (0, Q.useEffectEvent)(() => {
      _.current && ((_.current = !1), a?.(!1));
    }),
    j = () => {
      o != null && window.requestAnimationFrame(o);
    },
    M = (e) => {
      (d ?? S(e), s?.(e), j(), T(null));
    },
    N = async (e) => {
      if (!(e.length === 0 || v || u == null)) {
        (b(!0), T(null));
        try {
          (await u(e), M(``));
        } catch {
          T(p.formatMessage(Wn.quickChatError));
        } finally {
          b(!1);
        }
      }
    ...
    F = i.supportState,
    {
      ...
      cleanupEnabled: i.cleanupEnabled,
      enabled: F === !0,
      onTranscriptInsert: (e) => {
        let t = z(C, e);
        t !== C && (M(t), m.current?.focus());
      },
      onTranscriptSend: (e) => {
        let t = z(C, e);
        (M(t), N(t.trim()));
      ...
      onStartError: (e) => {
        (f.get(g).danger(De(p, `start`, e).message),
          ye.error(`[AvatarOverlay] unable to start dictation`, {
            safe: {},
            sensitive: { error: e },
          }));
      },
      onTranscribeError: (e) => {
        (f.get(g).danger(De(p, `transcription`, e).message),
          ye.error(`[AvatarOverlay] dictation failed`, {
            safe: {},
            sensitive: { error: e },
          }));
      },
  ...
  ((0, Q.useLayoutEffect)(
    ...
    P(
      ...
      () => {
        _.current && m.current?.focus();
      },
      [],
    ));
  let H = async (e) => {
    (e.preventDefault(), e.stopPropagation(), !(R || ee) && (await N(E)));
  };
  return (0, $.jsxs)(ft, {
    emptyWidth: D,
    nativeMaterialAttached: t,
      ...
      (0, $.jsx)(ne.div, {
        ...
        children: re
          ? (0, $.jsx)(me, {
              ...
              color: `secondary`,
              idleIcon: (0, $.jsx)(pe, { className: `icon-sm` }),
              isDictating: R,
              isVisible: !0,
              isTranscribing: ee,
              canRetryDictation: L,
          ...
          : (0, $.jsx)(W, {
              ...
              className: `size-7 shrink-0 !bg-[#636363] !text-white enabled:hover:!bg-[#636363] disabled:opacity-100 electron:!rounded-full`,
              color: `secondary`,
              disabled: E.length === 0 || v,
              loading: v,
              size: `icon`,
              type: `submit`,
              children: v ? null : (0, $.jsx)(r, { className: `icon-sm` }),
            }),
      }),
      w == null
        ? null
...
function Cn(e) {
  ...
  t[0] === m
    ? (y = t[1])
    : ((y = (e) => {
        let t = Ve(e.currentTarget);
        v.current !== t &&
          ((v.current = t), m(e.currentTarget.value, Ne(e.currentTarget)));
      }),
      (t[0] = m),
      (t[1] = y));
  let b = y,
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = { height: `auto`, marginBottom: 14, opacity: 1, y: 0 }), (t[2] = S))
    : (S = t[2]);
  let C;
  t[3] !== o || t[4] !== d
    ? ((C = o
  ...
  t[22] === p
    ...
    : ((N = (e) => {
        ...
        e.key === `Escape` && (e.stopPropagation(), p());
      }),
      (t[22] = p),
      (t[23] = N));
  let P;
...
function wn(e) {
  let t = (0, zn.c)(206),
    {
      ...
      notification: f,
      notificationFollowUp: p,
      publishesFollowUpVisibility: m,
      onAnimationFrame: h,
      role: g,
      onActivateNotification: _,
      onDismissNotification: v,
      onOpenNotificationActions: y,
      onExpansionChange: b,
      onRunNotificationControl: x,
  ...
  let D = E,
    ...
    [re, H] = (0, Q.useState)(p?.draft ?? ``),
    [ie, oe] = (0, Q.useState)(!1),
    [U, G] = (0, Q.useState)(null),
    K = s || (!u && ie),
    q = (0, Q.useRef)(null),
    se = (0, Q.useRef)(null),
    ce = (0, Q.useRef)(null),
    J = (0, Q.useRef)(void 0),
    le = f.kind === `activity` && n && _ != null,
    ue = le || (f.kind !== `activity` && (_ != null || f.action != null)),
    de = f.controlTarget != null && x != null,
    fe = f.isLoading && de,
    pe = f.kind !== `activity` && v != null && !fe,
    me = !o && f.notificationPreferenceId != null && y != null,
    he = R || L,
    ge = j != null && he,
    _e = j != null && !fe && !he,
    ve = de && B !== void 0 && B === f.turnKey,
    ye = p?.notificationId === f.id && p.turnKey === f.turnKey ? p : null,
    Y = p !== void 0,
    xe = u && !a ? re : (ye?.draft ?? re),
    Se = de && (Y ? ye != null : ve),
    Ce = de && (!o || Se),
    Te = fe && (Se || (!o && K)),
    De = Ce && (Se || (!o && K)),
    Oe = ye?.submissionStatus === `error`,
    ke = ye?.submissionStatus === `submitting`,
    Ae = m && Se,
    je = u && !a && de,
    Me = j != null || Te,
    Ne = u && s && U === `reply`,
  ...
  t[4] !== te || t[5] !== j
    ? ((Ie = (e) => {
        if ((J.current?.(), (J.current = void 0), e == null || j == null))
          return;
        let t = () => {
          let t = Array.from(
              e.querySelectorAll(
          ...
          te((e) => (z.current && e ? e : t || r));
        };
        (t(), (J.current = at({ axis: `both`, target: e, onChange: t })));
      }),
      (t[4] = te),
      (t[5] = j),
      (t[6] = Ie))
  ...
  (t[10] === L
    ...
    : ((Ve = () => {
      ...
      (t[11] = Ve),
      (t[12] = He)),
    (0, Q.useLayoutEffect)(Ve, He));
  let Ue;
  t[13] !== Y || t[14] !== Be || t[15] !== Ae
    ? ((Ue = () => {
        if (Ae)
          return Y
            ? (Be({ type: `follow-up-active-changed`, isActive: !0 }),
              () => {
                Be({ type: `follow-up-active-changed`, isActive: !1 });
              })
            : (Be({ type: `open-follow-up` }),
              () => {
                Be({ type: `close-follow-up` });
              });
      }),
      (t[13] = Y),
      (t[14] = Be),
  ...
  let We;
  (t[17] !== Y || t[18] !== Ae
    ? ((We = [Y, Ae]), (t[17] = Y), (t[18] = Ae), (t[19] = We))
    : (We = t[19]),
    (0, Q.useEffect)(Ue, We));
  let Ke, Je;
  (t[20] === ve
    ...
    : ((Ke = () => {
      ...
      (t[21] = Ke),
      (t[22] = Je)),
    P(`avatar-overlay-keyboard-interaction-ready`, Ke, Je));
  let Ye;
  t[23] !== Y || t[24] !== f || t[25] !== x || t[26] !== V || t[27] !== H
    ? ((Ye = () => {
        (H(``), V(void 0), Y && x?.(f, { type: `close-follow-up` }));
      }),
      (t[23] = Y),
      (t[24] = f),
      (t[25] = x),
  ...
  let Xe = Ye,
    Ze = lt,
    Qe = f.isLoading && fn.activityPillLoading,
    $e = j != null && fn.activityPillWaitingRequest,
    et = _e && fn.activityPillSingleControl,
    tt;
  t[29] !== Qe || t[30] !== $e || t[31] !== et
    ? ((tt = I(
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((rt = () => {
      ...
      (t[38] = it),
      (t[39] = ot))
    : ((rt = t[37]), (it = t[38]), (ot = t[39]));
  let st;
  t[40] !== a || t[41] !== u
    ? ((st = (e) => {
        if (!u || a) return;
        let t = e.target;
        if (t instanceof Node && se.current?.contains(t)) {
          G(`reply`);
          return;
        }
      ...
      (t[42] = st))
    : (st = t[42]);
  let ct = ue || me ? `button` : void 0,
    ut;
  t[43] !== me ||
  t[44] !== D.actionAriaLabel ||
  t[45] !== D.expandNotificationStackAriaLabel ||
  t[46] !== le ||
  t[47] !== w ||
  t[48] !== ue ||
  t[49] !== f.title
    ? ((ut = le
        ? D.expandNotificationStackAriaLabel
        : ue
          ? D.actionAriaLabel
          : me
            ? w.formatMessage(ee.notificationActions, { title: f.title })
            : void 0),
      (t[43] = me),
      (t[44] = D.actionAriaLabel),
      (t[45] = D.expandNotificationStackAriaLabel),
    ...
    : (ut = t[50]);
  let dt = c && `opacity-0`,
    ft = De && fn.activityPillContentFade,
    pt = ue ? `cursor-interaction` : `cursor-default`,
    mt;
  t[51] !== dt || t[52] !== ft || t[53] !== pt
    ? ((mt = I(
      ...
      (t[54] = mt))
    : (mt = t[54]);
  let ht = ue || me ? 0 : void 0,
    gt;
  t[55] !== ue || t[56] !== f || t[57] !== _ || t[58] !== S
    ? ((gt = () => {
        if (ue) {
          if (_ != null) {
            _(f.id);
  ...
  t[65] !== S
    ? ((_t = (e) => {
      ...
      (t[66] = _t))
    : (_t = t[66]);
  let vt = f.kind !== `activity` && `font-bold`,
    yt = j != null && `pr-[38px]`,
    bt = Fe && `line-clamp-2`,
    xt =
      !Fe && (j != null && L ? `break-words whitespace-pre-wrap` : `truncate`),
    St = f.kind === `activity` && `text-token-text-secondary`,
    Ct = f.kind !== `activity` && `text-token-foreground`,
    Tt;
  t[67] !== vt ||
  t[68] !== yt ||
  t[69] !== bt ||
  ...
  t[71] !== St ||
  t[72] !== Ct
    ? ((Tt = I(`text-[13px] leading-[17px]`, vt, yt, bt, xt, St, Ct)),
      (t[67] = vt),
      (t[68] = yt),
      (t[69] = bt),
      (t[70] = xt),
    ...
    : (Tt = t[73]);
  let Et;
  t[74] !== D.subtitle || t[75] !== f.isLoading || t[76] !== Fe
    ? ((Et =
        Fe &&
        (0, $.jsxs)($.Fragment, {
          children: [
  ...
  let Ot;
  t[82] !== L || t[83] !== j
    ? ((Ot = j == null ? void 0 : { maxHeight: L ? Vn : Bn }),
      (t[82] = L),
      (t[83] = j),
      (t[84] = Ot))
    : (Ot = t[84]);
  let kt = (f.kind === `activity` || Fe) && `hidden`,
    At = j == null && `truncate`,
    jt =
      j != null && (L ? `overflow-y-auto overscroll-contain` : `overflow-clip`),
    Mt;
  t[85] !== kt || t[86] !== At || t[87] !== jt
    ? ((Mt = I(
  ...
  t[89] === T
    ...
    : ((Pt = T
      ...
      (t[90] = Pt));
  let Ft;
  t[91] !== D.subtitle || t[92] !== f.isLoading || t[93] !== Fe || t[94] !== j
    ? ((Ft =
        j == null &&
        !Fe &&
        (0, $.jsx)(`span`, {
  ...
  t[102] !== j
    ? ((It =
        ...
        (0, $.jsx)(Tn, {
          isExpanded: L,
          nativeMaterialAttached: l,
          patchSummaryCopy: D.patchSummary,
          request: j,
  ...
  t[109] !== It
    ? ((Lt = (0, $.jsxs)(ne.div, {
        ...
        className: Mt,
        initial: !1,
        "data-avatar-overlay-overflow-content": Nt,
        "data-avatar-overlay-waiting-request-body": `true`,
        transition: Pt,
        children: [Ft, It],
      })),
  ...
  t[119] !== Lt
    ? ((Rt = (0, $.jsxs)(ne.div, {
      ...
      (t[120] = Rt))
    : (Rt = t[120]);
  let zt = D.statusIconAriaLabel,
    Bt = A.iconType,
    Vt = A.iconType === `check-circle` ? `success` : void 0,
    Ht = (Me || (l && u && A.iconType === `check-circle`)) && `opacity-0`,
    Ut;
  t[121] === Ht
    ? (Ut = t[122])
    : ((Ut = I(
  ...
  let Wt =
      j?.kind === `question`
        ? (0, $.jsx)(M, { className: A.iconClassName })
        : Ln(A),
    Gt;
  t[123] !== Ut || t[124] !== Wt
    ? ((Gt = (0, $.jsx)(`span`, { className: Ut, children: Wt })),
      (t[123] = Ut),
      (t[124] = Wt),
      (t[125] = Gt))
    : (Gt = t[125]);
  let Kt;
  t[126] !== D.statusIconAriaLabel ||
  t[127] !== A ||
  t[128] !== Vt ||
  t[129] !== Gt
    ? ((Kt = (0, $.jsx)(`span`, {
        ...
        "data-avatar-overlay-status": Bt,
        "data-avatar-overlay-trailing-accessory": Vt,
        children: Gt,
      })),
      (t[126] = D.statusIconAriaLabel),
      (t[127] = A),
    ...
    ? ((X = Ce
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(W, {
                ref: se,
                "aria-label": w.formatMessage(Wn.replyNotification, {
                  title: f.title,
                }),
                "aria-pressed": Se,
                ...
                className: I(
                  qn,
                  qe.replyStopControl,
                  l ? `enabled:hover:!bg-transparent` : qe.cssControl,
                ),
                color: `ghost`,
                size: `icon`,
                title: w.formatMessage(Wn.replyNotification, {
                  title: f.title,
                }),
                onClick: () => {
                  if (Se) {
                  ...
                  (H(``),
                    V(f.turnKey),
                    Y && x?.(f, { type: `open-follow-up` }),
                    je &&
                      window.requestAnimationFrame(() => {
                        q.current?.focus();
                      }));
                },
                children: (0, $.jsx)(wt, { className: `relative size-7` }),
              }),
              _e
                ? null
                : (0, $.jsx)(W, {
                    ref: ce,
                    "aria-label": w.formatMessage(Wn.stopNotification, {
                      title: f.title,
                    }),
                    "aria-hidden": !Te || void 0,
                    "data-native-hovered": Pe || void 0,
                    className: I(
                      qn,
                      !Te && `pointer-events-none opacity-0`,
                      qe.replyStopControl,
                      l ? `enabled:hover:!bg-transparent` : qe.cssControl,
                    ),
                    color: `ghost`,
                    ...
                    title: w.formatMessage(Wn.stopNotification, {
                      title: f.title,
                    }),
                    onClick: () => {
                      (H(``), V(void 0), x?.(f, { type: `stop` }));
                    },
                    children: (0, $.jsx)(Ee, {
  ...
  let qt;
  t[148] !== he ||
  t[149] !== D.collapseNotificationAriaLabel ||
  t[150] !== D.expandNotificationAriaLabel ||
  t[151] !== ge ||
  t[152] !== L ||
  t[153] !== l ||
  t[154] !== f.id ||
    ...
    ? ((qt = ge
        ? (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(W, {
              "aria-expanded": L,
              "aria-label": L
                ? D.collapseNotificationAriaLabel
                : D.expandNotificationAriaLabel,
              className: I(
              ...
              onClick: () => {
                L && te(!0);
                let e = !L;
                ((z.current = e), b == null ? F(e) : b(f.id, e));
              },
              children: (0, $.jsx)(ne.span, {
                animate: { rotate: L ? 0 : -90 },
                transition: T
                  ? { duration: 0 }
                  : { duration: 0.16, ease: [0.23, 1, 0.32, 1] },
                children: (0, $.jsx)(we, { className: `size-5` }),
              }),
            }),
          })
        : null),
    ...
    ? ((Z =
        Se || je
          ? (0, $.jsx)(Cn, {
              autoFocus: ve,
              draft: xe,
              hasSubmissionError: Oe,
              inputRef: q,
              isNativeMeasurementPlaceholder: a,
              isSubmitting: ke,
              isVisible: Se,
              keepsNativeBackingMounted: je,
              ...
              onSubmitFollowUp: (e) => {
                (Y || (H(``), V(void 0)),
                  x?.(f, { type: `submit-follow-up`, prompt: e }));
              },
            })
          : null),
      (t[160] = Xe),
  ...
  let Jt;
  t[176] !== h || t[177] !== Z
    ? ((Jt = (0, $.jsx)(ae, { onExitComplete: h, children: Z })),
      (t[176] = h),
      (t[177] = Z),
      (t[178] = Jt))
    : (Jt = t[178]);
  let Xt;
  t[179] !== pe ||
  t[180] !== D.dismissNotificationAriaLabel ||
  t[181] !== Se ||
  t[182] !== K ||
  t[183] !== u ||
  t[184] !== f ||
    ...
    ? ((Xt =
        pe && !Se
          ? (0, $.jsx)(`div`, {
              ...
              "data-avatar-overlay-chromium-overflow": `true`,
              children: (0, $.jsx)(Ge, {
                ariaLabel: D.dismissNotificationAriaLabel,
                onClick: () => {
                  v(f);
                },
              }),
...
function Tn(e) {
  ...
  switch (s.kind) {
    case `question`: {
      ...
      t[2] === e
        ? (o = t[3])
        : ((o = I(`min-w-0 pr-[38px]`, e)), (t[2] = e), (t[3] = o));
      let c;
      t[4] !== s.prompt || t[5] !== o
        ? ((c = (0, $.jsx)(`div`, {
            className: o,
...
function On(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = I(`min-w-0 pr-[38px]`, i)), (t[0] = i), (t[1] = a));
  let o;
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, $.jsx)(`div`, {
...
function kn(e) {
  ...
  if (!i) {
    ...
    t[6] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((o = (0, $.jsx)(je, { className: `mx-1.5 text-token-text-tertiary` })),
        (t[6] = o))
      : (o = t[6]);
    let s;
    t[7] === a
  ...
  t[20] !== o || t[21] !== s || t[22] !== c
    ...
    : (l = t[23]);
  let u;
  t[24] === r ? (u = t[25]) : ((u = r.map(An)), (t[24] = r), (t[25] = u));
  let d;
  t[26] === u
    ? (d = t[27])
    : ((d = (0, $.jsx)(`div`, {
...
function Ln(e) {
  switch (e.iconType) {
    ...
    case `clock`:
      return (0, $.jsx)(ke, { className: e.iconClassName });
    case `spinner`:
      return null;
    case `warning`:
      return (0, $.jsx)(U, { className: e.iconClassName });
  }
}
function Rn(e) {
  let t = e.tray;
...
//# sourceMappingURL=avatar-overlay-native-frame-7AJGWkAc.js.map
