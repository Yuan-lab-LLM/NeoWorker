...
import { n as ve, t as ye } from "./use-git-recent-branches-C-3Xty1U.js";
var be,
  xe = e(() => {
...
function Se({ reviewInstructions: e, requestMessage: t }) {
  return [A, be.trim(), e.trim(), B, t].join(`
`);
}
...
function we(e) {
  ...
  t[0] !== n || t[1] !== s || t[2] !== o || t[3] !== a
    ? ((c = async (e) => {
        let { context: t, conversationId: r, delivery: i } = e,
          { gitRoot: c, cwd: l } = t,
          u = await Ce({ context: t, hostId: n, intl: o }),
          d = r == null ? null : a.get(Z, r);
        if (i === `inline` && r != null && d === n) {
          if (s == null) throw Error(`Code review host is unavailable`);
          return (
            await N(`start-turn-for-host`, {
              hostId: s.getHostId(),
              conversationId: r,
              params: {
                cwd: l,
        ...
        let f = await N(`start-conversation`, {
          hostId: n,
          input: [{ type: `text`, text: u.prompt, text_elements: [] }],
          cwd: l,
          workspaceRoots: [c],
  ...
  t[7] === r
    ? (u = t[8])
    : ((u = (e) => {
        (pe.error(`Failed to start quick review conversation`, {
          safe: {},
          sensitive: { error: e },
        }),
          r(e));
  ...
  return (
    t[9] !== c || t[10] !== l || t[11] !== u
      ? ((d = { mutationFn: c, onSuccess: l, onError: u }),
        (t[9] = c),
        (t[10] = l),
        (t[11] = u),
        (t[12] = d))
...
function Ie(e) {
  ...
  t[0] === p
    ? (m = t[1])
    : ((m = { retainRepoWatch: p }), (t[0] = p), (t[1] = m));
  let {
      data: h,
      error: _,
      isFetching: v,
      isLoading: y,
      refetch: b,
    } = E(a, o, `review_mode_content`, m),
    S;
  t[2] === p
    ? (S = t[3])
    : ((S = { retainRepoWatch: p }), (t[2] = p), (t[3] = S));
  let {
      data: C,
      isLoading: D,
      isError: O,
      refetch: k,
    } = ke(a, o, `review_mode_content`, S),
    A;
  t[4] === p
    ? (A = t[5])
    : ((A = { retainRepoWatch: p }), (t[4] = p), (t[5] = A));
  let {
      data: M,
      isLoading: N,
      isError: P,
      refetch: F,
    } = ve(a, o, `review_mode_content`, A),
    I = te(i.reviewDelivery),
    L;
  t[6] !== l || t[7] !== s || t[8] !== c
    ? ((L = (e) => {
        (s.release(),
          pe.error(`Failed to start code review`, {
            safe: {},
            sensitive: { error: e },
          }),
          c.get(ee).danger(
    ...
    : (L = t[9]);
  let R;
  t[10] !== n || t[11] !== f || t[12] !== s || t[13] !== c
    ? ((R = (e) => {
        if ((s.release(), ge(c, e.diffFilter), e.delivery === `detached`)) {
          (u(c, e.conversationId, e.baseBranch), f(e.conversationId));
          return;
        }
        u(c, n, e.baseBranch);
        let t = c.get(me.activeTab$)?.tabId;
        (he(c, !t?.startsWith(`sidechat:`)), c.set(x, !1));
      }),
      (t[10] = n),
      (t[11] = f),
      (t[12] = s),
  ...
  let { mutate: B, isPending: V, variables: H } = we(z),
    de = V && H?.context.mode === `uncommitted`,
  ...
  t[105] !== I ||
  t[106] !== H
    ? ((Z = [C, n, h, _, r, a, o.id, O, D, v, y, P, N, V, M, I, H]),
      (t[90] = C),
      (t[91] = n),
      (t[92] = h),
      (t[93] = _),
...
//# sourceMappingURL=review-slash-command-submenu-registration-B3zRjvHe.js.map
