...
function F(e) {
  let t = (0, I.c)(64),
    ...
    l = O(r),
    {
      cancelPendingWorktree: d,
      clearPendingWorktreeAttention: f,
      createPendingWorktree: m,
      retryPendingWorktree: g,
    } = fe(),
    y;
  t[0] !== m ||
  t[1] !== a ||
  ...
  t[5] !== i
    ? ((y = async () => {
        if (l == null || l.launchMode !== `create-stable-worktree`) return;
        let e = await _(i, l.hostId, null),
          t = await N({
            createPendingWorktree: m,
            intl: a,
            pendingWorktree: l,
  ...
  t[13] !== n || t[14] !== l
    ? ((T = () => {
        ...
        l === void 0 || !w.current || n();
      }),
      (t[13] = n),
      (t[14] = l),
      (t[15] = T))
    : (T = t[15]);
  let k = (0, L.useEffectEvent)(T),
    j;
  t[16] === k
    ? (j = t[17])
    : ((j = () => {
      ...
      (t[17] = j));
  let M;
  (t[18] === l ? (M = t[19]) : ((M = [l]), (t[18] = l), (t[19] = M)),
    (0, L.useEffect)(j, M));
  let P;
  t[20] !== f || t[21] !== r
    ? ((P = () => {
  ...
  if (
    ...
    (0, L.useEffect)(z, B),
    l == null || l.launchMode !== `create-stable-worktree`)
  )
    return null;
  let V;
  t[27] === l.phase
    ? (V = t[28])
    : ((V = le(l.phase)), (t[27] = l.phase), (t[28] = V));
  let H = V,
    U = l.phase === `failed`,
    W =
      U &&
      l.worktreeGitRoot != null &&
      l.worktreeWorkspaceRoot != null &&
      l.localEnvironmentConfigPath != null,
    G;
  t[29] === n
    ? (G = t[30])
    : ((G = (e) => {
  ...
  t[31] === l.label
    ? (K = t[32])
    : ((K = (0, R.jsx)(ae, { className: `contents`, children: l.label })),
      (t[31] = l.label),
      (t[32] = K));
  let q;
  ...
  t[34] === K
    ? (J = t[35])
    : ((J = (0, R.jsx)(A, {
        children: (0, R.jsx)(p, { title: K, subtitle: q }),
      })),
      (t[34] = K),
      (t[35] = J));
  let Y;
  t[36] !== d || t[37] !== H || t[38] !== n || t[39] !== l.id
    ? ((Y = H
        ? (0, R.jsx)(x, {
            color: `secondary`,
            onClick: () => {
  ...
  t[47] !== l.hostId ||
  t[48] !== l.id ||
  t[49] !== l.localEnvironmentConfigPath ||
  t[50] !== l.sourceWorkspaceRoot ||
  t[51] !== g ||
  t[52] !== i
    ? ((X = U
        ? (0, R.jsxs)(R.Fragment, {
            children: [
              (0, R.jsx)(x, {
                ...
                onClick: () => {
                  if (
                    (de(i, l.hostId), n(), l.localEnvironmentConfigPath != null)
                  ) {
                    c(
                      ce({
                        configPath: l.localEnvironmentConfigPath,
                        workspaceRoot: l.sourceWorkspaceRoot,
                      }),
                      {
                        state: {
                          hostId: l.hostId,
                          reopenStableWorktreeId: l.id,
                  ...
                  c(`/settings/local-environments?${e.toString()}`);
                },
                children: (0, R.jsx)(v, {
...
//# sourceMappingURL=stable-worktree-status-dialog-CQRmhDRG.js.map
