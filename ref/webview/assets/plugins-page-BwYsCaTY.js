...
import { n as Xi, t as Zi } from "./toolbar-breadcrumb-COhCwKVT.js";
import { n as Qi, r as $i, t as ea } from "./use-home-directory-Ca_CpGeT.js";
import { n as ta, t as na } from "./connector-logo-stack-iQ1syRDg.js";
import { r as ra, t as ia } from "./esm-CafTuWNK.js";
import { n as aa, t as oa } from "./use-media-query-_4fcOL58.js";
import {
  $ as sa,
  A as ca,
  B as la,
  ...
  y as yo,
  z as bo,
} from "./plugin-detail-page-DVo0QfWH.js";
import { n as xo, t as So } from "./control-group-BUQ6z2CV.js";
function Co(e) {
  let t = (0, wo.c)(13),
    {
      directoryEntrypoint: n,
      errorMessage: r,
      isPageLoading: i,
      isPluginDataLoading: a,
      pageName: o,
      routeKey: s,
    } = e,
    c = (0, To.useRef)(!1),
  ...
  (t[4] === d
    ...
    : ((f = () => {
        ...
        let e =
          l.current ??
          st.start(`plugins_page_load`, d.attributes, {
            key: d.routeKey,
            startedAtMs: d.startedAtMs,
            traceAttributes: {
              "plugins.entrypoint": d.attributes.entrypoint,
              "plugins.page_kind": d.attributes.pageKind,
            },
          });
        return (
          (l.current = e),
          e.mark(`page_committed`),
          () => {
            ((c.current = !1),
              queueMicrotask(() => {
                !c.current && e.isRecording() && e.abort(`navigation_away`);
              }));
          }
        );
      }),
  ...
  if (
    (t[7] !== r || t[8] !== a
      ? ((m = () => {
          !a && r == null && l.current?.mark(`plugin_data_ready`);
        }),
        (h = [r, a]),
        (t[7] = r),
        (t[8] = a),
      ...
      : ((g = (0, Eo.jsx)(Ir, {
          onPaint: () => {
            ...
            e == null ||
              !e.isRecording() ||
              (r == null
                ? (e.mark(`content_visible`), e.end())
                : e.fail(`plugin_list_failed`));
          },
        })),
        (t[11] = r),
        (t[12] = g)),
...
var wo,
  ...
  ko = e(() => {
    ((wo = z()),
      ...
      (Eo = T()),
      (Do = {
        [Me.CODEX_PLUGIN_DIRECTORY_ENTRYPOINT_DIRECT]: `direct`,
        [Me.CODEX_PLUGIN_DIRECTORY_ENTRYPOINT_SETTINGS]: `settings`,
        [Me.CODEX_PLUGIN_DIRECTORY_ENTRYPOINT_SIDEBAR]: `sidebar`,
        [Me.CODEX_PLUGIN_DIRECTORY_ENTRYPOINT_OTHER]: `other`,
        [Me.CODEX_PLUGIN_DIRECTORY_ENTRYPOINT_UNSPECIFIED]: `other`,
        [Me.UNRECOGNIZED]: `other`,
      }),
      (Oo = {
        [qi.CODEX_PLUGIN_PAGE_NAME_CATEGORY]: `category`,
        [qi.CODEX_PLUGIN_PAGE_NAME_DIRECTORY]: `directory`,
        [qi.CODEX_PLUGIN_PAGE_NAME_PERSONAL]: `personal`,
        [qi.CODEX_PLUGIN_PAGE_NAME_SEARCH]: `search`,
        [qi.CODEX_PLUGIN_PAGE_NAME_WORKSPACE]: `workspace`,
      }));
  });
function Ao(e) {
  let t = e.source.trim();
...
function No(e) {
                    ...
                    children: (e) => {
                      let t =
                        c > 0 || e.state.meta.isBlurred
                          ? (e.state.meta.errors.find(Po) ?? null)
                          : null;
                      ...
                      (0, U.jsxs)(`label`, {
                        ...
                        children: [
                          ...
                          (0, U.jsx)(`textarea`, {
                            ...
                            className: wn(Vo, `min-h-20 resize-y`),
                            disabled: n,
                            onBlur: e.handleBlur,
                            onChange: (t) => {
                              e.handleChange(t.target.value);
  ...
  return (
    t[9] !== u.Subscribe || t[10] !== d
      ? ((f = (0, U.jsx)(u.Subscribe, { selector: Lo, children: d })),
        (t[9] = u.Subscribe),
        (t[10] = d),
        (t[11] = f))
      : (f = t[11]),
...
var Ro,
  ...
  Ho = e(() => {
    ((Ro = z()),
      ...
      Mo(),
      (U = T()),
      (Bo = `flex flex-col gap-1.5 text-sm text-token-description-foreground`),
      (Vo = `w-full rounded-md border border-token-input-border bg-token-input-background px-2.5 py-1.5 text-base text-token-input-foreground outline-none placeholder:text-token-input-placeholder-foreground focus:border-token-focus-border`));
  });
function Uo(e) {
  let t = Wo.parse(e);
  return {
    categoryIds: t.category_ids,
    collapsedCategoryIds: t.collapsed_category_ids,
    sections: t.sections.map((e) => ({ id: e.id, pluginIds: e.plugin_ids })),
  };
}
var Wo,
  Go = e(() => {
    (cr(),
      (Wo = fn({
        category_ids: An(zi()).default([]).catch([]),
        collapsed_category_ids: An(zi()).default([]).catch([]),
        sections: An(
          fn({ id: zi(), plugin_ids: An(zi()).default([]).catch([]) }),
        )
          .default([])
          .catch([]),
      }).catch({
...
function Ko(e) {
  return { hiddenPluginIds: qo.parse(e).hidden_plugin_ids };
}
var qo,
  Jo = e(() => {
    (cr(),
      (qo = fn({ hidden_plugin_ids: An(zi()).default([]) }).catch({
        hidden_plugin_ids: [],
      })));
  }),
  Yo,
  ...
  Zo,
  Qo = e(() => {
    ((Yo = `_container_1ujd8_1`),
      (Xo = `_grid_1ujd8_5`),
      (Zo = { container: Yo, grid: Xo }));
  });
function $o(e) {
  let t = (0, ts.c)(5),
    { children: n, className: r } = e,
    i;
  t[0] === r ? (i = t[1]) : ((i = wn(r, Zo.container)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
      ? ((a = (0, ns.jsx)(`div`, { className: i, children: n })),
        (t[2] = n),
        (t[3] = i),
        (t[4] = a))
      : (a = t[4]),
...
function es(e) {
  ...
  return (
    t[4] !== n || t[5] !== u
      ? ((d = (0, ns.jsx)(`div`, { className: u, children: n })),
        (t[4] = n),
        (t[5] = u),
        (t[6] = d))
      : (d = t[6]),
...
function as(e) {
  let t = (0, hs.c)(62),
    {
      ...
      homeDirectory: s,
      isLoading: c,
      installedStateAction: l,
      installButtonLabel: u,
      highlightedPluginKey: d,
      pluginInstallationStatus: f,
      isSingleColumn: p,
      flushCards: m,
      getCopyLinkUrl: h,
      hostId: g,
      gridGap: _,
      reducedMotion: v,
      useCompactEmptyState: y,
      plugins: b,
      emptyStateTitle: x,
      onInstallPlugin: S,
      onCopyShareLink: C,
      onOpenPluginDetails: w,
      onShareInstalledPlugin: T,
      onTryInChat: E,
      onUninstallInstalledPlugin: D,
      onToggleInstalledPluginEnabled: O,
      pendingPluginId: k,
      uninstalling: A,
      unavailablePluginIds: j,
    } = e,
    M = i === void 0 ? `compact` : i,
    N = l === void 0 ? `status` : l,
    P = f === void 0 ? null : f,
    F = p === void 0 ? !1 : p,
    I = m === void 0 ? !1 : m,
    L = _ === void 0 ? `compact` : _,
    ee = v === void 0 ? !1 : v,
    R = y === void 0 ? !1 : y,
    ne = r(`1269116100`);
  if (c) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, W.jsx)(`div`, {
            className: `flex h-full min-h-full flex-1 items-center justify-center px-6 py-8 text-center`,
            children: (0, W.jsx)(Pr, {
              children: (0, W.jsx)(B, { ...G.pageLoading }),
            }),
          })),
          (t[0] = e))
        : (e = t[0]),
  ...
  if (o) {
    ...
    t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, W.jsx)(B, { ...G.loadErrorTitle })), (t[1] = e))
      : (e = t[1]);
    let n;
      ...
      t[5] !== a || t[6] !== x || t[7] !== R
        ? ((e = (0, W.jsx)(`div`, {
            ...
            children: R
              ...
              : (0, W.jsx)(sr, { title: x, description: a }),
          })),
          (t[5] = a),
          (t[6] = x),
          (t[7] = R),
      ...
      ? ((e = (e, t) =>
          (0, W.jsxs)(
            gs.Fragment,
            {
              children: [
                (0, W.jsx)(os, {
                  contentClassName: M === `compact` ? `!gap-px` : void 0,
                  installedStateAction: N,
                  installProgressPercent: Hr(P, g, e.plugin.id),
                  installPhase: Yn(P, g, e.plugin.id),
                  isInstallLocked: P != null,
                  isUpdatingEnabled: k === e.plugin.id,
                  isUninstalling:
                    g != null &&
                    A != null &&
                    te(A, { hostId: g, pluginId: e.plugin.id }),
                  reducedMotion: ee,
                  cardClassName: I ? `!rounded-none !border-0` : n,
                  copyLinkUrl:
                    e.plugin.shareContext?.shareUrl ?? h?.(e) ?? null,
                  ...
                  homeDirectory: s,
                  hostId: g,
                  isPluginSharingEnabled: ne,
                  isUnavailableInCurrentContext: j?.has(e.plugin.id),
                  isHighlighted: d === hi(e),
                  installButtonLabel: u,
                  onInstallPlugin: S,
                  onTryInChat: E,
                }),
...
function os(e) {
  let t = (0, hs.c)(173),
    {
      ...
      homeDirectory: a,
      hostId: s,
      installedStateAction: c,
      installButtonLabel: l,
      installPhase: u,
      installProgressPercent: f,
      isInstallLocked: p,
      isUpdatingEnabled: h,
      isUninstalling: g,
      reducedMotion: _,
      onCopyShareLink: y,
      onOpenPluginDetails: b,
      onShareInstalledPlugin: x,
      onUninstallInstalledPlugin: S,
      onToggleInstalledPluginEnabled: C,
      plugin: w,
      isPluginSharingEnabled: T,
      isUnavailableInCurrentContext: E,
      isHighlighted: D,
      onInstallPlugin: O,
      onTryInChat: k,
    } = e,
    ...
    M = (0, gs.useRef)(!1),
    N;
  t[0] === w ? (N = t[1]) : ((N = $t(w)), (t[0] = w), (t[1] = N));
  let P = N,
    F = f != null,
    I;
  t[2] !== c || t[3] !== F || t[4] !== C || t[5] !== w
    ? ((I = F
        ? `install`
        : ps({
            installedStateAction: c,
    ...
    : (I = t[6]);
  let L = I,
    R = w.plugin.source.type === `remote`,
    te;
  t[7] === w.plugin
    ? (te = t[8])
    : ((te = ao(w.plugin)), (t[7] = w.plugin), (t[8] = te));
  let re = te,
    ie;
  t[9] === re
    ? (ie = t[10])
    : ((ie = re
        ? (0, W.jsx)(B, { ...G.installedByAdminAction })
        : (0, W.jsx)(B, { ...G.uninstallMenuItem })),
      (t[9] = re),
      (t[10] = ie));
  let ae = ie,
    oe;
  t[11] !== a || t[12] !== w.marketplacePath || t[13] !== w.plugin.source
    ? ((oe = $e(a, w.marketplacePath, w.plugin.source)),
      (t[11] = a),
      (t[12] = w.marketplacePath),
      (t[13] = w.plugin.source),
      (t[14] = oe))
    : (oe = t[14]);
  let ce = oe,
    le;
  t[15] !== x || t[16] !== w || t[17] !== ce
    ? ((le =
        w.plugin.installed && ce != null && x != null
          ? () => {
              x(w);
            }
          : void 0),
  ...
  let ue = le,
    de = ue != null,
    fe = i != null || (y != null && ce != null),
    pe;
  t[19] !== fe || t[20] !== i || t[21] !== y || t[22] !== w
    ? ((pe = fe
        ? (0, W.jsx)(Bt.Item, {
            LeftIcon: At,
    ...
    : (pe = t[23]);
  let me = pe,
    he = w.plugin.installed && !w.plugin.enabled,
    ge = l == null && !w.plugin.installed,
    ye;
  t[24] === w.plugin.name
    ? (ye = t[25])
    : ((ye = xe(w.plugin.name)), (t[24] = w.plugin.name), (t[25] = ye));
  let be = ye != null,
    Se = !w.plugin.installed && (l != null || (be && !R)),
    Ce;
  t[26] !== s || t[27] !== w || t[28] !== Se
    ? ((Ce = Se
        ? { hostId: s, ...Ii(w), pluginSummary: w.plugin }
        : { hostId: s, pluginSummary: w.plugin }),
      (t[26] = s),
      (t[27] = w),
      (t[28] = Se),
      (t[29] = Ce))
    : (Ce = t[29]);
  let { blockedReason: we, isLoading: Te } = v(Ce),
    Ee;
  t[30] !== we || t[31] !== w.plugin
    ? ((Ee = bt(w.plugin) ? `disabled-by-admin` : we),
      (t[30] = we),
      (t[31] = w.plugin),
      (t[32] = Ee))
    : (Ee = t[32]);
  let De = Ee,
    Oe = De === `disabled-by-admin`,
    ke,
    Ae,
    je,
    Me,
  ...
  if (
    ...
    ((Pe = qt(w.plugin.name, be ? De : null)),
      (Fe = ge && Oe),
      (Ne = p || Oe || Te));
    let e;
    if (
      (t[77] === l
        ? (e = t[78])
        : ((e = l ?? (0, W.jsx)(B, { ...G.installTooltip })),
          (t[77] = l),
          (t[78] = e)),
      (je = e),
      F)
      ...
      (t[79] === u
        ...
        : ((e =
            u === `installing`
              ? (0, W.jsx)(B, { ...G.installing })
              : (0, W.jsx)(B, { ...G.installLoading })),
          (t[79] = u),
          (t[80] = e)),
        (je = e));
    } else if (Oe) {
      ...
      (t[81] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, W.jsx)(B, { ...G.disabledByAdmin })), (t[81] = e))
        : (e = t[81]),
        (je = e));
    } else if (p) {
      let e;
      (t[82] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, W.jsx)(B, { ...G.installLoading })), (t[82] = e))
        : (e = t[82]),
        (je = e));
    }
    let i;
    t[83] === w.plugin.shareContext?.creatorName
      ? (i = t[84])
      : ((i = w.plugin.shareContext?.creatorName?.trim() || null),
        (t[83] = w.plugin.shareContext?.creatorName),
        (t[84] = i));
    let a = i,
      o =
        w.marketplacePath == null &&
        (w.remoteMarketplaceName === `workspace-shared-with-me-private` ||
          w.remoteMarketplaceName === `workspace-shared-with-me-unlisted`),
      s = c !== `status` && x != null,
      d = null;
    if (s)
      if (ce != null) {
        ...
        let e;
        (t[86] === w.plugin.interface?.developerName
          ? (e = t[87])
          : ((e = w.plugin.interface?.developerName?.trim() ?? null),
            (t[86] = w.plugin.interface?.developerName),
            (t[87] = e)),
          (d = e));
      }
    ...
    (t[88] === d
      ...
      (Ae = m));
    let h = s ? null : a;
    Ie = (k != null && !Oe) || de || fe || S != null;
    let g = F ? `disabled:opacity-100` : void 0,
      v = F ? `ghost` : `outline`,
      y;
    t[90] !== O || t[91] !== w
      ? ((y = (e) => {
          (e.stopPropagation(), O(w));
        }),
        (t[90] = O),
        (t[91] = w),
        (t[92] = y))
      : (y = t[92]);
    let C;
    t[93] !== l || t[94] !== u || t[95] !== f || t[96] !== F || t[97] !== _
      ? ((C = F
          ? (0, W.jsxs)(W.Fragment, {
              children: [
                (0, W.jsx)(ee, {
    ...
    t[105] === D
      ? (Le = t[106])
      : ((Le = wn(`group !cursor-interaction justify-center`, D)),
        (t[105] = D),
        (t[106] = Le));
    let j = (he || A || Oe) && `opacity-60`;
    (t[107] !== r || t[108] !== j
      ? ((Re = wn(r, j)), (t[107] = r), (t[108] = j), (t[109] = Re))
      : (Re = t[109]),
      (z = `center`),
      (Be = !1));
    let M = b ? `!cursor-interaction` : null,
      N;
    t[110] === M
      ? (N = t[111])
      : ((N = wn(
    ...
    t[112] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (I = t[112]);
    let L;
    t[113] !== w.plugin.name || t[114] !== P
      ? ((L = (0, W.jsx)(xt, {
          alt: P,
          knownAppId: w.plugin.name,
          fallback: I,
        })),
        (t[113] = w.plugin.name),
        (t[114] = P),
    ...
    t[119] !== L
      ...
      : (R = t[120]),
      t[121] !== N || t[122] !== R
        ? ((Ve = (0, W.jsx)(`span`, { className: N, children: R })),
          (t[121] = N),
          (t[122] = R),
          (t[123] = Ve))
        : (Ve = t[123]),
      (Ue = P),
      t[124] !== h || t[125] !== w.description
        ? ((We =
            w.description == null && h == null
              ? void 0
              : (0, W.jsxs)(W.Fragment, {
                  children: [
                    w.description == null
          ...
          (t[126] = We))
        : (We = t[126]),
      (Ge = `flex flex-col gap-0.5 !text-token-description-foreground`),
      (Ke = ms(w, A, T, Pe)),
      (t[33] = fe),
      (t[34] = be),
      (t[35] = ge),
    ...
    ((ke = t[60]),
      ...
      (Ke = t[76]));
  let qe;
  t[127] !== O || t[128] !== b || t[129] !== w || t[130] !== Pe
    ? ((qe = b
        ? () => {
            if (M.current) {
              M.current = !1;
  ...
  t[157] !== ae
    ? ((Je = g
        ? (0, W.jsx)(H, {
            ...
            disabled: !0,
            size: `toolbar`,
            children: (0, W.jsx)(B, { ...G.uninstalling }),
          })
        : L === `toggle`
          ? (0, W.jsxs)(`div`, {
              ...
              children: [
                ...
                Ie
                  ? (0, W.jsx)(`div`, {
                      ...
                      onClick: ls,
                      onKeyDown: cs,
                      children: (0, W.jsxs)(se, {
                        align: `end`,
                        contentWidth: `sm`,
                        triggerButton: (0, W.jsx)(Ln, {
                          label: j.formatMessage(G.moreActions),
                          size: `toolbar`,
                        }),
                        children: [
                          k != null && !Oe
                            ? (0, W.jsx)(Bt.Item, {
                                ...
                                children: (0, W.jsx)(B, {
                                  ...
                                  description: `Menu item label for trying a plugin in task`,
                                }),
                              })
                            : null,
                          ue == null
                            ...
                            : (0, W.jsx)(Bt.Item, {
                                ...
                                leftIconClassName: `icon-xs`,
                                onSelect: ue,
                                children: (0, W.jsx)(B, { ...G.shareMenuItem }),
                              }),
                          me,
                          de && ce != null
                            ? (0, W.jsx)(Bt.Item, {
                ...
                (0, W.jsx)(_e, {
                  tooltipContent: Oe
                    ? (0, W.jsx)(B, { ...G.disabledByAdmin })
                    : w.plugin.enabled
                      ? (0, W.jsx)(B, { ...G.disableToggleTooltip })
                      : (0, W.jsx)(B, { ...G.enableToggleTooltip }),
                  children: (0, W.jsx)(Pi, {
                    checked: w.plugin.enabled,
                    disabled: Oe || h || g,
                    ariaLabel: j.formatMessage(G.toggleAria),
                    onClick: ss,
                    onChange: (e) => {
                      C?.({
                        plugin: w.plugin,
          ...
          : L === `menu`
            ? (0, W.jsxs)(`div`, {
                ...
                children: [
                  Ae,
                  (0, W.jsx)(Ia, {
                    disableMenuLabel: (0, W.jsx)(B, {
                      id: `plugins.card.disableMenuItem`,
                      defaultMessage: `Disable`,
                      description: `Menu item label for disabling a plugin from a plugin card`,
                    }),
                    enableButtonLabel: (0, W.jsx)(B, { ...G.enableButton }),
                    enabledStatusAriaLabel: j.formatMessage(G.enabledStatus),
                    isEnabled: w.plugin.enabled && !Oe,
                    isUninstallDisabled: re,
                    isUninstalling: g,
                    isUpdating: h,
                    menuLabel: j.formatMessage({
            ...
            : L === `status`
              ...
              : Fe
                ? (0, W.jsx)(_e, {
                    tooltipContent: (0, W.jsx)(B, {
                      ...G.disabledInstallTooltip,
                    }),
                    children: (0, W.jsx)(`span`, {
                      role: `img`,
                      "aria-label": j.formatMessage(G.disabledInstallTooltip),
                      className: `flex h-7 w-7 shrink-0 items-center justify-center text-token-text-tertiary`,
                      children: (0, W.jsx)(ve, { className: `icon-sm` }),
                    }),
                  })
                : (0, W.jsx)(Za, {
                    measurement: Me,
...
function us(e) {
  let t = (0, hs.c)(27),
    {
      isUninstallDisabled: n,
      isUninstalling: r,
      onManage: i,
      onShare: a,
      onUninstall: o,
      onTryInChat: s,
      uninstallMenuLabel: c,
    } = e,
    l = V(),
    u = s != null || a != null || i != null,
    f = o != null || n;
  if (!u && !f) {
    let e;
    return (
  ...
  t[1] === l
    ? (p = t[2])
    : ((p = l.formatMessage(G.moreActions)), (t[1] = l), (t[2] = p));
  let h;
  t[3] === p
    ? (h = t[4])
    : ((h = (0, W.jsx)(Ln, { label: p, size: `toolbar` })),
      (t[3] = p),
      (t[4] = h));
  let g;
  t[5] === s
        ...
        s == null
          ...
          : (0, W.jsx)(Bt.Item, {
              ...
              children: (0, W.jsx)(B, {
                ...
                defaultMessage: `Try now`,
                description: `Menu item label for trying an installed plugin in task`,
              }),
            })),
      (t[5] = s),
      (t[6] = g));
  ...
  let y;
  t[11] !== u || t[12] !== f
    ? ((y = f && u ? (0, W.jsx)(Bt.Separator, {}) : null),
      (t[11] = u),
      (t[12] = f),
      (t[13] = y))
    : (y = t[13]);
  let b;
  t[14] !== f || t[15] !== n || t[16] !== r || t[17] !== o || t[18] !== c
    ? ((b = f
        ? (0, W.jsx)(Bt.Item, {
            LeftIcon: d,
            className: `!text-token-error-foreground`,
      ...
      i.push(
        (0, W.jsx)(
          `span`,
          {
            ...
            children: (0, W.jsx)(B, { ...G.unavailableInCurrentContext }),
          },
          `${e.plugin.id}-unavailable`,
        ),
      ),
    r && i.push((0, W.jsx)(yt, {}, `${e.plugin.id}-plugin-upsell`)),
    !n &&
      e.marketplaceName.length > 0 &&
      Nn(e.marketplaceName) !== `Built by OpenAI` &&
      i.push(
        (0, W.jsx)(
          `span`,
          {
            className: `text-token-description-foreground`,
            children: Nn(e.marketplaceName),
          },
...
function ys(e) {
  ti.error(`Failed to refresh plugins after adding marketplace`, {
    safe: {},
    sensitive: { error: e },
  });
}
...
function Ss(e) {
  let t = (0, Es.c)(12),
    ...
    o = V(),
    s = Qi(a),
    { availablePlugins: c, featuredPluginIds: l } = x(a),
    u = r(`1269116100`),
    d = r(`4218407052`),
    { value: f } = ut(`2817990312`),
    p = Uo(f),
    { value: m } = ut(`1349514884`),
    { hiddenPluginIds: h } = Ko(m),
    g = i === `personal` && u,
    _;
  t[0] !== a || t[1] !== g
    ? ((_ = { enabled: g, hostId: a, marketplaceKind: `shared-with-me` }),
      (t[0] = a),
      (t[1] = g),
      (t[2] = _))
    : (_ = t[2]);
  let { data: v } = Xe(_),
    ...
    b;
  t[3] !== a || t[4] !== y
    ? ((b = { enabled: y, hostId: a, marketplaceKind: `workspace-directory` }),
      (t[3] = a),
      (t[4] = y),
      (t[5] = b))
    : (b = t[5]);
  let { data: S } = Xe(b),
    ...
    w;
  t[6] !== a || t[7] !== C
    ? ((w = { enabled: C, hostId: a, marketplaceKind: `created-by-me-remote` }),
      (t[6] = a),
      (t[7] = C),
      (t[8] = w))
    : (w = t[8]);
  let { data: T } = Xe(w),
    ...
    D;
  t[9] !== a || t[10] !== E
    ? ((D = { enabled: E, hostId: a }), (t[9] = a), (t[10] = E), (t[11] = D))
    : (D = t[11]);
  let { data: O } = to(D),
    k = Hi(c, h),
    A = Hi(v ?? [], h),
    j = Hi(S ?? [], h),
    M = Hi(T ?? [], h),
    N = O == null ? null : Hi(O, h),
    P = xi(k),
    F = xi(A).filter(ws),
    I = xi(j),
    { marketplaceFilterValue: L, plugins: ee } = Xn({
      availablePlugins: k,
      createdByMeRemotePlugins: M,
      homeDirectory: s,
      pluginShares: N,
      storefrontPlugins: P,
    });
  switch (i) {
    case `openai`:
      return Ts(
        hn({
          categoryOrder: p.categoryIds,
          categorySections: p.sections,
    ...
    case `workspace`:
      return Ts(hn({ connectedPlugins: [], plugins: I }));
    case `personal`: {
      let e = P.filter((e) => !Hn(e) && (L == null || un(e) !== L));
      return [
        {
        ...
        },
        {
          ...
          plugins: Ar({ plugins: F, query: `` }),
        },
        ...tr(e).map((t) => ({
          id: `plugins-marketplace-${encodeURIComponent(t.value)}`,
          title: t.subLabel == null ? t.label : `${t.label} · ${t.subLabel}`,
          plugins: Ar({
            marketplaceFilterValue: t.value,
            plugins: e,
            query: ``,
          }),
        })),
...
function ws(e) {
  return e.remoteMarketplaceName === Ds;
}
function Ts(e) {
  return e.map(({ plugins: e, section: t, visibleItemLimit: n }) => ({
    id: t.id,
    title: t.title,
    plugins: e,
    visibleItemLimit: n,
...
var Es,
  ...
  Os = e(() => {
    ((Es = z()),
      ...
      di(),
      wi(),
      (Ds = `workspace-shared-with-me-private`));
  });
function ks(e) {
  let t = (0, Fs.c)(32),
    { category: i, hostId: a, initialOffset: o, limit: s, searchTerm: c } = e,
    l = V(),
    ...
    p = d.category === i && d.hostId === a && d.limit === s && d.query === u,
    m = d;
  if (!p)
    ((m = {
      category: i,
      ...
      f(m));
  else if (d.initialOffset !== o) {
    let e = o === d.loadedOffset ? d.loadedOffset : o,
      n;
    (t[0] !== o || t[1] !== d || t[2] !== e
      ? ((n = { ...d, initialOffset: o, loadedOffset: e }),
        (t[0] = o),
        (t[1] = d),
        (t[2] = e),
        (t[3] = n))
  ...
  let { loadedOffset: h } = m,
    { data: g, isLoading: _ } = n(),
    { data: v, error: y, isLoading: b } = $i(a),
    {
      availablePlugins: S,
      errorMessage: C,
      featuredPluginIds: w,
    ...
    E = r(`1269116100`),
    D = r(`4218407052`),
    { value: O } = ut(`2817990312`),
    k = Uo(O),
    { value: A } = ut(`1349514884`),
    { hiddenPluginIds: j } = Ko(A),
    M = g?.structure === `workspace`,
    N;
  t[4] !== a || t[5] !== E
    ? ((N = { enabled: E, hostId: a, marketplaceKind: `shared-with-me` }),
      (t[4] = a),
      (t[5] = E),
      (t[6] = N))
    : (N = t[6]);
  let { data: P, error: F, isLoading: I } = Xe(N),
    L = E && M,
    ee;
  t[7] !== a || t[8] !== L
    ? ((ee = { enabled: L, hostId: a, marketplaceKind: `workspace-directory` }),
      (t[7] = a),
      (t[8] = L),
      (t[9] = ee))
    : (ee = t[9]);
  let { data: R, error: te, isLoading: ne } = Xe(ee),
    re;
  t[10] !== a || t[11] !== D
    ? ((re = {
        enabled: D,
      ...
      (t[12] = re))
    : (re = t[12]);
  let { data: ie, error: ae, isLoading: oe } = Xe(re),
    se;
  t[13] !== a || t[14] !== E
    ? ((se = { enabled: E, hostId: a }), (t[13] = a), (t[14] = E), (t[15] = se))
    : (se = t[15]);
  let { data: ce, error: le, isLoading: ue } = to(se),
    de = Hi(S, j),
    fe = Hi(E ? (P ?? []) : [], j),
    pe = Hi(E && M ? (R ?? []) : [], j),
    me = Hi(D ? (ie ?? []) : [], j),
    he = !E || ce == null ? null : Hi(ce, j),
    ge = xi(de),
    _e = xi(fe).filter(Ms),
    ve = xi(pe),
    ye =
      (a === `local` && M ? g.name?.trim() : null) ||
      R?.find(js)?.marketplaceDisplayName?.trim() ||
      null,
    { marketplaceFilterValue: be, plugins: xe } = Xn({
      availablePlugins: de,
      createdByMeRemotePlugins: me,
      homeDirectory: v?.homeDirectory,
      pluginShares: he,
      storefrontPlugins: ge,
    }),
    Se = ge.filter(Hn),
    Ce = ge.filter((e) => !Hn(e) && (be == null || un(e) !== be)),
    we = [
      {
        section: {
          id: `plugins-created-by-you`,
      ...
      },
      {
        ...
        plugins: Ar({ plugins: _e, query: u }),
      },
      ...tr(Ce).map((e) => ({
        section: {
          id: `plugins-marketplace-${encodeURIComponent(e.value)}`,
          title: e.subLabel == null ? e.label : `${e.label} · ${e.subLabel}`,
        },
        plugins: Ar({ marketplaceFilterValue: e.value, plugins: Ce, query: u }),
      })),
    ].filter(As),
    Te = hn({
      categoryOrder: k.categoryIds,
      categorySections: k.sections,
      collapsedCategoryIds: k.collapsedCategoryIds,
      connectedPlugins: [],
      featuredPluginIds: w,
      plugins: Se,
    }),
    Ee = hn({ connectedPlugins: [], plugins: ve }),
    De =
      i.length === 0
        ? [
            {
    ...
    Oe = _ || b || T || (E && (I || ue || (M && ne))) || (D && oe),
    ke = Oe
      ? void 0
      : Ns({ limit: h + s, sections: En({ query: u, sections: De }) }),
    Ae = ke?.hasNextPage ?? !1,
    je;
  t[16] !== i ||
  t[17] !== Ae ||
  ...
  t[23] !== f
    ? ((je = () => {
        if (!Ae) return Promise.resolve(null);
        let e = h + s;
        return (
          f({
            category: i,
...
function js(e) {
  return !!e.marketplaceDisplayName?.trim();
}
function Ms(e) {
  return e.remoteMarketplaceName === Ls;
}
function Ns({ limit: e, sections: t }) {
  let n = t.flatMap(({ plugins: e, section: t }) =>
      e.map((e) => ({ plugin: e, section: t })),
    ),
    r = n.slice(0, e);
  return {
    data: t.flatMap(({ section: e }) => {
      let t = r.flatMap((t) => (t.section.id === e.id ? [t.plugin] : []));
      return t.length === 0 ? [] : [{ id: e.id, plugins: t, title: e.title }];
    }),
    hasNextPage: n.length > r.length,
  };
}
function Ps(e, t, n) {
  return t.flatMap((t) =>
    t.section.id === n
      ? [{ ...t, section: { ...t.section, id: `plugins-search-${e}-${n}` } }]
      : [],
  );
}
var Fs,
  ...
  Rs = e(() => {
    ((Fs = z()),
      ...
      di(),
      wi(),
      (Ls = `workspace-shared-with-me-private`));
  });
function zs(e) {
  let t = (0, Vs.c)(55),
    n = e.inputType === _i.String,
    r = e.inputType === _i.Array,
    i = e.inputType === _i.Record,
    a = V(),
    o;
  t[0] === a
    ? (o = t[1])
  ...
  if (
    ...
    if (((p = s), (m = l), e.inputType === _i.Record)) {
      let [t] = e.placeHolderValue;
      ((p = t?.key ?? s), (m = t?.value ?? l));
    }
    ((t[6] = s),
      (t[7] = e.inputType),
      (t[8] = e.placeHolderValue),
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, Hs.jsx)(H, {
                    ...
                    size: `icon`,
                    disabled:
                      e.disabled || (g.length <= 1 && t.trim().length === 0),
                    "aria-label": f,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
                    },
                    children: (0, Hs.jsx)(d, { className: `icon-2xs` }),
                  }),
                ],
              },
              `list-${n}`,
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Hs.jsx)(Tn, { className: `icon-2xs` })), (t[46] = w))
    : (w = t[46]);
...
function Bs(e) {
  ...
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, Hs.jsx)(`input`, { className: i, ...r })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a))
      : (a = t[7]),
...
function Gs({
  ...
  let o = (0, Qs.useMemo)(() => qs(e, t), [e, t]),
    [s, l] = (0, Qs.useState)(o),
    [u, f] = (0, Qs.useState)(!1),
    [p, m] = (0, Qs.useState)(null),
    h = V(),
    g = s.label.trim(),
    _ = !(0, Zs.default)(s, o),
    v =
      s.transportType === `streamable_http`
        ? s.http.url.trim().length === 0
        : s.stdio.command.trim().length === 0,
    b = async () => {
      if (!(g.length === 0 || v)) {
        (m(null), f(!0));
        try {
          await n(Js(s), s.label);
        } catch (e) {
          m(
            Ks(
              e,
  ...
  return (0, K.jsx)(ur, {
    ...
    subtitle: x
      ...
      : (0, K.jsxs)(`a`, {
          ...
          rel: `noreferrer`,
          onClick: (e) => {
            Yt({ event: e, href: Xt, initiator: `open_in_browser_bridge` });
          },
          ...
          children: [
            ...
            (0, K.jsx)(M, { href: Xt, className: `icon-xxs` }),
          ],
        }),
    action:
      i && s.label.trim().length > 0
        ? (0, K.jsxs)(H, {
            color: `danger`,
            size: `toolbar`,
            disabled: u,
    ...
    children: (0, K.jsxs)(`div`, {
      className: `relative`,
      children: [
        u ? (0, K.jsx)(y, { overlay: !0 }) : null,
        (0, K.jsx)(Zr, {
          children: (0, K.jsxs)(Zr.Content, {
            children: [
              x
                ? (0, K.jsx)(`p`, {
                    className: `text-sm text-token-text-secondary`,
                    ...
                    children: [
                      ...
                      (0, K.jsx)(cn, {
                        label: (0, K.jsx)(B, {
                          ...
                          defaultMessage: `Type`,
                          description: `Label for the MCP server transport type selector`,
                        }),
                        control: (0, K.jsx)(Br, {
                          ...
                          selectedId: s.transportType,
                          size: `toolbar`,
                          onSelect: (e) => {
                            l((t) => ({ ...t, transportType: e }));
                          },
                        }),
                      }),
                    ],
                    ...
                    : (0, K.jsxs)(K.Fragment, {
                        children: [
                          ...
                          (0, K.jsx)(zs, {
                            ...
                            value: s.http.bearerTokenEnvVar,
...
function qs(e, t) {
  ...
  return {
    ...
    stdio: {
      ...
      env: `command` in e && e.env ? Ys(e.env) : [],
      envVars:
    ...
    http: {
      ...
      httpHeaders: `url` in e && e.http_headers ? Ys(e.http_headers) : [],
      envHttpHeaders:
        `url` in e && e.env_http_headers ? Ys(e.env_http_headers) : [],
    },
  };
}
function Js(e) {
  ...
  if (e.transportType === `streamable_http`) {
    let n = Xs(e.http.httpHeaders),
      r = Xs(e.http.envHttpHeaders);
    return {
      ...t,
      url: e.http.url,
...
function nc({
  ...
  hostId: t,
  searchQuery: n = ``,
  useActiveWorkspaceRoot: r,
}) {
  let { data: i, isPending: a } = u(e, {
      hostId: t,
      useActiveWorkspaceRoot: r,
    }),
    { data: o, isFetching: s, isPending: c } = Ie(fe, t),
    l = ae({ hostId: t }),
    d = Mt({ hostId: t }),
    f = j(),
    p = V(),
    ...
    [_, v] = (0, lc.useState)([]),
    [y, b] = (0, lc.useState)({}),
    [x, S] = (0, lc.useState)(null),
    [C, w] = (0, lc.useState)(null),
    T = i?.servers ?? {},
    E = i?.serverOrigins ?? {},
    D = i?.configWriteTarget ?? null,
    O = Object.entries(T),
    A = O.map(([e]) => e),
    M = n.trim().toLowerCase(),
    N = (0, sc.default)(
      O,
      ([e, t]) => t.name?.trim() || e,
      ([e]) => e,
      ...
      M.length === 0
        ? !0
        : [e, t.name ?? e].some((e) => e.toLowerCase().includes(M)),
    ),
    P = new Set(O.flatMap(([e, t]) => [e, t.name ?? e])),
    F = _.includes(t),
    I = F ? (y[t] ?? []) : [],
    L = (0, sc.default)(
      (i == null ? [] : (o?.data ?? [])).filter(
        (e) =>
          !P.has(e.name) &&
          !I.includes(e.name) &&
          (M.length === 0 || e.name.toLowerCase().includes(M)),
      ),
      (e) => e.name,
    ),
    ee = A.length > 0,
    R = L.length > 0,
    te = M.length > 0 && N.length === 0 && L.length === 0,
    ne = !te && (ee || R),
    re = p.formatMessage({
  ...
  o != null &&
    (o.data.forEach((e) => {
      ie[e.name] = e.authStatus;
    }),
    O.forEach(([e, t]) => {
      let n = ie[e] ?? (t.name == null ? void 0 : ie[t.name]);
      n != null && (ie[e] = n);
    }));
  let oe = () => {
      v((e) => (e.includes(t) ? e : [...e, t]));
    },
    se = () => {
      (w(null), S(null));
    },
    ce = () => {
      if (D != null) return D.filePath;
      throw Error(
        p.formatMessage({
    ...
    le = async (e, t) => {
      try {
        (await d.mutateAsync({ key: e, enabled: t }), oe());
      } catch {}
    },
    ue = async (e, t) => {
      let n = x ?? rc(t, A);
      try {
        (await l.mutateAsync({ filePath: ce(), key: n, value: e }), oe(), se());
      } catch (e) {
        throw (
          ti.error(`Failed to save MCP server`, {
            safe: { targetKey: n },
            sensitive: { error: e },
          }),
          e
    ...
    de = async (e) => {
      let n = x ?? rc(e, A);
      try {
        (await l.mutateAsync({ filePath: ce(), key: n, value: null }),
          b((r) => ({
            ...r,
            [t]: (0, cc.default)([...(r[t] ?? []), n, e, T[n]?.name ?? n]),
          })),
          oe(),
          se());
      } catch (e) {
        throw (
          ti.error(`Failed to uninstall MCP server`, {
            safe: { targetKey: n },
            sensitive: { error: e },
          }),
          e
    ...
    pe = async (e) => {
      ...
      g((t) => ({ ...t, [e]: null }));
      try {
        let { authorizationUrl: n } = await Vn(`login-mcp-server`, {
          hostId: t,
          name: e,
        });
        n &&
        ...
        (ti.error(`Failed to start login for MCP server`, {
          safe: { serverName: e },
          sensitive: { error: t },
        }),
          g((t) => {
    ...
    me = (0, lc.useEffectEvent)((e, t) => {
      (g((n) => {
        ...
        t && (oe(), f.invalidateQueries({ queryKey: br })));
    }),
    he = (0, lc.useRef)(!0);
  if (
    ((0, lc.useEffect)(() => {
      ...
      m?.hostId === t && me(m.name, m.success);
    }, [m, t]),
    vn(
      ...
      (e) => {
        (v((t) => t.filter((t) => t !== e.hostId)),
          ...
          f.invalidateQueries({ queryKey: [...br, e.hostId] }));
      },
      [f],
    ),
    C)
                  ...
                  F
                    ? (0, q.jsx)(_e, {
                        ...
                        children: (0, q.jsx)(H, {
                          ...
                          size: `icon`,
                          onClick: () => {
                            lr.dispatchMessage(`codex-app-server-restart`, {
                              hostId: t,
                            });
                          },
                          children: (0, q.jsx)(k, { className: `icon-xs` }),
                        }),
                      })
                    : null,
                  ne ? (0, q.jsx)(ac, { onClick: ge }) : null,
                ],
              }),
          }),
          a || (c && N.length === 0)
            ? (0, q.jsx)(Zr.Content, { children: (0, q.jsx)(Pr, {}) })
            : te
              ? (0, q.jsx)(Zr.Content, {
                  children: (0, q.jsx)(In, {
                    children: (0, q.jsx)(cn, {
                          ...
                          ? N.map(([e, t]) =>
                              (0, q.jsx)(
                                ic,
                                {
                                  ...
                                  enabled: t.enabled !== !1,
                                  authStatus: ie[e],
                                  onAuthenticateClicked: () => pe(e),
                                  onEnableClicked: (t) => le(e, t),
                                  onSettingsClicked: () => {
                                    (S(e), w(t));
                                  },
                                  isReadOnly: E[e]?.name.type === `project`,
                                },
                                e,
                              ),
                            )
                  ...
                  children: L.map((e) =>
                    (0, q.jsx)(
                      ic,
                      {
                        ...
                        onAuthenticateClicked: () => pe(e.name),
                      },
                      e.name,
                    ),
                  ),
...
function rc(e, t) {
  let n = e
      ...
      .replace(/-+/gu, `-`),
    r = n.length > 0 ? n.toLowerCase() : `custom-server`;
  if (!t.includes(r)) return r;
  let i = 2,
    a = `${r}-${i}`;
  for (; t.includes(a);) ((i += 1), (a = `${r}-${i}`));
  return a;
}
function ic(e) {
  let t = (0, oc.c)(14),
            ...
            children: [
              ...
              c
                ? (0, q.jsx)(H, {
                    ...
                    children: (0, q.jsx)(Sn, { className: `icon-xs` }),
                  })
                : null,
              o
                ? (0, q.jsx)(Pi, {
  ...
  return (
    t[11] !== p || t[12] !== m
      ? ((h = (0, q.jsx)(cn, { label: p, control: m })),
        (t[11] = p),
        (t[12] = m),
        (t[13] = h))
      : (h = t[13]),
...
function ac(e) {
  let t = (0, oc.c)(4),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, q.jsx)(Tn, { className: `icon-xs` })),
      (i = (0, q.jsx)(B, {
...
var oc,
  ...
  dc = e(() => {
    ((oc = z()),
      ...
      Lr(),
      (q = T()),
      (uc = { command: ``, args: [], env_vars: [], enabled: !0 }));
  });
function fc(e) {
  let t = (0, hc.c)(8),
...
function pc(e) {
  ...
  return (
    t[8] !== n || t[9] !== l
      ? ((u = (0, gc.jsx)(`div`, {
          className: `flex min-h-0 flex-1 items-center justify-center py-8`,
          children: (0, gc.jsx)(sr, { title: o, description: n, actions: l }),
        })),
        (t[8] = n),
        (t[9] = l),
        (t[10] = u))
...
var hc,
  gc,
  _c = e(() => {
    ((hc = z()), ht(), Bn(), er(), _n(), Xr(), yr(), is(), (gc = T()));
  });
function vc({ creatorPath: e, isFirstOpen: t, kind: n }) {
  let r = yc[n],
    i = `[$${r.skillName}](${$n(e)})`;
...
var yc,
  ...
  Sc = e(() => {
    (yi(),
      ...
      (bc = Di(`has-opened-plugin-creator-prefill-v1`, !1)),
      (xc = Di(`has-opened-skill-creator-prefill-v1`, !1)));
  }),
  Cc,
  wc,
  Tc = e(() => {
...
function Ec(e) {
  let t = (0, Mc.c)(28),
    {
      ...
      onRemoveMarketplace: f,
      onRetry: p,
      pendingUpgradeMarketplaceName: m,
      pendingRemoveMarketplaceName: h,
    } = e,
    g = V();
  if (r) {
    let e;
  ...
  if (n) {
    ...
    return (
      t[8] !== n || t[9] !== o
        ? ((s = (0, J.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, J.jsx)(sr, { title: e, description: n, actions: o }),
          })),
          (t[8] = n),
          (t[9] = o),
          (t[10] = s))
  ...
  let _;
  t[11] !== i || t[12] !== o || t[13] !== p
    ? ((_ = (0, J.jsx)(Ac, { errors: o, isRetrying: i, onRetry: p })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = p),
      (t[14] = _))
                      ...
                      children: [
                        ...
                        (0, J.jsx)(_e, {
                          ...
                          children: (0, J.jsx)(H, {
                            ...
                            onClick: (n) => {
                              (n.stopPropagation(), t && f(e));
                            },
                            children: n
                              ? null
                              : (0, J.jsx)(d, { className: `icon-sm` }),
                          }),
                        }),
                      ],
                    }),
...
function kc(e) {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, J.jsx)(B, {
        ...
        defaultMessage: `This removes the marketplace from your configuration. Its plugins won't appear unless you add it again.`,
  ...
  t[8] === u
    ? (f = t[9])
    : ((f = (0, J.jsx)(Wi, {
        children: (0, J.jsx)(ft, { title: u, subtitle: d, subtitleSize: `sm` }),
      })),
      (t[8] = u),
      (t[9] = f));
  let p;
  ...
  t[19] !== _ || t[20] !== h
    ? ((v = (0, J.jsx)(Wi, {
        children: (0, J.jsxs)(ke, { children: [h, _] }),
      })),
      (t[19] = _),
      (t[20] = h),
      (t[21] = v))
...
function Pc(e) {
  return I.safePost(`/plugins/user-suggestions`, {
    requestBody: { suggestion: e.trim() },
  });
}
var Fc = e(() => {
  je();
});
function Ic({ initialSuggestion: e, onClose: t }) {
  let n = We(vr),
    r = V(),
    [i, a] = (0, Lc.useState)(!1),
    [o, s] = (0, Lc.useState)(!1),
    [c, l] = (0, Lc.useState)(() => e.trim().slice(0, zc)),
    [u, d] = (0, Lc.useState)(null),
    f = c.trim(),
    p = async (e) => {
      if ((e.preventDefault(), !(f.length === 0 || o))) {
        (s(!0), d(null));
        try {
          (await Pc(c),
            t(),
          ...
          d(e instanceof Gn && e.status === 429 ? `rate-limited` : `failed`);
        } finally {
          s(!1);
        }
      }
  ...
  return (0, Rc.jsx)(ie, {
    ...
    showDialogClose: !o,
    size: `compact`,
    children: (0, Rc.jsxs)(ue, {
      as: `form`,
      onSubmit: (e) => void p(e),
      children: [
        (0, Rc.jsx)(Wi, {
          children: (0, Rc.jsx)(ft, {
            title: (0, Rc.jsx)(Lt, {
              className: `contents`,
              children: (0, Rc.jsx)(B, {
            ...
            subtitle: (0, Rc.jsx)(Tt, {
              className: `contents`,
              children: (0, Rc.jsx)(B, {
                id: `skills.appsPage.pluginRequest.description`,
                defaultMessage: `Tell us which plugin you’d like and what you’d use it for`,
                description: `Description for the plugin request dialog`,
              }),
            }),
          }),
        }),
        (0, Rc.jsxs)(Wi, {
          ...
          children: [
            (0, Rc.jsx)(`textarea`, {
              ...
              "aria-describedby": u == null ? void 0 : `plugin-request-error`,
              "aria-invalid": u != null,
              ...
              onFocus: (e) => {
                if (!i) {
                  ...
                  (e.currentTarget.setSelectionRange(t, t), a(!0));
                }
              },
              onKeyDown: (e) => {
                e.key === `Enter` &&
                  ...
                  children:
                    u === `rate-limited`
                      ? (0, Rc.jsx)(B, {
                          ...
                          defaultMessage: `You’ve submitted several requests. Try again in a minute`,
                          description: `Error shown when a user submits too many plugin requests`,
                        })
                      : (0, Rc.jsx)(B, {
                          id: `skills.appsPage.pluginRequest.failed`,
                          defaultMessage: `Couldn’t submit your request. Try again`,
                          description: `Error shown when a plugin request fails`,
                        }),
                }),
          ],
        }),
        (0, Rc.jsx)(Wi, {
          children: (0, Rc.jsxs)(ke, {
            children: [
              (0, Rc.jsx)(H, {
                color: `outline`,
                disabled: o,
                ...
                children: (0, Rc.jsx)(B, {
                  ...
                  defaultMessage: `Cancel`,
                  description: `Cancel button in the plugin request dialog`,
                }),
              }),
              (0, Rc.jsx)(H, {
                disabled: f.length === 0,
                ...
                children: (0, Rc.jsx)(B, {
                  ...
                  description: `Submit button in the plugin request dialog`,
                }),
              }),
            ],
          }),
...
function qc(e) {
  ...
  if (e.mode === `manage`) {
    ...
    let p;
    t[26] === e.onExitManageMode
      ? (p = t[27])
      : ((p =
          e.onExitManageMode == null
            ? []
            : [
                {
                  id: `plugins`,
    ...
    t[29] === p
      ? (h = t[30])
      : ((h = (0, Y.jsx)(Zi, { ancestors: p, current: m })),
        (t[29] = p),
        (t[30] = h));
    let g = e.hostSelector,
      _ = e.searchInput,
      v;
    t[31] === f
      ? (v = t[32])
      : ((v = (0, Y.jsx)(Jc, { actions: f })), (t[31] = f), (t[32] = v));
    let y;
    t[33] === n
      ? (y = t[34])
      : ((y = n.formatMessage({
    ...
    t[39] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (C = t[39]);
    let w;
    t[40] !== e.isRefreshDisabled || t[41] !== x || t[42] !== S
      ? ((w = (0, Y.jsx)(Bt.Item, {
          LeftIcon: x,
  ...
  if (
    t[59] !== n ||
    t[60] !== e.canCreatePlugin ||
    t[61] !== e.canCreateSkill ||
    t[62] !== e.currentBrowseTab ||
    t[63] !== e.onAddMarketplace ||
    t[64] !== e.onCreatePlugin ||
    t[65] !== e.onCreateSkill ||
    t[66] !== e.recordSkillAction
  ) {
    if (
      ((r =
      ...
      t[70] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        : (a = t[70]);
      let o;
      (t[71] !== e.onAddMarketplace || t[72] !== i
        ? ((o = {
            ariaLabel: i,
            disabled: !1,
            Icon: Tn,
            label: a,
            onSelect: e.onAddMarketplace,
          }),
          (t[71] = e.onAddMarketplace),
          (t[72] = i),
          (t[73] = o))
        : (o = t[73]),
        r.push(o));
    ...
    if (e.recordSkillAction) {
      ...
      t[76] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        : (a = t[76]);
      let o;
      (t[77] !== e.recordSkillAction.disabled ||
      t[78] !== e.recordSkillAction.onSelect ||
      t[79] !== i
        ? ((o = {
            ariaLabel: i,
            disabled: e.recordSkillAction.disabled,
  ...
  t[86] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (c = t[86]);
  let l;
  t[87] !== e.currentBrowseTab || t[88] !== e.onBrowseTabSelect || t[89] !== o
    ? ((l = (0, Y.jsx)(Br, {
        ariaLabel: o,
      ...
      (t[87] = e.currentBrowseTab),
      (t[88] = e.onBrowseTabSelect),
      (t[89] = o),
      (t[90] = l))
    : (l = t[90]);
  let u;
  t[91] !== e.isRefreshDisabled ||
  t[92] !== e.isRefreshingPage ||
  t[93] !== e.needsSkillsRefresh ||
  t[94] !== e.onRefreshPage
    ? ((u = e.needsSkillsRefresh
        ? (0, Y.jsxs)(H, {
            color: `ghost`,
            size: `toolbar`,
  ...
  t[99] === e.isRefreshingPage
    ? (m = t[100])
    : ((m = e.isRefreshingPage
        ? (0, Y.jsx)(mn, { className: `icon-sm` })
        : (0, Y.jsx)(k, { className: `icon-sm` })),
      (t[99] = e.isRefreshingPage),
      (t[100] = m));
  let h;
        ...
        e.onManage == null
          ...
          : (0, Y.jsx)(_e, {
              ...
              children: (0, Y.jsx)(H, {
                ...
                uniform: !0,
                onClick: e.onManage,
                children: (0, Y.jsx)(Sn, { className: `icon-sm` }),
              }),
            })),
      (t[106] = a),
      (t[107] = e.onManage),
  ...
  t[109] === r
    ? (_ = t[110])
    : ((_ = (0, Y.jsx)(Jc, { actions: r })), (t[109] = r), (t[110] = _));
  let v;
  t[111] !== e.hostSelector ||
  t[112] !== h ||
  t[113] !== g ||
  t[114] !== _ ||
  t[115] !== u
...
function Jc(e) {
  ...
  if (n.length === 1) {
    let e;
    t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Y.jsx)(Tn, { className: `icon-xs` })), (t[1] = e))
      : (e = t[1]);
    let n;
    ...
    return (
      t[6] !== i.label || t[7] !== n
        ? ((r = (0, Y.jsx)(_e, { tooltipContent: i.label, children: n })),
          (t[6] = i.label),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  let c = i.label,
    l;
  t[11] === n ? (l = t[12]) : ((l = n.map(Yc)), (t[11] = n), (t[12] = l));
  let u;
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Y.jsx)(B, {
        id: `skills.appsPage.create`,
        defaultMessage: `Create`,
        description: `Label for the primary create button on the Skills & Apps page`,
      })),
      (t[13] = u))
    : (u = t[13]);
  let d;
...
function Qc(e) {
  let t = (0, dl.c)(78),
    {
      cardPlacementContext: n,
      catalogStatusMessage: r,
      contentAfterConnected: i,
      errorMessage: a,
      homeDirectory: o,
      hostId: s,
      ...
      pendingPluginId: p,
      uninstalling: m,
      highlightedPluginKey: h,
      onToggleInstalledPluginEnabled: g,
      onInstallPlugin: _,
      onManage: v,
  ...
  if (
    ...
    bb0: {
      ...
      t[70] !== m
        ? ((P = (e) => {
            let { section: t, plugins: i, visibleItemLimit: u } = e;
            return t.id === `plugins-connected`
              ? (0, X.jsx)(
                  tl,
                  { id: t.id, plugins: i, onManage: v, onOpenPluginDetails: y },
                  t.id,
                )
              : (0, X.jsx)(
                  da,
                  {
                    count: T ? i.length : void 0,
                    id: t.id,
                    title: t.title,
                    children: (0, X.jsx)(nl, {
                      cardPlacementContext: n,
                      ...
                      onShareInstalledPlugin:
                        t.id === `plugins-created-by-you` ? b : void 0,
                      onTryInChat: x,
                      onToggleInstalledPluginEnabled: g,
                      onUninstallInstalledPlugin: S,
                      pendingPluginId: p,
        ...
        : (P = t[71]);
      let F = e.map(P);
      ((D = `flex flex-1 flex-col gap-8`),
        (O = N === -1 ? null : F.slice(0, N + 1)),
        (k = i),
        (A = N === -1 ? F : F.slice(N + 1)));
    }
    ((t[0] = n),
  ...
  let M;
  return (
    t[72] !== E || t[73] !== D || t[74] !== O || t[75] !== k || t[76] !== A
      ? ((M = (0, X.jsxs)(`div`, { className: D, children: [O, k, A, E] })),
        (t[72] = E),
        (t[73] = D),
        (t[74] = O),
        (t[75] = k),
...
function tl(e) {
  let t = (0, dl.c)(18),
    { id: n, plugins: r, onManage: i, onOpenPluginDetails: a } = e,
    o = V(),
    s;
  t[0] === o
    ? (s = t[1])
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, X.jsx)(Sn, { className: `icon-sm` })), (t[3] = u))
    : (u = t[3]);
  let d;
  t[4] !== c || t[5] !== i
    ? ((d = (0, X.jsx)(H, {
  ...
  t[7] !== c || t[8] !== d
    ? ((f = (0, X.jsxs)(`div`, {
        ...
        children: [l, (0, X.jsx)(_e, { tooltipContent: c, children: d })],
      })),
      (t[7] = c),
      (t[8] = d),
      (t[9] = f))
    : (f = t[9]);
  let p;
  t[10] !== i || t[11] !== a || t[12] !== r
    ? ((p = (0, X.jsx)(sl, {
        plugins: r,
        onManage: i,
        onOpenPluginDetails: a,
      })),
      (t[10] = i),
      (t[11] = a),
      (t[12] = r),
...
function nl(e) {
  let t = (0, dl.c)(35),
    {
      ...
      onTryInChat: g,
      onToggleInstalledPluginEnabled: _,
      onUninstallInstalledPlugin: v,
      pendingPluginId: y,
      uninstalling: b,
      reducedMotion: x,
      sectionId: S,
  ...
  t[0] !== s || t[1] !== c || t[2] !== f
    ? ((T =
        c?.hostId === s ? f.find((e) => e.plugin.id === c.pluginId) : void 0),
      (t[0] = s),
      (t[1] = c),
      (t[2] = f),
      (t[3] = T))
  ...
  let E = T,
    D;
  t[4] === f ? (D = t[5]) : ((D = new Map(f.map(ol))), (t[4] = f), (t[5] = D));
  let O = D,
    k;
  t[6] !== n || t[7] !== O || t[8] !== S
    ? ((k = (e) => {
        ...
        if (t != null)
          return n.kind === `home`
            ? { kind: n.kind, position: t, sectionId: S }
            : { categoryId: n.categoryId, kind: n.kind, position: t };
      }),
      (t[6] = n),
      (t[7] = O),
      (t[8] = S),
...
function rl(e) {
  ...
  return (0, X.jsxs)(Ta, {
    ...
    children: [
      i.length > 0
        ? (0, X.jsx)(na, { size: `medium`, children: i.map(il) })
        : null,
      (0, X.jsx)(`span`, {
        children: (0, X.jsx)(B, {
          ...
          values: {
            pluginNames: t.slice(0, 2).map($t).join(`, `),
...
function il(e) {
  return (0, X.jsx)(
    xt,
    {
      ...
      logoUrl: e.logoPath,
      fallback: (0, X.jsx)(He, { className: `text-token-text-secondary` }),
    },
    hi(e),
  );
}
function al(e) {
  return (
    e.logoPath != null || e.logoDarkPath != null || P(e.plugin.name) != null
  );
}
function ol(e, t) {
  return [hi(e), t];
...
function sl(e) {
  ...
  if (
    ...
    let e = ul({ containerWidth: c, pluginCount: n.length }),
      s = n.slice(0, e),
      m = n.slice(e),
      h = m.length,
      g = i != null;
    ((p = `px-2`),
      (l = o),
      (u = `group/plugin-row flex h-11 gap-1 overflow-visible`));
    let _;
    (t[11] !== g || t[12] !== i
      ? ((_ = (e) => {
          let t = $t(e);
      ...
      (t[9] = f),
      (t[10] = p));
  } else ((l = t[6]), (u = t[7]), (d = t[8]), (f = t[9]), (p = t[10]));
  let m;
  t[14] !== l || t[15] !== u || t[16] !== d || t[17] !== f
    ? ((m = (0, X.jsxs)(`div`, { ref: l, className: u, children: [d, f] })),
      (t[14] = l),
      (t[15] = u),
      (t[16] = d),
      (t[17] = f),
  ...
  return (
    t[19] !== p || t[20] !== m
      ? ((h = (0, X.jsx)(`div`, { className: p, children: m })),
        (t[19] = p),
        (t[20] = m),
        (t[21] = h))
      : (h = t[21]),
...
function ll(e) {
  ...
  let a;
  return (
    t[3] !== n.logoDarkPath || t[4] !== n.logoPath || t[5] !== i
      ? ((a = (0, X.jsx)(xt, {
          alt: ``,
...
function ul({ containerWidth: e, pluginCount: t }) {
  if (e == null) return t;
  let n = Math.max(1, Math.floor((e + fl) / 48));
  return n >= t ? t : n - 1;
}
var dl,
  X,
...
function ml(e) {
  let t = (0, vl.c)(37),
    ...
    d = V(),
    f =
      n.shortDescription && n.shortDescription.length > 0
        ? n.shortDescription
        : n.description,
    p;
  t[0] !== c || t[1] !== n.repoPath
    ? ((p = gl({ repoRoot: c, repoPath: n.repoPath })),
      (t[0] = c),
      (t[1] = n.repoPath),
      (t[2] = p))
    : (p = t[2]);
  ...
  t[3] === n.name
    ? (h = t[4])
    : ((h = Zt(n.name)), (t[3] = n.name), (t[4] = h));
  let g = h,
    _ = n.iconLarge ? `large` : `small`,
    v;
  t[5] !== n || t[6] !== m || t[7] !== _
    ? ((v = (0, bl.jsx)(_l, { skill: n, size: _, basePath: m })),
      (t[5] = n),
      (t[6] = m),
      (t[7] = _),
      (t[8] = v))
  ...
  t[14] !== n
    ? ((x = o
        ? (0, bl.jsx)(Ia, {
            enabledStatusAriaLabel: d.formatMessage(xl.installed),
            isEnabled: !0,
            isUninstalling: !1,
            isUpdating: !1,
          })
        : (0, bl.jsx)(_e, {
            tooltipContent: (0, bl.jsx)(B, { ...xl.installSkill }),
            children: (0, bl.jsx)(H, {
              "aria-label": d.formatMessage(xl.installSkill),
              color: `secondary`,
              size: `composer`,
              disabled: b,
              loading: s,
              ...
              children: (0, bl.jsx)(B, { ...xl.installSkill }),
            }),
          })),
      (t[9] = d),
      (t[10] = b),
  ...
  t[16] === g
    ? (C = t[17])
    : ((C = (0, bl.jsx)(Qr, { kind: `Skill`, title: g })),
      (t[16] = g),
      (t[17] = C));
  let w;
  t[18] !== g || t[19] !== i || t[20] !== m
    ? ((w = (e) => {
        let { isOpen: t } = e;
        return (0, bl.jsx)(or, {
          hostId: i,
    ...
    : (w = t[21]);
  let T;
  t[22] !== r || t[23] !== o || t[24] !== s || t[25] !== l || t[26] !== n
    ? ((T = (0, bl.jsx)(hl, {
        canInstall: r,
        installing: s,
        isInstalled: o,
...
function hl(e) {
  ...
  t[3] === s
    ? (l = t[4])
    : ((l = s ? null : (0, bl.jsx)(Tn, { className: `icon-xs` })),
      (t[3] = s),
      (t[4] = l));
  let u;
  t[5] === i
  ...
  let d;
  return (
    t[7] !== r || t[8] !== s || t[9] !== c || t[10] !== l || t[11] !== u
      ? ((d = (0, bl.jsx)(`div`, {
          className: `flex w-full justify-end`,
          children: (0, bl.jsxs)(H, {
            color: `primary`,
            size: `toolbar`,
            disabled: s,
            loading: r,
...
function gl({ repoRoot: e, repoPath: t }) {
  if (!e) return null;
  let n = t.split(`/`).join(yl.default.sep),
    r = yl.default.join(e, n);
  return r.toLowerCase().endsWith(`.md`) ? r : yl.default.join(r, `SKILL.md`);
}
function _l(e) {
  let t = (0, vl.c)(13),
...
function Cl(e) {
  let t = (0, Ll.c)(83),
    {
      ...
      installedSkills: o,
      installedSkillsForRecommendedActions: s,
      installedRecommendedSkillIds: c,
      highlightedInstalledSkillPath: l,
      highlightedRecommendedSkillId: u,
      hostId: d,
      installingSkillId: f,
      isLoadingInstalledSkills: p,
      isLoadingRecommendedSkills: m,
      onInstallRecommendedSkill: h,
      onInstalledRecommendedSkillUpdated: g,
      onSelectSection: _,
      onSkillsUpdated: v,
      recommendedRepoRoot: y,
      recommendedSkills: b,
      roots: x,
      selectedSectionId: S,
      searchResultsTitle: C,
      installedSection: w,
      recommendedSection: T,
    } = e,
    E = i === void 0 ? `check` : i,
    D = V(),
    O;
  if (t[0] !== c || t[1] !== s || t[2] !== b) {
    let e;
    (t[4] !== c || t[5] !== s
      ? ((e = (e) => {
          let t = c.has(e.id);
          return {
            installedSkill: t ? la({ installedSkills: s, skill: e }) : null,
            isInstalled: t,
            skill: e,
          };
        }),
  ...
  let k = O,
    A = w != null && (a.length > 0 || o.length > 0),
    j = T != null && k.length > 0;
  if (!p && !m && r == null && !A && !j) {
    let e;
    return (
...
function wl(e) {
  ...
  let g;
  t[12] !== c || t[13] !== u.length
    ? ((g = Fl({ itemCount: u.length, visibleItemLimit: c })),
      (t[12] = c),
      (t[13] = u.length),
      (t[14] = g))
    : (g = t[14]);
...
function Tl(e) {
  let { hiddenItems: t, isExpanded: n, onToggle: r } = e;
  return (0, Z.jsx)(Pl, { isExpanded: n, skillNames: t.map(El), onClick: r });
}
function El(e) {
  let { skill: t } = e;
  return Ci(t);
...
function Dl(e) {
  ...
  return (
    t[13] !== u || t[14] !== o || t[15] !== d
      ? ((f = (0, Z.jsx)(es, { gap: u, isSingleColumn: o, children: d })),
        (t[13] = u),
        (t[14] = o),
        (t[15] = d),
        (t[16] = f))
...
function Ol(e) {
  let t = (0, Ll.c)(20),
    ...
    c = V(),
    l;
  t[0] !== r || t[1] !== c || t[2] !== o || t[3] !== s
    ? ((l = r === `toggle` ? Ji({ skill: s, roots: o, intl: c }) : void 0),
      (t[0] = r),
      (t[1] = c),
      (t[2] = o),
      (t[3] = s),
  ...
  t[5] === r
    ? (d = t[6])
    : ((d = r === `toggle` ? (0, Z.jsx)(kl, {}) : void 0),
      (t[5] = r),
      (t[6] = d));
  let f = r !== `toggle`,
    p;
  t[7] === s ? (p = t[8]) : ((p = Ci(s)), (t[7] = s), (t[8] = p));
  let m;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = []), (t[9] = m))
    : (m = t[9]);
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(`span`, {
          ...
          children: (0, Z.jsx)(mi, { className: `icon-sm` }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
  ...
  let t = (0, Ll.c)(17),
    {
      ...
      entries: r,
      errorMessage: i,
      highlightInstalledSkills: a,
      hostId: o,
      highlightedSkillId: s,
      installingSkillId: c,
      isLoading: l,
      onInstall: u,
      onSkillsUpdated: d,
  ...
  if (i) {
    ...
    return (
      t[2] === i
        ...
        : ((n = (0, Z.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, Z.jsx)(sr, { title: e, description: i }),
          })),
          (t[2] = i),
          (t[3] = n)),
      n
      ...
      ? ((g = (0, Z.jsx)(Z.Fragment, {
          children: h
            ...
            : (0, Z.jsx)(ua, {
                items: r,
                visibleItemLimit:
                  Fl({ itemCount: r.length, visibleItemLimit: 6 }) ?? r.length,
                renderExpandRow: jl,
                children: (e) =>
                  (0, Z.jsx)(Nl, {
                    canInstall: n,
...
function jl(e) {
  let { hiddenItems: t, isExpanded: n, onToggle: r } = e;
  return (0, Z.jsx)(Pl, { isExpanded: n, skillNames: t.map(Ml), onClick: r });
}
function Ml(e) {
  let { skill: t } = e;
  return t.name;
...
function Nl(e) {
  let t = (0, Ll.c)(23),
    {
      canInstall: n,
      entries: r,
      highlightInstalledSkills: i,
      hostId: a,
      highlightedSkillId: o,
      installingSkillId: s,
      onInstall: c,
      onSkillsUpdated: l,
      repoRoot: u,
  ...
  if (
    ...
    t[19] !== d
      ? ((e = (e) => {
          let { installedSkill: t, isInstalled: r, skill: f } = e;
          return t == null
            ? (0, Z.jsx)(
                ml,
                {
  ...
  return (
    t[21] === f
      ? (p = t[22])
      : ((p = (0, Z.jsx)(es, { gap: `compact`, children: f })),
        (t[21] = f),
        (t[22] = p)),
    p
  );
...
function Pl(e) {
  ...
  t[0] === r
    ? (a = t[1])
    : ((a = r.slice(0, 2).join(`, `)), (t[0] = r), (t[1] = a));
  ...
  return (
    t[5] !== n || t[6] !== i || t[7] !== s
      ? ((c = (0, Z.jsx)(Ta, { isExpanded: n, onClick: i, children: s })),
        (t[5] = n),
        (t[6] = i),
        (t[7] = s),
        (t[8] = c))
...
function Fl({ itemCount: e, visibleItemLimit: t }) {
  return e - t >= 3 ? t : void 0;
}
function Il(e, t) {
  let n = [];
  for (let t of e) n.push({ id: t.id, label: t.title });
  return (t != null && n.push({ id: t.id, label: t.title }), n);
}
var Ll,
  Z,
  Rl = e(() => {
...
function zl({
  directoryEntrypoint: e,
  headerPlacement: t = `app-shell`,
  hostId: i,
  initialManageTab: a,
  manageOnly: s = !1,
  mode: c = `browse`,
  ...
  let l = We(vr),
    ...
    p = pe(),
    m = Un({
      explicitEntrypoint: e,
      locationKey: p.key,
      locationState: p.state,
    }),
    h = pt(),
    g = lo(p.state),
    _ = Fa(p.search) ?? g.initialSearchQuery,
    v = _r(uu, p.key),
    y = l.get(v),
    b = A(),
    S = Jn(),
    ...
    T = (0, Q.useRef)(null),
    E = (0, Q.useRef)(null),
    D = (0, Q.useRef)(y?.browseScrollTop ?? null),
    O = me(it(Ze) ?? []),
    [k, M] = (0, Q.useState)(
      i ?? y?.selectedHostId ?? g.initialHostId ?? `local`,
    ),
    N = i ?? (O.some((e) => e.hostId === k) ? k : `local`),
    P = tt({ hostId: N }),
    [F, I] = (0, Q.useState)(() =>
      s
        ? Ql(a ?? g.initialTab)
    ...
    [ee, R] = (0, Q.useState)(() => g.connectAppId ?? null),
    [te, ne] = (0, Q.useState)(_ ?? y?.searchQuery ?? ``),
    [re, ie] = (0, Q.useState)(0),
    [ae, oe] = (0, Q.useState)(_ ?? ``),
    [se, le] = (0, Q.useState)(!1),
    [ue, de] = (0, Q.useState)(!1),
    [fe, ge] = (0, Q.useState)(`idle`),
    [_e, ve] = (0, Q.useState)(0),
    [be, xe] = (0, Q.useState)(null),
    [Se, Ce] = (0, Q.useState)(null),
    [we, Ee] = (0, Q.useState)(y?.selectedPluginDirectoryTab ?? `openai`),
    [De, Oe] = (0, Q.useState)(null),
    [ke, Ae] = (0, Q.useState)(null),
    [je, Me] = (0, Q.useState)(null),
    [Ne, Pe] = (0, Q.useState)(!1),
    [Le, Re] = (0, Q.useState)(null),
    ze = hr(N),
    { data: z, isLoading: Ve } = $i(N),
    He = z?.homeDirectory,
    Ue = ri(bc),
    Ke = Mn(bc),
    qe = ri(xc),
    Je = Mn(xc),
    {
      ...
      installedSkillMatchKeys: Qe,
      installedSkillMetadata: et,
      isFetching: nt,
      isLoading: st,
      markSkillsUpdated: ct,
      standaloneInstalledSkills: lt,
      workspaceRoots: ft,
    } = pa(N),
    {
      canInstallRecommendedSkills: ht,
      defaultRecommendedRepoRoot: gt,
      skillCreatorPath: _t,
    } = va(N),
    yt = ze == null ? null : `${ze}/skills/.system/plugin-creator/SKILL.md`,
    {
      errorMessage: bt,
      isLoading: xt,
      refresh: Ct,
    ...
    Et = po({ recommendedSkills: xt || bt != null ? null : Tt, skills: et }),
    {
      clearInstalledRecommendedSkills: Ot,
      installRecommendedSkill: kt,
      installedRecommendedSkillIds: At,
      installingSkillId: jt,
    } = Sa({
      forceReloadSkills: Ye,
      hostId: N,
      onInstalled: () => {
    ...
    {
      errorMessage: Mt,
      featuredPluginIds: Pt,
      isLoading: Ft,
      isFetching: It,
      marketplaceLoadErrors: Lt,
      marketplaces: Rt,
      availablePlugins: Bt,
      installedPlugins: Vt,
      forceReload: Ht,
    ...
    { value: Wt } = ut(`2817990312`),
    Gt = Uo(Wt),
    { value: Kt } = ut(`1349514884`),
    { hiddenPluginIds: qt } = Ko(Kt),
    Jt = r(`1269116100`),
    Yt = r(`603443661`),
    Xt = r(`4218407052`),
    { mutateAsync: Zt } = qa({ hostId: N }),
    { mutateAsync: Qt } = Ga({ hostId: N }),
    { data: en, isLoading: tn } = Xe({
      enabled: Jt,
      hostId: N,
      marketplaceKind: `shared-with-me`,
    }),
    { data: rn, isLoading: an } = Xe({
      enabled: Jt,
      hostId: N,
      marketplaceKind: `workspace-directory`,
    }),
    { data: on, isLoading: sn } = Xe({
      enabled: Xt,
      hostId: N,
      marketplaceKind: `created-by-me-remote`,
    }),
    cn = Hi(Bt, qt),
    ln = Hi(Vt, qt),
    fn = en == null ? en : Hi(en, qt),
    mn = rn == null ? rn : Hi(rn, qt),
    _n = on == null ? on : Hi(on, qt),
    vn = vs({ forceReloadPlugins: Ht, hostId: N }),
    yn = s ? null : Vr(ft),
    bn = s && N === `local`,
    { data: xn } = u(yn, { hostId: N, useActiveWorkspaceRoot: bn }),
    {
      data: Sn,
      hardRefetchAppsList: Cn,
      isHardRefetchingAppsList: Tn,
      isLoading: Dn,
      loadError: On,
    } = ar({ hostId: N }),
    kn = On?.message ?? null,
    { installPlugin: An, status: jn, uninstalling: Nn } = Te(),
    { pendingPluginId: Fn, setPluginEnabled: In } = Pn({ hostId: N }),
    { uninstallPlugin: Ln } = ii({ hostId: N }),
    { pendingRemoveMarketplaceName: Rn, removeMarketplace: zn } = zr({
      hostId: N,
    }),
    {
      isUpgradingMarketplaces: Bn,
      pendingUpgradeMarketplaceName: Vn,
      upgradeMarketplaces: Wn,
    } = Er({ hostId: N }),
    { data: Gn } = Ie(Dt, N),
    {
      clearConnectingApp: Kn,
      connectingApp: qn,
      handleAppConnectOAuthStarted: Yn,
      handleConnectApp: er,
      handleOpenAppUrl: rr,
      isAppConnectPending: H,
    } = qr({ hostId: N }),
    { setAppEnabled: or, updatingAppId: sr } = C({ hostId: N }),
    cr = Se == null ? null : (Sn?.find((e) => e.id === Se) ?? null),
    lr = Jr(Se),
    dr = wa(Gn?.config),
    fr = bo(Gn?.config),
    pr = Bn || Vn != null,
    mr = !Rt.some((e) => ka(e, dr)) || pr || Rn != null,
    gr = ee == null ? null : (Sn?.find((e) => e.id === ee) ?? null),
    yr = ee != null && H(ee),
    br = qn ?? gr,
    { authMethod: Sr } = rt(),
    { data: wr } = n(),
    Dr = wr?.structure === `workspace`,
    Or = Jl(we, Dr) ? we : `openai`,
    kr = Fe(Sr),
    jr = F.kind === `manage`,
    Mr = F.tab,
    Nr = F.kind === `browse` ? F.tab : null,
    Pr = N === `local` ? [`claude-cowork`] : [],
    Fr = P && Nr === `plugins` && Pr.length > 0,
    Ir = dt(`external-agent-imported-connectors`, {
      params: { hostId: Mi, providers: Pr },
      queryConfig: { enabled: Fr },
    }),
    Lr = kr || Tr(Bt),
    Rr = xi(cn),
    Br =
      fn == null ? null : xi(fn).filter((e) => e.remoteMarketplaceName === lu),
    Hr = mn == null ? null : xi(mn),
    Gr =
      (N === `local` && Dr ? wr.name?.trim() : null) ||
      rn
        ?.find((e) => !!e.marketplaceDisplayName?.trim())
        ?.marketplaceDisplayName?.trim() ||
      null,
    Kr = fo(d, `skills`),
    Yr = fo(d, Nr ?? `plugins`),
    Xr = te.trim().toLowerCase(),
    Zr = ae.trim().toLowerCase(),
    Qr = Xr.length > 0,
    $r = Ya(p.search),
    ei = Aa({ skills: lt, query: Xr }),
    ti = Ca({ skills: Tt, query: Xr }),
    ni = Va(ti),
    ai = no({
      installedRecommendedSkillIds: At,
      installedSkillMatchKeys: Qe,
    ...
    si = sa({ installedSkills: ei, recommendedSkills: ai }),
    { data: ci, isLoading: li } = to({ enabled: Jt, hostId: N }),
    { marketplaceFilterValue: ui, plugins: di } = Xn({
      availablePlugins: cn,
      createdByMeRemotePlugins: _n ?? null,
      homeDirectory: He,
      pluginShares: Jt && ci != null ? Hi(ci, qt) : null,
      storefrontPlugins: Rr,
    }),
    pi = ir({
      createdByMePlugins: [...di, ...(_n ?? [])],
      installedPlugins: ln,
      sharedWithYouPlugins: fn ?? [],
      workspacePlugins: mn ?? [],
    }),
    mi = Rr.filter(Hn),
    _i = Rr.filter((e) => !Hn(e) && (ui == null || un(e) !== ui)),
    vi = eu({ intl: d, roots: ft, skillEntries: si }),
    yi = Qr && Nr === `plugins`,
    bi = Nr === `skills` || yi ? null : De,
    Si = Qr ? [] : pi,
    Ci =
      yi || Or === `personal`
        ? [
            ...hn({ connectedPlugins: Si, plugins: [] }),
            {
              section: {
                id: `plugins-created-by-you`,
              ...
              plugins: Ar({ plugins: di, query: Xr }),
            },
            {
              section: {
                id: `plugins-shared-with-you`,
              ...
              plugins: Ar({ plugins: Br ?? [], query: Xr }),
            },
            ...tr(_i).map((e) => ({
              section: {
                id: `plugins-marketplace-${encodeURIComponent(e.value)}`,
                title:
                  e.subLabel == null ? e.label : `${e.label} · ${e.subLabel}`,
              },
              plugins: Ar({
                plugins: _i,
                marketplaceFilterValue: e.value,
                query: Xr,
              }),
            })),
          ].filter(({ plugins: e }) => e.length > 0)
        : [],
    wi;
  if (yi) {
    let e = { openai: mi, workspace: Hr ?? [] };
    wi = En({
      query: Xr,
      sections: Yl(d, Gr, Dr).flatMap((t) => {
        if (t.id === `personal`)
          return Ci.map((e) => ({ ...e, visibleItemLimit: e.plugins.length }));
        let n = e[t.id];
        return [
          {
            section: { id: `plugins-search-${t.id}`, title: t.label },
            plugins: n,
            visibleItemLimit: n.length,
          },
        ];
      }),
    });
    ...
    switch (Or) {
      case `openai`:
        wi = hn({
          categoryOrder: Gt.categoryIds,
          categorySections: Qr ? [] : Gt.sections,
          collapsedCategoryIds: Gt.collapsedCategoryIds,
          connectedPlugins: Si,
          featuredPluginIds: Qr ? void 0 : Pt,
          plugins: Ar({ plugins: mi, query: Xr }),
        });
        break;
      case `workspace`:
        wi = hn({
          connectedPlugins: Si,
          plugins: Ar({ plugins: Hr ?? [], query: Xr }),
        });
        break;
      case `personal`:
        wi = Ci;
  ...
  let Ti =
      kr && Nr === `plugins` && !Qr && bi == null && Or === `openai`
        ? (0, $.jsx)(B, {
    ...
    Oi = bi == null ? void 0 : Di.find((e) => e.id === bi),
    Ai = Oi?.id ?? null,
    ji = pn({
      apps: Qn({
        apps: Sn ?? [],
        connectors: Fr ? (Ir.data?.connectors ?? []) : [],
      }),
      plugins: mi,
    ...
    Ni = (
      Ai == null
        ? wi
        : wi.filter(
            ({ section: e }) => e.id === `plugins-connected` || e.id === Ai,
          )
    ).flatMap(({ plugins: e }) => e),
    Pi = yi ? Ni.slice(0, $r.offset + $r.limit) : Ni,
    Fi = Qr
      ? ga({
          pluginResultKeys: Pi.map((e) => `plugin:${hi(e)}`),
          skillResultKeys: [
            ...si.map(({ skill: e }) => `installed-skill:${e.path}`),
            ...ai.map((e) => `recommended-skill:${e.id}`),
          ],
          tab: Nr ?? `plugins`,
        })
      : [],
    Li = Fi.length,
    Ri = Fi.length === 0 ? null : Math.min(re, Fi.length - 1),
    zi = Ri == null ? null : (Fi[Ri] ?? null),
    Bi = Ar({ plugins: pi, query: Zr }),
    Vi = new Set(
      [...cn, ...di, ...(_n ?? []), ...(fn ?? []), ...(mn ?? [])].map(
        (e) => e.plugin.id,
      ),
    ...
    Wi = new Set(
      pi.filter((e) => !Vi.has(e.plugin.id)).map((e) => e.plugin.id),
    ),
    Gi = Aa({ skills: Et, query: Zr }),
    { installedApps: Ki } = _a(Sn ?? []),
    Ji = ja({ apps: Ki, query: Zr }),
    Yi = Ma({ configuredMarketplaceNames: fr, marketplaces: Rt, query: `` }),
    Xi = {
      apps: Ki.length,
      marketplace: Yi.length,
      mcps: Object.keys(xn?.servers ?? {}).length,
      plugins: pi.length,
      skills: Et.length,
    },
    Zi = jr && (sn || (Jt && (li || tn || an))),
    Qi = so({
      currentTab: Mr,
      isCurrentTabLoading: Mr === `plugins` && (Ft || (Jt && Ve) || Zi),
      isManagePage: jr,
      isPluginsEnabled: P,
      tabCounts: Xi,
    }),
    ea = jr ? Qi === `plugins` : Nr === `plugins`,
    ta = Zn({
      categoryKey: Ai,
      directoryTab: Or,
      isGlobalSearch: yi,
    ...
    na = fi({
      canonicalCategoryIds: Gt.categoryIds,
      directoryTab: Or,
      selectedCategoryTitle: Oi?.title,
    }),
    ra = { referrer: Ur(ta.pageName), source: ta.source },
    ia;
  (Or === `openai` &&
    !yi &&
    (ta.pageName === qi.CODEX_PLUGIN_PAGE_NAME_DIRECTORY
      ? (ia = { kind: `home` })
      : ta.pageName === qi.CODEX_PLUGIN_PAGE_NAME_CATEGORY &&
        na != null &&
        (ia = { categoryId: na, kind: `category` })),
    Ui({
      scope: l,
      categoryId: na,
      enabled: !jr && ea && P,
      entrypoint: m,
      pageName: ta.pageName,
      searchQuery: Xr,
      source: ta.source,
    }));
  let oa = fo(d, Qi),
    ca = Ma({ configuredMarketplaceNames: fr, marketplaces: Yi, query: Zr }),
    la = !jr && Nr === `skills` && se,
    ua = la || st || vi.length > 0 || si.length > 0,
    fa = la || xt || bt != null || ai.length > 0,
    ma = Kr.sections.at(-1) ?? null,
    ya = [
      ...vi.map((e) => ({ id: e.id, title: e.title })),
      ...(fa && ma != null ? [ma] : []),
    ],
    ba = ya.some((e) => e.id === ke) ? ke : (ya[0]?.id ?? null),
    xa = (0, Q.useEffectEvent)(async () => {
      let { availablePlugins: e } = await Ut();
      return kr || Tr(e);
    }),
    Ta = (Nr === `skills` || Qr) && ua ? (Kr.sections[0] ?? null) : null,
    Ea = (Nr === `skills` || Qr) && fa ? (Kr.sections.at(-1) ?? null) : null,
    Da = async () => {
      try {
        await Cn();
      } catch {}
    ...
    Pa = (e) => {
      l.get(Ge).danger(
        ...
        e == null ? void 0 : { description: L(e) },
      );
    },
    Ia = async (e) => {
      let t = $e(He, e.marketplacePath, e.plugin.source);
      try {
        let n = await Ba({ hostId: N, ...Ii(e) }).catch(() => null),
          r = n?.shareContext ?? e.plugin.shareContext,
          i = uo({
            pluginShareUrl: n?.pluginShareUrl ?? null,
            shareContext: r,
            savedShareUrl: null,
            configuredShareUrl: Na(e),
          });
        if (
          (i == null &&
            Jt &&
            ...
            ((i = (
              await Qa({
                pluginPath: t,
                remotePluginId: r?.remotePluginId ?? null,
                savePluginShare: Zt,
              })
            ).shareUrl),
            Ht()),
    ...
    La = async (e) => {
      ...
      if (t == null) return;
      let n = await Ba({ hostId: N, ...Ii(e) }).catch(() => null),
        r = e.plugin.shareContext,
        i =
          r != null && r.sharePrincipals != null && r.remoteVersion != null
            ? r
            : (n?.shareContext ?? r);
      if (i?.remotePluginId != null && i.sharePrincipals == null) {
        l.get(Ge).danger(
          d.formatMessage({
        ...
        initialShare:
          i == null
            ...
            : {
                ...
                sharePrincipals: Ua(i),
                shareUrl: uo({
                  pluginShareUrl: n?.pluginShareUrl ?? null,
                  shareContext: n?.shareContext ?? i,
                  savedShareUrl: null,
                  configuredShareUrl: Na(e),
                }),
              },
        saveShare: (e) =>
          Qa({ pluginPath: t, remotePluginId: e, savePluginShare: Zt }),
      });
      Wr(l, mo, {
        initialSharePrincipals: a.getCurrentShare()?.sharePrincipals ?? [],
        pluginDisplayName: $t(e),
        shouldShowCopyLinkCreationProgress: () =>
          a.getCurrentShare()?.shareUrl == null,
        onCopyLink: async () => {
          try {
            let e = a.getCurrentShare()?.shareUrl != null,
              t = await a.getOrCreateShare();
            return (
              e || Ht(),
              t.shareUrl.length === 0 ? (Pa(), !1) : await o(t.shareUrl)
            );
          } catch (e) {
            return (Pa(e), !1);
          }
        },
        onSaveShareTargets: async (e) => {
          try {
            let t = await a.saveShareTargets(e, (e, t) =>
              Qt({ remotePluginId: e, targets: t }),
            );
            return (Ht(), t);
          } catch (e) {
            throw (
        ...
        onUpdateSharedVersion: async () => {
          if (i?.remotePluginId != null)
            try {
              (await Zt({ pluginPath: t, remotePluginId: i.remotePluginId }),
                Ht(),
                l.get(Ge).success(
                  d.formatMessage({
        ...
        shouldShowUpdateSharedVersion: Ja({
          localVersion: e.plugin.localVersion,
          shareContext: i,
        }),
      });
    },
    ...
    Ha =
      ...
      (Qr
        ? sn || tn || an
        : Nr === `plugins` &&
          ((Or === `workspace` && an) || (Or === `personal` && (sn || tn)))),
    Wa = Sr === `chatgpt` && Yt,
    Ka = se || pr || Tn || st || nt || Ft || It,
    Za =
      i == null && O.length > 0
        ? (0, $.jsx)(Kl, {
    ...
    eo = () => {
      if (yt == null) return;
      zt(l, xr, {});
      let e = vc({ creatorPath: yt, isFirstOpen: !Ue, kind: `plugin` });
      (Ue || Ke(!0), S({ prefillPrompt: e, startInSidebar: !0 }));
    };
  (0, Q.useEffect)(() => {
    if (!za) {
      ge(`idle`);
  ...
  let ao = () => {
      if (_t == null) return;
      zt(l, xr, {});
      let e = vc({ creatorPath: _t, isFirstOpen: !qe, kind: `skill` });
      (qe || Je(!0), S({ prefillPrompt: e, startInSidebar: !0 }));
    },
    oo = Cr(it(ot)),
    co = ce({
      activeProject: oo,
    ...
    ho = (e, t, n = gi(e.plugin.interface?.defaultPrompt)) => {
      (t != null &&
        nr(l, {
          plugin: e.plugin,
          target: he.CODEX_PLUGIN_CLICK_TARGET_TRY_IN_TASK,
          ...t,
        }),
        S({
          activeProject: oo,
    ...
    go = async () => {
      le(!0);
      try {
        (ct(), await Promise.all([Ht(), Ct(), Cn()]), Ot(), de(!1));
      } catch {
        l.get(Ge).danger(
          d.formatMessage({
    ...
    xo = (e, t = !1) => {
      ...
      n !== p.search &&
        h(
          { hash: p.hash, pathname: p.pathname, search: n },
          { replace: t, state: p.state },
        );
    },
    So = (e) => {
      (ne(e),
        ie(0),
        Nr === `plugins` &&
          xo(e.trim().length === 0 ? null : { limit: 30, offset: 0 }, !0));
    },
    wo = () => {
    ...
    To = (e) => {
      if (!(!Qr || Fi.length === 0)) {
        if (e.key === `ArrowDown`) {
          (e.preventDefault(),
            ie(Math.min((Ri ?? 0) + 1, Fi.length - 1)),
            wo());
          return;
        }
        if (e.key === `ArrowUp`) {
          (e.preventDefault(), ie(Math.max((Ri ?? 0) - 1, 0)), wo());
          return;
        }
        if (e.key === `Enter`) {
          let t = E.current?.querySelector(
    ...
    Do = () => {
      (ki(l, N),
        l.set(v, {
          browseScrollTop: E.current?.scrollTop ?? null,
          searchQuery: te,
          selectedHostId: N,
          selectedPluginDirectoryTab: Or,
        }),
        h(`/settings/plugins-settings`, {
          state: {
            initialHostId: N,
            initialTab: `plugins`,
    ...
    Oo = () => {
      h(`..`, { state: { initialHostId: N, initialTab: $l(Qi) } });
    },
    ko = (0, Q.useCallback)((e) => {
      E.current = e;
      let t = D.current;
      e == null || t == null || ((e.scrollTop = t), (D.current = null));
    }, []),
    Ao = (e, t) => {
      (jr ||
        l.set(v, {
        ...
        h((jr ? at : ye)(e, { hostId: N }), { state: jr ? void 0 : Be(t) }));
    },
    jo = (e, t) => {
      (gn(l, { placement: t, plugin: e.plugin, source: ta.source }), Ao(e, ra));
    },
    Mo = (0, Q.useEffectEvent)(() => {
      T.current?.focus();
    }),
    Po = async (e) => {
      try {
        (await zn({ marketplaceDisplayName: Oa(e), marketplaceName: e.name }),
          Me(null));
      } catch {}
    },
    Fo = async () => {
    ...
    Io = async (e) => {
      try {
        await Wn({ marketplaceDisplayName: Oa(e), marketplaceName: e.name });
      } catch {}
    };
  (0, Q.useEffect)(() => {
    let e = (e) => {
      (e.metaKey || e.ctrlKey) &&
        e.key.toLowerCase() === `f` &&
        (nu(e.target) || (e.preventDefault(), Mo()));
    };
    return (
        ...
        : (0, $.jsx)(da, {
            ...
            children: (0, $.jsx)(as, {
              ...
              onInstallPlugin: async (e) => {
                (R(null), await er(e.importedConnectorApp));
              },
              onOpenPluginDetails: jo,
            }),
          }),
    Ro = {
      cardPlacementContext: ia,
      catalogStatusMessage: Ti,
      errorMessage: Mt,
      homeDirectory: He,
      highlightedPluginKey: zi?.startsWith(`plugin:`) ? zi.slice(7) : null,
      hostId: N,
      pluginInstallationStatus: jn,
      isLoading: Ha,
      pendingPluginId: Fn,
      uninstalling: Nn,
      reducedMotion: b,
      onInstallPlugin: async (e) => {
        An(e, {
          ...
          marketplaceAnalytics: {
            source: ta.source,
            surface: mt.CODEX_PLUGIN_MARKETPLACE_SURFACE_DIRECTORY,
          },
          activeProject: oo,
          onSuccess: Ht,
          source: ta.source,
      ...
      onToggleInstalledPluginEnabled: async ({ plugin: e, ...t }) =>
        In({
          ...t,
          marketplaceAnalytics: {
            plugin: e,
      ...
      onUninstallInstalledPlugin: async ({ plugin: e, ...t }) => {
        await Ln({
          ...t,
          marketplaceAnalytics: {
            plugin: e,
    ...
    children: [
      !jr && Nr === `plugins`
        ? (0, $.jsx)(
            Co,
            {
              directoryEntrypoint: m,
              errorMessage: Mt,
              isPageLoading: Ha,
              isPluginDataLoading: Ft,
              pageName: ta.pageName,
              routeKey: p.key,
            },
            p.key,
        ...
        : (0, $.jsx)(oi.Header, {
            ...
            children: jr
              ? (0, $.jsx)(qc, {
                  ...
                  canCreateSkill: _t != null,
                  hostSelector: Za,
                  isRefreshDisabled: Ka,
                  isRefreshingPage: se,
                  searchInput: f
                    ? (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(Ei, {
                          ...
                          label: oa.searchLabel,
                          onSearchQueryChange: oe,
                          placeholder: oa.searchPlaceholder,
                          searchQuery: ae,
                        }),
                      })
                    : void 0,
                  ...
                  onCreatePlugin: eo,
                  onCreateSkill: ao,
                  onExitManageMode: s ? void 0 : Oo,
                  onRefreshPage: () => {
                    go();
                  },
                  recordSkillAction: co ?? void 0,
                })
              : (0, $.jsx)(qc, {
                  mode: `browse`,
                  canCreatePlugin: yt != null,
                  canCreateSkill: _t != null,
                  currentBrowseTab: Nr ?? `plugins`,
                  hostSelector: Za,
                  isRefreshDisabled: Ka,
                  isRefreshingPage: se,
                  needsSkillsRefresh: ue,
                  onCreatePlugin: eo,
                  onCreateSkill: ao,
                  onAddMarketplace: () => {
                    Pe(!0);
                  },
                  onBrowseTabSelect: _o,
                  onManage: Do,
                  onRefreshPage: () => {
                    go();
                  },
      ...
      (0, $.jsx)(`div`, {
        className: `flex min-h-0 flex-1 flex-col text-base select-none`,
        children:
          !P && !(jr && Qi === `mcps`)
            ? (0, $.jsx)(Gl, {})
            : (0, $.jsx)($.Fragment, {
                children: (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    (0, $.jsx)($o, {
                      ...
                      children: jr
                                ...
                                children: [
                                  Qi === `plugins`
                                    ? (0, $.jsx)(as, {
                                        ...
                                        onUninstallInstalledPlugin: Ln,
                                        onToggleInstalledPluginEnabled: In,
                                        pendingPluginId: Fn,
                                        uninstalling: Nn,
                                        reducedMotion: b,
                                        emptyStateTitle: (0, $.jsx)(B, {
                                      ...
                                      : Qi === `mcps`
                                        ...
                                        : Qi === `marketplace`
                                          ? (0, $.jsx)(Ec, {
                                              ...
                                              isRetrying: se || It,
                                              marketplaceLoadErrors: Lt,
                                              configuredMarketplaceNames: fr,
                                              configuredGitMarketplaceNames: dr,
                                              isUpgradingMarketplaces: Bn,
                                              marketplaces: ca,
                                              onUpgradeMarketplace: (e) => {
                                                Io(e);
                                              },
                                              onRemoveMarketplace: Me,
                                              onRetry: go,
                                              pendingUpgradeMarketplaceName: Vn,
                                              pendingRemoveMarketplaceName: Rn,
                                            })
                                          : Sn == null
                                            ? (0, $.jsx)(pc, {
                                                errorMessage: kn,
                        ...
                        : (0, $.jsx)(vt, {
                            ...
                            subtitle:
                              Nr === `skills`
                                ? (0, $.jsx)(B, {
                                    ...
                                    defaultMessage: `Extend ChatGPT with task-specific skills`,
                            ...
                            search: {
                              autoFocus: Nr === `plugins`,
                              id: `plugins-page-search`,
                              inputRef: T,
                              label: Yr.searchLabel,
                              onKeyDown: To,
                              onSearchQueryChange: So,
                              placeholder: Yr.searchPlaceholder,
                              searchQuery: te,
                            },
                            children: (0, $.jsxs)(`div`, {
                              className: wn(
                              ...
                              children: [
                                Nr === `plugins` && !Qr
                                  ? (0, $.jsx)(Hl, {
                                      ...Ro,
                                      connectedPlugins: pi,
                                      importedConnectorsContent: Lo,
                                      isWorkspaceAccount: Dr,
                                  ...
                                  : yi
                                    ? (0, $.jsx)(Bl, {
                                        ...Ro,
                                        canRequestPluginSuggestion: Wa,
                                        category: ``,
                                        initialOffset: $r.offset,
                                        limit: $r.limit,
                                        searchTerm: te,
                                        onLoadedOffsetChange: (e) => {
                                          xo(
                                            { limit: $r.limit, offset: e },
                                            !0,
                                          );
                                        },
                                        onRequestPlugin: vo,
                                ...
                                Nr === `skills` && (!Qr || Li > 0)
                                  ? (0, $.jsx)(Cl, {
                                      ...
                                      highlightedInstalledSkillPath:
                                        zi?.startsWith(`installed-skill:`)
                                          ? zi.slice(16)
                                          : null,
                                      highlightedRecommendedSkillId:
                                        zi?.startsWith(`recommended-skill:`)
                                          ? zi.slice(18)
                                          : null,
                                      installedSkillGroups: vi,
                                      installedStateAction: `check`,
                                      installedSection: Ta,
                                      installedRecommendedSkillIds: At,
                                      installedSkills: si,
                                      installedSkillsForRecommendedActions: lt,
                                      installingSkillId: jt,
                                      isLoadingInstalledSkills: st || la,
                                      isLoadingRecommendedSkills: xt || la,
                                      onInstallRecommendedSkill: kt,
                                      ...
                                      onSelectSection: Ae,
                                      onSkillsUpdated: ct,
                                      recommendedRepoRoot: wt,
                                      recommendedSection: Ea,
                                      recommendedSkills: ai,
                                      roots: ft,
                                      selectedSectionId: ba,
                                      searchResultsTitle: Qr
                                        ? (0, $.jsx)(B, {
                                            id: `skills.appsPage.skillsFilter.all`,
                                            defaultMessage: `Skills`,
                                            description: `Label for the Skills option in the browse filter dropdown on the Skills & Apps page`,
                    ...
                    (0, $.jsx)($a, {
                      app: cr,
                      errorMessage: lr.error?.message ?? null,
...
function Bl(e) {
  ...
  t[0] === e
    ? ((n = t[1]),
      ...
      (u = t[9]))
    : (({
        canRequestPluginSuggestion: n,
        category: r,
        hostId: i,
        initialOffset: a,
        limit: o,
        onLoadedOffsetChange: s,
        onRequestPlugin: c,
        searchTerm: u,
        ...l
      } = e),
      ...
      (t[9] = u));
  let d;
  t[10] !== r || t[11] !== i || t[12] !== a || t[13] !== o || t[14] !== u
    ? ((d = {
        category: r,
        hostId: i,
        initialOffset: a,
  ...
  t[24] !== m || t[25] !== s
    ...
    : (x = t[26]);
  let S;
  t[27] !== h || t[28] !== g || t[29] !== v || t[30] !== x
    ? ((S = (0, $.jsx)(
        Jt,
        { hasNextPage: h, isFetchingNextPage: g, onLoadNextPage: x },
        v,
      )),
      (t[27] = h),
      (t[28] = g),
  ...
  return (
    t[32] !== b || t[33] !== S
      ? ((C = (0, $.jsxs)($.Fragment, { children: [b, S] })),
        (t[32] = b),
        (t[33] = S),
        (t[34] = C))
      : (C = t[34]),
...
function Hl(e) {
  ...
  let f;
  t[11] !== r || t[12] !== u
    ? ((f = { hostId: r, tab: u }), (t[11] = r), (t[12] = u), (t[13] = f))
    : (f = t[13]);
  let p = Ss(f),
    m;
  if (
    ...
    let f = p.find(e),
      h = f == null ? p : [f],
      g;
    (t[28] === p ? (g = t[29]) : ((g = p.map(Wl)), (t[28] = p), (t[29] = g)),
      (m = (0, $.jsx)(Qc, {
        ...c,
        contentAfterConnected: (0, $.jsxs)($.Fragment, {
          children: [
            (0, $.jsx)(ql, {
              filterSections: g,
              isWorkspaceAccount: a,
              selectedSectionId: f?.id ?? null,
              selectedTab: u,
              workspaceName: d,
              onSelectSection: o,
              onSelectTab: s,
            }),
            f == null && u === `openai` ? i : null,
          ],
        }),
        hostId: r,
        sections: [...hn({ connectedPlugins: n, plugins: [] }), ...h.map(Ul)],
      })),
      (t[14] = p),
      (t[15] = n),
      (t[16] = r),
...
function Ul(e) {
  let { id: t, plugins: n, title: r, visibleItemLimit: i } = e;
  return { plugins: n, section: { id: t, title: r }, visibleItemLimit: i };
}
function Wl(e) {
  let { id: t, title: n } = e;
  return { id: t, title: n };
...
function Kl(e) {
  let t = (0, au.c)(36),
    { connectedRemoteConnections: n, onSelectHost: r, selectedHostId: i } = e,
    a = V(),
    o;
  t[0] === a
    ? (o = t[1])
  ...
  t[17] === s
    ...
    : ((y = (0, $.jsxs)(`span`, {
        ...
        children: [
          v,
          (0, $.jsx)(`span`, { className: `truncate`, children: s }),
        ],
      })),
      (t[17] = s),
      (t[18] = y));
  let b;
  t[19] !== y || t[20] !== g || t[21] !== _
    ? ((b = (0, $.jsx)(Bt.Item, { RightIcon: g, onSelect: _, children: y })),
      (t[19] = y),
      (t[20] = g),
      (t[21] = _),
      (t[22] = b))
    ...
    (t[27] !== r || t[28] !== i
      ? ((e = (e) =>
          (0, $.jsx)(
            Bt.Item,
            {
              RightIcon: e.hostId === i ? Kr : void 0,
              onSelect: () => {
                r(e.hostId);
              },
...
function ql(e) {
  let t = (0, au.c)(21),
    ...
    u;
  t[0] !== l || t[1] !== r || t[2] !== o
    ? ((u = Yl(l, o, r)), (t[0] = l), (t[1] = r), (t[2] = o), (t[3] = u))
    : (u = t[3]);
  let d = u,
    f;
  t[4] === l
...
function Xl(e) {
  ...
  let c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(Ki, { className: `icon-sm text-token-text-secondary` })),
      (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === s
  ...
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, $.jsx)(Bt.Item, { RightIcon: u, onSelect: d, children: f })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = p))
    : (p = t[10]);
...
function eu({ intl: e, roots: t, skillEntries: n }) {
  let r = new Map();
  for (let i of n) {
    let n = Ji({ skill: i.skill, roots: t, intl: e }),
      a = r.get(n);
    if (a == null) {
      r.set(n, {
        id: `skills-installed-${tu(n)}`,
        title: n,
        skillEntries: [i],
      });
      continue;
...
function ru(e) {
  let t = (0, au.c)(41),
    { currentTab: n, onSelectTab: r, showNonMcpTabs: i, tabCounts: a } = e,
    o = V(),
    s = a.plugins,
    c;
  t[0] === o
  ...
  t[15] === o
    ...
    : ((_ = o.formatMessage({
      ...
      (t[16] = _));
  let v;
  t[17] !== _ || t[18] !== a.skills
    ? ((v = { count: g, id: `skills`, label: _ }),
      (t[17] = _),
      (t[18] = a.skills),
      (t[19] = v))
    : (v = t[19]);
  ...
  t[20] === o
    ...
    : ((b = o.formatMessage({
      ...
      (t[21] = b));
  let x;
  t[22] !== b || t[23] !== a.marketplace
    ? ((x = { count: y, id: `marketplace`, label: b }),
      (t[22] = b),
      (t[23] = a.marketplace),
      (t[24] = x))
    : (x = t[24]);
  let S;
  t[25] !== v || t[26] !== x || t[27] !== l || t[28] !== f || t[29] !== h
    ? ((S = [l, f, h, v, x]),
      (t[25] = v),
      (t[26] = x),
      (t[27] = l),
  ...
  let T;
  t[33] !== i || t[34] !== C
    ? ((T = C.filter((e) => e.id === `mcps` || (i && e.count > 0)).map(iu)),
      (t[33] = i),
      (t[34] = C),
      (t[35] = T))
    : (T = t[35]);
...
var au,
  ...
  du = e(() => {
    ((au = z()),
      ...
      (su = 15e3),
      (cu = `(max-width: 1023px)`),
      (lu = `workspace-shared-with-me-private`),
      (uu = si(vr, (e) => null)));
  });
export {
  xc as a,
...
//# sourceMappingURL=plugins-page-BwYsCaTY.js.map
