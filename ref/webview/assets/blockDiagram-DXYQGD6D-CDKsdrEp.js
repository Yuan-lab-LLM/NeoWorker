import { i as e, r as t, t as n } from "./src-zTh6it5j.js";
import { c as r, h as i, i as a, x as o } from "./chunk-5PVQY5BW-Dg9V_wGW.js";
import { t as s } from "./clone-C_NGO5yP.js";
import { q as c } from "./runtime.worker-_LqsnMiG.js";
import {
  D as l,
  L as u,
  a as d,
...
import { t as v } from "./channel-s837YGUR.js";
import { n as y } from "./chunk-U2HBQHQK-CM1HhHWn.js";
import { t as b } from "./chunk-FMBD7UC4-BTarQcMh.js";
import { n as x, t as S } from "./chunk-BSJP7CBP-BlaZACv4.js";
import { n as C, t as w } from "./chunk-ZZ45TVLE-CLSPDLuY.js";
import { t as T } from "./graphlib-DoalxkyI.js";
var E = (function () {
...
var Ee = t((t, n) => {
    ...
    let r = n.updatedPath ? n.updatedPath : n.originalPath,
      { subGraphTitleTotalMargin: a } = C(f());
    if (t.label) {
      let o = H[t.id],
        s = t.x,
        c = t.y;
      if (r) {
        let a = i.calcLabelPosition(r);
        (e.debug(
          ...
          n.updatedPath && ((s = a.x), (c = a.y)));
      }
      o.attr(`transform`, `translate(${s}, ${c + a / 2})`);
    }
    if (t.startLabelLeft) {
      let e = U[t.id].startLeft,
        ...
        a = t.y;
      if (r) {
        let e = i.calcTerminalLabelPosition(
      ...
      e.attr(`transform`, `translate(${n}, ${a})`);
    }
    if (t.startLabelRight) {
  ...
  Ae = t(function (t, n, r, i, a, s, u) {
    let d = r.points;
    e.debug(`abc88 InsertEdge: edge=`, r, `e=`, n);
    let p = !1,
      m = s.node(n.v);
    var h = s.node(n.w);
    (h?.intersect &&
      ...
      r.toCluster &&
        (e.debug(`to cluster abc88`, i[r.toCluster]),
        (d = ke(r.points, i[r.toCluster].node)),
        (p = !0)),
      r.fromCluster &&
        (e.debug(`from cluster abc88`, i[r.fromCluster]),
        (d = ke(d.reverse(), i[r.fromCluster].node).reverse()),
        (p = !0)));
    ...
    let C = t
        ...
        .attr(`d`, b(g))
        .attr(`id`, r.id)
        .attr(`class`, ` ` + S + (r.classes ? ` ` + r.classes : ``))
        .attr(`style`, r.style),
      w = ``;
    ((f().flowchart.arrowMarkerAbsolute || f().state.arrowMarkerAbsolute) &&
      ...
      Se(C, r, w, u, a));
    let T = {};
    return (p && (T.updatedPath = d), (T.originalPath = r.points), T);
  }, `insertEdge`),
  je = t((e) => {
    let t = new Set();
    for (let n of e)
  ...
  q = t(async (e, t, r, i) => {
    ...
    m =
      t.labelType === `markdown`
        ...
        : await V(d, u(a(p), o), t.labelStyle, !1, i);
    let h = m.getBBox(),
      _ = t.padding / 2;
    if (g(o)) {
      let e = m.children[0],
...
//# sourceMappingURL=blockDiagram-DXYQGD6D-CDKsdrEp.js.map
