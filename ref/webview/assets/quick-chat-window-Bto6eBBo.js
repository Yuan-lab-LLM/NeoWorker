...
import { n as Ct, t as wt } from "./toolbar-breadcrumb-COhCwKVT.js";
import {
  F as Tt,
  I as Et,
  P as Dt,
  ...
  return n === 0
    ...
    : n === 1
      ...
      : n > 1 && n < 7
        ...
        : (0, W.jsx)(ie, { value: e, day: `numeric`, month: `short` });
}
function Vt(e, t) {
...
function Kt(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Jt.jsx)(`h3`, {
        ...
        children: (0, Jt.jsx)(be, { ...Wt.nuxTitle }),
      })),
      (t[1] = i))
    : (i = t[1]);
  let a;
...
function en(e) {
  ...
  let f = d,
    p = c.length > 0 || (a === `recent` && f.length === 0),
    m;
  t[2] !== i ||
  t[3] !== o ||
  t[4] !== s ||
  ...
  t[8] !== a
    ? ((m = p
        ...
        : (0, nn.jsx)(Ve.div, {
            ...
            animate: { opacity: 1 },
            exit: l ? void 0 : { opacity: 0 },
            transition: l ? void 0 : { type: `spring`, duration: 0.3 },
            children:
              a === `welcome`
                ? (0, nn.jsx)(Kt, { onViewHistory: s })
                : (0, nn.jsxs)(`section`, {
                    ...
                    children: [
                      (0, nn.jsx)(`h3`, {
                        ...
                        children: (0, nn.jsx)(be, { ...Wt.recentChats }),
                      }),
                      (0, nn.jsx)(zt, {
                        conversations: f,
                        nowMs: i,
  ...
  return (
    t[10] === m
      ? (h = t[11])
      : ((h = (0, nn.jsx)(Ge, { initial: !1, children: m })),
        (t[10] = m),
        (t[11] = h)),
    h
  );
...
var tn,
  nn,
  rn = e(() => {
    ((tn = A()), Oe(), M(), P(), _e(), qe(), G(), Yt(), $t(), Gt(), (nn = s()));
  });
function an(e) {
  let t = (0, sn.c)(30),
    {
            ...
            r[0],
            {
              ...
              content: (0, K.jsx)(m, {
                ...
                triggerButton: (0, K.jsx)(Xe, {
                  ...
                  color: `ghost`,
                  size: `toolbar`,
                  children: (0, K.jsx)(x, { className: `icon-xs` }),
                }),
                children: e.map(on),
              }),
            },
  ...
  t[3] === g
    ...
    : ((_ = Le(
      ...
      (t[4] = _));
  let v = a ? void 0 : !0,
    y = l === `floating` ? !0 : void 0,
    b =
      l === `floating` &&
      `cursor-grab touch-none select-none active:cursor-grabbing`,
    S = l === `window` && `draggable`,
    C;
  t[5] !== b || t[6] !== S
    ? ((C = Le(`flex h-toolbar shrink-0 items-center gap-2 px-3`, b, S)),
      (t[5] = b),
      (t[6] = S),
      (t[7] = C))
    : (C = t[7]);
  ...
  t[8] !== l || t[9] !== d
    ? ((w =
        l === `window`
          ? {
              paddingInlineEnd: Math.max(d.right, 12),
              paddingInlineStart: Math.max(d.left, 12),
            }
          : void 0),
      (t[8] = l),
      (t[9] = d),
  ...
  t[11] !== p || t[12] !== c
    ? ((T = (0, K.jsx)(`div`, {
        ...
        children: (0, K.jsx)(wt, { textSm: !0, ancestors: p, current: c }),
      })),
      (t[11] = p),
      (t[12] = c),
      (t[13] = T))
  ...
  t[14] !== o || t[15] !== s
    ...
    : (E = t[16]);
  let D;
  t[17] !== w || t[18] !== T || t[19] !== E || t[20] !== y || t[21] !== C
    ? ((D = (0, K.jsxs)(`header`, {
        "data-quick-chat-drag-handle": y,
        className: C,
        style: w,
        children: [T, E],
      })),
...
function on(e) {
  return (0, K.jsx)(Se.Item, { onSelect: e.onClick, children: e.label }, e.id);
}
var sn,
  K,
  cn = e(() => {
    ((sn = A()), St(), P(), bt(), Ke(), b(), Ct(), L(), De(), (K = s()));
  });
function ln(e, t, n, r) {
  return e == null
...
function fn({
  ...
  let s = Me(),
    ...
    l = (t) => {
      ...
      let a = {
        height: X(
          i.startSize.height - (Te(t.clientY, s) - i.startPointer.y),
          r.height,
          n.height,
        ),
        width: X(
          i.startSize.width +
            (e === `left` ? -1 : 1) * (Te(t.clientX, s) - i.startPointer.x),
          r.width,
          n.width,
        ),
      };
  ...
  return (0, mn.jsx)(`div`, {
    ...
    onPointerDown: (e) => {
      ...
      ((c.current = {
        ...
        startPointer: { x: Te(e.clientX, s), y: Te(e.clientY, s) },
        startSize: n,
      }),
        a?.(!0));
    },
...
function bn(e) {
  ...
  t[0] !== u || t[1] !== d || t[2] !== f
    ? ((p = {
      ...
      (t[3] = p))
    : (p = t[3]);
  let { previewSrc: m } = yt(p);
  if (l == null) return null;
  let h = s + 1,
    g;
  t[4] !== l.title || t[5] !== h || t[6] !== o
    ? ((g =
        l.title ??
        o.formatMessage(
          {
  ...
  t[8] !== l.attribution || t[9] !== l.destinationUrl
    ? ((v =
      ...
      (t[10] = v))
    : (v = t[10]);
  let y = l.title ?? void 0,
    b = a === `window` ? `all` : `top-and-sides`,
    x;
  ...
  return (
    ...
    t[26] !== x
      ? ((T = (0, wn.jsx)(ue, {
          alt: _,
          bottomExternalLink: v,
          caption: y,
          containedInPortal: !0,
          containerResizeEdges: b,
...
function An(e, t, n) {
  let r = (0, Pn.c)(17),
    ...
    o;
  r[0] !== n || r[1] !== a
    ? ((o = () => (n ? a : 1)), (r[0] = n), (r[1] = a), (r[2] = o))
    : (o = r[2]);
  let s = (0, Fn.useEffectEvent)(o),
    c = (0, Fn.useRef)(null),
    l = (0, Fn.useRef)(null),
    d = (0, Fn.useRef)(null),
    f = (0, Fn.useRef)(null),
    ...
    ? ((_ = () => {
        ...
        let u = `following`,
          ...
          S = () => {
            ...
            let e = `${Math.ceil(Te(a.getBoundingClientRect().height, s()))}px`;
        ...
        let D = (e, t) => {
          ...
          te = () => {
            if (u === `anchoring` || u === `settling`) {
              C();
              return;
            }
            if (u === `free` && n.scrollTop >= x() - Ln) {
              E(`auto`);
              return;
            }
            C();
          ...
          re = Array.from(r.querySelectorAll(In));
        for (let e of re) y.add(e);
        S();
        let ie = p.current;
        if (((p.current = null), h)) {
          let e = re.at(-1) ?? null;
          ...
          ie?.mode === `free`
            ? ((u = `free`), (n.scrollTop = Math.min(ie.scrollTop, x())), C())
            : (ie?.mode === `anchored` || ie?.mode === `anchoring`) &&
                ie.anchoredTurn?.isConnected
              ? D(ie.anchoredTurn, `auto`)
              : E(`auto`, !0);
        let ae = typeof MutationObserver > `u` ? null : new MutationObserver(O);
        ae?.observe(r, { childList: !0, subtree: !0 });
        let j = typeof ResizeObserver > `u` ? null : new ResizeObserver(ee);
        return (
          j?.observe(r),
          a != null && j?.observe(a),
          j?.observe(n),
          n.addEventListener(`keydown`, A),
          n.addEventListener(`pointerdown`, k, { passive: !0 }),
          n.addEventListener(`scroll`, te, { passive: !0 }),
          n.addEventListener(`scrollend`, ne),
          n.addEventListener(`touchmove`, k, { passive: !0 }),
          n.addEventListener(`wheel`, k, { passive: !0 }),
          () => {
            ((p.current = { anchoredTurn: _, mode: u, scrollTop: n.scrollTop }),
              (m.current = jn),
              ae?.disconnect(),
              j?.disconnect(),
              n.style.removeProperty(`--quick-chat-footer-height`),
              ...
              n.removeEventListener(`scroll`, te),
              n.removeEventListener(`scrollend`, ne),
              n.removeEventListener(`touchmove`, k),
              n.removeEventListener(`wheel`, k));
          }
        );
      }),
      (r[3] = s),
...
function Jn(e) {
  ...
  t[9] === C
    ? (w = t[10])
    : ((w = Le(`flex min-h-full shrink-0 flex-col`, C)),
      (t[9] = C),
      (t[10] = w));
  ...
  t[11] === T
    ? (E = t[12])
    : ((E = Le(`flex flex-1 shrink-0 flex-col pt-4`, T)),
      (t[11] = T),
      (t[12] = E));
  let D;
  ...
  t[17] === _
    ...
    : ((O = (0, Q.jsx)(`div`, {
      ...
      (t[18] = O));
  let ee;
  t[19] !== D || t[20] !== O || t[21] !== w
    ? ((ee = (0, Q.jsxs)(`div`, { className: w, children: [D, O] })),
      (t[19] = D),
      (t[20] = O),
      (t[21] = w),
      (t[22] = ee))
...
function Zn(e) {
  let t = (0, or.c)(349),
    ...
    _ = c === void 0 ? `floating` : c,
    b = re($e),
    x = Ce(),
    S = Me(),
    C = Te((0, sr.useSyncExternalStore)(rr, ir), _ === `floating` ? S : 1),
    w = Te((0, sr.useSyncExternalStore)(rr, ar), _ === `floating` ? S : 1),
    T = he(),
    D = (0, sr.useId)(),
    ee = ce(ae),
    k = ce(y),
    ...
    ne = ce(o),
    ie;
  t[0] === _ ? (ie = t[1]) : ((ie = p(_)), (t[0] = _), (t[1] = ie));
  let j = ie,
    oe = je(),
    M = pt(0),
    N = pt(0),
    {
      contextSourceConversationId: ue,
      conversationId: P,
      initialScrollMode: pe,
      projectId: ge,
      projectName: _e,
      title: ye,
    } = s,
    Se;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = { flatConversationHistory: !0 }), (t[2] = Se))
    : (Se = t[2]);
  let F = h(Se),
    De;
  t[3] === F.chatTargets
    ? (De = t[4])
    : ((De = F.chatTargets.flatMap($n)), (t[3] = F.chatTargets), (t[4] = De));
  let Oe = De,
    ke = O(fr, Oe),
    Ne = O(pr, Oe),
    Fe = O(a, P),
    I = O(Qe, P),
    Ie = O(fe, P),
    L = s.hasConversation || I != null,
    R = Ie ?? ge,
    Ue;
  t[5] !== F.projectNamesById || t[6] !== R || t[7] !== _e
    ? ((Ue = R == null ? null : (F.projectNamesById.get(R) ?? _e)),
      (t[5] = F.projectNamesById),
      (t[6] = R),
      (t[7] = _e),
      (t[8] = Ue))
    : (Ue = t[8]);
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((at = []), (t[9] = at))
    : (at = t[9]);
  let [B, ot] = (0, sr.useState)(at),
    [V, st] = (0, sr.useState)(null),
    [ct, lt] = (0, sr.useState)(null),
    ut = (0, sr.useRef)(Qn),
    mt = (0, sr.useRef)(null),
    [ht, _t] = (0, sr.useState)(!1),
    vt = B.length > 0 || V != null,
    yt = ht || (rt != null && !it) || vt,
    bt = _ === `window` ? window : null,
    xt;
  ...
  let St;
  t[11] !== yt || t[12] !== bt
    ? ((St = { disabled: yt, dropTarget: bt, onFilesDropped: xt }),
      (t[11] = yt),
      (t[12] = bt),
      (t[13] = St))
    : (St = t[13]);
  ...
  if (
    ...
    ((Bt = Xt({
      ...
      sourceTargets: [...F.pinnedTargets, ...F.chatTargets],
    })),
      (Vt = Qt(Bt)),
      (t[17] = F.chatTargets),
      (t[18] = F.pinnedTargets),
  ...
  t[44] === x
    ...
    : ((nn = x.formatMessage({
      ...
      (t[45] = nn));
  let rn = nn,
    on = Math.max(0, C - 32 - 46),
    sn = w / 2,
    K = Math.min(lr, on),
    cn = Math.min(ur, sn),
    q = tr(Pt.height, K, on),
    J = tr(Pt.width, cn, sn),
    Y = ln(k, { height: q, width: J }, C, w),
    fn,
    X,
    pn,
    mn,
  ...
  if (
    ...
    fn = async () => {
      if (I != null) {
        (dt(b, {
          action: ft.CODEX_QUICK_CHAT_LIFECYCLE_ACTION_ADD_TO_CODEX_CLICKED,
          dockPosition: k,
          hasConversation: L,
          source: z.CODEX_QUICK_CHAT_SOURCE_ADD_TO_CODEX_BUTTON,
          surface: j,
        }),
          Rt(!0));
        try {
          ...
          (dt(b, {
            action: ft.CODEX_QUICK_CHAT_LIFECYCLE_ACTION_ADD_TO_CODEX_FAILED,
            dockPosition: k,
            hasConversation: L,
            source: z.CODEX_QUICK_CHAT_SOURCE_ADD_TO_CODEX_BUTTON,
            surface: j,
        ...
        (dt(b, {
          action: ft.CODEX_QUICK_CHAT_LIFECYCLE_ACTION_ADD_TO_CODEX_SUCCEEDED,
          dockPosition: k,
          hasConversation: L,
          source: z.CODEX_QUICK_CHAT_SOURCE_ADD_TO_CODEX_BUTTON,
          surface: j,
        }),
          X(z.CODEX_QUICK_CHAT_SOURCE_ADD_TO_CODEX_BUTTON));
      }
    };
    let e;
    (t[68] !== b || t[69] !== ot
      ? ((e = (e) => {
          let { cancel: t, conversationId: n } = kt(b, e);
          ot((r) => [
            ...r,
  ...
  t[90] !== w
    ? ((vn = (e, t) => {
        ...
        (M.stop(),
          ...
          e !== k &&
            (0, cr.flushSync)(() => {
              xe(b, e, { source: z.CODEX_QUICK_CHAT_SOURCE_DRAG, surface: j });
            }),
          de(M, 0, dr),
          de(N, 0, dr));
      }),
  ...
  t[100] !== w
    ? ((xn = (e, t) => {
        let n = dn(k, e, { height: q, width: J }, M.get(), t.width, C, w),
          r = Y.y + N.get() + q,
          i = ln(k, t, C, w),
          a = tr(r - t.height, 16, C - t.height - 16);
        (M.stop(),
          N.stop(),
          (0, cr.flushSync)(() => {
            Nt(t);
  ...
  let Sn = xn,
    Cn;
  t[102] !== j || t[103] !== k || t[104] !== b || t[105] !== yn
    ? ((Cn = (e) => {
        (ve(b, e, {
          source: z.CODEX_QUICK_CHAT_SOURCE_RESIZE_HANDLE,
          surface: j,
        }),
          yn(k, e));
      }),
  ...
  t[120] === _
    ...
    : ((Nn = Le(
      ...
      (t[120] = _),
      (t[121] = Nn));
  let Pn = _ === `floating` ? `quick-chat` : void 0,
    Fn = _ === `floating`,
    In = _ === `floating` ? `dialog` : void 0,
    Ln;
  t[122] !== B.length ||
  t[123] !== X ||
  t[124] !== pn ||
            ...
            ? B.length > 0
              ...
              : H
                ...
                : _ === `floating` &&
                  (e.preventDefault(),
                  e.stopPropagation(),
                  X(z.CODEX_QUICK_CHAT_SOURCE_ESCAPE_KEY))
  ...
  t[137] !== _
    ? ((Rn =
        _ === `floating`
          ? { height: q, left: Y.x, top: Y.y, width: J, x: M, y: N }
          : void 0),
      (t[131] = q),
      (t[132] = J),
      (t[133] = Y.x),
  ...
  t[147] !== w
    ? ((zn = () => {
        let e = un(
          { height: q, left: Y.x + M.get(), top: Y.y + N.get(), width: J },
          C,
          w,
        );
        yn(e);
  ...
  let Un = vt ? !0 : void 0,
    Wn;
  t[169] !== P || t[170] !== B.length || t[171] !== L
    ? ((Wn =
        L && B.length === 0 ? (0, $.jsx)(Ft, { conversationId: P }) : null),
      (t[169] = P),
      (t[170] = B.length),
      (t[171] = L),
      (t[172] = Wn))
    : (Wn = t[172]);
  let Gn = _ === `floating` ? !0 : void 0,
    Kn =
      _ === `floating` &&
      `cursor-grab touch-none select-none active:cursor-grabbing`,
    qn = _ === `window` && `draggable`,
    Yn;
  t[173] !== Kn || t[174] !== qn
    ? ((Yn = Le(
    ...
    : (Yn = t[175]);
  let Q;
  t[176] !== _ || t[177] !== T || t[178] !== S
    ? ((Q =
        _ === `window`
          ? {
              paddingInlineEnd: Math.max(T.right / S, 12),
              paddingInlineStart: Math.max(T.left / S, 12),
            }
          : void 0),
      (t[176] = _),
      (t[177] = T),
  ...
  t[191] !== D
        ...
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(Xe, {
                ...
                children: (0, $.jsx)(f, { className: `icon-xs rotate-180` }),
              }),
              (0, $.jsx)(`h2`, {
                id: D,
                    ...
                    children: [
                      (0, $.jsx)(v, {
                        ...
                        children: (0, $.jsx)(Xe, {
                          ...
                          onClick: () =>
                            we(b, {
                              source: z.CODEX_QUICK_CHAT_SOURCE_HEADER_NEW_CHAT,
                              surface: j,
                            }),
    ...
    : (Xn = t[192]);
  let Zn;
  t[193] !== fn || t[194] !== Lt || t[195] !== H || t[196] !== I
    ? ((Zn =
        H || I == null
          ? null
          : (0, $.jsx)(v, {
              tooltipContent: (0, $.jsx)(be, {
        ...
        ? (0, $.jsx)(v, {
            ...
            children: (0, $.jsx)(Xe, {
              ...
              onClick: (e) => {
                ...
                t != null &&
                  (dt(b, {
                    action: ft.CODEX_QUICK_CHAT_LIFECYCLE_ACTION_POPPED_OUT,
                    dockPosition: k,
                    hasConversation: L,
                    source: z.CODEX_QUICK_CHAT_SOURCE_POPOUT_BUTTON,
                    surface: j,
                  }),
                  m?.(I ?? P, On(t, S)));
              },
              children: (0, $.jsx)(He, { className: `icon-xs` }),
            }),
          })
        : null),
      (t[198] = j),
    ...
    ? ((hr =
        _ === `floating`
          ? (0, $.jsx)(Xe, {
              ...
              size: `icon`,
              onClick: () => {
                X(z.CODEX_QUICK_CHAT_SOURCE_CLOSE_BUTTON);
              },
              children: (0, $.jsx)(n, { className: `icon-xs` }),
            })
          : null),
      (t[209] = Ut),
      (t[210] = X),
  ...
  t[221] !== gr
    ? ((_r = (0, $.jsxs)(`header`, {
      ...
      (t[222] = _r))
    : (_r = t[222]);
  let vr = _ === `window` ? `px-5 pb-5` : l.floatingComposerInset,
    yr;
  t[223] !== j ||
  t[224] !== ue ||
  t[225] !== P ||
    ...
    ? ((yr =
        rt == null || it
          ? (0, $.jsx)(
              er,
              {
                ...
                getExtraDeveloperInstructions:
                  ue == null || I != null ? void 0 : () => i(b, ue),
                projectId: R,
                projectName: We,
                radiusVariant: `single-line`,
                isPrimaryComposer: !1,
                showLockdownSlashCommand: !0,
                surfaceVariant: _ === `window` ? `opaque` : `default`,
                onProjectChangeFromSlashCommand: L ? null : En,
                ...
                onSubmitAccepted: () => {
                  se(b, P, {
                    fileCount: qe?.length ?? 0,
                    selectedTextAttachmentCount: Je?.length ?? 0,
                    source: z.CODEX_QUICK_CHAT_SOURCE_COMPOSER,
                    surface: j,
                  });
                },
              },
          ...
          : (0, $.jsx)(Dt, {
              ...
              isTemporaryChat: !1,
              onContinueSuccess: () => {
                d(z.CODEX_QUICK_CHAT_SOURCE_UNSPECIFIED);
              },
              request: rt,
            })),
      (t[223] = j),
  ...
  t[243] === wr
    ? (Tr = t[244])
    : ((Tr = Le(`flex min-h-0 flex-1 flex-col`, wr)),
      (t[243] = wr),
      (t[244] = Tr));
  let Er = H ? !0 : void 0,
    Dr;
  ...
  t[251] !== U
    ? ((Dr = L
        ...
        : (0, $.jsx)(en, {
            ...
            onConversationSelect: (e, t) => {
              le(b, e, t, {
                source: z.CODEX_QUICK_CHAT_SOURCE_EMPTY_STATE_CONVERSATION,
                surface: j,
              });
            },
            onViewAll: () => {
    ...
    : (Dr = t[252]);
  let Or;
  t[253] !== Ge || t[254] !== qe || t[255] !== Ke || t[256] !== Je
    ? ((Or = Ge
        ? { attachments: qe, prompt: Ke, selectedTextAttachments: Je }
        : null),
      (t[253] = Ge),
      (t[254] = qe),
      (t[255] = Ke),
  ...
  t[270] === Nr
    ? (Pr = t[271])
    : ((Pr = Le(`flex min-h-0 flex-1 flex-col`, Nr)),
      (t[270] = Nr),
      (t[271] = Pr));
  let Fr = H ? void 0 : !0,
    Ir,
    Lr;
  t[272] !== j || t[273] !== b || t[274] !== U
    ? ((Ir = (e, t) => {
        (U(!1),
          le(b, e, t, {
            source: z.CODEX_QUICK_CHAT_SOURCE_HISTORY_CONVERSATION,
            surface: j,
          }));
      }),
      (Lr = () => {
        (U(!1),
          we(b, {
            source: z.CODEX_QUICK_CHAT_SOURCE_HISTORY_NEW_CHAT,
            surface: j,
          }));
      }),
      (t[272] = j),
  ...
  t[277] !== Ht || t[278] !== Ir || t[279] !== Lr
    ...
    : (Rr = t[280]);
  let zr;
  t[281] !== F.canFetchNextConversationPage ||
  t[282] !== F.fetchNextConversationPage ||
  t[283] !== F.isFetchingNextConversationPage
    ? ((zr = (0, $.jsx)(Ee, {
        hasNextPage: F.canFetchNextConversationPage,
        isFetchingNextPage: F.isFetchingNextConversationPage,
        onLoadNextPage: F.fetchNextConversationPage,
      })),
      (t[281] = F.canFetchNextConversationPage),
      (t[282] = F.fetchNextConversationPage),
      (t[283] = F.isFetchingNextConversationPage),
    ...
    ? ((Wr = B.map((e, t) =>
        (0, $.jsxs)(
          an,
          {
            ...
            minimizeLabel: _ === `floating` ? Ut : void 0,
            onMinimize:
              _ === `floating`
                ? () => {
                    X(z.CODEX_QUICK_CHAT_SOURCE_CLOSE_BUTTON);
  ...
  t[318] !== hn || t[319] !== Hn || t[320] !== Ur || t[321] !== Wr
    ...
    : (Gr = t[322]);
  let Kr;
  t[323] !== pn || t[324] !== V || t[325] !== ct || t[326] !== _
    ? ((Kr =
        V != null && ct != null
          ? (0, $.jsx)(bn, {
              onClose: pn,
...
function Qn() {}
function $n(e) {
  return e.kind === `optimistic` ? [d(e.conversationId)] : [];
}
function er(e) {
  let t = (0, or.c)(5),
    n;
  ...
  return (
    t[2] !== r || t[3] !== e
      ? ((i = (0, $.jsx)(mt, {
          children: (0, $.jsx)(Je, { ...e, composerController: r }),
        })),
        (t[2] = r),
        (t[3] = e),
        (t[4] = i))
...
var or,
  ...
  mr = e(() => {
    ((or = A()),
      ...
      (fr = ut($e, (e, { get: t }) => e.map((e) => t(a, e)), { isEqual: st })),
      (pr = ut($e, (e, { get: t }) => e.map((e) => t(Qe, e)), {
        isEqual: st,
      })));
  });
export { mr as n, Zn as t };
//# sourceMappingURL=quick-chat-window-Bto6eBBo.js.map
