...
import { n as h, r as g } from "./debug-modal-DYDgh1V1.js";
function _() {
  let e = (0, y.c)(4),
  ...
  if (
    ...
    return (
      e[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, x.jsx)(a, { to: `/`, replace: !0 })), (e[1] = t))
        : (t = e[1]),
      t
    );
  }
...
var y, b, x;
e(() => {
  ((y = o()), p(), (b = t(s(), 1)), n(), i(), m(), u(), g(), (x = r()));
})();
export { _ as DebugWindowPage };
//# sourceMappingURL=debug-window-page-sa-p93GC.js.map
