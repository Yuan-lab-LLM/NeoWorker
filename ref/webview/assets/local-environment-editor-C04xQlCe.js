...
import { n as Te, t as Ee } from "./play-outline-CTUUwJeL.js";
import { n as De, t as Oe } from "./flask-BQjQDhOP.js";
import {
  n as ke,
  t as Ae,
} from "./local-environment-workflow-messages-CqeXv1k-.js";
import { r as je, t as Me } from "./esm-CafTuWNK.js";
async function Ne(e, t, n, r) {
  let i = [
    ...Array.from(new Set(n)).flatMap((e) => [
      g(`local-environment-config`, { configPath: e, hostId: t }),
      g(`local-environment`, { configPath: e, hostId: t }),
    ]),
    ...(r == null
      ? []
      : [g(`local-environments`, { hostId: t, workspaceRoot: r })]),
  ];
...
function Fe(e) {
  let t = (0, Ie.c)(5),
    ...
    i = Re[n],
    a;
  t[0] === r ? (a = t[1]) : ((a = A(`icon-sm`, r)), (t[0] = r), (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, Le.jsx)(i, { className: a })),
        (t[2] = i),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
...
var Ie,
  ...
  ze = e(() => {
    ((Ie = x()),
      ...
      W(),
      (Le = s()),
      (Re = { tool: de, run: Ee, debug: ge, test: Oe }));
  }),
  Be,
  Ve = e(() => {
    (w(),
...
function He(e) {
  return `defaultName` in e
    ? {
        actions: [],
        cleanupPlatformScripts: We(null),
        cleanupScript: ``,
        name: e.defaultName,
        setupPlatformScripts: We(null),
        setupScript: ``,
      }
    : {
        ...
        cleanupPlatformScripts: We(e.environment.cleanup),
        cleanupScript: e.environment.cleanup?.script ?? ``,
        name: e.environment.name,
        setupPlatformScripts: We(e.environment.setup),
...
var Ye,
  ...
  J = e(() => {
    (L(),
      (Ye = `cd "$CODEX_WORKTREE_PATH"
pip install -r requirements.txt
npm install
./run/setup.sh`),
      (Xe = `docker compose down --remove-orphans
rm -rf .cache/tmp`),
      (Ze = `python -m pip install -r requirements.txt
pnpm install`),
...
function dt(e) {
  let t = (0, ft.c)(33),
    ...
    p,
    h;
  if (t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== s || t[4] !== o) {
    let e;
    t[11] === s
      ? (e = t[12])
      : ((e = (e) => ({
    ...
    t[16] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((y = (0, X.jsx)(O, { ...Y.actionsTitle })), (t[16] = y))
      : (y = t[16]);
    let b;
    t[17] !== n || t[18] !== o
      ? ((b = () => {
    ...
    (t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((x = (0, X.jsx)(O, { ...Y.addAction })), (t[20] = x))
      : (x = t[20]),
      t[21] === b
        ? (h = t[22])
        : ((h = (0, X.jsx)(z.Header, {
      ...
      t[23] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((d = (0, X.jsx)(`div`, {
            ...
            children: (0, X.jsx)(O, { ...Y.actionsDescription }),
          })),
          (t[23] = d))
        : (d = t[23]),
      (p =
        n.length === 0
          ? (0, X.jsx)(he, {
              children: (0, X.jsx)(`div`, {
                ...
                children: (0, X.jsx)(O, { ...Y.actionsEmpty }),
              }),
            })
          : (0, X.jsx)(`div`, {
              ...
              children: n.map((e) => {
                let t = g.find((t) => t.value === (e.icon ?? `tool`)) ?? g[0],
                  c = a.includes(e.id),
                  l = c && e.name.trim().length === 0,
                  u = c && e.command.trim().length === 0,
                  d = `local-env-action-name-error-${e.id}`,
                  p = `local-env-action-command-error-${e.id}`;
                return (0, X.jsxs)(
                  `div`,
                  {
                      ...
                      (0, X.jsxs)(`div`, {
                        ...
                        children: [
                          (0, X.jsx)(`label`, {
                            ...
                            children: (0, X.jsx)(O, { ...Y.actionName }),
                          }),
                          (0, X.jsxs)(`div`, {
                      ...
                      (0, X.jsxs)(`div`, {
                        ...
                        children: [
                          (0, X.jsx)(`label`, {
                            ...
                            children: (0, X.jsx)(O, { ...Y.actionScript }),
                          }),
                          (0, X.jsx)(`textarea`, {
    ...
    ((c = t[5]), (l = t[6]), (u = t[7]), (d = t[8]), (p = t[9]), (h = t[10]));
  let g;
  t[24] !== c || t[25] !== u || t[26] !== d || t[27] !== p
    ? ((g = (0, X.jsxs)(c, { className: u, children: [d, p] })),
      (t[24] = c),
      (t[25] = u),
      (t[26] = d),
      (t[27] = p),
  ...
  let _;
  return (
    t[29] !== l || t[30] !== h || t[31] !== g
      ? ((_ = (0, X.jsxs)(l, { children: [h, g] })),
        (t[29] = l),
        (t[30] = h),
        (t[31] = g),
        (t[32] = _))
...
function mt(e) {
  ...
  t[0] === l
    ? ((d = t[1]), (f = t[2]))
    : ((d = l
        ? (0, Z.jsx)(O, { ...Y.setupScript })
        : (0, Z.jsx)(O, { ...Y.cleanupScript })),
      (f = l
        ? (0, Z.jsx)(O, {
        ...
        : (0, Z.jsx)(O, { ...Y.cleanupDescription })),
      (t[0] = l),
      (t[1] = d),
      (t[2] = f));
  let p;
  t[3] !== n || t[4] !== d || t[5] !== f
    ? ((p = (0, Z.jsx)(z.Header, { title: d, subtitle: f, actions: n })),
      (t[3] = n),
      (t[4] = d),
      (t[5] = f),
      (t[6] = p))
  ...
  let S;
  t[29] !== x || t[30] !== h
    ? ((S = (0, Z.jsxs)(z.Content, { className: `gap-2`, children: [h, x] })),
      (t[29] = x),
      (t[30] = h),
      (t[31] = S))
    : (S = t[31]);
...
var ht,
  ...
  Z,
  _t = e(() => {
    ((ht = x()), (gt = t(ee(), 1)), w(), J(), et(), ut(), P(), (Z = s()));
  });
function vt() {
  let e = (0, bt.c)(4),
    t;
...
function St(e) {
  ...
  t[5] !== r
    ? ((b = () => ({
        ...
        draft: He(
          c == null
            ? {
                defaultName: xe(r) ?? y.formatMessage(Y.defaultEnvironmentName),
              }
            : { environment: c },
        ),
        hasParseError: l,
      ...
      (t[6] = b))
    : (b = t[6]);
  let [x] = (0, kt.useState)(b),
    { data: ee, error: te, refetch: re } = v(n),
    w = ee?.codexHome,
    T;
  t[7] !== w || t[8] !== i?.isCodexWorktree || t[9] !== r
    ? ((T = i?.isCodexWorktree === !0 || (w != null && a(r, w))),
      (t[7] = w),
  ...
  let E = T,
    ...
    se;
  t[11] !== D || t[12] !== r
    ? ((se = { cwd: r, hostConfig: D }), (t[11] = D), (t[12] = r), (t[13] = se))
    : (se = t[13]);
  let ce;
  t[14] === oe
    ? (ce = t[15])
  ...
  let {
      ...
      error: ue,
      refetch: de,
    } = ve(se, `local_environment_editor`, ce),
    A;
  t[16] !== n || t[17] !== r
    ? ((A = { hostId: n, workspaceRoot: r }),
      (t[16] = n),
      (t[17] = r),
      (t[18] = A))
    : (A = t[18]);
  let { updateSelection: ge } = _e(A),
    j;
  t[19] !== k || t[20] !== D || t[21] !== _
    ? ((j = {
        onSuccess: (e, t) => {
          !e.success || !k || me(_, k, D, t.value, `local_environment_editor`);
        },
      }),
      (t[19] = k),
      (t[20] = D),
      ...
      (t[22] = j))
    : (j = t[22]);
  let M = ne(`set-config-value`, D, j),
    [P, be] = (0, kt.useState)(x.revision == null),
    F = P && ((i == null && te != null) || (E && ue != null)),
    I = !P || ((i != null || w != null) && (!E || k?.root != null)),
    L;
  t[23] !== E ||
  t[24] !== x.configPath ||
  t[25] !== x.revision ||
  ...
  let V = Se(Ce),
    H = je({
      ...
      onSubmit: (e) => {
        ...
        Tt({
          isDirty: H.state.isDirty || x.revision == null || x.hasParseError,
          isSelectionReady: I,
          readError: u,
          selectionError: F,
          isSaving: V.isPending,
          validation: Ge(t.name, t.actions),
        }) ??
          V.mutate(t, {
            onSuccess: (e) => {
              if (e.type !== `invalid`) {
  ...
  t[59] !== F
    ? ((W = (e) => {
        let { values: t, isDirty: n } = e,
          r = (e) => {
            d?.(!(0, Ot.default)(e, x.draft));
          },
          i = Ge(t.name, t.actions),
          a = Tt({
            isDirty: n || x.revision == null || x.hasParseError,
            isSelectionReady: I,
            readError: u,
            selectionError: F,
            isSaving: V.isPending,
                ...
                children: [
                  x.hasParseError
                    ? (0, $.jsx)(`div`, {
                        ...
                        role: `alert`,
                        children: (0, $.jsx)(O, { ...ke.parseError }),
                      })
                    : null,
                  u
                    ? (0, $.jsxs)(`div`, {
                  ...
                  (0, $.jsxs)(`div`, {
                    ...
                    children: [
                      (0, $.jsx)(`label`, {
                        ...
                        children: (0, $.jsx)(O, { ...Y.environmentName }),
                      }),
                      (0, $.jsx)(`input`, {
...
//# sourceMappingURL=local-environment-editor-C04xQlCe.js.map
