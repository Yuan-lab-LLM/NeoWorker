...
import { n as Hr, t as Ur } from "./thread-scroll-layout-BywaziyM.js";
import { n as Wr, t as Gr } from "./header-DqwsovE6.js";
import {
  n as Kr,
  r as qr,
} from "./use-hotkey-window-detail-layout-BFpX_mZR.js";
import { B as Jr, z as Yr } from "./local-conversation-thread-Bj5uKwgs.js";
import { n as Xr, t as Zr } from "./thread-app-shell-chrome-DLtp8zjL.js";
function Qr(e) {
  let t = (0, ri.c)(35),
    {
      trigger: n,
    ...
    h = s === void 0 ? `end` : s,
    g = !!m?.results,
    [_, v] = (0, ai.useState)(m?.targets[0] ?? null);
  if (!m?.targets?.length) return null;
  let y = m?.targets?.some((e) => e.gitRoot === _?.gitRoot)
      ? _
      : (m.targets[0] ?? null),
    b = p ?? `panel`,
    x;
  t[0] !== i || t[1] !== r || t[2] !== d
    ...
    : (x = t[3]);
  let S;
  t[4] !== m.results || t[5] !== m.targets || t[6] !== y?.gitRoot
    ? ((S =
        !m.results &&
        m?.targets?.map((e) =>
          (0, W.jsx)(
            lt.Item,
            {
              ...
              RightIcon: e.gitRoot === y?.gitRoot ? Yn : void 0,
              children: (0, W.jsxs)(`div`, {
                className: `flex flex-col truncate`,
                title: e.gitRoot ?? void 0,
                children: [
                  (0, W.jsx)(`span`, {
    ...
    : (S = t[7]);
  let C;
  t[8] !== m.results?.appliedPaths ||
  t[9] !== m.results?.conflictedPaths ||
  t[10] !== m.results?.skippedPaths ||
  t[11] !== g
    ? ((C = g
        ? (0, W.jsx)(ei, {
            appliedPaths: m?.results?.appliedPaths ?? [],
            skippedPaths: m?.results?.skippedPaths ?? [],
            conflictedPaths: m?.results?.conflictedPaths ?? [],
          })
        : null),
      (t[8] = m.results?.appliedPaths),
      (t[9] = m.results?.conflictedPaths),
        ...
        ? (0, W.jsxs)(W.Fragment, {
            children: [
              (0, W.jsx)(mn, {
                ...
                onClick: () => {
                  y && a.primary.onClick(y);
                },
                disabled: a.primary.disabled || !y,
                loading: a.primary.loading,
                children: a.primary.label,
              }),
              a.secondary
                ? (0, W.jsx)(mn, {
                    size: `toolbar`,
                    ...
                    className: `justify-center`,
                    onClick: () => {
                      y && a.secondary?.onClick(y);
                    },
                    disabled: a.secondary.disabled || !y,
                    loading: a.secondary.loading,
                    children: a.secondary.label,
                  })
                : null,
            ],
          })
  ...
  t[21] === u
    ? (D = t[22])
    : ((D = u
        ? (0, W.jsx)(lt.Section, { className: `mt-2`, children: u })
        : null),
      (t[21] = u),
      (t[22] = D));
  let k;
...
function $r(e) {
  return !!(e && typeof e == `object` && `primary` in e);
}
function ei(e) {
  let t = (0, ri.c)(17),
    { appliedPaths: n, skippedPaths: r, conflictedPaths: i } = e;
  if (!(n.length + r.length + i.length > 0)) {
    let e;
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, W.jsx)(`div`, {
            className: `p-2 text-sm text-token-description-foreground`,
            children: (0, W.jsx)(U, {
  ...
  let u;
  return (
    t[13] !== a || t[14] !== s || t[15] !== l
      ? ((u = (0, W.jsxs)(`div`, {
          className: `vertical-scroll-fade-mask flex max-h-64 flex-col gap-3 overflow-y-auto rounded-lg p-2`,
          children: [a, s, l],
        })),
        (t[13] = a),
        (t[14] = s),
...
function ti(e) {
  let t = (0, ri.c)(13),
    { label: n, paths: r, className: i, Icon: a } = e;
  if (r.length === 0) return null;
  let o;
  t[0] === i
    ? (o = t[1])
    : ((o = Ut(`flex flex-col gap-1.5 text-sm`, i)), (t[0] = i), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
    : ((s = n
        ? (0, W.jsx)(`div`, {
            className: `whitespace-nowrap text-token-description-foreground`,
            children: n,
          })
        : null),
      (t[2] = n),
  ...
  if (t[4] !== a || t[5] !== r) {
    ...
    (t[7] === a
      ? (e = t[8])
      : ((e = (e) => (0, W.jsx)(ni, { filePath: e, Icon: a }, e)),
        (t[7] = a),
        (t[8] = e)),
      (c = r.map(e)),
      (t[4] = a),
  ...
  return (
    t[9] !== o || t[10] !== s || t[11] !== c
      ? ((l = (0, W.jsxs)(`div`, { className: o, children: [s, c] })),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c),
        (t[12] = l))
...
function ni(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = ii.default.basename(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === n
    ? (o = t[3])
    : ((o = ii.default.basename(ii.default.dirname(n))),
      (t[2] = n),
      (t[3] = o));
  let s = o,
    c = s && s !== `.` ? `${s}/${a}` : a,
  ...
  t[4] === r
    ? (l = t[5])
    : ((l = (0, W.jsx)(r, { className: `icon-2xs shrink-0` })),
      (t[4] = r),
      (t[5] = l));
  let u;
  t[6] === c
    ? (u = t[7])
    : ((u = (0, W.jsx)(`span`, { className: `truncate`, children: c })),
      (t[6] = c),
      (t[7] = u));
  let d;
  return (
...
function pi(e) {
  let t = (0, hi.c)(29),
    { turnId: n, diff: r, taskEnvironment: i } = e,
    a = Ce(Gn),
    o = _e(Se, n),
    s = Or(i),
    c = Kt(s == null ? void 0 : i?.repo_map?.[s]?.clone_url),
    l = Gt(Tr),
    { data: u } = ht(c, l, `remote_conversation_apply_diff`),
    { data: d } = hr(),
    f = dt(),
    p;
  bb0: {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { open: !1, result: null }), (t[5] = h))
    : (h = t[5]);
  let [g, _] = (0, gi.useState)(h),
    v;
  t[6] !== f || t[7] !== a || t[8] !== n
    ? ((v = {
        onSuccess(e, t) {
          ...
          (mi(i, e, f, a.get(we)),
            i && e.status === `success`
              ? ge(a, n)
              : !i && e.status === `success` && x(a, n),
            e.status !== `success` && _({ open: !0, result: e }));
        },
        onError(e, t) {
          let { revert: n } = t;
          mi(n === void 0 ? !1 : n, { status: `error` }, f, a.get(we));
        },
      }),
      (t[6] = f),
      (t[7] = a),
      ...
      (t[9] = v))
    : (v = t[9]);
  let y = ke(`apply-patch`, l, v),
    b;
  t[10] !== r || t[11] !== c || t[12] !== y
    ? ((b = (e) => {
        y.isPending ||
          (c &&
            y.mutate({
  ...
  return (
    ...
    t[27] !== D
      ? ((k = {
          hasAppliedCodeLocally: o,
          canApply: C,
          isApplying: y.isPending,
          apply: w,
          revert: T,
          results: g,
          setResultsOpen: E,
          isNonWorkspaceEnvironment: m,
          taskEnvironmentLabel: D,
          gitRootPath: c,
          branchName: O,
        }),
        (t[18] = c),
...
function mi(e, t, n, r) {
  if (t.status === `error` && t.errorCode === `not-git-repo`) {
    r.danger(
      n.formatMessage(
        e
          ? {
...
function vi(e) {
  let t = (0, wi.c)(53),
    ...
    a;
  t[0] !== r || t[1] !== i || t[2] !== n
    ? ((a = { turnId: n, diff: r, taskEnvironment: i }),
      (t[0] = r),
      (t[1] = i),
      (t[2] = n),
      (t[3] = a))
  ...
  let {
      ...
      results: d,
      setResultsOpen: f,
      isNonWorkspaceEnvironment: p,
      taskEnvironmentLabel: m,
    } = pi(a),
    h;
  t[4] === m
    ? (h = t[5])
    : ((h = function (e) {
        ...
        return m
          ? (0, G.jsx)(R, {
              ...
              children: (0, G.jsx)(di, { className: t }),
            })
          : (0, G.jsx)(di, { className: t });
      }),
      (t[4] = m),
      (t[5] = h));
  let g = h;
  if (o) {
    ...
    let r;
    t[7] !== p || t[8] !== m
      ? ((r = p && m && (0, G.jsx)(yi, { taskEnvironmentName: m })),
        (t[7] = p),
        (t[8] = m),
        (t[9] = r))
      : (r = t[9]);
    ...
    t[23] !== h
      ? ((b = (0, G.jsx)(mr, {
          ...
          primaryCtaText: a,
          onPrimaryCtaClick: o,
          isPrimaryCtaDisabled: h,
          secondaryCtaText: _,
          onSecondaryCtaClick: v,
          isSecondaryCtaDisabled: y,
        })),
        (t[18] = v),
        (t[19] = y),
        (t[20] = e),
      ...
      : (b = t[24]);
    let x;
    t[25] !== d.open || t[26] !== d.result || t[27] !== f
      ? ((x = (0, G.jsx)(bi, {
          open: d.open,
          result: d.result,
          onOpenChange: f,
    ...
    return (
      t[29] !== b || t[30] !== x
        ? ((S = (0, G.jsxs)(G.Fragment, { children: [b, x] })),
          (t[29] = b),
          (t[30] = x),
          (t[31] = S))
        : (S = t[31]),
  ...
  let y;
  t[33] !== p || t[34] !== m
    ? ((y = p && m && (0, G.jsx)(yi, { taskEnvironmentName: m })),
      (t[33] = p),
      (t[34] = m),
      (t[35] = y))
    : (y = t[35]);
  ...
  let C = c || !s,
    w;
  t[41] !== _ || t[42] !== b || t[43] !== S || t[44] !== C
    ? ((w = (0, G.jsx)(mr, {
        Icon: _,
        content: b,
        primaryCtaText: x,
        onPrimaryCtaClick: S,
        isPrimaryCtaDisabled: C,
      })),
      (t[41] = _),
      (t[42] = b),
      (t[43] = S),
    ...
    : (w = t[45]);
  let T;
  t[46] !== d.open || t[47] !== d.result || t[48] !== f
    ? ((T = (0, G.jsx)(bi, {
        open: d.open,
        result: d.result,
        onOpenChange: f,
  ...
  return (
    t[50] !== w || t[51] !== T
      ? ((E = (0, G.jsxs)(G.Fragment, { children: [w, T] })),
        (t[50] = w),
        (t[51] = T),
        (t[52] = E))
      : (E = t[52]),
...
function yi(e) {
  let t = (0, wi.c)(2),
    { taskEnvironmentName: n } = e,
    r;
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, G.jsx)(`div`, {
          className: `truncate text-base text-token-editor-warning-foreground`,
          children: (0, G.jsx)(U, {
...
function bi(e) {
  let t = (0, wi.c)(33),
    { open: n, onOpenChange: r, result: i } = e,
    a = dt(),
    o;
  t[0] === i?.appliedPaths
    ? (o = t[1])
    : ((o = i?.appliedPaths ?? []), (t[0] = i?.appliedPaths), (t[1] = o));
  let s = o,
    c,
    l,
    u,
  ...
  if (
    ...
    t[4] !== r ||
    t[5] !== n ||
    t[6] !== i?.conflictedPaths ||
    t[7] !== i?.errorCode ||
    t[8] !== i?.skippedPaths
  ) {
    let e = i?.conflictedPaths ?? [],
      o = i?.skippedPaths ?? [],
      h = i?.errorCode === `not-git-repo`,
      g = s.length > 0 || e.length > 0 || o.length > 0;
    ((l = E),
      (f = n),
      (p = r),
      (m = !1),
            ...
            children: [
              ...
              e.length > 0 &&
                (0, G.jsxs)(`div`, {
                  ...
                  children: [
                    (0, G.jsx)(`div`, {
                      className: `font-medium text-token-charts-red`,
              ...
              o.length > 0 &&
                (0, G.jsxs)(`div`, {
                  ...
                  children: [
                    (0, G.jsx)(`div`, {
                      className: `font-medium text-token-description-foreground`,
                      children: a.formatMessage(
                        {
    ...
    ((c = t[9]),
      ...
      (m = t[15]));
  let h;
  t[17] === r ? (h = t[18]) : ((h = () => r(!1)), (t[17] = r), (t[18] = h));
  let g;
  ...
  t[20] === h
    ...
    : ((_ = (0, G.jsx)(Mr, {
      ...
      (t[21] = _));
  let v;
  t[22] !== c || t[23] !== u || t[24] !== d || t[25] !== _
    ? ((v = (0, G.jsxs)(c, { children: [u, d, _] })),
      (t[22] = c),
      (t[23] = u),
      (t[24] = d),
      (t[25] = _),
  ...
  let y;
  return (
    t[27] !== l || t[28] !== v || t[29] !== f || t[30] !== p || t[31] !== m
      ? ((y = (0, G.jsx)(l, {
          open: f,
          onOpenChange: p,
          triggerAsChild: m,
...
function xi(e) {
  return (0, G.jsx)(`li`, { className: `truncate`, title: e, children: e }, e);
}
function Si(e) {
  return (0, G.jsx)(`li`, { className: `truncate`, title: e, children: e }, e);
}
...
function Ei(e) {
  ...
  bb0: {
    ...
    if (t[7] !== r) {
      ((e = cn(r)), (n = 0), (i = 0));
      for (let t of e) ((n += t.additions), (i += t.deletions));
      ((t[7] = r), (t[8] = e), (t[9] = n), (t[10] = i));
    } else ((e = t[8]), (n = t[9]), (i = t[10]));
    let a;
    (t[11] !== e.length || t[12] !== n || t[13] !== i
      ? ((a = { fileCount: e.length, linesAdded: n, linesRemoved: i }),
        (t[11] = e.length),
        (t[12] = n),
        (t[13] = i),
        (t[14] = a))
  ...
  t[15] !== x || t[16] !== S
    ? ((C = S
        ? (0, K.jsxs)(`div`, {
            ...
            children: [
              (0, K.jsx)(ci, { className: `icon-lg text-token-foreground` }),
              (0, K.jsx)(`div`, {
                className: `heading-lg text-token-foreground`,
                children: (0, K.jsx)(U, {
              ...
              x
                ...
                : null,
              (0, K.jsx)(lt.Separator, { paddingClassName: `py-2` }),
              (0, K.jsx)(`div`, {
                className: `mb-1 text-sm text-token-description-foreground`,
                children: (0, K.jsx)(U, {
  ...
  t[18] !== g || t[19] !== h
    ? ((T = h
        ? [
            {
              label: g ?? Oi.default.basename(h),
              subtitle: Oi.default.basename(h),
              gitRoot: h,
              workspaceRoot: h,
            },
          ]
  ...
  t[21] === d.result
    ...
    : ((E = d.result
        ? {
            appliedPaths: d.result.appliedPaths ?? [],
            skippedPaths: d.result.skippedPaths ?? [],
            conflictedPaths: d.result.conflictedPaths ?? [],
          }
        : null),
      (t[21] = d.result),
      (t[22] = E));
  let D;
  t[23] !== T || t[24] !== E
    ? ((D = { targets: T, results: E }), (t[23] = T), (t[24] = E), (t[25] = D))
    : (D = t[25]);
  let O = !s || c,
    k;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, K.jsx)(ci, { className: `icon-xs` })), (t[26] = k))
    : (k = t[26]);
  let A;
  t[27] === y
    ? (A = t[28])
    : ((A = (0, K.jsx)(U, { ...y })), (t[27] = y), (t[28] = A));
  let j;
  t[29] !== c || t[30] !== A || t[31] !== O
    ? ((j = (0, K.jsxs)(mn, {
        size: `toolbar`,
        color: `outline`,
        loading: c,
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (M = t[33]);
  let N;
  t[34] !== l || t[35] !== s || t[36] !== o || t[37] !== c || t[38] !== u
    ? ((N = o
        ? {
            primary: {
              label: (0, K.jsx)(U, {
  ...
  t[40] !== p || t[41] !== m
    ? ((P =
        p && m
          ? (0, K.jsx)(`div`, {
              className: `text-center text-sm text-balance text-token-editor-warning-foreground`,
              children: (0, K.jsx)(U, {
                id: `codex.applyOrRevertBanner.applyMessageDifferentEnvironment`,
                defaultMessage: `This chat was created in {environment} so its changes may not apply cleanly.`,
                description: `Banner warning the user that the Codex code changes they are viewing were made in a different environment and may not apply cleanly.`,
                values: {
                  environment: (0, K.jsx)(`span`, {
                    className: `font-medium`,
                    children: m,
                  }),
                },
  ...
  t[48] !== D
    ...
    : (F = t[49]);
  let I;
  t[50] !== d.open || t[51] !== d.result || t[52] !== f
    ? ((I = (0, K.jsx)(bi, {
        open: d.open,
        result: d.result,
        onOpenChange: f,
  ...
  return (
    t[54] !== F || t[55] !== I
      ? ((L = (0, K.jsxs)(K.Fragment, { children: [F, I] })),
        (t[54] = F),
        (t[55] = I),
        (t[56] = L))
      : (L = t[56]),
...
function Ai({ turns: e, selectedTurn: t, diffTaskTurn: n }) {
  let r = new Map();
  for (let t of e) r.set(t.id, t);
  (t && r.set(t.id, t), n && r.set(n.id, n));
  let i = Array.from(r.values()).filter((e) => !ae(e)),
    a = t ? Mi(i, r, t) : null,
    o = !!t && !!n && u(r, t.id, n.id),
    s = ji(n),
    c = o ? s : null;
  n &&
    c &&
    (!a || n.created_at > a.actionTurn.created_at) &&
    (a = { actionTurn: n, prItem: c });
  let l = ji(t);
  return (
    !a && t && l && (a = { actionTurn: t, prItem: l }),
    !a && !t && n && s && (a = { actionTurn: n, prItem: s }),
    a
  );
}
function ji(e) {
  return e?.output_items?.find((e) => e.type === `pr`) ?? null;
}
function Mi(e, t, n) {
  let r = null;
  for (let i of e) {
    if (!w(t, n.id, i.id)) continue;
    let e = ji(i);
    e?.output_diff?.diff &&
      (!r || i.created_at > r.actionTurn.created_at) &&
      (r = { actionTurn: i, prItem: e });
  }
  return r;
}
var Ni = e(() => {
...
function Pi(e) {
  let t = (0, Ri.c)(25),
    ...
    c = s === void 0 ? `toolbar` : s,
    l = Ce(wn),
    u = dt(),
    d = Ee(Dr.createPullRequestAsDraft),
    f = Re(),
    p = (0, zi.useRef)(null),
    m = (0, zi.useRef)(null),
    [h, g] = (0, zi.useState)(null),
    _ = Ai({ turns: r, selectedTurn: i, diffTaskTurn: a }),
    v = _?.actionTurn ?? null,
    y = (_?.prItem ?? null)?.output_diff?.diff ?? null,
    b = v?.id ?? null,
    x = v?.pull_request_status ?? null,
    S = !!h && h === b,
    C = !!n && !!b && (f.isPending || x === `creating` || S),
    w = C ? Fi : !1,
    T;
  t[0] !== w || t[1] !== C
    ? ((T = { enabled: C, refetchInterval: w }),
      (t[0] = w),
      (t[1] = C),
      (t[2] = T))
    : (T = t[2]);
  let { data: E } = ar(n, b, T),
    D = E?.turn ?? v,
    O = D?.pull_request_status ?? null,
    A = D?.pull_request_data?.url ?? null,
    j = Li(o, D?.id ?? null, A) ?? Li(o, b, A),
    M = D?.turn_status === `completed`,
    N = Ii(O, A),
    P = f.isPending || O === `creating` || (S && !N);
  ((0, zi.useEffect)(() => {
    let e = p.current;
    e != null &&
      A &&
      (kt({ ...e, href: A, initiator: `pull_request_link` }),
      (p.current = null));
  }, [A]),
    (0, zi.useEffect)(() => {
      !b ||
  ...
  let F = function (e) {
      A && vt({ event: e, href: A, initiator: `pull_request_link` });
    },
    I = async function (e) {
      if (!n || !b || !M || P) return;
      let t = Et(e);
      ((p.current = {
        ...(t ? { disposition: `new-tab` } : {}),
        openTargetIntent: t ? `alternate` : `default`,
      }),
        (m.current = null),
        g(b));
      try {
  ...
  if (A) {
    ...
    t[3] === n
      ? (r = t[4])
      : ((r = (0, q.jsx)(rr, { className: `icon-xs shrink-0`, status: n })),
        (t[3] = n),
        (t[4] = r));
    let i;
    t[5] === e
      ? (i = t[6])
      : ((i = (0, q.jsx)(zn, { number: e })), (t[5] = e), (t[6] = i));
    let a;
    return (
      t[7] !== F || t[8] !== c || t[9] !== r || t[10] !== i
        ? ((a = (0, q.jsxs)(mn, {
            className: `shrink-0`,
            color: `outline`,
            size: c,
  ...
  t[14] === P
    ? (z = t[15])
    : ((z = P
        ? (0, q.jsx)(Nt, { className: `icon-xs` })
        : (0, q.jsx)(k, { className: `icon-xs` })),
      (t[14] = P),
      (t[15] = z));
  let B;
  t[16] !== d || t[17] !== P
  ...
  let ee;
  return (
    t[19] !== c || t[20] !== L || t[21] !== R || t[22] !== z || t[23] !== B
      ? ((ee = (0, q.jsxs)(mn, {
          className: `shrink-0`,
          color: `outline`,
          disabled: L,
...
function Fi(e) {
  let t = e.state.data?.turn;
  return Ii(t?.pull_request_status ?? null, t?.pull_request_data?.url ?? null)
    ? !1
    : Bi;
}
function Ii(e, t) {
  return t
    ...
    : e === `created` ||
        e === `failed` ||
        e === `updated` ||
        e === `externally_created`;
}
function Li(e, t, n) {
  if (t != null) {
    let n = e.find((e) => e.assistant_turn_id === t);
    if (n) return n.pull_request;
  }
  if (n != null) {
    let t = e.find((e) => e.pull_request.url === n);
    if (t) return t.pull_request;
  }
  return null;
}
var Ri,
...
function Hi(e) {
  let t = (0, Ui.c)(33),
    { conversationId: n } = e,
    r = dt(),
    { isPinned: i, togglePin: a } = _t(n),
    o = _e(mt, `toggleThreadPin`),
    c = _e(mt, `copySessionId`),
    l = i ? p : Je,
    u;
  t[0] === r
    ? (u = t[1])
    : ((u = r.formatMessage(wt.moreActions)), (t[0] = r), (t[1] = u));
  let d = u,
    f;
  (t[2] === a ? (f = t[3]) : ((f = [a]), (t[2] = a), (t[3] = f)),
    It(`toggle-thread-pin`, a, f));
  let m, h;
  (t[4] === n
    ? ((m = t[5]), (h = t[6]))
    : ((m = () => {
  ...
  if (
    (t[7] === n
      ...
      : ((g = () => {
        ...
        (t[8] = g),
        (t[9] = _)),
    It(`copy-deeplink`, g, _),
    !n)
  )
    return null;
  let v;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, J.jsx)(B, { className: `icon-sm` })), (t[10] = v))
    : (v = t[10]);
  let y;
  t[11] === d
    ? (y = t[12])
  ...
  t[13] === l
    ? (x = t[14])
    : ((x = (0, J.jsx)(U, { ...l })), (t[13] = l), (t[14] = x));
  let S;
  t[15] !== x || t[16] !== b || t[17] !== a || t[18] !== o
    ? ((S = (0, J.jsx)(lt.Item, {
        onSelect: a,
        LeftIcon: b,
        keyboardShortcut: o,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, J.jsx)(lt.Item, {
        disabled: !0,
        LeftIcon: T,
        children: (0, J.jsx)(U, { ...wt.renameThread }),
      })),
      (t[20] = C))
    : (C = t[20]);
  let w, E;
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, J.jsx)(lt.Item, {
        disabled: !0,
        LeftIcon: ne,
        children: (0, J.jsx)(U, { ...wt.archiveThread }),
      })),
      (E = (0, J.jsx)(lt.Separator, {})),
      (t[21] = w),
      (t[22] = E))
    : ((w = t[21]), (E = t[22]));
  let D;
  t[23] === n ? (D = t[24]) : ((D = () => Jn(n)), (t[23] = n), (t[24] = D));
  let k;
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, J.jsx)(U, { ...wt.copySessionId })), (t[25] = k))
    : (k = t[25]);
  let A;
  t[26] !== c || t[27] !== D
    ? ((A = (0, J.jsx)(lt.Item, {
...
function Gi(e, t, n) {
  let r = e?.current_diff_task_turn,
    i = e?.current_assistant_turn,
    a = t?.output_items?.find((e) => e.type === `pr`),
    o = r?.output_items?.find((e) => e.type === `pr`),
    s = t == null || (r != null && Ki(n, t, r)) ? o : void 0;
  return t && t.id !== i?.id
    ? ((a ?? s)?.output_diff?.diff ?? null)
    : ((a ?? s ?? i?.output_items?.find((e) => e.type === `pr`))?.output_diff
        ?.diff ?? null);
}
function Ki(e, t, n) {
  let r = new Map();
  for (let t of e) r.set(t.id, t);
  return (r.set(t.id, t), r.set(n.id, n), u(r, t.id, n.id));
}
var qi = e(() => {
  ut();
});
function Ji() {
  let e = (0, Yi.c)(28),
    ...
    i = t.data,
    a = i?.task.id,
    o = a == null ? null : `${_}/tasks/${a}`,
    s = i?.current_diff_task_turn,
    c = i?.current_assistant_turn,
    l;
  e[0] === i?.task.external_pull_requests
    ? (l = e[1])
    : ((l = i?.task.external_pull_requests ?? []),
      (e[0] = i?.task.external_pull_requests),
      (e[1] = l));
  let u = l,
    d;
  e[2] !== r || e[3] !== i || e[4] !== n
    ? ((d = Gi(i, r, n)), (e[2] = r), (e[3] = i), (e[4] = n), (e[5] = d))
    : (d = e[5]);
  let f = d,
    p = r?.id ?? s?.id ?? null,
    m =
      r?.environment ??
      (r?.id === s?.id ? s?.environment : void 0) ??
      (r == null || r.id === c?.id ? c?.environment : void 0),
    h = i?.task.title ?? null,
    g = a ?? null,
    v;
  e[6] === g
    ? (v = e[7])
    : ((v = (0, Y.jsx)(Hi, { conversationId: g })), (e[6] = g), (e[7] = v));
  let y;
  e[8] !== p || e[9] !== m || e[10] !== f
    ? ((y =
        f && p
          ? (0, Y.jsx)(Ei, { turnId: p, diff: f, taskEnvironment: m })
          : null),
      (e[8] = p),
      (e[9] = m),
      (e[10] = f),
  ...
  e[12] === o
    ...
    : ((x = (0, Y.jsx)(R, {
        ...
        children: (0, Y.jsxs)(mn, {
          color: `outline`,
          size: `toolbar`,
          onClick: (e) => {
            o != null &&
              vt({ event: e, href: o, initiator: `open_in_browser_bridge` });
          },
          children: [
            (0, Y.jsx)(b, {
              className: `icon-2xs`,
              ExternalIcon: nr,
              href: o ?? `https://chatgpt.com/codex`,
            }),
            (0, Y.jsx)(U, {
      ...
      (e[13] = x));
  let S;
  e[14] !== s || e[15] !== u || e[16] !== r || e[17] !== a || e[18] !== n
    ? ((S = a
        ? (0, Y.jsx)(Pi, {
            taskId: a,
            turns: n,
  ...
  let w;
  return (
    e[24] !== h || e[25] !== v || e[26] !== C
      ? ((w = (0, Y.jsx)(Lt, { start: h, startActions: v, trailing: C })),
        (e[24] = h),
        (e[25] = v),
        (e[26] = C),
        (e[27] = w))
...
function Zi(e) {
  let t = e?.thread_events?.events;
  return Array.isArray(t)
    ? t.flatMap((e, t) => {
        let n = oa(e);
        return n == null ? [] : [{ id: `stored:${t}`, notification: n }];
      })
    : [];
}
function Qi(e) {
  if (!ma(e) || e.item_type !== `thread_event`) return null;
  let t = e,
    n = oa(t.event);
  return n == null
    ? null
...
function $i({
  ...
  storedEvents: t,
  liveEvents: n,
  preserveLiveImageGenerationEvents: r = !1,
}) {
  let i = t.some(
    (e) =>
      e.notification.method === `item/completed` &&
      e.notification.params.item.type === `agentMessage`,
  );
  if (e !== `completed` || !i) return [...t, ...n];
  if (!r) return t;
  let a = new Set(
      t.flatMap((e) =>
        e.notification.method === `item/completed`
          ? [ea(e.notification.params.item)]
          : [],
      ),
    ),
    o = n.filter(
      (e) =>
        e.notification.method === `item/completed` &&
        e.notification.params.item.type === `imageGeneration` &&
        !a.has(ea(e.notification.params.item)),
    );
  return [...t, ...o];
}
function ea(e) {
...
function ta({
  ...
  threadEvents: r,
  fallbackDiff: i,
  includeUserMessage: a,
}) {
  let o = tt([]),
    s = {
      params: {
        threadId: n.conversation_id ?? e,
        input: a ? aa(t.input_items) : [],
        cwd: null,
      ...
      turnId: n.id,
      turnStartedAtMs: pa(n.created_at),
    ...
    c = r.reduce(na, s),
    l = ra(n, c.status),
    u = l === c.status ? c : { ...c, status: l };
  if (u.items.some((e) => e.type === `agentMessage`)) return u;
  let d = fa(n.output_items?.filter((e) => e.type === `message`) ?? []);
  return d.trim().length === 0
    ? u
    : En(u, (e) => {
        e.items.push({
          id: `cloud-assistant-message:${n.id}`,
          type: `agentMessage`,
          text: d,
          phase: null,
          memoryCitation: null,
...
function na(e, t) {
  return En(e, (e) => {
    switch (t.method) {
      case `turn/started`:
        ((e.turnId = t.params.turn.id),
          (e.status = t.params.turn.status),
          (e.error = t.params.turn.error),
          (e.turnStartedAtMs = e.turnStartedAtMs ?? Date.now()));
        break;
      case `turn/completed`:
        ((e.turnId = t.params.turn.id),
          (e.status = t.params.turn.status),
      ...
      case `turn/diff/updated`:
        e.diff = t.params.diff;
        break;
      case `turn/plan/updated`:
        e.items.push({
          id: zt(),
          type: `todo-list`,
          explanation: t.params.explanation ?? null,
          plan: t.params.plan,
        });
        break;
      case `item/started`: {
        let n = ca(t.params.item);
        if (n.type === `userMessage`) break;
        (n.type === `agentMessage` &&
          (e.finalAssistantStartedAtMs =
            e.finalAssistantStartedAtMs ?? Date.now()),
          la(e.items, n));
        break;
      }
      case `item/completed`: {
      ...
      case `item/agentMessage/delta`: {
        let n = ua(e.items, t.params.itemId, `agentMessage`);
        n && (n.text = `${n.text}${t.params.delta}`);
        break;
      }
      case `item/plan/delta`: {
        let n = ua(e.items, t.params.itemId, `plan`);
        n && (n.text = `${n.text}${t.params.delta}`);
        break;
      }
      case `item/reasoning/summaryTextDelta`: {
        let n = ua(e.items, t.params.itemId, `reasoning`);
        if (!n) break;
        let r = t.params.summaryIndex;
        ((n.summary = da(n.summary, r, ``)),
          (n.summary[r] = `${n.summary[r]}${t.params.delta}`));
        break;
      }
      case `item/reasoning/textDelta`: {
        let n = ua(e.items, t.params.itemId, `reasoning`);
        if (!n) break;
        let r = t.params.contentIndex;
        ((n.content = da(n.content, r, ``)),
          (n.content[r] = `${n.content[r]}${t.params.delta}`));
        break;
      }
      case `item/commandExecution/outputDelta`: {
        let n = ua(e.items, t.params.itemId, `commandExecution`);
        n &&
          (n.aggregatedOutput = `${n.aggregatedOutput ?? ``}${t.params.delta}`);
        break;
      }
      case `error`:
        e.items.push({
          id: zt(),
          type: `error`,
          message: t.params.error.message,
          willRetry: t.params.willRetry,
          errorInfo: t.params.error.codexErrorInfo,
          additionalDetails: t.params.error.additionalDetails ?? null,
        });
        break;
    }
  });
...
function ra(e, t) {
  let n = ia(e);
  return n === `inProgress` ? t : n;
}
function ia(e) {
  if (
    e.cancellation_requested_at != null &&
    (e.turn_status === `pending` || e.turn_status === `in_progress`)
  )
    return `interrupted`;
  switch (e.turn_status) {
    case `completed`:
      return `completed`;
    case `failed`:
      return `failed`;
...
function oa(e) {
  if (!ma(e)) return null;
  let t = e.method;
  return typeof t != `string` || !sa(t)
    ? null
    : { method: t, params: e.params };
}
function sa(e) {
  return (
    e === `turn/started` ||
    ...
    e === `item/started` ||
    e === `item/completed` ||
    e === `item/agentMessage/delta` ||
    e === `item/plan/delta` ||
    e === `item/reasoning/summaryTextDelta` ||
    e === `item/reasoning/textDelta` ||
...
function ua(e, t, n) {
  return e.find((e) => e.id === t && e.type === n) ?? null;
}
function da(e, t, n) {
...
function fa(e) {
  return e
    .flatMap((e) => e.content.filter((e) => e.content_type === `text`))
    .map((e) => e.text)
    .join(``);
}
function pa(e) {
  return typeof e == `number` ? e * 1e3 : null;
}
function ma(e) {
...
function ga({ getGroupings: e, routeContextId: t, scrollAdapter: n }) {
  return Br({
    contextId: t,
    getTurns: () =>
      e().flatMap(({ node: e, activeId: t }) => {
        let n = _a(e.userTurn.input_items.filter((e) => e.type === `message`)),
          r =
            e.assistantTurns.find((e) => e.id === t) ??
            e.assistantTurns[0] ??
            null,
          i =
            r == null
              ? ``
              : Te(_a(r.output_items.filter((e) => e.type === `message`))),
          a = [];
        return (
          n.trim().length > 0 &&
            a.push({
              turnKey: `user:${e.userTurn.id}`,
              units: [{ unitId: `message`, text: n }],
            }),
          r != null &&
            i.trim().length > 0 &&
            a.push({
              turnKey: `assistant:${r.id}`,
              units: [{ unitId: `message`, text: i }],
            }),
          a
        );
      }),
...
function ya(e) {
  ...
  return t.success
    ? { id: t.data.id, createdAt: t.data.key.created_at, line: t.data.line }
    : null;
}
var ba,
  xa = e(() => {
    (vn(),
      (ba = jt({
        id: kr(),
        item_type: pn(`log`),
        key: jt({ type: pn(`UserSetupScript`), created_at: kr() }),
        line: kr(),
      })));
  });
function Sa(e) {
...
function Ca(e) {
  let t = (0, wa.c)(16),
    {
      ...
      turnId: r,
      turnStatus: i,
      keepStreamOpenAfterCompletion: a,
    } = e,
    o = a === void 0 ? !1 : a,
    s;
  t[0] === r
    ? (s = t[1])
    : ((s = () => (r == null ? Da : (Ea.get(r) ?? Da))),
      (t[0] = r),
      (t[1] = s));
  let [c, l] = (0, Ta.useState)(s),
    u = y(),
    d,
    f;
  (t[2] === r
  ...
  let m = p,
    ...
    g;
  return (
    t[10] !== u || t[11] !== m || t[12] !== n || t[13] !== r
      ? ((h = () => {
          if (!m || !n || !r) return;
          let e = new URLSearchParams();
          (e.append(`item_type`, `thread_event`), e.append(`item_type`, `log`));
          let t = `/wham/tasks/${n}/turns/${r}/stream?${e.toString()}`,
            i = lr.getInstance().stream(`GET`, t, {
              headers: I(),
              onEvent: (e) => {
                let t = Qi(e.data),
                  n = ya(e.data);
                (t == null && n == null) ||
                  l((e) => {
                    let i =
                        t == null || e.threadEvents.some((e) => e.id === t.id)
                          ? e.threadEvents
                          : [...e.threadEvents, t],
                      a =
                        n == null || e.setupLogs.some((e) => e.id === n.id)
                          ? e.setupLogs
                          : [...e.setupLogs, n];
                    if (i === e.threadEvents && a === e.setupLogs) return e;
                    let o = { setupLogs: a, threadEvents: i };
                    return (Ea.set(r, o), o);
                  });
              },
              onComplete: () => {
                (u.invalidateQueries({ queryKey: [`tasks`] }),
                  u.invalidateQueries({ queryKey: [`task`, n] }),
                  u.invalidateQueries({ queryKey: [`task`, n, `turns`] }));
              },
            });
          return () => {
            lr.getInstance().cancelStream(i);
          };
        }),
        (g = [u, m, n, r]),
        (t[10] = u),
...
var wa,
  ...
  Oa = e(() => {
    ((wa = V()),
      ...
      xa(),
      (Ea = new Map()),
      (Da = { setupLogs: [], threadEvents: [] }));
  });
function ka(e) {
  let t = (0, Za.c)(77),
    { hostId: n, showComposer: r, conversationDetailLevel: i } = e,
    a = r === void 0 ? !0 : r,
    o = Ce(Gn),
    { data: s, error: c, isLoading: l } = H(He),
    { isFetching: u, isLoading: d } = H(Ir),
    f = H(F),
    p = H(de),
    h = H(tn),
    g = Ln(`chatgpt.supportsNewChatKeyShortcut`),
    [v, y] = (0, X.useState)(null),
    { taskId: b } = Nr(),
    { mutate: x } = Pn(b ?? ``),
    S = p ?? s?.current_assistant_turn,
    C = S?.environment,
    w = S?.turn_status ?? null,
    T = w === `pending` || w === `in_progress`,
    E = w === `failed`,
    D = xe(),
    O = i ?? D,
    k = O === Tn,
    j;
  t[0] !== p || t[1] !== s || t[2] !== f
    ? ((j = Gi(s, p, f)), (t[0] = p), (t[1] = s), (t[2] = f), (t[3] = j))
    : (j = t[3]);
  let M = j,
    N = s?.task.has_unread_turn ? s.task.id : null,
    P,
    I;
  (t[4] !== x || t[5] !== o || t[6] !== N
    ? ((P = () => {
  ...
  t[9] === b
    ...
    : ((L = (e) => {
      ...
      (t[10] = L));
  let R = L,
    z = (0, X.useEffectEvent)(Aa),
    B;
  t[11] !== k || t[12] !== z || t[13] !== s?.task.id || t[14] !== M
    ? ((B = () => {
        k || (s?.task.id && M && z(s?.task.id ?? null, M));
      }),
      (t[11] = k),
      (t[12] = z),
      (t[13] = s?.task.id),
  ...
  let ee = s?.task.id,
    te;
  (t[16] !== k || t[17] !== ee || t[18] !== M
    ? ((te = [k, ee, M]), (t[16] = k), (t[17] = ee), (t[18] = M), (t[19] = te))
    : (te = t[19]),
    (0, X.useEffect)(B, te));
  let ne;
  t[20] === g
    ...
    : ((ne = (e) => {
      ...
      (t[21] = ne));
  let re = ft(ne),
    ie = s?.task.title ?? void 0,
    ae;
  t[22] === ie
    ? (ae = t[23])
    : ((ae = (0, Z.jsx)(at, {
        extension: !0,
        children: (0, Z.jsx)(Gr, { title: ie }),
      })),
      (t[22] = ie),
      (t[23] = ae));
  let oe;
  t[24] === s
    ...
    : ((oe = (0, Z.jsx)(at, {
        extension: !0,
        children: (0, Z.jsx)(ja, { taskDetails: s }),
      })),
      (t[24] = s),
      (t[25] = oe));
  let se;
  t[26] !== k || t[27] !== p || t[28] !== C || t[29] !== b || t[30] !== M
    ? ((se =
        M &&
        b &&
        p?.id &&
        !k &&
        (0, Z.jsx)(vi, { turnId: p.id, diff: M, taskEnvironment: C })),
      (t[26] = k),
      (t[27] = p),
      (t[28] = C),
      (t[29] = b),
  ...
  t[32] !== E || t[33] !== R
    ...
    : (ce = t[34]);
  let le;
  t[35] !== T || t[36] !== w || t[37] !== o || t[38] !== a || t[39] !== b
    ? ((le =
        a &&
        w != null &&
        (0, Z.jsx)(`div`, {
  ...
  t[57] !== M
    ? ((pe = s
        ? (0, Z.jsx)(Pa, {
            ...
            taskId: b ?? null,
            turnsLoading: d || u,
            focusedAssistantId: S?.id ?? null,
            conversationDetailLevel: O,
            hideCodeBlocks: k,
          })
        : l
          ? (0, Z.jsx)(`div`, {
  ...
  t[62] === b
    ? (he = t[63])
    : ((he = (0, Z.jsx)(pr, {}, b)), (t[62] = b), (t[63] = he));
  let ge;
  t[64] !== h || t[65] !== ue || t[66] !== me || t[67] !== he
    ? ((ge = (0, Z.jsxs)(Ur, {
        hasLiveMcpAppFrame: h,
        footer: ue,
        children: [me, he],
      })),
      (t[64] = h),
    ...
    : (ge = t[68]);
  let _e;
  t[69] !== re || t[70] !== ae || t[71] !== oe || t[72] !== ge
    ? ((_e = (0, Z.jsx)(rn, {
        containerRef: re,
  ...
  return (
    t[74] !== v || t[75] !== _e
      ? ((ve = (0, Z.jsx)(hn, { value: v, children: _e })),
        (t[74] = v),
        (t[75] = _e),
        (t[76] = ve))
      : (ve = t[76]),
...
function ja(e) {
  ...
  t[0] === n
    ...
    : ((r =
        ...
        (0, Z.jsxs)(`a`, {
          ...
          href: `https://chatgpt.com/codex/tasks/${n.task.id}`,
          children: [
            (0, Z.jsx)(Qt, { className: `icon-2xs` }),
            (0, Z.jsx)(U, {
            ...
            (0, Z.jsx)(R, {
              ...
              children: (0, Z.jsx)(Dt, { className: `icon-2xs` }),
            }),
          ],
        })),
      (t[0] = n),
  ...
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, Z.jsx)(Z.Fragment, { children: r })), (t[2] = r), (t[3] = i)),
    i
  );
}
function Ma(e) {
  return (0, Z.jsx)(Z.Fragment, { children: X.Children.toArray(e) });
}
function Na(e) {
  return (0, Z.jsx)(
    `span`,
    { className: `underline underline-offset-2`, children: e },
    `codex-cloud`,
  );
}
function Pa({
      ...
      () => ({
        scrollToTurn: async (e, t) => {
          t?.signal?.aborted ||
            (await Fr(),
            !t?.signal?.aborted &&
              (Fa(d, e)?.scrollIntoView({
                block: `center`,
                behavior: `smooth`,
              }),
              await Fr()));
        },
        getTurnContainer: (e) => Fa(d, e),
      }),
      [],
    ),
    p = (0, X.useRef)(u);
  ...
  let h = H(l),
    g = (0, X.useMemo)(
      () =>
        ga({
          getGroupings: () => p.current,
          routeContextId: r == null ? `unavailable` : `remote:${r}`,
          scrollAdapter: f,
        }),
      [f, r],
    );
  return (
    Rr({ containerRef: d, contextId: g.contextId }),
    u.length === 0
      ? (0, Z.jsx)(m, {
          fillParent: !0,
      ...
      : (0, Z.jsxs)(Z.Fragment, {
          children: [
            vr.isRecording() || (r != null && Wn.isPending(r))
              ? (0, Z.jsx)(
                  Bn,
                  {
                    onPaint: () => {
                      (vr.markRemoteThreadVisible(),
                        r != null && Wn.complete(r));
                    },
                  },
                  r,
                )
              : null,
            (0, Z.jsx)(S, { conversationSource: g, diffSource: h }),
            (0, Z.jsxs)(`div`, {
              ref: d,
              ...
              children: [
                i ? null : (0, Z.jsx)(Yr, { getItems: () => Ka(u) }),
                u.map(({ node: t, activeId: i }) => {
                  let c = t.userTurn.input_items.filter(
                      (e) => e.type === `image_asset_pointer`,
                    ),
                    l = t.userTurn.input_items.filter(
                      (e) => e.type === `comment`,
                    ).length,
                    u = Ga(
                      t.userTurn.input_items.filter(
                        (e) => e.type === `message`,
                      ),
                    ),
                    d = t.userTurn.input_items.flatMap((e) =>
                      e.type === `ide_context`
                        ? bn(e.context, { contextOnly: !0 })
                        : [],
                    ),
                    f = $e(t.assistantTurns, i),
                    p = !!a && f?.id === a,
                    m = `user:${t.userTurn.id}`,
                    h = yt(m, `message`);
                  return (0, Z.jsxs)(
                    `div`,
                    {
                      className: `flex flex-col gap-2`,
                      "data-content-search-turn-key": m,
                      "data-content-search-assistant-turn-key":
                        (f == null ? null : `assistant:${f.id}`) ?? void 0,
                      children: [
                        (0, Z.jsx)($t, { role: `user` }),
                        c.length > 0
                          ? (0, Z.jsx)(Ja, { attachments: c })
                          : null,
                        d.length > 0
                          ? (0, Z.jsx)(`div`, {
                              className: `flex max-w-full flex-wrap justify-end gap-2 self-end`,
                              children: (0, Z.jsx)(Pt, { annotations: d }),
                            })
                          : null,
                        (0, Z.jsx)(`div`, {
                          className: `scroll-mt-4`,
                          "data-content-search-unit-key": h,
                          children: (0, Z.jsx)(Xn, {
                            hasExternalAttachments: d.length > 0,
                            message: u,
                            sentAtMs: null,
                            hostId: e,
                            commentCount: l,
                            referencesPriorConversation:
                              t.userTurn.input_items.some(
                                (e) => e.type === `prior_conversation`,
                              ),
                          }),
                        }),
                        f
...
function Fa(e, t) {
  ...
  return n == null
    ? null
    : (n.querySelector(`[data-content-search-turn-key="${t}"]`) ??
        n.querySelector(`[data-content-search-assistant-turn-key="${t}"]`) ??
        null);
}
function Ia(e) {
  let t = (0, Za.c)(50),
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((l = t[0]), (c = t[1]));
  let u;
  t[2] !== a.id || t[3] !== a.turn_status || t[4] !== r
    ? ((u = {
        taskId: r,
        turnId: a.id,
        turnStatus: a.turn_status,
        keepStreamOpenAfterCompletion: l,
      }),
      (t[2] = a.id),
      (t[3] = a.turn_status),
      (t[4] = r),
      (t[5] = u))
    : (u = t[5]);
  let { setupLogs: d, threadEvents: f } = Ca(u),
    p;
  t[6] === a ? (p = t[7]) : ((p = Zi(a)), (t[6] = a), (t[7] = p));
  let m = p,
    h;
  t[8] !== a.turn_status || t[9] !== f || t[10] !== m
    ? ((h = $i({
        turnStatus: a.turn_status,
        storedEvents: m,
        liveEvents: f,
        preserveLiveImageGenerationEvents: l,
      }).map(Ra)),
      (t[8] = a.turn_status),
      (t[9] = f),
      (t[10] = m),
    ...
    : (h = t[11]);
  let g = h,
    _ = a.error?.code === `startup_script_failed`,
    v;
  t[12] === _ ? (v = t[13]) : ((v = { enabled: _ }), (t[12] = _), (t[13] = v));
  let { data: y } = Jt(r, a.id, v),
    b;
  t[14] !== d || t[15] !== y
    ? ((b = y == null ? d : y.logs.flatMap(La)),
      (t[14] = d),
      (t[15] = y),
      (t[16] = b))
    : (b = t[16]);
  let x = b,
    S = a.turn_status === `failed` && _,
    C =
      g.length === 0 &&
      (a.turn_status === `pending` || a.turn_status === `in_progress`),
    w;
  t[17] === n ? (w = t[18]) : ((w = { hostId: n }), (t[17] = n), (t[18] = w));
  let { data: T } = gn(w),
    E;
  t[19] === T
    ? (E = t[20])
    : ((E = T === void 0 ? [] : T), (t[19] = T), (t[20] = E));
  let D = E,
    O = r ?? a.id,
    k;
  t[21] !== a || t[22] !== s || t[23] !== O || t[24] !== g || t[25] !== i
    ? ((k = ta({
        taskId: O,
        userTurn: i,
        assistantTurn: a,
  ...
  let A = k,
    j;
  t[27] === A ? (j = t[28]) : ((j = Pr(A, [])), (t[27] = A), (t[28] = j));
  let M = j,
    N;
  t[29] !== D ||
  t[30] !== a.id ||
  ...
  t[38] !== M
    ? ((N = S
        ...
        : C
          ? (0, Z.jsx)(Ha, { logs: x })
          : (0, Z.jsx)(Ft, {
              conversationId: Mn(r ?? a.id),
              hostId: n,
              turnSearchKey: `assistant:${a.id}`,
              turn: A,
              turnState: M,
              conversationDetailLevel: o,
              cwd: null,
  ...
  t[40] === a.turn_status
    ? (P = t[41])
    : ((P =
        a.turn_status === `cancelled`
          ? (0, Z.jsx)(`div`, {
              className: `text-secondary px-4 text-sm`,
              children: (0, Z.jsx)(U, {
      ...
      (t[41] = P));
  let F;
  t[42] !== a.error?.message || t[43] !== a.turn_status || t[44] !== _
    ? ((F =
        a.turn_status === `failed` && !_
          ? (0, Z.jsx)(za, { message: a.error?.message ?? null })
          : null),
      (t[42] = a.error?.message),
      (t[43] = a.turn_status),
      (t[44] = _),
      (t[45] = F))
    : (F = t[45]);
  let I;
  return (
    t[46] !== N || t[47] !== P || t[48] !== F
      ? ((I = (0, Z.jsxs)(Z.Fragment, { children: [N, P, F] })),
        (t[46] = N),
        (t[47] = P),
        (t[48] = F),
        (t[49] = I))
...
function La(e, t) {
  return e.key.type === `UserSetupScript`
    ? [{ id: `stored:${t}`, createdAt: e.key.created_at ?? ``, line: e.line }]
    : [];
}
function Ra(e) {
...
function za(e) {
  ...
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, Z.jsx)(mr, { type: `error`, content: r })),
        (t[2] = r),
        (t[3] = i)),
    i
  );
...
`)),
  ...
  return (
    t[3] === i
      ? (a = t[4])
      : ((a = (0, Z.jsx)(Wa, { title: r, output: i })), (t[3] = i), (t[4] = a)),
    a
  );
}
function Va(e) {
...
function Wa(e) {
  ...
  t[0] === r
    ...
    : ((i =
        r.length > 0
          ? (0, Z.jsx)(Cr, { className: `text-sm`, children: r })
          : (0, Z.jsx)(`span`, {
  ...
  t[4] === a
    ? (s = t[5])
    : ((s = [{ key: `cloud-environment-setup-output`, node: a }]),
      (t[4] = a),
      (t[5] = s));
  let c;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = { preview: `500px`, expanded: `500px`, collapsed: `0px` }),
      (t[6] = c))
    : (c = t[6]);
  let l;
  t[7] === s
...
function Ka(e) {
  return e.map(({ node: e, activeId: t }) => {
    let n = `user:${e.userTurn.id}`,
      r = $e(e.assistantTurns, t),
      i = r?.output_items ?? [];
    return {
      id: yt(n, `message`),
      getPreview: () => {
        let e = i.flatMap((e) => {
          ...
          return (
            e.type === `pr`
              ? (n = e.pr_title.trim() || null)
              : (e.type === `comment` || e.type === `suggested_task`) &&
                (n = e.title?.trim() || null),
            [{ label: n, type: t }]
          );
        });
        return (
          r?.direct_push_pushed_commit_sha != null &&
            e.push({ label: null, type: `commit` }),
          {
            outputs: e,
            response: Ga(i.filter((e) => e.type === `message`)).trim(),
          }
        );
      },
      getLabel: () =>
        Ga(e.userTurn.input_items.filter((e) => e.type === `message`)).trim(),
      isHeartbeat: !1,
      turnKey: n,
    };
  });
...
function Ja(e) {
  let t = (0, Za.c)(4),
    { attachments: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.map(Ya)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Ya(e, t) {
  return (0, Z.jsx)(Xa, { asset: e }, `${e.asset_pointer}-${t}`);
}
function Xa(e) {
  let t = (0, Za.c)(25),
    { asset: n } = e,
  ...
  t[2] === r
    ...
    : ((c = r.formatMessage({
      ...
      (t[3] = c));
  let l = c,
    { src: u, isLoading: d, isError: f, refetch: p } = et(n.asset_pointer);
  if (f) return null;
  if (d || !u) {
    let e;
    t[4] === r
...
function $a() {
  ...
  let c = s,
    ...
    f = H(Xe),
    p = u && c != null,
    [m, h] = (0, no.useState)(null),
    g = d && f,
    _ = !g,
    v = g && r.data != null && l != null,
    y;
  (e[4] === t ? (y = e[5]) : ((y = () => Ke(t)), (e[4] = t), (e[5] = y)),
    Mt(y));
  let b;
  e[6] === c
    ? (b = e[7])
    : ((b = (0, Q.jsx)(rt, { lastTurnCwd: null, lastTurnDiff: c })),
      (e[6] = c),
      (e[7] = b));
  let x;
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Q.jsx)(cr.MainContentLayout, { layout: `thread-edge-scroll` })),
      (e[8] = x))
    : (x = e[8]);
  let S;
  e[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, Q.jsx)(cr.Header, { children: (0, Q.jsx)(Ji, {}) })),
      (e[9] = S))
    : (S = e[9]);
  let C;
  e[10] !== n || e[11] !== _
    ? ((C = (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(ka, { hostId: n, showComposer: _ }),
      })),
      (e[10] = n),
      (e[11] = _),
      (e[12] = C))
  ...
  e[13] === p
    ? (w = e[14])
    : ((w = (0, Q.jsx)(Zr, { showReviewTab: p, threadType: `remote` })),
      (e[13] = p),
      (e[14] = w));
  let T;
  e[15] === v
    ? (T = e[16])
    : ((T = v ? (0, Q.jsx)(eo, {}) : null), (e[15] = v), (e[16] = T));
  let E;
  e[17] !== b || e[18] !== C || e[19] !== w || e[20] !== T
    ? ((E = (0, Q.jsxs)(`div`, {
        ref: h,
        className: `relative h-full min-h-0`,
        children: [b, x, S, C, w, T],
      })),
      (e[17] = b),
      (e[18] = C),
      (e[19] = w),
  ...
  return (
    e[22] !== m || e[23] !== E
      ? ((D = (0, Q.jsx)(hn, { value: m, children: E })),
        (e[22] = m),
        (e[23] = E),
        (e[24] = D))
      : (D = e[24]),
...
function eo() {
  let e = (0, to.c)(2),
    t = H(de),
    n = t?.turn_status === `pending` || t?.turn_status === `in_progress`,
    r;
  return (
    e[0] === n
      ? (r = e[1])
...
function io(e) {
  let t = (0, ao.c)(13),
    ...
    a = H(qt),
    o = H(He).data,
    s = o?.task.task_status_display?.environment_label,
    c;
  if (
    (t[0] !== s || t[1] !== o?.task || t[2] !== i || t[3] !== r
      ? ((c =
          r !== `hotkey` || i == null
            ? null
            : {
  ...
  let u = l,
    d;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(pe.Surface, {})), (t[10] = d))
    : (d = t[10]);
  let f;
  return (
    t[11] === u
      ? (f = t[12])
      : ((f = (0, $.jsxs)($.Fragment, { children: [d, u] })),
        (t[11] = u),
        (t[12] = f)),
    f
  );
...
export { io as RemoteConversationPage };
//# sourceMappingURL=remote-conversation-page-Bmkn7k3n.js.map
