...
function f(e) {
  let n = (0, g.c)(12),
    { backAriaLabel: r, label: a, seed: o, onBack: s } = e,
    c;
  n[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, _.jsx)(t, { className: `icon-xs` })), (n[0] = c))
    : (c = n[0]);
  let l;
  n[1] !== r || n[2] !== s
    ? ((l = (0, _.jsx)(`button`, {
  ...
  n[4] === o
    ? (u = n[5])
    : ((u = (0, _.jsx)(i, { seed: o, className: `size-6`, "aria-hidden": !0 })),
      (n[4] = o),
      (n[5] = u));
  let d;
  n[6] === a
...
//# sourceMappingURL=subagent-panel-f_gsLZAq.js.map
