...
import { a as t, n, u as r } from "./register-BqqwIOLc-BmdQpaTx.js";
function i() {
  return {
  ...
  function a(e) {
    ...
    (n(r.type === `math`), this.exit(e), (r.value = t));
    let i = r.data.hChildren[0];
    (n(i.type === `element`),
      n(i.tagName === `code`),
  ...
  function s(e) {
    ...
    (n(r.type === `inlineMath`),
      this.exit(e),
      (r.value = t),
      r.data.hChildren.push({ type: `text`, value: t }));
  }
  function c(e) {
...
`,
      ...
      handlers: { math: n, inlineMath: i },
    }
  );
  function n(e, t, n, i) {
    let a = e.value || ``,
      o = n.createTracker(i),
      s = `$`.repeat(Math.max(r(a, `$`) + 1, 2)),
      c = n.enter(`mathFlow`),
      l = o.move(s);
    if (e.meta) {
...
`,
  ...
  function i(e, n, r) {
    let i = e.value || ``,
      a = 1;
    for (t || a++; RegExp(`(^|[^$])` + `\\$`.repeat(a) + `([^$]|$)`).test(i);)
      a++;
    let o = `$`.repeat(a);
    /[^ \r\n]/.test(i) &&
      ((/^[ \r\n]/.test(i) && /[ \r\n]$/.test(i)) || /^\$|\$$/.test(i)) &&
...
//# sourceMappingURL=index-9fQ9wihu-DleF-bRg.js.map
