...
import {
  n as vt,
  t as yt,
} from "./use-hotkey-window-dismiss-on-escape-aCDydxPp.js";
function bt(e) {
  let t = (0, J.c)(52),
    {
      canUseCloud: n,
  ...
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, Y.jsxs)(Y.Fragment, { children: [u, d, f] })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = p))
    : (p = t[10]);
  ...
  if (o) {
    ...
    return (
      t[13] !== o || t[14] !== e
        ? ((n = (0, Y.jsx)(y, { tooltipContent: o, children: e })),
          (t[13] = o),
          (t[14] = e),
          (t[15] = n))
        : (n = t[15]),
...
function Tt(e) {
  ...
  t[0] !== n || t[1] !== i
    ? ((s = () => {
        Ie({ composerMode: n, setComposerMode: i });
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = s))
  ...
  (t[3] === c ? (l = t[4]) : ((l = { enabled: c }), (t[3] = c), (t[4] = l)),
    m(`composer.toggleWorktreeMode`, s, l));
  let u;
  t[5] === o
    ? (u = t[6])
    : ((u = o.formatMessage({
...
function Lt() {
  ...
  let t = ce(),
    ...
    o = Ke(),
    { access: s } = _(),
    { isLoading: c, remoteProjects: f, selectedRemoteProject: m } = we(),
    g = (0, Q.useRef)(null),
    y = (0, Q.useRef)(null),
    x = (0, Q.useRef)(null),
    S = (0, Q.useRef)(null),
    C = r.state,
    w = C?.focusComposerNonce ?? null,
    T = C?.project,
    E = T === void 0 ? void 0 : T?.type === `local` ? T.projectId : null,
    { data: O, isLoading: k } = I(He),
    j = te(d.hotkeyWindowProjectlessDefaultEnabled),
    P = I(de),
    F = St({
      activeWorkspaceRoot: O?.roots[0] ?? null,
      defaultToProjectless: j === !0,
      localProjects: P,
      projectId: E,
    }),
    L =
      T === void 0
        ? m
        : T?.type === `remote`
          ? (f.find((e) => e.id === T.projectId) ?? null)
          : null,
    R = L == null && F === `~`,
    ae = I(ne),
    B = L?.hostId ?? `local`,
    ...
    U = je(B),
    W = Ct({
      composerWorkspaceRoot: F,
      selectedRemoteProjectPath: L?.remotePath ?? null,
    }),
    fe =
      L == null && F == null && (T === void 0 ? k : T?.type === `remote` && c),
    pe = N({ cwd: W, hostId: B, isLoading: fe }),
    me = I(ve),
    { data: be, isLoading: Ce } = Ae(
      W == null ? null : { cwd: W, hostConfig: H },
      `hotkey_window_home_page`,
      { retainRepoWatch: me },
    ),
    G = be?.root ?? null,
    Ee = W != null && G != null && a && !l(W, U),
    Oe = L == null && !k && !Ce && G == null,
    K = R || Oe,
    Me = {
      fallbackMode: `local`,
      isAvailabilityLoading: !K && ((L == null && k) || Ce || o),
      isCloudAvailable: !K,
      isLocalAvailable: !0,
      isWorktreeAvailable: Ee,
    },
    Ne = D(re, pe),
    Fe = I(ue),
    Ie = le(),
    q = b({ ...Me, composerMode: Ne, cloudAccess: s, isEverydayWorkMode: !1 }),
    { gitRoot: Le } = it(W, {
      enabled: q === `worktree` && W != null,
      hostId: B,
    ...
    }),
    {
      ...
      isLoading: Be,
      error: Ve,
      resolvedConfigPath: Ue,
      repairConfigPath: We,
      updateSelection: Ge,
    } = Se({ hostId: B, workspaceRoot: q === `worktree` ? W : null }),
    [Je, Ye] = (0, Q.useState)(!1),
    [Xe, $e] = (0, Q.useState)(null),
    et = Ot({
      activationNonce: w,
      interactiveRegionRef: y,
      onInteractiveChange: (e) => {
        z.hotkeyWindowHotkeys?.homePointerInteractionChanged({
          isInteractive: e,
        });
      },
    });
  he(`hotkey-window-home-composer-position-changed`, (e) => {
    $e(e.topInsetPx);
  });
  let tt = (e) => {
    let t = g.current,
    ...
    (c?.minimumComposerTopInsetPx === s.minimumComposerTopInsetPx &&
      ...
      ((S.current = s), z.hotkeyWindowHotkeys?.homeLayoutChanged(s));
  };
  (0, Q.useEffect)(() => {
    Qe();
  }, [w]);
  ...
  (0, Q.useLayoutEffect)(() => {
    let e = null,
      ...
      r = nt && typeof MutationObserver < `u` ? new MutationObserver(t) : null;
    return (
  ...
  let at = (0, Q.useCallback)(
    ...
    st = (e) => {
      if (W == null) {
        ke.dispatchMessage(`show-settings`, { section: `local-environments` });
        return;
      }
      ke.dispatchMessage(`show-settings`, {
        section:
          e == null
            ? `local-environments?${new URLSearchParams({ workspaceRoot: W }).toString()}`
            : Te({ configPath: e, workspaceRoot: W }).slice(10),
        state: { hostId: B, returnTo: `/settings/local-environments` },
      });
    },
    lt = (e) => {
      z.hotkeyWindowHotkeys?.open({ path: ee(e) });
    },
    ut = (e) => {
      let t = {
        ...C,
        project: e == null ? null : { type: `local`, projectId: De(e) },
      };
      i(
    ...
    dt = (e) => {
      x.current === e.pointerId &&
        ...
        z.hotkeyWindowHotkeys?.homeDragEnd());
    },
    pt = (e) => {
      e.button === 0 &&
        (e.preventDefault(),
        ...
        z.hotkeyWindowHotkeys?.homeDragStart({
          pointerWindowX: e.clientX,
          pointerWindowY: e.clientY,
        }));
    },
    mt = (e) => {
      x.current === e.pointerId && z.hotkeyWindowHotkeys?.homeDragMove();
    },
    ht =
      Pe(L?.remotePath ?? W, L?.label) ??
      t.formatMessage({
  ...
  return (0, $.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, $.jsxs)(`div`, {
        ...
        style: Xe == null ? void 0 : { bottom: `auto`, top: Xe },
        children: [
          (0, $.jsx)(`div`, {
          ...
          (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(qe, {
              children: (0, $.jsx)(ct, {
                ...
                composerModeAvailability: Me,
                placeholderText: yt,
                defaultCwd: F ?? (R || T !== void 0 ? `~` : void 0),
                selectedProject: R ? null : (T ?? ae),
                hotkeyWindowHomeFooterControls: (0, $.jsxs)(oe, {
                  open: Je,
                  onOpenChange: Ye,
                  children: [
                    (0, $.jsx)(M, {
                      asChild: !0,
                      children: (0, $.jsx)(ye, { label: xt, size: `composer` }),
                    }),
                    (0, $.jsx)(p, {
                      align: `center`,
                      side: `top`,
                          ...
                          q === `worktree`
                            ? (0, $.jsx)(Z, {
                                ...
                                control: (0, $.jsx)(_t, {
                                  ...
                                  isLoading: Be,
                                  hasError: Ve != null,
                                  selectedConfigPath: Ue,
                                  repairConfigPath: We,
                                  onSelectConfigPath: Ge,
                                  onOpenSettings: st,
                                }),
                              })
                            : null,
...
//# sourceMappingURL=hotkey-window-home-page-wPuIcIe6.js.map
