...
import { n as dt, t as ft } from "./toolbar-breadcrumb-COhCwKVT.js";
import { n as pt, t as mt } from "./use-home-directory-Ca_CpGeT.js";
import { n as ht, t as gt } from "./settings-loading-row-BdxyJgCw.js";
import {
  _ as _t,
  c as vt,
  d as yt,
  ...
  v as Tt,
  y as Et,
} from "./browser-use-settings-DfdZKrCs.js";
var Dt,
  Ot = e(() => {
    Dt =
...
function Ft(e) {
  ...
  t[1] === r
    ? (i = t[2])
    : ((i = De(`h-2 w-2 shrink-0 rounded-full`, r)), (t[1] = r), (t[2] = i));
  let a;
  t[3] === i
    ? (a = t[4])
  ...
  t[5] === n.isConnected
    ...
    : ((o = (0, Y.jsx)(`span`, {
        ...
        children: n.isConnected
          ? (0, Y.jsx)(V, { ...Lt.connected })
          : (0, Y.jsx)(V, { ...Lt.disconnected }),
      })),
      (t[5] = n.isConnected),
      (t[6] = o));
  let s;
...
function Ht() {
  let e = (0, Z.c)(24),
    ...
    r = M(ce, t),
    i;
  e[0] === t ? (i = e[1]) : ((i = { hostId: t }), (e[0] = t), (e[1] = i));
  let a = o(i),
    { platform: s } = T(),
    c = Oe(t).kind === `local`,
    l = n(`188145323`);
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(q.Header, { title: (0, Q.jsx)(V, { ...X.control }) })),
      (e[5] = f))
    : (f = e[5]);
  let p;
  e[6] !== a || e[7] !== s
    ? ((p = (0, Q.jsx)(Wt, { computerUseAvailability: a, platform: s })),
      (e[6] = a),
      (e[7] = s),
      (e[8] = p))
    : (p = e[8]);
  let m;
  e[9] !== r || e[10] !== a.available || e[11] !== s
    ? ((m = s === `macOS` && a.available && r ? (0, Q.jsx)(en, {}) : null),
      (e[9] = r),
      (e[10] = a.available),
      (e[11] = s),
      (e[12] = m))
  ...
  e[13] !== p || e[14] !== m
    ? ((h = (0, Q.jsxs)(q, {
        children: [f, (0, Q.jsxs)(q.Content, { children: [p, m] })],
      })),
      (e[13] = p),
      (e[14] = m),
      (e[15] = h))
    : (h = e[15]);
  let g;
  e[16] !== a.available || e[17] !== l || e[18] !== c || e[19] !== s
    ? ((g = a.available
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              s === `macOS` && c && l
                ? (0, Q.jsx)(fe, { electron: !0, children: (0, Q.jsx)(Ut, {}) })
                : null,
              (0, Q.jsxs)(q, {
                children: [
                  (0, Q.jsx)(q.Header, {
                    title: (0, Q.jsx)(V, { ...X.alwaysAllowedApps }),
                  }),
                  (0, Q.jsx)(q.Content, {
                    children: (0, Q.jsx)(W, { children: (0, Q.jsx)(rn, {}) }),
                  }),
                ],
              }),
              (0, Q.jsx)(Qt, {}),
  ...
  return (
    e[21] !== h || e[22] !== g
      ? ((_ = (0, Q.jsxs)(Le, { title: u, subtitle: d, children: [h, g] })),
        (e[21] = h),
        (e[22] = g),
        (e[23] = _))
      : (_ = e[23]),
...
function Ut() {
  let e = (0, Z.c)(11),
    t = L(K),
    n = H(),
    r = ee(u.alwaysHidePictureInPicture),
    i;
  ...
  e[5] === t
    ? (c = e[6])
    : ((c = (e) => {
        F(t, u.alwaysHidePictureInPicture, e);
      }),
      (e[5] = t),
      (e[6] = c));
  let l;
...
function Wt(e) {
  let t = (0, Z.c)(35),
    { computerUseAvailability: r, platform: i } = e,
    a = H(),
    o = ae(),
    { selectedHostId: s } = le(),
    u = Oe(s).kind === `local`,
    { data: d } = M(je, s),
    f;
  t[0] === s ? (f = t[1]) : ((f = { hostId: s }), (t[0] = s), (t[1] = f));
  let p = oe(f),
    m;
  t[2] === s ? (m = t[3]) : ((m = { hostId: s }), (t[2] = s), (t[3] = m));
  let { isUpdating: h, setAppEnabled: g, updatingAppId: _ } = l(m),
    v;
  ...
  let y = c(s, v),
    ...
    S = n(Qe),
    C;
  t[5] !== b || t[6] !== y.availablePlugins
    ? ((C = J(y.availablePlugins, fn, b)),
      (t[5] = b),
      (t[6] = y.availablePlugins),
      (t[7] = C))
    : (C = t[7]);
  let w = C,
    T;
  t[8] !== b || t[9] !== y.availablePlugins
    ? ((T = sn(y.availablePlugins, b)),
      (t[8] = b),
      (t[9] = y.availablePlugins),
      (t[10] = T))
    : (T = t[10]);
  let E = T,
    D = y.availablePlugins.find(Ne) ?? null,
    O = S ? (y.availablePlugins.find(Ke) ?? null) : null,
    k = [
      {
    ...
    A = E?.plugin.installed === !0,
    j = A && E.plugin.enabled,
    N = d?.find(Kt)?.isEnabled ?? !0,
    P = h && _ === gn,
    F;
  t[11] !== E || t[12] !== A || t[13] !== s
    ? ((F = { hostId: s, plugin: E, shouldReadBrowserExtension: A }),
      (t[11] = E),
      (t[12] = A),
      (t[13] = s),
      (t[14] = F))
  ...
  let I = qt(F),
    L = [],
    R;
  t[15] !== E || t[16] !== p || t[17] !== u
    ? ((R =
        E == null && u && !p.isLoading && !p.allowed
          ? [
              {
                description: (0, Q.jsx)(V, {
                  ...Te.restrictedAvailabilityDescription,
                }),
                icon: (0, Q.jsx)(`img`, {
                  alt: ``,
                ...
                title: (0, Q.jsx)(V, { ...X.googleChrome }),
              },
            ]
          : []),
      (t[15] = E),
    ...
    : (R = t[18]);
  let ee = R;
  if (r.available && w != null) {
    let e, n;
    t[19] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(V, { ...X.anyApp })),
        (n = (0, Q.jsx)(V, {
    ...
    (t[21] === w
      ? (r = t[22])
      : ((r = { plugin: w, title: e, description: n }),
        (t[21] = w),
        (t[22] = r)),
      L.push(r));
  }
  if (E != null) {
    ...
    t[23] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(V, { ...X.googleChrome })), (t[23] = e))
      : (e = t[23]);
    let n;
    t[24] === I
      ? (n = t[25])
      : ((n = (0, Q.jsx)(Ft, { status: I })), (t[24] = I), (t[25] = n));
    let r;
    t[26] !== j || t[27] !== o
      ? ((r = j
          ? (0, Q.jsx)(G, {
      ...
      : (r = t[28]);
    let i;
    (t[29] !== E || t[30] !== r || t[31] !== n
      ? ((i = { plugin: E, title: e, description: n, action: r }),
        (t[29] = E),
        (t[30] = r),
        (t[31] = n),
        (t[32] = i))
        ...
        ...(t.plugin.installed && t.plugin.enabled
          ? {
              ...
              onToggleEnabled: (t) => {
                g({
                  appId: gn,
                  appName: a.formatMessage(e.title),
                  enabled: t,
                }).catch(Gt);
              },
              toggleAriaLabel: a.formatMessage(e.toggleAriaLabel),
              toggleTooltip: N
                ? (0, Q.jsx)(V, { ...e.disableTooltip })
                : (0, Q.jsx)(V, { ...e.enableTooltip }),
            }
          : { displayName: a.formatMessage(e.title), plugin: t }),
        icon: (0, Q.jsx)(`img`, {
          alt: ``,
          className: `h-full w-full object-contain`,
          src: e.icon,
        }),
        title: (0, Q.jsx)(V, { ...e.title }),
        description: (0, Q.jsx)(V, { ...e.description }),
      });
    }
  let z, B;
  return (
...
function qt(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = { browserExtensionId: l }), (t[4] = l), (t[5] = u));
  let f = Be(u),
    p = c || f.isLoading,
    m;
  return (
    t[6] !== s || t[7] !== f.isConnected || t[8] !== p
      ? ((m = {
          browserExtension: s,
...
function Jt() {
  ...
  e[1] !== a || e[2] !== i.installedPlugins
    ...
    : (o = e[3]);
  let s = o,
    l = s?.plugin.installed === !0,
    u = l && s.plugin.enabled,
    d;
  e[4] !== s || e[5] !== l || e[6] !== n
    ? ((d = { hostId: n, plugin: s, shouldReadBrowserExtension: l }),
      (e[4] = s),
      (e[5] = l),
      (e[6] = n),
      (e[7] = d))
  ...
  if (!i.isLoading && !u) {
    ...
    return (
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, Q.jsx)(A, { to: `/settings/computer-use`, replace: !0 })),
          (e[11] = t))
        : (t = e[11]),
      t
    );
  ...
  e[18] !== m || e[19] !== t
    ? ((S = () => {
        m != null &&
          Ye(`chrome-extension-settings-open`, {
            params: { extensionId: m },
          }).catch(() => {
            t.get(R).danger(
              (0, Q.jsx)(V, {
  ...
  let D;
  e[29] !== h || e[30] !== g
    ? ((D = g ? null : (0, Q.jsx)(Xt, { installed: h })),
      (e[29] = h),
      (e[30] = g),
      (e[31] = D))
    : (D = e[31]);
...
function Yt(e) {
  ...
  let f;
  t[6] !== l || t[7] !== d
    ? ((f = [l, d]), (t[6] = l), (t[7] = d), (t[8] = f))
    : (f = t[8]);
  let p = f,
    m;
  t[9] !== s || t[10] !== p
    ? ((m = p.find((e) => e.id === s) ?? p[0]),
      (t[9] = s),
      (t[10] = p),
      (t[11] = m))
    : (m = t[11]);
  ...
  t[21] === T
    ? (E = t[22])
    : ((E = (0, Q.jsx)(`span`, { className: `truncate`, children: T })),
      (t[21] = T),
      (t[22] = E));
  let D;
  t[23] !== w || t[24] !== E
  ...
  let A;
  return (
    t[35] !== k || t[36] !== b || t[37] !== x
      ? ((A = (0, Q.jsx)(U, { label: b, description: x, control: k })),
        (t[35] = k),
        (t[36] = b),
        (t[37] = x),
        (t[38] = A))
...
function Xt(e) {
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = De(`h-2 w-2 rounded-full`, a)), (t[2] = a), (t[3] = o));
  let s;
  t[4] === o
    ? (s = t[5])
...
function Qt() {
  ...
  e[6] === c.label
    ? (u = e[7])
    : ((u = (0, Q.jsx)(V, { ...c.label })), (e[6] = c.label), (e[7] = u));
  let d;
  e[8] !== l || e[9] !== u
    ? ((d = (0, Q.jsx)(C, {
    ...
    ? ((p = $.map((e) =>
        (0, Q.jsx)(
          he.Item,
          {
            ...
            RightIcon: o === e.value ? Je : void 0,
            children: (0, Q.jsx)(`span`, {
              className: `text-sm`,
              children: (0, Q.jsx)(V, { ...e.label }),
            }),
          },
          e.value,
        ),
...
function en() {
  ...
  e[9] === a
    ...
    : ((d = (e) => {
      ...
      (e[10] = d));
  let f;
  e[11] !== r.data.enabled || e[12] !== l || e[13] !== u || e[14] !== d
    ? ((f = (0, Q.jsx)(at, {
        ariaLabel: l,
...
function an(e) {
  ...
  t[16] !== y || t[17] !== g
    ? ((x = (0, Q.jsx)(ct, {
        children: (0, Q.jsx)(ie, { title: g, subtitle: y }),
      })),
      (t[16] = y),
      (t[17] = g),
      (t[18] = x))
  ...
  let k;
  t[29] !== w || t[30] !== O
    ? ((k = (0, Q.jsx)(ct, { children: (0, Q.jsxs)(E, { children: [w, O] }) })),
      (t[29] = w),
      (t[30] = O),
      (t[31] = k))
    : (k = t[31]);
  ...
  return (
    t[38] !== j || t[39] !== f
      ? ((M = (0, Q.jsxs)(Q.Fragment, { children: [f, j] })),
        (t[38] = j),
        (t[39] = f),
        (t[40] = M))
      : (M = t[40]),
...
function cn(e) {
  ...
  return (
    t[10] === o
      ? (c = t[11])
      : ((c = (0, Q.jsx)(Q.Fragment, { children: o })),
        (t[10] = o),
        (t[11] = c)),
    c
  );
...
//# sourceMappingURL=computer-use-settings-BzkBOuLk.js.map
