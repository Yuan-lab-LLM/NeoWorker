...
import { n as qe, t as Je } from "./toolbar-breadcrumb-COhCwKVT.js";
import {
  n as Ye,
  t as G,
...
import { n as q, t as at } from "./settings-row-disclosure-NtnSBbIg.js";
function ot(e, t) {
  return t?.label ?? De(e) ?? e;
}
var st = e(() => {
  Fe();
});
function J(e) {
  let t = (0, ct.c)(29),
    ...
    f;
  t[0] !== c.length || t[1] !== r
    ? ((f = c.length > 0 || Ue.some((e) => !!r?.[e]?.script)),
      (t[0] = c.length),
      (t[1] = r),
      (t[2] = f))
    : (f = t[2]);
  ...
  t[3] === m
    ? ((h = t[4]), (g = t[5]))
    : ((h = m
        ? (0, X.jsx)(D, { ...K.setupScript })
        : (0, X.jsx)(D, { ...K.cleanupScript })),
      (g = m
        ? (0, X.jsx)(D, {
        ...
        : (0, X.jsx)(D, { ...K.cleanupDescription })),
      (t[3] = m),
      (t[4] = h),
      (t[5] = g));
  let _;
  t[6] !== n || t[7] !== h || t[8] !== g
    ? ((_ = (0, X.jsx)(V.Header, { title: h, subtitle: g, actions: n })),
      (t[6] = n),
      (t[7] = h),
      (t[8] = g),
      (t[9] = _))
  ...
  t[10] !== p || t[11] !== a || t[12] !== o || t[13] !== m
    ? ((v = p
        ? (0, X.jsx)(Ze, {
            ...
            onSelect: s,
            ariaLabel: m
              ? a.formatMessage(K.setupPlatformSelector)
              : a.formatMessage(K.cleanupPlatformSelector),
          })
        : null),
      (t[10] = p),
      (t[11] = a),
  ...
  t[18] !== p || t[19] !== d || t[20] !== o
    ...
    : (b = t[21]);
  let x;
  t[22] !== v || t[23] !== y || t[24] !== b
    ? ((x = (0, X.jsxs)(V.Content, {
        className: `gap-2`,
        children: [v, y, b],
      })),
      (t[22] = v),
  ...
  return (
    t[26] !== _ || t[27] !== x
      ? ((S = (0, X.jsxs)(V, { className: `gap-2`, children: [_, x] })),
        (t[26] = _),
        (t[27] = x),
        (t[28] = S))
      : (S = t[28]),
                ...
                children: [
                  ...
                  i
                    ? (0, Z.jsx)(`div`, {
                        ...
                        children: (0, Z.jsx)(D, { ...Ye.parseError }),
                      })
                    : null,
                  a
                    ? (0, Z.jsx)(`div`, {
                        className: `mt-2 text-sm text-token-error-foreground`,
                        children: (0, Z.jsx)(D, { ...Ye.readError }),
                      })
                    : null,
                ],
              }),
    ...
    ? ((l = o
        ? (0, Z.jsxs)(Z.Fragment, {
            children: [
              ...
              (0, Z.jsx)(J, { lifecycle: r.cleanup, scriptType: `cleanup` }),
              (0, Z.jsxs)(V, {
                className: `gap-2`,
                children: [
                  (0, Z.jsx)(V.Header, {
                    ...
                    subtitle: (0, Z.jsx)(D, { ...K.actionsDescription }),
                  }),
                  (0, Z.jsx)(V.Content, {
                    children: (0, Z.jsx)(N, {
                      children:
                        s != null && s.length > 0
                          ? s.map(dt)
                          : (0, Z.jsx)(j, {
                              label: (0, Z.jsx)(D, { ...K.actionsEmpty }),
                              control: null,
                            }),
                    }),
                  }),
...
function ft(e) {
  ...
  t[10] !== n.name || t[11] !== a || t[12] !== r || t[13] !== c
    ...
    : (m = t[14]);
  let h;
  t[15] !== n.name || t[16] !== f || t[17] !== p || t[18] !== m
    ? ((h = (0, Z.jsx)(j, {
        icon: f,
        label: n.name,
        description: p,
...
function vt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(D, { ...gt.selectProject })), (t[0] = d))
    : (d = t[0]);
  let f;
...
function yt(e) {
  ...
  if (r) {
    ...
    return (
      t[5] === n
        ? (i = t[6])
        : ((i = (0, Q.jsx)(N, {
            children: (0, Q.jsx)(j, { control: n, label: r }),
          })),
          (t[5] = n),
          (t[6] = i)),
      i
  ...
  t[11] === d
    ...
    : ((p = d.formatMessage({
      ...
      (t[12] = p));
  let m;
  if (t[13] !== n || t[14] !== i || t[15] !== c || t[16] !== u || t[17] !== o) {
    let e;
    (t[19] !== n || t[20] !== i || t[21] !== c || t[22] !== u
      ? ((e = (e) => {
          let t = n.find((t) => t.path != null && f(t.path, e)) ?? null;
          return (0, Q.jsx)(
            bt,
            {
              hostId: i,
...
function bt(e) {
  ...
  let {
      ...
      error: f,
      refetch: p,
    } = ie(`local-environments`, c),
    m = l === void 0 ? [] : l,
    [h, g] = (0, Dt.useState)(!1),
    _ = `local-environment-inherited-${(0, Dt.useId)()}`,
    v = !u && !d && f == null,
    y = v ? Ct(m, i) : null,
    b = y?.projectEnvironments ?? [],
    S = y?.inheritedEnvironments ?? [],
    C = je(b),
    ee = r?.isCodexWorktree ? x : Me,
    te,
    ne,
    re,
    ae,
  ...
  t[8] !== i
    ? ((T = ot(i, r)),
      (re = r?.repositoryData?.ownerRepo?.owner ?? null),
      (ae = u || d),
      (ne = f != null),
      (te = s.formatMessage(
        {
  ...
  t[24] === T
    ? (O = t[25])
    : ((O = (0, Q.jsx)(`span`, { className: `block truncate`, children: T })),
      (t[24] = T),
      (t[25] = O));
  let k = O,
    A;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Q.jsx)(be, { className: `icon-xs` })), (t[26] = A))
    : (A = t[26]);
  let ge = (0, Q.jsx)(L, {
    ...
    ye =
      C == null
        ? (0, Q.jsx)(j, { control: ge, description: re, icon: he, label: k })
        : (0, Q.jsx)(Se, {
            actions: ge,
            ariaLabel: oe,
            description: re,
    ...
    P = ae
      ? (0, Q.jsx)(j, {
          control: null,
          icon: (0, Q.jsx)(ve, { className: `icon-xs` }),
          label: ce,
          size: `compact`,
        })
      : ne
                    ...
                    content: S.map((e) =>
                      (0, Q.jsx)(
                        St,
                        {
                          environment: e,
                          errorLabel: de,
                          sourceFolderName: W(wt(e.configPath)),
                          onSelectEnvironment: () => {
                            o(i, e.configPath);
                          },
                        },
    ...
    F;
  t[27] !== _e || t[28] !== ye || t[29] !== P
    ? ((F = (0, Q.jsxs)(_e, { children: [ye, P] })),
      (t[27] = _e),
      (t[28] = ye),
      (t[29] = P),
      (t[30] = F))
...
function St(e) {
  ...
  t[10] !== s || t[11] !== l || t[12] !== i
    ? ((p =
      ...
      (t[13] = p))
    : (p = t[13]);
  let m = u ? `text-token-error-foreground` : void 0,
    h = u ? r : c,
    g;
  t[14] !== m || t[15] !== h
    ? ((g = (0, Q.jsx)(`span`, { className: m, children: h })),
      (t[14] = m),
      (t[15] = h),
      (t[16] = g))
    : (g = t[16]);
...
function Ct(e, t) {
  let n = [],
    r = [];
  for (let i of e) f(wt(i.configPath), t) ? n.push(i) : r.push(i);
...
function kt(e) {
  let t = (0, Ft.c)(83),
    ...
    y = g?.hostId ?? n,
    {
      ...
      isLoading: C,
      refetch: ee,
    } = v(se, u.LOCAL_PROJECTS),
    {
      error: te,
      isFetching: w,
      isLoading: T,
      refetch: oe,
    } = v(se, u.REMOTE_PROJECTS),
    E = c(ne(We), y),
    ce = E.flatMap(Nt),
    le = y === `local` ? C : T,
    de = y === `local` ? x : w,
    pe = y === `local` ? b : te,
    [me, he] = (0, It.useState)(g?.workspaceRoot ?? s.get(`workspaceRoot`)),
    [O, k] = (0, It.useState)(g?.configPath ?? s.get(`configPath`)),
    [A, j] = (0, It.useState)(g != null || s.get(`mode`) === `edit`),
    [_e, ve] = (0, It.useState)(0),
    ye = me ?? null,
    M = ye != null && (g != null || ce.includes(ye) || O != null) ? ye : null,
    be = M == null ? null : (E.find((e) => e.path === M) ?? null),
    P = M == null,
    F = () => {
      if (y !== `local`) {
        fe({ hostId: y });
  ...
  let we = Se,
    R = () => {
      if (g != null) {
        (f(g.returnTo, { replace: !0 }),
          g.reopenStableWorktreeId != null &&
            ze(r, {
              id: g.reopenStableWorktreeId,
  ...
  let Oe = De,
    {
      ...
      error: Ne,
      refetch: Fe,
    } = ie(`local-environments`, {
      params: { hostId: y, workspaceRoot: M ?? `` },
      queryConfig: { enabled: M != null },
      select: Mt,
    }),
    Ie = B != null && !Ae && !Me && Ne == null,
    Le;
  t[9] !== Ie || t[10] !== B
    ? ((Le = Ie ? je(B) : null), (t[9] = Ie), (t[10] = B), (t[11] = Le))
    : (Le = t[11]);
  let Re = Le,
    Be = g != null && g.configPath == null && Ie && M != null ? xe(B, M) : null,
    Ve = g?.configPath ?? Be ?? (g == null ? Re : null);
  A && O == null && Ve != null && k(Ve);
  let He = O ?? Ve,
    Ue = M != null && He != null,
    {
      data: H,
      ...
      error: Ke,
      refetch: U,
    } = ie(`local-environment-config`, {
      params: { configPath: He ?? ``, hostId: y },
      queryConfig: { enabled: Ue },
    }),
    W = H?.environment?.type === `success` ? H.environment.environment : null,
    qe = H?.environment?.type === `error`,
    G = Ke != null,
    Xe = Ne != null || Ke != null,
    Ze = () => {
      if (He == null) {
  ...
  t[12] !== U || t[13] !== Fe
    ? ((Qe = async () => {
        Fe();
        let e = await U();
        e.data != null && e.error == null && ve(jt);
      }),
      (t[12] = U),
      (t[13] = Fe),
      (t[14] = Qe))
  ...
  let $e = Qe,
    et;
  t[15] !== U || t[16] !== j || t[17] !== k
    ? ((et = async () => {
        let e = await U();
        e.isSuccess && (k(e.data.configPath), j(!0));
      }),
      (t[15] = U),
      (t[16] = j),
      (t[17] = k),
    ...
    return (
            ...
            values: {
              learnMore: (0, $.jsx)(
                `a`,
                {
                  ...
                  rel: `noreferrer`,
                  onClick: At,
                  children: (0, $.jsx)(D, { ...gt.workspaceSelectLearnMore }),
                },
                `learn-more`,
              ),
            },
      ...
      (0, $.jsx)(Pt, {
        ...
        children: (0, $.jsx)(vt, {
          ...
          hasError: pe != null,
          hostId: y,
          isLoading: le || (pe != null && de),
          workspaceRoots: ce,
          onAddWorkspace: F,
          onCreateEnvironment: Oe,
          onRetry: I,
          onSelectEnvironment: Te,
        }),
      })
    );
  }
  let rt = ot(M, be),
    K;
  t[21] !== g || t[22] !== we || t[23] !== R || t[24] !== A || t[25] !== rt
    ? ((K =
        g == null
          ? (0, $.jsx)(Je, {
              ancestors: [
                ...
                ...(A ? [{ id: `workspace`, label: rt, onClick: R }] : []),
              ],
              current: A
                ? (0, $.jsx)(D, {
  ...
  if (nt) {
    ...
    return (
      t[28] === q
        ? (n = t[29])
        : ((n = (0, $.jsx)(Pt, { backSlot: q, children: e })),
          (t[28] = q),
          (t[29] = n)),
      n
    );
  ...
  if (!H || M == null) {
    ...
    return (
      t[37] !== q || t[38] !== i
        ? ((a = (0, $.jsx)(Pt, { backSlot: q, children: i })),
          (t[37] = q),
          (t[38] = i),
          (t[39] = a))
        : (a = t[39]),
  ...
  if (A) {
    ...
    return (
      t[60] !== q || t[61] !== r
        ? ((i = (0, $.jsx)(Pt, { backSlot: q, title: e, children: r })),
          (t[60] = q),
          (t[61] = r),
          (t[62] = i))
        : (i = t[62]),
  ...
  t[63] !== H.exists || t[64] !== o
    ? ((J = H.exists
      ...
      (t[65] = J))
    : (J = t[65]);
  let ct = H.exists ? `secondary` : `primary`,
    Y;
  t[66] === H.exists
    ? (Y = t[67])
    : ((Y = H.exists
        ? (0, $.jsxs)($.Fragment, {
            children: [
              ...
              (0, $.jsx)(D, { ...gt.editEnvironment }),
            ],
          })
        : (0, $.jsx)(D, { ...gt.createEnvironment })),
      (t[66] = H.exists),
      (t[67] = Y));
  let X;
  t[68] !== st || t[69] !== ct || t[70] !== Y || t[71] !== J
    ? ((X = (0, $.jsx)(L, {
        "aria-label": J,
        color: ct,
        size: `toolbar`,
  ...
  let lt = W?.name,
    dt;
  t[73] !== H.exists || t[74] !== qe || t[75] !== G || t[76] !== W
    ? ((dt = (0, $.jsx)(ut, {
...
function At(e) {
  me({ event: e, href: m, initiator: `open_in_browser_bridge` });
}
function jt(e) {
  return e + 1;
}
...
function Nt(e) {
  return e.projectKind === `local` ? s(e) : [e.path];
}
function Pt({
  action: e,
  backSlot: t,
  subtitle: n,
  title: r = (0, $.jsx)(pe, { slug: `local-environments` }),
  children: i,
}) {
  return (0, $.jsx)(R, {
    action: e,
...
function Rt() {
  ...
  return (
    e[0] !== n || e[1] !== r
      ? ((i = (0, Bt.jsx)(kt, { settingsHostId: n }, r)),
        (e[0] = n),
        (e[1] = r),
        (e[2] = i))
      : (i = e[2]),
...
//# sourceMappingURL=local-environments-settings-page-BN0xsa52.js.map
