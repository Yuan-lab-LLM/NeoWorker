...
import { n as m, t as h } from "./codex-avatar-rFd6-NsG.js";
function g(e) {
  let t = (0, ne.c)(25),
    {
      ariaLabel: n,
    ...
    [te, b] = (0, v.useState)(!1),
    x = p ?? (te ? `jumping` : g),
    re = x === `idle` || x === `running` || x === `waving`,
    S = o != null,
    ie = S || l != null,
    C;
  n != null && (C = ie ? `group` : `img`);
  let w;
  t[0] === i
    ? (w = t[1])
    : ((w = c(
  ...
  let O = re ? a : null,
    k;
  t[4] !== r || t[5] !== x || t[6] !== m || t[7] !== d || t[8] !== O
    ? ((k = (0, y.jsx)(h, {
        assetRef: r,
        className: `relative z-10`,
        lookFrame: O,
        spriteVersionNumber: m,
        spritesheetUrl: d,
        state: x,
      })),
      (t[4] = r),
  ...
  let A;
  t[10] !== S || t[11] !== o
    ? ((A = S ? (0, y.jsx)(_, { notificationBadge: o }) : null),
      (t[10] = S),
      (t[11] = o),
      (t[12] = A))
    : (A = t[12]);
...
function _(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (e) => {
        ...
        (!t.hasMoved && Math.abs(n) < b && Math.abs(r) < b) ||
          (e.preventDefault(), (t.hasMoved = !0), m({ x: n, y: r }));
      }),
      (t[1] = C))
    : (C = t[1]);
  let w = C,
  ...
  t[2] === f
    ...
    : ((T = (e) => {
        ...
        if (
          ...
          (t != null &&
            f(te({ avatarBounds: t, clientX: e.clientX, clientY: e.clientY })),
            m(null),
            e.preventDefault(),
            (g.current = !0),
            window.setTimeout(() => {
  ...
  t[6] === i
    ? (j = t[7])
    : ((j = (e) => {
        if ((e.stopPropagation(), g.current)) {
          ((g.current = !1), e.preventDefault());
          return;
        }
        i.onClick();
      }),
  ...
  let M = j,
    N = a == null ? x[u] : null,
    P = p == null ? void 0 : `${p.x}px ${p.y}px`,
    ae = i.isGlassy && !i.nativeMaterialAttached,
    oe = ae && i.isIconOnly,
    F = a == null,
    I;
  t[8] !== i.content ||
  ...
  t[20] !== V
    ? ((H = c(
      ...
      (t[21] = H))
    : (H = t[21]);
  let U = a == null ? void 0 : `mascot-badge`,
    W = _ ? 1 : 0.7,
    le = _ ? 0 : 3,
    G;
  t[22] !== W || t[23] !== le
    ? ((G = { opacity: 0, scale: W, y: le }),
      (t[22] = W),
      (t[23] = le),
      (t[24] = G))
    : (G = t[24]);
  ...
  t[25] !== o || t[26] !== _
    ? ((K = o
      ...
      (t[27] = K))
    : (K = t[27]);
  let ue = a == null ? void 0 : `position`,
    de = F ? A : void 0,
    fe = F ? O : void 0,
    pe = F ? ie : void 0,
    me = F ? w : void 0,
    q = F ? E : void 0,
    he = oe ? void 0 : i.backgroundColor,
    ge = oe ? void 0 : i.foregroundColor,
    J;
  t[28] !== a || t[29] !== he || t[30] !== ge || t[31] !== P
    ? ((J = { ...a, backgroundColor: he, color: ge, translate: P }),
      (t[28] = a),
      (t[29] = he),
      (t[30] = ge),
      (t[31] = P),
  ...
  t[36] === _
    ? (Z = t[37])
    : ((Z = _ ? void 0 : { scale: 0.94 }), (t[36] = _), (t[37] = Z));
  let Q;
  t[38] !== M ||
  t[39] !== i.ariaLabel ||
  t[40] !== i.content ||
  ...
  t[54] !== Z
    ? ((Q = (0, y.jsx)(l.button, {
        ...
        "data-avatar-overlay-hit-region": U,
        initial: G,
        exit: K,
        onClick: M,
        layout: ue,
  ...
  return (
    t[56] !== Q || t[57] !== I
      ? (($ = (0, y.jsxs)(y.Fragment, { children: [I, Q] })),
        (t[56] = Q),
        (t[57] = I),
        (t[58] = $))
      : ($ = t[58]),
...
function te({ avatarBounds: e, clientX: t, clientY: n }) {
...
var ne,
  ...
  S = e(() => {
    ((ne = i()),
      ...
      (re = f(`avatar-mascot-notification-badge-corner`, `top-end`)));
  });
export { _ as n, S as r, g as t };
//# sourceMappingURL=avatar-mascot-button-lIOXDH5S.js.map
