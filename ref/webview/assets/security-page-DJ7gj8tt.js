...
function C() {
  let e = (0, E.c)(9),
    ...
    o = r && !i,
    s;
  e[0] === o ? (s = e[1]) : ((s = { enabled: o }), (e[0] = o), (e[1] = s));
  let { installedPlugins: c, isLoading: l } = n(x, void 0, s),
    u;
  e[2] !== c || e[3] !== l || e[4] !== i || e[5] !== r
    ? ((u = p({
        installedPlugins: c,
        isGateEnabled: r,
        isLoading: l,
  ...
  return (
    e[7] === u
      ? (d = e[8])
      : ((d = (0, D.jsx)(w, { state: u })), (e[7] = u), (e[8] = d)),
    d
  );
}
function w(e) {
  ...
  t[5] === n
    ? (s = t[6])
    : ((s = n === `loading` ? (0, D.jsx)(u, {}) : (0, D.jsx)(f, {})),
      (t[5] = n),
      (t[6] = s));
  let l;
  return (
...
var E, D;
e(() => {
  ((E = o()), s(), d(), y(), i(), h(), b(), S(), l(), _(), v(), (D = r()));
})();
export { C as SecurityPage };
//# sourceMappingURL=security-page-DJ7gj8tt.js.map
