...
import {
  ...
  yt as Pe,
  z as Fe,
} from "./workbook-Bcziiv_P.js";
import { C as Ie, o as Le, w as Re } from "./document-B3tlET84.js";
import {
  A as ze,
  C as Be,
  D as Ve,
  ...
  x as ft,
  y as pt,
} from "./remote-text-edit-session-DoJKJPVz.js";
import {
  a as mt,
  i as ht,
  r as gt,
  t as _t,
} from "./feature-catalog-BRPzcYeX.js";
import { n as vt, t as yt } from "./PopcornPageNumberNavigation-ub7O3ho1.js";
var bt,
  xt,
  St = e(() => {
    (_(),
...
function Tt() {
  let e = new O({ stub: () => {} }, void 0);
  return (
    (e.colorScheme = { name: `Office`, themeColors: { ...kt } }),
    e.toProto()
  );
}
function Et() {
...
function Nt() {
  ...
  return {
    ...
    sections: [
      {
        id: `doc-section-1`,
        breakType: Ie.SECTION_BREAK_TYPE_UNSPECIFIED,
  ...
  Jt = e(() => {
    (D(),
      ...
      (Kt = class {
        #e;
        constructor(e, t) {
          ((this.#e = structuredClone(e)), t?.addParagraphs(e.paragraphs));
        }
        get id() {
          return this.#e.id ?? ``;
        }
      ...
      (qt = class {
        ...
        constructor(e) {
          ((this.#t = e.documentId ?? ``),
            ...
            (this.#i = e.onMutated));
          let t = e.endnotes ?? [];
          this.#e = t.map((t) => new Kt(t, e.fontFamilyCache));
        }
        get items() {
          return [...this.#e];
        }
        ...
        replace(e) {
          ((this.#e = e.map((e) => new Kt(e))), this.#i?.());
        }
        toProto() {
          return this.#e.map((e) => e.toProto());
        }
        #a(e) {
          return be(e) ? E(e) : E([String(e)]);
        }
        #o(e) {
          let t = this.#r(e);
          if (t)
  ...
  $t = e(() => {
    (D(),
      ...
      (Zt = class {
        #e;
        constructor(e, t) {
          ((this.#e = e), t?.addParagraphs(e.paragraphs));
        }
        get id() {
          return this.#e.id ?? ``;
        }
      ...
      (Qt = class {
        ...
        constructor(e) {
          ((this.#t = e.documentId ?? ``),
            ...
            (this.#i = e.onMutated));
          let t = e.footnotes ?? [];
          this.#e = t.map((t) => new Zt(t, e.fontFamilyCache));
        }
        add(e, t) {
          let n = this.#a(e),
            r = this.#o(t.range),
  ...
  for (let t of e)
    for (let e = 0; e < t.cells.length; e += 1) {
      ...
      for (; i < t.cells.length;) {
        ...
        ((r += en(e.gridSpan)), (e.horizontalMerge = !0), (i += 1));
      }
...
function on(e) {
  ...
  for (let e of n)
    r.has(e.cell) ||
      (r.add(e.cell),
      e.rowSpan > 1 &&
        (e.cell.rowSpan = Math.max(en(e.cell.rowSpan), e.rowSpan)));
}
function sn(e) {
  let t = e.table;
  if (!t || t.rows.length === 0 || !tn(t.rows)) return e;
  let n = nn(t.rows);
  return (rn(n), on(n), { ...e, table: { ...t, rows: n } });
}
var cn = e(() => {});
function ln(e) {
  return ge(e, fn);
...
function un(e) {
  return ln(new O({ stub: () => {} }, e));
}
function dn(e, t, n, r = pn) {
...
var fn,
  ...
  mn = e(() => {
    (xe(),
      ...
      (pn = ge(new O({ stub: () => {} }, void 0), fn)));
  }),
  hn,
  gn,
  _n = e(() => {
    ((hn = `__docxField:PAGE__`), (gn = `__docxField:NUMPAGES__`));
  });
function vn(e) {
...
function Sn(e, t = { widthPx: kn, heightPx: An }) {
  if (!e.bbox) return t;
  let n = vn(e.bbox.widthEmu),
    r = vn(e.bbox.heightEmu);
...
function Cn(e, t) {
  return yn(e.bbox?.xEmu) ?? t;
}
function wn(e, t) {
  return yn(e.bbox?.yEmu) ?? t;
}
function Tn(e, t) {
  let n = xn(e, Mn, Nn),
    r = yn(e.placement?.yOffsetEmu) ?? yn(e.bbox?.yEmu) ?? 0;
...
function En(e, t) {
  ...
  if (!n) return;
  let r = t.get(n);
  if (r !== void 0) return r + (yn(e.bbox?.yEmu) ?? 0);
}
function Dn(e) {
  return xn(e, jn, Pn) !== void 0;
}
function On(e) {
  return Sn(e);
}
var kn,
  ...
  Fn = e(() => {
    (ae(),
      ...
      (jn = 1),
      (Mn = 2),
      (Nn = `__docxAnchorParagraphId:`),
      (Pn = `__docxInlineParagraphId:`));
  });
function q(e) {
  return W(e);
}
...
function Rn(e) {
  ...
  let n = 0;
  for (let e of t.rows)
    e.heightEmu && e.heightEmu > 0 ? (n += e.heightEmu * G) : (n += Gn);
  return Math.max(n, t.rows.length * Gn);
}
function zn(e, t) {
  let n =
...
function Vn(e, t, n, r = pn, i) {
  return Wn(e, t, n, r, i).heightPx;
}
...
function Un(e) {
  let t = e.table;
  return t
    ? t.rows.map((e) => (e.heightEmu && e.heightEmu > 0 ? e.heightEmu * G : Gn))
    : [];
}
function Wn(e, t, n, r = pn, i) {
  let a = e.table;
  if (!a || a.rows.length === 0)
...
function Xn(e, t) {
  return (
    ...
    Yn(e.leftPx, e.rightPx, t.leftPx, t.rightPx) &&
    Yn(e.topPx, e.bottomPx, t.topPx, t.bottomPx)
  );
}
function Zn(e, t) {
  ...
  for (;;) {
    ...
    if (!n) {
      let n = e
          .filter(
            (e) =>
              Zn(e, o) && Yn(t, s, e.leftPx, e.rightPx) && e.topPx > c + 0.01,
          )
...
function hr(e) {
  return e.placement?.type === Da && e.placement.wrap?.type === Oa;
}
function gr(e) {
  return e.placement?.type === Da && e.placement.wrap?.type === ka;
}
function _r(e) {
  if (!vr(e)) return !1;
...
function vr(e) {
  return e.placement?.type === Ca && !Dn(e);
}
function yr(e, t, n, r, i = 0) {
  if (pr(e.kind)) {
    let a = En(e.element, n);
    if (a !== void 0) return a;
    if (vr(e.element)) return t + j(e.element).topPx;
    if (Dn(e.element) && r !== void 0)
      return r + (e.element.bbox?.yEmu ?? 0) * G;
    let o = Tn(e.element, n);
    if (o !== void 0) return xr(e.element) ? i + o : o;
    let s = wn(e.element, t);
    return br(e.element) ? i + s : s;
  }
  return t;
}
function br(e) {
...
function Cr(e, t, n, r) {
  return pr(e.kind) && (mr(e.element) || gr(e.element) || hr(e.element))
    ? t
    : Math.max(t, n + r + wr(e.element));
}
function wr(e) {
  return vr(e) ? j(e).bottomPx : 0;
}
function Tr(e, t) {
  ...
  if (n)
    for (let e of n.rows)
      for (let n of e.cells) {
        ...
        for (let e of n.elements ?? []) Dr(e, t);
      }
}
function Or(e, t, n) {
  let r = e,
...
function jr(e, t, n) {
  ...
  if (r.numberFormat === `bullet`) {
    let e = kr(r.levelText);
    return e
      ? { startAt: n, paragraphStyle: { bulletCharacter: e, tabStops: [] } }
      : void 0;
  }
  let i = Ar(r.numberFormat, r.levelText);
  if (i)
    return {
      startAt: n,
...
function Nr(e) {
  ...
  for (let c of Er(e))
    Dr(c, (e) => {
      ...
      s.add(e.id);
      let c = t.get(e.id) ?? Or(e.styleId, n, r);
      if (!c?.numId) return;
      let l = Math.max(0, c.level ?? 0),
        u = i.get(c.numId),
        d = a.get(c.numId) ?? [];
      for (let e = l + 1; e < d.length; e += 1) d[e] = void 0;
      d[l] === void 0 && (d[l] = Mr(e.paragraphStyle, u, l));
      let f = d[l] ?? 1;
      (o.set(e.id, { startAt: f, paragraphStyle: jr(u, l, f)?.paragraphStyle }),
        (d[l] = f + 1),
        a.set(c.numId, d));
    });
  return o;
  ...
  return {
    paragraphs: e.map((e) => {
      ...
      if (!s) {
        ...
        let t = Pr(e.paragraphStyle, void 0, void 0),
          n = me(a?.paragraphStyle, t);
        return (
          n && o !== void 0 && n.autoNumberType && (n.autoNumberStartAt = o),
          n === e.paragraphStyle ? e : ((i = !0), { ...e, paragraphStyle: n })
        );
      }
      let c = Lr(e.textStyle, s.textStyle, r.preserveDirectTextStyle === !0),
        l = s.contextualSpacing ? R(c) : c,
        u = Pr(e.paragraphStyle, s.paragraphStyle, void 0),
        d = me(a?.paragraphStyle, u);
      d && o !== void 0 && d.autoNumberType && (d.autoNumberStartAt = o);
      let f = Rr(e.runs, r.preserveDirectTextStyle === !0 ? c : s.textStyle),
...
function Lr(e, t, n = !1) {
  if (!n) {
    ...
    return (
      ...
      Object.keys(n).length === 0 ? t : H(n, t)
    );
  }
  return H(e, t);
}
    ...
    a = r.rows.map((e) => {
      let r = !1,
        a = e.cells.map((e) => {
          ...
          let a = Ir(i, t, n, { preserveDirectTextStyle: !0 });
...
function Br(e, t, n) {
  return zr(e.paragraphs && e.paragraphs.length > 0 ? Fr(e, t, n) : e, t, n);
}
function Vr(e, t, n) {
  return e.map((e) => Br(e, t, n));
}
function Hr(e, t, n, r) {
  return e.map((e) => {
    let i = Br(e, t, n),
    ...
    return {
      ...
      firstParagraphUsesContextualSpacing: ve(s?.textStyle),
    };
  });
}
function Ur(e, t) {
...
function Wr(e, t, n, r) {
  ...
  for (let o of e.footnotes ?? []) {
    ...
    let e = Hr([Ur(`docx-footnote-${o.id}`, o.paragraphs ?? [])], t, n, r)[0];
    if (e) {
...
function qr(e, t, n, r) {
  let i = [],
    a = new Set();
  for (let o = t; o < n; o += 1)
    for (let t of Kr(e[o], r)) a.has(t) || (a.add(t), i.push(t));
  return i;
}
function Jr(e, t) {
...
function Xr(e, t, n, r) {
  ...
  let s = Ur(`docx-footnotes-${t.join(`-`)}`, o),
    c = Zi(s, n, r),
...
function Zr(e, t, n, r) {
  return e.ids.length === 0
    ? 0
    : Xr(t, e.ids, n.contentWidthPx, r).reservedHeightPx;
}
function Qr(e, t, n, r) {
  return n.contentBottomPx - Zr(e, t, n, r);
}
function $r(e, t, n = pn, r) {
  let i = Yr(t, r),
    a = e.linesByWidth.get(i);
  if (a) return a;
  let o =
    e.kind === `text` ? Zi(e.element, t, n, e.defaultTabStopTwips, r) : [];
  return (e.linesByWidth.set(i, o), o);
}
function ei(e, t, n, r = pn, i) {
  let a = Yr(n, i),
    o = e.measurementsByWidth.get(a);
  if (o) return o;
  let s = Vi(e.element, e.kind, t, n, r, i);
  return (e.measurementsByWidth.set(a, s), s);
}
function ti(e, t, n, r = pn, i) {
  let a = zn(e.element, n),
    o = Yr(a, i),
    s = e.tableMeasurementsByWidth.get(o);
  if (s) return s;
  let c = Wn(e.element, t, a, r, i);
...
function ni(e, t, n) {
  ...
  if (e.kind === `table`) {
    let n = ai(e.element, t);
    if (n !== void 0) return n;
    let a = ri(e.element, r, i);
  ...
  if (fr(e.kind)) {
    ...
    if (n !== void 0) return n;
    let a = ri(e.element, r, i);
    return a === void 0 ? Cn(e.element, r) : a;
  }
  return r;
}
function ri(e, t, n) {
...
function ii(e, t, n) {
  let r = hr(t.element) && !mr(t.element);
  if (!r && !gr(t.element)) return;
  let { leftPx: i, rightPx: a, topPx: o, bottomPx: s } = j(t.element);
  Qn(e, {
    leftPx: n.xPx - i,
...
function ui({
  ...
  if (o.idsByReferenceRunId.size === 0) return li(e, t, Math.max(0, r - n));
  let l = t,
    u = 0,
    d = !1,
    f = [...a],
  ...
  for (; l < e.length;) {
    let t = e[l],
      a = [...f],
      m = new Set(p);
    for (let e of Kr(t, o)) m.has(e) || (a.push(e), m.add(e));
    let h = a.length > 0 ? Xr(o, a, s, c).reservedHeightPx : 0,
      g = Math.min(r, i - h),
      _ = Math.max(0, g - n),
...
function mi(e, t, n) {
  ...
  for (let n = t + i; n <= e.length; n += 1) if (pi(e, t, n)) return n - t;
  return i;
}
function hi(e) {
  let t = e.table;
  ...
  let n = t.rows[0];
  return n ? +!n.cells.some((e) => di(e.rowSpan) > 1) : 0;
}
function gi(e, t, n, r) {
  let i = e.table;
  if (!i) return e;
...
function _i({
  ...
  for (let e = t; e < c.rows.length; e += 1) {
    ...
    let r = e - t + 1;
    if (g > n + Sa) break;
    r >= h && pi(l, t, e + 1) && ((_ = r), (v = g));
  }
  if (_ === 0) {
    if (!r) return { rowCount: 0, widthPx: u.widthPx, heightPx: 0 };
    ((_ = mi(l, t, h)), (v = p + fi(u.rowHeightsPx, t, t + _)));
  }
  let y = gi(e.element, t, _, f),
    b = Vi(y, `table`, i, a, o);
  return {
    element: y,
    rowCount: _,
...
function yi(e, t) {
  return vi(e) ? t.length > 0 && t.every((e) => !ci(e)) : !1;
}
function bi(e) {
  let t = e.paragraphs ?? [];
  return t.length === 1 && t[0]?.docxSectionBreakCarrier === !0 && vi(e);
}
function xi(e) {
  return e
    ? e.segments.length === 0 &&
...
function Si({
  ...
  return e !== 0 || i <= 0 || !xi(t[0]) ? !1 : n && r;
}
function Ci(e, t) {
  let n = e[t];
  return n
    ? pr(n.kind)
      ? !(mr(n.element) || hr(n.element) || (gr(n.element) && !Dn(n.element)))
      : !0
    : !1;
}
function wi(e, t, n, r, i, a = pn, o) {
  let s = 0;
  for (let c = n + 1; c < t.length; c += 1) {
    let n = t[c];
    if (!n || !Ci(t, c)) continue;
    if (n.kind !== `text`) return s + ei(n, r, i, a, o).heightPx;
    let l = $r(n, i, a, o),
      u = yi(n.element, l),
      d = ur({
    ...
    let f =
      Si({
        ...
        previousEmptyParagraphHasSpacing: oi(e),
  ...
  for (let i = 0; i < e.length; i += 1) {
    ...
    if (C.kind !== `text`) {
      ...
      for (; !e;) {
        let w = t.columns.widths[l] ?? t.contentWidthPx,
          ...
          E = T === n,
          D = T + (d[l] ?? 0),
          O = ei(C, o, w, s, t.documentGridLinePitchTwips),
          k = yr(C, D, h, g[l]),
          A = Cr(C, D, k, O.heightPx);
        if (A > r) {
    ...
    for (; !T;) {
      let e = t.columns.widths[l] ?? t.contentWidthPx,
        o = u[l] ?? n,
        E = $r(C, e, s, t.documentGridLinePitchTwips);
      if (E.length === 0 || w >= E.length) {
        (dr(C.element, o, h), (g[l] = o), (T = !0));
        break;
      }
      let D = f[l] ?? !1,
        O = p[l] ?? !1,
      ...
      if (w >= E.length) {
        let e = (C.element.paragraphs?.length ?? 0) > 1 ? xa : 0;
        ((u[l] = (u[l] ?? n) + e),
...
function Oi(e) {
  return (e ?? ``).includes(wa);
}
function ki(e, t, n) {
  return n % 2 != 0 || !Oi(e) ? 0 : t.margins.rightPx - t.margins.leftPx;
}
function Ai(e, t = 0) {
  return {
    key: e.key,
...
function Mi(e, t) {
  return e?.columnFrame ? { ...e, columnFrame: ji(e.columnFrame, t) } : e;
}
function Ni(e, t) {
  return {
    ...e,
    xPx: e.xPx + t,
    flow: Mi(e.flow, t),
    children: e.children?.map((e) => Ni(e, t)),
  };
}
function Pi(e, t, n, r = {}) {
  let i = ki(e.sectionId, t, n),
    a =
      Math.abs(i) < 0.01
        ? e
        : {
            ...e,
            layout: Ai(t, i),
            headerElements: e.headerElements.map((e) => Ni(e, i)),
            bodyElements: e.bodyElements.map((e) => Ni(e, i)),
            footerElements: e.footerElements.map((e) => Ni(e, i)),
            pageNumberElement: e.pageNumberElement
              ? Ni(e.pageNumberElement, i)
              : void 0,
          };
  return r.layoutMode === `pageless` ? Fi(a, t, r) : a;
}
function Fi(e, t, n) {
  let r = Ii(e.bodyElements),
...
function Vi(e, t, n, r, i, a) {
  if (t === `table`) {
    let t = zn(e, r);
    return { widthPx: t, heightPx: Vn(e, n, t, i, a) };
  }
  if (t === `image`) {
    let t = On(e);
  ...
  return t === `shape` || t === `chart` || t === `group`
    ? Sn(e, { widthPx: Math.max(1, Math.min(r, 180)), heightPx: 120 })
    : { widthPx: r, heightPx: dn(e, n, r, i) };
}
function Hi(e, t) {
...
function Ui(e, t, n, r, i, a) {
  return (e.children ?? []).map((e) => {
    ...
    return (
      o === `group` && (c.children = Ui(e, c.xPx, c.yPx, c.widthPx, i, a)),
      c
    );
  });
}
  ...
  for (let n of e.table?.rows ?? [])
    for (let e of n.cells ?? [])
      for (let n of e.elements ?? [])
        Wi(n) || (n.id && n.id.length > 0 && t.set(n.id, n));
  return t;
}
function Ki(e, t) {
  ...
  return {
    ...
    bbox: {
      ...
      xEmu: In(t.xPx),
      yEmu: In(t.yPx),
      widthEmu: n ? 0 : In(t.widthPx),
      heightEmu: r ? 0 : In(t.heightPx),
    },
  };
}
function qi(e, t, n, r, i, a, o, s) {
  ...
  let c = y(
      sn({
        ...Ki(e, { xPx: t, yPx: n, widthPx: r, heightPx: i }),
        type: m.ELEMENT_TYPE_TABLE,
      }),
      a,
      o,
  ...
  for (let e of c.cellElementFrames ?? []) {
    ...
    if (!t) continue;
    let n = tr(t);
    u.push(Ji(t, n, e.xPx, e.yPx, e.widthPx, e.heightPx, a, o, void 0, s));
  }
  return u;
}
function Ji(e, t, n, r, i, a, o, s, c, l) {
  let u = {
    kind: t,
    element: e,
    xPx: n,
  ...
  return (
    t === `group` && (u.children = Ui(e, n, r, i, o, s)),
    t === `table` && (u.children = qi(e, n, r, i, a, o, s, l)),
    u
  );
}
function Yi(e, t, n, r, i, a) {
  if (
    ...
    return;
  let o = Xr(n, t.ids, r.contentWidthPx, a);
  o.textHeightPx <= 0 ||
    e.bodyElements.push(
      Ji(
        o.element,
...
function Xi(e, t, n, r, i, a, o, s, c) {
  let l = !1;
  for (let e of qr(r, i, a, n))
    t.idSet.has(e) || (t.idSet.add(e), t.ids.push(e), (l = !0));
  l && Yi(e, t, n, o, s, c);
}
function Zi(e, t, n = pn, r, i) {
  return (
    ee(e, n, {
...
function Qi(e, t, n, r, i) {
  ...
  for (let [t, l] of e.entries()) {
    let u = tr(l),
      d = Vi(l, u, r, n.contentWidthPx, i),
      f =
        u === `table`
          ? (ai(l, n) ?? Bn(l, n.contentLeftPx))
          : fr(u)
            ? (ai(l, n) ?? Cn(l, n.contentLeftPx))
            : n.contentLeftPx,
      p = u === `text` ? o : yr({ element: l, kind: u }, o, s, c);
    if ((a.push(Ji(l, u, f, p, d.widthPx, d.heightPx, r, i)), u === `text`)) {
      (dr(l, p, s), (c = p), (o += d.heightPx), t < e.length - 1 && (o += xa));
      continue;
    }
    let m = Cr({ element: l, kind: u }, o, p, d.heightPx);
    m > o && ((o = m), t < e.length - 1 && (o += xa));
  }
  return { elements: a, totalHeightPx: Math.max(0, o - t) };
}
function $i(e, t, n = {}) {
  let r = e.pageSetup?.widthEmu || t.widthEmu || va,
    i = e.pageSetup?.heightEmu || t.heightEmu || ya,
    a = Math.max(1, q(r)),
    o = Math.max(1, q(i)),
    s = n.layoutMode === `pageless` ? Math.max(o, ba) : o,
    c = Di(e),
    l = c.leftPx,
...
function ea(e) {
  return (
    ...
    e.breakType === Ie.SECTION_BREAK_TYPE_NEXT_PAGE ||
    e.breakType === Ie.SECTION_BREAK_TYPE_EVEN_PAGE ||
    e.breakType === Ie.SECTION_BREAK_TYPE_ODD_PAGE
  );
}
function ta(e) {
...
function na(e) {
  return !ea(e) || ta(e) ? !1 : (e.elements?.length ?? 0) > 0;
}
function ra(e, t) {
  let n = [],
    r = !1;
  for (let i of e) {
    ...
    (n.push(s ? { ...i, breakType: Ie.SECTION_BREAK_TYPE_UNSPECIFIED } : i),
      (r = !1));
  }
  return n;
}
...
function pa(e, t) {
  let n = (e) =>
    e
      .replaceAll(hn, t.currentPageText ?? ``)
      .replaceAll(gn, t.totalPagesText ?? ``);
  return e.map((e) => ma(e, n));
}
function ma(e, t) {
  return {
    ...e,
    ...
    children: (e.children ?? []).map((e) => ma(e, t)),
    table: e.table
      ? {
          ...e.table,
          rows: e.table.rows.map((e) => ({
            ...
            cells: e.cells.map((e) => ({
              ...
              elements: (e.elements ?? []).map((e) => ma(e, t)),
            })),
          })),
        }
      : e.table,
...
function ga(e, t, n, r, i, a, o, s) {
  let c = da(n, `__docxField:PAGE__`) || da(r, `__docxField:PAGE__`),
    l = c ? ca(a.nextValue ?? 1, a.formatType) : void 0;
  c && (a.nextValue = (a.nextValue ?? 1) + 1);
  let u = pa(n, { currentPageText: l }),
    d = pa(r, { currentPageText: l }),
    f = Qi(u, Math.max(0, t.margins.headerPx), t, o, s),
    p = Qi(d, 0, t, o, s),
    m = Qi(
      d,
      Math.max(
  ...
  return (
    i &&
      !c &&
      a.nextValue !== void 0 &&
      ((h = ha(ca(a.nextValue, a.formatType), t)), (a.nextValue += 1)),
    {
      sectionId: e,
...
function _a(e, t, n = pn, r = {}) {
  let i = r.layoutMode === `pageless`,
    ...
    x = new Map(),
    S = Gr(),
    C = new ue(e.textStyles ?? []),
    w = (e) => C.resolve(e),
    T = Nr(e),
    E = Wr(e, w, T, e.settings?.defaultTabStop),
    D = a.map((t) => ({ section: t, settings: $i(t, e, r) }));
  for (let a = 0; a < D.length; a += 1) {
    let { section: C, settings: O } = D[a],
      k = D[a - 1],
      A = D[a + 1];
    sa(d, C);
    let j = Vr(C.header?.elements ?? s, w, T),
      M = Vr(C.footer?.elements ?? c, w, T),
      ee = Vr(C.firstHeader?.elements ?? l, w, T),
      te = Vr(C.firstFooter?.elements ?? u, w, T),
      ne = !!C.pageSetup?.pageNumbers;
    (C.header && (s = j),
      C.footer && (c = M),
      C.firstHeader && (l = ee),
      C.firstFooter && (u = te));
    let N = Hr(C.elements ?? [], w, T, e.settings?.defaultTabStop),
      P = C.id || `doc-section`,
      F = (e) =>
        ga(
          P,
      ...
      I = !f || !m || (!i && (p !== O.key || ea(C)));
    I &&
      (f && o.push(Pi(f, m ?? O, o.length + 1, r)),
      (f = F(!0)),
      (x = new Map()),
      (S = Gr()),
      (p = O.key),
    ...
    let L = Math.max(h, O.contentTopPx),
      re = !I && (i || !ea(C)) && L > O.contentTopPx + 0.01,
      ie =
        k !== void 0 &&
        C.breakType === Ie.SECTION_BREAK_TYPE_CONTINUOUS &&
        Tr(k.settings.columns, O.columns),
      ae = re && _ && (!ie || !v);
    if (
      f !== void 0 &&
      A !== void 0 &&
      ...
      (i || !ea(A.section)) &&
      Tr(O.columns, A.settings.columns) &&
      f
    ) {
      let e = Ei({
        preparedElements: N,
    ...
    for (let e = 0; e < N.length; e += 1) {
      ...
      if (s.kind !== `text`) {
        ...
        for (; !c;) {
          let l = O.columns.widths[R] ?? O.contentWidthPx,
            u = z[R] ?? L,
            d = u + (B[R] ?? 0),
            h = ei(s, t, l, n, O.documentGridLinePitchTwips),
            b = yr(s, d, x, W[R], i ? Sr(O, L) : 0),
            C = Cr(s, d, b, h.heightPx),
            w = u === O.contentTopPx;
      ...
      for (; !l;) {
        let u = O.columns.widths[R] ?? O.contentWidthPx,
          d = z[R] ?? L,
          h = $r(s, u, n, O.documentGridLinePitchTwips);
        if (h.length === 0 || c >= h.length) {
          (dr(s.element, d, x), (W[R] = d), (l = !0));
          break;
        }
        let b = V[R] ?? !1,
          C = H[R] ?? !1,
        ...
        if (A && P > k && !ne) {
          let r = wi(s, N, e, t, u, n, O.documentGridLinePitchTwips);
          r !== void 0 && I + r > te + Sa && ((P = k), (I = 0), (re = !1));
        }
        if (P === k) {
          if (!ne) {
            if (R < O.columns.widths.length - 1) {
        ...
        if (
          ...
          i || Xi(f, S, E, h, k, P, O, t, n),
          c === 0 && (dr(s.element, j, x), (W[R] = j)),
          (z[R] = j + I),
          (c = P),
          (B[R] = 0),
          re && c < h.length)
        ...
        if (c >= h.length) {
          let e = (s.element.paragraphs?.length ?? 0) > 1 ? xa : 0;
          ((z[R] = (z[R] ?? L) + e),
    ...
    ((h = Math.max(...z)), (b = Jn(oe)));
  }
  return (f && m ? o.push(Pi(f, m, o.length + 1, r)) : f && o.push(f), o);
}
var va,
  ya,
  ba,
  ...
  Ma = e(() => {
    (Re(),
      ...
      (Sa = 0.5),
      (Ca = 1),
      (wa = `__docxMirrorMargins:1`),
      (Ta = `__docxPageNumberStart:`),
      (Ea = `__docxPageNumberFormat:`),
      (Da = 2),
      (Oa = 1),
      (ka = 5),
      (Aa = 6),
      (ja = { layoutDocumentFlow: _a }));
  });
function Na(e) {
  let t = e.table;
  ...
  let n = !1,
    r = t.rows.map((e) => {
      let t = !1,
        r = e.cells.map((e) =>
          e.marginLeft === Ba.leftEmu &&
          e.marginRight === Ba.rightEmu &&
          e.marginTop === Ba.topEmu &&
          e.marginBottom === Ba.bottomEmu
            ? ((t = !0),
              {
                ...e,
                marginLeft: void 0,
...
function qa(e) {
  return e === void 0 ? void 0 : Ka(W(e));
}
function Ja(e) {
  return e === void 0 ? void 0 : Ka(e * G);
}
function Ya(e) {
  ...
  for (let [n, r] of e.entries()) {
    let e = r.paragraphStyle,
      ...
      a = {
        ...
        marginLeftPx: qa(r.marginLeft) ?? Ja(e?.marginLeft),
        indentPx: qa(r.indent) ?? Ja(e?.indent),
        spaceBeforeTwips: r.spaceBefore,
        spaceAfterTwips: r.spaceAfter,
        spaceBeforePx: qa(r.spaceBefore),
        spaceAfterPx: qa(r.spaceAfter),
...
function Za(e) {
  return Wa(e.xPx, e.yPx, e.widthPx, e.heightPx);
}
function Qa(e, t) {
  return Wa(e.left - t.left, e.top - t.top, e.width, e.height);
}
function $a(e, t, n) {
  if (!t) return;
  let r = Za(t.contentFrame),
    i = n?.columnFrame ? Za(n.columnFrame) : void 0;
  return {
    pageFrame: e,
    contentRelativeFrame: Qa(e, r),
    columnRelativeFrame: i ? Qa(e, i) : void 0,
  };
}
function eo(e) {
  if (e)
...
function ro(e, t) {
  ...
  return {
    type: to(e.type),
    color: n && t ? ne(n, t) : void 0,
    colorValue: n?.value,
    colorType: n?.type === void 0 ? void 0 : no(n.type),
...
function ao(e, t) {
  if (e)
    return {
      style: e.style === void 0 ? void 0 : io(e.style),
      widthPx: e.widthEmu === void 0 ? void 0 : Ka(e.widthEmu * G),
      color: e.fill?.color && t ? ne(e.fill.color, t) : void 0,
      fill: ro(e.fill, t),
    };
}
function oo(e) {
  ...
  if (t)
    return {
      ...
      columnFrame: t.columnFrame ? Za(t.columnFrame) : void 0,
...
function co(e, t, n, r, i, a) {
  ...
  return {
    index: t + 1,
    text: e.text,
    frame: Wa(o, i + a, e.widthPx, n.heightPx),
    font: e.font,
    fontKey: e.fontKey,
    fill: e.fill,
...
function lo(e, t, n = 0, r = 0, i = e.topY ?? 0) {
  let a = e.segments.map((t, a) => co(t, a, e, n, r, i));
  return {
    index: t + 1,
    text: e.segments.map((e) => e.text).join(``),
    frame: Wa(n + (e.x ?? 0), r + i, e.widthPx, e.heightPx),
    align: e.align,
...
function po(e) {
  let t = new Map();
  for (let n of e.cellLayouts ?? []) t.set(fo(n.row, n.col), uo(n.block.lines));
  return t;
}
function mo(e) {
  let t = new Map();
  for (let n of e.cellElementFrames ?? []) {
    let e = fo(n.row, n.col),
      r = t.get(e) ?? [];
    (r.push({
      elementId: n.elementId,
      frame: Wa(n.xPx, n.yPx, n.widthPx, n.heightPx),
    }),
      t.set(e, r));
  }
  return t;
...
function ho(e) {
  if (!e) return;
  let t = {
    left: e.marginLeft === void 0 ? void 0 : Ka(e.marginLeft * G),
    right: e.marginRight === void 0 ? void 0 : Ka(e.marginRight * G),
    top: e.marginTop === void 0 ? void 0 : Ka(e.marginTop * G),
    bottom: e.marginBottom === void 0 ? void 0 : Ka(e.marginBottom * G),
  };
...
function go(e, t, n, r) {
  ...
  let i = sn({ ...Fa(e), type: m.ELEMENT_TYPE_TABLE }),
    a = y(i, t, n, {
      paragraphSpacingUnit: `twips`,
      explicitRowHeightBehavior: `atLeast`,
      autoRowMinimumHeightPx: 0,
  ...
  let o = po(a),
    ...
    l = a.rowHeightsPx.map((t, l) => {
      let u = a.cellRects
          .filter((e) => e.row === l)
          .map((t) => {
            let a = fo(t.row, t.col),
              c = o.get(a),
              l = s.get(a),
              u = i.table?.rows?.[t.row]?.cells?.[t.col],
              d = Ya(u?.paragraphs),
              f = Wa(t.xPx, t.yPx, t.widthPx, t.heightPx);
            return {
              row: t.row + 1,
              col: t.col + 1,
              frame: f,
              coordinateHints: $a(f, r, e.flow),
        ...
        d = { index: l + 1, frame: Wa(e.xPx, c, e.widthPx, t), cells: u };
      return ((c += t), d);
    });
  return {
    frame: Wa(e.xPx, e.yPx, e.widthPx, e.heightPx),
    height: a.heightPx,
...
function _o(e, t, n, r, i, a, o) {
  let s = so(e),
    c = e.textLines ? uo(e.textLines, e.xPx, e.yPx) : void 0,
    l = Ya(e.element.paragraphs),
    u = Wa(e.xPx, e.yPx, e.widthPx, e.heightPx);
  return {
    path: n,
    order: r,
    region: t,
    ...
    frame: u,
    coordinateHints: $a(u, i, e.flow),
    flow: oo(e),
    bboxEmu: Xa(e.element.bbox),
    placement: eo(e.element.placement),
    text: s,
    textLines: c,
    paragraphs: l,
    shapeType: e.element.shape?.geometry?.toString(),
    shapeFill: ro(e.element.shape?.fill, o),
    shapeLine: ao(e.element.shape?.line, o),
    ...
    tableLayout: a && o ? go(e, a, o, i) : void 0,
    children: (e.children ?? []).map((e, r) =>
      _o(e, t, `${n}.children.${r + 1}`, r + 1, i, a, o),
    ),
  };
}
function vo(e) {
  return {
    ...
    contentFrame: Za(e.contentFrame),
    columns: e.columns.map((e) => ({ index: e.index, frame: Za(e.frame) })),
    documentGrid: e.documentGrid,
    mirrorMarginXOffsetPx: e.mirrorMarginXOffsetPx,
  };
}
function yo(e, t, n, r, i) {
  return e.map((e, a) => _o(e, t, `${t}.${a + 1}`, a + 1, n, r, i));
}
function bo(e, t, n) {
  let r = e.toProto(),
    i = n ? un(r.theme) : void 0;
  return {
    schema: Co,
    unit: `px`,
    document: {
    ...
    pages: t.map((e, t) => ({
      ...
      frame: Wa(0, 0, e.widthPx, e.heightPx),
      layout: vo(e.layout),
      headerElements: yo(e.headerElements, `header`, e.layout, n, i),
      bodyElements: yo(e.bodyElements, `body`, e.layout, n, i),
      footerElements: yo(e.footerElements, `footer`, e.layout, n, i),
      pageNumberElement: e.pageNumberElement
        ? _o(
            e.pageNumberElement,
            `pageNumber`,
...
function xo(e) {
  let t = Ua(1, 1).getContext(`2d`);
  if (!t)
    throw Error(`Canvas 2D context unavailable for document layout export.`);
  return bo(e, Ra(e, t), t);
}
function So(e, t) {
  let n = t ? bo(e, t) : xo(e);
  return new Blob([JSON.stringify(n, null, 2)], { type: wo });
}
var Co,
  wo,
  To = e(() => {
    (u(),
      ...
      ae(),
      Me(),
      (Co = `openai.document.layout/v1`),
      (wo = `application/vnd.openai.document-layout+json`));
  }),
  Eo,
  Do = e(() => {
    Eo = class {
      ...
      (Po = class {
        ...
        add(e = {}) {
          let { text: t, style: n } = e,
            r;
          if ((this.#t() && this.#e.clear(), t !== void 0 && be(t))) {
            let e = E(t);
...
function Zo(e) {
  if (e) return $o(e) ? e : es(e) ? Jo[e] : void 0;
}
function Qo() {
  return Ko.map((e) => ts(qo[e]));
}
function $o(e) {
  return Object.prototype.hasOwnProperty.call(qo, e);
}
function es(e) {
  return Object.prototype.hasOwnProperty.call(Jo, e);
}
function ts(e) {
  return {
    id: e.styleId,
...
function is(e) {
  let t = as(e),
    n = os(e),
    r = ss(e),
    i = xs(e.pPr?.spacing?.after);
  if (!(t === void 0 && n === void 0 && r === void 0 && i === void 0))
    return { tableProperties: t, cellStyle: n, textStyle: r, spaceAfter: i };
}
function as(e) {
  let t = us(e.tblPr?.shading),
    n = cs(e.tblPr?.alignment),
    r = ps(e.tblPr?.borders),
    i = ys(e.tblPr?.cellMargins);
  if (!(t === void 0 && n === void 0 && r === void 0 && i === void 0))
    return { fill: t, alignment: n, borders: r, cellMargins: i, effects: [] };
}
function os(e) {
  let t = us(e.tcPr?.shading),
    n = bs(e.tcPr?.margins?.left),
    r = bs(e.tcPr?.margins?.right),
    i = bs(e.tcPr?.margins?.top),
    a = bs(e.tcPr?.margins?.bottom),
    o = fs(e.tcPr?.borders),
    s = ms(e.tcPr?.borders),
...
function cs(e) {
  switch (e) {
    case `left`:
      return c.ALIGNMENT_TYPE_LEFT;
    case `center`:
      return c.ALIGNMENT_TYPE_CENTER;
    case `right`:
      return c.ALIGNMENT_TYPE_RIGHT;
    default:
      return;
  }
}
...
function us(e) {
  let t = Ss(e);
  return t ? new S({ type: `solid`, color: t }).toProto() : void 0;
}
function ds(e) {
  let t = ws(e);
  return t ? new S({ type: `solid`, color: t }).toProto() : void 0;
...
function fs(e) {
  ...
  let t = {
    ...
    bottom: _s(e.bottom),
    left: _s(e.left),
    diagonalDown: _s(e.tl2br),
    diagonalUp: _s(e.tr2bl),
  };
  if (!(
    t.top === void 0 &&
    t.right === void 0 &&
...
function _s(e) {
  if (!(!e || e.val === `nil`))
    return ce({ color: Cs(e), width: vs(e), style: `solid` })?.toProto();
}
function vs(e) {
  let t = Number(e.sz);
...
function Os(e) {
  ...
  (n.forEachCell((e) => {
    ...
    (n.borders = { top: Is, bottom: Is, insideHorizontal: Is }),
...
function ks(e, t) {
  ...
  ((n.textStyle.bold = !0), (n.borders = { bottom: Is }));
}
function As(e, t) {
  ...
  ((n.textStyle.bold = !0), (n.borders = { top: Is }));
}
function js(e, t) {
  (t.firstColumn &&
    (e.cells.block({
...
var Ps,
  ...
  Rs = e(() => {
    (u(),
      ...
      ie(),
      Yo(),
      (Ps = { tableStyleLight1: `TableStyleLight1` }),
      (Fs = {
        TableStyleLight1: Ps.tableStyleLight1,
        "Table Style Light 1": Ps.tableStyleLight1,
      }),
      (Is = { color: `#111111`, width: 0.35, style: `solid` }),
      (Ls = { left: 7.2, right: 7.2, top: 2.4, bottom: 2.4 }));
  });
function zs(e) {
...
function Us(e, t, n) {
  if (e?.wrap === `inline`) return Hs(e.alignment, e, n);
  let r = t.left !== void 0 || t.top !== void 0,
    i = n?.spaceBefore !== void 0 || n?.spaceAfter !== void 0;
  if (!e?.wrap && !r) return i ? Hs(void 0, e, n) : void 0;
  let a = Ks(e, n),
    o = qs(e, n);
  return {
    ...
    xOffsetEmu: t.left === void 0 ? void 0 : P(t.left),
    yOffsetEmu: t.top === void 0 ? void 0 : P(t.top),
    horizontalAlignment:
      t.left === void 0
        ? (e?.horizontalAlignment ?? e?.alignment)
        : e?.horizontalAlignment,
    verticalAlignment: e?.verticalAlignment,
    wrap: { type: Js(e?.wrap), side: e?.wrapSide },
    distanceTopEmu: a === void 0 ? void 0 : P(a),
    distanceBottomEmu: o === void 0 ? void 0 : P(o),
    distanceLeftEmu: e?.distanceLeft === void 0 ? void 0 : P(e.distanceLeft),
    distanceRightEmu: e?.distanceRight === void 0 ? void 0 : P(e.distanceRight),
    behindDocument: e?.behindDocument,
    layoutInCell: e?.layoutInCell,
    allowOverlap: e?.allowOverlap,
    relativeHeight: e?.relativeHeight,
...
function Ws(e, t) {
  let n = Ks(e, t),
    r = qs(e, t);
  return {
    distanceTopEmu: n === void 0 ? void 0 : P(n),
    distanceBottomEmu: r === void 0 ? void 0 : P(r),
    distanceLeftEmu: e?.distanceLeft === void 0 ? void 0 : P(e.distanceLeft),
    distanceRightEmu: e?.distanceRight === void 0 ? void 0 : P(e.distanceRight),
  };
}
...
var Qs,
  ...
  nc = e(() => {
    (Rs(),
      ...
      ($s = 7.68),
      (ec = { left: $s, right: $s, top: $s, bottom: $s }),
      (tc = class {
        #e;
        constructor(e) {
          this.#e = e;
        ...
        add(e) {
          ...
          if (d) {
            ...
            (n
              ...
              : r
                ? (u.styleId = ns(r))
                : e && (u.styleId = e),
              (u.styleOptions = { ...Qs, ...Xs(u.styleOptions), ...Xs(t) }));
          }
          Zs(f) &&
            u.rowCount > 0 &&
            u.columnCount > 0 &&
          ...
          let p = Xo(f);
          return (p && Ds(u, p), r !== void 0 && (u.columnWidths = r), u);
        }
      }));
  });
function rc(e) {
...
function ic(e, t) {
  ...
  return `blob` in e
    ? { ...n, blob: ac(e.blob), contentType: e.contentType }
    : `path` in e
      ? { ...n, path: e.path }
      : `dataUrl` in e
        ? { ...n, dataUrl: e.dataUrl }
  ...
  if (e)
    return e.map((e, t) =>
      e.fill || e.line || e.stroke
        ? { ...e }
        : { ...e, fill: mc[t % mc.length], line: hc[t % hc.length] },
    );
}
var pc,
  mc,
...
function yc(e, t) {
  ...
  return n === void 0 ? t : H({ alignment: n }, t);
}
var bc,
  xc = e(() => {
    (Ce(),
    ...
    (u(),
      ...
      (Sc = class e {
        ...
        constructor(e) {
          ...
          ((this.#i = new Mo(this.#e, t)), this.#h(this.#i));
          let r = new De(this.#e, []),
            i = new z(this.#e, []),
            a = new se(this.#e, []),
            o = new te(this.#e, []);
          ((this.#c = new lc(r)),
            ...
            (this.#o = new tc(a)),
            (this.#l = new pc(o)),
            (this.#a = new Po(this.#i.paragraphs)));
        ...
        resolveTextBlock(e) {
          ...
          return n && (n instanceof Mo || `text` in n) ? n.text : null;
        }
        set text(e) {
          this.#i.text.set(e);
        }
        ...
        startParagraphBlock(e = !1) {
          if (!e && this.#n.length === 1 && this.#n[0] === this.#i.id)
            return this.#a;
          let t = new Mo(this.#e);
          return (this.#g(t), new Po(t.paragraphs));
        }
        get tables() {
          return this.#o;
        }
        ...
        addGroup(e) {
          let t = Vs(
            ...
            n = new _c(this.#e, {
              ...
              children: e.children,
              bbox: {
                xEmu: t.left === void 0 ? void 0 : P(t.left),
                yEmu: t.top === void 0 ? void 0 : P(t.top),
                widthEmu: t.width === void 0 ? void 0 : P(t.width),
                heightEmu: t.height === void 0 ? void 0 : P(t.height),
              },
            });
          return (
            (n.placement = Us(e.style, t, {
        ...
        toProto() {
          return this.#n
            .map((e) => this.#r.get(e))
            .filter((e) => !!e)
            .map((e) => (e instanceof Mo, e.toProto()));
        }
        #d() {
          return {
        ...
        #m() {
          return new bc(this.#u.readTextStyleDefinitions());
        }
        #h(e) {
      ...
      (kc = class {
        ...
        constructor(e) {
          ...
          ((this.#m = e.context),
            ...
            (this.#t = t?.breakType ?? Ie.SECTION_BREAK_TYPE_UNSPECIFIED),
            (this.#n = wc(t?.pageSetup)),
            (this.#r = Tc(t?.columns)),
            (this.#h = t?.startsWithPageBreak ?? !1),
            (this.#g = t?.pageNumberStart),
            (this.#_ = t?.pageNumberFormat),
            (this.#v = Ec(t?.documentGrid)),
        ...
        get pageSetup() {
          return this.#n ? wc(this.#n) : void 0;
        }
        set pageSetup(e) {
          ((this.#n = wc(e)), this.#m.invalidateLayout());
        }
        get columns() {
          return this.#r ? Tc(this.#r) : void 0;
        }
        set columns(e) {
          ((this.#r = Tc(e)), this.#m.invalidateLayout());
        }
        get header() {
        ...
        set documentGrid(e) {
          ((this.#v = Ec(e)), this.#m.invalidateLayout());
        }
        clearHeader() {
        ...
        toProto() {
          let e = {
              ...
              firstHeader: void 0,
              firstFooter: void 0,
              documentGrid: Ec(this.#v),
            },
            t = this.#a.toProto();
          this.#l && Oc(t) && (e.header = this.#y(t));
          let n = this.#o.toProto();
          this.#u && Oc(n) && (e.footer = this.#y(n));
          let r = this.#s.toProto();
          this.#d && Oc(r) && (e.firstHeader = this.#y(r));
          let i = this.#c.toProto();
          return (this.#f && Oc(i) && (e.firstFooter = this.#y(i)), e);
        }
        #y(e) {
          return { elements: e };
        }
    ...
    (Re(),
      ...
      (jc = class {
        ...
        add(e = {}) {
          let t = {
              id: e.id || this.#r(),
              breakType: e.breakType ?? Ie.SECTION_BREAK_TYPE_UNSPECIFIED,
            ...
            n = new kc({ section: t, context: this.#n, defaultId: t.id });
  ...
  Ic = e(() => {
    (Ft(),
      ...
      (Pc = class {
        ...
        toProto() {
          return Nc(this.#e) ? void 0 : K(this.#e);
        }
      }),
      (Fc = class {
        #e;
        ...
        set backgroundFill(e) {
          ((this.#r = e === void 0 ? void 0 : new S(e)),
        ...
        get footnoteProperties() {
          return (
            (this.#t ||= new Pc(this.#e.footnoteProperties, this.#i)),
            this.#t
          );
        }
        get endnoteProperties() {
          return (
            (this.#n ||= new Pc(this.#e.endnoteProperties, this.#i)),
            this.#n
          );
        }
...
function Rc(e) {
  return {
    ...
    wholeTable: e.wholeTable
      ? { ...e.wholeTable, paragraphStyle: Lc(e.wholeTable.paragraphStyle) }
      : void 0,
    conditionalStyles: (e.conditionalStyles ?? []).map((e) => ({
      ...e,
      style: e.style
        ? { ...e.style, paragraphStyle: Lc(e.style.paragraphStyle) }
        : void 0,
    })),
  };
}
  ...
  Bc = e(() => {
    (Ft(),
      ...
      (zc = class {
        ...
        #n;
        constructor(e = [], t = {}) {
          ((this.#n = t.fontFamilyCache), (this.#e = K(e).map(Rc)));
          for (let e of this.#e) this.#r(e);
          this.#t = t.onMutated;
        }
        get items() {
          return K(this.#e).map(Rc);
        }
        getById(e) {
          if (!e) return;
          let t = this.#e.find((t) => t.id === e);
          return t ? Rc(K(t)) : void 0;
        }
        getByName(e) {
          if (!e) return;
          let t = this.#e.find((t) => t.name === e);
        ...
        set(e) {
          let t = Rc(K(e));
          this.#r(t);
          let n = this.#e.findIndex((e) => e.id === t.id || e.name === t.name);
          return (
            n >= 0 ? (this.#e[n] = t) : this.#e.push(t),
            this.#t?.(),
            Rc(K(t))
        ...
        addOfficeWordDefaults() {
          ...
          for (let n of e) {
            let e = Rc(K(n));
            this.#r(e);
            let r = t.findIndex((t) => t.id === e.id || t.name === e.name);
            r >= 0 ? (t[r] = e) : t.push(e);
          }
          return ((this.#e = t), this.#t?.(), K(e).map(Rc));
        }
        delete(e) {
        ...
        #r(e) {
          this.#n?.addTextStyle(e.wholeTable?.textStyle);
          for (let t of e.conditionalStyles ?? [])
            this.#n?.addTextStyle(t.style?.textStyle);
        }
      }));
  });
function Vc(e) {
...
function Hc(e) {
  return { ...e, paragraphStyle: Vc(e.paragraphStyle) };
}
var Uc,
  Wc = e(() => {
    (Ft(),
      (Uc = class {
        ...
        #n;
        constructor(e = [], t = {}) {
          ((this.#n = t.fontFamilyCache), (this.#e = K(e).map(Hc)));
          for (let e of this.#e) this.#n?.addTextStyle(e.textStyle);
          this.#t = t.onMutated;
        }
        get items() {
          return K(this.#e).map(Hc);
        }
        getById(e) {
          if (!e) return;
          let t = this.#e.find((t) => t.id === e);
          return t ? Hc(K(t)) : void 0;
        }
        getByName(e) {
          if (!e) return;
          let t = this.#e.find((t) => t.name === e);
        ...
        set(e) {
          let t = Hc(K(e));
          this.#n?.addTextStyle(t.textStyle);
          let n = this.#e.findIndex((e) => e.id === t.id || e.name === t.name);
          return (
            n >= 0 ? (this.#e[n] = t) : this.#e.push(t),
            this.#t?.(),
...
function Jc(e, t) {
  ...
  if (
    ...
    let e = t[n.value] ?? kt[n.value];
    e !== void 0 && (n.lastColor = e.replace(/^#/, ``));
  }
  for (let e of Object.values(n)) Jc(e, t);
}
var Yc,
  Xc = e(() => {
    (Re(),
      ...
      (Yc = class e {
        ...
        constructor(e) {
          ...
          ((this.#e = {
            ...
            (this.#t = new Wt()),
            (this.charts = new w(
              { fontFamilyCache: this.#n, stub: () => {} },
              e.charts ?? [],
            )),
            (this.images = new ke({ stub: () => {} }, e.images ?? [])),
            (this.textStyles = new Uc(e.textStyles ?? [], {
              fontFamilyCache: this.#n,
              onMutated: () => this.invalidateLayoutCache(),
            })),
            (this.tableStyleDefinitions = new zc(
            ...
            (this.fonts = new Yt(e.fonts ?? [], {
              onMutated: () => this.invalidateLayoutCache(),
            })),
            (this.settings = new Fc(e.settings, {
              onMutated: () => this.invalidateLayoutCache(),
            })),
            (this.theme = new Gc(e.theme, {
              onMutated: () => this.invalidateLayoutCache(),
            })),
            this.#n.addThemeFontScheme(e.theme?.fontScheme),
            (this.commentContents = new It(e.comments ?? [], {
              onMutated: () => this.invalidateLayoutCache(),
            })),
            (this.commentReferences = new Rt(e.commentReferences ?? [], {
              onMutated: () => this.invalidateLayoutCache(),
            })),
            (this.#i = {
              fontFamilyCache: this.#n,
          ...
          (r?.widthEmu && (this.#e.widthEmu = r.widthEmu),
            ...
            (this.citations = new bt(t.contentReferences ?? [])),
            (this.footnotes = new Qt({
            ...
            (this.revisions = new Ao(e.reviewMarks ?? [])));
        }
        static create() {
          return new e(Nt());
        }
        ...
        toProto() {
          ...
          return (
            ...
            Jc(a, this.theme.hexColorMap),
            a
          );
        }
        toDocumentBytes() {
          return qc(Le.encode(this.toProto()).finish());
        }
        save() {}
        export(e = { format: `layout` }) {
          let t = e.format ?? `layout`;
          if (t === `layout`) return Promise.resolve(So(this));
...
function $c(e) {
  let [t, n] = (0, el.useState)({ width: 0, height: 0 });
  return (
    (0, el.useEffect)(() => {
      let t = e.current;
      if (!t) return;
...
function al() {
  return _t().map((e) => ({
    text: `${ol(e.artifact)} / ${e.area}: ${e.feature}. ${e.summary}`,
    style: {
      bulletCharacter: `•`,
      marginLeft: 720,
      indent: 360,
...
function sl() {
  ...
  ((t.pageSetup = cl),
    ...
    (e.body.text.get(`Feature highlights across the engine:`).style =
      `heading1`));
  for (let t of al()) e.body.paragraphs.add(t);
  ...
  let n = e.sections.add({ pageSetup: cl, columns: ul });
  ...
  for (let e of _t())
    (n.body.paragraphs.add({
      text: `${ol(e.artifact)} / ${e.area}`,
      style: { spaceBefore: 120, spaceAfter: 60 },
    }),
      (n.body.text.get(`${ol(e.artifact)} / ${e.area}`).style = `heading2`),
      n.body.paragraphs.add({
  ...
  let r = e.sections.add({ pageSetup: cl, columns: ll });
  return (
...
var cl,
  ...
  dl = e(() => {
    (Xc(),
      ...
      (ll = { count: 1, space: 360, widths: [], hasSeparatorLine: !1 }),
      (ul = { count: 2, space: 360, widths: [], hasSeparatorLine: !1 }));
  }),
  fl = e(() => {});
function pl() {
  return new Worker(
        ...
        #f(e) {
          switch (e.kind) {
            ...
            case `rendered-pages`:
              ...
              return;
            case `debug-log`:
              it(e.namespace).debug(e.message, e.details);
              return;
            default:
              return e;
          }
...
function Ul({
  ...
  let h = (0, Wl.useRef)(null),
    g = (0, Wl.useRef)(null),
    _ = window.devicePixelRatio || 1,
    v = (0, Wl.useMemo)(() => Pl(i, o), [i, o]),
    y = (0, Wl.useMemo)(() => Ll(r, a), [r, a]);
  return (
    (0, Wl.useEffect)(() => {
      let r = h.current;
      if (
...
function ql({
  ...
  let o = (0, Q.useRef)(null),
    ...
    T = (0, Q.useMemo)(
      () => Dl(w, { scrollTop: g, viewportHeight: v.height, overscanPx: tu }),
      [v.height, g, w],
    ),
    E = (0, Q.useMemo)(() => {
    ...
    D = (0, Q.useMemo)(() => Ol(w) + 32 + Math.max(0, i), [i, w]),
    O = (0, Q.useMemo)(() => {
      let e = new Map(),
        t = [];
      for (let n of E) {
        ...
        for (let i of r?.textLayoutBlocks ?? [])
          (e.set(i.id, n.pageIndex), t.push($l(i, n)));
      }
        ...
        new ct(
          {
            ...
            onPointerMove: (t) => {
              let n = Ql(t, null, l.current, u.current, d.current);
  ...
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      p.current !== t.pageIndex &&
        ((p.current = t.pageIndex),
        Jl(S, g, v.height) !== t.pageIndex && (f.current = t.pageIndex));
    }, [v.height, S, g, t.pageIndex]),
    (0, Q.useEffect)(() => {
      let n = Jl(S, g, v.height);
    ...
    (0, Q.useEffect)(() => {
      if (!s.current) return;
      if (Jl(S, g, v.height) === t.pageIndex) {
        f.current = null;
        return;
      }
      let e = S[t.pageIndex];
    ...
    M = (0, Q.useCallback)(
      (e, t) => (n) => {
        ...
        if (!c.current) {
          ...
          let a = i ? Il(t?.textLayoutBlocks ?? [], i) : null;
...
function ru({
  ...
  if (!p) return null;
  let m = (0, cu.useSyncExternalStore)(
      (e) => p.subscribe(e),
      () => p.getSnapshot(),
      () => p.getSnapshot(),
    ),
    ...
    y =
      v.width > 0 && m.pageLayouts.length > 0
        ? iu({ pageLayouts: m.pageLayouts, viewportWidth: v.width })
        : null,
    b = y != null && r != null,
    x = (0, cu.useCallback)(
      (e) => {
    ...
    S = b
      ? {
          label: r,
          selected: h && Math.abs(m.zoom - y) < du,
          onSelect: () => {
            let e = ou({
      ...
      : void 0;
  (0, cu.useEffect)(() => {
    !h || !b || Math.abs(m.zoom - y) < du || p.setZoom(y);
  }, [b, p, y, h, m.zoom]);
  ...
  return (
    ...
    (0, $.jsx)(Zc, {
      ...
      header: (0, $.jsx)(Ve, {
        ...
        icon: (0, $.jsx)(rt, {
          kind: `document`,
          children: (0, $.jsx)(Ke, { className: `size-4` }),
        }),
      }),
      children: (0, $.jsxs)(`div`, {
...
function iu({ pageLayouts: e, viewportWidth: t }) {
  let n = e.reduce((e, t) => Math.max(e, t.width), 0);
  return n <= 0 ? 1 : au((t - 80) / n);
}
function au(e) {
  return Math.max(lu, Math.min(uu, e));
}
function ou({ pageIndex: e, pageLayouts: t, viewportHeight: n, zoom: r }) {
  let i = 32;
  for (let a of t) {
...
function mu({
  ...
  let b = (0, hu.useRef)(t),
    ...
    S = dt(
      void 0,
      () => new wl({ document: pu(s), initialPageIndex: c, initialZoom: l }),
    );
  return (
    (0, hu.useEffect)(() => {
      S && t !== b.current && ((b.current = t), S.replaceDocument(pu(s)));
    }, [S, t, s]),
    (0, hu.useEffect)(() => {
      !S ||
        _ == null ||
...
var hu, gu;
e(() => {
  (Xc(), a(), (hu = t(r())), fu(), El(), dl(), Be(), (gu = n()));
})();
export { mu as PopcornElectronDocumentPanel };
//# sourceMappingURL=PopcornElectronDocumentPanel-5Li1GjYe.js.map
