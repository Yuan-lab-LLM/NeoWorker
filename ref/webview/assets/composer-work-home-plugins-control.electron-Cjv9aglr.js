...
import { n as W, t as ie } from "./connector-logo-stack-iQ1syRDg.js";
function ae() {
  let e = (0, G.c)(1),
    t;
  return (
...
function J(e) {
  let t = (0, Y.c)(91),
    {
      ...
      onPluginSelectionChange: c,
      onRequestComposerFocus: l,
      pluginInstallationStatus: u,
      selectedPluginIds: d,
    } = e,
    p = E(),
    m = (0, X.useRef)(!1),
  ...
  if (
    ...
    bb0: {
      x = te({ plugins: n, query: _ });
      let e;
      (t[29] === _ ? (e = t[30]) : ((e = _.trim()), (t[29] = _), (t[30] = e)),
        (C = e.length > 0));
      let r = n.length > 0,
        i;
      t[31] === p
      ...
      t[33] === p
        ? (s = t[34])
        : ((s = p.formatMessage(Q.connectPlugins)), (t[33] = p), (t[34] = s));
      let w = s,
        E;
      t[35] === p
        ? (E = t[36])
        : ((E = p.formatMessage(Q.pluginsTooltip)), (t[35] = p), (t[36] = E));
      let re = E,
        W;
      t[37] !== p || t[38] !== u
        ? ((W =
            u == null
              ? null
              : u.phase === `loading`
                ? p.formatMessage(Q.loadingPlugin, {
                    pluginName: u.pluginDisplayName,
                  })
                : p.formatMessage(Q.installingPlugin, {
                    pluginName: u.pluginDisplayName,
                  })),
          (t[37] = p),
          (t[38] = u),
      ...
      ((b = ne),
              ...
              ? (0, Z.jsxs)(`span`, {
                  ...
                  children: [
                    (0, Z.jsxs)(`span`, {
                      ...
                      children: [
                        n.length < 3
                          ? (0, Z.jsx)(ee, { className: `icon-xs shrink-0` })
                          : null,
                        (0, Z.jsx)(ie, {
                          size: `small`,
        ...
        t[51] === l
          ? (N = t[52])
          : ((N = (e) => {
              m.current && ((m.current = !1), e.preventDefault(), l());
            }),
            (t[51] = l),
            (t[52] = N)));
      let Y;
      ...
      (t[55] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((X = (e) => v(e.currentTarget.value)), (t[55] = X))
        : (X = t[55]),
        t[56] !== _ || t[57] !== Y
          ? ((P = (0, Z.jsx)(T.SearchInput, {
              autoFocus: !0,
              className: `mb-1`,
              placeholder: Y,
              value: _,
  ...
  t[59] !== x || t[60] !== i || t[61] !== C
    ...
    : (W = t[62]);
  let G;
  t[63] !== y || t[64] !== D || t[65] !== W || t[66] !== I
    ? ((G = (0, Z.jsxs)(y, { className: D, children: [I, W] })),
      (t[63] = y),
      (t[64] = D),
      (t[65] = W),
      (t[66] = I),
  ...
  t[68] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, Z.jsx)(T.Separator, {})), (t[68] = K))
    : (K = t[68]);
  let q;
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = (0, Z.jsx)(w, { ...Q.connectPlugins })), (t[69] = q))
    : (q = t[69]);
  let J;
  t[70] !== r || t[71] !== o || t[72] !== s
    ? ((J = (0, Z.jsx)(T.Section, {
...
function se(e) {
  ...
  let {
    ...
    pluginInstallationStatus: w,
  } = V(h);
  if (!S) return null;
  let T;
  t[5] !== a || t[6] !== c || t[7] !== S || t[8] !== u
    ? ((T = () => {
        n(u, c, S, l.CODEX_PLUGIN_DIRECTORY_ENTRYPOINT_OTHER, a);
      }),
      (t[5] = a),
      (t[6] = c),
      (t[7] = S),
  ...
  t[10] !== r || t[11] !== s || t[12] !== f
    ? ((D = (e, t) => {
        if (t) {
          (r.insertMentionAtSelection(I(e, P(s))), f(e));
          return;
        }
...
//# sourceMappingURL=composer-work-home-plugins-control.electron-Cjv9aglr.js.map
