import { i as e, o as t, r as n, t as r } from "./src-DbaHYgEA.js";
import { h as i } from "./chunk-5PVQY5BW-DF1BR3Yd.js";
import {
  $ as a,
  J as o,
  Tt as s,
...
import {
  ...
  s as A,
  v as te,
} from "./chunk-ICPOFSXX-CC2k9yFo.js";
import { t as ne } from "./dist-BDogiz3R.js";
...
function ue(e) {
  ...
  if (e instanceof M) return ve(e);
  e instanceof S || (e = p(e));
  var t = he(e.r),
    n = he(e.g),
    r = he(e.b),
    i = fe((0.2225045 * t + 0.7168786 * n + 0.0606169 * r) / 1),
    a,
    o;
  return (
    t === n && n === r
      ? (a = o = i)
      : ((a = fe((0.4360747 * t + 0.3850649 * n + 0.1430804 * r) / ae)),
        (o = fe((0.0139322 * t + 0.0971045 * n + 0.7141733 * r) / oe))),
    new j(116 * i - 16, 500 * (a - i), 200 * (i - o), e.opacity)
  );
}
function de(e, t, n, r) {
  return arguments.length === 1 ? ue(e) : new j(e, t, n, r ?? 1);
}
function j(e, t, n, r) {
...
_(
  ...
  h(m, {
    brighter(e) {
      return new j(this.l + 18 * (e ?? 1), this.a, this.b, this.opacity);
    },
    darker(e) {
      return new j(this.l - 18 * (e ?? 1), this.a, this.b, this.opacity);
    },
    rgb() {
      ...
      return (
        ...
        (n = oe * pe(n)),
        new S(
          me(3.1338561 * t - 1.6168667 * e - 0.4906146 * n),
          me(-0.9787684 * t + 1.9161415 * e + 0.033454 * n),
          me(0.0719453 * t - 0.2289914 * e + 1.4052427 * n),
          this.opacity,
        )
      );
    },
...
function fe(e) {
  return e > 0.008856451679035631 ? e ** (1 / 3) : e / le + se;
}
function pe(e) {
  return e > ce ? e * e * e : le * (e - se);
}
function me(e) {
...
function ge(e) {
  ...
  if ((e instanceof j || (e = ue(e)), e.a === 0 && e.b === 0))
    return new M(NaN, 0 < e.l && e.l < 100 ? 0 : NaN, e.l, e.opacity);
  var t = Math.atan2(e.b, e.a) * ie;
  return new M(
    t < 0 ? t + 360 : t,
...
function _e(e, t, n, r) {
  return arguments.length === 1 ? ge(e) : new M(e, t, n, r ?? 1);
}
function M(e, t, n, r) {
...
_(
  ...
  h(m, {
    brighter(e) {
      return new M(this.h, this.c, this.l + 18 * (e ?? 1), this.opacity);
    },
    darker(e) {
      return new M(this.h, this.c, this.l - 18 * (e ?? 1), this.opacity);
    },
...
function ye(e) {
  return function (t, n) {
    var r = e((t = _e(t)).h, (n = _e(n)).h),
      i = d(t.c, n.c),
      a = d(t.l, n.l),
      o = d(t.opacity, n.opacity);
    return function (e) {
      return (
        (t.h = r(e)),
        (t.c = i(e)),
...
const Oe = N(
  (e) => {
    e.setTime(
      e - e.getMilliseconds() - e.getSeconds() * F - e.getMinutes() * I,
    );
  },
  (e, t) => {
    e.setTime(+e + t * L);
...
const B = N(
  ...
  (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * I) / R,
  (e) => e.getDate() - 1,
);
B.range;
const Ae = N(
...
function V(e) {
  return N(
    ...
    (e, t) =>
      (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * I) / Ce,
  );
}
const Me = V(0),
  Ne = V(1),
  ...
  Ie = V(5),
  Le = V(6);
(Me.range, Ne.range, Pe.range, Fe.range, H.range, Ie.range, Le.range);
function U(e) {
  return N(
    (t) => {
...
const Re = U(0),
  ...
  Ue = U(5),
  We = U(6);
(Re.range, ze.range, Be.range, Ve.range, He.range, Ue.range, We.range);
const Ge = N(
  (e) => {
...
function qe(e, t, n, r, i, a) {
  ...
  function c(t, n, r) {
    let i = Math.abs(n - t) / r,
      a = y(([, , e]) => e).right(o, i);
    if (a === o.length) return e.every(g(t / Te, n / Te, r));
    if (a === 0) return P.every(Math.max(g(t, n, r), 1));
    let [s, c] = o[i / o[a - 1][2] < o[a][2] / i ? a - 1 : a];
    return s.every(c);
  }
  return [s, c];
}
const [Je, Ye] = qe(G, Ke, Re, je, ke, De),
  [Xe, Ze] = qe(W, Ge, Me, B, Oe, Ee);
function Qe(e) {
  if (0 <= e.y && e.y < 100) {
      ...
      if (
        ...
        (`w` in r || (r.w = 1),
          `Z` in r
            ? ((a = $e(et(r.y, 0, 1))),
              (o = a.getUTCDay()),
              (a = o > 4 || o === 0 ? ze.ceil(a) : ze(a)),
              (a = Ae.offset(a, (r.V - 1) * 7)),
              (r.y = a.getUTCFullYear()),
              (r.m = a.getUTCMonth()),
              (r.d = a.getUTCDate() + ((r.w + 6) % 7)))
            : ((a = Qe(et(r.y, 0, 1))),
              (o = a.getDay()),
              (a = o > 4 || o === 0 ? Ne.ceil(a) : Ne(a)),
              (a = B.offset(a, (r.V - 1) * 7)),
              (r.y = a.getFullYear()),
              (r.m = a.getMonth()),
        ...
        (`W` in r || `U` in r) &&
          ...
          (o =
            `Z` in r
              ? $e(et(r.y, 0, 1)).getUTCDay()
              : Qe(et(r.y, 0, 1)).getDay()),
          (r.m = 0),
          (r.d =
            `W` in r
              ? ((r.w + 6) % 7) + r.W * 7 - ((o + 5) % 7)
...
function Bt(e, t) {
  return ((e = zt(e)), q(H.count(W(e), e) + (W(e).getDay() === 4), t, 2));
}
function Vt(e) {
  return e.getDay();
}
function Ht(e, t) {
  return q(Ne.count(W(e) - 1, e), t, 2);
}
function Ut(e, t) {
  return q(e.getFullYear() % 100, t, 2);
}
function Wt(e, t) {
  return ((e = zt(e)), q(e.getFullYear() % 100, t, 2));
}
function Gt(e, t) {
...
function an(e, t) {
  return q(Re.count(G(e) - 1, e), t, 2);
}
function on(e) {
  var t = e.getUTCDay();
  return t >= 4 || t === 0 ? He(e) : He.ceil(e);
}
function sn(e, t) {
  return ((e = on(e)), q(He.count(G(e), e) + (G(e).getUTCDay() === 4), t, 2));
}
function cn(e) {
  return e.getUTCDay();
}
function ln(e, t) {
  return q(ze.count(G(e) - 1, e), t, 2);
}
function un(e, t) {
  return q(e.getUTCFullYear() % 100, t, 2);
}
function dn(e, t) {
  return ((e = on(e)), q(e.getUTCFullYear() % 100, t, 2));
}
function fn(e, t) {
...
function Cn(e, t, n, r, i, a, o, s, u, d) {
  var f = l(),
    p = f.invert,
    m = f.domain,
    h = d(`.%L`),
  ...
  return (
    ...
    (f.domain = function (e) {
      return arguments.length ? m(Array.from(e, Sn)) : m().map(xn);
    }),
    (f.ticks = function (t) {
      var n = m();
    ...
    (f.copy = function () {
      return c(f, Cn(e, t, n, r, i, a, o, s, u, d));
    }),
    f
  );
}
function wn() {
  return a.apply(
    Cn(Xe, Ze, W, Ge, Me, B, Oe, Ee, z, yn).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
...
function In(e, t) {
  ...
  function f(f) {
    var p = r ?? (t.ticks ? t.ticks.apply(t, n) : t.domain()),
      m = i ?? (t.tickFormat ? t.tickFormat.apply(t, n) : Tn),
      h = Math.max(a, 0) + s,
      g = t.range(),
      _ = +g[0] + c,
      v = +g[g.length - 1] + c,
      y = (t.bandwidth ? Pn : Nn)(t.copy(), c),
    ...
    ((x = x.merge(
      ...
      (E = E.merge(
        w
          ...
          .attr(u, l * h)
          .attr(`dy`, e === En ? `0em` : e === On ? `0.71em` : `0.32em`),
      )),
      f !== b &&
        ((x = x.transition(f)),
        (S = S.transition(f)),
        ...
        w.attr(`opacity`, An).attr(`transform`, function (e) {
      ...
      b
        ...
        .attr(`text-anchor`, e === Dn ? `start` : e === kn ? `end` : `middle`),
      b.each(function () {
        this.__axis = y;
      }));
  }
      ...
      return function (e, t, n) {
        ...
        ((i.isoWeekYear = function () {
          ...
          (i.isoWeek = function (e) {
            if (!this.$utils().u(e))
              return this.add(7 * (e - this.isoWeek()), `day`);
            var t,
              i,
              a,
              o,
              ...
              c =
                ((t = this.isoWeekYear()),
                (i = this.$u),
                (a = (i ? n.utc : n)().year(t).startOf(`year`)),
                (o = 4 - a.isoWeekday()),
                a.isoWeekday() > 4 && (o += 7),
                a.add(o, `day`));
...
Jn.parser = Jn;
var Yn = Jn;
(J.default.extend(Wn.default),
  J.default.extend(Gn.default),
  J.default.extend(Kn.default));
var Xn = { friday: 5, saturday: 6 },
  Y = ``,
  Zn = ``,
  Qn = void 0,
  $n = ``,
  ...
  Rr = n(function (e, t, n, r) {
    ...
    return r.includes(i) || r.includes(a)
      ? !1
      : (n.includes(`weekends`) &&
            (e.isoWeekday() === Xn[fr] || e.isoWeekday() === Xn[fr] + 1)) ||
  ...
  Hr = n(function (e, t, n, r) {
    ...
    ((i =
      e.startTime instanceof Date
        ? (0, J.default)(e.startTime)
        : (0, J.default)(e.startTime, t, !0)),
      (i = i.add(1, `d`)));
    let a;
    a =
      e.endTime instanceof Date
        ? (0, J.default)(e.endTime)
        : (0, J.default)(e.endTime, t, !0);
  ...
  Yr = n(function (e, t) {
    ...
    switch (r.length) {
      case 1:
        ...
        break;
      case 2:
        ((i.id = Jr()), (i.startTime = Wr(void 0, Y, r[0])), (a = r[1]));
        break;
      case 3:
        ((i.id = Jr(r[0])), (i.startTime = Wr(void 0, Y, r[1])), (a = r[2]));
        break;
      default:
    }
    return (
      a &&
        ((i.endTime = Kr(i.startTime, Y, a, lr)),
        (i.manualEndTime = (0, J.default)(a, `YYYY-MM-DD`, !0).isValid()),
        Hr(i, Y, tr, er)),
      i
    );
  }, `compileData`),
  ...
  ti = n(function (e, t) {
    let n = { section: X, type: X, description: e, task: e, classes: [] },
      r = Yr(Zr, t);
    ...
    let e = n(function (e) {
        ...
        switch (Z[e].raw.startTime.type) {
          case `prevTaskEnd`:
            ...
            break;
          case `getStartDate`:
            ((n = Wr(void 0, Y, Z[e].raw.startTime.startData)),
              n && (Z[e].startTime = n));
            break;
        }
        return (
          Z[e].startTime &&
            ((Z[e].endTime = Kr(Z[e].startTime, Y, Z[e].raw.endTime.data, lr)),
            Z[e].endTime &&
              ((Z[e].processed = !0),
              (Z[e].manualEndTime = (0, J.default)(
  ...
  ri = n(function (e, t) {
    let n = t;
    (k().securityLevel !== `loose` && (n = (0, Un.sanitizeUrl)(t)),
...
(n(ci, `getTaskTags`), J.default.extend(qn.default));
var li = n(function () {
  ...
  pi = {
    ...
    renderer: {
      setConf: li,
      draw: n(function (t, i, a, s) {
        let c = k().gantt;
        s.db.setDiagramId(i);
        let l = k().securityLevel,
          u;
        l === `sandbox` && (u = r(`#i` + i));
        let d = r(l === `sandbox` ? u.nodes()[0].contentDocument.body : `body`),
          p = l === `sandbox` ? u.nodes()[0].contentDocument : document,
        ...
        if (
          ...
          for (let n of Object.keys(e)) {
            let r = di(e[n], t) + 1;
            ((t += r), (v += r * (c.barHeight + c.barGap)), (_[n] = r));
          }
        } else {
          v += h.length * (c.barHeight + c.barGap);
          for (let e of g) _[e] = h.filter((t) => t.type === e).length;
        }
        m.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + v);
        let y = d.select(`[id="${i}"]`),
          b = wn()
            .domain([
              f(h, function (e) {
        ...
        function C(e, t, n) {
          let r = c.barHeight,
            ...
            u = o()
              ...
              .range([`#00B9FA`, `#F95002`])
              .interpolate(be);
          (T(i, a, l, t, n, e, s.db.getExcludes(), s.db.getIncludes()),
            D(l, a, t, n),
            w(e, i, a, l, r, u, t, n),
            O(i, a, l, r, u),
            te(l, a, t, n));
        ...
        function w(e, t, n, a, o, l, u) {
          ...
          y.append(`g`)
            ...
            .attr(`width`, function () {
              return u - c.rightPadding / 2;
            })
            .attr(`height`, t)
            .attr(`class`, function (e) {
              for (let [t, n] of g.entries())
                if (e.type === n)
                  return `section section` + (t % c.numberSectionStyles);
              return `section section0`;
            })
            .enter();
          let f = y.append(`g`).selectAll(`rect`).data(e).enter(),
            p = s.db.getLinks();
          if (
            (f
              .append(`rect`)
              ...
              .attr(`y`, function (e, r) {
                return (
                  (r = e.order),
                  e.vert ? c.gridLineStartPadding : r * t + n
                );
              })
              .attr(`width`, function (e) {
                return e.milestone
                  ...
                  : e.vert
                    ? 0.08 * o
                    : b(e.renderEndTime || e.endTime) - b(e.startTime);
              })
              .attr(`height`, function (e) {
                return e.vert
                  ? h.length * (c.barHeight + c.barGap) + c.barHeight * 2
                  : o;
              })
            ...
            f
              ...
              .attr(`x`, function (e) {
                let t = b(e.startTime),
                  n = b(e.renderEndTime || e.endTime);
                if (
                  (e.milestone &&
                    ((t += 0.5 * (b(e.endTime) - b(e.startTime)) - 0.5 * o),
                    (n = t + o)),
                  e.vert)
                )
                  return b(e.startTime) + a;
                let r = this.getBBox().width;
                return r > n - t
                  ? n + r + 1.5 * c.leftPadding > u
                    ? t + a - 5
                    : n + a + 5
                  : (n - t) / 2 + t + a;
              })
              .attr(`y`, function (e, r) {
                return e.vert
                  ? c.gridLineStartPadding +
                      h.length * (c.barHeight + c.barGap) +
                      60
                  : ((r = e.order),
                    r * t + c.barHeight / 2 + (c.fontSize / 2 - 2) + n);
              })
              .attr(`text-height`, o)
              .attr(`class`, function (e) {
                let t = b(e.startTime),
                ...
                let a = 0;
                for (let [t, n] of g.entries())
                  e.type === n && (a = t % c.numberSectionStyles);
                let s = ``;
                return (
                  e.active &&
                    (s = e.crit ? `activeCritText` + a : `activeText` + a),
                  e.done
                    ? (s = e.crit
                        ? s + ` doneCritText` + a
                        : s + ` doneText` + a)
                    : e.crit && (s = s + ` critText` + a),
                  e.milestone && (s += ` milestoneText`),
                  e.vert && (s += ` vertText`),
                  r > n - t
                    ? n + r + 1.5 * c.leftPadding > u
                      ? i + ` taskTextOutsideLeft taskTextOutside` + a + ` ` + s
                      : i +
                        ...
                        ` width-` +
                        r
                    : i + ` taskText taskText` + a + ` ` + s + ` width-` + r
                );
              }),
        ...
        function T(t, n, r, a, o, l, u, d) {
          ...
          for (let { startTime: e, endTime: t } of l)
            ((f === void 0 || e < f) && (f = e),
              (p === void 0 || t > p) && (p = t));
          if (!f || !p) return;
          if ((0, J.default)(p).diff((0, J.default)(f), `year`) > 5) {
            e.warn(
          ...
          y.append(`g`)
            ...
            .attr(`x`, (e) => b(e.start.startOf(`day`)) + r)
            .attr(`y`, c.gridLineStartPadding)
            .attr(
              `width`,
              (e) => b(e.end.endOf(`day`)) - b(e.start.startOf(`day`)),
            )
            .attr(`height`, o - n - c.gridLineStartPadding)
            .attr(`transform-origin`, function (e, n) {
              return (
                (b(e.start) + r + 0.5 * (b(e.end) - b(e.start))).toString() +
                `px ` +
                (n * t + 0.5 * o).toString() +
                `px`
              );
        ...
        function E(e, t, n, r) {
          ...
          let i = t - e,
            a = J.default.duration({ [r ?? `day`]: n }).asMilliseconds();
          return a <= 0 ? 1 / 0 : Math.ceil(i / a);
        }
        n(E, `getEstimatedTickCount`);
        function D(t, n, r, i) {
          let a = s.db.getDateFormat(),
            o = s.db.getAxisFormat(),
            l;
          l = o || (a === `D` ? `%d` : (c.axisFormat ?? `%Y-%m-%d`));
          let u = Rn(b)
              .tickSize(-i + n + c.gridLineStartPadding)
              .tickFormat(yn(l)),
            d =
        ...
        function O(e, t) {
          let n = 0,
            r = Object.keys(_).map((e) => [e, _[e]]);
          y.append(`g`)
            .selectAll(`text`)
            .data(r)
            .enter()
            .append(function (e) {
              let t = e[0].split(A.lineBreakRegex),
                n = -(t.length - 1) / 2,
        ...
        function te(e, t, n, r) {
          ...
          if (i === `off`) return;
          let a = y.append(`g`).attr(`class`, `today`),
            o = new Date(),
            l = a.append(`line`);
          (l
            .attr(`x1`, b(o) + e)
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-0MPwDlB5.js.map
