...
import {
  ...
  r as Xe,
  t as Ze,
} from "./use-ascii-engine-3WV0MVdz.js";
import { n as Qe, t as $e } from "./onboarding-login-content-DFGuiF6T.js";
function et() {
  let e = D(be),
    t = _(),
    n = N(),
  ...
  let T = async () => {
      ...
      try {
        let { authUrl: i, completion: a } = await Ge({ signal: r.signal });
        i &&
          z({
            href: qe({
              authUrl: i,
              codexAppVersion: We(e),
              useDesktopAuth: !1,
        ...
        let o = await a;
        o.success ? (t(), n(`/first-run`)) : w(d(o.error ?? `Unknown error`));
      } catch (e) {
    ...
    E = async () => {
      ...
      try {
        ...
        let s = await a;
        s.success ? (t(), n(`/first-run`)) : w(d(s.error ?? `Unknown error`));
      } catch (e) {
        if (e instanceof Error && e.name === `AbortError`) return;
        w(d(e));
      } finally {
    ...
    { data: A } = p(`show-copilot-login-first`),
    j = async () => {
      try {
        (await f(e, `use-copilot-auth-if-available`, !0, {
          throwOnFailure: !0,
        }),
          t(),
          n(`/first-run`));
    ...
    M = async () => {
      ...
      if (!(!e || x)) {
        S(!0);
        try {
          (await fe(`login-with-api-key`, { hostId: Ie, apiKey: e }),
            t(),
            n(`/first-run`));
        } catch (e) {
          w(d(e));
    ...
    P =
      !c || !A
        ...
        : (0, K.jsxs)(K.Fragment, {
            children: [
              !s && (0, K.jsx)(nt, { isPrimary: !0, handleCopilotSignIn: j }),
              (0, K.jsx)(`div`, {
                className: `pt-2`,
                children: (0, K.jsx)(tt, {
                  isPrimary: !1,
              ...
              children: [
                ...
                F != null &&
                  (0, K.jsx)(lt, {
                    ...
                    onCopyCode: k,
                    onCancel: () => {
                      (F.abortController.abort(), o(null));
                    },
                  }),
                !s &&
                  l &&
...
function ot(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, K.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, K.jsx)(u, { href: ut, className: `icon-2xs` }),
        ],
      })),
      (t[11] = g))
    : (g = t[11]);
  ...
  t[16] === _
    ? (y = t[17])
    : ((y = (0, K.jsx)(V, { color: `ghost`, onClick: _, children: v })),
      (t[16] = _),
      (t[17] = y));
  let b;
  t[18] !== n || t[19] !== a
...
function lt(e) {
  ...
  t[11] === u
    ? (y = t[12])
    : ((y = u
        ? (0, K.jsx)(Ee, { className: `icon-sm text-token-foreground` })
        : (0, K.jsx)(i, { className: `icon-sm` })),
      (t[11] = u),
      (t[12] = y));
  let b;
  ...
  t[26] === s
    ? (T = t[27])
    : ((T = (0, K.jsx)(V, { color: `ghost`, onClick: s, children: w })),
      (t[26] = s),
      (t[27] = T));
  let E = n.length === 0,
    D;
  ...
  let O;
  t[29] !== a || t[30] !== E
    ? ((O = (0, K.jsx)(V, { onClick: a, disabled: E, children: D })),
      (t[29] = a),
      (t[30] = E),
      (t[31] = O))
    : (O = t[31]);
...
function jt(e) {
  ...
  if (c && !i) {
    let e = v ? `size-10` : `size-[52px]`,
      r;
    t[0] === e ? (r = t[1]) : ((r = ue(`shrink-0`, e)), (t[0] = e), (t[1] = r));
    let i;
    t[2] !== n || t[3] !== r
      ? ((i = (0, Z.jsx)(s, { appBrand: n, className: r })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = i))
      : (i = t[4]);
  ...
  t[14] === y
    ? (b = t[15])
    : ((b = ue(`flex w-full flex-col items-center`, y)),
      (t[14] = y),
      (t[15] = b));
  let x;
  t[16] === _
  ...
  t[18] === S
    ? (C = t[19])
    : ((C = ue(`shrink-0`, S)), (t[18] = S), (t[19] = C));
  let w;
  t[20] !== n || t[21] !== C
    ? ((w = (0, Z.jsx)(s, { appBrand: n, className: C })),
      (t[20] = n),
      (t[21] = C),
      (t[22] = w))
    : (w = t[22]);
...
function Pt() {
  let e = D(be),
    ...
    c = de(pe),
    u = de(me),
    f = a == null ? null : { hasPreviouslyCompletedOnboarding: a },
    p = Oe(),
    m = gt(we(vt).get(`enabled`, !1)),
    h = (t) => {
      e.get(O).warning(
        r.formatMessage(
          {
    ...
    ee = () => {
      f != null && (L(e, Me, { method: `apikey`, ...f }), S(!0));
    },
    te = () => {
      w(!1);
    },
      ...
      j.current ??
        (typeof window > `u` ||
          (`AudioContext` in window &&
            ((j.current = new window.AudioContext()),
            j.current.state === `suspended` && j.current.resume())));
    },
    ie = () => {
      (ne(), w(!0));
    },
    oe = async (r = `signin`) => {
      ...
      v(c);
      try {
        let { useDesktopAuth: l, useStreamlinedLoginUx: u } = ht(re(p, _t)),
          m = ae(p, `2936610421`),
          { authUrl: g, completion: _ } = await Ge({
            signal: c.signal,
            ...(m ? { appBrand: o } : {}),
            useHostedLoginSuccessPage: m,
        ...
        v.success
          ? (L(e, Le, { method: a, ...f }),
            i.removeQueries({ queryKey: b(`account-info`), exact: !0 }),
            P(),
            s(!0),
            t(),
            n(`/welcome`, { replace: !0 }))
          : (L(e, B, { method: a, errorKind: Ft(v.error), ...f }),
            h(d(v.error ?? `Unknown error`)));
      } catch (t) {
        if (t instanceof Error && t.name === `AbortError`) {
          L(e, B, { method: a, errorKind: `abort`, ...f });
          return;
        }
        (L(e, B, { method: a, errorKind: Ft(t), ...f }), h(d(t)));
      } finally {
        v(null);
      }
    };
  return f == null
    ? (0, $.jsx)(Fe, {
        children: (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(le, { className: `h-4 w-4 text-token-foreground` }),
            (0, $.jsx)(I, {
    ...
    : (0, $.jsx)(Fe, {
        ...
        children: C
          ? (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(bt, { onExit: te, audioContextRef: j }),
            })
          : (0, $.jsx)(jt, {
              appBrand: o,
              apiKeyValue: T,
              isApiKeyEntryVisible: x,
              isApiKeySignInPending: k,
              isChatGptSignInPending: y,
              ...
              onApiKeySubmit: async () => {
                ...
                if (!(!r || k || f == null)) {
                  A(!0);
                  try {
                    (await fe(`login-with-api-key`, { hostId: Ie, apiKey: r }),
                      L(e, Le, { method: `apikey`, ...f }),
                      P(),
                      s(!0),
                      t(),
                      n(`/welcome`, { replace: !0 }));
                  } catch (t) {
                    (L(e, B, { method: `apikey`, errorKind: Ft(t), ...f }),
                      h(d(t)));
                  } finally {
                    A(!1);
                  }
              ...
              onApiKeyValueChange: E,
              onChatGptSignIn: oe,
              onChatGptSignUp: () => oe(`signup`),
              onPlaySnake: ie,
...
var Rt, zt;
e(() => {
  ((Rt = T()), k(), Te(), mt(), It(), (zt = c()));
})();
export { Lt as LoginRoute };
//# sourceMappingURL=login-route-Cm-BjELq.js.map
