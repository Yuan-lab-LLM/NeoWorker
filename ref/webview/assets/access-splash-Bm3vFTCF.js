...
function l(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, d.jsx)(o, { "aria-hidden": !0, className: `icon-sm` })),
      (t[0] = f))
    : (f = t[0]);
  let p;
  t[1] === r
  ...
  t[7] === s
    ? (g = t[8])
    : ((g = (e) => {
        c({ event: e, href: s, initiator: `open_in_browser_bridge` });
      }),
      (t[7] = s),
      (t[8] = g));
  let _;
  t[9] === s
    ? (_ = t[10])
    : ((_ = (0, d.jsx)(n, { className: `icon-sm`, href: s })),
      (t[9] = s),
      (t[10] = _));
  let v;
...
//# sourceMappingURL=access-splash-Bm3vFTCF.js.map
