...
function D() {
  ...
  if (e[0] !== r || e[1] !== n || e[2] !== i) {
    ...
    ((l = C),
      ...
      (e[6] = f),
      (e[7] = p));
  } else ((o = e[3]), (s = e[4]), (l = e[5]), (f = e[6]), (p = e[7]));
  let h;
  e[9] !== o || e[10] !== f
    ? ((h = (0, k.jsx)(o, { children: f })),
      (e[9] = o),
      (e[10] = f),
      (e[11] = h))
    : (h = e[11]);
  ...
  let v;
  return (
    e[15] !== l || e[16] !== p || e[17] !== _
      ? ((v = (0, k.jsxs)(l, { children: [p, _] })),
        (e[15] = l),
        (e[16] = p),
        (e[17] = _),
        (e[18] = v))
...
var O, k;
e(() => {
  ((O = i()), s(), l(), h(), r(), o(), S(), y(), w(), p(), _(), (k = n()));
})();
export { E as DebugSettings };
//# sourceMappingURL=debug-settings-CnyuKS_j.js.map
