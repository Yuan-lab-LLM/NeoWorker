...
import { n as re, t as ie } from "./artifact-preview-status-0ScAQLgS.js";
function ae(e) {
  let t = H.safeParse(e);
  if (!t.success)
    throw Error(`Notebook must be a JSON object with a cells array`);
  return { cells: t.data.cells.map(oe), title: j(t.data.metadata, `title`) };
}
function oe(e) {
  let t = le(e.source),
    n = e.id ?? null,
...
function A(e, t, n) {
  switch (e.output_type) {
    ...
    case `error`:
      return [
        {
          ename: j(e, `ename`) ?? `Error`,
          evalue: j(e, `evalue`) ?? ``,
          summaryMarkdown: n,
          traceback: P(e.traceback) ?? ``,
          type: `error`,
        },
      ];
    case `display_data`:
...
function ue(e, t) {
  for (let n of N(e)) {
    ...
    let r = R.safeParse(e[t]);
    if (!r.success) continue;
    let i = P(r.data.summaryMarkdown);
...
var F,
  ...
  de = e(() => {
    (S(),
      (F = [`codex`, `codexNotebook`, `codex_notebook`, `codex-app`]),
      (I = [`title`, `cellTitle`, `cell_title`]),
      (L = [
      ...
      (V = v({
        ...
        id: k().optional(),
        metadata: R.optional(),
        outputs: b(B).optional(),
        source: z,
      }).passthrough()),
      (H = v({ cells: b(V), metadata: R.optional() }).passthrough()));
  });
function fe(e) {
...
function me(e) {
  let t = (0, Q.c)(30),
    ...
    u = _(),
    d;
  t[0] === n ? (d = t[1]) : ((d = Ce(n)), (t[0] = n), (t[1] = d));
  let f = d,
    p;
  t[2] !== f.document || t[3] !== f.status || t[4] !== l
    ? ((p = f.status === `ready` ? (f.document.title ?? Z(l)) : Z(l)),
      (t[2] = f.document),
      (t[3] = f.status),
      (t[4] = l),
      (t[5] = p))
  ...
  let m = p,
    h;
  t[6] !== u || t[7] !== f.document || t[8] !== f.status
    ? ((h =
        f.status === `ready`
          ? u.formatMessage(
              {
    ...
    : (h = t[9]);
  let v = h,
    y = v == null ? `IPYNB` : `IPYNB · ${v}`,
    b;
  t[10] !== u || t[11] !== f.status
    ? ((b =
        f.status === `ready`
          ? (0, $.jsxs)($.Fragment, {
              children: [
  ...
  let x;
  t[13] !== i || t[14] !== c
    ? ((x = (0, $.jsx)(s, { hostId: i, path: c })),
      (t[13] = i),
      (t[14] = c),
      (t[15] = x))
    : (x = t[15]);
  let S;
  t[16] !== r || t[17] !== b || t[18] !== x
    ? ((S = (0, $.jsxs)(`div`, {
...
function ve(e) {
  let t = (0, Q.c)(25),
    ...
    o;
  t[0] !== n || t[1] !== r || t[2] !== a
    ? ((o = Te(a, n, r)), (t[0] = n), (t[1] = r), (t[2] = a), (t[3] = o))
    : (o = t[3]);
  let s = o,
    c;
    ...
    ? ((p =
        n.cellType === `code`
          ? (0, $.jsx)(`span`, {
              ...
              children: (0, $.jsx)(C, { className: `icon-2xs` }),
            })
          : null),
      (t[16] = n.cellType),
      (t[17] = a),
...
function Ce(e) {
  try {
    return {
      document: ae(JSON.parse(new TextDecoder().decode(we(e)))),
      status: `ready`,
    };
  } catch {
    return { status: `error` };
...
//# sourceMappingURL=notebook-preview-panel-Du9aIMqK.js.map
