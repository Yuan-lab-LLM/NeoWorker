...
var D,
  ...
  L = e(() => {
    ((D = t(p(), 1)),
      ...
      (A = n(k, {})),
      (j = l(d, `ambient-suggestions`, ({ projectRoot: e }) => ({
        enabled: e != null,
      }))),
      (M = l(
        d,
      ...
      (N = h(d, (e) => null)),
      (P = m(d, (e, { get: t }) => b(S(t, e)))),
      (F = m(d, (e, { get: t }) => {
        let n = t(j, e);
        return n.data != null || n.isError;
      })),
      (I = m(d, ({ domain: e, hostId: t, projectRoot: n }, { get: r }) => {
  ...
  R,
  z = e(() => {
    (o(), (R = n(`electron:new-chat-suggestion-source-debug-override`, null)));
  });
export {
  F as a,
  P as c,
...
//# sourceMappingURL=new-chat-suggestion-source-debug-state-BFY13kAU.js.map
