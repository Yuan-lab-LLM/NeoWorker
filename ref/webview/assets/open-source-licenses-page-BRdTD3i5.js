  ...
  let o = a,
    s =
      r.state != null && typeof r.state == `object` && !Array.isArray(r.state)
        ? r.state
        : null,
    { data: u, isLoading: f } = c(M),
    p;
  e[2] !== o || e[3] !== s || e[4] !== t
    ? ((p = () => {
        t(o, { replace: !0, state: s });
      }),
      (e[2] = o),
      (e[3] = s),
      (e[4] = t),
...
e(() => {
  ((A = o()),
    ...
    p(),
    (j = r()),
    (M = f(S, `third-party-notices`, {
      enabled: !0,
      staleTime: m.ONE_MINUTE,
    })));
})();
export { O as OpenSourceLicensesPage };
//# sourceMappingURL=open-source-licenses-page-BRdTD3i5.js.map
