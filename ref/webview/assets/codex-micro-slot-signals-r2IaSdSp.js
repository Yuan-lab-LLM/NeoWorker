...
function ye({
  ...
  return i?.clientThreadId === t
    ? U(e, i.agentKeyId, { hostId: r, threadKey: he(n), title: a })
    : null;
}
function be(e, t, n) {
  return O(n) ? (e.set(J, { agentKeyId: t, clientThreadId: n }), !0) : !1;
}
function xe(e, t, n) {
...
function Se(e, t, n) {
  if (!O(t) || N(e.get, M.agentSource) !== `custom`) return !1;
  let r = e.get(J),
    i = ye({
      assignments: e.get(q) ?? K,
      clientThreadId: t,
      conversationId: n,
      hostId: e.get(R, n) ?? `local`,
      pending: r,
      title: e.get(y, n),
    });
...
function Ce(e, t, n) {
  if (N(e.get, M.agentSource) !== `custom`) return;
  let r = W(t),
    i = r == null ? null : (e.get(q) ?? K)[r];
  if (i == null || !(`threadKey` in i) || i.threadKey !== n || i.hostId == null)
    return;
  let a = me(i.threadKey);
  a != null && te(e, F(a), i.hostId);
}
function W(e) {
  return f[e] ?? null;
}
    ...
    (v(),
      ...
      (Q = m(j, ({ get: e }) => {
        ...
        if (r === `recent`) {
          ...
          if (p) {
            let n = e(s, `codex`);
            ((t = n.threadKeys), (m = n.pinnedProjectThreadKeys));
          } else
            ((t = e(u).recentRenderableThreadKeys),
              (m = e(c).pinnedProjectGroups.flatMap((e) => e.threadKeys)));
          let r = new Map();
          for (let i of [...t, ...n, ...m]) r.set(i, e(de, i));
          _ = Ee({
            unpinnedThreadKeys: t,
            pinnedThreadKeys: n,
            pinnedProjectThreadKeys: m,
            updatedAtByThreadKey: r,
          });
        } else if (r === `pinned`) {
          let t = e(c);
          if (p) {
            let n = pe(
                ...
                e(s, `codex`).pinnedProjectThreadKeys,
              ),
            ...
            ((g = t.pinnedThreadKeys),
              (m = t.pinnedProjectGroups.flatMap((e) => e.threadKeys)));
        }
        let v = [];
        if (r === `priority`) {
          let t = e(s, `codex`);
        ...
        let b = X({
            ...
            pinnedThreadKeys: g,
            pinnedProjectThreadKeys: m,
            recentlyUpdatedThreadKeys: _,
            priorityThreadKeys: v,
            customAgentThreadKeys: f.map((e) => {
              let t = i[e];
              ...
              case `local`:
                return n.conversation == null
                  ...
                  : [
                      {
                        threadKey: t,
                        title: e(y, n.conversation.id),
                        localStatus: {
                          status: e(I, n.conversation.id),
                          pendingChip: e(V, n.conversation.id),
                          unread: e(ue, n.conversation.id) === !0,
                        },
                      },
                    ];
              case `remote`: {
        ...
        if (r === `custom`) {
          let e = new Set(x.map((e) => e.threadKey));
          for (let t of Object.values(i))
            t != null &&
              `threadKey` in t &&
              !e.has(t.threadKey) &&
              x.push({ threadKey: t.threadKey, title: t.title });
        }
        let S = Te({
          isAppWindowFocused: e(t) === !0,
          threadKeys: b,
          threads: x,
          selectedThreadKey: e(k),
        });
        return r === `custom`
          ? S.map((e) => {
              let t = f[e.id],
      ...
      ($ = m(j, ({ get: e }) => ({
        brightness: N(e, M.lightingBrightness) / 100,
        inactivityTimeoutMs: H(N(e, M.lightingAutoOff)),
        slots: e(Q),
        voiceState: e(ve),
      }))));
  });
...
//# sourceMappingURL=codex-micro-slot-signals-r2IaSdSp.js.map
