...
import { t as M } from "./app-14A_I_iz.js";
import {
  c as N,
  n as P,
  s as ne,
...
function ie(e) {
  ...
  if (a === `mascot-badge`) {
    ...
    return (
      t[0] !== n || t[1] !== r
        ? ((e = (0, z.jsx)(se, { dispatchAction: n, preparation: r })),
          (t[0] = n),
          (t[1] = r),
          (t[2] = e))
        : (e = t[2]),
  ...
  t[14] === i.activities
    ? (u = t[15])
    : ((u = i.activities.map(oe)), (t[14] = i.activities), (t[15] = u));
  ...
  let m = i.expandedNotificationIds,
    ee = i.isNotificationStackExpanded,
    h = i.layout,
    g = r.nativeAttached,
    _ = i.notificationFollowUp,
    te = i.activityStackItems.length,
    v;
  t[17] === i.activities
    ? (v = t[18])
    : ((v = i.activities.map(ae)), (t[17] = i.activities), (t[18] = v));
  let b = y(a) ? a : i.pointerSurfaceId,
    x,
    S,
    C,
    w,
  ...
  t[38] !== r.backingRect.width
    ? ((P =
        (y(a) || a === `realtime-caption`) && i.voiceControls != null
          ? {
              activity: `idle`,
  ...
  t[40] === a
    ? (F = t[41])
    : ((F = { type: `native-surface`, id: a }), (t[40] = a), (t[41] = F));
  let I;
  ...
  t[71] !== f
    ? ((I = (0, z.jsx)(
        re,
        {
          ...
          isNotificationTrayOpen: ee,
          layout: h,
          nativeMaterialAttached: g,
          notificationFollowUp: _,
          notificationStackContentExpanded: !0,
          notificationStackItemCount: te,
          notifications: v,
          pointerSurfaceId: b,
          ...
          onOpenNotificationActions: w,
          onNotificationExpansionChange: T,
          onRunNotificationControl: E,
          onQuickChatDraftChange: D,
          onQuickChatEditorActiveChange: O,
          onQuickChatVisibilityChange: k,
          onRunNotificationAction: A,
          onSubmitQuestionOption: j,
          onSubmitQuickChat: M,
          quickChatDraft: i.quickChatDraft,
          quickChatEnabled: N,
          quickChatVisible: i.isQuickChatVisible,
          realtimeVoiceSurface: P,
          renderMode: F,
        },
        l,
      )),
...
function se(e) {
  ...
  t[0] !== a.activities.length || t[1] !== i || t[2] !== o
    ? ((c = i.formatMessage(o ? B.hideActivity : B.showActivity, {
      ...
      (t[3] = c))
    : (c = t[3]);
  let l = s == null ? `text-[rgba(255,255,255,0.38)]` : `text-white`,
    u;
  t[4] === l
    ? (u = t[5])
    : ((u = v(
  ...
  let m;
  return (
    t[16] !== c || t[17] !== u || t[18] !== d || t[19] !== f || t[20] !== p
      ? ((m = (0, z.jsx)(`button`, {
          type: `button`,
          "aria-label": c,
...
function de() {
  let e = (0, W.c)(16),
    t = (0, G.useSyncExternalStore)(_e, V, V),
    n = (0, G.useRef)(null),
  ...
  e[11] === t
    ? (d = e[12])
    : ((d = (0, q.jsx)(ie, { preparation: t, dispatchAction: fe })),
      (e[11] = t),
      (e[12] = d));
  let f;
  return (
...
function ge(e) {
  if (e.code !== o.MISSING_TRANSLATION) throw e;
}
function V() {
  return Z;
}
...
//# sourceMappingURL=avatarOverlayCompositionSurface-D14b-Nu9.js.map
