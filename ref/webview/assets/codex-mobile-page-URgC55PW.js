...
function N() {
  let e = (0, F.c)(8),
    ...
    [r] = v(D),
    a;
  e[0] === t ? (a = e[1]) : ((a = i(t)), (e[0] = t), (e[1] = a));
  let { data: s, isError: c, isFetching: u, isPending: d } = S(a);
...
function P(e) {
  ...
  if (
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, L.jsx)(y.MainContentLayout, { layout: `full-bleed` })),
        (t[0] = e))
      : (e = t[0]);
    let r;
    t[1] !== n || t[2] !== i || t[3] !== a
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, L.jsx)(y.MainContentLayout, { layout: `full-bleed` })),
      (t[10] = l))
    : (l = t[10]);
  let u;
  return (
...
//# sourceMappingURL=codex-mobile-page-URgC55PW.js.map
