...
import { n as me, t as he } from "./onboarding-banner-x8BEylhu.js";
var ge,
  _e = e(() => {
...
function ve() {
  ...
  e[3] !== t || e[4] !== l
    ? ((d = async function (e, n) {
        ...
        try {
          ...
          D(t, j, { hotkey: e ?? void 0, enabled: e != null, source: n });
        } catch (e) {
          let t = e;
    ...
    ? ((b =
        y == null && i == null
          ...
          : (0, q.jsxs)(`div`, {
              ...
              children: [
                y == null ? null : (0, q.jsx)(be, { hotkey: y }),
                i
                  ? (0, q.jsx)(`span`, {
  ...
  e[17] !== l.isPending || e[18] !== k
    ...
    : (A = e[19]);
  let M;
  e[20] !== f || e[21] !== p || e[22] !== h?.hotkey
    ? ((M = X.map((e) =>
        (0, q.jsx)(
          O.Item,
          {
            RightIcon: e.hotkey === h?.hotkey ? W : void 0,
            onSelect: () => {
              (a(null), e.hotkey !== p && f(e.hotkey, `capture`));
            },
            children: e.label,
          },
          e.hotkey,
      ...
      (e[23] = M))
    : (M = e[23]);
  let N = p == null ? W : void 0,
    I;
  e[24] !== f || e[25] !== p
    ? ((I = () => {
        (a(null), p != null && f(null, `disable`));
      }),
      (e[24] = f),
      (e[25] = p),
      (e[26] = I))
  ...
  let R;
  e[28] !== N || e[29] !== I
    ? ((R = (0, q.jsx)(O.Item, { RightIcon: N, onSelect: I, children: L })),
      (e[28] = N),
      (e[29] = I),
      (e[30] = R))
    : (R = e[30]);
  let B;
  e[31] !== R || e[32] !== M
    ? ((B = (0, q.jsxs)(O.Section, { children: [M, R] })),
      (e[31] = R),
      (e[32] = M),
      (e[33] = B))
    : (B = e[33]);
  let V;
  e[34] !== l.isPending || e[35] !== B || e[36] !== A
    ? ((V = (0, q.jsx)(s, {
        align: `end`,
        contentWidth: `icon`,
        disabled: w,
  ...
  return (
    e[38] !== S || e[39] !== V
      ? ((H = (0, q.jsx)(P, { label: C, description: S, control: V })),
        (e[38] = S),
        (e[39] = V),
        (e[40] = H))
      : (H = e[40]),
...
function we() {
  ...
  e[3] === i
    ? (y = e[4])
    : ((y = h.find((e) => e.id === i) ?? h[0]), (e[3] = i), (e[4] = y));
  let b = y;
  if (o || c || !a) return null;
  let S;
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(A, { slug: `appshots` })), (e[5] = S))
    : (S = e[5]);
  let C;
  ...
  e[10] === b.label
    ? (M = e[11])
    : ((M = (0, $.jsx)(u, { contentClassName: `truncate`, children: b.label })),
      (e[10] = b.label),
      (e[11] = M));
  let N;
  e[12] !== i || e[13] !== t
    ? ((N = h.map((e) =>
        (0, $.jsx)(
          O.Item,
          {
            RightIcon: e.id === i ? W : void 0,
            subTextAllowWrap: !0,
            onSelect: () => {
              m(t, _.destination, e.id);
            },
            SubText: (0, $.jsx)(`div`, {
  ...
  e[19] === F
    ...
    : ((L = (0, $.jsx)(se, {
        ...
        children: (0, $.jsx)(se.Content, {
          children: (0, $.jsxs)(R, { children: [w, F, I] }),
        }),
      })),
      (e[19] = F),
      (e[20] = L));
...
function Te() {
  ...
  return (
    e[5] !== r || e[6] !== a || e[7] !== o
      ? ((s = (0, $.jsx)(P, {
          label: i,
          control: (0, $.jsx)(de, { ariaLabel: a, checked: r, onChange: o }),
        })),
        (e[5] = r),
        (e[6] = a),
        (e[7] = o),
...
//# sourceMappingURL=appshots-settings-Dsut1O6i.js.map
