...
import { i as V, n as H, t as U } from "./modifiers.esm--SGMoLew.js";
var W,
  be,
  G = e(() => {
    (v(),
...
function J(e) {
  let t = (0, we.c)(45),
    {
      ...
      onEditMessage: ee,
      onDeleteMessage: d,
      onOpenInSideChatMessage: f,
      onSendNowMessage: p,
      onReorderMessages: m,
      onQueueingChange: h,
      onResumeInterruptedQueue: g,
    } = e,
    _ = re(),
    v;
  t[0] === n ? (v = t[1]) : ((v = n.map(Y)), (t[0] = n), (t[1] = v));
  let y = v,
    b;
  t[2] !== y || t[3] !== m
    ? ((b = { messageIds: y, onReorderMessages: m }),
      (t[2] = y),
      (t[3] = m),
      (t[4] = b))
    : (b = t[4]);
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = { container: document.body }), (t[8] = C))
    : (C = t[8]);
  let T;
  if (
    t[9] !== c ||
    ...
    t[32] !== p
      ? ((e = (e) => {
          let {
              ...
              diffCommentAttachments: a,
            } = te(e.context.commentAttachments ?? []),
            s = r(
              e.context.fileAttachments,
              e.context.generatedPastedTextAttachmentPaths,
            );
          return (0, Q.jsx)(
            X,
            {
              ...
              messageText: Z(_, {
                ...
                diffCommentCount: a.length,
                imageCommentCount:
                  e.context.imageCommentDrafts?.reduce(Se, 0) ??
                  e.context.imageCommentDraft?.comments.length ??
                  0,
                pastedTextAttachmentPreview:
                  e.context.pastedTextAttachments?.[0]?.preview ??
                  (s == null ? void 0 : ``),
                pastedTextAttachmentCount:
                  e.context.pastedTextAttachments?.length ?? s?.length,
                selectedTextAttachmentCount:
                  e.context.selectedTextAttachments?.length ?? 0,
                responseAnnotationCount:
                  e.context.responseTextAnnotations?.length ?? 0,
              }),
              isPaused: i(e.pausedReason),
              hostId: l,
              isEditing: e.id === c,
              isQueueingEnabled: u,
              isSendNowDisabled: o,
  ...
  t[34] === T
    ? (E = t[35])
    : ((E = (0, Q.jsx)(le, { initial: !1, children: T })),
      (t[34] = T),
      (t[35] = E));
  let D;
  t[36] !== y || t[37] !== E
    ? ((D = (0, Q.jsx)(me, { items: y, strategy: s, children: E })),
      (t[36] = y),
      (t[37] = E),
      (t[38] = D))
    : (D = t[38]);
  let O;
  t[39] !== x || t[40] !== D
    ? ((O = (0, Q.jsx)(L, { ...x, accessibility: C, children: D })),
      (t[39] = x),
      (t[40] = D),
      (t[41] = O))
    : (O = t[41]);
...
function X(e) {
  let n = (0, we.c)(97),
    {
      ...
      onEditMessage: p,
      onDeleteMessage: m,
      onOpenInSideChatMessage: h,
      onSendNowMessage: g,
      onQueueingChange: _,
    } = e,
    v = re(),
    te;
  n[0] === r ? (te = n[1]) : ((te = { id: r }), (n[0] = r), (n[1] = te));
  let {
      attributes: b,
      listeners: x,
      setNodeRef: ne,
    ...
    k = a ? Te.retryQueuedMessage : Te.sendQueuedMessageNow,
    A;
  n[2] === E
    ? (A = n[3])
    : ((A = S.Translate.toString(E)), (n[2] = E), (n[3] = A));
  let j;
  n[4] !== A || n[5] !== D
    ? ((j = { transform: A, transition: D }),
      (n[4] = A),
      (n[5] = D),
      (n[6] = j))
    : (j = n[6]);
  ...
  n[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = { height: 0, opacity: 0 }),
      (le = { height: `auto`, opacity: 1 }),
      (ue = { height: 0, opacity: 0 }),
      (de = { duration: 0.18 }),
      (n[7] = ce),
      (n[8] = le),
      (n[9] = ue),
      (n[10] = de))
    : ((ce = n[7]), (le = n[8]), (ue = n[9]), (de = n[10]));
  let me = s || O ? `opacity-60` : void 0,
    he = O ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    M;
  n[11] === he
    ? (M = n[12])
    : ((M = ae(
  ...
  n[13] === M
    ? (N = n[14])
    : ((N = (0, Q.jsx)(d, { className: M, "aria-hidden": !0 })),
      (n[13] = M),
      (n[14] = N));
  let _e;
  ...
  n[23] !== o || n[24] !== i
    ? ((I = (0, Q.jsx)(ie, {
        className: `line-clamp-1 max-h-lh min-w-0 leading-4 text-token-text-secondary`,
        markdownClassName: `![--markdown-line-height:var(--leading-4)] [&_blockquote]:mb-0 [&_blockquote]:!py-0 [&_blockquote]:!ps-0 [&_blockquote]:!leading-4`,
        text: i,
        cwd: null,
        hostId: o,
      })),
  ...
  let z;
  n[31] !== v || n[32] !== k
    ? ((z = v.formatMessage(k)), (n[31] = v), (n[32] = k), (n[33] = z))
    : (z = n[33]);
  let B;
  n[34] !== r || n[35] !== g
    ? ((B = (e) => {
  ...
  n[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, Q.jsx)(xe, { className: `icon-2xs shrink-0` })), (n[37] = ye))
    : (ye = n[37]);
  let V;
  n[38] === k
    ? (V = n[39])
    : ((V = (0, Q.jsx)(w, { ...k })), (n[38] = k), (n[39] = V));
  let H;
  n[40] !== f || n[41] !== z || n[42] !== B || n[43] !== V
    ? ((H = (0, Q.jsxs)(pe, {
  ...
  n[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, Q.jsx)(t, { className: `icon-2xs` })), (n[53] = K))
    : (K = n[53]);
  let q;
  n[54] !== W || n[55] !== G
    ? ((q = (0, Q.jsx)(pe, {
  ...
  n[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, Q.jsx)(ee, { className: `icon-2xs` })), (n[59] = Se))
    : (Se = n[59]);
  let Y;
  n[60] === J
    ? (Y = n[61])
  ...
  n[79] !== Y || n[80] !== Z || n[81] !== Ee || n[82] !== ke
    ...
    : (Ae = n[83]);
  let je;
  n[84] !== U || n[85] !== q || n[86] !== Ae
    ? ((je = (0, Q.jsxs)(Q.Fragment, { children: [U, q, Ae] })),
      (n[84] = U),
      (n[85] = q),
      (n[86] = Ae),
      (n[87] = je))
    : (je = n[87]);
  let $;
  n[88] !== P || n[89] !== L || n[90] !== je || n[91] !== me
    ? (($ = (0, Q.jsx)(se, { className: me, icon: P, title: L, actions: je })),
      (n[88] = P),
      (n[89] = L),
      (n[90] = je),
      (n[91] = me),
...
function Z(
  e,
  {
    ...
    diffCommentCount: i,
    imageCommentCount: a,
    pastedTextAttachmentCount: o = 0,
    pastedTextAttachmentPreview: s,
    responseAnnotationCount: c,
    selectedTextAttachmentCount: l = 0,
  },
) {
  if (t.trim().length > 0) return /^(?:`{3,}|~{3,})/.test(t.trim()) ? _(t) : t;
  if (s != null) {
    let t =
      s ||
      e.formatMessage({
    ...
    return o <= 1
      ...
      : e.formatMessage(
          ...
          { preview: t, remainingCount: o - 1 },
        );
  }
  return n > 0 || c > 0 || r > 0 || i > 0 || a > 0
    ? F(e, { annotationCount: n + c, designTweakCount: r, commentCount: i + a })
    : l > 0
      ? e.formatMessage(
          {
...
export { J as QueuedMessageList };
//# sourceMappingURL=queued-message-list-CJCiiVt0.js.map
