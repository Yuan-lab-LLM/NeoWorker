...
import {
  ...
  r as et,
  t as tt,
} from "./avatar-overlay-native-frame-7AJGWkAc.js";
import {
  c as nt,
  u as rt,
...
import {
  n as it,
  t as at,
} from "./use-floating-window-pointer-interactivity-D2j8KaO0.js";
import {
  C as ot,
  S as st,
  _ as ct,
  ...
  x as Ct,
  y as wt,
} from "./use-avatar-overlay-selection-DMTELIr3.js";
import {
  i as Tt,
  n as Et,
  t as Dt,
...
import {
  ...
  o as At,
  t as jt,
} from "./avatar-overlay-mascot-size-CydkQqgJ.js";
function Mt({
  ...
  return n.flatMap((n) => {
      ...
      return [
        {
          ...
          edgeZone: null,
          opacity:
            n.id !== `voice-controls` && (Oe(n.id) || n.id === `mascot-badge`)
              ? n.opacity
              : 1,
          platterRect: n.rect,
          presentationOffset:
    ...
    let s = Nt(n.rect, o.visibleRect, o.presentationRect);
    return [
      {
        ...n,
        ...a,
        chromiumPresentationRect: t
          ? n.rect
          : Nt(n.rect, o.contentRect, o.presentationRect),
        edgeZone: o.edgeZone,
...
function Ft(e, { includeInertSurfaces: t = !1 } = {}) {
  if (e == null) return null;
  let n = Rt(e.querySelector(Ut)),
    r = Bt(e.querySelector(B), t);
  return n == null ? null : { mascot: n, tray: r };
}
function It(e, t, { includeInert: n = !1 } = {}) {
  if (e == null) return [];
  let r = Array.from(e.querySelectorAll(Kt)).flatMap((e) => {
    if ((!n && e.closest(`[inert]`) != null) || Vt(e)) return [];
    ...
    let l = e.querySelector(qt),
      ...
      d = e.querySelector(Jt),
      f = d?.getBoundingClientRect();
    return [
      {
        ...(l != null && u != null && !Vt(l) && u.width > 0 && u.height > 0
          ? {
...
function Lt(e) {
  return Array.from(e.querySelectorAll(Yt.join(`, `)));
}
function Rt(e) {
  if (e == null || Vt(e)) return null;
...
function zt(e) {
  return {
    backing: Rt(e?.querySelector(Gt) ?? null)?.height ?? 0,
    visible: Rt(e?.querySelector(U) ?? null)?.height ?? 0,
  };
}
function Bt(e, t) {
  if (e == null || Vt(e)) return null;
  ...
  let r = Array.from(e.querySelectorAll(Kt))
      .filter(
        (e) =>
  ...
  let s = o.getBoundingClientRect(),
    c = Math.max(
      0,
      ...Array.from(o.querySelectorAll(W)).map(
...
var Ut,
  ...
  Xt = e(() => {
    (A(),
      (Ut = `[data-avatar-overlay-size='mascot']`),
      (B = `[data-avatar-overlay-size='notification-tray']`),
      (V = `[data-avatar-overlay-size='notification-tray-header']`),
      (H = `[data-avatar-overlay-size='notification-tray-list']`),
      (Wt = `[data-avatar-overlay-measure='notification-tray-row']`),
      (Gt = `[data-avatar-overlay-size='notification-stack-backing-layout']`),
      (U = `[data-avatar-overlay-size='notification-stack-visible-layout']`),
      (Kt = `[data-avatar-overlay-native-surface-id]`),
      (qt = `[data-avatar-overlay-chromium-overflow='true']`),
      (W = `[data-avatar-overlay-backing-canvas='true']`),
      (Jt = `[data-avatar-overlay-trailing-accessory]`),
      (Yt = [Ut, B, V, H, Wt, Gt, U, Kt, qt, Jt]));
  });
function Zt() {
  let e = (0, Cn.c)(13),
  ...
  (e[0] === r
    ...
    : ((i = () => {
        r &&
          D.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, {
            isInteractive: !1,
          });
      }),
      (a = [r]),
  ...
  if (
    (e[3] === r
      ...
      : ((o = () => (
          r &&
            D.dispatchMessage(`avatar-overlay-composition-changed`, {
              state: null,
            }),
          Qt
        )),
  ...
  let c;
  e[6] !== t || e[7] !== n
    ? ((c = bn(t, n)), (e[6] = t), (e[7] = n), (e[8] = c))
    : (c = e[8]);
  let l;
  return (
    e[9] !== t || e[10] !== n || e[11] !== c
      ? ((l = (0, Tn.jsx)($t, { selectedAvatar: t, selectedAvatarId: n }, c)),
        (e[9] = t),
        (e[10] = n),
        (e[11] = c),
        (e[12] = l))
...
function Qt() {
  D.dispatchMessage(`avatar-overlay-composition-changed`, { state: null });
}
function $t(e) {
  let t = (0, Cn.c)(35),
    { selectedAvatar: r, selectedAvatarId: i } = e,
    a = oe(Ne),
    o = ye(),
    c = le() === !0,
    l = n(`451951815`),
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = { taskFilter: `current`, limit: 20 }), (t[0] = y))
    : (y = t[0]);
  let { data: ae, refetch: b } = Fe(y),
    se = ae === void 0 ? [] : ae,
    ce = be(),
    ue = P(),
    de = nt({
  ...
  t[1] !== v || t[2] !== a
    ? ((fe = (e, t) => {
          ...
          bb16: switch (t.intent) {
            case `command-approval`:
              if (
                ...
                T(`reply-with-command-execution-approval-decision`, {
                  conversationId: r,
            ...
            case `file-approval`:
              if (t.fileDecision != null && n?.kind === `patch`) {
                T(`reply-with-file-change-approval-decision`, {
                  conversationId: r,
                  requestId: n.requestId,
            ...
            case `permission-response`:
              if (t.permissionResponse != null && n?.kind === `permission`) {
                T(`reply-with-permissions-request-approval-response`, {
                  conversationId: r,
                  requestId: n.requestId,
            ...
            case `mcp-elicitation`:
              if (t.mcpElicitationAction != null && n?.kind === `tool`) {
                T(`reply-with-mcp-server-elicitation-response`, {
                  conversationId: r,
                  requestId: n.requestId,
            ...
            case `plan-start`:
              if (n?.kind === `plan` && t.planStartCollaborationMode != null) {
                T(`update-thread-settings-for-next-turn`, {
                  conversationId: r,
                  threadSettings: {
                  ...
                  .then(() =>
                    T(`remove-plan-implementation-request`, {
                      conversationId: r,
                      turnId: n.turnId,
                    }),
                  )
                  .then(async () =>
                    T(`send-follow-up-message`, {
                      conversationId: r,
                      prompt: `${C}\n${n.planContent}`,
                      serviceTier: await ve(
                        a,
                        a.get(j, r) ?? `local`,
        ...
        (t != null && t.intent !== `open`) ||
          (e.action != null &&
            D.dispatchMessage(`open-in-main-window`, { path: e.action.path }));
      }),
      (t[1] = v),
      (t[2] = a),
      (t[3] = fe))
  ...
  t[4] === v
    ...
    : ((S = (e, t) => {
        ...
        e.localConversationId == null ||
          n?.kind !== `question` ||
          T(`reply-with-user-input-response`, {
  ...
  let he = S,
    ge;
  t[6] !== ce || t[7] !== ue || t[8] !== v || t[9] !== b || t[10] !== a
    ? ((ge = async (e, t) => {
        ...
        switch (t.type) {
          ...
          case `stop`:
            ...
            switch (n.type) {
              case `app-server-conversation`:
                (await T(`interrupt-conversation`, {
                  conversationId: n.conversationId,
                  initiatedBy: `user`,
                }),
                  Promise.resolve(v()).catch(K));
                return;
              case `cloud-task`:
                (await ce.mutateAsync(n.taskId), Promise.resolve(b()).catch(G));
                return;
            }
          case `submit-follow-up`: {
            ...
            switch (n.type) {
              case `app-server-conversation`:
                (await T(`send-follow-up-message`, {
                  conversationId: n.conversationId,
                  prompt: e,
                  serviceTier: await ve(
                    a,
                    a.get(j, n.conversationId) ?? `local`,
                    null,
                  ),
                }),
                  Promise.resolve(v()).catch(rn));
                return;
              case `cloud-task`:
  ...
  t[12] === a
    ? (Se = t[13])
    : ((Se = (e) => (e == null ? void 0 : a.get(Pe, e)?.items)),
      (t[12] = a),
      (t[13] = Se));
  let w;
  t[14] !== v || t[15] !== a
  ...
  return (
    ...
    t[33] !== w
      ? ((Ce = (0, Tn.jsx)(an, {
          ...
          dictationStreamingEnabled: m,
          dictationSupportState: h,
          latestTurnItems: Se,
          mascotWidthPx: te,
          productLogger: ee,
          globalDictationOrbEnabled: p,
          quickChatEnabled: f,
          selectedAvatar: r,
          selectedAvatarId: i,
          sessions: de,
          ...
          onRefreshRemoteSessions: b,
          onRunNotificationControl: xe,
...
function en() {
  D.dispatchMessage(`open-current-main-window`, {
    focusComposer: !0,
    stealFocus: !0,
  });
}
function tn() {
  D.dispatchMessage(`avatar-overlay-close`, {});
}
function nn() {}
function rn() {}
function G() {}
...
function an(e) {
  let t = (0, Cn.c)(294),
    {
      dictationCleanupEnabled: r,
      dictationStreamingEnabled: i,
      dictationSupportState: a,
      firstAwakeNotificationEnabled: o,
      ...
      onClosePet: re,
      onMascotClick: ie,
      onRefreshLocalSessions: y,
      onRefreshRemoteSessions: ae,
      onRunNotificationControl: b,
      onRunNotificationAction: ce,
      onSubmitQuestionOption: le,
      onSubmitQuickChat: ue,
    } = e,
    fe = o === void 0 ? !0 : o,
    me = s === void 0 ? !1 : s,
    S = oe(Ne),
    ...
    ve = x(Et),
    C = n(`620613358`),
    [be, Se] = (0, q.useState)(!1),
    w = C || be,
    T = wt(),
    E = h ?? T,
    Me = be && E.phase !== `active`,
    O = E.phase === `inactive` && Me ? `starting` : E.phase,
    Fe = x(Be),
    Ie = x(ge),
    Le = Ie?.surface ?? null,
    k = Fe == null || Fe.phase === `inactive` ? null : Fe.locator,
    A = h?.isSessionActive ?? (Fe != null && Fe.phase !== `inactive`),
    j = O !== `inactive` && (Le == null || Le === `global-overlay`),
    M = A || j,
    He = C && j && E.isMuted,
    N = He ? (E.caption ?? ``) : null,
    P = w && (E.canStart || j),
    Ue = v(Pe, k?.conversationId),
    We;
  t[0] !== A || t[1] !== k
    ? ((We = {
        enabled: A,
  ...
  let Ge = te(We),
    ...
    Xe;
  t[3] !== j || t[4] !== Ye
    ? ((Xe = { enabled: j, hostId: Ye }), (t[3] = j), (t[4] = Ye), (t[5] = Xe))
    : (Xe = t[5]);
  let { data: Ze } = ke(Xe),
    F = ye(),
    $e = x(Ee),
    [I, nt] = (0, q.useState)(Mn),
    [rt, at] = (0, q.useState)(null),
    [ot, ct] = (0, q.useState)(!1),
    L = !ve && (!be || (C && E.phase === `active`)),
    ut = (0, q.useRef)(null),
    R = rt?.phase === `native` && L,
    [gt, _t] = (0, q.useState)(!0),
    [z, St] = (0, q.useState)(!1),
    [Ct, Tt] = (0, q.useState)(!1),
    [Ot, At] = (0, q.useState)(!1),
    [jt, Nt] = (0, q.useState)(!1),
    [Pt, Rt] = (0, q.useState)(null),
    [Bt, Vt] = (0, q.useState)(``),
    [Ht, Ut] = (0, q.useState)(0),
    [B, V] = (0, q.useState)(null),
    [H, Wt] = (0, q.useState)(null),
    Gt;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Gt = []), (t[6] = Gt))
    : (Gt = t[6]);
  let [U, Kt] = (0, q.useState)(Gt),
    qt;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qt = {}), (t[7] = qt))
    : (qt = t[7]);
  let [W, Jt] = (0, q.useState)(qt),
    [Yt, Xt] = (0, q.useState)(0),
    [Zt, Qt] = (0, q.useState)(null),
    [$t, en] = (0, q.useState)(vn),
    [tn, nn] = (0, q.useState)(_n),
    rn;
  t[8] !== fe || t[9] !== g || t[10] !== ne
    ? ((rn = () => (fe ? yn(g, ne) : null)),
      (t[8] = fe),
      (t[9] = g),
      (t[10] = ne),
  ...
  if (
    ...
    let e =
        G == null
          ? null
          : yt({ intl: F, petName: G.petName, startedAtMs: G.startedAtMs }),
      n = st({
        activities: $e.activities,
        intl: F,
        nowMs: tn,
        realtimeThreadId: E.conversationId,
      }),
      r;
    (t[41] !== F ||
    t[42] !== C ||
    ...
    t[46] !== Ze
      ? ((r =
          C && j && k != null
            ? lt({ intl: F, resolvedApps: Ze, status: ft(Ue) })
            : null),
        (t[41] = F),
        (t[42] = C),
        (t[43] = j),
      ...
      : (r = t[47]),
      (Y = r),
      ({ nextNotificationExpiresAtMs: Sn, notifications: J } = pt({
        dismissedNotificationTurnKeys: $t,
        extraNotifications: j ? n : M || e == null ? [] : [e],
        latestActivityFirst: !0,
        mutedNotificationPreferenceIds: _e,
        nowMs: tn,
        sessions: M ? [] : _,
      })),
      (an = J.map((e) => ({
        copy: et({
          intl: F,
          latestTurnItems: bt(e) ? l(e.localConversationId) : void 0,
          notification: e,
    ...
    (t[48] !== F || t[49] !== H
      ? ((i = (e) => {
          ...
          return {
            copy:
              H?.notificationId === n.id && H.replacedSubtitle === t.subtitle
                ? {
                    ...t,
                    subtitle: F.formatMessage({
      ...
      (Pn = je({
        ...
        items: bn,
        scrollOffset: Yt,
        viewportRect: { height: On, left: 0, top: 0, width: 345 },
      })),
      (t[12] = W),
      (t[13] = Yt),
      (t[14] = gt),
  ...
  let X = Pn,
    Fn;
  t[51] === _ ? (Fn = t[52]) : ((Fn = _.some(gn)), (t[51] = _), (t[52] = Fn));
  let In = Fn,
    Ln;
  t[53] === _ ? (Ln = t[54]) : ((Ln = _.some(hn)), (t[53] = _), (t[54] = Ln));
  let Rn = Ln,
    zn = m && (Ct || Ot || jt),
    Bn = (0, q.useRef)(null),
    Vn = (0, q.useRef)(null),
  ...
  (t[62] === G
    ...
    : ((Yn = () => {
        if (G == null) return;
        let e = qe(An, []);
        e.includes(G.avatarId) || de(An, [...e, G.avatarId]);
      }),
      (Xn = [G]),
      (t[62] = G),
      (t[63] = Yn),
  ...
  (t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? (($n = {
        ...
        onInteractiveChange: mn,
        regionElementSelectors: jn,
      }),
      (t[69] = $n))
    : ($n = t[69]),
    it($n));
  ...
  t[100] !== L
    ? ((er = () => {
        let e = It(Vn.current, Ve, { includeInert: !0 }),
          t = {
            ...W,
            ...Object.fromEntries(
              X.slots.flatMap((t) => {
        ...
        let o = Ft(Vn.current, { includeInertSurfaces: !0 });
        if (o == null) return;
        let s = zt(Vn.current),
          l = Mt({
            activityStackPresentation: X,
            isNotificationStackExpanded: R || z,
            measuredSurfaces: e,
            policies: xe({
              activityStackPresentation: X,
              isNotificationStackExpanded: R || z,
              ...
              showsNotificationBadge: K.length > 0,
              showsVoiceControls: P,
        ...
        let u = {
            ...
            activityStackItems: bn,
            activityStackPresentation: X,
            activityStackScrollOffset: Yt,
          ...
          d = {
            contentState: {
              ...
              expandedNotificationIds: U,
              isDarkAppearance: c,
              isNotificationStackExpanded: z,
              isQuickChatVisible: zn,
              isWindowDragActive: Zt != null,
              layout: I,
              locale: F.locale,
              notificationFollowUp: B,
              pointerSurfaceId: Pt,
              quickChatDictation: {
                cleanupEnabled: r,
                streamingEnabled: i,
              ...
              voiceControls: P
                ? {
                    ...
                    caption: N,
                    isSessionActive: A,
                    isMicrophoneMuted: E.isMicrophoneMuted,
                    isMuted: E.isMuted,
                    phase: O,
                    willResume: E.willResume,
                  }
                : null,
            },
            measurements: u,
          };
        (0, wn.default)(d, Gn.current) ||
          ((Gn.current = d),
          D.dispatchMessage(`avatar-overlay-composition-changed`, {
            state: d,
          }));
  ...
  t[115] !== L
    ? ((nr = () => {
        let e = Gn.current,
          ...
          n = Kn.current !== O;
        if (((Kn.current = O), R && e != null && t === !0 && P && n)) {
          let t = {
            ...e,
            contentState: {
              ...e.contentState,
            ...
            measurements: {
              ...
              surfaces: e.measurements.surfaces.map((e) =>
                Oe(e.id)
                  ...
                  : M && (e.id === `mascot-badge` || Re.some((t) => t === e.id))
                    ? { ...e, opacity: 0 }
                    : e,
              ),
            },
        ...
        if (r == null) return;
        let i = He
            ? It(Vn.current, [`realtime-caption`, `voice-status`], {
                includeInert: !0,
              })
            : [],
          a = i.find(pn)?.rect ?? null,
          o = Qe({ caption: a, status: i.find(fn)?.rect ?? null }),
          s = Vn.current
          ...
          l = {
            ...
            nativeCompositionEnabled: L,
            realtimeCaptionBelowMascotPx: c,
            showsVoiceControls: P,
          };
        if (xn(Hn.current, l)) {
          if (R && Wn.current != null) return;
          (R || (Wn.current = null), tr());
          return;
        }
        let u = Hn.current == null;
        Hn.current = l;
        let d = R && !u ? Un.current + 1 : null;
        (d != null && (Un.current = d),
          (Wn.current = d),
          D.dispatchMessage(`avatar-overlay-element-size-changed`, {
  ...
  let Q = nr,
    rr;
  t[117] !== j || t[118] !== ie || t[119] !== Je || t[120] !== k || t[121] !== Z
    ? ((rr = (e, t) => {
        let n = Bn.current;
        if (n == null || n.pointerId !== e.pointerId) return;
        ((Bn.current = null), Qt(null));
        let r = null;
        ...
        let {
          ...
          releaseSample: a,
          velocity: o,
        } = dt(n, t ? vt(e) : void 0, !t && n.usesOrbPhysics);
        (t &&
          !i &&
          (Z(
          ...
          i &&
            !n.hasMoved &&
            a != null &&
            D.dispatchMessage(`avatar-overlay-drag-move`, {
              pointerScreenX: a.screenX,
              pointerScreenY: a.screenY,
            }));
        let s = a ?? n;
        (D.dispatchMessage(`avatar-overlay-drag-end`, {
          pointerScreenX: s.screenX,
          pointerScreenY: s.screenY,
        }),
          n.usesOrbPhysics &&
            o != null &&
            D.dispatchMessage(`avatar-overlay-drag-release`, {
              shouldBounce: !0,
              velocityX: o.x * 3,
              velocityY: o.y * 3,
            }));
  ...
  t[123] === j
    ...
    : ((ir = (e) => {
        ...
        ((Bn.current = {
          ...
          Qt(null),
          D.dispatchMessage(`avatar-overlay-drag-start`, {
    ...
    ? ((or = (e) => {
        ...
        (Math.abs(r) < 4 && Math.abs(i) < 4) ||
          ...
          !t.usesOrbPhysics &&
            ...
            (r >= 4 ? Qt(`running-right`) : r <= -4 && Qt(`running-left`)),
          D.dispatchMessage(`avatar-overlay-drag-move`, {
  ...
  t[138] === Z
    ...
    : ((vr = () => {
        (Z(
          ...
          D.dispatchMessage(`avatar-overlay-composition-surface-action`, {
  ...
  let Cr = Sr,
    wr;
  t[142] !== yr || t[143] !== lr || t[144] !== z || t[145] !== J
    ? ((wr = (e) => {
        let t = J.find((t) => {
          let { id: n } = t;
          return n === e;
  ...
  t[147] !== ue || t[148] !== m
    ? ((Er = async (e) => {
        if (!m) return;
        let t = e.trim();
        t.length !== 0 && (await ue(t), Vt(``), Ut(dn));
      }),
      (t[147] = ue),
      (t[148] = m),
      (t[149] = Er))
  ...
  let Dr = Er,
    Or = un,
    kr;
  t[150] !== z || t[151] !== J.length || t[152] !== Z
    ? ((kr = () => {
        if ((Or(!1), z && J.length > 1)) {
          (Z(
  ...
  let Mr = jr,
    Nr;
  t[155] !== an || t[156] !== F || t[157] !== B || t[158] !== b || t[159] !== S
    ? ((Nr = (e, t, n) => {
        let r = n === void 0 ? !0 : n,
          i = e.controlTarget;
        switch (t.type) {
          ...
          case `submit-follow-up`: {
            ...
            (V((t) =>
              ...
              Promise.resolve(b(e, { type: `submit-follow-up`, prompt: n }))
                .then(() => {
                  let t = an.find((t) => {
    ...
    ? ((Fr = (e) => {
        ...
        switch (t.type) {
          ...
          case `run-notification-control`: {
            ...
            e == null
              ? t.action.type === `close-follow-up` && V(null)
              : Pr(e, t.action, !1);
            return;
          }
  ...
  t[177] !== E.start ||
  t[178] !== E.stop ||
  t[179] !== E.toggleMicrophoneMute ||
  t[180] !== E.toggleMute
    ? ((Ir = [z, J, E.start, E.stop, E.toggleMicrophoneMute, E.toggleMute]),
      (t[175] = z),
      (t[176] = J),
      (t[177] = E.start),
      (t[178] = E.stop),
      ...
      (t[181] = Ir))
    : (Ir = t[181]),
    Ce(`avatar-overlay-composition-action`, Fr, Ir));
  let Lr, Rr;
  (t[182] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Lr = (e) => {
        ...
        (t != null && t < Un.current) ||
          (ut.current != null && i.revision < ut.current.revision) ||
      ...
      (t[183] = Rr))
    : ((Lr = t[182]), (Rr = t[183])),
    Ce(`avatar-overlay-layout-changed`, Lr, Rr));
  let zr, Br;
  (t[184] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((zr = (e) => {
        let { direction: t } = e;
        (Bn.current != null && (Bn.current.usesWindowServerDrag = t != null),
          Qt(t == null ? null : `running-${t}`));
      }),
      (Br = []),
      (t[184] = zr),
      (t[185] = Br))
    : ((zr = t[184]), (Br = t[185])),
    Ce(`avatar-overlay-window-drag-state-changed`, zr, Br));
  let Vr, Hr;
  (t[186] === $
    ? ((Vr = t[187]), (Hr = t[188]))
    : ((Vr = () => {
  ...
  t[202] !== g.id
    ? ((Kr = [z, I, Q, g.id, Nn, f]),
      ...
      (t[203] = Kr))
    : (Kr = t[203]),
    (0, q.useLayoutEffect)(Gr, Kr));
  let qr, Jr;
  (t[204] === Sn
    ? ((qr = t[205]), (Jr = t[206]))
    : ((qr = () => {
        if (Sn == null) return;
        let e = Math.max(0, Sn - Date.now()),
          t = window.setTimeout(() => {
            nn(ln);
          }, e);
        return () => {
    ...
    (0, q.useEffect)(qr, Jr));
  let Yr, Xr;
  (t[207] !== In || t[208] !== Rn || t[209] !== y || t[210] !== ae
    ? ((Yr = () => {
        if (!In && !Rn) return;
  ...
  let ei = R ? !0 : void 0,
    ti;
  t[220] === f ? (ti = t[221]) : ((ti = kt(f)), (t[220] = f), (t[221] = ti));
  let ni;
  t[222] !== r || t[223] !== i || t[224] !== a
    ? ((ni = { cleanupEnabled: r, streamingEnabled: i, supportState: a }),
      (t[222] = r),
      (t[223] = i),
      (t[224] = a),
      (t[225] = ni))
  ...
  t[241] !== Y ||
  t[242] !== E.canStart ||
  t[243] !== E.isMicrophoneMuted ||
  t[244] !== E.isMuted ||
  t[245] !== E.start ||
  t[246] !== E.stop ||
  t[247] !== E.toggleMicrophoneMute ||
  t[248] !== E.toggleMute ||
  t[249] !== E.voiceActivity ||
  t[250] !== E.willResume ||
  t[251] !== O ||
  t[252] !== Ge ||
  t[253] !== h?.petOpenIntent
    ? ((ui = w
        ? {
            activity: E.voiceActivity,
            canStart: E.canStart,
            caption: N,
            handoff: Le === `global-overlay` ? (Ie?.handoff ?? null) : null,
            isSessionActive: A,
            microphoneMuted: E.isMicrophoneMuted,
            muted: E.isMuted,
            petOpenIntent: h?.petOpenIntent ?? ot,
            phase: j ? O : `inactive`,
            presentationAnchorRef: Ge,
            statusText: Y,
            willResume: E.willResume,
            onStart: E.start,
            onStop: E.stop,
            onToggleMicrophoneMute: E.toggleMicrophoneMute,
  ...
  return (
    ...
    t[292] !== ui
      ? ((fi = (0, Tn.jsx)(tt, {
          activityCopies: Zr,
          activityStackPresentation: X,
          areActivityPillsVisible: gt,
          avatar: g,
          avatarMenuItems: $r,
          debugWindowBorderVisible: he,
          globalDictationOrbEnabled: me,
          interactiveRegionRef: Vn,
          isNotificationTrayOpen: z,
          layout: I,
          mascotDragState: Zt,
...
function un(e) {
  D.dispatchMessage(`avatar-overlay-keyboard-interaction-changed`, {
    isInteractive: e,
  });
}
function dn(e) {
...
function yn(e, t) {
  return O(e, t) || qe(An, []).includes(e.id)
    ? null
...
var Cn, wn, q, Tn, En, Dn, On, kn, An, jn, Mn;
e(() => {
  ((Cn = ae()),
    Ze(),
    (wn = t(c(), 1)),
    ...
    (On = 208),
    (kn = []),
    (An = `first-awake-pet-notification-avatar-ids`),
    (jn = [`[data-avatar-overlay-hit-region]`, `[data-avatar-mascot='true']`]),
    (Mn = {
      mascot: { left: 244, top: 207, width: jt, height: 121 },
      placement: `top-end`,
      tray: { left: 19.5, top: 70, width: 345, height: 120 },
      viewport: { width: 384, height: 400 },
    }));
})();
export { Zt as AvatarOverlayNativePage };
//# sourceMappingURL=avatar-overlay-native-page-fJ5mwgkC.js.map
