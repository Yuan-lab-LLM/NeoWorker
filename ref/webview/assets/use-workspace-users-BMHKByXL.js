...
function E(e) {
  let t = (0, D.c)(30),
    { options: n, renderLabel: i, value: a, onChange: o } = e,
    s;
  if (t[0] !== n || t[1] !== a) {
    let e;
    (t[3] === a
      ? (e = t[4])
      : ((e = (e) => e.value === a), (t[3] = a), (t[4] = e)),
      (s = n.find(e)),
      (t[0] = n),
      (t[1] = a),
      (t[2] = s));
  ...
  let d;
  t[9] !== i || t[10] !== a
    ? ((d = i(a)), (t[9] = i), (t[10] = a), (t[11] = d))
    : (d = t[11]);
  let p;
  t[12] === d
    ? (p = t[13])
    : ((p = (0, O.jsx)(`span`, { className: `truncate`, children: d })),
      (t[12] = d),
      (t[13] = p));
  let m;
  ...
  t[15] !== u || t[16] !== p
    ...
    : (h = t[17]);
  let g;
  if (t[18] !== o || t[19] !== n || t[20] !== i || t[21] !== a) {
    let e;
    (t[23] !== o || t[24] !== i || t[25] !== a
      ? ((e = (e) =>
          (0, O.jsx)(
            f.Item,
            {
...
function A(e) {
  ...
  let _ = c ? l : void 0,
    ...
    x = n[h],
    S;
  t[8] !== h || t[9] !== n || t[10] !== c || t[11] !== f
    ? ((S = c
        ? (0, P.jsx)(p, { className: f })
  ...
  return (
    t[20] !== g || t[21] !== C
      ? ((w = (0, P.jsxs)(P.Fragment, { children: [g, C] })),
        (t[20] = g),
        (t[21] = C),
        (t[22] = w))
      : (w = t[22]),
...
function B(e) {
  ...
  t[4] !== d || t[5] !== u
    ...
    : (m = t[6]);
  let h;
  if (t[7] !== c || t[8] !== n || t[9] !== i || t[10] !== s) {
    let e;
    (t[12] !== c || t[13] !== i || t[14] !== s
      ? ((e = (e) =>
          (0, H.jsx)(
            f.Item,
            {
              disabled: e.disabled,
              RightIcon: e.value === s ? x : void 0,
...
function Y(e) {
  let t = (0, Z.c)(12),
    { accountId: r, authMethod: i } = l(),
    a;
  t[0] === e ? (a = t[1]) : ((a = e.trim()), (t[0] = e), (t[1] = a));
  let o = g(a, 200),
    s;
  t[2] !== r || t[3] !== o
    ? ((s = [`workspace-users`, r, o]), (t[2] = r), (t[3] = o), (t[4] = s))
    : (s = t[4]);
  let c = i === `chatgpt` && r != null && o.length > 0,
    u;
  t[5] !== r || t[6] !== o
    ? ((u = async () => {
        if (r == null) throw Error(`account id is required`);
        return (
          await n.safeGet(`/accounts/{account_id}/users`, {
            parameters: {
              path: { account_id: r },
  ...
  return (
    t[8] !== s || t[9] !== c || t[10] !== u
      ? ((d = { queryKey: s, enabled: c, queryFn: u, staleTime: m.ONE_MINUTE }),
        (t[8] = s),
        (t[9] = c),
        (t[10] = u),
        (t[11] = d))
...
function X(e) {
  ...
  let o = g(a, 200),
    s;
  t[2] !== r || t[3] !== o
    ? ((s = [`workspace-groups`, r, o]), (t[2] = r), (t[3] = o), (t[4] = s))
    : (s = t[4]);
  let c = i === `chatgpt` && r != null && o.length > 0,
    u;
  t[5] !== r || t[6] !== o
    ? ((u = async () => {
        if (r == null) throw Error(`account id is required`);
        return (
          await n.safeGet(`/accounts/{account_id}/groups`, {
            parameters: {
              path: { account_id: r },
              query: { limit: 10, offset: 0, query: o },
            },
...
//# sourceMappingURL=use-workspace-users-BMHKByXL.js.map
