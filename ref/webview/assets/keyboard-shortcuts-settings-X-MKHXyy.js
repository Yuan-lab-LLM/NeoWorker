...
import {
  ...
  r as je,
  t as Me,
} from "./hotkey-setter-S1Vpy1pX.js";
function Ne() {
  let e = (0, Ge.c)(1),
    t;
  return (
...
function Pe() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = {}), (e[0] = k))
    : (k = e[0]);
  let [A, j] = (0, Q.useState)(k),
    [oe, se] = (0, Q.useState)(!1),
    [fe, N] = (0, Q.useState)(null),
    { data: P } = ne(_),
    F;
  e[1] !== u || e[2] !== a
    ? ((F = {
        onSuccess: (e, t) => {
          let { commandId: n } = t,
            r = y(`codex-command-keymap-state`);
          a.setQueryData(r, e);
          let i = [r];
          (n === `hotkeyWindow` && i.push(he),
            (n === `globalDictationHold` || n === `globalDictationToggle`) &&
              i.push(y(`global-dictation-hotkey-state`)),
      ...
      (e[3] = F))
    : (F = e[3]);
  let I = i(`set-codex-command-keybinding`, F),
    L;
  e[4] !== u || e[5] !== a
    ? ((L = {
        onSuccess: (e) => {
          let t = y(`codex-command-keymap-state`);
          (a.setQueryData(t, e),
            Promise.all(
              [t, he, y(`global-dictation-hotkey-state`)].map((e) => u(e)),
            ));
        },
      }),
      (e[4] = u),
      ...
      (e[6] = L))
    : (L = e[6]);
  let B = i(`reset-codex-command-keybindings`, L),
    V,
    H;
  if (
    e[7] !== c ||
    ...
    e[30] !== C
      ? ((r = (e) =>
          de(e, {
            codexLocalAccessAllowed: c,
            modeSwitchAvailable: S,
            isGlobalDictationEnabled: f,
            isHotkeyWindowEnabled: p,
            isPriorityFilterEnabled: C,
    ...
    let i;
    (e[32] !== t || e[33] !== l
      ? ((i = (e) => ({ command: e, title: R(e, t, ce(l, e.id)).title })),
        (e[32] = t),
        (e[33] = l),
        (e[34] = i))
      : (i = e[34]),
      (H = Ke.filter(r).map(i).sort(Le)));
    let a = w.trim();
    ((V =
      a.length === 0
        ? H
        : H.filter((e) => {
            let { command: r, title: i } = e,
              o = R(r, t, ce(l, r.id)).description;
            return E
              ? pe(r.id, P, n).some((e) => {
                  let { label: t } = e;
                  return ze(t, a);
                })
              : [r.id, i, o].some((e) => re(e, a) > 0);
          })),
      (e[7] = c),
      (e[8] = t),
      (e[9] = f),
  ...
  e[40] !== H
    ? ((W =
        P == null
          ...
          : (0, $.jsx)(d, {
              autoFocus: E,
              isSearchingByKeystrokes: E,
              variant: `page`,
              trailingContent: (0, $.jsx)(g, {
                ...
                children: (0, $.jsx)(ye, {
                  ...
                  children: (0, $.jsx)(te, { className: `icon-sm` }),
                }),
              }),
              value: w,
              onKeyDown: E
                ? (e) => {
                    ...
                    if (t != null) {
                      let e = z(t, n === `macOS`, n === `linux`),
                        r = w.length === 0 ? e : `${w} ${e}`,
                        i =
                          w.length > 0 &&
                          H.some((e) => {
                            let { command: t } = e;
                            return pe(t.id, P, n).some((e) => {
                              let { label: t } = e;
                              return ze(t, r);
                            });
                          });
  ...
  e[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, $.jsx)(ue, { slug: `keyboard-shortcuts` })), (e[45] = K))
    : (K = e[45]);
  let q;
  e[46] !== D ||
  e[47] !== A ||
          ...
          : (0, $.jsx)(_e, {
              children:
                U.length === 0
                  ...
                  : U.map((e) => {
                      let { command: r, title: i } = e,
                        a = R(r, t, ce(l, r.id)).description,
                        o = A[r.id],
                        s = pe(r.id, P, n),
                        c =
                          P.bindings.some((e) => e.command === r.id) &&
                          (r.id !== `searchChats` || s.length > 0),
                        u = Ue({
                          commandId: r.id,
                          hasCustomBinding: c,
                          platform: n,
                        ...
                        d = D?.commandId === r.id && D.mode === `append`,
                        f = s.length === 0 ? [null] : s,
                        p = d && s.length > 0 ? [...s, null] : f,
                        m = `keyboard-shortcut-${r.id}-label`;
                      return (0, $.jsx)(
                        me,
                        {
  ...
  e[56] !== t || e[57] !== B
    ? ((Y = async () => {
        N(null);
        try {
          (await B.mutateAsync(void 0), se(!1));
        } catch (e) {
          let n = e;
          N(
            n instanceof Error
    ...
    : (Y = e[58]);
  let X;
  e[59] !== oe || e[60] !== fe || e[61] !== B.isPending || e[62] !== Y
    ? ((X = (0, $.jsx)(Re, {
        error: fe,
...
function Re(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(se, { className: `sr-only`, children: c })),
      (h = (0, $.jsx)(j, { className: `sr-only`, children: u })),
      (t[4] = p),
      (t[5] = h))
    : ((p = t[4]), (h = t[5]));
  let g;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $.jsx)(Oe, {
        children: (0, $.jsx)(O, { title: c, subtitle: u }),
      })),
      (t[6] = g))
    : (g = t[6]);
  let _;
  ...
  t[12] === v
    ? (b = t[13])
    : ((b = (0, $.jsx)(ye, { color: `secondary`, onClick: v, children: y })),
      (t[12] = v),
      (t[13] = b));
  let x;
  ...
  let w;
  t[17] !== b || t[18] !== S
    ? ((w = (0, $.jsx)(Oe, { children: (0, $.jsxs)(C, { children: [b, S] }) })),
      (t[17] = b),
      (t[18] = S),
      (t[19] = w))
    : (w = t[19]);
  let T;
  t[20] !== w || t[21] !== d || t[22] !== _
    ? ((T = (0, $.jsxs)(m, {
        as: `form`,
        onSubmit: d,
        children: [p, h, g, _, w],
...
function Be({
  ...
  for (let o of Ke)
    if (
      o.id !== t &&
      !L(o.id, t) &&
      pe(o.id, r, i).some((t) => He(t.accelerator, e, i === `macOS`))
    )
      return R(o, n, ce(a, o.id)).title;
  return null;
}
function Ve(e, t, n) {
  return z(e, n) === z(t, n);
...
function Ue({
  ...
  if (!t) return null;
  let i = Te({ commandId: e, isMacOS: n === `macOS` }),
...
e(() => {
  ((Ge = T()),
    ...
    F(),
    ($ = a()),
    (Ke = V.filter((e) => K(e) && e.id !== `findInThread`)));
})();
export { Ne as KeyboardShortcutsSettings };
//# sourceMappingURL=keyboard-shortcuts-settings-X-MKHXyy.js.map
