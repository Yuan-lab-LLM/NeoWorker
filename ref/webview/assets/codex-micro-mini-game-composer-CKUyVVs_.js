...
function ae(e, t = ``) {
  let n = k(
    (e?.items ?? []).flatMap((e) =>
      e.type === `agentMessage` ? oe(C(e.text, void 0), e.id) : [],
    ),
    fe,
  );
  return n.key.length > 0 || t.trim().length === 0
    ? n
    : k(oe(C(t, void 0), `home-title`), pe);
}
function O(e) {
  return e ? 20 : 10;
}
...
function he({ animateEntrance: e = !0, height: t, level: n, width: r }) {
  return {
    ...
    level: n,
    score: 0,
    ship: { angle: 0.75, radius: Ae, x: r / 2, y: t / 2 },
    status: `playing`,
    width: r,
  };
}
...
function P(e, t) {
  let n = Math.max(e / 2 - B - L, 0),
    r = t * n * 2;
  return r <= n ? L + r : e / 2 + B + r - n;
}
function Ce(e, t) {
  let { joystick: n } = e;
  if (n.distance >= je) {
    ...
    let r = Math.min(n.distance, 1),
      i = n.angle * Math.PI * 2;
    ((e.ship.x = F(
      e.ship.x + Math.cos(i) * V * r * t,
      e.ship.radius,
      e.width - e.ship.radius,
    )),
      (e.ship.y = F(
        e.ship.y + Math.sin(i) * V * r * t,
        e.ship.radius,
...
function Re(e) {
  let t = (0, ze.c)(17),
    { onFrame: n, onResize: r, playing: i, reducedMotion: o } = e,
    s = i === void 0 ? !0 : i,
    c = (0, W.useRef)(null),
...
function We(e) {
  ...
  (t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (e) => {
      ...
      (t[3] = u))
    : (u = t[3]),
    y(`codex-micro-joystick-event`, u));
  let d;
...
function Xe(e, t, n) {
  ...
  if (
    ...
    e.lastHitAtSeconds != null &&
      e.elapsedSeconds - e.lastHitAtSeconds > St &&
...
function Qe(e, t) {
  ...
  e.pendingLevel?.key !== t.key &&
    ((e.pendingLevel = t),
    (e.nextLevelUpdateAtSeconds ??= e.elapsedSeconds + vt));
}
function $e(e) {
  return e.animatesEntrance ? K(e.elapsedSeconds / Ct, 0, 1) : 1;
}
function et(e, t) {
...
function ct(e, t, n) {
  return e.reduce((e, r) => e + Math.max(n(r.character, t), 4) + q, -1);
}
function lt(e, t, n, r) {
  let i = 0;
...
function Tt(e) {
  ...
  (t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (e) => {
        let { event: t } = e;
        l.current = {
          expiresAt: globalThis.performance.now() + Nt,
          value: Et(t),
        };
      }),
      (t[1] = u))
        ...
        return i == null
          ...
          : (Xe(i, n, r < l.current.expiresAt ? l.current.value : 0),
            ...
            (i.status === `cleared` &&
              ...
              i.elapsedSeconds - i.completedAtSeconds >= Mt)
              ? (a(), !1)
              : !0);
      }),
      (t[7] = a),
...
function Dt(e, t, n) {
  ...
  for (let n of t.glyphs) {
    ...
    ((e.globalAlpha = (n.falling ? 0.7 : n.bonus ? 0.65 : 0.5) * r),
      e.fillText(n.character, n.x, n.y + (1 - r) * jt));
  }
...
function It({ columns: e, level: t, random: n = Math.random, rows: r }) {
...
function Lt(e, t) {
  ...
  ((e.stepAccumulatorSeconds = Math.min(
    ...
    e.stepAccumulatorSeconds >= n && ((e.stepAccumulatorSeconds = 0), Vt(e)));
}
function Rt(e, t) {
  if (e.status !== `playing`) return;
  if (e.inputState === `waiting-for-neutral`) {
    t.distance < Xt && (e.inputState = `waiting-for-direction`);
    return;
  }
  let n = _(t, Yt);
  if (n != null) {
    ...
    Kt(n, e.direction) || ((e.inputState = `moving`), (e.nextDirection = n));
  }
}
function zt(e, t) {
  e.foodGlyphs = Gt(t);
...
function Vt(e) {
  ...
  if ((e.body.unshift(t), n)) {
    ((e.foodCollected += 1), (e.score += O(e.food.bonus)), Wt(e));
    return;
  }
  e.body.pop();
}
...
function Ut(e, t) {
  return t.x < 0 || t.x >= e.columns || t.y < 0 || t.y >= e.rows
    ? !0
    : (qt(t, e.food) ? e.body : e.body.slice(0, -1)).some((e) => qt(e, t));
}
function Wt(e) {
  let t = [];
...
function Jt(e) {
  return Math.max(Qt, Zt - e.foodCollected * $t);
}
var Z,
  Yt,
  Xt,
...
function tn({ playing: e = !0, reducedMotion: t, level: n, onExit: r }) {
  let i = (0, Q.useRef)(null);
  (y(`codex-micro-joystick-event`, ({ event: e }) => {
    let t = i.current;
    t != null && Rt(t, e);
  }),
    (0, Q.useEffect)(() => {
  ...
  function a(e, t, r) {
    let a = Ft(r),
      o = (i.current ??= It({ columns: a, level: n, rows: Z.rows }));
    (Bt(o, a), nn(e, o, t, r));
  }
  function o(e, t, n) {
    let a = i.current;
...
function on(e) {
  ...
  t[0] === f.value
    ? (p = t[1])
    : ((p = te(f.value)), (t[0] = f.value), (t[1] = p));
  let g = p,
    _ = c(ee, r),
    v = m(re),
    { status: y } = m(o),
    b = v?.composerId === g,
    x = !i && !s && (y === `connected` || (b && y !== `not-detected`)),
    C = l && y === `connected`,
    w;
  t[2] === u
    ? (w = t[3])
  ...
  let T = w,
    ...
    D;
  if (
    (t[4] !== x || t[5] !== g || t[6] !== n || t[7] !== u
      ? ((E = () => {
          if (x)
            return ne(g, n, () => {
              u.get(re)?.composerId === g && ie(u);
            });
        }),
        (D = [x, g, n, u]),
        (t[4] = x),
    ...
    case `brick-breaker`: {
      ...
      return (
        t[16] !== T || t[17] !== C || t[18] !== k
          ? ((e = (0, $.jsx)(Tt, { level: k, onExit: T, playing: C })),
            (t[16] = T),
            (t[17] = C),
            (t[18] = k),
            (t[19] = e))
    ...
    case `snake`: {
      ...
      return (
        t[20] !== T || t[21] !== C || t[22] !== k
          ? ((e = (0, $.jsx)(tn, { level: k, onExit: T, playing: C })),
            (t[20] = T),
            (t[21] = C),
            (t[22] = k),
            (t[23] = e))
...
export { on as CodexMicroMiniGameComposer };
//# sourceMappingURL=codex-micro-mini-game-composer-CKUyVVs_.js.map
