...
function ue(e) {
  ...
  if (k === void 0) {
    ...
    ((e.width = 1),
      (e.height = 1),
      (k = e.getContext(`2d`, { willReadFrequently: !0 })));
  }
  return k
    ? (k.clearRect(0, 0, 1, 1),
      (k.fillStyle = t),
      k.fillRect(0, 0, 1, 1),
      Array.from(k.getImageData(0, 0, 1, 1).data, (e) => e / 255))
    : null;
}
function de(e, t) {
  let n = `${e}:${t}`,
...
function fe(e) {
  return (
    ...
    e(),
    () => {
      (j.delete(e), j.size === 0 && (M?.disconnect(), (M = null), A.clear()));
    }
  );
}
function pe({ animationData: e, color: t }) {
...
function C(e) {
  let t = (0, he.c)(71),
    {
      ...
      matchTextColor: ne,
      loop: re,
      mainDotLottieRefCallback: c,
      renderer: ie,
      segment: l,
      showFallbackWhileLoading: u,
      className: d,
    } = e,
    f = a === void 0 ? !0 : a,
    p = ee === void 0 ? `md` : ee,
    m = ne === void 0 ? !0 : ne,
    h = re === void 0 ? !0 : re,
    g = ie === void 0 ? `worker` : ie,
    _ = u === void 0 ? !0 : u,
    v = (0, w.useRef)(null),
    [y, oe] = (0, w.useState)(null),
    b;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((b = ce({ animation: n, animationData: r, fallback: i })),
      ...
      (t[3] = b))
    : (b = t[3]);
  let { SvgFallback: se, animationJson: x } = b,
    [S, le] = (0, w.useState)(null),
    [C, E] = (0, w.useState)(null),
    D = te(),
    O = typeof p == `number` ? `` : ge[p],
    k;
  t[4] === p
    ? (k = t[5])
    : ((k = typeof p == `number` ? { width: p, height: p } : {}),
      (t[4] = p),
      (t[5] = k));
  let A = k,
    j = typeof p == `number` ? `` : _e[p],
    M;
  t[6] !== p || t[7] !== A
    ? ((M = typeof p == `number` ? A : {}), (t[6] = p), (t[7] = A), (t[8] = M))
    : (M = t[8]);
  let N = M,
    P;
  t[9] !== d || t[10] !== j || t[11] !== s
    ? ((P = ae(j, d, s, `flex items-center justify-center`)),
      (t[9] = d),
      (t[10] = j),
      (t[11] = s),
      (t[12] = P))
  ...
  if (!f || ye) {
    ...
    let r = o ? n : void 0,
      i;
    t[28] !== e || t[29] !== r
      ? ((i = (0, T.jsx)(e, { className: `h-full w-full`, style: r })),
        (t[28] = e),
        (t[29] = r),
        (t[30] = i))
      : (i = t[30]);
  ...
  if (!D && !S && !_) {
    ...
    return (
      t[35] !== F || t[36] !== N
        ? ((e = (0, T.jsx)(`div`, { ref: v, className: F, style: N })),
          (t[35] = F),
          (t[36] = N),
          (t[37] = e))
        : (e = t[37]),
  ...
  let be = ye ? `visible` : `hidden`,
    U;
  t[38] !== H || t[39] !== be
    ? ((U = (0, T.jsx)(w.Activity, { mode: be, children: H })),
      (t[38] = H),
      (t[39] = be),
      (t[40] = U))
    : (U = t[40]);
  let xe = ye ? `hidden` : `visible`,
    W;
  t[41] === O
    ? (W = t[42])
    : ((W = ae(O, `flex items-center justify-center`)),
      (t[41] = O),
      (t[42] = W));
  let G = S?.data ?? void 0,
    K;
  ...
  let Y;
  t[54] !== H || t[55] !== J
    ? ((Y = (0, T.jsx)(w.Suspense, { fallback: H, children: J })),
      (t[54] = H),
      (t[55] = J),
      (t[56] = Y))
    : (Y = t[56]);
  let X;
  t[57] !== A || t[58] !== W || t[59] !== Y
    ? ((X = (0, T.jsx)(`div`, { className: W, style: A, children: Y })),
      (t[57] = A),
      (t[58] = W),
      (t[59] = Y),
      (t[60] = X))
    : (X = t[60]);
  let Z;
  t[61] !== F || t[62] !== N || t[63] !== X
    ? ((Z = (0, T.jsx)(`div`, { ref: v, className: F, style: N, children: X })),
      (t[61] = F),
      (t[62] = N),
      (t[63] = X),
      (t[64] = Z))
  ...
  let Q;
  t[65] !== xe || t[66] !== Z
    ? ((Q = (0, T.jsx)(w.Activity, { mode: xe, children: Z })),
      (t[65] = xe),
      (t[66] = Z),
      (t[67] = Q))
    : (Q = t[67]);
  ...
  return (
    t[68] !== U || t[69] !== Q
      ? (($ = (0, T.jsxs)(T.Fragment, { children: [U, Q] })),
        (t[68] = U),
        (t[69] = Q),
        (t[70] = $))
      : ($ = t[70]),
...
function me(e) {
  ...
  switch (
    ...
    case `main`: {
      ...
      return (
        t[5] !== e || t[6] !== r || t[7] !== i
          ? ((n = (0, T.jsx)(e, { ...i, dotLottieRefCallback: r })),
            (t[5] = e),
            (t[6] = r),
            (t[7] = i),
            (t[8] = n))
    ...
    case `worker`: {
      ...
      return (
        t[9] !== e || t[10] !== n || t[11] !== i
          ? ((r = (0, T.jsx)(e, { ...i, dotLottieRefCallback: n })),
            (t[9] = e),
            (t[10] = n),
            (t[11] = i),
            (t[12] = r))
...
var he,
  ...
  N = e(() => {
    ((he = re()),
      ...
      (E = r(
        () =>
          import(`./browser-BZl3yJkO.js`).then(
            (e) => (
              e.setWasmUrl(
      ...
      (D = E.then((e) => e.DotLottieReact)),
      (O = E.then((e) => e.DotLottieWorkerReact)),
      (ge = {
        fill: `h-full w-full`,
        xs: `w-3 h-3`,
        sm: `w-4 h-4`,
...
//# sourceMappingURL=animated-icon-Bg8ybngo.js.map
