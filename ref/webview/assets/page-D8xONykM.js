...
import { n as Me, t as Ne } from "./toolbar-breadcrumb-COhCwKVT.js";
import {
  a as Pe,
  c as Fe,
  i as Ie,
  ...
  t as Ve,
  w as He,
} from "./chart-widget-stores-Bt_RGVZr.js";
function Ue(e) {
  let t = (0, Ge.c)(33),
    {
      tabs: n,
              ...
              children: [
                ...
                e.onClose == null
                  ...
                  : (0, R.jsx)(`button`, {
                      ...
                      onClick: e.onClose,
                      children: (0, R.jsx)(ee, { className: `icon-2xs` }),
                    }),
                f.segmentedEdges && !s
                  ? (0, R.jsx)(`div`, {
...
function Ye(e) {
  ...
  let h;
  t[8] !== p || t[9] !== m
    ? ((h = (0, z.jsx)(He.Provider, { value: p, children: m })),
      (t[8] = p),
      (t[9] = m),
      (t[10] = h))
    : (h = t[10]);
  ...
  t[11] !== l.locale || t[12] !== h
    ? ((g = (0, z.jsx)(Ie, { locale: f, children: h })),
      (t[11] = l.locale),
      (t[12] = h),
      (t[13] = g))
    : (g = t[13]);
  ...
  return (
    t[22] !== _ || t[23] !== v
      ? ((y = (0, z.jsxs)(z.Fragment, { children: [_, v] })),
        (t[22] = _),
        (t[23] = v),
        (t[24] = y))
      : (y = t[24]),
...
function Xe(e) {
  return (0, z.jsx)(`li`, { children: e }, e);
}
function Ze(e, t, n, r) {
...
function at(e, t, n = Date.now()) {
  let r = ot(e, t),
    i = Math.floor((n - st) / V) * V + st;
  return {
    endTimeMs: r === `daily` ? i + V : Math.ceil(n / B) * B,
    interval: r,
    startTimeMs: i - (ct[e] - 1) * V,
  };
}
function ot(e, t) {
  switch (t) {
...
var B,
  ...
  U = e(() => {
    (he(),
      ...
      (ct = { "7d": 7, "30d": 30 }),
      (lt = M({
        start_time_ms: F().int().nonnegative(),
        end_time_ms: F().int().nonnegative(),
        granularity: Te([`1h`, `1d`]),
      })),
      (ut = M({
        project_id: L(),
        window: lt,
        overall: M({
          page_views: M({ value: F().nonnegative() }),
          unique_visitors: M({ value: F().nonnegative() }),
        }),
        timeseries: M({
          points: P(
            M({
              timestamp_ms: F().int().nonnegative(),
              page_views: F().nonnegative(),
              unique_visitors: F().nonnegative(),
            }),
          ),
        }),
        top_pages: P(
      ...
      (dt = M({ project_id: L(), event_names: P(L().min(1).max(64)) })),
      (ft = M({
        project_id: L(),
        event_name: L().min(1).max(64),
        window: lt.extend({ granularity: me(`1d`) }),
        overall: M({
          occurrences: M({ value: F().nonnegative() }),
          unique_visitors: M({ value: F().nonnegative() }),
        }),
        timeseries: M({
          points: P(
            M({
              timestamp_ms: F().int().nonnegative(),
              occurrences: F().nonnegative(),
            }),
          ),
        }),
      })),
      (pt = [`7d`, `30d`]),
      (mt = [`auto`, `hourly`, `daily`]),
      (H = `Etc/GMT+8`),
      (ht = ut.transform((e) => ({
...
function vt({ granularity: e, projectId: t, range: n }) {
  return [...xt, t, n, ot(n, e)];
}
function yt(e) {
  return [...St, e];
}
function bt({ eventName: e, projectId: t, range: n }) {
  return [...Ct, t, e, n];
}
var xt,
  St,
  ...
  Dt = e(() => {
    (w(),
      ...
      ke(),
      U(),
      (xt = [`appgen`, `analytics`, `overview`]),
      (St = [`appgen`, `analytics`, `events`]),
      (Ct = [`appgen`, `analytics`, `event`]),
      (wt = oe(_e, (e) => ({
        queryKey: vt(e),
        queryFn: async () => {
          let {
        ...
        retry: !1,
        staleTime: de.FIVE_MINUTES,
      }))),
      (Tt = oe(_e, (e) => ({
        queryKey: yt(e),
        queryFn: async () => {
          let { endTimeMs: t, startTimeMs: n } = at(`30d`, `daily`);
          return gt.parse(
            await ue(
      ...
      (Et = oe(_e, (e) => ({
        queryKey: bt(e),
        queryFn: async () => {
          let { endTimeMs: t, startTimeMs: n } = at(e.range, `daily`);
          return _t.parse(
            await ue(
...
function zt(e) {
  let t = (0, K.c)(16),
    { projectId: n } = e,
    r = j(),
    { data: i, isError: a, refetch: o } = y(Tt, n),
    s = i?.eventNames[0],
    c;
  if (i == null) {
    let e;
...
function Bt(e) {
  ...
  t[0] !== i || t[1] !== l || t[2] !== d
    ? ((p = { eventName: l, projectId: i, range: d }),
      ...
      (t[3] = p))
    : (p = t[3]);
  let { data: m, isError: h, isFetching: g, refetch: _ } = y(Et, p),
    v;
  if (m != null) {
    let e;
    (t[4] === m
  ...
  let b;
  t[12] !== a || t[13] !== l || t[14] !== d || t[15] !== s || t[16] !== _
    ? ((b = (e) => {
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, J.jsx)(re, { className: `icon-xs`, "aria-hidden": !0 })),
      (E = (0, J.jsx)(A, {
  ...
  return (
    t[34] !== v || t[35] !== O
      ? ((k = (0, J.jsxs)(J.Fragment, { children: [O, v] })),
        (t[34] = v),
        (t[35] = O),
        (t[36] = k))
      : (k = t[36]),
...
function Ht(e) {
  ...
  t[15] === u
    ? (d = t[16])
    : ((d = (0, J.jsx)(At, { label: l, value: u })), (t[15] = u), (t[16] = d));
  let f;
  ...
  t[21] === p
    ? (m = t[22])
    : ((m = (0, J.jsx)(At, { label: f, value: p })), (t[21] = p), (t[22] = m));
  let h;
  t[23] !== m || t[24] !== d
    ? ((h = (0, J.jsxs)(`div`, {
...
function qt(e) {
  ...
  t[0] !== o || t[1] !== n || t[2] !== i
    ? ((c = { granularity: o, projectId: n, range: i }),
      ...
      (t[3] = c))
    : (c = t[3]);
  let { data: l, isError: u, refetch: d } = y(wt, c),
    f;
  t[4] === r
    ? (f = t[5])
    : ((f = r.formatMessage({
...
function Jt(e) {
  ...
  t[4] === a
    ? (o = t[5])
    : ((o = (0, X.jsx)(At, { label: i, value: a })), (t[4] = a), (t[5] = o));
  let s;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, X.jsx)(A, {
  ...
  t[10] === c
    ? (l = t[11])
    : ((l = (0, X.jsx)(At, { label: s, value: c })), (t[10] = c), (t[11] = l));
  let u;
  t[12] !== o || t[13] !== l
    ? ((u = (0, X.jsxs)(`div`, {
        className: `grid grid-cols-2 gap-3`,
...
function Zt(e) {
  ...
  t[11] === s
    ? (u = t[12])
    : ((u = (0, X.jsx)(kt, { title: i, detail: s, trailing: l })),
      (t[11] = s),
      (t[12] = u));
  let d;
  t[13] !== r ||
...
function an(e) {
  ...
  if (r == null) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(v, { replace: !0, to: `/sites` })), (t[0] = e))
        : (e = t[0]),
      e
    );
  }
...
function on(e) {
  let t = (0, Q.c)(21),
    { projectId: r, section: a } = e,
    { data: o, isError: c, isLoading: l } = y(ye, r),
    u = T(),
    d = j(),
    f = n(`663642302`),
    ...
    h;
  t[0] !== p || t[1] !== m
    ? ((h = (0, $.jsx)(sn, { liveUrl: p, siteTitle: m })),
      (t[0] = p),
      (t[1] = m),
      (t[2] = h))
    : (h = t[2]);
  ...
  t[3] === g
    ? (_ = t[4])
    : ((_ = (0, $.jsx)(te, { extension: !0, children: g })),
      (t[3] = g),
      (t[4] = _));
  let v;
  t[5] === g
    ...
    : ((v = (0, $.jsx)(te, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(Ee.Header, { children: g }),
      })),
      (t[5] = g),
      (t[6] = v));
  let b;
                  ...
                  children: [
                    ...
                    f
                      ? (0, $.jsx)(Ue, {
                          ...
                          variant: `underline`,
                          onSelect: (e) => {
                            u(e === `overview` ? s(r) : k(r));
                          },
                        })
                      : null,
                    a === `overview`
                      ? (0, $.jsx)(qt, { projectId: r })
                      : (0, $.jsx)(zt, { projectId: r }),
                  ],
                }),
        }),
      })),
...
function sn(e) {
  let t = (0, Q.c)(20),
    { liveUrl: r, siteTitle: i } = e,
    o = n(`3765605143`),
    s = n(`1404955983`),
    c;
  t[0] !== o || t[1] !== s
    ? ((c = a(o, s)), (t[0] = o), (t[1] = s), (t[2] = c))
    : (c = t[2]);
  let u = c,
    d = T(),
    f = u ? `library` : `sites`,
  ...
  let g;
  t[12] !== i || t[13] !== h
    ? ((g = (0, $.jsx)(Ne, { ancestors: h, current: i })),
      (t[12] = i),
      (t[13] = h),
      (t[14] = g))
    : (g = t[14]);
    ...
    : ((_ =
        r == null
          ...
          : (0, $.jsxs)(I, {
              ...
              size: `toolbar`,
              onClick: (e) => {
                ie({ event: e, href: r, initiator: `mcp_app_resource` });
              },
              children: [
                (0, $.jsx)(l, {
                  className: `icon-xs`,
...
//# sourceMappingURL=page-D8xONykM.js.map
