...
import { n as C, t as w } from "./thread-scroll-layout-BywaziyM.js";
import { n as T, r as E } from "./use-hotkey-window-detail-layout-BFpX_mZR.js";
function D() {
  let e = (0, k.c)(7),
    t = l(u),
    n = O,
  ...
  return (
    e[5] === a
      ...
      : ((c = (0, A.jsx)(h, {
          ...
          children: (0, A.jsx)(w, { footer: a, children: s }),
        })),
        (e[5] = a),
        (e[6] = c)),
    c
...
function O(e) {
  f.hotkeyWindowHotkeys?.open({ path: a(e) });
}
var k, A;
e(() => {
  ((k = s()),
...
//# sourceMappingURL=hotkey-window-new-thread-page-CeglX4iZ.js.map
