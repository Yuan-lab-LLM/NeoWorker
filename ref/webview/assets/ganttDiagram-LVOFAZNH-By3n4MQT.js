...
import { i as S, n as C, o as w, r as T } from "./chunk-AGHRB4JF-D33xM56t.js";
import {
  B as E,
  C as D,
  V as O,
...
import { a as ie, i as ae, r as oe, t as se } from "./src-D1Kyl_w4.js";
import { t as ce } from "./dist-BNkeg5V9.js";
import { g as le, u as ue } from "./chunk-S3R3BYOJ-TWL1uuTy.js";
var de = n((e, t) => {
    (function (n, r) {
        ...
        draw: C(function (e, t, n, a) {
          ...
          if (
            ...
            for (let n of Object.keys(e)) {
              let r = yt(e[n], t) + 1;
              ((t += r), (D += r * (o.barHeight + o.barGap)), (E[n] = r));
            }
          } else {
            D += w.length * (o.barHeight + o.barGap);
            for (let e of T) E[e] = w.filter((t) => t.type === e).length;
          }
          y.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + D);
          let O = p.select(`[id="${t}"]`),
            k = d()
              .domain([
                x(w, function (e) {
            ...
            if (
              (d
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? w.length * (o.barHeight + o.barGap) + o.barHeight * 2
                    : s;
                })
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (k(e.endTime) - k(e.startTime)) - 0.5 * s),
                      (n = t + s)),
                    e.vert)
                  )
          ...
          C(te, `drawRects`);
          function re(e, t, n, r, i, s, c, l) {
            if (c.length === 0 && l.length === 0) return;
            let u, d;
            for (let { startTime: e, endTime: t } of s)
              ((u === void 0 || e < u) && (u = e),
                (d === void 0 || t > d) && (d = t));
            if (!u || !d) return;
            ...
            let f = a.db.getDateFormat(),
              p = [],
              m = null,
              h = (0, P.default)(u);
            for (; h.valueOf() <= d;)
              (a.db.isInvalidDate(h, f, c, l)
                ? m
                  ? (m.end = h)
                  : (m = { start: h, end: h })
                : (m &&= (p.push(m), null)),
            ...
            O.append(`g`)
              ...
              .attr(`height`, i - t - o.gridLineStartPadding)
          ...
          function le(e, t, n, r) {
            ...
            if (i === `off`) return;
            let s = O.append(`g`).attr(`class`, `today`),
              c = new Date(),
              l = s.append(`line`);
            (l
              .attr(`x1`, k(c) + e)
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-By3n4MQT.js.map
