...
import {
  ...
  r as Fr,
  t as Ir,
} from "./selectable-list-row-DEXpoLKq.js";
import { n as Lr, t as Rr } from "./use-plugin-scheduled-tasks-CWW1n729.js";
import { n as zr, t as Br } from "./play-outline-CTUUwJeL.js";
function Vr(e) {
  return { conversationId: jn(e), hostId: vr, source: `automation_history` };
}
function Hr(e) {
  return (
    ...
    r = await Promise.all(
      n.map(async (t) => {
        try {
          ...
          return (
            Zn.warning(`automation_history_archive_failed`, {
              safe: {},
...
function Gr(e) {
  ...
  if (r === `manual-draft`) {
    ...
    t[0] === m
      ? (n = t[1])
      : ((n = m.formatMessage(qr.create)), (t[0] = m), (t[1] = n));
    let r;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, G.jsx)(z, { ...qr.create })), (t[2] = r))
      : (r = t[2]);
    let i;
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, G.jsx)(z, { ...qr.createManually })), (t[12] = h))
    : (h = t[12]);
  let g = h,
    _;
  t[13] === m
    ? (_ = t[14])
    : ((_ = m.formatMessage(qr.create)), (t[13] = m), (t[14] = _));
  let v = (d || f) && p,
    y;
  t[15] === m
    ? (y = t[16])
    : ((y = m.formatMessage(qr.newScheduledTaskOptions)),
      (t[15] = m),
      (t[16] = y));
  let b;
  t[17] === u
    ...
    : ((b =
        u === `codex`
          ? (0, G.jsx)(z, { ...qr.createWithCodex })
          : (0, G.jsx)(z, { ...qr.createWithChat })),
      (t[17] = u),
      (t[18] = b));
  let x;
  t[19] !== p || t[20] !== l || t[21] !== b
    ? ((x = (0, G.jsx)(B.Item, {
        LeftIcon: cr,
        disabled: p,
        onSelect: l,
  ...
  let T;
  t[27] !== x || t[28] !== w
    ? ((T = (0, G.jsxs)(G.Fragment, { children: [x, w] })),
      (t[27] = x),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
...
function Xr(e) {
  ...
  t[7] !== s || t[8] !== c
    ? ((l = (0, K.jsx)(kr, {
        children: (0, K.jsx)(Ve, { title: s, subtitle: c }),
      })),
      (t[7] = s),
      (t[8] = c),
      (t[9] = l))
    : (l = t[9]);
  let u;
  t[10] === a ? (u = t[11]) : ((u = () => a(!1)), (t[10] = a), (t[11] = u));
  let d;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, K.jsx)(z, {
  ...
  t[17] !== f || t[18] !== p
    ? ((m = (0, K.jsx)(kr, {
        children: (0, K.jsxs)(ye, { children: [f, p] }),
      })),
      (t[17] = f),
      (t[18] = p),
      (t[19] = m))
    : (m = t[19]);
  let h;
  t[20] !== o || t[21] !== l || t[22] !== m
    ? ((h = (0, K.jsxs)(oe, { as: `form`, onSubmit: o, children: [l, m] })),
      (t[20] = o),
      (t[21] = l),
      (t[22] = m),
      (t[23] = h))
...
function ei(e) {
  ...
  let { pluginId: n, template: r } = t.data,
    i = $e({ pluginId: n, template: r });
  return lt({ ...i.scheduleConfig, mode: `custom`, customRrule: r.rrule })
    ? i
    : null;
}
var ti,
...
function oi(e) {
  ...
  t[4] === o
    ? (g = t[5])
    : ((g = Ft(`relative inline-flex`, o)), (t[4] = o), (t[5] = g));
  let _;
  t[6] !== a || t[7] !== c
    ? ((_ = c
        ? (0, ci.jsx)(At, { className: `icon-sm` })
  ...
  let v;
  t[9] !== g || t[10] !== _
    ? ((v = (0, ci.jsx)(`span`, { className: g, children: _ })),
      (t[9] = g),
      (t[10] = _),
      (t[11] = v))
    : (v = t[11]);
  let y;
  t[12] !== h || t[13] !== s || t[14] !== f || t[15] !== v
    ? ((y = (0, ci.jsx)(`span`, {
  ...
  let b;
  t[17] !== h || t[18] !== y
    ? ((b = (0, ci.jsx)(ue, { tooltipContent: h, children: y })),
      (t[17] = h),
      (t[18] = y),
      (t[19] = b))
    : (b = t[19]);
...
var si,
  ci,
  li = e(() => {
    ((si = I()), gr(), R(), ln(), Pr(), ur(), We(), _t(), _r(), (ci = b()));
  });
function ui() {
  let e = (0, hi.c)(1),
    t;
...
function di(e) {
  ...
  if (t[0] !== n || t[1] !== p || t[2] !== o || t[3] !== s || t[4] !== c) {
    ...
    (t[11] !== p || t[12] !== o
      ? ((a = (e) =>
          e.templates.map((t) => {
            let n = $e({ pluginId: e.plugin.id, template: t }),
              r = Ke(n.scheduleConfig, p) ?? ``,
              i = o.get(e.plugin.id);
            return {
              suggestion: {
                ...n,
...
function _i(e) {
  ...
  let d;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, J.jsx)(wr, { className: `icon-md text-token-text-secondary` })),
      (t[4] = d))
    : (d = t[4]);
  let f;
  ...
  t[6] === i
    ...
    : ((p = (0, J.jsx)(Ve, {
        icon: d,
        title: (0, J.jsx)(ut, {
          children: (0, J.jsx)(Xn, { kind: f, title: i }),
        }),
      })),
      (t[6] = i),
      (t[7] = p));
  ...
  t[12] === o
    ? (g = t[13])
    : ((g = (0, J.jsx)(vi, { rrule: o })), (t[12] = o), (t[13] = g));
  let _;
  t[14] === c
    ? (_ = t[15])
    : ((_ = () => {
  ...
  t[20] === y
    ? (x = t[21])
    : ((x = (0, J.jsxs)(ye, { className: w, children: [y, b] })),
      (t[20] = y),
      (t[21] = x));
  let S;
  t[22] !== x || t[23] !== u || t[24] !== p || t[25] !== h || t[26] !== g
    ? ((S = (0, J.jsxs)(oe, {
        as: `form`,
...
function vi(e) {
  ...
  if (t[0] !== r || t[1] !== n) {
    let e = pt(n),
      d = e.mode === `custom` ? nt(e.customRrule) : null,
      f = d?.frequency ?? e.mode,
      p = Nt.find((e) => e.id === f),
      m = d?.weekdays ?? e.weekdays,
      h = Vn.filter((e) => m.includes(e.id)),
      g =
        h.length === 1 && h[0] != null
    ...
    (t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((y = (0, J.jsx)(z, {
        ...
        (t[10] = y))
      : (y = t[10]),
      (s = (0, J.jsx)(Et, { control: _, label: y, variant: `nested` })),
      (c =
        f === `weekly`
          ? (0, J.jsx)(Et, {
              control: g,
  ...
  return {
    workspaceLabel: Le(e)
      ...
      : (() => {
          ...
          let i = e.cwds.map((e) => (r ? r(e) : qn({ root: e, labels: {} })));
...
function Ii({
  ...
  return (
    r.plugin.installed
      ? r.plugin.enabled
        ? r.plugin.availability === `AVAILABLE`
          ? n || (a = t ? `loading` : `unavailable`)
          : (a = `unavailable`)
        : (a = `disabled`)
      : (a = `uninstalled`),
    {
      state: a,
      detailPath: de(r, { hostId: e }),
      displayName: vt(r),
      logoDarkUrl: r.composerIconPath ?? r.logoDarkPath,
      logoUrl: r.composerIconPath ?? r.logoPath,
      pluginId: i,
    }
  );
}
...
function zi(e) {
  ...
  let s;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Y.jsx)(Ee, { className: `size-4` })), (t[5] = s))
    : (s = t[5]);
  let c;
...
function Ji(e) {
  ...
  if (c) {
    ...
    let r;
    t[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, X.jsx)(v, { className: `icon-sm` })), (t[4] = r))
      : (r = t[4]);
    let a;
    (t[5] === e
      ? (a = t[6])
  ...
  t[15] === _
    ? (y = t[16])
    : ((y = Ft(`automation-row`, _)), (t[15] = _), (t[16] = y));
  let b;
  t[17] !== n || t[18] !== f
    ? ((b = () => {
        f(n);
  ...
  t[26] === a
    ? (S = t[27])
    : ((S = a ? (0, X.jsx)(`span`, { children: a }) : null),
      (t[26] = a),
      (t[27] = S));
  let C;
  t[28] !== h || t[29] !== a
    ? ((C = h && a ? (0, X.jsx)(Or, {}) : null),
      (t[28] = h),
      (t[29] = a),
      (t[30] = C))
    : (C = t[30]);
...
function Yi(e) {
  ...
  return (
    t[11] !== o || t[12] !== l
      ? ((u = (0, X.jsx)(ue, { tooltipContent: o, children: l })),
        (t[11] = o),
        (t[12] = l),
        (t[13] = u))
      : (u = t[13]),
...
function ra(e) {
  ...
  if (
    ...
    let e;
    (t[36] !== i || t[37] !== O || t[38] !== r || t[39] !== A
      ? ((e = (e) => {
          let t = r.get(e.id),
            n = e.status === `PAUSED`;
          if (!(A === `all` || (A === `paused` ? n : !n))) return !1;
          let a = i.get(e.id);
          return ea(O, [
            e.name,
            e.prompt,
    ...
    t[52] !== y || t[53] !== u?.length
      ? ((F = u?.length
          ? (0, Z.jsxs)(W, {
              ...
              onClick: y,
              children: [
                (0, Z.jsx)(Gn, { "aria-hidden": !0, className: `icon-xs` }),
                (0, Z.jsx)(z, {
...
async function sa({ queryClient: e, threadId: t }) {
  (await U(`unarchive-conversation`, { hostId: vr, conversationId: jn(t) }),
    await e.invalidateQueries({ queryKey: he(`inbox-items`, { limit: 200 }) }));
}
var ca = e(() => {
  (Ln(), ir(), Er(), Tt());
});
function la() {
  let e = (0, Ca.c)(8),
    t = Ie(pn),
    { items: n, markAllRead: r, unreadRunCounts: i } = Nn(),
    a = t.data,
    o = t.isLoading,
    s;
  e[0] === a?.items
...
function ua({
  ...
  let d = De(Hn),
    ...
    [ve, be] = (0, Q.useState)(() => {
      let e = ei(D.state);
      return e == null ? p : kt(fn, e);
    }),
    [xe, Se] = (0, Q.useState)(ve),
    [Ce, I] = (0, Q.useState)(null),
    Ee = k.get(`automationId`),
    ke = k.get(`automationMode`),
    L = Ee == null ? null : (e.find((e) => e.id === Ee) ?? null),
    je =
      ke === `create`
        ? `create`
        : Ee == null
    ...
    Fe = Wt(Dr),
    { data: Le } = bt(),
    Re = re({ hostId: vr, cwd: null }),
    Be =
      Me != null &&
      ((ke === `create` && L == null) || (L != null && Me.id === L.id))
        ? Me
        : null,
    R = cn({
      draft:
        (Be != null && ze(ve)
          ? mr({ seed: Be, targetAutomation: L, models: Le?.models })
          : null) ?? (L != null && ve.id !== L.id ? g(L, Le?.models) : ve),
      modelSettings: Re,
    }),
    We = cn({
      draft:
        Be != null && ze(xe)
          ? mr({ seed: Be, targetAutomation: null, models: Le?.models })
          : xe,
      modelSettings: Re,
    }),
    Ke = je === `create` && we(R, We),
    qe = (e) => {
      be((t) => {
        let n = cn({
          draft:
    ...
    Je = b.data,
    { data: Ye } = _e(),
    Qe = new Map((Ye ?? []).map((e) => [String(e.id), i(e) ?? String(e.id)])),
    et = new Set((Ye ?? []).filter(Ze).map((e) => String(e.id))),
    tt = Array.from(
      new Set(
        t.flatMap((e) =>
          e.automationId != null && e.threadId != null && et.has(e.threadId)
            ? [e.automationId]
            : [],
        ),
      ),
    ),
    { availablePlugins: nt, installedPlugins: rt, isLoading: it } = _(vr),
    at = (0, wa.default)([...nt, ...rt], (e) => e.plugin.id),
    ot = new Set(nt.map((e) => e.plugin.id)),
    st = at.map(A),
    ct = new Map(
      nt.map((e) => [
        e.plugin.id,
    ...
    lt = Li({
      automations: e,
      runtimeSupportedPluginIds: ot,
      hostId: vr,
      isLoading: it,
      plugins: at,
    }),
    ut = L == null ? null : (lt.get(L.id) ?? null),
    B = R.pluginTemplateId == null ? null : Vt(R.pluginTemplateId),
    ft =
      B == null
        ? null
        : Ii({
            hostId: vr,
            isLoading: it,
            isSupportedByRuntime: ot.has(B),
            plugin: at.find((e) => e.plugin.id === B),
            pluginId: B,
          }),
    pt =
      R.kind === `cron` && R.pluginTemplateId != null
        ? ((x ?? [])
            .flatMap((e) =>
              e.templates.map((t) => ({
                selection: $e({ pluginId: e.plugin.id, template: t }),
                template: t,
              })),
            )
            .find(
              ({ selection: e }) => e.pluginTemplateId === R.pluginTemplateId,
            ) ?? null)
        : null,
    mt = pt?.selection ?? null,
    ht = mt != null && Pe(R, mt),
    gt = Ie(hr),
    _t = (e) =>
      e === `~`
        ...
        : qn({ root: e, labels: Je?.labels ?? {} }),
    vt = Pi({
      automations: e,
      intl: f,
      formatProjectLabel: (e) => gt.find((t) => t.projectId === e)?.label ?? e,
      formatRootLabel: _t,
      threadLabelById: Qe,
    }),
    yt = [...e].sort((e, t) => {
    ...
    { trimmedName: xt, trimmedPrompt: St, canSave: Ct } = c(R),
    wt = Ct && !(Ee != null && L == null && o),
    Tt = O(R),
    H =
      je === `edit` && Ct && Tt != null && R.status !== `DELETED`
        ? y({ draft: R, name: xt, prompt: St, status: R.status, rrule: Tt })
        : null,
    Et = nn(H, 600),
    Dt = lr(P.current, H),
    Ot = H != null && L != null && !Dn(L, H),
    At = je === `edit` && (H == null || Dt),
    jt = () => {
      Ne(null);
    },
    Mt = ({ automationId: e, automationMode: t, replace: n = !1 }) => {
      let r = new URLSearchParams(k);
      if (
        (e == null ? r.delete(`automationId`) : r.set(`automationId`, e),
        t == null ? r.delete(`automationMode`) : r.set(`automationMode`, t),
        n)
      ) {
        ee(r, { replace: !0, state: null });
        return;
      }
      ee(r, { state: null });
    },
    ...
    Ft = (e) => {
      (qe(g(e, Le?.models)), jt(), Mt({ automationId: e.id }));
    },
    It = (e) => {
      j(e);
    },
    ...
    zt = (e) => {
      switch (e.type) {
        case `codex`:
          (Nt(), xi({ intl: f, startNewConversation: w }));
          return;
        case `close`:
          Lt();
          return;
    ...
    Gt = () => {
      let e = ft?.detailPath;
      e != null && Bt({ type: `open-plugin`, detailPath: e });
    },
    Kt = () => {
      let e = Ce;
      (I(null), e != null && zt(e));
    ...
    qt = () => {
      v.invalidateQueries({ queryKey: he(`list-automations`) });
    },
    Jt = a(`automation-create`, {
      onSuccess: (e) => {
        let t = F.current;
        if (
          ((F.current = !1),
          ...
          M(
            h,
            {
              action: T.CODEX_AUTOMATION_ACTION_CREATED,
              source: t
                ? Ar.CODEX_AUTOMATION_SOURCE_SUGGESTED_CARD
                : Ar.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
              success: !0,
            },
            e.item,
            st,
          ),
          v.setQueryData(he(`list-automations`), (t) =>
            t == null
              ? { items: [e.item] }
              : {
          ...
          qt(),
          Be != null &&
            Fe({ directiveKey: Be.directiveKey, automationId: e.item.id }),
          t)
        ) {
          dt(d, ce, {});
          return;
        }
        (Nt(g(e.item, Le?.models)), I(null));
        let n = new URLSearchParams(k);
        (n.delete(`tab`),
          n.delete(`automationMode`),
          n.set(`automationId`, e.item.id),
          ee(n, { replace: !0, state: null }),
          dt(d, ce, {}));
      },
      onError: (e, t) => {
        let n = F.current;
          ...
          M(
            h,
            {
              ...
              source: n
                ...
                : Ar.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
              success: !1,
              failureReason: Ue.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
            },
            t,
            st,
          ),
    ...
    Yt = (e) => {
      ...
      ((me.current = null), N(!1), t.action());
    },
    U = a(`automation-update`, {
      onMutate: (e) => {
        let t = he(`list-automations`),
          n = v.getQueryData(t),
          r = R.id === e.id ? R.status : null;
        return (
          v.setQueryData(t, (t) =>
            t == null
              ? t
      ...
      onSuccess: (e, t) => {
        (M(
          h,
          {
            action: T.CODEX_AUTOMATION_ACTION_UPDATED,
            source: Ar.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
            success: !0,
          },
          e.item,
          st,
      ...
      onError: (t, n, r) => {
          ...
          h,
          {
            ...
            failureReason:
              ...
              `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
                ? Ue.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
                : Ue.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
          },
          n,
          st,
          i ?? null,
        ...
        let a = xa(r);
        P.current = ba(n);
        let o = a?.previousDraftStatus;
        (a?.previousAutomations != null &&
          v.setQueryData(he(`list-automations`), a.previousAutomations),
          o != null && R.id === n.id && qe((e) => ({ ...e, status: o })),
          (me.current = null),
          N(!1),
          d.get(Oe).danger(
            f.formatMessage({
      ...
      onSuccess: (t, n) => {
        ...
        if (
          (M(
            h,
            {
              action: T.CODEX_AUTOMATION_ACTION_DELETED,
              source: Ar.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
              success: t.success,
        ...
        (v.setQueryData(he(`list-automations`), (e) =>
    ...
    Zt = a(`automation-run-now`, {
      onSuccess: (t, n) => {
        let r = e.find((e) => e.id === n.id) ?? null;
        (M(
          h,
          {
            action: T.CODEX_AUTOMATION_ACTION_RUN_NOW,
            source: Ar.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
            success: t.success,
          },
          r,
    ...
    Qt = () => {
      if (wt && !(R.kind === `cron` && R.model == null)) {
        if (R.id != null) {
        ...
        Jt.mutate(br({ draft: R, name: xt, prompt: St, rrule: Tt }));
      }
    },
    $t = (e) => {
      Jt.isPending ||
        ...
        ((F.current = !0),
        pe(e.id),
        Jt.mutate(Xe({ modelSettings: Re, template: e })));
    },
    en = (e) => {
      (e.preventDefault(), Qt());
    },
    rn = (e) => {
      R.id == null ||
        Tt == null ||
        (qe((t) => ({ ...t, status: e })),
        U.mutate(y({ draft: R, name: xt, prompt: St, status: e, rrule: Tt })));
    },
    an = (e, t) => {
      if (L?.id === e.id) {
        rn(t);
    ...
    un = (e) => {
      ...
      Zt.mutate({
        id: e.id,
        collaborationMode: n == null ? null : (d.get(dr, n) ?? null),
        permissions:
          n == null ? null : Ge(d.get(Sn, n), d.get(Ae, n), d.get(jr)?.[n]),
      });
    },
    dn = () => {
      H == null || U.isPending || le || (N(!0), U.mutate(H));
    },
    pn = (e) => {
      if (H == null || Dt) {
        e();
      ...
      if (!Ot && !le && !U.isPending) {
        e();
        return;
      }
      ((me.current = { action: e, update: H }),
        !le && !U.isPending && (N(!0), U.mutate(H)));
    },
    mn = (e) => {
      pn(() => {
        Bt({ type: `plugin-template`, template: e });
      });
    },
    hn = () => {
      let e = ut?.detailPath;
      e != null &&
        pn(() => {
          Bt({ type: `open-plugin`, detailPath: e });
        });
    },
    gn = (e) => {
      if (!ki(d, L?.id ?? null, e.id)) {
        if (Ke || At) {
          I({ type: `open-automation`, automation: e });
          return;
        }
        pn(() => {
          Ft(e);
  ...
  let _n =
    ...
    vn = je != null,
    yn = je === `create` ? R.pluginTemplateId : null;
      ...
      children: [
            ...
            je == null
              ...
              : je === `create`
                ? (0, $.jsx)(ga, {
                    ...
                    setDraft: qe,
                    canSave: wt,
                    isSaving: Jt.isPending,
                    workspaceGroups: gt,
                    sourcePlugin: ft,
                    onCreateManually: Qt,
                    onCreateWithChat: Ut,
                    onOpenSourcePlugin: Gt,
                    onCancel: () => {
                      Bt({ type: `close` });
                    },
                    onEditAutomationName: ln,
                    onSubmit: en,
                  })
                : je === `edit` && L != null
                  ? (0, $.jsx)(ha, {
                      actions: (0, $.jsx)(ya, {
                        ...
                        isDeleting: Xt.isPending,
                        isRetrySavePending: le || U.isPending,
                        isRunNowPending: Zt.isPending,
                        isSaveRetryVisible: Dt,
                        showResetToPluginDefaults:
                          R.kind === `cron` && R.pluginTemplateId != null,
                        isResetToPluginDefaultsDisabled: pt == null || ht,
                        isUsingPluginDefaults: ht,
                        onDelete: sn,
                        onPause: () => {
                          rn(`PAUSED`);
                        },
                      ...
                      draft: R,
                      setDraft: qe,
                      selectedAutomation: L,
                      detailsTrailing:
                        ut == null
                          ? null
                          : (0, $.jsx)(zi, {
                              sourcePlugin: ut,
                              onOpenSourcePlugin: hn,
                            }),
                      banner: (0, $.jsx)(Wi, {
                        sourcePlugin: ut,
                        onOpenSourcePlugin: hn,
                  ...
                  : je === `missing`
                    ? (0, $.jsx)(pa, { onBackToAutomations: Lt })
                    : (0, $.jsx)(tr.DetailPanelLoading, {
                        loadingLabel: (0, $.jsx)(z, {
        ...
        pt != null && mt != null && ue
          ? (0, $.jsx)(_i, {
              ...
              prompt: pt.template.prompt,
              rrule: pt.template.rrule,
              onConfirm: () => {
                qe((e) => kt(e, mt));
              },
              onOpenChange: (e) => {
        ...
        (0, $.jsx)(`div`, {
          ...
          children:
            e.length === 0
              ? (0, $.jsx)(ma, {
                  canAddSuggestedAutomation: !Re.isLoading && Re.model != null,
                  creatingAutomationId: fe,
                  isLoading: o,
                  headerPlacement: ji(vn),
                  pluginIconsById: ct,
                  pluginTemplateGroups: x,
                  selectedPluginTemplateId: yn,
                  toolbarActions: _n,
                  onAddAutomationSuggestion: $t,
                  onSelectPluginTemplate: mn,
                })
              : (0, $.jsx)(ra, {
                  automations: yt,
                  sourcePluginsByAutomationId: lt,
                  automationRowSummaries: vt,
                  canAddAutomationSuggestion: !Re.isLoading && Re.model != null,
                  creatingAutomationId: fe,
                  headerPlacement: ji(vn),
                  pluginIconsById: ct,
                  pluginTemplateGroups: x,
                  unreadAutomationIds: r,
                  runningAutomationIds: tt,
                  isRunNowPending: Zt.isPending,
                  selectedAutomationId: L?.id ?? null,
                  selectedPluginTemplateId: yn,
                  toolbarActions: _n,
                  onMarkAllRead: s,
                  onSelectAutomation: gn,
                  onAddAutomationSuggestion: $t,
                  onSelectPluginTemplate: mn,
                  onPauseAutomation: (e) => {
                    an(e, `PAUSED`);
...
function ga(e) {
  ...
  t[15] !== f || t[16] !== c
    ...
    : (C = t[17]);
  let w;
  t[18] !== n || t[19] !== m || t[20] !== i || t[21] !== C || t[22] !== s
    ? ((w = (0, $.jsx)(nr, {
        detailsTrailing: C,
        disablePromptAutoFocus: !0,
        draft: n,
...
function _a({ automationId: e, formatRootLabel: t }) {
  let n = V(),
    ...
    s = wn(),
    { data: c } = _e(),
    { items: l, markRead: u, markUnread: d } = Nn(),
    f = new Map((c ?? []).map((e) => [String(e.id), i(e)])),
    p = new Set((c ?? []).filter(Ze).map((e) => String(e.id))),
    m = l
      .filter((t) => t.automationId === e)
      .sort((e, t) => t.createdAt - e.createdAt),
    h = m.some((e) => e.readAt == null),
    g = m.filter(Hr).length,
    _ = async (e) => {
      try {
    ...
    y = async (e) => {
      await U(`archive-conversation`, Vr(e));
    },
    b = () => {
      r.queryClient.invalidateQueries({
        queryKey: he(`inbox-items`, { limit: 200 }),
      });
    },
    x = async (e) => {
      try {
            ...
            children: m.map((e) =>
              (0, $.jsx)(
                va,
                {
                  item: e,
                  conversationTitle:
                    e.threadId == null ? null : (f.get(e.threadId) ?? null),
                  formatRootLabel: t,
                  isRunning: e.threadId != null && p.has(e.threadId),
                  onArchive: x,
                  onMarkRead: u,
                  onMarkUnread: d,
                  onUnarchive: (e) => {
  ...
  let l = V(),
    ...
    y =
      m != null && !h
        ...
        : void 0,
    b = y == null,
    x = Nr({ onSelect: y, isDisabled: b }),
    S = r
      ? (0, $.jsx)(At, { className: `icon-xs shrink-0` })
      : g
        ? (0, $.jsx)(`span`, {
            className: Ft(
              `h-2 w-2 rounded-full`,
              h ? `bg-token-error-foreground` : `bg-token-text-link-foreground`,
            ),
          })
        : h
          ? (0, $.jsx)(me, {
      ...
      children: (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsxs)(`div`, {
          className: Ft(
            ...
            _ && `relative`,
            b ? `cursor-default` : `cursor-interaction`,
            !b && `hover:bg-token-list-hover-background`,
          ),
          ...x,
          children: [
            (0, $.jsx)(`div`, {
              ...
              children: [
                ...
                (0, $.jsx)(`div`, {
                  className: Ft(
                    ...
                    _ && `group-hover:opacity-0 group-focus-within:opacity-0`,
                  ),
                  children: (0, $.jsx)(`span`, {
...
function ya(e) {
  ...
  t[6] === b
    ? (x = t[7])
    : ((x = (0, $.jsx)(Kt, { label: b, size: `toolbar` })),
      (t[6] = b),
      (t[7] = x));
  let S;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[26] !== _ || t[27] !== n || t[28] !== f || t[29] !== h
    ? ((O = n
        ...
        : (0, $.jsx)(W, {
            ...
            children: (0, $.jsx)(Tn, { className: `icon-sm` }),
          })),
      (t[26] = _),
      (t[27] = n),
      (t[28] = f),
...
function Sa({ status: e, success: t }) {
  ...
  if (
    (e === `deleted`
      ? (n = be.CODEX_AUTOMATION_DELETE_STATUS_DELETED)
      : e === `not_found` && (n = be.CODEX_AUTOMATION_DELETE_STATUS_NOT_FOUND),
    t || e === `deleted`)
  )
  ...
  switch (e) {
    case `not_found`:
      return {
        deleteStatus: n,
        failureReason: Ue.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION,
      };
    case `invalid_id`:
      return { failureReason: Ue.CODEX_AUTOMATION_FAILURE_REASON_INVALID_ID };
    case `store_unavailable`:
      return {
        failureReason: Ue.CODEX_AUTOMATION_FAILURE_REASON_STORAGE_UNAVAILABLE,
      };
    case `state_cleanup_failed`:
      return {
        failureReason: Ue.CODEX_AUTOMATION_FAILURE_REASON_STATE_CLEANUP_FAILED,
      };
    case `remove_failed`:
      return {
        failureReason: Ue.CODEX_AUTOMATION_FAILURE_REASON_REMOVE_FAILED,
      };
  }
}
var Ca, wa, Q, $, Ta;
...
//# sourceMappingURL=automations-page-B57I2hVa.js.map
