...
function x({
  ...
  ref: s,
  initialOffset: l = 0,
  remoteHostedPIPAnchorHostId: d,
}) {
  let p = l != null && l > 24 ? l : 0,
    re = ee(() => `${Math.abs(e?.get() ?? 0)}px`),
    _ = (0, T.useRef)(null),
    [v, y] = (0, T.useState)(!1),
    b = (0, T.useRef)(null),
    x = (0, T.useRef)(p),
    j = (0, T.useRef)(new Set()),
    M = (0, T.useRef)(new Set()),
    N = (0, T.useRef)(null),
    P = (0, T.useRef)(!1),
    F = (0, T.useRef)(!1),
    I = (0, T.useRef)(!1),
    ...
    ce = (0, T.useCallback)(
      (e) => {
        if (((_.current = e), !(e == null || z == null)))
          return z((t) => {
            F.current || S(e) || c(e, g(e) + t);
          });
      },
      [z],
    ),
    B = f(() => _.current),
    V = (0, T.useCallback)(() => x.current, []),
    H = f(
      (e) => (
        j.current.add(e),
        e(x.current),
    ...
    q = f((e, t) => {
      ...
      (n.scrollTo({ behavior: e, top: r === 0 ? 0 : -r }), W(g(n)));
    }),
    J = f((e, t, n = `system`) => {
      let r = x.current,
        i = Math.max(0, e);
    ...
    Z = f(() => {
      ...
      let t = {
        distanceFromBottomPx: x.current,
    ...
    Q = f(async () => {
      if (!(P.current || o == null)) {
        P.current = !0;
        try {
          for (; _.current != null && C(_.current) && (await o()) !== `stop`;) {
            let e = _.current;
            if (e != null && e.scrollHeight - e.clientHeight > O) break;
          }
        } catch {
        } finally {
          P.current = !1;
    ...
    $ = f(() => {
      ...
      let n = performance.now(),
        r = (e) => {
          ...
          let a = Math.min(1, (e - n) / D),
            o = 1 - (1 - a) ** 3;
          if ((c(i, t * (1 - o)), a < 1 && !S(i))) {
  ...
  ((0, T.useLayoutEffect)(() => {
    ...
    (0, T.useEffect)(() => {
      ...
      let t = new AbortController(),
        ...
        s = () => {
          ...
          t != null &&
            ...
            (K(), c(e, t.distanceFromBottomPx + t.wheelDistanceFromBottomPx));
          let n = x.current,
            r = i;
          if (r != null) {
            i = null;
          ...
          o();
          let l = g(e);
          if ((l > n ? `away` : l < n ? `toward` : null) === a.direction) {
            ((a.lastAtMs = s), l > n && C(e) && Q());
            for (let e of M.current) e(l, n);
            l <= 24 && (N.current = null);
          }
        },
        l = (t) => {
          let n = se(t, e.clientHeight),
            r = L.current;
        ...
        ee = (t) => {
          ...
          Math.max(Math.abs(i), Math.abs(o)) < k ||
            ((r = null),
            Math.abs(o) > Math.abs(i) && (K(), a(o > 0 ? `away` : `toward`)),
            o > Math.abs(i) && w(e) <= 0 && Q());
        },
        m = () => {
          r = null;
        };
      return (
        ...
        e.addEventListener(`keydown`, u, n),
        e.addEventListener(`touchstart`, p, n),
        e.addEventListener(`touchmove`, ee, n),
        e.addEventListener(`touchend`, m, n),
        e.addEventListener(`touchcancel`, m, n),
        e.addEventListener(`wheel`, l, n),
    ...
    (0, T.useImperativeHandle)(s, () => ({ scrollToBottom: $ })));
  let ue = (0, T.useMemo)(
      () => ({
        addScrollListener: H,
    ...
    de = ne((e) => {
      ...
      r !== t &&
        ...
        (b.current = t),
        !(F.current || I.current) &&
          (r == null || S(n) || q(`instant`, (e) => g(e) + t - r)));
    }),
              ...
              ? (0, E.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, E.jsx)(`div`, {
                      ...
                      className: m(`relative z-10 flex flex-col`, h),
                      children: n,
                    }),
                  ],
                })
...
function w(e) {
  return e.scrollHeight - e.clientHeight - g(e);
}
function se(e, t) {
  return e.deltaMode === M
    ? e.deltaY * j
    : e.deltaMode === N
      ? e.deltaY * t
      : e.deltaY;
...
export { P as n, b as r, x as t };
//# sourceMappingURL=thread-scroll-layout-BywaziyM.js.map
