...
import { t as _ } from "./chunk-FMBD7UC4-BHp580nX.js";
import { t as v } from "./chunk-YZCP3GAM-0pdEzbJW.js";
import { t as y } from "./chunk-55IACEB6-BOvtC-eN.js";
import { t as b } from "./chunk-EDXVE4YY-fKurjrhf.js";
import { r as x, t as S } from "./chunk-336JU56O-D3kVqOD2.js";
var C = (function () {
    ...
    parseMember(e) {
      ...
      ((this.classifier = t),
        (this.id = this.id.startsWith(` `)
          ? ` ` + this.id.trim()
          : this.id.trim()));
      let n = `${this.visibility ? `\\` + this.visibility : ``}${m(this.id)}${this.memberType === `method` ? `(${m(this.parameters)})${this.returnType ? ` : ` + m(this.returnType) : ``}` : ``}`;
...
//# sourceMappingURL=chunk-4TB4RGXK-CXofb0HL.js.map
