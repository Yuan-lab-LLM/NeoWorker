const e = require("./src-C7E6KJ89.js"),
  t = require("./src-BPbHdvxe.js"),
  n = require("./crash-reporter-env-CdLO-lmi.js"),
  r = require("./file-based-logger-D_CGHcxM.js"),
  i = require("./window-all-closed-a9FCmS92.js");
...
async function C() {
  try {
    ...
    try {
      return await i.Et.load(``);
    } catch {
      return i.Et.createDefault();
    }
  }
}
...
var oe = `pending-source-dmg-cleanup.json`,
  ...
  ce = t
    .mu({
      images: t
        .ou(
          t
            .mu({
              "image-path": t._u().optional(),
              "system-entities": t
                .ou(t.mu({ "mount-point": t._u().optional() }).passthrough())
                .optional(),
            })
            .passthrough(),
        )
    ...
    .passthrough(),
  le = t.mu({ sourceDmgPath: t._u() }).passthrough();
async function ue({
...
async function N(e) {
  try {
    return (
      a.app.releaseSingleInstanceLock(),
      await O(`/usr/bin/open`, [`-n`, e]),
      !0
    );
  } catch (e) {
    return (
...
function G() {
  let e = (0, u.execFileSync)(
    `/usr/bin/plutil`,
    [`-convert`, `json`, `-o`, `-`, `-`],
    {
      encoding: `utf8`,
      input: (0, u.execFileSync)(`/usr/bin/hdiutil`, [`info`, `-plist`]),
    },
  );
...
function me(e) {
  try {
    return ((0, u.execFileSync)(`/usr/bin/hdiutil`, [`detach`, e]), !0);
  } catch {
    return !1;
  }
}
...
var _e = 1e4;
function ve(e) {
  if (process.platform !== `darwin` || !a.app.isPackaged || e !== t.Ml.ChatGPT)
    return !1;
  let n = ye(),
    r = o.default.join(
...
//# sourceMappingURL=bootstrap-BGZptUDZ.js.map
