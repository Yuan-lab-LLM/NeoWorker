...
var u = n.a(`build-flavor`),
  d = [t.Lc.Nightly, t.Lc.InternalAlpha, t.Lc.PublicBeta, t.Lc.Prod],
  f = {
    [t.Lc.Nightly]: { kind: `msix` },
    [t.Lc.InternalAlpha]: { kind: `msix` },
    [t.Lc.PublicBeta]: {
      kind: `store`,
...
function v(e = process.env) {
  return e.CODEX_USE_OWL_APP_SHELL !== `0`;
}
function y(e) {
  switch (e) {
    case _.Agent:
...
var b = (0, a.randomUUID)();
function x(e, t = process.platform) {
  let n = process.env,
    a = (0, r.homedir)();
  return t === `darwin`
    ? (0, i.join)(a, `Library`, `Logs`, y(e ?? _.resolve()))
    : t === `win32`
      ? (0, i.join)(
...
//# sourceMappingURL=file-based-logger-D_CGHcxM.js.map
