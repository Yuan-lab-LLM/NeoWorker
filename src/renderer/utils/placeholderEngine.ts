...
const POOL: TaggedPlaceholder[] = [
  ...
  {
    text: "Translate this document and preserve the formatting",
    personas: ["universal"],
  },
  {
    text: "Review tomorrow's calendar and tell me what needs prep",
    personas: ["universal"],
  },
  {
    text: "Research the latest on this topic and cite the best sources",
    personas: ["universal"],
  },
  {
    text: "Organize this folder and rename files consistently",
    personas: ["universal"],
  },
  {
  ...
  {
    text: "Show my open commitments and flag anything at risk this week",
    personas: ["universal"],
  },
  {
  ...
  {
    text: "Run this task autonomously and report back with outcomes",
    personas: ["universal"],
  },
  {
    text: "Tell me what I finished this week and what is still blocked",
    personas: ["universal"],
  },
  {
  ...
  {
    text: "Convert this report into an exec-ready one-pager",
    personas: ["universal"],
  },
  {
  ...
  {
    text: "Review my inbox, highlight urgent threads, and draft replies",
    personas: ["universal"],
  },
  {
    text: "Turn this into a recurring automation or reminder",
    personas: ["universal"],
  },
  {
  ...
  {
    text: "Plan my week around deadlines, meetings, and follow-ups",
    personas: ["universal"],
  },

  // ── Engineering ───────────────────────────────────────────────────────
  {
    text: "Read the dev logs, explain the failure, and suggest a fix",
    personas: ["engineering"],
  },
  {
    text: "Compare these two implementations and recommend one",
    personas: ["engineering"],
  },
  {
    text: "Refactor this function without changing behavior",
    personas: ["engineering"],
  },
  {
    text: "Audit this codebase for security and reliability risks",
    personas: ["engineering"],
  },
  {
  ...
  {
    text: "Find recent code changes that still lack test coverage",
    personas: ["engineering"],
  },
  {
  ...
  {
    text: "Open a GitHub issue with repro steps and impacted files",
    personas: ["engineering"],
  },
  {
    text: "Review this PR for bugs, regressions, and missing tests",
    personas: ["engineering"],
  },
  {
    text: "Set up CI checks for build, test, and lint",
    personas: ["engineering"],
  },
  {
    text: "Find TODOs, FIXMEs, and dead code worth cleaning up",
    personas: ["engineering"],
  },
  {
    text: "Write the Dockerfile and call out runtime assumptions",
    personas: ["engineering"],
  },
  {
    text: "Run a browser QA pass on this flow and capture failures",
    personas: ["engineering"],
  },

  // ── Trading & finance ─────────────────────────────────────────────────
  {
    text: "Analyze the latest AAPL earnings and flag the key takeaways",
    personas: ["trading"],
  },
  {
    text: "Compare my portfolio allocation against the S&P 500",
    personas: ["trading"],
  },
  {
    text: "Summarize the latest Fed signals and likely market impact",
    personas: ["trading"],
  },
  {
  ...
  {
    text: "Pull the latest 10-K and highlight the major risk factors",
    personas: ["trading"],
  },
  {
    text: "Review TSLA options flow this week and flag unusual activity",
    personas: ["trading"],
  },
  {
  ...
  {
    text: "Summarize the macro outlook for emerging markets this week",
    personas: ["trading"],
  },
  {
    text: "Calculate Sharpe, drawdown, and volatility for this portfolio",
    personas: ["trading"],
  },
  {
    text: "Screen for stocks with low P/E and accelerating revenue",
    personas: ["trading"],
  },
  {
    text: "List the upcoming ex-dividend dates for my watchlist",
    personas: ["trading"],
  },

  // ── Education ─────────────────────────────────────────────────────────
  {
    text: "Create a lesson plan for intro to probability",
    personas: ["education"],
  },
  {
  ...
  {
    text: "Turn these lecture notes into a study guide",
    personas: ["education"],
  },
  {
    text: "Create a grading rubric for this essay assignment",
    personas: ["education"],
  },
  {
    text: "Quiz me on Spanish vocabulary from chapter 5",
    personas: ["education"],
  },
  {
    text: "Summarize this research paper in plain language",
    personas: ["education", "research"],
  },
  {
    text: "Design a 6-week Python curriculum with weekly milestones",
    personas: ["education"],
  },
  {
    text: "Create flashcards from this textbook chapter",
    personas: ["education"],
  },
  {
    text: "Suggest differentiated activities for mixed-level learners",
    personas: ["education"],
  },
  {
    text: "Draft a parent newsletter about this month's progress",
    personas: ["education"],
  },
  {
    text: "Build an assessment aligned to these learning objectives",
    personas: ["education"],
  },

  // ── Marketing & growth ────────────────────────────────────────────────
  {
    text: "Draft five ad variations and pick the strongest angle",
    personas: ["marketing"],
  },
  {
    text: "Audit this landing page for conversion issues and quick wins",
    personas: ["marketing"],
  },
  {
    text: "Create a four-week content calendar with themes and owners",
    personas: ["marketing"],
  },
  {
  ...
  {
    text: "Write launch posts for LinkedIn, X, and email",
    personas: ["marketing"],
  },
  {
    text: "Compare our SEO position against these competitors",
    personas: ["marketing"],
  },
  {
    text: "Build a customer persona from this survey data",
    personas: ["marketing", "data"],
  },
  {
    text: "Generate A/B test ideas for the checkout flow",
  ...
  {
    text: "Suggest influencer outreach targets for this niche",
    personas: ["marketing"],
  },

  // ── Design & UX ───────────────────────────────────────────────────────
  {
    text: "Review this flow for usability and accessibility issues",
    personas: ["design"],
  },
  {
    text: "Write a design spec for the new onboarding flow",
    personas: ["design", "product"],
  },
  {
    text: "Create a component inventory from this design file",
    personas: ["design"],
  },
  {
    text: "Suggest a color system for this fintech dashboard",
    personas: ["design"],
  },
  { text: "Audit this page for WCAG 2.1 AA issues", personas: ["design"] },
  {
    text: "Draft empty-state microcopy that helps users act",
    personas: ["design", "writing"],
  },
  {
    text: "Create a spacing and type scale for the design system",
    personas: ["design"],
  },
  ...
  // ── Product management ────────────────────────────────────────────────
  {
    text: "Write a PRD for this feature and define the open questions",
    personas: ["product"],
  },
  {
    text: "Prioritize this backlog using RICE and explain the tradeoffs",
    personas: ["product"],
  },
  {
  ...
  {
    text: "Build a competitive feature matrix for this market",
    personas: ["product", "founder"],
  },
  {
  ...
  {
    text: "Summarize last week's user feedback into clear themes",
    personas: ["product"],
  },
  {
    text: "Define success metrics, guardrails, and launch criteria",
    personas: ["product"],
  },
  {
  ...
  // ── Founders & startups ───────────────────────────────────────────────
  {
    text: "Draft this month's investor update with key metrics and asks",
    personas: ["founder"],
  },
  {
    text: "Estimate TAM/SAM/SOM for this market opportunity",
    personas: ["founder"],
  },
  {
    text: "Write the executive summary for our pitch deck",
    personas: ["founder"],
  },
  {
  ...
  {
    text: "Analyze this term sheet and flag unusual clauses",
    personas: ["founder", "legal"],
  },
  {
    text: "Create a competitive landscape map for our space",
    personas: ["founder"],
  },
  {
    text: "Draft a board meeting agenda and talking points",
    personas: ["founder"],
  },
  {
    text: "Calculate our runway at the current burn rate",
    personas: ["founder", "trading"],
  },

  // ── Sales ─────────────────────────────────────────────────────────────
  {
    text: "Research this prospect and draft personalized outreach",
    personas: ["sales"],
  },
  {
    text: "Build a battle card against our top competitor",
    personas: ["sales"],
  },
  { text: "Write a follow-up email after today's demo", personas: ["sales"] },
  {
    text: "Summarize this RFP and highlight our win themes",
    personas: ["sales"],
  },
  {
    text: "Turn this customer story into a case study outline",
    personas: ["sales", "marketing"],
  },
  {
    text: "Prepare a pricing comparison for the proposal",
    personas: ["sales"],
  },
  {
    text: "Script responses to budget and timing objections",
    personas: ["sales"],
  },

  // ── HR & people ops ───────────────────────────────────────────────────
  {
    text: "Write a job description for a senior data engineer",
    personas: ["hr"],
  },
  {
    text: "Create interview questions and a scorecard for this PM role",
    personas: ["hr"],
  },
  {
    text: "Draft a performance review template with clear criteria",
    personas: ["hr"],
  },
  ...
  {
    text: "Draft a company-wide announcement about the new policy",
    personas: ["hr"],
  },

  // ── Legal & compliance ────────────────────────────────────────────────
  {
    text: "Review this contract and flag non-standard clauses",
    personas: ["legal"],
  },
  {
    text: "Summarize this privacy policy in plain English",
    personas: ["legal"],
  },
  { text: "Draft a data processing agreement template", personas: ["legal"] },
  {
    text: "Check this copy for regulatory or compliance issues",
    personas: ["legal"],
  },
  {
  ...
  {
    text: "Create a data dictionary for this schema",
    personas: ["data", "engineering"],
  },
  {
  ...
  // ── Research & academia ───────────────────────────────────────────────
  {
    text: "Summarize the latest papers on transformer architectures",
    personas: ["research"],
  },
  {
    text: "Write a literature review on climate adaptation",
    personas: ["research"],
  },
  {
    text: "Design an experiment to test this hypothesis",
    personas: ["research"],
  },
  {
    text: "Create an annotated bibliography from these sources",
    personas: ["research"],
  },
  {
    text: "Compare the methodologies across these studies",
    personas: ["research"],
  },
  {
    text: "Draft an abstract for this conference submission",
    personas: ["research"],
  },
  {
    text: "Extract key findings from these papers into a table",
    personas: ["research"],
  },
  ...
  {
    text: "Map out the supply chain for this product",
    personas: ["operations"],
  },
  ...
  {
    text: "Create a risk register for this project",
    personas: ["operations", "product"],
  },

  // ── Customer support ──────────────────────────────────────────────────
  {
    text: "Draft a knowledge base article for this common issue",
    personas: ["support"],
  },
  {
    text: "Create response templates for our top ticket types",
    personas: ["support"],
  },
  {
    text: "Analyze support trends from the last 30 days",
    personas: ["support", "data"],
  },
  {
    text: "Write an escalation playbook for critical issues",
    personas: ["support", "operations"],
  },
  {
    text: "Triage these tickets by urgency, topic, and next action",
    personas: ["support"],
  },

  // ── Personal productivity ─────────────────────────────────────────────
  {
    text: "Plan a seven-day Tokyo itinerary with travel times and budget",
    personas: ["personal"],
  },
  {
    text: "Create a weekly meal plan with a grocery list",
    personas: ["personal"],
  },
  {
    text: "Build a monthly budget tracker from my expenses",
    personas: ["personal"],
  },
  {
  ...
  {
    text: "Organize my reading list by priority and topic",
    personas: ["personal"],
  },
  {
    text: "Make a pros-and-cons decision memo from these notes",
    personas: ["personal"],
  },

  // ── Healthcare ────────────────────────────────────────────────────────
  {
    text: "Summarize this clinical study in plain language",
    personas: ["healthcare", "research"],
  },
  {
    text: "Create a patient education handout for diabetes",
    personas: ["healthcare"],
  },
  {
    text: "Compare treatment options from these guidelines",
    personas: ["healthcare"],
  },
  {
    text: "Draft a care plan summary for the weekly review",
    personas: ["healthcare"],
  },

  // ── Real estate ───────────────────────────────────────────────────────
  {
    text: "Analyze comparable sales for this property",
    personas: ["realestate"],
  },
  {
  ...
  {
    text: "Build a rent-vs-buy calculator with my numbers",
    personas: ["realestate", "trading"],
  },
  {
  ...
  {
    text: "Create a podcast episode outline on remote work",
    personas: ["creative"],
  },
  {
  ...
  {
    text: "Generate tagline options for the rebrand",
    personas: ["creative", "marketing"],
  },
  {
    text: "Give me three short story prompts to get started",
    personas: ["creative"],
  },
  {
    text: "Create a mood board brief from these references",
    personas: ["creative", "design"],
  },

  // ── Writing & content ─────────────────────────────────────────────────
  {
    text: "Draft a newsletter from this week's updates",
    personas: ["writing"],
  },
  {
    text: "Write a talk outline on AI in healthcare",
    personas: ["writing", "healthcare"],
  },
  {
    text: "Turn this transcript into a polished article",
    personas: ["writing"],
  },
  {
    text: "Create a brand voice guide from these examples",
    personas: ["writing", "marketing"],
  },
  {
    text: "Rewrite this paragraph for a non-technical audience",
    personas: ["writing"],
  },
  {
    text: "Generate ten blog post titles for this topic",
    personas: ["writing", "marketing"],
  },
];
...
export function buildPlaceholders(
  ...
  if (!hasSignal) {
    const universal = POOL.filter((p) => p.personas.includes("universal")).map(
      localizePlaceholder,
    );
    // Add plugin prompts
  ...
  for (const entry of POOL) {
    ...
    const localizedText = localizePlaceholder(entry);
    if (isMatched) matched.push(localizedText);
    else if (isUniversal) universal.push(localizedText);
...
export function buildDynamicPrompts(signals: UserSignals): string[] {
  ...
  for (const g of goals.slice(0, 3)) {
    prompts.push(
      translate("welcome.dynamic.goal", "Help me make progress on: {value}", {
        value: g.value,
      }),
    );
  }
  ...
  for (const w of work.slice(0, 2)) {
    prompts.push(
      translate(
        "welcome.dynamic.work",
        "Anything new I should know about {value}?",
        { value: w.value },
      ),
    );
  }
  ...
  for (const c of signals.openCommitments.slice(0, 3)) {
    prompts.push(
      translate("welcome.dynamic.commitment", "Follow up on: {value}", {
        value: c,
      }),
    );
  }
  ...
  for (const t of signals.recentTaskTitles.slice(0, 3)) {
    prompts.push(
      translate("welcome.dynamic.recentTask", "Continue from: {value}", {
        value: t,
      }),
    );
  }
...
function localizePlaceholder(entry: TaggedPlaceholder): string {
  const index = POOL.indexOf(entry);
  if (index < 0) return entry.text;
  return translate(`welcome.placeholder.${index}`, entry.text);
}
