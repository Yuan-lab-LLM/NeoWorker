...
/**
 * Bundled skills that are valid in principle, but cannot run in the default
 * NeoWorker desktop environment yet. Keep them out of every product entry
 * point until their required runtime is bundled or configured with a proper
 * availability preflight.
 */
const CURRENTLY_UNAVAILABLE_RUNTIME_SKILL_IDS = new Set(["manim-video"]);
...
export function isSkillVisibleForCurrentProductSupport(
  ...
  return (
    ...
    !CURRENTLY_UNAVAILABLE_RUNTIME_SKILL_IDS.has(skillId) &&
