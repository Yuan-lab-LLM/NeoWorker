...
> = {
  ...
  gsap: {
    name: "GSAP 动画",
    description: "使用 GSAP 创建补间、时间线、缓动、错峰和响应式动效。",
  },
  himalaya: {
    name: "邮件 CLI",
    description:
  ...
  hyperframes: {
    name: "HyperFrames 视频制作",
    description: "创建 HTML 原生视频合成、字幕、旁白、转场和音频响应动画。",
  },
  "hyperframes-cli": {
    name: "HyperFrames 视频命令行工具",
    description: "搭建、检查、预览、渲染、转写和排查 HyperFrames 项目。",
  },
  "hyperframes-registry": {
    name: "HyperFrames 组件库",
    description: "安装并接入可复用的 HyperFrames 区块和组件。",
  },
  "idea-validation": {
    name: "想法验证",
    description:
  ...
  "manim-video": {
    name: "Manim 视频",
    description: "规划、搭建并渲染数学、算法、技术概念和数据故事讲解视频。",
  },
  "market-screener": {
    name: "市场筛选器",
  ...
  youtube: {
    name: "YouTube 字幕提取与总结",
    description: "获取 YouTube 视频字幕、元数据和转录，用于总结、问答和引用。",
  },
};
...
const ZH_PARAMETER_DESCRIPTIONS: Record<string, string> = {
  ...
  "The product, market, or idea to research competitors for":
    "要研究竞品的产品、市场或想法。",
  "What the animation should explain or visualize":
    "说明要讲解或可视化的主题。",
  "Primary video pattern to scaffold": "选择要搭建的视频讲解结构。",
  "Target audience for pacing and explanation depth":
    "说明目标受众，以便调整节奏和讲解深度。",
  "Approximate target runtime in seconds": "填写预计的视频时长，单位为秒。",
  "Workspace-relative or absolute output directory for the Manim project":
    "选择 Manim 项目的输出文件夹，可使用工作区相对路径或绝对路径。",
  "Whether to scaffold a voiceover script": "选择是否同时生成旁白脚本。",
};
...
const ZH_PARAMETER_OPTIONS: Record<string, Record<string, string>> = {
  mode: {
    ...
    "equation-derivation": "公式推导",
    "algorithm-visualization": "算法可视化",
    "data-story": "数据故事",
    "architecture-diagram": "架构演示",
    "paper-explainer": "论文讲解",
    "3d-visualization": "三维可视化",
  },
  tool: { Any: "任意" },
  voiceover: { auto: "自动选择", on: "生成旁白", off: "不生成旁白" },
};
