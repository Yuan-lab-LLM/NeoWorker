  ...
  const entries: MCPRegistryEntry[] = [
    {
      ...
      name: "Salesforce",
      description:
        "Salesforce CRM connector for NeoWorker. Requires SALESFORCE_INSTANCE_URL and an access token.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
      license: "MIT",
    ...
    },
    {
      ...
      name: "Jira",
      description:
        "Jira Cloud connector for NeoWorker. Requires JIRA_BASE_URL and auth (token or API token).",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      id: "hubspot",
      name: "HubSpot",
      description: "HubSpot CRM connector for NeoWorker. Requires HUBSPOT_ACCESS_TOKEN.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      id: "zendesk",
      name: "Zendesk",
      description: "Zendesk Support connector for NeoWorker. Requires ZENDESK credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      id: "servicenow",
      name: "ServiceNow",
      description: "ServiceNow connector for NeoWorker. Requires instance URL and credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      id: "linear",
      name: "Linear",
      description: "Linear GraphQL connector for NeoWorker. Requires LINEAR_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      id: "asana",
      name: "Asana",
      description: "Asana connector for NeoWorker. Requires ASANA_ACCESS_TOKEN.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      id: "okta",
      name: "Okta",
      description: "Okta connector for NeoWorker. Requires OKTA_BASE_URL and OKTA_API_TOKEN.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Resend",
      description:
        "Resend email connector for NeoWorker. Supports sending emails and webhook management. Requires RESEND_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    // --- Google Workspace connectors ---
    {
      ...
      description:
        "Google Calendar connector for NeoWorker. Manage events, scheduling, and availability. Requires Google OAuth credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Google Drive",
      description:
        "Google Drive connector for NeoWorker. File storage, search, and document management. Requires Google OAuth credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Gmail",
      description:
        "Gmail connector for NeoWorker. Read, send, and manage email. Requires Google OAuth credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      description:
        "Unified Google Workspace connector for NeoWorker. Access Sheets, Docs, Slides, Tasks, Chat, Drive, Gmail, and Calendar through one OAuth connection. Requires Google OAuth credentials with full Workspace scopes.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    // --- OAuth connectors ---
    {
      ...
      name: "DocuSign",
      description:
        "DocuSign connector for NeoWorker. Manage envelopes and e-signatures. Requires DocuSign OAuth credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Outreach",
      description:
        "Outreach connector for NeoWorker. Sales engagement sequences and analytics. Requires Outreach OAuth credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Slack",
      description:
        "Slack connector for NeoWorker. Team messaging, channels, and notifications. Requires Slack OAuth credentials.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Discord",
      description:
        "Discord bot connector for NeoWorker. Guild management, channels, roles, messages, threads, webhooks, and reactions. Requires DISCORD_BOT_TOKEN.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Figma",
      description:
        "Figma connector for NeoWorker. Extract design context, components, and styles from Figma files. Requires FIGMA_ACCESS_TOKEN.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Vercel",
      description:
        "Vercel connector for NeoWorker. Analyze, debug, and manage projects and deployments. Requires VERCEL_TOKEN.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "monday.com",
      description:
        "monday.com connector for NeoWorker. Manage projects, boards, and workflows. Requires MONDAY_API_TOKEN.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Maps",
      description:
        "Maps connector for NeoWorker. Search nearby places and walking routes with keyless OSM defaults and optional Google Maps Platform.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Rhino",
      description:
        "Rhino architecture connector for NeoWorker. Drives a local Rhino bridge for site, massing, floor plan, viewport, and export operations.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Blender",
      description:
        "Blender architecture connector for NeoWorker. Drives a local Blender bridge for model import, materials, cameras, lighting, and renders.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "ComfyUI",
      description:
        "ComfyUI connector for NeoWorker. Submits local ComfyUI workflows, monitors jobs, and collects generated outputs.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    // --- API-key connectors ---
    {
      ...
      name: "Apollo",
      description:
        "Apollo.io connector for NeoWorker. Prospecting and data enrichment. Requires APOLLO_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Clay",
      description:
        "Clay connector for NeoWorker. Data enrichment and waterfall workflows. Requires CLAY_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Similarweb",
      description:
        "Similarweb connector for NeoWorker. Web traffic analytics and competitive intelligence. Requires SIMILARWEB_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "MSCI",
      description:
        "MSCI connector for NeoWorker. ESG ratings, risk analytics, and index data. Requires MSCI_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "LegalZoom",
      description:
        "LegalZoom connector for NeoWorker. Legal document management and business filings. Requires LEGALZOOM_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "FactSet",
      description:
        "FactSet connector for NeoWorker. Financial data, analytics, and research. Requires FACTSET_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "WordPress",
      description:
        "WordPress connector for NeoWorker. Manage posts, pages, and media. Requires WordPress application password.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Harvey",
      description:
        "Harvey AI connector for NeoWorker. AI-powered legal research and document analysis. Requires HARVEY_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "LSEG (Refinitiv)",
      description:
        "LSEG/Refinitiv connector for NeoWorker. Market data, news, and financial analytics. Requires LSEG_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "S&P Global",
      description:
        "S&P Global connector for NeoWorker. Financial intelligence, credit ratings, and market data. Requires SPGLOBAL_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Daloopa",
      description:
        "Daloopa connector for NeoWorker. Read-only normalized financial data and filings. Requires DALOOPA_API_KEY and DALOOPA_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Morningstar",
      description:
        "Morningstar connector for NeoWorker. Read-only funds, market, company, and portfolio data. Requires MORNINGSTAR_API_KEY and MORNINGSTAR_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Moody's",
      description:
        "Moody's connector for NeoWorker. Read-only ratings, entity, and risk documents. Requires MOODYS_API_KEY and MOODYS_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "MT Newswires",
      description:
        "MT Newswires connector for NeoWorker. Read-only market news. Requires MTNEWSWIRES_API_KEY and MTNEWSWIRES_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Aiera",
      description:
        "Aiera connector for NeoWorker. Read-only events, transcripts, and filings. Requires AIERA_API_KEY and AIERA_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "PitchBook",
      description:
        "PitchBook connector for NeoWorker. Read-only private market company and deal data. Requires PITCHBOOK_API_KEY and PITCHBOOK_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Chronograph",
      description:
        "Chronograph connector for NeoWorker. Read-only portfolio monitoring and fund data. Requires CHRONOGRAPH_API_KEY and CHRONOGRAPH_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Egnyte",
      description:
        "Egnyte connector for NeoWorker finance workflows. Read-only document search and retrieval. Requires EGNYTE_API_KEY and EGNYTE_BASE_URL.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Common Room",
      description:
        "Common Room connector for NeoWorker. Community intelligence and signal tracking. Requires COMMONROOM_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
    ...
    },
    {
      ...
      name: "Tribe AI",
      description:
        "Tribe AI connector for NeoWorker. AI workforce management and expert matching. Requires TRIBEAI_API_KEY.",
      version: LOCAL_CONNECTOR_VERSION,
      author: "NeoWorker",
      homepage: "https://github.com/NeoWorker/NeoWorker",
      repository: "https://github.com/NeoWorker/NeoWorker",
...
export class MCPRegistryManager {
   ...
   * so updates are detected when providers publish new releases, not just when NeoWorker ships.
   */
