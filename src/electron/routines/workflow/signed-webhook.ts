    ...
    const outbound = request(
      {
        ...
        headers: {
          ...
          "User-Agent": "NeoWorker-Automation-Studio/1",
          "X-NeoWorker-Timestamp": timestamp,
          "X-NeoWorker-Signature": `sha256=${signature}`,
          "X-NeoWorker-Idempotency-Key": input.idempotencyKey,
        },
