...
export function buildOfficeCliOfficialWorkflowContract(
  ...
  return [
    ...
    "- For DOCX, use real heading hierarchy, readable page rhythm, intentional tables/lists, and the academic-paper or word-form profile when the content requires it.",
