...
export function getOfficeArtifactFormatForToolCall(
...
): CoordinatedOfficeArtifactFormat | null {
  ...
  if (canonical === "create_document") {
    ...
    return requestedFormat === "docx" || requestedFilename.endsWith(".docx")
      ? "docx"
      : null;
  }
  return null;
...
}): { defer: boolean; format: CoordinatedOfficeArtifactFormat | null; laterStepId?: string } {
