...
import { NEOWORKER_AUTOMATED_OUTPUT_ROOT } from "./workspace-private-paths";

export const MANAGED_AUTOMATED_OUTPUT_ROOT = NEOWORKER_AUTOMATED_OUTPUT_ROOT;
...
export function isAlreadyInManagedOutputZone(relativePath: string): boolean {
  ...
  return (
    normalized === ".neoworker" ||
    normalized.startsWith(".neoworker/") ||
