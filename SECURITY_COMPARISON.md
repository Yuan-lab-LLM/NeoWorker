...
When choosing a self-hosted AI assistant platform, security should be a primary concern. This document outlines key security considerations and how NeoWorker addresses them.
...
| Feature | Important For | NeoWorker |
|---------|---------------|------------|
...
If you discover a security vulnerability in NeoWorker:

1. **Do NOT** report via public GitHub issues
2. Use GitHub Security Advisories (preferred)
3. Or email: info@neoworkerapp.com
